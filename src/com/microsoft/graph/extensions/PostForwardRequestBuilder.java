...
public class PostForwardRequestBuilder extends BasePostForwardRequestBuilder implements IPostForwardRequestBuilder {
     ...
     */
    public PostForwardRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String comment, final java.util.List<Recipient> toRecipients) {
