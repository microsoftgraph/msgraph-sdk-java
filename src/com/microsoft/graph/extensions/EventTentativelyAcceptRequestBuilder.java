...
public class EventTentativelyAcceptRequestBuilder extends BaseEventTentativelyAcceptRequestBuilder implements IEventTentativelyAcceptRequestBuilder {
     ...
     */
    public EventTentativelyAcceptRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String comment, final Boolean sendResponse) {
