...
/**
 * The class for the Base Workbook Range Rows Above Request.
 */
public class BaseWorkbookRangeRowsAboveRequest extends BaseRequest implements IBaseWorkbookRangeRowsAboveRequest {
     ...
     */
    public BaseWorkbookRangeRowsAboveRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookRangeRowsAboveRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookRangeRowsAboveRequest expand(final String value) {
