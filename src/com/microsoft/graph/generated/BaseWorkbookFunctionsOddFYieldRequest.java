...
public class BaseWorkbookFunctionsOddFYieldRequest extends BaseRequest implements IBaseWorkbookFunctionsOddFYieldRequest {
     ...
     */
    public BaseWorkbookFunctionsOddFYieldRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsOddFYieldBody();
    }
