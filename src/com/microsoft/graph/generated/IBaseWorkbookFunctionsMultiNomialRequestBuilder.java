...
/**
 * The interface for the Base Workbook Functions Multi Nomial Request Builder.
 */
public interface IBaseWorkbookFunctionsMultiNomialRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsMultiNomialRequest instance
     */
    IWorkbookFunctionsMultiNomialRequest buildRequest(final java.util.List<Option> requestOptions);
}
