...
public class BasePermissionRequestBuilder extends BaseRequestBuilder implements IBasePermissionRequestBuilder {
     ...
     */
    public BasePermissionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IPermissionRequest buildRequest(final java.util.List<Option> requestOptions) {
