...
public class BasePlannerTaskDetailsRequestBuilder extends BaseRequestBuilder implements IBasePlannerTaskDetailsRequestBuilder {
     ...
     */
    public BasePlannerTaskDetailsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IPlannerTaskDetailsRequest buildRequest(final java.util.List<Option> requestOptions) {
