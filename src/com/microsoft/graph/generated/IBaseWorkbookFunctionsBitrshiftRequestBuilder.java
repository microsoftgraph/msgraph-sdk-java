...
/**
 * The interface for the Base Workbook Functions Bitrshift Request Builder.
 */
public interface IBaseWorkbookFunctionsBitrshiftRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsBitrshiftRequest instance
     */
    IWorkbookFunctionsBitrshiftRequest buildRequest(final java.util.List<Option> requestOptions);
}
