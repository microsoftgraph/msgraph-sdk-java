...
/**
 * The class for the Base Planner Plan Request Builder.
 */
public class BasePlannerPlanRequestBuilder extends BaseRequestBuilder implements IBasePlannerPlanRequestBuilder {
     ...
     */
    public BasePlannerPlanRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IPlannerPlanRequest buildRequest(final java.util.List<Option> requestOptions) {
