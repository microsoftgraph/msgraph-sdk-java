...
public class BaseUserReferenceRequestBuilder extends BaseRequestBuilder implements IBaseUserReferenceRequestBuilder {
     ...
     */
    public BaseUserReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IUserReferenceRequest buildRequest(final java.util.List<Option> requestOptions) {
