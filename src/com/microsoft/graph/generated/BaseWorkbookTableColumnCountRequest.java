...
/**
 * The class for the Base Workbook Table Column Count Request.
 */
public class BaseWorkbookTableColumnCountRequest extends BaseRequest implements IBaseWorkbookTableColumnCountRequest {
     ...
     */
    public BaseWorkbookTableColumnCountRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
