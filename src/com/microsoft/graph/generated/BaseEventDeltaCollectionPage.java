...
/**
 * The class for the Base Event Delta Collection Page.
 */
public class BaseEventDeltaCollectionPage extends BaseCollectionPage<Event, IEventDeltaCollectionRequestBuilder> implements IBaseEventDeltaCollectionPage {
     ...
     */
    public BaseEventDeltaCollectionPage(final BaseEventDeltaCollectionResponse response, final IEventDeltaCollectionRequestBuilder builder) {
