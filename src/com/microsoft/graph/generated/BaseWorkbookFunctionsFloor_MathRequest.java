...
public class BaseWorkbookFunctionsFloor_MathRequest extends BaseRequest implements IBaseWorkbookFunctionsFloor_MathRequest {
     ...
     */
    public IWorkbookFunctionsFloor_MathRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookFunctionsFloor_MathRequest)this;
    }
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsFloor_MathRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsFloor_MathRequest expand(final String value) {
