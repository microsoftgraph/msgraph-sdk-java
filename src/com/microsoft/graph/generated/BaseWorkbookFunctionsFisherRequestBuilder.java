...
public class BaseWorkbookFunctionsFisherRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsFisherRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsFisherRequest instance
     */
    public IWorkbookFunctionsFisherRequest buildRequest(final java.util.List<Option> requestOptions) {
