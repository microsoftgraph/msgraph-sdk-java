...
public class BaseWorkbookFunctionsDstDevRequest extends BaseRequest implements IBaseWorkbookFunctionsDstDevRequest {
     ...
     */
    public BaseWorkbookFunctionsDstDevRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsDstDevBody();
    }
