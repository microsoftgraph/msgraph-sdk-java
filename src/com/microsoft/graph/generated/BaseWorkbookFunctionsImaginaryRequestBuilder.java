...
public class BaseWorkbookFunctionsImaginaryRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImaginaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImaginaryRequest instance
     */
    public IWorkbookFunctionsImaginaryRequest buildRequest(final java.util.List<Option> requestOptions) {
