...
public class BaseThumbnailStreamRequestBuilder extends BaseRequestBuilder implements IBaseThumbnailStreamRequestBuilder {
     ...
     */
    public BaseThumbnailStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IThumbnailStreamRequest buildRequest(final java.util.List<Option> requestOptions) {
