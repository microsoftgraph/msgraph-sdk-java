...
public class BaseWorkbookChartFontRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartFontRequestBuilder {
     ...
     */
    public BaseWorkbookChartFontRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartFontRequest buildRequest(final java.util.List<Option> requestOptions) {
