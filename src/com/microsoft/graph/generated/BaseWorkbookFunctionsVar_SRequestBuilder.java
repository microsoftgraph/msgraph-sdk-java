...
/**
 * The class for the Base Workbook Functions Var_SRequest Builder.
 */
public class BaseWorkbookFunctionsVar_SRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsVar_SRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsVar_SRequest instance
     */
    public IWorkbookFunctionsVar_SRequest buildRequest(final java.util.List<Option> requestOptions) {
