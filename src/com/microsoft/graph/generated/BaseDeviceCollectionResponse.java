...
/**
 * The class for the Base Device Collection Response.
 */
public class BaseDeviceCollectionResponse implements IJsonBackedObject {
    ...
    @Expose
    public java.util.List<Device> value;
