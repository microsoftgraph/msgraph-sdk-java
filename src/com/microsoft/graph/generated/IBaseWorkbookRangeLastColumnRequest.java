...
/**
 * The interface for the Base Workbook Range Last Column Request.
 */
public interface IBaseWorkbookRangeLastColumnRequest {
     ...
     */
    IWorkbookRangeLastColumnRequest select(final String value);
     ...
     * @return The updated request
     */
    IWorkbookRangeLastColumnRequest expand(final String value);
