...
public class BaseWorkbookFunctionsSumSqRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSumSqRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsSumSqRequest instance
     */
    public IWorkbookFunctionsSumSqRequest buildRequest(final java.util.List<Option> requestOptions) {
