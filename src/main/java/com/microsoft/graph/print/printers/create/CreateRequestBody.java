...
import microsoft.graph.models.PrintCertificateSigningRequest;
/** Provides operations to call the create method. */
public class CreateRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateRequestBody currentObject = this;
