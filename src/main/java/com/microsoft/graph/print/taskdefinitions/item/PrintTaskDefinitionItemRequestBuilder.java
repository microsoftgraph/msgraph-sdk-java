...
public class PrintTaskDefinitionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PrintTaskDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrintTaskDefinition> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintTaskDefinition> executionException = new java.util.concurrent.CompletableFuture<PrintTaskDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
