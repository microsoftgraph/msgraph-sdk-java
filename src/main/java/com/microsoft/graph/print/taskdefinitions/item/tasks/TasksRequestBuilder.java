package microsoft.graph.print.taskdefinitions.item.tasks;
...
import microsoft.graph.models.PrintTaskCollectionResponse;
import microsoft.graph.print.taskdefinitions.item.tasks.count.CountRequestBuilder;
...
public class TasksRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrintTaskCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintTaskCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of PrintTaskCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<PrintTaskCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TasksRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintTaskCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of printTask
     */
    public java.util.concurrent.CompletableFuture<PrintTask> post(@javax.annotation.Nonnull final PrintTask body, @javax.annotation.Nullable final java.util.function.Consumer<TasksRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
