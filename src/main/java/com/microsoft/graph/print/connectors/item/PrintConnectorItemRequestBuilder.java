...
public class PrintConnectorItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PrintConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrintConnector> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintConnector> executionException = new java.util.concurrent.CompletableFuture<PrintConnector>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
