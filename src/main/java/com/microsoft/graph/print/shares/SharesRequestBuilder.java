...
public class SharesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PrinterShare body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrinterShareCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrinterShareCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrinterShareCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<PrinterShare> post(@javax.annotation.Nonnull final PrinterShare body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrinterShare> executionException = new java.util.concurrent.CompletableFuture<PrinterShare>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
