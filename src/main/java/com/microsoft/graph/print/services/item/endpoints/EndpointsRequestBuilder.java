...
public class EndpointsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PrintServiceEndpoint body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrintServiceEndpointCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintServiceEndpointCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrintServiceEndpointCollectionResponse>();
