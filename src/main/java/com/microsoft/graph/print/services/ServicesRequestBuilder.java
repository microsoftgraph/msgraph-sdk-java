package microsoft.graph.print.services;
...
import microsoft.graph.models.PrintServiceCollectionResponse;
...
public class ServicesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrintServiceCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintServiceCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of PrintServiceCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<PrintServiceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ServicesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintServiceCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<PrintService> post(@javax.annotation.Nonnull final PrintService body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintService::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of printService
     */
    public java.util.concurrent.CompletableFuture<PrintService> post(@javax.annotation.Nonnull final PrintService body, @javax.annotation.Nullable final java.util.function.Consumer<ServicesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintService::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
