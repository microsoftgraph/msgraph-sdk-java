...
public class ServicesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrintServiceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintServiceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrintServiceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<PrintService> post(@javax.annotation.Nonnull final PrintService body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintService> executionException = new java.util.concurrent.CompletableFuture<PrintService>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
