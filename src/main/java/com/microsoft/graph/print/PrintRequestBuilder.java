...
public class PrintRequestBuilder {
     ...
     * @return a CompletableFuture of Print
     */
    public java.util.concurrent.CompletableFuture<Print> patch(@javax.annotation.Nonnull final Print body, @javax.annotation.Nullable final java.util.function.Consumer<PrintRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of Print
     */
    public java.util.concurrent.CompletableFuture<Print> patch(@javax.annotation.Nonnull final Print body, @javax.annotation.Nullable final java.util.function.Consumer<PrintRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
