...
/**
 * The interface for the Call Record Reference Request.
 */
public interface ICallRecordReferenceRequest extends IHttpRequest {

    void delete(final ICallback<? super CallRecord> callback);

    CallRecord delete() throws ClientException;
     ...
     */
    ICallRecordReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    ICallRecordReferenceRequest expand(final String value);
