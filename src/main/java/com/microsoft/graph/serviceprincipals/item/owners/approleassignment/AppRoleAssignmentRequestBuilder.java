package microsoft.graph.serviceprincipals.item.owners.approleassignment;
...
import microsoft.graph.serviceprincipals.item.owners.approleassignment.count.CountRequestBuilder;
