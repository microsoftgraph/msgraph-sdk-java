package microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.addkey.AddKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.addpassword.AddPasswordRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.addtokensigningcertificate.AddTokenSigningCertificateRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.removekey.RemoveKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.removepassword.RemovePasswordRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.restore.RestoreRequestBuilder;
