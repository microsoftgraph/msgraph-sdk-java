...
public class FederatedIdentityCredentialItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final FederatedIdentityCredential body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<FederatedIdentityCredential> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<FederatedIdentityCredential> executionException = new java.util.concurrent.CompletableFuture<FederatedIdentityCredential>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
