package microsoft.graph.serviceprincipals.item.ownedobjects.approleassignment;
...
import microsoft.graph.serviceprincipals.item.ownedobjects.approleassignment.count.CountRequestBuilder;
