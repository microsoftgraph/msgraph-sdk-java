...
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.addkey.AddKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.addpassword.AddPasswordRequestBuilder;
...
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.removekey.RemoveKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.removepassword.RemovePasswordRequestBuilder;
