package com.microsoft.graph.serviceprincipals.item.synchronization.jobs.item.pause;
...
public class PauseRequestBuilder extends BaseRequestBuilder {
    ...
    public PauseRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/pause", pathParameters);
    }
    /**
     * Instantiates a new PauseRequestBuilder and sets the default values.
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/synchronization-synchronizationjob-pause?view=graph-rest-1.0">Find more info here</a>
     */
