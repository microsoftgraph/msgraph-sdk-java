...
public class EndpointsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Endpoint body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Endpoint> post(@javax.annotation.Nonnull final Endpoint body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Endpoint> executionException = new java.util.concurrent.CompletableFuture<Endpoint>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Endpoint> post(@javax.annotation.Nonnull final Endpoint body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
