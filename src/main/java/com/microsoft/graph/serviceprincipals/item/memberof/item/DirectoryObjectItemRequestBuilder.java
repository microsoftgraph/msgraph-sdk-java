package com.microsoft.graph.serviceprincipals.item.memberof.item;

import com.microsoft.graph.models.DirectoryObject;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.serviceprincipals.item.memberof.item.application.ApplicationRequestBuilder;
import com.microsoft.graph.serviceprincipals.item.memberof.item.device.DeviceRequestBuilder;
import com.microsoft.graph.serviceprincipals.item.memberof.item.group.GroupRequestBuilder;
import com.microsoft.graph.serviceprincipals.item.memberof.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.serviceprincipals.item.memberof.item.user.UserRequestBuilder;
