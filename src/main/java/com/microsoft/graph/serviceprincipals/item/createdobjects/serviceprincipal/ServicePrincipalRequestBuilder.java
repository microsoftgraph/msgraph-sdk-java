package microsoft.graph.serviceprincipals.item.createdobjects.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.createdobjects.serviceprincipal.count.CountRequestBuilder;
