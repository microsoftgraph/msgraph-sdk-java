package microsoft.graph.serviceprincipals.item.tokenlifetimepolicies;
...
import microsoft.graph.serviceprincipals.item.tokenlifetimepolicies.count.CountRequestBuilder;
