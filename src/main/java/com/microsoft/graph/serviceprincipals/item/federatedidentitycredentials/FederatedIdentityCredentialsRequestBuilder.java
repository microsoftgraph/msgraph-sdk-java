...
public class FederatedIdentityCredentialsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<FederatedIdentityCredentialCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<FederatedIdentityCredentialCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<FederatedIdentityCredentialCollectionResponse>();
