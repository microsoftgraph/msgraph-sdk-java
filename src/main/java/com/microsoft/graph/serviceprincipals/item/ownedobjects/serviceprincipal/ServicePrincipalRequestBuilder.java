package microsoft.graph.serviceprincipals.item.ownedobjects.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.ownedobjects.serviceprincipal.count.CountRequestBuilder;
