package com.microsoft.graph.serviceprincipals.item.ownedobjects.serviceprincipal;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.ServicePrincipalCollectionResponse;
import com.microsoft.graph.serviceprincipals.item.ownedobjects.serviceprincipal.count.CountRequestBuilder;
...
public class ServicePrincipalRequestBuilder {
    ...
    public ServicePrincipalRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/microsoft.graph.servicePrincipal{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
