package microsoft.graph.serviceprincipals.item.transitivememberof.group;
...
import microsoft.graph.serviceprincipals.item.transitivememberof.group.count.CountRequestBuilder;
