...
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.addkey.AddKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.addpassword.AddPasswordRequestBuilder;
...
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.removekey.RemoveKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.removepassword.RemovePasswordRequestBuilder;
