package microsoft.graph.serviceprincipals.item.memberof.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.memberof.serviceprincipal.count.CountRequestBuilder;
