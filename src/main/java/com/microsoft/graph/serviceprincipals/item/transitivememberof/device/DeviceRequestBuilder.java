package microsoft.graph.serviceprincipals.item.transitivememberof.device;
...
import microsoft.graph.serviceprincipals.item.transitivememberof.device.count.CountRequestBuilder;
