package microsoft.graph.serviceprincipals.item.ownedobjects.group;
...
import microsoft.graph.serviceprincipals.item.ownedobjects.group.count.CountRequestBuilder;
