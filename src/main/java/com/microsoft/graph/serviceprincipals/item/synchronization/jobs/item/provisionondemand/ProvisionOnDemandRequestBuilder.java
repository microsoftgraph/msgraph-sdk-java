...
public class ProvisionOnDemandRequestBuilder extends BaseRequestBuilder {
    ...
    public StringKeyStringValuePair post(@jakarta.annotation.Nonnull final ProvisionOnDemandPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public StringKeyStringValuePair post(@jakarta.annotation.Nonnull final ProvisionOnDemandPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, StringKeyStringValuePair::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Select a user and provision the account on-demand. The rate limit for this API is 5 requests per 10 seconds.  This API is available in the following national cloud deployments.
     * @param body The request body
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ProvisionOnDemandPostRequestBody body) {
