package com.microsoft.graph.serviceprincipals.item.owners.item.user;
...
public class UserRequestBuilder {
    ...
    public UserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
