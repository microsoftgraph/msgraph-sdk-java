...
public class FunctionsResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
     ...
     * @return a functionsResponse
     */
    @javax.annotation.Nonnull
    public static FunctionsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<AttributeMappingFunctionSchema> value) {
        this.value = value;
    }
}
