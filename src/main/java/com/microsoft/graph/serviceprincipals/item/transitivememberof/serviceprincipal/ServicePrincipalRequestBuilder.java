package microsoft.graph.serviceprincipals.item.transitivememberof.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
