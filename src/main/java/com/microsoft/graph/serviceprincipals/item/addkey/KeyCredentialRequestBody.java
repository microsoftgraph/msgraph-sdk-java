...
public class KeyCredentialRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a KeyCredentialRequestBody
     */
    @javax.annotation.Nonnull
    public static KeyCredentialRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final KeyCredentialRequestBody currentObject = this;
