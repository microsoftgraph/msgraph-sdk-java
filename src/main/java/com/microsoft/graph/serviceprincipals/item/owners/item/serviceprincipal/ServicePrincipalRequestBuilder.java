package microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.addkey.AddKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.addpassword.AddPasswordRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.addtokensigningcertificate.AddTokenSigningCertificateRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.removekey.RemoveKeyRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.removepassword.RemovePasswordRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.restore.RestoreRequestBuilder;
