...
public class DelegatedPermissionClassificationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DelegatedPermissionClassification body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedPermissionClassificationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedPermissionClassificationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedPermissionClassificationCollectionResponse>();
