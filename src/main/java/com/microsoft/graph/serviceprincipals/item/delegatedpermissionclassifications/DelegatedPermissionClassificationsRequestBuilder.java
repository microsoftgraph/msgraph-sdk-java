...
public class DelegatedPermissionClassificationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedPermissionClassificationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedPermissionClassificationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedPermissionClassificationCollectionResponse>();
