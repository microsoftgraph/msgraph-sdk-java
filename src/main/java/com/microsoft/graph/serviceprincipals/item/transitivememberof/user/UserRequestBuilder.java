package microsoft.graph.serviceprincipals.item.transitivememberof.user;
...
import microsoft.graph.serviceprincipals.item.transitivememberof.user.count.CountRequestBuilder;
