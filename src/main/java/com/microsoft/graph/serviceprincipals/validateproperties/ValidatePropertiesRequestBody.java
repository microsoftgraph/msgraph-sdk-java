package microsoft.graph.serviceprincipals.validateproperties;
...
public class ValidatePropertiesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a validatePropertiesRequestBody
     */
    @javax.annotation.Nonnull
    public static ValidatePropertiesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ValidatePropertiesRequestBody currentObject = this;
