...
public class RiskyUserHistoryItemItemRequestBuilder {
     ...
     * @return a CompletableFuture of riskyUserHistoryItem
     */
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> patch(@javax.annotation.Nonnull final RiskyUserHistoryItem body, @javax.annotation.Nullable final java.util.function.Consumer<RiskyUserHistoryItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
