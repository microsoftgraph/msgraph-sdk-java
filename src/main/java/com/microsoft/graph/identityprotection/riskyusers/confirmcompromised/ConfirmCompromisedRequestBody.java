...
public class ConfirmCompromisedRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a confirmCompromisedRequestBody
     */
    @javax.annotation.Nonnull
    public static ConfirmCompromisedRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ConfirmCompromisedRequestBody currentObject = this;
