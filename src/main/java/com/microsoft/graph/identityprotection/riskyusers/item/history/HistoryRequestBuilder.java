package microsoft.graph.identityprotection.riskyusers.item.history;
...
import microsoft.graph.identityprotection.riskyusers.item.history.count.CountRequestBuilder;
