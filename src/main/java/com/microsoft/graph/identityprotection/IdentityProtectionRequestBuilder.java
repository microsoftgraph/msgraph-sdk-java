...
public class IdentityProtectionRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final IdentityProtectionRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IdentityProtectionRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityProtectionRoot> executionException = new java.util.concurrent.CompletableFuture<IdentityProtectionRoot>();
