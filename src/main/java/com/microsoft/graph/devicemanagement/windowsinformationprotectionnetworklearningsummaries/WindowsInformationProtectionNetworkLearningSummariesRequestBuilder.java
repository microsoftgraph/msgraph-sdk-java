...
public class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WindowsInformationProtectionNetworkLearningSummary body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummaryCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummaryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummary> post(@javax.annotation.Nonnull final WindowsInformationProtectionNetworkLearningSummary body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummary> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
