...
public class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummaryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummaryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummary> post(@javax.annotation.Nonnull final WindowsInformationProtectionNetworkLearningSummary body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummary> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionNetworkLearningSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
