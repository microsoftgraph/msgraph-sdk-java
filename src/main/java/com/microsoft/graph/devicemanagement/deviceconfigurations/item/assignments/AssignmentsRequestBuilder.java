...
public class AssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfigurationAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationAssignmentCollectionResponse>();
