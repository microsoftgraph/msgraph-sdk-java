...
public class UserStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationUserStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfigurationUserStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationUserStatusCollectionResponse>();
