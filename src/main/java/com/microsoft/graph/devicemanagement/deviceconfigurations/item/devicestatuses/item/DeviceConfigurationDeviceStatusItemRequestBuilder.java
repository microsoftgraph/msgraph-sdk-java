...
public class DeviceConfigurationDeviceStatusItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeviceConfigurationDeviceStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatus> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatus> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
