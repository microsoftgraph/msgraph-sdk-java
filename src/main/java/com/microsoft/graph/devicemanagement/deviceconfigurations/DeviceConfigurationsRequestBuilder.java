...
public class DeviceConfigurationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfigurationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfiguration> post(@javax.annotation.Nonnull final DeviceConfiguration body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfiguration> executionException = new java.util.concurrent.CompletableFuture<DeviceConfiguration>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
