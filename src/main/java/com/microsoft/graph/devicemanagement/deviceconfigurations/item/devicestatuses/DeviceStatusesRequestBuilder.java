...
public class DeviceStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatusCollectionResponse>();
