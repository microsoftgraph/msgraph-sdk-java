...
public class GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse implements AdditionalDataHolder, Parsable {
    ...
    public static GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
