...
public class GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getOmaSettingPlainTextValueWithSecretReferenceValueIdResponse
     */
    @jakarta.annotation.Nonnull
    public static GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
