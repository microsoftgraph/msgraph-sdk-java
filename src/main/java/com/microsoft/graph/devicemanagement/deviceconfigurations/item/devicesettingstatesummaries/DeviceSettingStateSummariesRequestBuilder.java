...
public class DeviceSettingStateSummariesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SettingStateDeviceSummary body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SettingStateDeviceSummaryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SettingStateDeviceSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SettingStateDeviceSummaryCollectionResponse>();
