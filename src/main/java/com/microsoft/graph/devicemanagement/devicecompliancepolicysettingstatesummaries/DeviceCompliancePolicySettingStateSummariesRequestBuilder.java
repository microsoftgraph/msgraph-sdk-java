...
public class DeviceCompliancePolicySettingStateSummariesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceCompliancePolicySettingStateSummary body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummaryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummaryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummary> post(@javax.annotation.Nonnull final DeviceCompliancePolicySettingStateSummary body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummary> executionException = new java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
