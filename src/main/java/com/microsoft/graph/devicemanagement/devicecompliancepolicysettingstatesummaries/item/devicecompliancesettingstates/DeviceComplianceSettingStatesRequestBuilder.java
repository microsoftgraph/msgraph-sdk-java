...
public class DeviceComplianceSettingStatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceSettingStateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceComplianceSettingStateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceSettingStateCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceSettingState> post(@javax.annotation.Nonnull final DeviceComplianceSettingState body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceComplianceSettingState> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceSettingState>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
