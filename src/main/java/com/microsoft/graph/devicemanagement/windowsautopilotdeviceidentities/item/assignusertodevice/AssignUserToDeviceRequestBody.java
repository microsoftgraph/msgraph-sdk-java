...
public class AssignUserToDeviceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a assignUserToDeviceRequestBody
     */
    @javax.annotation.Nonnull
    public static AssignUserToDeviceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AssignUserToDeviceRequestBody currentObject = this;
