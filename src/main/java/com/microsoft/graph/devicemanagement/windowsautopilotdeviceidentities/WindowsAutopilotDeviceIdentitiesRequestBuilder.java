...
public class WindowsAutopilotDeviceIdentitiesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeviceIdentityCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsAutopilotDeviceIdentityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsAutopilotDeviceIdentityCollectionResponse>();
