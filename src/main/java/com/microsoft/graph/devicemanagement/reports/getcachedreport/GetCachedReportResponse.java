...
public class GetCachedReportResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCachedReportResponse
     */
    @javax.annotation.Nonnull
    public static GetCachedReportResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCachedReportResponse currentObject = this;
