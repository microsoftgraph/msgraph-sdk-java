...
public class GetComplianceSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getComplianceSettingNonComplianceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetComplianceSettingNonComplianceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingNonComplianceReportRequestBody currentObject = this;
