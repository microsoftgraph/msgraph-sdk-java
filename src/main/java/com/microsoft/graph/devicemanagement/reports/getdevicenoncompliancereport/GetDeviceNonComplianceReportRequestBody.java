...
public class GetDeviceNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDeviceNonComplianceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDeviceNonComplianceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceNonComplianceReportRequestBody currentObject = this;
