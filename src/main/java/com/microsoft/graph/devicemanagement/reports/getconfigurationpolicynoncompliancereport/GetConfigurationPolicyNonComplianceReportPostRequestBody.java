...
public class GetConfigurationPolicyNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicyNonComplianceReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyNonComplianceReportPostRequestBody currentObject = this;
