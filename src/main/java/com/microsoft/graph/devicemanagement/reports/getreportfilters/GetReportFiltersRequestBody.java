package microsoft.graph.devicemanagement.reports.getreportfilters;
...
public class GetReportFiltersRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getReportFiltersRequestBody
     */
    @javax.annotation.Nonnull
    public static GetReportFiltersRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetReportFiltersRequestBody currentObject = this;
