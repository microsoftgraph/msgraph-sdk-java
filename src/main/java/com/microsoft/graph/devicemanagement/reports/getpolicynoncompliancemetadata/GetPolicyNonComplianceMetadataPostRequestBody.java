...
public class GetPolicyNonComplianceMetadataPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getPolicyNonComplianceMetadataPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetPolicyNonComplianceMetadataPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetPolicyNonComplianceMetadataPostRequestBody currentObject = this;
