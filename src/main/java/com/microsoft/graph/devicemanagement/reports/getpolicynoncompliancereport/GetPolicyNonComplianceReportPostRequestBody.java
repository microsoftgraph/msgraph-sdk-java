...
public class GetPolicyNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetPolicyNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
