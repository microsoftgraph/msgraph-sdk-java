...
public class GetConfigurationSettingNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationSettingNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationSettingNonComplianceReportPostRequestBody currentObject = this;
