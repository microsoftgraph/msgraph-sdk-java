...
public class GetConfigurationSettingNonComplianceReportResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationSettingNonComplianceReportResponse
     */
    @javax.annotation.Nonnull
    public static GetConfigurationSettingNonComplianceReportResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationSettingNonComplianceReportResponse currentObject = this;
