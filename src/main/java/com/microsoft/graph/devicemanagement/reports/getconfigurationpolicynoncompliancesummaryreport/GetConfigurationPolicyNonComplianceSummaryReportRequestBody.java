...
public class GetConfigurationPolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicyNonComplianceSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyNonComplianceSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyNonComplianceSummaryReportRequestBody currentObject = this;
