...
public class GetDeviceNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetDeviceNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceNonComplianceReportPostRequestBody currentObject = this;
