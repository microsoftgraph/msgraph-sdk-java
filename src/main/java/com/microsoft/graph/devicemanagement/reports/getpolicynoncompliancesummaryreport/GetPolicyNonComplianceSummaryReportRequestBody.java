package microsoft.graph.devicemanagement.reports.getpolicynoncompliancesummaryreport;
...
public class GetPolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getPolicyNonComplianceSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetPolicyNonComplianceSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetPolicyNonComplianceSummaryReportRequestBody currentObject = this;
