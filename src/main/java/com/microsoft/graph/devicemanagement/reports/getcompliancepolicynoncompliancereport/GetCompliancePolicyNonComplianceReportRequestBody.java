...
public class GetCompliancePolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCompliancePolicyNonComplianceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePolicyNonComplianceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyNonComplianceReportRequestBody currentObject = this;
