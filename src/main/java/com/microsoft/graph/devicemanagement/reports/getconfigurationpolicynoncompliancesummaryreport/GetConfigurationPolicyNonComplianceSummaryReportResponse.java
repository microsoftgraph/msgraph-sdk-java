...
public class GetConfigurationPolicyNonComplianceSummaryReportResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a void
     */
    public GetConfigurationPolicyNonComplianceSummaryReportResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getConfigurationPolicyNonComplianceSummaryReportResponse
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyNonComplianceSummaryReportResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyNonComplianceSummaryReportResponse currentObject = this;
