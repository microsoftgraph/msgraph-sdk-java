...
public class GetDeviceManagementIntentPerSettingContributingProfilesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDeviceManagementIntentPerSettingContributingProfilesRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDeviceManagementIntentPerSettingContributingProfilesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceManagementIntentPerSettingContributingProfilesRequestBody currentObject = this;
