...
public class GetPolicyNonComplianceMetadataRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getPolicyNonComplianceMetadataRequestBody
     */
    @javax.annotation.Nonnull
    public static GetPolicyNonComplianceMetadataRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetPolicyNonComplianceMetadataRequestBody currentObject = this;
