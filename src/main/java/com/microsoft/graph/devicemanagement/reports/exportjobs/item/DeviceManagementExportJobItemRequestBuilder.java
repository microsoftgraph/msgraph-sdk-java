...
public class DeviceManagementExportJobItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeviceManagementExportJob body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementExportJob> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementExportJob> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementExportJob>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
