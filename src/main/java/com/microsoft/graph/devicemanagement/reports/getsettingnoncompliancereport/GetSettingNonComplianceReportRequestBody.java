...
public class GetSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getSettingNonComplianceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetSettingNonComplianceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetSettingNonComplianceReportRequestBody currentObject = this;
