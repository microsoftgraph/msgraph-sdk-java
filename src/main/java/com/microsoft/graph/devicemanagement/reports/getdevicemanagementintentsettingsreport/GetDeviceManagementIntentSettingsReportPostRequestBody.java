...
public class GetDeviceManagementIntentSettingsReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDeviceManagementIntentSettingsReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDeviceManagementIntentSettingsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceManagementIntentSettingsReportPostRequestBody currentObject = this;
