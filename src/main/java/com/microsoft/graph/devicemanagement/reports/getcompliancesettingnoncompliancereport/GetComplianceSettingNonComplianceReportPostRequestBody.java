...
public class GetComplianceSettingNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getComplianceSettingNonComplianceReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetComplianceSettingNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingNonComplianceReportPostRequestBody currentObject = this;
