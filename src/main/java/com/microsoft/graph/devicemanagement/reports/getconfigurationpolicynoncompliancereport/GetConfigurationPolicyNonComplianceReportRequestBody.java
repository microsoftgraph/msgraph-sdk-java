...
public class GetConfigurationPolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicyNonComplianceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyNonComplianceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyNonComplianceReportRequestBody currentObject = this;
