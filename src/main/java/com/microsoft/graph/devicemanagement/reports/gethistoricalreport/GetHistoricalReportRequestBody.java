package microsoft.graph.devicemanagement.reports.gethistoricalreport;
...
public class GetHistoricalReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getHistoricalReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetHistoricalReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetHistoricalReportRequestBody currentObject = this;
