...
public class GetSettingNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetSettingNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetSettingNonComplianceReportPostRequestBody currentObject = this;
