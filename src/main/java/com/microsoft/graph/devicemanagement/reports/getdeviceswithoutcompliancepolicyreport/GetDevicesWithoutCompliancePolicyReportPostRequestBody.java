...
public class GetDevicesWithoutCompliancePolicyReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a GetDevicesWithoutCompliancePolicyReportPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GetDevicesWithoutCompliancePolicyReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
