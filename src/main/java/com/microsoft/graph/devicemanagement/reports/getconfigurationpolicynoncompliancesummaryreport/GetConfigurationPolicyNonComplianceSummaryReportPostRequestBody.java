...
public class GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicyNonComplianceSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody currentObject = this;
