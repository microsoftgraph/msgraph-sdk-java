...
public class GetDeviceManagementIntentSettingsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDeviceManagementIntentSettingsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDeviceManagementIntentSettingsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceManagementIntentSettingsReportRequestBody currentObject = this;
