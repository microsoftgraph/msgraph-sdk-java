...
public class GetPolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getPolicyNonComplianceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetPolicyNonComplianceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetPolicyNonComplianceReportRequestBody currentObject = this;
