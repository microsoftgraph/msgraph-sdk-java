...
public class GetReportFiltersPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetReportFiltersPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetReportFiltersPostRequestBody currentObject = this;
