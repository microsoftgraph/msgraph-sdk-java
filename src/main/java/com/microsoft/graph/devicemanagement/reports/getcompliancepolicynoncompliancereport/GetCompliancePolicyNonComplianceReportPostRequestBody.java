...
public class GetCompliancePolicyNonComplianceReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetCompliancePolicyNonComplianceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyNonComplianceReportPostRequestBody currentObject = this;
