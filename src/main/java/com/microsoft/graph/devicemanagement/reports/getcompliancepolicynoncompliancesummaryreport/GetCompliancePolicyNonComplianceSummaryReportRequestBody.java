...
public class GetCompliancePolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCompliancePolicyNonComplianceSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePolicyNonComplianceSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyNonComplianceSummaryReportRequestBody currentObject = this;
