...
public class GetEffectivePermissionsWithScopeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetEffectivePermissionsWithScopeResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetEffectivePermissionsWithScopeResponse> executionException = new java.util.concurrent.CompletableFuture<GetEffectivePermissionsWithScopeResponse>();
