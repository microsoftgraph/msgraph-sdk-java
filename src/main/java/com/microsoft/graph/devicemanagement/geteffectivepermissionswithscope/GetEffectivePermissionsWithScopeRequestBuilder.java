...
public class GetEffectivePermissionsWithScopeRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GetEffectivePermissionsWithScopeResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<GetEffectivePermissionsWithScopeResponse>() {{
    ...
    public class GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public GetEffectivePermissionsWithScopeRequestBuilderGetQueryParameters queryParameters = new GetEffectivePermissionsWithScopeRequestBuilderGetQueryParameters();
        /**
