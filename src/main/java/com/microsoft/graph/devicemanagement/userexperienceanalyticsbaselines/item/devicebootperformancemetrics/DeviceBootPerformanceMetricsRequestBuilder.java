...
public class DeviceBootPerformanceMetricsRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceBootPerformanceMetricsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public DeviceBootPerformanceMetricsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
