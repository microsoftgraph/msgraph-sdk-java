...
public class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function verifyWindowsEnrollmentAutoDiscovery
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function verifyWindowsEnrollmentAutoDiscovery
