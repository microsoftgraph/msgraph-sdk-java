...
public class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a verifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse
     */
    @javax.annotation.Nonnull
    public static VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
