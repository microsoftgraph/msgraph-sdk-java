...
public class DownloadApplePushNotificationCertificateSigningRequestResponse implements AdditionalDataHolder, Parsable {
    ...
    public static DownloadApplePushNotificationCertificateSigningRequestResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
