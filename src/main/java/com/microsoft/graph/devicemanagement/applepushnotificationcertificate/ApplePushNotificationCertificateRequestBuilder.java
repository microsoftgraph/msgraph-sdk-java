...
public class ApplePushNotificationCertificateRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-devices-applepushnotificationcertificate-get?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ApplePushNotificationCertificate> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ApplePushNotificationCertificate> executionException = new java.util.concurrent.CompletableFuture<ApplePushNotificationCertificate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     * @return a CompletableFuture of applePushNotificationCertificate
     * @see <a href="https://docs.microsoft.com/graph/api/intune-devices-applepushnotificationcertificate-update?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final ApplePushNotificationCertificate body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final ApplePushNotificationCertificate body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
