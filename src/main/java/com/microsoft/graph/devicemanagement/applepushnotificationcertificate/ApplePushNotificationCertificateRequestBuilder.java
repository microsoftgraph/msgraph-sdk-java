...
public class ApplePushNotificationCertificateRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ApplePushNotificationCertificate> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ApplePushNotificationCertificate> executionException = new java.util.concurrent.CompletableFuture<ApplePushNotificationCertificate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
