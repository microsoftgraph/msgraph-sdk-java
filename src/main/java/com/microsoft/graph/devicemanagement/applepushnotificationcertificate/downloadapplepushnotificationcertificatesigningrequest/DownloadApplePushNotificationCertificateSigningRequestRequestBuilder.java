...
public class DownloadApplePushNotificationCertificateSigningRequestRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse> executionException = new java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
