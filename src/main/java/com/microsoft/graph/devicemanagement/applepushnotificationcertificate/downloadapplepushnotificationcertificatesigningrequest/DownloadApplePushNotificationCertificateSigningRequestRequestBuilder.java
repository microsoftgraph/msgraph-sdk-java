...
public class DownloadApplePushNotificationCertificateSigningRequestRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse> executionException = new java.util.concurrent.CompletableFuture<DownloadApplePushNotificationCertificateSigningRequestResponse>();
