...
public class MetricDevicesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder byUserExperienceAnalyticsWorkFromAnywhereDeviceId(@javax.annotation.Nonnull final String userExperienceAnalyticsWorkFromAnywhereDeviceId) {
    ...
    public MetricDevicesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public MetricDevicesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDevice> post(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereDevice body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDevice> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDevice>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereDevice> post(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereDevice body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereDevice body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereDevice body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
