...
public class CreateDownloadUrlRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AppLogCollectionDownloadDetails> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AppLogCollectionDownloadDetails> executionException = new java.util.concurrent.CompletableFuture<AppLogCollectionDownloadDetails>();
