...
public class UserExperienceAnalyticsCategoryItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UserExperienceAnalyticsCategoryItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public UserExperienceAnalyticsCategoryItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
