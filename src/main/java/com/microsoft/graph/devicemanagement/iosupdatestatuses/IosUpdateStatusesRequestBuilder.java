...
public class IosUpdateStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IosUpdateDeviceStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IosUpdateDeviceStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IosUpdateDeviceStatusCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<IosUpdateDeviceStatus> post(@javax.annotation.Nonnull final IosUpdateDeviceStatus body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<IosUpdateDeviceStatus> executionException = new java.util.concurrent.CompletableFuture<IosUpdateDeviceStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
