...
public class NotificationMessageTemplateItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final NotificationMessageTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<NotificationMessageTemplate> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<NotificationMessageTemplate> executionException = new java.util.concurrent.CompletableFuture<NotificationMessageTemplate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
