...
public class LocalizedNotificationMessagesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse>();
