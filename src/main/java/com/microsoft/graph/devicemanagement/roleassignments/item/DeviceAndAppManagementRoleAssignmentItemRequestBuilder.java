...
public class DeviceAndAppManagementRoleAssignmentItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment> executionException = new java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
