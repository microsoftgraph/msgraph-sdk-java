...
public class TermsAndConditionsAcceptanceStatusItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TermsAndConditionsAcceptanceStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TermsAndConditionsAcceptanceStatus> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TermsAndConditionsAcceptanceStatus> executionException = new java.util.concurrent.CompletableFuture<TermsAndConditionsAcceptanceStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
