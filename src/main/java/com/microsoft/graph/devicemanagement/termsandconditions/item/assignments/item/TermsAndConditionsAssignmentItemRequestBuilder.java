...
public class TermsAndConditionsAssignmentItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TermsAndConditionsAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TermsAndConditionsAssignment> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TermsAndConditionsAssignment> executionException = new java.util.concurrent.CompletableFuture<TermsAndConditionsAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
