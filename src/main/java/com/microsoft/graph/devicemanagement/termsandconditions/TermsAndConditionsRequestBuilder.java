...
public class TermsAndConditionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TermsAndConditionsCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TermsAndConditionsCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TermsAndConditionsCollectionResponse>();
