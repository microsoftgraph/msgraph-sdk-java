package microsoft.graph.devicemanagement.termsandconditions.item.acceptancestatuses.item.termsandconditions;
...
public class TermsAndConditionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<TermsAndConditionsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @return a CompletableFuture of termsAndConditions
     */
    public java.util.concurrent.CompletableFuture<TermsAndConditions> get(@javax.annotation.Nullable final java.util.function.Consumer<TermsAndConditionsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of termsAndConditions
     */
    public java.util.concurrent.CompletableFuture<TermsAndConditions> get(@javax.annotation.Nullable final java.util.function.Consumer<TermsAndConditionsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public class TermsAndConditionsRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public TermsAndConditionsRequestBuilderGetQueryParameters queryParameters = new TermsAndConditionsRequestBuilderGetQueryParameters();
        /**
