...
public class AssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TermsAndConditionsAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TermsAndConditionsAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TermsAndConditionsAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TermsAndConditionsAssignmentCollectionResponse>();
