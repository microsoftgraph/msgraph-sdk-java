...
public class MobileThreatDefenseConnectorsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse>();
