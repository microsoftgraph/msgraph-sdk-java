...
public class MobileThreatDefenseConnectorItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MobileThreatDefenseConnector> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileThreatDefenseConnector> executionException = new java.util.concurrent.CompletableFuture<MobileThreatDefenseConnector>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
