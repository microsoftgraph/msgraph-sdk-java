...
public class MobileThreatDefenseConnectorItemRequestBuilder {
     ...
     * @return a CompletableFuture of mobileThreatDefenseConnector
     */
    public java.util.concurrent.CompletableFuture<MobileThreatDefenseConnector> patch(@javax.annotation.Nonnull final MobileThreatDefenseConnector body, @javax.annotation.Nullable final java.util.function.Consumer<MobileThreatDefenseConnectorItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
