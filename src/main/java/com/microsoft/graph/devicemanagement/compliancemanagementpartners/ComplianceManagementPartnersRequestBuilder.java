...
public class ComplianceManagementPartnersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ComplianceManagementPartnerCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ComplianceManagementPartnerCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ComplianceManagementPartnerCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ComplianceManagementPartnerCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ComplianceManagementPartnersRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ComplianceManagementPartnerCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of complianceManagementPartner
     */
    public java.util.concurrent.CompletableFuture<ComplianceManagementPartner> post(@javax.annotation.Nonnull final ComplianceManagementPartner body, @javax.annotation.Nullable final java.util.function.Consumer<ComplianceManagementPartnersRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
