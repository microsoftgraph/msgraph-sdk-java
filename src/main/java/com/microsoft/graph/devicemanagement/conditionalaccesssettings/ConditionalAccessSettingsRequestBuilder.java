...
public class ConditionalAccessSettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesConditionalAccessSettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnPremisesConditionalAccessSettings> executionException = new java.util.concurrent.CompletableFuture<OnPremisesConditionalAccessSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
