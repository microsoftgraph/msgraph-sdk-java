...
public class ResourceOperationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ResourceOperationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ResourceOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ResourceOperationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ResourceOperation> post(@javax.annotation.Nonnull final ResourceOperation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ResourceOperation> executionException = new java.util.concurrent.CompletableFuture<ResourceOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
