...
public class ResourceOperationsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-rbac-resourceoperation-list?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ResourceOperationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ResourceOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ResourceOperationCollectionResponse>();
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-rbac-resourceoperation-create?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ResourceOperation> post(@javax.annotation.Nonnull final ResourceOperation body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ResourceOperation> executionException = new java.util.concurrent.CompletableFuture<ResourceOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ResourceOperation body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ResourceOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
