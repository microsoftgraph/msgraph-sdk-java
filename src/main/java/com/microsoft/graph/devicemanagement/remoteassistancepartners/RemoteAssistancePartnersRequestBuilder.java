...
public class RemoteAssistancePartnersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RemoteAssistancePartnerCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RemoteAssistancePartnerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RemoteAssistancePartnerCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<RemoteAssistancePartner> post(@javax.annotation.Nonnull final RemoteAssistancePartner body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RemoteAssistancePartner> executionException = new java.util.concurrent.CompletableFuture<RemoteAssistancePartner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
