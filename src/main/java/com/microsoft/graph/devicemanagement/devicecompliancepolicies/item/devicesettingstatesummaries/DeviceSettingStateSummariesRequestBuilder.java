package microsoft.graph.devicemanagement.devicecompliancepolicies.item.devicesettingstatesummaries;
...
import microsoft.graph.devicemanagement.devicecompliancepolicies.item.devicesettingstatesummaries.count.CountRequestBuilder;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.models.SettingStateDeviceSummary;
import microsoft.graph.models.SettingStateDeviceSummaryCollectionResponse;
...
public class DeviceSettingStateSummariesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SettingStateDeviceSummaryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SettingStateDeviceSummaryCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of SettingStateDeviceSummaryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<SettingStateDeviceSummaryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, SettingStateDeviceSummaryCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of settingStateDeviceSummary
     */
    public java.util.concurrent.CompletableFuture<SettingStateDeviceSummary> post(@javax.annotation.Nonnull final SettingStateDeviceSummary body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
