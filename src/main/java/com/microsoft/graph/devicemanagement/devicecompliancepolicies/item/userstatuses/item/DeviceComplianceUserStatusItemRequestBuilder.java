...
public class DeviceComplianceUserStatusItemRequestBuilder {
     ...
     * @return a CompletableFuture of deviceComplianceUserStatus
     */
    public java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus> patch(@javax.annotation.Nonnull final DeviceComplianceUserStatus body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceComplianceUserStatusItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
