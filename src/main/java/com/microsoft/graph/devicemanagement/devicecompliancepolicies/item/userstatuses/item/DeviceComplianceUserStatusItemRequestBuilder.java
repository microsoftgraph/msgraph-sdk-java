...
public class DeviceComplianceUserStatusItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeviceComplianceUserStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
