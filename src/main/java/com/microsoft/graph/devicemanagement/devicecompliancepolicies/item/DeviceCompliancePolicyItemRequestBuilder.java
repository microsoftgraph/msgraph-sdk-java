...
public class DeviceCompliancePolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of deviceCompliancePolicy
     */
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicy> patch(@javax.annotation.Nonnull final DeviceCompliancePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceCompliancePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of deviceCompliancePolicy
     */
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicy> patch(@javax.annotation.Nonnull final DeviceCompliancePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceCompliancePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
