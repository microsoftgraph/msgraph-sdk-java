...
public class DeviceStatusesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceComplianceDeviceStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceDeviceStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceComplianceDeviceStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceDeviceStatusCollectionResponse>();
