...
public class DeviceManagementPartnersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementPartnerCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementPartnerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementPartnerCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementPartner> post(@javax.annotation.Nonnull final DeviceManagementPartner body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementPartner> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementPartner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
