...
public class RoleDefinitionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RoleDefinitionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RoleDefinitionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RoleDefinitionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<RoleDefinition> post(@javax.annotation.Nonnull final RoleDefinition body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RoleDefinition> executionException = new java.util.concurrent.CompletableFuture<RoleDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
