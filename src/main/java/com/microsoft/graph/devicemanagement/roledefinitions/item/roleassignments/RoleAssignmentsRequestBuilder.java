...
public class RoleAssignmentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-rbac-roleassignment-list?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RoleAssignmentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<RoleAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RoleAssignmentCollectionResponse>();
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-rbac-roleassignment-create?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RoleAssignment> post(@javax.annotation.Nonnull final RoleAssignment body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<RoleAssignment> executionException = new java.util.concurrent.CompletableFuture<RoleAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final RoleAssignment body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final RoleAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
