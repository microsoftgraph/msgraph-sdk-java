...
public class RoleDefinitionRequestBuilder {
     ...
     * @return a CompletableFuture of roleDefinition
     */
    public java.util.concurrent.CompletableFuture<RoleDefinition> get(@javax.annotation.Nullable final java.util.function.Consumer<RoleDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of roleDefinition
     */
    public java.util.concurrent.CompletableFuture<RoleDefinition> get(@javax.annotation.Nullable final java.util.function.Consumer<RoleDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
