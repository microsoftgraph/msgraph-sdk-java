...
public class ImportRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ImportPostResponse
    ...
    public java.util.concurrent.CompletableFuture<ImportPostResponse> post(@jakarta.annotation.Nonnull final ImportPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ImportPostResponse> post(@jakarta.annotation.Nonnull final ImportPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ImportPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Not yet documented
     * @param body The request body
