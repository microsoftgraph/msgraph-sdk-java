...
public class ImportRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ImportPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ImportResponse> post(@javax.annotation.Nonnull final ImportPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ImportResponse> executionException = new java.util.concurrent.CompletableFuture<ImportResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ImportResponse> post(@javax.annotation.Nonnull final ImportPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
