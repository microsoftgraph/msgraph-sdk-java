...
public class ImportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a importRequestBody
     */
    @javax.annotation.Nonnull
    public static ImportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ImportRequestBody currentObject = this;
