...
public class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentityCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentityCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentity> post(@javax.annotation.Nonnull final ImportedWindowsAutopilotDeviceIdentity body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentity> executionException = new java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentity>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
