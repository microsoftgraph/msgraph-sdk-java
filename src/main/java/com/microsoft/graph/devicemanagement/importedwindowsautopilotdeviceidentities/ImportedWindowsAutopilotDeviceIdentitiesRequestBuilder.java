...
public class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentityCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentityCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentity> post(@jakarta.annotation.Nonnull final ImportedWindowsAutopilotDeviceIdentity body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentity> executionException = new java.util.concurrent.CompletableFuture<ImportedWindowsAutopilotDeviceIdentity>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ImportedWindowsAutopilotDeviceIdentity body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ImportedWindowsAutopilotDeviceIdentity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
