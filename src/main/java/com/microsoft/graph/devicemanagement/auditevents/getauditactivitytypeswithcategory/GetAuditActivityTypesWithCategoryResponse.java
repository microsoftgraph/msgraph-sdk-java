...
public class GetAuditActivityTypesWithCategoryResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    ...
    public static GetAuditActivityTypesWithCategoryResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAuditActivityTypesWithCategoryResponse currentObject = this;
