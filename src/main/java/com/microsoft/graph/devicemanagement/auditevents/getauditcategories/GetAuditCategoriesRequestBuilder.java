...
public class GetAuditCategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetAuditCategoriesResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetAuditCategoriesResponse> executionException = new java.util.concurrent.CompletableFuture<GetAuditCategoriesResponse>();
