...
public class GetAuditActivityTypesWithCategoryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetAuditActivityTypesWithCategoryResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetAuditActivityTypesWithCategoryResponse> executionException = new java.util.concurrent.CompletableFuture<GetAuditActivityTypesWithCategoryResponse>();
