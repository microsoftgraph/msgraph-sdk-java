...
public class GetAuditActivityTypesWithCategoryRequestBuilder extends BaseRequestBuilder {
    ...
    public GetAuditActivityTypesWithCategoryRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String category) {
        super(requestAdapter, "{+baseurl}/deviceManagement/auditEvents/getAuditActivityTypes(category='{category}'){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters);
     ...
     */
    @jakarta.annotation.Nullable
    public GetAuditActivityTypesWithCategoryRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/auditEvents/getAuditActivityTypes(category='{category}'){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<GetAuditActivityTypesWithCategoryResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetAuditActivityTypesWithCategoryResponse> executionException = new java.util.concurrent.CompletableFuture<GetAuditActivityTypesWithCategoryResponse>();
