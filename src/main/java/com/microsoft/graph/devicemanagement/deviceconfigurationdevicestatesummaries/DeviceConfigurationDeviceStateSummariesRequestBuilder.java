...
public class DeviceConfigurationDeviceStateSummariesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStateSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStateSummary> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStateSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
