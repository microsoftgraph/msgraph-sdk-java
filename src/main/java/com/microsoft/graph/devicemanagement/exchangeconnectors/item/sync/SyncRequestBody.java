...
import microsoft.graph.models.DeviceManagementExchangeConnectorSyncType;
/** Provides operations to call the sync method.  */
public class SyncRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a syncRequestBody
     */
    @javax.annotation.Nonnull
    public static SyncRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SyncRequestBody currentObject = this;
