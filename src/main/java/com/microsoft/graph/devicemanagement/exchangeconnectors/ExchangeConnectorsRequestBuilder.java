...
public class ExchangeConnectorsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementExchangeConnectorCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementExchangeConnectorCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementExchangeConnectorCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementExchangeConnector> post(@javax.annotation.Nonnull final DeviceManagementExchangeConnector body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementExchangeConnector> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementExchangeConnector>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
