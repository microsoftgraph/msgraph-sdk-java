...
public class TelecomExpenseManagementPartnersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TelecomExpenseManagementPartner body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TelecomExpenseManagementPartnerCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TelecomExpenseManagementPartnerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TelecomExpenseManagementPartnerCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TelecomExpenseManagementPartner> post(@javax.annotation.Nonnull final TelecomExpenseManagementPartner body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TelecomExpenseManagementPartner> executionException = new java.util.concurrent.CompletableFuture<TelecomExpenseManagementPartner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
