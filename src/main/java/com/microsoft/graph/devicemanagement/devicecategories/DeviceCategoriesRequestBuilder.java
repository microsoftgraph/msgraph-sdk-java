package microsoft.graph.devicemanagement.devicecategories;
...
import microsoft.graph.devicemanagement.devicecategories.count.CountRequestBuilder;
import microsoft.graph.models.DeviceCategory;
import microsoft.graph.models.DeviceCategoryCollectionResponse;
...
public class DeviceCategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceCategoryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceCategoryCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DeviceCategoryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DeviceCategoryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceCategoriesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceCategoryCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of deviceCategory
     */
    public java.util.concurrent.CompletableFuture<DeviceCategory> post(@javax.annotation.Nonnull final DeviceCategory body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceCategoriesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
