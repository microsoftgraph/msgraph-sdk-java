...
public class DeviceCategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceCategoryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceCategoryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceCategoryCollectionResponse>();
