package microsoft.graph.devicemanagement.windowsinformationprotectionapplearningsummaries;
...
import microsoft.graph.devicemanagement.windowsinformationprotectionapplearningsummaries.count.CountRequestBuilder;
...
public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummaryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, WindowsInformationProtectionAppLearningSummaryCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of WindowsInformationProtectionAppLearningSummaryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummaryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<WindowsInformationProtectionAppLearningSummariesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, WindowsInformationProtectionAppLearningSummaryCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
