...
public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummaryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummaryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummary> post(@javax.annotation.Nonnull final WindowsInformationProtectionAppLearningSummary body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummary> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLearningSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
