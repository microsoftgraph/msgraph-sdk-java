...
public class DetectedAppsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DetectedApp body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DetectedAppCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DetectedAppCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DetectedAppCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DetectedApp> post(@javax.annotation.Nonnull final DetectedApp body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DetectedApp> executionException = new java.util.concurrent.CompletableFuture<DetectedApp>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
