...
public class SoftwareUpdateStatusSummaryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SoftwareUpdateStatusSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SoftwareUpdateStatusSummary> executionException = new java.util.concurrent.CompletableFuture<SoftwareUpdateStatusSummary>();
