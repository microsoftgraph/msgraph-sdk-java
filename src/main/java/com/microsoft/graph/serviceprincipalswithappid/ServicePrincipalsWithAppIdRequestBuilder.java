...
public class ServicePrincipalsWithAppIdRequestBuilder extends BaseRequestBuilder {
    ...
    public ServicePrincipalsWithAppIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String appId) {
     ...
     */
    @javax.annotation.Nullable
    public ServicePrincipalsWithAppIdRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
