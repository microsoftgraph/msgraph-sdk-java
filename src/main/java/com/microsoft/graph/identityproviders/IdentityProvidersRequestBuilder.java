...
public class IdentityProvidersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IdentityProviderCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityProviderCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IdentityProviderCollectionResponse>();
