package microsoft.graph.identityproviders;
...
import microsoft.graph.identityproviders.availableprovidertypes.AvailableProviderTypesRequestBuilder;
import microsoft.graph.identityproviders.count.CountRequestBuilder;
...
public class IdentityProvidersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final IdentityProvider body) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IdentityProviderCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, IdentityProviderCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<IdentityProviderCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<IdentityProvidersRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, IdentityProviderCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of identityProvider
     */
    public java.util.concurrent.CompletableFuture<IdentityProvider> post(@javax.annotation.Nonnull final IdentityProvider body, @javax.annotation.Nullable final java.util.function.Consumer<IdentityProvidersRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
