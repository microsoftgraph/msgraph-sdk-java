package com.microsoft.graph.policies.authorizationpolicy;
...
public class AuthorizationPolicyRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AuthorizationPolicyRequestBuilder} and sets the default values.
    ...
    public AuthorizationPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/authorizationPolicy{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AuthorizationPolicyRequestBuilder} and sets the default values.
    ...
    public AuthorizationPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/authorizationPolicy{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public AuthorizationPolicy get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public AuthorizationPolicy patch(@jakarta.annotation.Nonnull final AuthorizationPolicy body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AuthorizationPolicy patch(@jakarta.annotation.Nonnull final AuthorizationPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/policies/authorizationPolicy", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AuthorizationPolicy body) {
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AuthorizationPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/policies/authorizationPolicy", pathParameters);
