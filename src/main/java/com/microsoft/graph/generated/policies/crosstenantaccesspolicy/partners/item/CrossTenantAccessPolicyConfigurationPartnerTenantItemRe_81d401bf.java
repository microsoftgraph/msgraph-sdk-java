...
public class CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf extends BaseRequestBuilder {
    /**
     ...
     * @return a {@link IdentitySynchronizationRequestBuilder}
     */
    ...
    /**
     * Instantiates a new {@link CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}", pathParameters);
    }
    /**
     * Instantiates a new {@link CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf(rawUrl, requestAdapter);
    }
    /**
