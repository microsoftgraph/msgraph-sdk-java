...
public class PermissionGrantConditionSetItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link PermissionGrantConditionSetItemRequestBuilder} and sets the default values.
    ...
    public PermissionGrantConditionSetItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes/{permissionGrantConditionSet%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionGrantConditionSetItemRequestBuilder} and sets the default values.
    ...
    public PermissionGrantConditionSet get() {
        return get(null);
    }
    /**
     * Condition sets which are excluded in this permission grant policy. Automatically expanded on GET.
     ...
     */
    @jakarta.annotation.Nullable
    public PermissionGrantConditionSet get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public PermissionGrantConditionSet patch(@jakarta.annotation.Nonnull final PermissionGrantConditionSet body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PermissionGrantConditionSet patch(@jakarta.annotation.Nonnull final PermissionGrantConditionSet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes/{permissionGrantConditionSet%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PermissionGrantConditionSet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes/{permissionGrantConditionSet%2Did}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link PermissionGrantConditionSetItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public PermissionGrantConditionSetItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
