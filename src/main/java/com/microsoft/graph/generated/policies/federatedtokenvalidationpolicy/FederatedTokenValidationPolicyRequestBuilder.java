package com.microsoft.graph.policies.federatedtokenvalidationpolicy;
...
public class FederatedTokenValidationPolicyRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link FederatedTokenValidationPolicyRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public FederatedTokenValidationPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/federatedTokenValidationPolicy{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link FederatedTokenValidationPolicyRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public FederatedTokenValidationPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/federatedTokenValidationPolicy{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final FederatedTokenValidationPolicy body) {
