...
/**
 * The interface for the Base Workbook Worksheet Protection Protect Request Builder.
 */
public interface IBaseWorkbookWorksheetProtectionProtectRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookWorksheetProtectionProtectRequest instance
     */
    IWorkbookWorksheetProtectionProtectRequest buildRequest(final java.util.List<Option> requestOptions);
}
