...
public class VerifyRequestBuilder extends BaseRequestBuilder {
    ...
    public Domain post(@jakarta.annotation.Nonnull final VerifyPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Domain post(@jakarta.annotation.Nonnull final VerifyPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
