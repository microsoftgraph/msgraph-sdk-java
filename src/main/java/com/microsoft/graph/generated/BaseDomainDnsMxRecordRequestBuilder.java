...
public class BaseDomainDnsMxRecordRequestBuilder extends BaseRequestBuilder implements IBaseDomainDnsMxRecordRequestBuilder {
     ...
     */
    public BaseDomainDnsMxRecordRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IDomainDnsMxRecordRequest buildRequest(final java.util.List<Option> requestOptions) {
