package com.microsoft.graph.users.item.events.item.instances.item.exceptionoccurrences;

import com.microsoft.graph.models.EventCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.events.item.instances.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.users.item.events.item.instances.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.events.item.instances.item.exceptionoccurrences.item.EventItemRequestBuilder;
...
public class ExceptionOccurrencesRequestBuilder extends BaseRequestBuilder {
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExceptionOccurrencesRequestBuilder} and sets the default values.
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
