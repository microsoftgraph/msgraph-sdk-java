package com.microsoft.graph.users.item.calendarview.item.exceptionoccurrences;

import com.microsoft.graph.models.EventCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.calendarview.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.users.item.calendarview.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.calendarview.item.exceptionoccurrences.item.EventItemRequestBuilder;
...
public class ExceptionOccurrencesRequestBuilder extends BaseRequestBuilder {
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExceptionOccurrencesRequestBuilder} and sets the default values.
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
