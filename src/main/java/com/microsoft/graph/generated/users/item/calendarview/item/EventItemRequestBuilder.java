...
import com.microsoft.graph.users.item.calendarview.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
...
import com.microsoft.graph.users.item.calendarview.item.permanentdelete.PermanentDeleteRequestBuilder;
...
public class EventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24expand,%24select}", rawUrl);
    }
    /**
