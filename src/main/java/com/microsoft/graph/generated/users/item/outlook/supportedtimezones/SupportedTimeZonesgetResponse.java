...
public class SupportedTimeZonesgetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link SupportedTimeZonesgetResponse} and sets the default values.
     */
    ...
    public static SupportedTimeZonesgetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
