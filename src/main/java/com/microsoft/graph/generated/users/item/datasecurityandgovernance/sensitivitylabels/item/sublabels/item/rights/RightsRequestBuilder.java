package com.microsoft.graph.users.item.datasecurityandgovernance.sensitivitylabels.item.sublabels.item.rights;
...
public class RightsRequestBuilder extends BaseRequestBuilder {
    ...
    public RightsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}/rights{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RightsRequestBuilder} and sets the default values.
    ...
    public RightsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}/rights{?%24expand,%24select}", rawUrl);
    }
    /**
