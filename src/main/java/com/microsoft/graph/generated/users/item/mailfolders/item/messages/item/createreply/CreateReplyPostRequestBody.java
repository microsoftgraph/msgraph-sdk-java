package com.microsoft.graph.users.item.mailfolders.item.messages.item.createreply;
...
public class CreateReplyPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CreateReplyPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CreateReplyPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CreateReplyPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
