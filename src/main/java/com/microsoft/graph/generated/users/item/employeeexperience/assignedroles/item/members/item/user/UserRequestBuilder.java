package com.microsoft.graph.users.item.employeeexperience.assignedroles.item.members.item.user;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.User;
import com.microsoft.graph.users.item.employeeexperience.assignedroles.item.members.item.user.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.users.item.employeeexperience.assignedroles.item.members.item.user.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserRequestBuilder extends BaseRequestBuilder {
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}/user{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserRequestBuilder} and sets the default values.
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}/user{?%24expand,%24select}", rawUrl);
    }
    /**
