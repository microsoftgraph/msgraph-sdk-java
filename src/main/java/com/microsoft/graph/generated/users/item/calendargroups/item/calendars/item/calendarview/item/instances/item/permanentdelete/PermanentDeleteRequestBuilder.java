package com.microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.instances.item.permanentdelete;
...
public class PermanentDeleteRequestBuilder extends BaseRequestBuilder {
    ...
    public PermanentDeleteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/permanentDelete", pathParameters);
    }
    /**
     * Instantiates a new {@link PermanentDeleteRequestBuilder} and sets the default values.
    ...
    public PermanentDeleteRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/permanentDelete", rawUrl);
    }
    /**
