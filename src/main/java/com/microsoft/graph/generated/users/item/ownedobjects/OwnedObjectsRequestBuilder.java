package com.microsoft.graph.users.item.ownedobjects;

import com.microsoft.graph.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.ownedobjects.count.CountRequestBuilder;
...
public class OwnedObjectsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link OwnedObjectsRequestBuilder} and sets the default values.
    ...
    public OwnedObjectsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedObjects{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link OwnedObjectsRequestBuilder} and sets the default values.
    ...
    public OwnedObjectsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedObjects{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-list-ownedobjects?view=graph-rest-1.0">Find more info here</a>
     */
