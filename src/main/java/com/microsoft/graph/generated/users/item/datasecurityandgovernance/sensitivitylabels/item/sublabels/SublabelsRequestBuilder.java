package com.microsoft.graph.users.item.datasecurityandgovernance.sensitivitylabels.item.sublabels;
...
import com.microsoft.graph.users.item.datasecurityandgovernance.sensitivitylabels.item.sublabels.computeinheritancewithlabelidswithlocalewithcontentformats.ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e;
...
import com.microsoft.graph.users.item.datasecurityandgovernance.sensitivitylabels.item.sublabels.count.CountRequestBuilder;
import com.microsoft.graph.users.item.datasecurityandgovernance.sensitivitylabels.item.sublabels.item.SensitivityLabelItemRequestBuilder;
...
public class SublabelsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SensitivityLabel body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels", pathParameters);
