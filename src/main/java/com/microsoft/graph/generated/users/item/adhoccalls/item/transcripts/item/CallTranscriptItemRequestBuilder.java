package com.microsoft.graph.users.item.adhoccalls.item.transcripts.item;

import com.microsoft.graph.models.CallTranscript;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.adhoccalls.item.transcripts.item.content.ContentRequestBuilder;
import com.microsoft.graph.users.item.adhoccalls.item.transcripts.item.metadatacontent.MetadataContentRequestBuilder;
...
public class CallTranscriptItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CallTranscriptItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/adhocCalls/{adhocCall%2Did}/transcripts/{callTranscript%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link CallTranscriptItemRequestBuilder} and sets the default values.
    ...
    public CallTranscriptItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/adhocCalls/{adhocCall%2Did}/transcripts/{callTranscript%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/adhocCalls/{adhocCall%2Did}/transcripts/{callTranscript%2Did}{?%24expand,%24select}", pathParameters);
