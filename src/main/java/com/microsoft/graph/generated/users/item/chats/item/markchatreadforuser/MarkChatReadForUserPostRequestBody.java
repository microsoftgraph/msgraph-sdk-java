...
public class MarkChatReadForUserPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MarkChatReadForUserPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link MarkChatReadForUserPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static MarkChatReadForUserPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
