package com.microsoft.graph.users.item.chats.item.targetedmessages.item.replies.item.undosoftdelete;
...
public class UndoSoftDeleteRequestBuilder extends BaseRequestBuilder {
    ...
    public UndoSoftDeleteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/replies/{chatMessage%2Did}/undoSoftDelete", pathParameters);
    }
    /**
     * Instantiates a new {@link UndoSoftDeleteRequestBuilder} and sets the default values.
    ...
    public UndoSoftDeleteRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/replies/{chatMessage%2Did}/undoSoftDelete", rawUrl);
    }
    /**
