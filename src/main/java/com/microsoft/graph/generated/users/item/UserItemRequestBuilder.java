...
import com.microsoft.graph.users.item.datasecurityandgovernance.DataSecurityAndGovernanceRequestBuilder;
...
public class UserItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}{?%24expand,%24select}", pathParameters);
