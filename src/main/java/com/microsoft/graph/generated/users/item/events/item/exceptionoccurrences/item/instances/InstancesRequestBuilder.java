package com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.instances;

import com.microsoft.graph.models.EventCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.instances.count.CountRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.instances.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.instances.item.EventItemRequestBuilder;
