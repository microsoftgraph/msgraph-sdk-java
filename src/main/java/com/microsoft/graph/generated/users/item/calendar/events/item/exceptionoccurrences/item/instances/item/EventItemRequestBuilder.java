package com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item;

import com.microsoft.graph.models.Event;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EventItemRequestBuilder} and sets the default values.
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24expand,%24select}", rawUrl);
    }
    /**
