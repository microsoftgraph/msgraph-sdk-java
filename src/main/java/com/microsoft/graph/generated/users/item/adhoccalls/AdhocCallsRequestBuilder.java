package com.microsoft.graph.users.item.adhoccalls;
...
public class AdhocCallsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     * @return a {@link AdhocCallItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public AdhocCallItemRequestBuilder byAdhocCallId(@jakarta.annotation.Nonnull final String adhocCallId) {
        Objects.requireNonNull(adhocCallId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("adhocCall%2Did", adhocCallId);
        return new AdhocCallItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     * @return a {@link AdhocCallCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public AdhocCallCollectionResponse get() {
        return get(null);
    }
    /**
     * Ad hoc calls associated with the user. Read-only. Nullable.
     ...
     */
    @jakarta.annotation.Nullable
    public AdhocCallCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AdhocCallCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public AdhocCall post(@jakarta.annotation.Nonnull final AdhocCall body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AdhocCall post(@jakarta.annotation.Nonnull final AdhocCall body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AdhocCall::createFromDiscriminatorValue);
    }
    /**
     * Ad hoc calls associated with the user. Read-only. Nullable.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/adhocCalls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AdhocCall body) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AdhocCall body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/adhocCalls", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public AdhocCallsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new AdhocCallsRequestBuilder(rawUrl, requestAdapter);
    }
    /**
     * Ad hoc calls associated with the user. Read-only. Nullable.
     */
