...
public class CreateReplyAllPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link CreateReplyAllPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CreateReplyAllPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CreateReplyAllPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
