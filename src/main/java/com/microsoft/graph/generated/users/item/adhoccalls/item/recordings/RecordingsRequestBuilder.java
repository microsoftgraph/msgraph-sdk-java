package com.microsoft.graph.users.item.adhoccalls.item.recordings;
...
import com.microsoft.graph.users.item.adhoccalls.item.recordings.count.CountRequestBuilder;
import com.microsoft.graph.users.item.adhoccalls.item.recordings.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.adhoccalls.item.recordings.item.CallRecordingItemRequestBuilder;
