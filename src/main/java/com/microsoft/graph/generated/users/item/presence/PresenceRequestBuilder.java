...
import com.microsoft.graph.users.item.presence.clearautomaticlocation.ClearAutomaticLocationRequestBuilder;
import com.microsoft.graph.users.item.presence.clearlocation.ClearLocationRequestBuilder;
...
import com.microsoft.graph.users.item.presence.setautomaticlocation.SetAutomaticLocationRequestBuilder;
import com.microsoft.graph.users.item.presence.setmanuallocation.SetManualLocationRequestBuilder;
...
public class PresenceRequestBuilder extends BaseRequestBuilder {
    ...
    public PresenceRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/presence", pathParameters);
    }
    /**
     * Instantiates a new {@link PresenceRequestBuilder} and sets the default values.
    ...
    public PresenceRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/presence", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/presence{?%24expand,%24select}", pathParameters);
