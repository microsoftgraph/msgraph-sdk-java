...
import com.microsoft.graph.users.item.joinedteams.item.channels.item.allmembers.AllMembersRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.channels.item.archive.ArchiveRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.channels.item.completemigration.CompleteMigrationRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.channels.item.doesuserhaveaccessuseriduseridtenantidtenantiduserprinc_363088ef.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrinc_40d13b0e;
import com.microsoft.graph.users.item.joinedteams.item.channels.item.enabledapps.EnabledAppsRequestBuilder;
...
import com.microsoft.graph.users.item.joinedteams.item.channels.item.startmigration.StartMigrationRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.channels.item.tabs.TabsRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.channels.item.unarchive.UnarchiveRequestBuilder;
...
public class ChannelItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ChannelItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChannelItemRequestBuilder} and sets the default values.
    ...
    public ChannelItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}{?%24expand,%24select}", pathParameters);
