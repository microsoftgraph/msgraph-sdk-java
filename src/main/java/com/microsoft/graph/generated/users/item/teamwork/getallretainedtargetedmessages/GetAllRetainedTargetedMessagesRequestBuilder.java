package com.microsoft.graph.users.item.teamwork.getallretainedtargetedmessages;
...
public class GetAllRetainedTargetedMessagesRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetAllRetainedTargetedMessagesRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetAllRetainedTargetedMessagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/teamwork/getAllRetainedTargetedMessages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllRetainedTargetedMessagesRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetAllRetainedTargetedMessagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetAllRetainedTargetedMessagesRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
