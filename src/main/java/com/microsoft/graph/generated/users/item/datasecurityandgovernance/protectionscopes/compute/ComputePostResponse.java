...
public class ComputePostResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * @return a {@link java.util.List<PolicyUserScope>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<PolicyUserScope> getValue() {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<PolicyUserScope> value) {
