...
import com.microsoft.graph.users.item.joinedteams.item.primarychannel.doesuserhaveaccessuseriduseridtenantidtenantiduserprinc_363088ef.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrinc_40d13b0e;
import com.microsoft.graph.users.item.joinedteams.item.primarychannel.enabledapps.EnabledAppsRequestBuilder;
...
import com.microsoft.graph.users.item.joinedteams.item.primarychannel.startmigration.StartMigrationRequestBuilder;
...
public class PrimaryChannelRequestBuilder extends BaseRequestBuilder {
    ...
    public PrimaryChannelRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel", pathParameters);
    }
    /**
     * Instantiates a new {@link PrimaryChannelRequestBuilder} and sets the default values.
    ...
    public PrimaryChannelRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24expand,%24select}", pathParameters);
