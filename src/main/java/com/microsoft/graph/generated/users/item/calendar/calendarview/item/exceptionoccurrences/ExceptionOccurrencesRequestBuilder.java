package com.microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences;

import com.microsoft.graph.models.EventCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.item.EventItemRequestBuilder;
