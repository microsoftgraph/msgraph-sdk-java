...
public class EndBreakRequestBuilder extends BaseRequestBuilder {
    ...
    public EndBreakRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeCards/{timeCard%2Did}/endBreak", pathParameters);
    }
    /**
     * Instantiates a new {@link EndBreakRequestBuilder} and sets the default values.
    ...
    public EndBreakRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeCards/{timeCard%2Did}/endBreak", rawUrl);
    }
    /**
