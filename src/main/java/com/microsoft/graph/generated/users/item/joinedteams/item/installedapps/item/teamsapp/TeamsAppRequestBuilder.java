package com.microsoft.graph.users.item.joinedteams.item.installedapps.item.teamsapp;
...
public class TeamsAppRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamsAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsAppRequestBuilder} and sets the default values.
    ...
    public TeamsAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24expand,%24select}", rawUrl);
    }
    /**
