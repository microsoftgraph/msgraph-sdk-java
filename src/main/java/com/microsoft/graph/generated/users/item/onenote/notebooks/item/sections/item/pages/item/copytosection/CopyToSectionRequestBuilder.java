package com.microsoft.graph.users.item.onenote.notebooks.item.sections.item.pages.item.copytosection;
...
public class CopyToSectionRequestBuilder extends BaseRequestBuilder {
    ...
    public CopyToSectionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/copyToSection", pathParameters);
    }
    /**
     * Instantiates a new {@link CopyToSectionRequestBuilder} and sets the default values.
    ...
    public CopyToSectionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/copyToSection", rawUrl);
    }
    /**
