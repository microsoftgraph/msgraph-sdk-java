...
/**
 * The class for the Base Workbook Chart Axis Title Request Builder.
 */
public class BaseWorkbookChartAxisTitleRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartAxisTitleRequestBuilder {
     ...
     */
    public BaseWorkbookChartAxisTitleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartAxisTitleRequest buildRequest(final java.util.List<Option> requestOptions) {
