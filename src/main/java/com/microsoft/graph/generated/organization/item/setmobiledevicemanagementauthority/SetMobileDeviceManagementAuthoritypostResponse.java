...
public class SetMobileDeviceManagementAuthoritypostResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SetMobileDeviceManagementAuthoritypostResponse} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static SetMobileDeviceManagementAuthoritypostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
