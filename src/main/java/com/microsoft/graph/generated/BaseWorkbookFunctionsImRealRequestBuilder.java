...
public class BaseWorkbookFunctionsImRealRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImRealRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImRealRequest instance
     */
    public IWorkbookFunctionsImRealRequest buildRequest(final java.util.List<Option> requestOptions) {
