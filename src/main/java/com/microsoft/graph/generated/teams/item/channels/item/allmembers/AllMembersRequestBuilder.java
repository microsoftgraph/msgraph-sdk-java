package com.microsoft.graph.teams.item.channels.item.allmembers;

import com.microsoft.graph.models.ConversationMember;
import com.microsoft.graph.models.ConversationMemberCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teams.item.channels.item.allmembers.add.AddRequestBuilder;
import com.microsoft.graph.teams.item.channels.item.allmembers.count.CountRequestBuilder;
import com.microsoft.graph.teams.item.channels.item.allmembers.item.ConversationMemberItemRequestBuilder;
import com.microsoft.graph.teams.item.channels.item.allmembers.remove.RemoveRequestBuilder;
...
public class AllMembersRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public AllMembersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/allMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConversationMember body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/allMembers", pathParameters);
