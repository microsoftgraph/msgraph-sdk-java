package com.microsoft.graph.teams.item.schedule.timecards.clockin;
...
public class ClockInRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ClockInRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/timeCards/clockIn", pathParameters);
    }
    /**
     * Instantiates a new {@link ClockInRequestBuilder} and sets the default values.
    ...
    public ClockInRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/timeCards/clockIn", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public TimeCard post(@jakarta.annotation.Nonnull final ClockInPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ClockInPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
