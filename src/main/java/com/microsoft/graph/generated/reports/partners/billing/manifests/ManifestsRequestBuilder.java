...
public class ManifestsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ManifestsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/partners/billing/manifests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Manifest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/reports/partners/billing/manifests", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ManifestsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
