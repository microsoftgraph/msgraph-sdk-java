...
public class PrintUsageByUserItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link PrintUsageByUserItemRequestBuilder} and sets the default values.
    ...
    public PrintUsageByUserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/dailyPrintUsageByUser/{printUsageByUser%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrintUsageByUserItemRequestBuilder} and sets the default values.
    ...
    public PrintUsageByUserItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/dailyPrintUsageByUser/{printUsageByUser%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public PrintUsageByUser patch(@jakarta.annotation.Nonnull final PrintUsageByUser body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PrintUsageByUser patch(@jakarta.annotation.Nonnull final PrintUsageByUser body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/reports/dailyPrintUsageByUser/{printUsageByUser%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PrintUsageByUser body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/reports/dailyPrintUsageByUser/{printUsageByUser%2Did}", pathParameters);
