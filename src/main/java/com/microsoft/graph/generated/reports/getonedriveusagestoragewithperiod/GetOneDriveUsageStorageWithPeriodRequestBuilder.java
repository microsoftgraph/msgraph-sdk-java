...
public class GetOneDriveUsageStorageWithPeriodRequestBuilder extends BaseRequestBuilder {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetOneDriveUsageStorageWithPeriodRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetOneDriveUsageStorageWithPeriodRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
