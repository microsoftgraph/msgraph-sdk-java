package com.microsoft.graph.reports.partners.billing.usage.unbilled.microsoftgraphpartnersbillingexport;
...
public class MicrosoftGraphPartnersBillingExportRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphPartnersBillingExportRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/partners/billing/usage/unbilled/microsoft.graph.partners.billing.export", pathParameters);
    }
    /**
     * Instantiates a new MicrosoftGraphPartnersBillingExportRequestBuilder and sets the default values.
     ...
     * @return a Operation
     * @see <a href="https://learn.microsoft.com/graph/api/partners-billing-unbilledusage-export?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MicrosoftGraphPartnersBillingExportRequestBuilder
     */
    @jakarta.annotation.Nonnull
