package com.microsoft.graph.reports.authenticationmethods.usersregisteredbymethodwithincludedusertypeswithinclude_94b5abcf;
...
public class UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb(rawUrl, requestAdapter);
    }
    /**
