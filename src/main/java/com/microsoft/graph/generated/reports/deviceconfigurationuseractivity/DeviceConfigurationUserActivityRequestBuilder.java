...
public class DeviceConfigurationUserActivityRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link DeviceConfigurationUserActivityRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nonnull
    public DeviceConfigurationUserActivityRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
