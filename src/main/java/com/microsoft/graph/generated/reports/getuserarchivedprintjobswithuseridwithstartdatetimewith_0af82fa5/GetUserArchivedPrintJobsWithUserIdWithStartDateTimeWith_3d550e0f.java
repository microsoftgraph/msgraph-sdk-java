...
public class GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_3d550e0f extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_3d550e0f} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_3d550e0f(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_8f118200 get() {
        return get(null);
    }
    /**
     * Get a list of archived print jobs for a particular user.
     ...
     */
    @jakarta.annotation.Nullable
    public GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_8f118200 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_8f118200::createFromDiscriminatorValue);
    }
    /**
     * Get a list of archived print jobs for a particular user.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_3d550e0f withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWith_3d550e0f(rawUrl, requestAdapter);
    }
    /**
     * Get a list of archived print jobs for a particular user.
     */
