...
/**
 * The class for the Base Workbook Range Rows Below Request.
 */
public class BaseWorkbookRangeRowsBelowRequest extends BaseRequest implements IBaseWorkbookRangeRowsBelowRequest {
     ...
     */
    public BaseWorkbookRangeRowsBelowRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
