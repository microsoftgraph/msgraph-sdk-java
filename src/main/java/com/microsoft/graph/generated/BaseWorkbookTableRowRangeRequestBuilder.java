...
public class BaseWorkbookTableRowRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableRowRangeRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableRowRangeRequest instance
     */
    public IWorkbookTableRowRangeRequest buildRequest(final java.util.List<Option> requestOptions) {
