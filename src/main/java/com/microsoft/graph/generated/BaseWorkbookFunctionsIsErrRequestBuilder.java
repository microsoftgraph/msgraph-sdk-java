...
public class BaseWorkbookFunctionsIsErrRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsErrRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement value) {
     ...
     * @return The IWorkbookFunctionsIsErrRequest instance
     */
    public IWorkbookFunctionsIsErrRequest buildRequest(final java.util.List<Option> requestOptions) {
