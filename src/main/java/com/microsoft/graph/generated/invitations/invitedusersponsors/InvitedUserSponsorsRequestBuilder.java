...
public class InvitedUserSponsorsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public InvitedUserSponsorsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
