package com.microsoft.graph.solutions.backuprestore.restoresessions.item.activate;
...
public class ActivateRequestBuilder extends BaseRequestBuilder {
    ...
    public ActivateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/restoreSessions/{restoreSessionBase%2Did}/activate", pathParameters);
    }
    /**
     * Instantiates a new {@link ActivateRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/restoresessionbase-activate?view=graph-rest-1.0">Find more info here</a>
     */
