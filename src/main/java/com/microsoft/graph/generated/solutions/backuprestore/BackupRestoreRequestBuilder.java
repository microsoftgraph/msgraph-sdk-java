...
import com.microsoft.graph.solutions.backuprestore.browsesessions.BrowseSessionsRequestBuilder;
...
import com.microsoft.graph.solutions.backuprestore.onedriveforbusinessbrowsesessions.OneDriveForBusinessBrowseSessionsRequestBuilder;
...
import com.microsoft.graph.solutions.backuprestore.sharepointbrowsesessions.SharePointBrowseSessionsRequestBuilder;
...
public class BackupRestoreRequestBuilder extends BaseRequestBuilder {
    ...
    public BackupRestoreRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore", pathParameters);
    }
    /**
     * Instantiates a new {@link BackupRestoreRequestBuilder} and sets the default values.
    ...
    public BackupRestoreRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore{?%24expand,%24select}", pathParameters);
