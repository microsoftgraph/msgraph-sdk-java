package com.microsoft.graph.solutions.virtualevents.townhalls.item.registrationswithemail;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.VirtualEventRegistration;
import com.microsoft.graph.solutions.virtualevents.townhalls.item.registrationswithemail.cancel.CancelRequestBuilder;
...
public class RegistrationsWithEmailRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrationsWithEmailRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String email) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email='{email}'){?%24expand,%24select}", pathParameters);
    ...
    public RegistrationsWithEmailRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email='{email}'){?%24expand,%24select}", rawUrl);
    }
    /**
