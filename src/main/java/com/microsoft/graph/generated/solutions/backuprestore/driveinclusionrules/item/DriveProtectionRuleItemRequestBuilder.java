package com.microsoft.graph.solutions.backuprestore.driveinclusionrules.item;
...
public class DriveProtectionRuleItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveProtectionRuleItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/driveInclusionRules/{driveProtectionRule%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveProtectionRuleItemRequestBuilder} and sets the default values.
    ...
    public DriveProtectionRuleItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/driveInclusionRules/{driveProtectionRule%2Did}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DriveProtectionRule patch(@jakarta.annotation.Nonnull final DriveProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DriveProtectionRule patch(@jakarta.annotation.Nonnull final DriveProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/driveInclusionRules/{driveProtectionRule%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DriveProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DriveProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
