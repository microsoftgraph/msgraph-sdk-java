package com.microsoft.graph.solutions.virtualevents.townhalls.item.registrations.item.sessions;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.VirtualEventSessionCollectionResponse;
import com.microsoft.graph.solutions.virtualevents.townhalls.item.registrations.item.sessions.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.townhalls.item.registrations.item.sessions.item.VirtualEventSessionItemRequestBuilder;
...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations/{virtualEventRegistration%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SessionsRequestBuilder} and sets the default values.
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations/{virtualEventRegistration%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
