...
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.sessions.SessionsRequestBuilder;
...
public class VirtualEventRegistrationItemRequestBuilder extends BaseRequestBuilder {
    ...
    public VirtualEventRegistrationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link VirtualEventRegistrationItemRequestBuilder} and sets the default values.
    ...
    public VirtualEventRegistrationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}{?%24expand,%24select}", pathParameters);
