package com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions.item.siterestoreartifacts.item.restorepoint;
...
public class RestorePointRequestBuilder extends BaseRequestBuilder {
    ...
    public RestorePointRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions/{sharePointRestoreSession%2Did}/siteRestoreArtifacts/{siteRestoreArtifact%2Did}/restorePoint{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RestorePointRequestBuilder} and sets the default values.
    ...
    public RestorePointRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions/{sharePointRestoreSession%2Did}/siteRestoreArtifacts/{siteRestoreArtifact%2Did}/restorePoint{?%24expand,%24select}", rawUrl);
    }
    /**
