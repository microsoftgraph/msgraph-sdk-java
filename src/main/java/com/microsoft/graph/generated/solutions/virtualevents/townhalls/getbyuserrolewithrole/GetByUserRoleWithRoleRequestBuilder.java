package com.microsoft.graph.solutions.virtualevents.townhalls.getbyuserrolewithrole;
...
public class GetByUserRoleWithRoleRequestBuilder extends BaseRequestBuilder {
    ...
    public GetByUserRoleWithRoleRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/getByUserRole(role='{role}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/virtualeventtownhall-getbyuserrole?view=graph-rest-1.0">Find more info here</a>
     */
