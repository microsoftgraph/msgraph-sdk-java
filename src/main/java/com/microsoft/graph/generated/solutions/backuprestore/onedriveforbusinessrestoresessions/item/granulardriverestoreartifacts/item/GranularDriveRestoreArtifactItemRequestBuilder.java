package com.microsoft.graph.solutions.backuprestore.onedriveforbusinessrestoresessions.item.granulardriverestoreartifacts.item;

import com.microsoft.graph.models.GranularDriveRestoreArtifact;
...
public class GranularDriveRestoreArtifactItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public GranularDriveRestoreArtifact get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GranularDriveRestoreArtifact::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessRestoreSessions/{oneDriveForBusinessRestoreSession%2Did}/granularDriveRestoreArtifacts/{granularDriveRestoreArtifact%2Did}{?%24expand,%24select}", pathParameters);
