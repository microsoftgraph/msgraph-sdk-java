package com.microsoft.graph.solutions.backuprestore.siteinclusionrules.item;
...
public class SiteProtectionRuleItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SiteProtectionRuleItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/siteInclusionRules/{siteProtectionRule%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SiteProtectionRuleItemRequestBuilder} and sets the default values.
    ...
    public SiteProtectionRuleItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/siteInclusionRules/{siteProtectionRule%2Did}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public SiteProtectionRule patch(@jakarta.annotation.Nonnull final SiteProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SiteProtectionRule patch(@jakarta.annotation.Nonnull final SiteProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/siteInclusionRules/{siteProtectionRule%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SiteProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SiteProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
