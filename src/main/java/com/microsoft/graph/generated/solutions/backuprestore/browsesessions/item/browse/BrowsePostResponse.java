...
public class BrowsePostResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link BrowsePostResponse} and sets the default values.
     */
    public BrowsePostResponse() {
        super();
    }
    /**
    ...
    public static BrowsePostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
