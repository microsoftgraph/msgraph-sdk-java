package com.microsoft.graph.solutions.virtualevents.events.item.presenters;
...
import com.microsoft.graph.solutions.virtualevents.events.item.presenters.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.events.item.presenters.item.VirtualEventPresenterItemRequestBuilder;
...
public class PresentersRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/presenters{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VirtualEventPresenter body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/presenters", pathParameters);
