package com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions;
...
import com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions.count.CountRequestBuilder;
import com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions.item.SharePointRestoreSessionItemRequestBuilder;
...
public class SharePointRestoreSessionsRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public SharePointRestoreSessionItemRequestBuilder bySharePointRestoreSessionId(@jakarta.annotation.Nonnull final String sharePointRestoreSessionId) {
        ...
        urlTplParams.put("sharePointRestoreSession%2Did", sharePointRestoreSessionId);
        return new SharePointRestoreSessionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Instantiates a new {@link SharePointRestoreSessionsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SharePointRestoreSessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SharePointRestoreSessionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public SharePointRestoreSessionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, SharePointRestoreSessionCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/backuprestoreroot-post-sharepointrestoresessions?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SharePointRestoreSession body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions", pathParameters);
