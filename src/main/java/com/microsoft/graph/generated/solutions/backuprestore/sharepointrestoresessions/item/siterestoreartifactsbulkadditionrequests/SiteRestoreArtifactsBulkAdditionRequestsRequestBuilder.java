package com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions.item.siterestoreartifactsbulkadditionrequests;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.SiteRestoreArtifactsBulkAdditionRequest;
import com.microsoft.graph.models.SiteRestoreArtifactsBulkAdditionRequestCollectionResponse;
import com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions.item.siterestoreartifactsbulkadditionrequests.count.CountRequestBuilder;
import com.microsoft.graph.solutions.backuprestore.sharepointrestoresessions.item.siterestoreartifactsbulkadditionrequests.item.SiteRestoreArtifactsBulkAdditionRequestItemRequestBuilder;
...
public class SiteRestoreArtifactsBulkAdditionRequestsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public SiteRestoreArtifactsBulkAdditionRequestItemRequestBuilder bySiteRestoreArtifactsBulkAdditionRequestId(@jakarta.annotation.Nonnull final String siteRestoreArtifactsBulkAdditionRequestId) {
        Objects.requireNonNull(siteRestoreArtifactsBulkAdditionRequestId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("siteRestoreArtifactsBulkAdditionRequest%2Did", siteRestoreArtifactsBulkAdditionRequestId);
        return new SiteRestoreArtifactsBulkAdditionRequestItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions/{sharePointRestoreSession%2Did}/siteRestoreArtifactsBulkAdditionRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SiteRestoreArtifactsBulkAdditionRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SiteRestoreArtifactsBulkAdditionRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions/{sharePointRestoreSession%2Did}/siteRestoreArtifactsBulkAdditionRequests", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public SiteRestoreArtifactsBulkAdditionRequestsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
