package com.microsoft.graph.solutions.virtualevents.webinars.item.registrationswithemail;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.VirtualEventRegistration;
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrationswithemail.cancel.CancelRequestBuilder;
...
public class RegistrationsWithEmailRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public RegistrationsWithEmailRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String email) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations(email='{email}')", pathParameters);
        this.pathParameters.put("email", email);
    }
    /**
     * Instantiates a new {@link RegistrationsWithEmailRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public RegistrationsWithEmailRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations(email='{email}')", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations(email='{email}'){?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RegistrationsWithEmailRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
