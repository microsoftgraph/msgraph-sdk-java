package com.microsoft.graph.solutions.backuprestore.protectionunits.item.graphsiteprotectionunit;
...
public class GraphSiteProtectionUnitRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public GraphSiteProtectionUnitRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public SiteProtectionUnit get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
