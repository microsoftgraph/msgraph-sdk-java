package com.microsoft.graph.solutions.backuprestore.onedriveforbusinessprotectionpolicies.item.driveprotectionunitsbulkadditionjobs.item;
...
public class DriveProtectionUnitsBulkAdditionJobItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link DriveProtectionUnitsBulkAdditionJobItemRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DriveProtectionUnitsBulkAdditionJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicy%2Did}/driveProtectionUnitsBulkAdditionJobs/{driveProtectionUnitsBulkAdditionJob%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveProtectionUnitsBulkAdditionJobItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DriveProtectionUnitsBulkAdditionJobItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public DriveProtectionUnitsBulkAdditionJobItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
