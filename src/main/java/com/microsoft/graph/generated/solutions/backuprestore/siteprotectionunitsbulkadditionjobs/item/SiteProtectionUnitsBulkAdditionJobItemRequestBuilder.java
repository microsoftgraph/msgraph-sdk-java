package com.microsoft.graph.solutions.backuprestore.siteprotectionunitsbulkadditionjobs.item;
...
public class SiteProtectionUnitsBulkAdditionJobItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SiteProtectionUnitsBulkAdditionJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/siteProtectionUnitsBulkAdditionJobs/{siteProtectionUnitsBulkAdditionJob%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SiteProtectionUnitsBulkAdditionJobItemRequestBuilder} and sets the default values.
    ...
    public SiteProtectionUnitsBulkAdditionJobItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/siteProtectionUnitsBulkAdditionJobs/{siteProtectionUnitsBulkAdditionJob%2Did}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public SiteProtectionUnitsBulkAdditionJob patch(@jakarta.annotation.Nonnull final SiteProtectionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SiteProtectionUnitsBulkAdditionJob patch(@jakarta.annotation.Nonnull final SiteProtectionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/siteProtectionUnitsBulkAdditionJobs/{siteProtectionUnitsBulkAdditionJob%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SiteProtectionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SiteProtectionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
