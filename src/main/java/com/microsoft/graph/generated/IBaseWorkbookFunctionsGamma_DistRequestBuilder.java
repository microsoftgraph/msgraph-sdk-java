...
/**
 * The interface for the Base Workbook Functions Gamma_Dist Request Builder.
 */
public interface IBaseWorkbookFunctionsGamma_DistRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsGamma_DistRequest instance
     */
    IWorkbookFunctionsGamma_DistRequest buildRequest(final java.util.List<Option> requestOptions);
}
