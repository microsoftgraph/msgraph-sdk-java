...
public class BaseWorkbookFunctionsOct2BinRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsOct2BinRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement places) {
     ...
     * @return The IWorkbookFunctionsOct2BinRequest instance
     */
    public IWorkbookFunctionsOct2BinRequest buildRequest(final java.util.List<Option> requestOptions) {
