...
public class BucketTaskBoardFormatRequestBuilder extends BaseRequestBuilder {
    ...
    public BucketTaskBoardFormatRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/tasks/{plannerTask%2Did}/bucketTaskBoardFormat", pathParameters);
    }
    /**
     * Instantiates a new {@link BucketTaskBoardFormatRequestBuilder} and sets the default values.
    ...
    public BucketTaskBoardFormatRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/tasks/{plannerTask%2Did}/bucketTaskBoardFormat", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/planner/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24expand,%24select}", pathParameters);
