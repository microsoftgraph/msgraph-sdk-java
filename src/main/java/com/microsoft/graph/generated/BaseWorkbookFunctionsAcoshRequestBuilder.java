...
public class BaseWorkbookFunctionsAcoshRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsAcoshRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsAcoshRequest instance
     */
    public IWorkbookFunctionsAcoshRequest buildRequest(final java.util.List<Option> requestOptions) {
