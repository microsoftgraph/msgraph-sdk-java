...
public class ContractItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ContractItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/contracts/{contract%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ContractItemRequestBuilder and sets the default values.
    ...
    public ContractItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/contracts/{contract%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
