...
public class BaseWorkbookFunctionsBesselJRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsBesselJRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement n) {
     ...
     * @return The IWorkbookFunctionsBesselJRequest instance
     */
    public IWorkbookFunctionsBesselJRequest buildRequest(final java.util.List<Option> requestOptions) {
