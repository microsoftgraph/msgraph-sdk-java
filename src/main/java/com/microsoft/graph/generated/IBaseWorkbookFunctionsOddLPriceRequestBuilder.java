...
/**
 * The interface for the Base Workbook Functions Odd LPrice Request Builder.
 */
public interface IBaseWorkbookFunctionsOddLPriceRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsOddLPriceRequest instance
     */
    IWorkbookFunctionsOddLPriceRequest buildRequest(final java.util.List<Option> requestOptions);
}
