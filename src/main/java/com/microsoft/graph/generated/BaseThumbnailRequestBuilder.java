...
public class BaseThumbnailRequestBuilder extends BaseRequestBuilder implements IBaseThumbnailRequestBuilder {
     ...
     */
    public BaseThumbnailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IThumbnailRequest buildRequest(final java.util.List<Option> requestOptions) {
