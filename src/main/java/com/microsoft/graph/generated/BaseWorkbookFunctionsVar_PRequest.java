...
public class BaseWorkbookFunctionsVar_PRequest extends BaseRequest implements IBaseWorkbookFunctionsVar_PRequest {
     ...
     */
    public IWorkbookFunctionsVar_PRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookFunctionsVar_PRequest)this;
    }
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsVar_PRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsVar_PRequest expand(final String value) {
