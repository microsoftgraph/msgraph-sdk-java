...
public class BaseWorkbookFunctionsWeibull_DistRequest extends BaseRequest implements IBaseWorkbookFunctionsWeibull_DistRequest {
     ...
     */
    public IWorkbookFunctionsWeibull_DistRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsWeibull_DistRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsWeibull_DistRequest expand(final String value) {
