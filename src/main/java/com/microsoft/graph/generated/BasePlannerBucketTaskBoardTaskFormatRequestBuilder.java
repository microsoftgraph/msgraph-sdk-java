...
public class BasePlannerBucketTaskBoardTaskFormatRequestBuilder extends BaseRequestBuilder implements IBasePlannerBucketTaskBoardTaskFormatRequestBuilder {
     ...
     */
    public BasePlannerBucketTaskBoardTaskFormatRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IPlannerBucketTaskBoardTaskFormatRequest buildRequest(final java.util.List<Option> requestOptions) {
