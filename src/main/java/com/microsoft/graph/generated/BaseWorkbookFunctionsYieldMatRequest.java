...
public class BaseWorkbookFunctionsYieldMatRequest extends BaseRequest implements IBaseWorkbookFunctionsYieldMatRequest {
     ...
     */
    public IWorkbookFunctionsYieldMatRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookFunctionsYieldMatRequest)this;
    }
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsYieldMatRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsYieldMatRequest expand(final String value) {
