...
/**
 * The class for the Base Workbook Table Column Range Request.
 */
public class BaseWorkbookTableColumnRangeRequest extends BaseRequest implements IBaseWorkbookTableColumnRangeRequest {
     ...
     */
    public BaseWorkbookTableColumnRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
