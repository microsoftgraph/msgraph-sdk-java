...
public class BaseWorkbookFunctionsDcountARequest extends BaseRequest implements IBaseWorkbookFunctionsDcountARequest {
     ...
     */
    public IWorkbookFunctionsDcountARequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsDcountARequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsDcountARequest expand(final String value) {
