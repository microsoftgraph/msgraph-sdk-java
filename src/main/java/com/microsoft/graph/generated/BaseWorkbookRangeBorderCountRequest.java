...
/**
 * The class for the Base Workbook Range Border Count Request.
 */
public class BaseWorkbookRangeBorderCountRequest extends BaseRequest implements IBaseWorkbookRangeBorderCountRequest {
     ...
     */
    public BaseWorkbookRangeBorderCountRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
