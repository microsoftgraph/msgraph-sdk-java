...
public class LearningCourseActivitiesWithExternalcourseActivityIdReq_93f96b28 extends BaseRequestBuilder {
    ...
    public LearningCourseActivitiesWithExternalcourseActivityIdReq_93f96b28(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String externalcourseActivityId) {
        super(requestAdapter, "{+baseurl}/employeeExperience/learningCourseActivities(externalcourseActivityId='{externalcourseActivityId}'){?%24expand,%24select}", pathParameters);
    ...
    public LearningCourseActivitiesWithExternalcourseActivityIdReq_93f96b28(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/learningCourseActivities(externalcourseActivityId='{externalcourseActivityId}'){?%24expand,%24select}", rawUrl);
    }
    /**
