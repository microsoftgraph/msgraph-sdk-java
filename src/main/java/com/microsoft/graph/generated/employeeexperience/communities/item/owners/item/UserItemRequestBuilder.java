package com.microsoft.graph.employeeexperience.communities.item.owners.item;

import com.microsoft.graph.employeeexperience.communities.item.owners.item.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.employeeexperience.communities.item.owners.item.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/owners/{user%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserItemRequestBuilder} and sets the default values.
