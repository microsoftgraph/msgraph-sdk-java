package com.microsoft.graph.employeeexperience.communities.item.owners;

import com.microsoft.graph.employeeexperience.communities.item.owners.count.CountRequestBuilder;
import com.microsoft.graph.employeeexperience.communities.item.owners.item.UserItemRequestBuilder;
...
public class OwnersRequestBuilder extends BaseRequestBuilder {
    ...
    public OwnersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/owners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link OwnersRequestBuilder} and sets the default values.
