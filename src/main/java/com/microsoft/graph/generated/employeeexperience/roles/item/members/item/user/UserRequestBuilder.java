package com.microsoft.graph.employeeexperience.roles.item.members.item.user;

import com.microsoft.graph.employeeexperience.roles.item.members.item.user.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.employeeexperience.roles.item.members.item.user.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserRequestBuilder extends BaseRequestBuilder {
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}/user{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserRequestBuilder} and sets the default values.
