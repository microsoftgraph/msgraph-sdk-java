...
public class LearningProviderItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link LearningContentsWithExternalIdRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final LearningProvider body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}", pathParameters);
