...
public class BaseWorkbookFunctionsNowRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNowRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsNowRequest instance
     */
    public IWorkbookFunctionsNowRequest buildRequest(final java.util.List<Option> requestOptions) {
