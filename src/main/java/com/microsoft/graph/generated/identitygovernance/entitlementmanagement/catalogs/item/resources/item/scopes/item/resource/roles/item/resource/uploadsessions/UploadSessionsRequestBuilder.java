package com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.scopes.item.resource.roles.item.resource.uploadsessions;

import com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.scopes.item.resource.roles.item.resource.uploadsessions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.scopes.item.resource.roles.item.resource.uploadsessions.item.CustomDataProvidedResourceUploadSessionItemRequestBuilder;
