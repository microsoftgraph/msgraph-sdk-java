package com.microsoft.graph.identitygovernance.entitlementmanagement.resourcerequests.item.catalog.resources.item.roles.item.resource.uploadsessions.item.files.item;

import com.microsoft.graph.identitygovernance.entitlementmanagement.resourcerequests.item.catalog.resources.item.roles.item.resource.uploadsessions.item.files.item.value.ContentRequestBuilder;
