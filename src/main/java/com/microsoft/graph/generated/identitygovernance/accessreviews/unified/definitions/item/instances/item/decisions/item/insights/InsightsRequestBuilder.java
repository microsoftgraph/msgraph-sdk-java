package com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions.item.insights;

import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions.item.insights.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions.item.insights.item.GovernanceInsightItemRequestBuilder;
