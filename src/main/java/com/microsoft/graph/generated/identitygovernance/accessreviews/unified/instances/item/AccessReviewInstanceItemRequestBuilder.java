package com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item;

import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.acceptrecommendations.AcceptRecommendationsRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.applydecisions.ApplyDecisionsRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.batchapplycustomdataprovidedresourcedecisions.BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.batchrecorddecisions.BatchRecordDecisionsRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.contactedreviewers.ContactedReviewersRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.decisions.DecisionsRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.resetdecisions.ResetDecisionsRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.sendreminder.SendReminderRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.stages.StagesRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.stop.StopRequestBuilder;
...
public class AccessReviewInstanceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessReviewInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessReviewInstanceItemRequestBuilder} and sets the default values.
    ...
    public AccessReviewInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
