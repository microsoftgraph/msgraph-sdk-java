package com.microsoft.graph.identitygovernance.catalogs.item.customworkflowextensions;

import com.microsoft.graph.identitygovernance.catalogs.item.customworkflowextensions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.customworkflowextensions.item.CustomCalloutExtensionItemRequestBuilder;
...
public class CustomWorkflowExtensionsRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomWorkflowExtensionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/customWorkflowExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link CustomWorkflowExtensionsRequestBuilder} and sets the default values.
    ...
    public CustomWorkflowExtensionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/customWorkflowExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
