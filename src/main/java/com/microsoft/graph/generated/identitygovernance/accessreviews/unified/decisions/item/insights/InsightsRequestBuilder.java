package com.microsoft.graph.identitygovernance.accessreviews.unified.decisions.item.insights;

import com.microsoft.graph.identitygovernance.accessreviews.unified.decisions.item.insights.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.decisions.item.insights.item.GovernanceInsightItemRequestBuilder;
...
public class InsightsRequestBuilder extends BaseRequestBuilder {
    ...
    public InsightsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/decisions/{accessReviewInstanceDecisionItem%2Did}/insights{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link InsightsRequestBuilder} and sets the default values.
    ...
    public InsightsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/decisions/{accessReviewInstanceDecisionItem%2Did}/insights{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
