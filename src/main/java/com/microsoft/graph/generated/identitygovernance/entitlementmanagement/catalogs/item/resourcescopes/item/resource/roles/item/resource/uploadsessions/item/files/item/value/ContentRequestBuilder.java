package com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resourcescopes.item.resource.roles.item.resource.uploadsessions.item.files.item.value;
