package com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.environment;
...
public class EnvironmentRequestBuilder extends BaseRequestBuilder {
    ...
    public EnvironmentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource/environment{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EnvironmentRequestBuilder} and sets the default values.
    ...
    public EnvironmentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource/environment{?%24expand,%24select}", rawUrl);
    }
    /**
