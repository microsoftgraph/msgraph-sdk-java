...
public class BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/batchApplyCustomDataProvidedResourceDecisions", pathParameters);
    }
    /**
     * Instantiates a new {@link BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/batchApplyCustomDataProvidedResourceDecisions", rawUrl);
    }
    /**
