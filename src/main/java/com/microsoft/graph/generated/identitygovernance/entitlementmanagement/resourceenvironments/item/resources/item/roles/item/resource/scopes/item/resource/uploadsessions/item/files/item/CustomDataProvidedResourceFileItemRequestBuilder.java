package com.microsoft.graph.identitygovernance.entitlementmanagement.resourceenvironments.item.resources.item.roles.item.resource.scopes.item.resource.uploadsessions.item.files.item;

import com.microsoft.graph.identitygovernance.entitlementmanagement.resourceenvironments.item.resources.item.roles.item.resource.scopes.item.resource.uploadsessions.item.files.item.value.ContentRequestBuilder;
