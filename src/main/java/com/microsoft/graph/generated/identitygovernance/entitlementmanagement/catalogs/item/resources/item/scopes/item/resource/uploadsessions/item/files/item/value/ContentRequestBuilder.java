package com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.scopes.item.resource.uploadsessions.item.files.item.value;
