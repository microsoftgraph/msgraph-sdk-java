...
public class UserConsentRequestItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link UserConsentRequestItemRequestBuilder} and sets the default values.
    ...
    public UserConsentRequestItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserConsentRequestItemRequestBuilder} and sets the default values.
    ...
    public UserConsentRequestItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}{?%24expand,%24select}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link UserConsentRequestItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
