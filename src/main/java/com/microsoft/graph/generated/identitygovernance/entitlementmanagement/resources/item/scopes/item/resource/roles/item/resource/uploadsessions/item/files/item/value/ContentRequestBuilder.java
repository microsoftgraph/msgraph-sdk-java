package com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.scopes.item.resource.roles.item.resource.uploadsessions.item.files.item.value;
