package com.microsoft.graph.identitygovernance.catalogs.item.resourceroles;

import com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.item.AccessPackageResourceRoleItemRequestBuilder;
...
public class ResourceRolesRequestBuilder extends BaseRequestBuilder {
    ...
    public ResourceRolesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceRoles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ResourceRolesRequestBuilder} and sets the default values.
    ...
    public ResourceRolesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceRoles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
