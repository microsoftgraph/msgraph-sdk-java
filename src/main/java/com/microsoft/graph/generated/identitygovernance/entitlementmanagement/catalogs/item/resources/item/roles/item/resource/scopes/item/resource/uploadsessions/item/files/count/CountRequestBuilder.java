package com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.roles.item.resource.scopes.item.resource.uploadsessions.item.files.count;
