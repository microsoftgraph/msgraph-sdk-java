...
public class ConnectedOrganizationsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ConnectedOrganizationItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link ConnectedOrganizationsRequestBuilder} and sets the default values.
    ...
    public ConnectedOrganizationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ConnectedOrganizationsRequestBuilder} and sets the default values.
    ...
    public ConnectedOrganizationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Retrieve a list of connectedOrganization objects.
     * @return a {@link ConnectedOrganizationCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConnectedOrganization body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations", pathParameters);
