package com.microsoft.graph.identitygovernance.entitlementmanagement.accesspackages.item.resourcerolescopes.item.scope.resource.roles.item.resource.uploadsessions.item.files.item.value;
