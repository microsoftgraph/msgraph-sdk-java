package com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item;

import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.environment.EnvironmentRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.externaloriginresourceconnector.ExternalOriginResourceConnectorRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.refresh.RefreshRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.roles.RolesRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.scopes.ScopesRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.uploadsessions.UploadSessionsRequestBuilder;
...
public class AccessPackageResourceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessPackageResourceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessPackageResourceItemRequestBuilder} and sets the default values.
    ...
    public AccessPackageResourceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
