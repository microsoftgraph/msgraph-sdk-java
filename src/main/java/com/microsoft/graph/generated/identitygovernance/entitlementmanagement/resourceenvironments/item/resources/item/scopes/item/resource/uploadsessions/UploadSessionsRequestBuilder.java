package com.microsoft.graph.identitygovernance.entitlementmanagement.resourceenvironments.item.resources.item.scopes.item.resource.uploadsessions;

import com.microsoft.graph.identitygovernance.entitlementmanagement.resourceenvironments.item.resources.item.scopes.item.resource.uploadsessions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resourceenvironments.item.resources.item.scopes.item.resource.uploadsessions.item.CustomDataProvidedResourceUploadSessionItemRequestBuilder;
