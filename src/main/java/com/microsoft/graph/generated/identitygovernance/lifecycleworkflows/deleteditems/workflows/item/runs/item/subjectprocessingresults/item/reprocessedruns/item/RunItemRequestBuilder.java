package com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.runs.item.subjectprocessingresults.item.reprocessedruns.item;
...
public class RunItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RunItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/subjectProcessingResults/{subjectProcessingResult%2Did}/reprocessedRuns/{run%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RunItemRequestBuilder} and sets the default values.
    ...
    public RunItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/subjectProcessingResults/{subjectProcessingResult%2Did}/reprocessedRuns/{run%2Did1}{?%24expand,%24select}", rawUrl);
    }
    /**
