package com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.roles.item.resource.uploadsessions;

import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.roles.item.resource.uploadsessions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.roles.item.resource.uploadsessions.item.CustomDataProvidedResourceUploadSessionItemRequestBuilder;
...
public class UploadSessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public UploadSessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource/roles/{accessPackageResourceRole%2Did}/resource/uploadSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link UploadSessionsRequestBuilder} and sets the default values.
    ...
    public UploadSessionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource/roles/{accessPackageResourceRole%2Did}/resource/uploadSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
