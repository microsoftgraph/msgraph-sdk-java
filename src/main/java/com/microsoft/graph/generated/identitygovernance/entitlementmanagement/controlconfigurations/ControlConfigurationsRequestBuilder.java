package com.microsoft.graph.identitygovernance.entitlementmanagement.controlconfigurations;

import com.microsoft.graph.identitygovernance.entitlementmanagement.controlconfigurations.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.controlconfigurations.item.ControlConfigurationItemRequestBuilder;
import com.microsoft.graph.models.ControlConfiguration;
import com.microsoft.graph.models.ControlConfigurationCollectionResponse;
...
public class ControlConfigurationsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ControlConfigurationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public ControlConfigurationCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public ControlConfiguration post(@jakarta.annotation.Nonnull final ControlConfiguration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ControlConfiguration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
