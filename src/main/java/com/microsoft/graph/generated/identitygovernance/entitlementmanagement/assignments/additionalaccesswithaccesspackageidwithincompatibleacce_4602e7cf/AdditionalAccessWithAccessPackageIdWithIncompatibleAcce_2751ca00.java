...
public class AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_2751ca00 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_2751ca00} and sets the default values.
     ...
     */
    public AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_2751ca00(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String accessPackageId, @jakarta.annotation.Nullable final String incompatibleAccessPackageId) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_2751ca00(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_0b84c55f get() {
        return get(null);
    }
    /**
     * Invoke function additionalAccess
     ...
     */
    @jakarta.annotation.Nullable
    public AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_0b84c55f get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_0b84c55f::createFromDiscriminatorValue);
    }
    /**
     * Invoke function additionalAccess
     ...
     */
    @jakarta.annotation.Nonnull
    public AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_2751ca00 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new AdditionalAccessWithAccessPackageIdWithIncompatibleAcce_2751ca00(rawUrl, requestAdapter);
    }
    /**
     * Invoke function additionalAccess
     */
