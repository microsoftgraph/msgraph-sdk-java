package com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.item.resource.scopes.item;

import com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.item.resource.scopes.item.resource.ResourceRequestBuilder;
...
public class AccessPackageResourceScopeItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessPackageResourceScopeItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceRoles/{accessPackageResourceRole%2Did}/resource/scopes/{accessPackageResourceScope%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessPackageResourceScopeItemRequestBuilder} and sets the default values.
    ...
    public AccessPackageResourceScopeItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceRoles/{accessPackageResourceRole%2Did}/resource/scopes/{accessPackageResourceScope%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
