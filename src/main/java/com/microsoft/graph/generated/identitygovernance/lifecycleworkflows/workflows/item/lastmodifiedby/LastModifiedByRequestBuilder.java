package com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.lastmodifiedby;

import com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.lastmodifiedby.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.lastmodifiedby.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class LastModifiedByRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/lastModifiedBy{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link LastModifiedByRequestBuilder} and sets the default values.
    ...
    public LastModifiedByRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/lastModifiedBy{?%24expand,%24select}", rawUrl);
    }
    /**
