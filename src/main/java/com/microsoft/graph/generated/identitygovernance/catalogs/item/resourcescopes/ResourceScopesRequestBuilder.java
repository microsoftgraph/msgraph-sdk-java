package com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes;

import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.AccessPackageResourceScopeItemRequestBuilder;
...
public class ResourceScopesRequestBuilder extends BaseRequestBuilder {
    ...
    public ResourceScopesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ResourceScopesRequestBuilder} and sets the default values.
    ...
    public ResourceScopesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
