package com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.roles.item.resource.scopes.item.resource.uploadsessions;

import com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.roles.item.resource.scopes.item.resource.uploadsessions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.resources.item.roles.item.resource.scopes.item.resource.uploadsessions.item.CustomDataProvidedResourceUploadSessionItemRequestBuilder;
