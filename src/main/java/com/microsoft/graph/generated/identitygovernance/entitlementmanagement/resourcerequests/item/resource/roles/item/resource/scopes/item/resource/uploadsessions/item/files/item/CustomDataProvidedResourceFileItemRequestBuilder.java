package com.microsoft.graph.identitygovernance.entitlementmanagement.resourcerequests.item.resource.roles.item.resource.scopes.item.resource.uploadsessions.item.files.item;

import com.microsoft.graph.identitygovernance.entitlementmanagement.resourcerequests.item.resource.roles.item.resource.scopes.item.resource.uploadsessions.item.files.item.value.ContentRequestBuilder;
