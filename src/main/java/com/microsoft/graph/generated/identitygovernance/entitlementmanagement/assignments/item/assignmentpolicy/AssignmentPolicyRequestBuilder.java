...
public class AssignmentPolicyRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AssignmentPolicyRequestBuilder} and sets the default values.
    ...
    public AssignmentPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}/assignmentPolicy{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AssignmentPolicyRequestBuilder} and sets the default values.
    ...
    public AssignmentPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}/assignmentPolicy{?%24expand,%24select}", rawUrl);
    }
    /**
