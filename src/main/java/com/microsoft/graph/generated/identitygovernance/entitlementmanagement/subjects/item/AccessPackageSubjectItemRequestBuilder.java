...
public class AccessPackageSubjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AccessPackageSubjectItemRequestBuilder} and sets the default values.
    ...
    public AccessPackageSubjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessPackageSubjectItemRequestBuilder} and sets the default values.
    ...
    public AccessPackageSubjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}{?%24expand,%24select}", pathParameters);
