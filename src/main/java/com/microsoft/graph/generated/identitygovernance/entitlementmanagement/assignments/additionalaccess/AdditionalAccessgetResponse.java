...
public class AdditionalAccessgetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link AdditionalAccessgetResponse} and sets the default values.
     */
    ...
    public static AdditionalAccessgetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
