package com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages;

import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.item.AccessReviewStageItemRequestBuilder;
...
public class StagesRequestBuilder extends BaseRequestBuilder {
    ...
    public StagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link StagesRequestBuilder} and sets the default values.
    ...
    public StagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
