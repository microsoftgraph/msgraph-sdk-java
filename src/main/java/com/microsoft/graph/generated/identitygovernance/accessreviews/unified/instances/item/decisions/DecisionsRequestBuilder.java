package com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.decisions;

import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.decisions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.decisions.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.instances.item.decisions.item.AccessReviewInstanceDecisionItemItemRequestBuilder;
...
public class DecisionsRequestBuilder extends BaseRequestBuilder {
    ...
    public DecisionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/decisions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DecisionsRequestBuilder} and sets the default values.
    ...
    public DecisionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/decisions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
