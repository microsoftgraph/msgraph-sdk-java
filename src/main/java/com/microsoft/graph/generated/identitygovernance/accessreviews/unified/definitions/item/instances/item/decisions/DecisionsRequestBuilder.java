package com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions;

import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.identitygovernance.accessreviews.unified.definitions.item.instances.item.decisions.item.AccessReviewInstanceDecisionItemItemRequestBuilder;
