...
public class PrivilegedAccessGroupEligibilityScheduleInstanceItemReq_24448360 extends BaseRequestBuilder {
    ...
    public PrivilegedAccessGroupEligibilityScheduleInstanceItemReq_24448360(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleInstances/{privilegedAccessGroupEligibilityScheduleInstance%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedAccessGroupEligibilityScheduleInstanceItemReq_24448360} and sets the default values.
    ...
    public PrivilegedAccessGroupEligibilityScheduleInstanceItemReq_24448360(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleInstances/{privilegedAccessGroupEligibilityScheduleInstance%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
