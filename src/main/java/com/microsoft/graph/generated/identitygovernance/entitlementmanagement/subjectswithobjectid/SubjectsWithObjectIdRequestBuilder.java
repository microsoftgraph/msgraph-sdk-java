package com.microsoft.graph.identitygovernance.entitlementmanagement.subjectswithobjectid;
...
public class SubjectsWithObjectIdRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link SubjectsWithObjectIdRequestBuilder} and sets the default values.
     * @param objectId Alternate key of accessPackageSubject
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SubjectsWithObjectIdRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String objectId) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects(objectId='{objectId}')", pathParameters);
        this.pathParameters.put("objectId", objectId);
    }
    /**
     * Instantiates a new {@link SubjectsWithObjectIdRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SubjectsWithObjectIdRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects(objectId='{objectId}')", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/entitlementManagement/subjects(objectId='{objectId}'){?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public SubjectsWithObjectIdRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new SubjectsWithObjectIdRequestBuilder(rawUrl, requestAdapter);
    }
    /**
