package com.microsoft.graph.identitygovernance.entitlementmanagement.resourceenvironments.item.resources.item.scopes.item.resource.roles.item.resource.uploadsessions.item.files.item.value;
