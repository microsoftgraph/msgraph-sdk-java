package com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.uploadsessions.item.files.item;

import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.uploadsessions.item.files.item.value.ContentRequestBuilder;
...
public class CustomDataProvidedResourceFileItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomDataProvidedResourceFileItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource/uploadSessions/{customDataProvidedResourceUploadSession%2Did}/files/{customDataProvidedResourceFile%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link CustomDataProvidedResourceFileItemRequestBuilder} and sets the default values.
    ...
    public CustomDataProvidedResourceFileItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource/uploadSessions/{customDataProvidedResourceUploadSession%2Did}/files/{customDataProvidedResourceFile%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
