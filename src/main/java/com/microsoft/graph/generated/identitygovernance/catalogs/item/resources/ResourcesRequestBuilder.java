package com.microsoft.graph.identitygovernance.catalogs.item.resources;

import com.microsoft.graph.identitygovernance.catalogs.item.resources.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resources.item.AccessPackageResourceItemRequestBuilder;
...
public class ResourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public ResourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ResourcesRequestBuilder} and sets the default values.
    ...
    public ResourcesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
