...
public class PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223 extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new PrivilegedAccessGroupAssignmentScheduleInstanceItemRequ_595d3223(rawUrl, requestAdapter);
    }
    /**
