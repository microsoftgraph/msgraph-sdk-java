package com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.item.resource.roles;

import com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.item.resource.roles.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourceroles.item.resource.roles.item.AccessPackageResourceRoleItemRequestBuilder;
...
public class RolesRequestBuilder extends BaseRequestBuilder {
    ...
    public RolesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceRoles/{accessPackageResourceRole%2Did}/resource/roles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RolesRequestBuilder} and sets the default values.
    ...
    public RolesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceRoles/{accessPackageResourceRole%2Did}/resource/roles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
