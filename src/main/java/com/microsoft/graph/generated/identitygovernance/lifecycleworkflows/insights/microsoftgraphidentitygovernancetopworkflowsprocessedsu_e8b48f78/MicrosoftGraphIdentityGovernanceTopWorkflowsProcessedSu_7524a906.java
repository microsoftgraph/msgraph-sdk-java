...
public class MicrosoftGraphIdentityGovernanceTopWorkflowsProcessedSu_7524a906 extends BaseRequestBuilder {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphIdentityGovernanceTopWorkflowsProcessedSu_7524a906(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public TopWorkflowsProcessedSummaryWithStartDateTimeWithEndDat_b730b0ca get() {
        return get(null);
    }
    /**
     * Provide a summary of the workflows processed the most, known as top workflows, for a specified period in a tenant. Workflow basic details are given, along with run information. For information about tasks processed, see insights: topTasksProcessedSummary.
     ...
     */
    @jakarta.annotation.Nullable
    public TopWorkflowsProcessedSummaryWithStartDateTimeWithEndDat_b730b0ca get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphIdentityGovernanceTopWorkflowsProcessedSu_7524a906 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
