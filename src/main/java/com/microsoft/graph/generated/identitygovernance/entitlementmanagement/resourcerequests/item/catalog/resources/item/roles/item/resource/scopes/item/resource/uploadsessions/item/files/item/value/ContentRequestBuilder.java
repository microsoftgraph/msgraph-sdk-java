package com.microsoft.graph.identitygovernance.entitlementmanagement.resourcerequests.item.catalog.resources.item.roles.item.resource.scopes.item.resource.uploadsessions.item.files.item.value;
