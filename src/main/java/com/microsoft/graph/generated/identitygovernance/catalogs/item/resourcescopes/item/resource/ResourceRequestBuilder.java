package com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource;

import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.environment.EnvironmentRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.externaloriginresourceconnector.ExternalOriginResourceConnectorRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.refresh.RefreshRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.roles.RolesRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.scopes.ScopesRequestBuilder;
import com.microsoft.graph.identitygovernance.catalogs.item.resourcescopes.item.resource.uploadsessions.UploadSessionsRequestBuilder;
...
public class ResourceRequestBuilder extends BaseRequestBuilder {
    ...
    public ResourceRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ResourceRequestBuilder} and sets the default values.
    ...
    public ResourceRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/resourceScopes/{accessPackageResourceScope%2Did}/resource{?%24expand,%24select}", rawUrl);
    }
    /**
