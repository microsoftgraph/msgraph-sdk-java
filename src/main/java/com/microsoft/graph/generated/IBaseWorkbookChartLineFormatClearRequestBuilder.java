...
/**
 * The interface for the Base Workbook Chart Line Format Clear Request Builder.
 */
public interface IBaseWorkbookChartLineFormatClearRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookChartLineFormatClearRequest instance
     */
    IWorkbookChartLineFormatClearRequest buildRequest(final java.util.List<Option> requestOptions);
}
