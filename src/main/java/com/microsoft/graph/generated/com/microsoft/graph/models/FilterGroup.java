...
public class FilterGroup implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static FilterGroup createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<FilterClause>
     */
    @jakarta.annotation.Nullable
    public java.util.List<FilterClause> getClauses() {
        return this.backingStore.get("clauses");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("clauses", (n) -> { this.setClauses(n.getCollectionOfObjectValues(FilterClause::createFromDiscriminatorValue)); });
     ...
     */
    public void setClauses(@jakarta.annotation.Nullable final java.util.List<FilterClause> value) {
        this.backingStore.set("clauses", value);
    }
    /**
