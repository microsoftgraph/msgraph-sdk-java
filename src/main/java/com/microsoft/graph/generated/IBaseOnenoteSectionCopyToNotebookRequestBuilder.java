...
/**
 * The interface for the Base Onenote Section Copy To Notebook Request Builder.
 */
public interface IBaseOnenoteSectionCopyToNotebookRequestBuilder extends IRequestBuilder {
     ...
     * @return The IOnenoteSectionCopyToNotebookRequest instance
     */
    IOnenoteSectionCopyToNotebookRequest buildRequest(final java.util.List<Option> requestOptions);
}
