...
public class BaseWorkbookFunctionsCoupNumRequest extends BaseRequest implements IBaseWorkbookFunctionsCoupNumRequest {
     ...
     */
    public IWorkbookFunctionsCoupNumRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookFunctionsCoupNumRequest)this;
    }
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsCoupNumRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsCoupNumRequest expand(final String value) {
