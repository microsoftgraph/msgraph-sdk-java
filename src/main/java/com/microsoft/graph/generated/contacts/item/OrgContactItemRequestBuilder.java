...
import com.microsoft.graph.contacts.item.onpremisessyncbehavior.OnPremisesSyncBehaviorRequestBuilder;
...
public class OrgContactItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/contacts/{orgContact%2Did}{?%24expand,%24select}", pathParameters);
