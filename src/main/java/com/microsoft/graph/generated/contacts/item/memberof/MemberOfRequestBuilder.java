package com.microsoft.graph.contacts.item.memberof;

import com.microsoft.graph.contacts.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.graphgroup.GraphGroupRequestBuilder;
...
public class MemberOfRequestBuilder extends BaseRequestBuilder {
    ...
    public MemberOfRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MemberOfRequestBuilder and sets the default values.
    ...
    public MemberOfRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Groups that this contact is a member of. Read-only. Nullable. Supports $expand.
     * @return a DirectoryObjectCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/orgcontact-list-memberof?view=graph-rest-1.0">Find more info here</a>
     */
