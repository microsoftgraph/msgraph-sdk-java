...
public class MediaContentRatingJapan implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MediaContentRatingJapan} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("movieRating", (n) -> { this.setMovieRating(n.getEnumValue(RatingJapanMoviesType::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("tvRating", (n) -> { this.setTvRating(n.getEnumValue(RatingJapanTelevisionType::forValue)); });
        return deserializerMap;
    }
    /**
     * Gets the movieRating property value. Movies rating labels in Japan
     * @return a {@link RatingJapanMoviesType}
     */
     ...
     * @return a {@link RatingJapanTelevisionType}
     */
    @jakarta.annotation.Nullable
