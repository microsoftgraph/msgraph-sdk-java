...
public class ApplicationsRequiredResourceAccess implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ApplicationsRequiredResourceAccess} and sets the default values.
     */
     ...
     * @return a {@link ApplicationsRequiredResourceAccess}
     */
    @jakarta.annotation.Nonnull
    public static ApplicationsRequiredResourceAccess createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ApplicationsRequiredResourceAccess();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("permissions", (n) -> { this.setPermissions(n.getCollectionOfObjectValues(ApplicationResourcePermission::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<ApplicationResourcePermission> getPermissions() {
