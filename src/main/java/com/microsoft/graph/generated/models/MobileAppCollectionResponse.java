...
public class MobileAppCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link MobileAppCollectionResponse} and sets the default values.
     */
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<MobileApp> value) {
