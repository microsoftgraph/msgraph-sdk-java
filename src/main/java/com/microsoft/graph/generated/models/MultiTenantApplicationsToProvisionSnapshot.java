...
public class MultiTenantApplicationsToProvisionSnapshot implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MultiTenantApplicationsToProvisionSnapshot} and sets the default values.
     */
     ...
     * @return a {@link MultiTenantApplicationsToProvisionSnapshot}
     */
    @jakarta.annotation.Nonnull
    public static MultiTenantApplicationsToProvisionSnapshot createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("requiredResourceAccesses", (n) -> { this.setRequiredResourceAccesses(n.getCollectionOfObjectValues(ApplicationsRequiredResourceAccess::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<ApplicationsRequiredResourceAccess> getRequiredResourceAccesses() {
        return this.backingStore.get("requiredResourceAccesses");
    }
    /**
    ...
    public void setRequiredResourceAccesses(@jakarta.annotation.Nullable final java.util.List<ApplicationsRequiredResourceAccess> value) {
        this.backingStore.set("requiredResourceAccesses", value);
    }
}
