...
public class EmailDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EmailDetails} and sets the default values.
     */
    public EmailDetails() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static EmailDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
