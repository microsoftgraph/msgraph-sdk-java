...
public class FixtureMap extends BaseMapFeature implements Parsable {
    /**
     * Instantiates a new {@link FixtureMap} and sets the default values.
     */
    public FixtureMap() {
        super();
    ...
    public static FixtureMap createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
