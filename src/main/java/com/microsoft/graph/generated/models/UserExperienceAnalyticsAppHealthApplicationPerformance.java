...
public class UserExperienceAnalyticsAppHealthApplicationPerformance extends Entity implements Parsable {
     ...
     * @return a {@link UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore}
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore getAppHealthScore() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("appHealthScore", (n) -> { this.setAppHealthScore(n.getObjectValue(UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore::createFromDiscriminatorValue)); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("appHealthScore", this.getAppHealthScore());
     ...
     */
    public void setAppHealthScore(@jakarta.annotation.Nullable final UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore} and sets the default values.
         */
        public UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore result = new UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore();
