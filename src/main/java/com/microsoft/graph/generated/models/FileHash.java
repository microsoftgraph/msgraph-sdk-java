...
public class FileHash implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FileHash} and sets the default values.
     */
    public FileHash() {
    ...
    public String getHashValue() {
        return this.backingStore.get("hashValue");
    }
    /**
    ...
    public void setHashValue(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("hashValue", value);
    }
    /**
