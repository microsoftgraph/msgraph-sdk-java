...
public class EducationAssignmentGrade implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EducationAssignmentGrade} and sets the default values.
     */
     ...
     * @return a {@link EducationAssignmentGrade}
     */
    @jakarta.annotation.Nonnull
    public static EducationAssignmentGrade createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public IdentitySet getGradedBy() {
        return this.backingStore.get("gradedBy");
    }
    /**
    ...
    public OffsetDateTime getGradedDateTime() {
        return this.backingStore.get("gradedDateTime");
    }
    /**
     ...
     */
    public void setGradedBy(@jakarta.annotation.Nullable final IdentitySet value) {
        this.backingStore.set("gradedBy", value);
    }
    /**
     ...
     */
    public void setGradedDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("gradedDateTime", value);
    }
    /**
