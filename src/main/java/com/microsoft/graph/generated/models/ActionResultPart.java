...
public class ActionResultPart implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ActionResultPart} and sets the default values.
     */
     ...
     * @return a {@link ActionResultPart}
     */
    @jakarta.annotation.Nonnull
    public static ActionResultPart createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
