...
public class RubricQualitySelectedColumnModel implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RubricQualitySelectedColumnModel} and sets the default values.
     */
     ...
     * @return a {@link RubricQualitySelectedColumnModel}
     */
    @jakarta.annotation.Nonnull
    public static RubricQualitySelectedColumnModel createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columnId", (n) -> { this.setColumnId(n.getStringValue()); });
     ...
     */
    public void setColumnId(@jakarta.annotation.Nullable final String value) {
