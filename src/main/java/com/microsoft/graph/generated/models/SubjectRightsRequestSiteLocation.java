...
public class SubjectRightsRequestSiteLocation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SubjectRightsRequestSiteLocation} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static SubjectRightsRequestSiteLocation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
