...
public class MailboxDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MailboxDetails} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MailboxDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
