...
public class MediaContentRatingNewZealand implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link MediaContentRatingNewZealand} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("movieRating", (n) -> { this.setMovieRating(n.getEnumValue(RatingNewZealandMoviesType::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("tvRating", (n) -> { this.setTvRating(n.getEnumValue(RatingNewZealandTelevisionType::forValue)); });
        return deserializerMap;
    }
    /**
     * Gets the movieRating property value. Movies rating labels in New Zealand
     * @return a {@link RatingNewZealandMoviesType}
     */
     ...
     * @return a {@link RatingNewZealandTelevisionType}
     */
    @jakarta.annotation.Nullable
