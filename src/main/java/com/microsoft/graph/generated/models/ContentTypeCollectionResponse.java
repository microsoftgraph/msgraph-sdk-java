...
public class ContentTypeCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link ContentTypeCollectionResponse} and sets the default values.
     */
    ...
    public static ContentTypeCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
