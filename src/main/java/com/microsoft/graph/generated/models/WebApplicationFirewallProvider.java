...
public class WebApplicationFirewallProvider extends Entity implements Parsable {
    /**
     * Instantiates a new {@link WebApplicationFirewallProvider} and sets the default values.
     */
    public WebApplicationFirewallProvider() {
        super();
    }
    /**
    ...
    public static WebApplicationFirewallProvider createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
