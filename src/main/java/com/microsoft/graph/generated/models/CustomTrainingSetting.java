...
public class CustomTrainingSetting extends TrainingSetting implements Parsable {
     ...
     * @return a java.util.List<CustomTrainingSettingAssignedTo>
     */
    @jakarta.annotation.Nullable
    public java.util.List<CustomTrainingSettingAssignedTo> getAssignedTo() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("assignedTo", (n) -> { this.setAssignedTo(n.getCollectionOfEnumValues(CustomTrainingSettingAssignedTo::forValue)); });
     ...
     */
    public void setAssignedTo(@jakarta.annotation.Nullable final java.util.List<CustomTrainingSettingAssignedTo> value) {
