...
public class EducationAiFeedbackContentSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EducationAiFeedbackContentSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static EducationAiFeedbackContentSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isMessageClarityEnabled", (n) -> { this.setIsMessageClarityEnabled(n.getBooleanValue()); });
        deserializerMap.put("isQualityOfInformationEnabled", (n) -> { this.setIsQualityOfInformationEnabled(n.getBooleanValue()); });
        deserializerMap.put("isSpeechOrganizationEnabled", (n) -> { this.setIsSpeechOrganizationEnabled(n.getBooleanValue()); });
    ...
    public Boolean getIsMessageClarityEnabled() {
     ...
     */
    @jakarta.annotation.Nullable
    public Boolean getIsQualityOfInformationEnabled() {
     ...
     */
    @jakarta.annotation.Nullable
    public Boolean getIsSpeechOrganizationEnabled() {
        return this.backingStore.get("isSpeechOrganizationEnabled");
    }
    /**
    ...
    public void setIsSpeechOrganizationEnabled(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("isSpeechOrganizationEnabled", value);
    }
    /**
