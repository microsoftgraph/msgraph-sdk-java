...
public class PrinterShareViewpoint implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PrinterShareViewpoint} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static PrinterShareViewpoint createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
