...
public class UserRegistrationFeatureSummary implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("userRoles", (n) -> { this.setUserRoles(n.getEnumValue(UserRegistrationFeatureSummaryUserRoles::forValue)); });
        deserializerMap.put("userTypes", (n) -> { this.setUserTypes(n.getEnumValue(UserRegistrationFeatureSummaryUserTypes::forValue)); });
     ...
     * @return a UserRegistrationFeatureSummaryUserRoles
     */
    @jakarta.annotation.Nullable
    public UserRegistrationFeatureSummaryUserRoles getUserRoles() {
     ...
     * @return a UserRegistrationFeatureSummaryUserTypes
     */
    @jakarta.annotation.Nullable
    public UserRegistrationFeatureSummaryUserTypes getUserTypes() {
     ...
     */
    public void setUserRoles(@jakarta.annotation.Nullable final UserRegistrationFeatureSummaryUserRoles value) {
     ...
     */
    public void setUserTypes(@jakarta.annotation.Nullable final UserRegistrationFeatureSummaryUserTypes value) {
