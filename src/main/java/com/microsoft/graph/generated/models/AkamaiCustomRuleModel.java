...
public class AkamaiCustomRuleModel implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AkamaiCustomRuleModel} and sets the default values.
     */
     ...
     * @return a {@link AkamaiCustomRuleModel}
     */
    @jakarta.annotation.Nonnull
    public static AkamaiCustomRuleModel createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
