...
public class AkamaiAttackGroupActionModel implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AkamaiAttackGroupActionModel} and sets the default values.
     */
     ...
     * @return a {@link AkamaiAttackGroupActionModel}
     */
    @jakarta.annotation.Nonnull
    public static AkamaiAttackGroupActionModel createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
