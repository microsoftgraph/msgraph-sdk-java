...
public class MediaContentRatingUnitedKingdom implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link MediaContentRatingUnitedKingdom} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("movieRating", (n) -> { this.setMovieRating(n.getEnumValue(RatingUnitedKingdomMoviesType::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("tvRating", (n) -> { this.setTvRating(n.getEnumValue(RatingUnitedKingdomTelevisionType::forValue)); });
        return deserializerMap;
    }
    /**
     * Gets the movieRating property value. Movies rating labels in United Kingdom
     * @return a {@link RatingUnitedKingdomMoviesType}
     */
     ...
     * @return a {@link RatingUnitedKingdomTelevisionType}
     */
    @jakarta.annotation.Nullable
