...
public class AccessReviewScope implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AccessReviewScope} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AccessReviewScope createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
