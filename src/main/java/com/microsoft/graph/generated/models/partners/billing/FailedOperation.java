...
public class FailedOperation extends Operation implements Parsable {
    /**
     ...
     * @return a FailedOperation
     */
    @jakarta.annotation.Nonnull
    public static FailedOperation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
