...
public class RestorePointSearchResult implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RestorePointSearchResult} and sets the default values.
     */
     ...
     * @return a {@link RestorePointSearchResult}
     */
    @jakarta.annotation.Nonnull
    public static RestorePointSearchResult createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
