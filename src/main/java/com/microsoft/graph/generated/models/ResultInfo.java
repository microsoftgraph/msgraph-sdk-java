...
public class ResultInfo implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ResultInfo} and sets the default values.
     */
    public ResultInfo() {
    ...
    public Integer getSubcode() {
        return this.backingStore.get("subcode");
    }
    /**
    ...
    public void setSubcode(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("subcode", value);
    }
}
