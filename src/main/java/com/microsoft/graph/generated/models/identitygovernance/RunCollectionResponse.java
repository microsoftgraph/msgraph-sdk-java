...
public class RunCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link RunCollectionResponse} and sets the default values.
     */
    ...
    public static RunCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<Run> value) {
