...
public class Endpoint implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    public void setUserAgent(@jakarta.annotation.Nullable final UserAgent value) {
