...
public class ActivitySettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ActivitySettings} and sets the default values.
     */
     ...
     * @return a {@link java.util.List<UrlToItemResolverBase>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<UrlToItemResolverBase> getUrlToItemResolvers() {
        return this.backingStore.get("urlToItemResolvers");
    }
    /**
    ...
    public void setUrlToItemResolvers(@jakarta.annotation.Nullable final java.util.List<UrlToItemResolverBase> value) {
        this.backingStore.set("urlToItemResolvers", value);
    }
}
