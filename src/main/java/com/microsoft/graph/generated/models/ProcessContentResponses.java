...
public class ProcessContentResponses implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ProcessContentResponses} and sets the default values.
     */
     ...
     * @return a {@link ProcessContentResponses}
     */
    @jakarta.annotation.Nonnull
    public static ProcessContentResponses createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("results", (n) -> { this.setResults(n.getObjectValue(ProcessContentResponse::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public ProcessContentResponse getResults() {
     ...
     */
    public void setResults(@jakarta.annotation.Nullable final ProcessContentResponse value) {
