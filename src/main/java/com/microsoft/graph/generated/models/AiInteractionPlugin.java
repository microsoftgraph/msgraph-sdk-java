...
public class AiInteractionPlugin implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AiInteractionPlugin} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AiInteractionPlugin createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
