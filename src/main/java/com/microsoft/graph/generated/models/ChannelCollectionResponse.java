...
public class ChannelCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link ChannelCollectionResponse} and sets the default values.
     */
    ...
    public static ChannelCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<Channel> value) {
