...
public class StoragePlanInformation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link StoragePlanInformation} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static StoragePlanInformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
