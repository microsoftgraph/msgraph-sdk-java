...
public class ComplianceManagementPartnerAssignment implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link ComplianceManagementPartnerAssignment} and sets the default values.
     */
     ...
     * @return a {@link ComplianceManagementPartnerAssignment}
     */
    @jakarta.annotation.Nonnull
    public static ComplianceManagementPartnerAssignment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
