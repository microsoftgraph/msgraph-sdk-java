...
public class SubjectRightsRequestAllMailboxLocation extends SubjectRightsRequestMailboxLocation implements Parsable {
    /**
     * Instantiates a new {@link SubjectRightsRequestAllMailboxLocation} and sets the default values.
     */
    public SubjectRightsRequestAllMailboxLocation() {
        super();
        this.setOdataType("#microsoft.graph.subjectRightsRequestAllMailboxLocation");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link SubjectRightsRequestAllMailboxLocation}
     */
