...
public class SynchronizationLinkedObjects implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link SynchronizationLinkedObjects} and sets the default values.
     */
     ...
     * @return a {@link SynchronizationLinkedObjects}
     */
    @jakarta.annotation.Nonnull
     ...
     * @return a {@link SynchronizationJobSubject}
     */
     ...
     * @return a {@link java.util.List<SynchronizationJobSubject>}
     */
    @jakarta.annotation.Nullable
