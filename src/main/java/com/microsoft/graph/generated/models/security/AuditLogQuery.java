...
public class AuditLogQuery extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("recordTypeFilters", (n) -> { this.setRecordTypeFilters(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<String> getRecordTypeFilters() {
     ...
     */
    public void setRecordTypeFilters(@jakarta.annotation.Nullable final java.util.List<String> value) {
