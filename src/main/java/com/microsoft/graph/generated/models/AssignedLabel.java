...
public class AssignedLabel implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AssignedLabel} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AssignedLabel createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
