...
public class SpaApplication implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SpaApplication} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static SpaApplication createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
