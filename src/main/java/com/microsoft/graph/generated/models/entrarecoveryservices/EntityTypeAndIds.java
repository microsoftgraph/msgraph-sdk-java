...
public class EntityTypeAndIds implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EntityTypeAndIds} and sets the default values.
     */
     ...
     * @return a {@link EntityTypeAndIds}
     */
    @jakarta.annotation.Nonnull
    public static EntityTypeAndIds createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<String> getEntityIds() {
        return this.backingStore.get("entityIds");
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public ResourceTypeName getEntityType() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("entityIds", (n) -> { this.setEntityIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("entityType", (n) -> { this.setEntityType(n.getEnumValue(ResourceTypeName::forValue)); });
    ...
    public void setEntityIds(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("entityIds", value);
    }
    /**
     * Sets the entityType property value. The entityType property
     * @param value Value to set for the entityType property.
     */
    public void setEntityType(@jakarta.annotation.Nullable final ResourceTypeName value) {
