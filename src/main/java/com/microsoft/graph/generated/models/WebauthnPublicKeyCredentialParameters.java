...
public class WebauthnPublicKeyCredentialParameters implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WebauthnPublicKeyCredentialParameters} and sets the default values.
     */
     ...
     * @return a {@link WebauthnPublicKeyCredentialParameters}
     */
    @jakarta.annotation.Nonnull
    public static WebauthnPublicKeyCredentialParameters createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WebauthnPublicKeyCredentialParameters();
    }
    /**
    ...
    public Integer getAlg() {
        return this.backingStore.get("alg");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("alg", (n) -> { this.setAlg(n.getIntegerValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeIntegerValue("alg", this.getAlg());
    ...
    public void setAlg(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("alg", value);
    }
    /**
