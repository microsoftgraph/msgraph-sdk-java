...
public class AttachmentBaseCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link AttachmentBaseCollectionResponse} and sets the default values.
     */
     ...
     * @return a {@link AttachmentBaseCollectionResponse}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(AttachmentBase::createFromDiscriminatorValue)); });
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<AttachmentBase> value) {
