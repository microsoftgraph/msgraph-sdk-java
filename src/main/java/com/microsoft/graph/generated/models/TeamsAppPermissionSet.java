...
public class TeamsAppPermissionSet implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TeamsAppPermissionSet} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static TeamsAppPermissionSet createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link java.util.List<TeamsAppResourceSpecificPermission>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<TeamsAppResourceSpecificPermission> getResourceSpecificPermissions() {
        return this.backingStore.get("resourceSpecificPermissions");
    }
    /**
     ...
     */
    public void setResourceSpecificPermissions(@jakarta.annotation.Nullable final java.util.List<TeamsAppResourceSpecificPermission> value) {
        this.backingStore.set("resourceSpecificPermissions", value);
    }
}
