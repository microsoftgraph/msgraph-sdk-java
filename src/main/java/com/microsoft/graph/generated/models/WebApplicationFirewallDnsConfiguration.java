...
public class WebApplicationFirewallDnsConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WebApplicationFirewallDnsConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WebApplicationFirewallDnsConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isDomainVerified", (n) -> { this.setIsDomainVerified(n.getBooleanValue()); });
        deserializerMap.put("isProxied", (n) -> { this.setIsProxied(n.getBooleanValue()); });
        deserializerMap.put("name", (n) -> { this.setName(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("recordType", (n) -> { this.setRecordType(n.getEnumValue(WebApplicationFirewallDnsRecordType::forValue)); });
     ...
     * @return a {@link WebApplicationFirewallDnsRecordType}
     */
    @jakarta.annotation.Nullable
    public WebApplicationFirewallDnsRecordType getRecordType() {
     ...
     */
    public void setRecordType(@jakarta.annotation.Nullable final WebApplicationFirewallDnsRecordType value) {
