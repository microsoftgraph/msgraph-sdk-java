...
public class UsageDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UsageDetails} and sets the default values.
     */
    public UsageDetails() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static UsageDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public OffsetDateTime getLastAccessedDateTime() {
        return this.backingStore.get("lastAccessedDateTime");
    }
    /**
    ...
    public void setLastAccessedDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("lastAccessedDateTime", value);
    }
    /**
