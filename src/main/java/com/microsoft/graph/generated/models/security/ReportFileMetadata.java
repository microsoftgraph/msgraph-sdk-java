...
public class ReportFileMetadata implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ReportFileMetadata} and sets the default values.
     */
     ...
     * @return a {@link ReportFileMetadata}
     */
    @jakarta.annotation.Nonnull
    public static ReportFileMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
