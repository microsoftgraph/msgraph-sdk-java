...
public class WhoisHistoryRecordCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link WhoisHistoryRecordCollectionResponse} and sets the default values.
     */
     ...
     * @return a {@link WhoisHistoryRecordCollectionResponse}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(WhoisHistoryRecord::createFromDiscriminatorValue)); });
