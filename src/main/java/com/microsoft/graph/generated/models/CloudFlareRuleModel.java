...
public class CloudFlareRuleModel implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudFlareRuleModel} and sets the default values.
     */
     ...
     * @return a {@link CloudFlareRuleModel}
     */
    @jakarta.annotation.Nonnull
    public static CloudFlareRuleModel createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
