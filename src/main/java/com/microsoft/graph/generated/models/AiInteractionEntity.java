...
public class AiInteractionEntity implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AiInteractionEntity} and sets the default values.
     */
     ...
     * @return a {@link AiInteractionEntity}
     */
    @jakarta.annotation.Nonnull
    public static AiInteractionEntity createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
