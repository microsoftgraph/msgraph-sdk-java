...
public class EffectivePolicyAssignment implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EffectivePolicyAssignment} and sets the default values.
     */
     ...
     * @return a {@link EffectivePolicyAssignment}
     */
    @jakarta.annotation.Nonnull
    public static EffectivePolicyAssignment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("policyAssignment", (n) -> { this.setPolicyAssignment(n.getObjectValue(PolicyAssignment::createFromDiscriminatorValue)); });
    ...
    public PolicyAssignment getPolicyAssignment() {
        return this.backingStore.get("policyAssignment");
    }
    /**
     ...
     * @param value Value to set for the policyAssignment property.
     */
    public void setPolicyAssignment(@jakarta.annotation.Nullable final PolicyAssignment value) {
        this.backingStore.set("policyAssignment", value);
    }
    /**
