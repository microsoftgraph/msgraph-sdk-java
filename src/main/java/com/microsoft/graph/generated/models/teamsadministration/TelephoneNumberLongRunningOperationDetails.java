...
public class TelephoneNumberLongRunningOperationDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TelephoneNumberLongRunningOperationDetails} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static TelephoneNumberLongRunningOperationDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
