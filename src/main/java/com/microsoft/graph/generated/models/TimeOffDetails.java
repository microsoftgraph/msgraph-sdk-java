...
public class TimeOffDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TimeOffDetails} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static TimeOffDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
