...
public class ProtectionUnitsBulkJobBase extends Entity implements Parsable {
    /**
     * Instantiates a new {@link ProtectionUnitsBulkJobBase} and sets the default values.
     */
    public ProtectionUnitsBulkJobBase() {
        super();
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link ProtectionUnitsBulkJobBase}
     */
    @jakarta.annotation.Nonnull
    public static ProtectionUnitsBulkJobBase createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ProtectionUnitsBulkJobStatus::forValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public ProtectionUnitsBulkJobStatus getStatus() {
