...
public class DriveProtectionUnit extends ProtectionUnitBase implements Parsable {
    /**
     * Instantiates a new {@link DriveProtectionUnit} and sets the default values.
     */
    ...
    public static DriveProtectionUnit createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
