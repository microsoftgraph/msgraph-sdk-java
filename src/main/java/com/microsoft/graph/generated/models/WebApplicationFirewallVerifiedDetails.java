...
public class WebApplicationFirewallVerifiedDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WebApplicationFirewallVerifiedDetails} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WebApplicationFirewallVerifiedDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public WebApplicationFirewallDnsConfiguration getDnsConfiguration() {
        return this.backingStore.get("dnsConfiguration");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dnsConfiguration", (n) -> { this.setDnsConfiguration(n.getObjectValue(WebApplicationFirewallDnsConfiguration::createFromDiscriminatorValue)); });
    ...
    public void setDnsConfiguration(@jakarta.annotation.Nullable final WebApplicationFirewallDnsConfiguration value) {
        this.backingStore.set("dnsConfiguration", value);
    }
    /**
