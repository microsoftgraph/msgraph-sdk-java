...
public class IdentitySource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link IdentitySource} and sets the default values.
     */
     ...
     * @return a {@link IdentitySource}
     */
    @jakarta.annotation.Nonnull
    public static IdentitySource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
