...
public class EducationSpeakerCoachSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EducationSpeakerCoachSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static EducationSpeakerCoachSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public EducationSpeakerCoachAudienceEngagementSettings getAudienceEngagementSettings() {
     ...
     */
    @jakarta.annotation.Nullable
    public EducationSpeakerCoachContentSettings getContentSettings() {
     ...
     */
    @jakarta.annotation.Nullable
    public EducationSpeakerCoachDeliverySettings getDeliverySettings() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("audienceEngagementSettings", (n) -> { this.setAudienceEngagementSettings(n.getObjectValue(EducationSpeakerCoachAudienceEngagementSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("contentSettings", (n) -> { this.setContentSettings(n.getObjectValue(EducationSpeakerCoachContentSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("deliverySettings", (n) -> { this.setDeliverySettings(n.getObjectValue(EducationSpeakerCoachDeliverySettings::createFromDiscriminatorValue)); });
