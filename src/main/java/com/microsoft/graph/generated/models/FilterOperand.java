...
public class FilterOperand implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FilterOperand} and sets the default values.
     */
     ...
     * @return a {@link FilterOperand}
     */
    @jakarta.annotation.Nonnull
    public static FilterOperand createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
