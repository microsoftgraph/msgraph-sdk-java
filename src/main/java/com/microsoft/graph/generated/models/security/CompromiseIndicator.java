...
public class CompromiseIndicator implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CompromiseIndicator} and sets the default values.
     */
     ...
     * @return a {@link CompromiseIndicator}
     */
    @jakarta.annotation.Nonnull
    public static CompromiseIndicator createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("verdict", (n) -> { this.setVerdict(n.getEnumValue(VerdictCategory::forValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public VerdictCategory getVerdict() {
