...
public class WorkflowExecutionConditions implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WorkflowExecutionConditions} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WorkflowExecutionConditions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
