...
public class AzureADRegistrationPolicy implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AzureADRegistrationPolicy} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AzureADRegistrationPolicy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public DeviceRegistrationMembership getAllowedToRegister() {
        return this.backingStore.get("allowedToRegister");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedToRegister", (n) -> { this.setAllowedToRegister(n.getObjectValue(DeviceRegistrationMembership::createFromDiscriminatorValue)); });
    ...
    public void setAllowedToRegister(@jakarta.annotation.Nullable final DeviceRegistrationMembership value) {
        this.backingStore.set("allowedToRegister", value);
    }
    /**
