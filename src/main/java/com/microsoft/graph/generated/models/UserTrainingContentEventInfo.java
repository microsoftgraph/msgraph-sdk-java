...
public class UserTrainingContentEventInfo implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link UserTrainingContentEventInfo} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("potentialScoreImpact", (n) -> { this.setPotentialScoreImpact(n.getObjectValue(UserTrainingContentEventInfoPotentialScoreImpact::createFromDiscriminatorValue)); });
     ...
     * @return a {@link UserTrainingContentEventInfoPotentialScoreImpact}
     */
    @jakarta.annotation.Nullable
    public UserTrainingContentEventInfoPotentialScoreImpact getPotentialScoreImpact() {
     ...
     */
    public void setPotentialScoreImpact(@jakarta.annotation.Nullable final UserTrainingContentEventInfoPotentialScoreImpact value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class UserTrainingContentEventInfoPotentialScoreImpact implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link UserTrainingContentEventInfoPotentialScoreImpact} and sets the default values.
         */
        public UserTrainingContentEventInfoPotentialScoreImpact() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static UserTrainingContentEventInfoPotentialScoreImpact createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final UserTrainingContentEventInfoPotentialScoreImpact result = new UserTrainingContentEventInfoPotentialScoreImpact();
