...
public class ConditionalAccessSessionControl implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ConditionalAccessSessionControl} and sets the default values.
     */
     ...
     * @return a {@link ConditionalAccessSessionControl}
     */
    @jakarta.annotation.Nonnull
    public static ConditionalAccessSessionControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
