...
public class EducationAssignmentPointsGradeType extends EducationAssignmentGradeType implements Parsable {
    /**
     * Instantiates a new {@link EducationAssignmentPointsGradeType} and sets the default values.
     */
     ...
     * @return a {@link EducationAssignmentPointsGradeType}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maxPoints", (n) -> { this.setMaxPoints(n.getObjectValue(EducationAssignmentPointsGradeTypeMaxPoints::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the maxPoints property value. Max points possible for this assignment.
     * @return a {@link EducationAssignmentPointsGradeTypeMaxPoints}
     */
    @jakarta.annotation.Nullable
    public EducationAssignmentPointsGradeTypeMaxPoints getMaxPoints() {
     ...
     */
    public void setMaxPoints(@jakarta.annotation.Nullable final EducationAssignmentPointsGradeTypeMaxPoints value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class EducationAssignmentPointsGradeTypeMaxPoints implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link EducationAssignmentPointsGradeTypeMaxPoints} and sets the default values.
         */
        public EducationAssignmentPointsGradeTypeMaxPoints() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static EducationAssignmentPointsGradeTypeMaxPoints createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final EducationAssignmentPointsGradeTypeMaxPoints result = new EducationAssignmentPointsGradeTypeMaxPoints();
