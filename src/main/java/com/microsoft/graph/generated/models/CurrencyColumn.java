...
public class CurrencyColumn implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CurrencyColumn} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CurrencyColumn createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
