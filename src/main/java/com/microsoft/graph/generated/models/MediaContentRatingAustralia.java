...
public class MediaContentRatingAustralia implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MediaContentRatingAustralia} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("movieRating", (n) -> { this.setMovieRating(n.getEnumValue(RatingAustraliaMoviesType::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("tvRating", (n) -> { this.setTvRating(n.getEnumValue(RatingAustraliaTelevisionType::forValue)); });
        return deserializerMap;
    }
    /**
     * Gets the movieRating property value. Movies rating labels in Australia
     * @return a {@link RatingAustraliaMoviesType}
     */
     ...
     * @return a {@link RatingAustraliaTelevisionType}
     */
    @jakarta.annotation.Nullable
