...
public class CloudPcAuditProperty implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcAuditProperty} and sets the default values.
     */
     ...
     * @return a {@link CloudPcAuditProperty}
     */
    @jakarta.annotation.Nonnull
    public static CloudPcAuditProperty createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
