...
public class BillingMetricsRecent extends BillingMetricsBase implements Parsable {
    /**
     * Instantiates a new {@link BillingMetricsRecent} and sets the default values.
     */
    public BillingMetricsRecent() {
        super();
    }
    /**
    ...
    public static BillingMetricsRecent createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
