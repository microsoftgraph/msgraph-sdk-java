...
public class IntelligenceProfileCountryOrRegionOfOrigin implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link IntelligenceProfileCountryOrRegionOfOrigin} and sets the default values.
     */
     ...
     * @return a {@link IntelligenceProfileCountryOrRegionOfOrigin}
     */
    @jakarta.annotation.Nonnull
    public static IntelligenceProfileCountryOrRegionOfOrigin createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
