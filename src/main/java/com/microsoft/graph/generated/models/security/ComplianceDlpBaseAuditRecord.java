...
public class ComplianceDlpBaseAuditRecord extends AuditData implements Parsable {
    /**
     * Instantiates a new {@link ComplianceDlpBaseAuditRecord} and sets the default values.
     */
    public ComplianceDlpBaseAuditRecord() {
        super();
        this.setOdataType("#microsoft.graph.security.complianceDlpBaseAuditRecord");
    }
    /**
