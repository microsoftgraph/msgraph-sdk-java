...
public class CustomAppManagementApplicationConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CustomAppManagementApplicationConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CustomAppManagementApplicationConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
