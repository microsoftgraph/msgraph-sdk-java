...
public class ObjectMappingMetadataEntry implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ObjectMappingMetadataEntry} and sets the default values.
     */
     ...
     * @return a {@link ObjectMappingMetadataEntry}
     */
    @jakarta.annotation.Nonnull
    public static ObjectMappingMetadataEntry createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
