...
public class FaceCheckConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FaceCheckConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static FaceCheckConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sourcePhotoClaimName", (n) -> { this.setSourcePhotoClaimName(n.getStringValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public String getSourcePhotoClaimName() {
        return this.backingStore.get("sourcePhotoClaimName");
    }
    /**
    ...
    public void setSourcePhotoClaimName(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("sourcePhotoClaimName", value);
    }
}
