...
public class ResultTemplateOption implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ResultTemplateOption} and sets the default values.
     */
    ...
    public Boolean getEnableResultTemplate() {
        return this.backingStore.get("enableResultTemplate");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enableResultTemplate", (n) -> { this.setEnableResultTemplate(n.getBooleanValue()); });
     ...
     */
    public void setEnableResultTemplate(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("enableResultTemplate", value);
    }
    /**
