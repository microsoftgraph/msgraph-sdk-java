...
public class PublicClientApplication implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PublicClientApplication} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static PublicClientApplication createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
