...
public class CloudPcAuditResource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcAuditResource} and sets the default values.
     */
     ...
     * @return a {@link CloudPcAuditResource}
     */
    @jakarta.annotation.Nonnull
    public static CloudPcAuditResource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link java.util.List<CloudPcAuditProperty>}
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setModifiedProperties(@jakarta.annotation.Nullable final java.util.List<CloudPcAuditProperty> value) {
