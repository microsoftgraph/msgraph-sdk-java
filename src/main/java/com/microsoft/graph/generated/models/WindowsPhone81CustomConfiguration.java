...
public class WindowsPhone81CustomConfiguration extends DeviceConfiguration implements Parsable {
    /**
     * Instantiates a new {@link WindowsPhone81CustomConfiguration} and sets the default values.
     */
     ...
     * @return a {@link WindowsPhone81CustomConfiguration}
     */
    @jakarta.annotation.Nonnull
    public static WindowsPhone81CustomConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
