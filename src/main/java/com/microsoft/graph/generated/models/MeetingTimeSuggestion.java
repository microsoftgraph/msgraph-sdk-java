...
public class MeetingTimeSuggestion implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a {@link MeetingTimeSuggestionConfidence}
     */
    @jakarta.annotation.Nullable
    public MeetingTimeSuggestionConfidence getConfidence() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("confidence", (n) -> { this.setConfidence(n.getObjectValue(MeetingTimeSuggestionConfidence::createFromDiscriminatorValue)); });
     ...
     */
    public void setConfidence(@jakarta.annotation.Nullable final MeetingTimeSuggestionConfidence value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class MeetingTimeSuggestionConfidence implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link MeetingTimeSuggestionConfidence} and sets the default values.
         */
        public MeetingTimeSuggestionConfidence() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static MeetingTimeSuggestionConfidence createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final MeetingTimeSuggestionConfidence result = new MeetingTimeSuggestionConfidence();
