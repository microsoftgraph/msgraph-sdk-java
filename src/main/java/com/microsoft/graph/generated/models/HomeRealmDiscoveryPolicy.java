...
public class HomeRealmDiscoveryPolicy extends StsPolicy implements Parsable {
    /**
     * Instantiates a new {@link HomeRealmDiscoveryPolicy} and sets the default values.
     */
    ...
    public static HomeRealmDiscoveryPolicy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
