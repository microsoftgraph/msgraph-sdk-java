...
public class ChallengingWord implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ChallengingWord} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ChallengingWord createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ChallengingWord();
    }
    /**
     ...
     */
    public void setWord(@jakarta.annotation.Nullable final String value) {
