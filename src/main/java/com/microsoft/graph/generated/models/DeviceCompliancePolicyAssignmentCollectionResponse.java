...
public class DeviceCompliancePolicyAssignmentCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link DeviceCompliancePolicyAssignmentCollectionResponse} and sets the default values.
     */
    ...
    public static DeviceCompliancePolicyAssignmentCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
