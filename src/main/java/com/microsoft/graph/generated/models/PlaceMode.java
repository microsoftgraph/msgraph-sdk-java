...
public class PlaceMode implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PlaceMode} and sets the default values.
     */
    public PlaceMode() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static PlaceMode createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
