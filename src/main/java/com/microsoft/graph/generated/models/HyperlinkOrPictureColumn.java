...
public class HyperlinkOrPictureColumn implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link HyperlinkOrPictureColumn} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static HyperlinkOrPictureColumn createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Boolean getIsPicture() {
        return this.backingStore.get("isPicture");
    }
    /**
     ...
     */
    public void setIsPicture(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("isPicture", value);
    }
    /**
