...
public class WindowsUpdateInstallScheduleType implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WindowsUpdateInstallScheduleType} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WindowsUpdateInstallScheduleType createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
