...
public class AuthenticationConditionApplicationCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(AuthenticationConditionApplication::createFromDiscriminatorValue)); });
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<AuthenticationConditionApplication> value) {
