...
public class UserAgent implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public String getHeaderValue() {
        return this.backingStore.get("headerValue");
    }
    /**
    ...
    public void setHeaderValue(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("headerValue", value);
    }
    /**
