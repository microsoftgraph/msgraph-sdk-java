...
public class Trending extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("weight", (n) -> { this.setWeight(n.getObjectValue(TrendingWeight::createFromDiscriminatorValue)); });
     ...
     * @return a {@link TrendingWeight}
     */
    @jakarta.annotation.Nullable
    public TrendingWeight getWeight() {
     ...
     */
    public void setWeight(@jakarta.annotation.Nullable final TrendingWeight value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class TrendingWeight implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link TrendingWeight} and sets the default values.
         */
        public TrendingWeight() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static TrendingWeight createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final TrendingWeight result = new TrendingWeight();
