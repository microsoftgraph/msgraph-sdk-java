...
public class OnenoteOperationError implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link OnenoteOperationError} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static OnenoteOperationError createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
