...
public class GenericError implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GenericError} and sets the default values.
     */
    public GenericError() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static GenericError createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
