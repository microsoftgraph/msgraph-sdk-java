...
public class GeoCoordinates implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a {@link GeoCoordinatesAltitude}
     */
    @jakarta.annotation.Nullable
    public GeoCoordinatesAltitude getAltitude() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("altitude", (n) -> { this.setAltitude(n.getObjectValue(GeoCoordinatesAltitude::createFromDiscriminatorValue)); });
        deserializerMap.put("latitude", (n) -> { this.setLatitude(n.getObjectValue(GeoCoordinatesLatitude::createFromDiscriminatorValue)); });
        deserializerMap.put("longitude", (n) -> { this.setLongitude(n.getObjectValue(GeoCoordinatesLongitude::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the latitude property value. Optional. The latitude, in decimal, for the item. Read-only.
     * @return a {@link GeoCoordinatesLatitude}
     */
    @jakarta.annotation.Nullable
    public GeoCoordinatesLatitude getLatitude() {
     ...
     * @return a {@link GeoCoordinatesLongitude}
     */
    @jakarta.annotation.Nullable
    public GeoCoordinatesLongitude getLongitude() {
     ...
     */
    public void setAltitude(@jakarta.annotation.Nullable final GeoCoordinatesAltitude value) {
     ...
     */
    public void setLatitude(@jakarta.annotation.Nullable final GeoCoordinatesLatitude value) {
     ...
     */
    public void setLongitude(@jakarta.annotation.Nullable final GeoCoordinatesLongitude value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class GeoCoordinatesAltitude implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link GeoCoordinatesAltitude} and sets the default values.
         */
        public GeoCoordinatesAltitude() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static GeoCoordinatesAltitude createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final GeoCoordinatesAltitude result = new GeoCoordinatesAltitude();
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class GeoCoordinatesLatitude implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link GeoCoordinatesLatitude} and sets the default values.
         */
        public GeoCoordinatesLatitude() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static GeoCoordinatesLatitude createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final GeoCoordinatesLatitude result = new GeoCoordinatesLatitude();
            final ParseNode mappingValueNode = parseNode.getChildNode("");
            if (mappingValueNode != null) {
                final String mappingValue = mappingValueNode.getStringValue();
            }
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class GeoCoordinatesLongitude implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link GeoCoordinatesLongitude} and sets the default values.
         */
        public GeoCoordinatesLongitude() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static GeoCoordinatesLongitude createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final GeoCoordinatesLongitude result = new GeoCoordinatesLongitude();
            final ParseNode mappingValueNode = parseNode.getChildNode("");
            if (mappingValueNode != null) {
                final String mappingValue = mappingValueNode.getStringValue();
            }
