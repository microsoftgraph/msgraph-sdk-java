...
public class NumberColumn implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maximum", (n) -> { this.setMaximum(n.getObjectValue(NumberColumnMaximum::createFromDiscriminatorValue)); });
        deserializerMap.put("minimum", (n) -> { this.setMinimum(n.getObjectValue(NumberColumnMinimum::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the maximum property value. The maximum permitted value.
     * @return a {@link NumberColumnMaximum}
     */
    @jakarta.annotation.Nullable
    public NumberColumnMaximum getMaximum() {
        return this.backingStore.get("maximum");
    }
    /**
     * Gets the minimum property value. The minimum permitted value.
     * @return a {@link NumberColumnMinimum}
     */
    @jakarta.annotation.Nullable
    public NumberColumnMinimum getMinimum() {
     ...
     */
    public void setMaximum(@jakarta.annotation.Nullable final NumberColumnMaximum value) {
     ...
     */
    public void setMinimum(@jakarta.annotation.Nullable final NumberColumnMinimum value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class NumberColumnMaximum implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link NumberColumnMaximum} and sets the default values.
         */
        public NumberColumnMaximum() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static NumberColumnMaximum createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final NumberColumnMaximum result = new NumberColumnMaximum();
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class NumberColumnMinimum implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link NumberColumnMinimum} and sets the default values.
         */
        public NumberColumnMinimum() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static NumberColumnMinimum createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final NumberColumnMinimum result = new NumberColumnMinimum();
            final ParseNode mappingValueNode = parseNode.getChildNode("");
            if (mappingValueNode != null) {
                final String mappingValue = mappingValueNode.getStringValue();
            }
