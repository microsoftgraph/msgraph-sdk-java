...
public class WorkflowSetting implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WorkflowSetting} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WorkflowSetting createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the quarantineConfiguration property value. The threshold configuration that automatically halts the workflow when its conditions are met.
    ...
    /**
     * Sets the quarantineConfiguration property value. The threshold configuration that automatically halts the workflow when its conditions are met.
