...
public class RetentionSetting implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RetentionSetting} and sets the default values.
     */
     ...
     * @return a {@link RetentionSetting}
     */
    @jakarta.annotation.Nonnull
    public static RetentionSetting createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("period", (n) -> { this.setPeriod(n.getPeriodAndDurationValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public PeriodAndDuration getPeriod() {
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writePeriodAndDurationValue("period", this.getPeriod());
