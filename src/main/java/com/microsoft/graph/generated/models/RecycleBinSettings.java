...
public class RecycleBinSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RecycleBinSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static RecycleBinSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("retentionPeriodOverrideDays", (n) -> { this.setRetentionPeriodOverrideDays(n.getIntegerValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public Integer getRetentionPeriodOverrideDays() {
        return this.backingStore.get("retentionPeriodOverrideDays");
    }
    /**
    ...
    public void setRetentionPeriodOverrideDays(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("retentionPeriodOverrideDays", value);
    }
}
