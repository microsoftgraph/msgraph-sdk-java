...
public class TrainingSetting implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link TrainingSetting} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static TrainingSetting createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        final ParseNode mappingValueNode = parseNode.getChildNode("@odata.type");
        if (mappingValueNode != null) {
            final String mappingValue = mappingValueNode.getStringValue();
            switch (mappingValue) {
                case "#microsoft.graph.customTrainingSetting": return new CustomTrainingSetting();
                case "#microsoft.graph.microsoftCustomTrainingSetting": return new MicrosoftCustomTrainingSetting();
                case "#microsoft.graph.microsoftManagedTrainingSetting": return new MicrosoftManagedTrainingSetting();
                case "#microsoft.graph.microsoftTrainingAssignmentMapping": return new MicrosoftTrainingAssignmentMapping();
                case "#microsoft.graph.noTrainingSetting": return new NoTrainingSetting();
            }
        }
