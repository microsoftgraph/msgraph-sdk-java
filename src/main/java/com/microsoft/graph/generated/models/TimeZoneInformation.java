...
public class TimeZoneInformation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TimeZoneInformation} and sets the default values.
     */
     ...
     * @return a {@link TimeZoneInformation}
     */
    @jakarta.annotation.Nonnull
    public static TimeZoneInformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
