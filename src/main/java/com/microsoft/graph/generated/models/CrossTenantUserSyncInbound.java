...
public class CrossTenantUserSyncInbound implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CrossTenantUserSyncInbound} and sets the default values.
     */
    ...
    public Boolean getIsSyncAllowed() {
        return this.backingStore.get("isSyncAllowed");
    }
    /**
    ...
    public void setIsSyncAllowed(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("isSyncAllowed", value);
    }
    /**
