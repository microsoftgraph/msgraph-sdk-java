...
public class LocalizedName implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link LocalizedName} and sets the default values.
     */
     ...
     * @return a {@link LocalizedName}
     */
    @jakarta.annotation.Nonnull
    public static LocalizedName createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
