...
/**
 * The class for the Base Workbook Range Resized Range Request.
 */
public class BaseWorkbookRangeResizedRangeRequest extends BaseRequest implements IBaseWorkbookRangeResizedRangeRequest {
     ...
     */
    public BaseWorkbookRangeResizedRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookRangeResizedRangeRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookRangeResizedRangeRequest expand(final String value) {
