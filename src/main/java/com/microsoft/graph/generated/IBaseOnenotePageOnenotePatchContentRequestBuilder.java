...
/**
 * The interface for the Base Onenote Page Onenote Patch Content Request Builder.
 */
public interface IBaseOnenotePageOnenotePatchContentRequestBuilder extends IRequestBuilder {
     ...
     * @return The IOnenotePageOnenotePatchContentRequest instance
     */
    IOnenotePageOnenotePatchContentRequest buildRequest(final java.util.List<Option> requestOptions);
}
