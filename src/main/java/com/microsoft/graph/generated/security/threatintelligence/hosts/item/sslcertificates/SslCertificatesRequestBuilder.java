package com.microsoft.graph.security.threatintelligence.hosts.item.sslcertificates;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.security.HostSslCertificateCollectionResponse;
import com.microsoft.graph.security.threatintelligence.hosts.item.sslcertificates.count.CountRequestBuilder;
import com.microsoft.graph.security.threatintelligence.hosts.item.sslcertificates.item.HostSslCertificateItemRequestBuilder;
...
public class SslCertificatesRequestBuilder extends BaseRequestBuilder {
    ...
    public SslCertificatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/sslCertificates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SslCertificatesRequestBuilder and sets the default values.
