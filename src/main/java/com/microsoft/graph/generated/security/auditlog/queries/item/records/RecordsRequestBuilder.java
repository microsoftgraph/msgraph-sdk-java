package com.microsoft.graph.security.auditlog.queries.item.records;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.security.AuditLogRecord;
import com.microsoft.graph.models.security.AuditLogRecordCollectionResponse;
import com.microsoft.graph.security.auditlog.queries.item.records.count.CountRequestBuilder;
import com.microsoft.graph.security.auditlog.queries.item.records.item.AuditLogRecordItemRequestBuilder;
...
public class RecordsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public AuditLogRecordItemRequestBuilder byAuditLogRecordId(@jakarta.annotation.Nonnull final String auditLogRecordId) {
        Objects.requireNonNull(auditLogRecordId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("auditLogRecord%2Did", auditLogRecordId);
