...
import com.microsoft.graph.models.security.StatisticsOptions;
...
public class EstimateStatisticsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EstimateStatisticsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link EstimateStatisticsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static EstimateStatisticsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new EstimateStatisticsPostRequestBody();
    }
    /**
