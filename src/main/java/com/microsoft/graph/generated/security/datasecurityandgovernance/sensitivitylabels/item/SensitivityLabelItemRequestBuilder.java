package com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.SensitivityLabel;
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.rights.RightsRequestBuilder;
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.sublabels.SublabelsRequestBuilder;
...
public class SensitivityLabelItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SensitivityLabelItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SensitivityLabelItemRequestBuilder} and sets the default values.
    ...
    public SensitivityLabelItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/sensitivitylabel-get?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}{?%24expand,%24select}", pathParameters);
