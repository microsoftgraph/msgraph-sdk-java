package com.microsoft.graph.security.identities.identityaccounts.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.security.IdentityAccounts;
import com.microsoft.graph.security.identities.identityaccounts.item.microsoftgraphsecurityinvokeaction.MicrosoftGraphSecurityInvokeActionRequestBuilder;
...
public class IdentityAccountsItemRequestBuilder extends BaseRequestBuilder {
    ...
    public IdentityAccountsItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/identityAccounts/{identityAccounts%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link IdentityAccountsItemRequestBuilder} and sets the default values.
    ...
    public IdentityAccountsItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/identityAccounts/{identityAccounts%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-identityaccounts-get?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/identities/identityAccounts/{identityAccounts%2Did}{?%24expand,%24select}", pathParameters);
