package com.microsoft.graph.security.labels.categories.item.subcategories;
...
import com.microsoft.graph.security.labels.categories.item.subcategories.count.CountRequestBuilder;
import com.microsoft.graph.security.labels.categories.item.subcategories.item.SubcategoryTemplateItemRequestBuilder;
...
public class SubcategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subcategories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
