package com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.sublabels;
...
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.sublabels.computeinheritancewithlabelidswithlocalewithcontentformats.ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e;
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.sublabels.computerightsandinheritance.ComputeRightsAndInheritanceRequestBuilder;
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.sublabels.count.CountRequestBuilder;
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.sublabels.item.SensitivityLabelItemRequestBuilder;
...
public class SublabelsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public SensitivityLabelItemRequestBuilder bySensitivityLabelId1(@jakarta.annotation.Nonnull final String sensitivityLabelId1) {
        Objects.requireNonNull(sensitivityLabelId1);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("sensitivityLabel%2Did1", sensitivityLabelId1);
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SensitivityLabel body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public SublabelsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
