...
public class LandingPageItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link LandingPageItemRequestBuilder} and sets the default values.
    ...
    public LandingPageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link LandingPageItemRequestBuilder} and sets the default values.
    ...
    public LandingPageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public LandingPage patch(@jakarta.annotation.Nonnull final LandingPage body) {
     ...
     */
    @jakarta.annotation.Nullable
    public LandingPage patch(@jakarta.annotation.Nonnull final LandingPage body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final LandingPage body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link LandingPageItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
