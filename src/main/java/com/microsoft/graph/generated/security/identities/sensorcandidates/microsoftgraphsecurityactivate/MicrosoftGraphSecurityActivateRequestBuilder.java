...
public class MicrosoftGraphSecurityActivateRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphSecurityActivateRequestBuilder} and sets the default values.
    ...
    public MicrosoftGraphSecurityActivateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/sensorCandidates/microsoft.graph.security.activate", pathParameters);
    }
    /**
     * Instantiates a new {@link MicrosoftGraphSecurityActivateRequestBuilder} and sets the default values.
    ...
    public MicrosoftGraphSecurityActivateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/sensorCandidates/microsoft.graph.security.activate", rawUrl);
    }
    /**
     * Activate Microsoft Defender for Identity sensors.
     * @param body The request body
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-sensorcandidate-activate?view=graph-rest-1.0">Find more info here</a>
     */
