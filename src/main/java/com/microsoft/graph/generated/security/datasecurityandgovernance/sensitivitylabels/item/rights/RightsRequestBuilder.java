package com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.item.rights;
...
public class RightsRequestBuilder extends BaseRequestBuilder {
    ...
    public RightsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/rights{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RightsRequestBuilder} and sets the default values.
    ...
    public RightsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/rights{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/usagerightsincluded-get?view=graph-rest-1.0">Find more info here</a>
     */
