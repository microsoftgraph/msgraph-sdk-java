package com.microsoft.graph.security.identities.settings.autoauditingconfiguration;
...
public class AutoAuditingConfigurationRequestBuilder extends BaseRequestBuilder {
    ...
    public AutoAuditingConfigurationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/settings/autoAuditingConfiguration", pathParameters);
    }
    /**
     * Instantiates a new {@link AutoAuditingConfigurationRequestBuilder} and sets the default values.
    ...
    public AutoAuditingConfigurationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/settings/autoAuditingConfiguration", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-autoauditingconfiguration-get?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @return a {@link AutoAuditingConfiguration}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-autoauditingconfiguration-update?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/identities/settings/autoAuditingConfiguration{?%24expand,%24select}", pathParameters);
