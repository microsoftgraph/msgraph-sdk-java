package com.microsoft.graph.security.attacksimulation.simulationautomations.item.runs.count;
...
public class CountRequestBuilder extends BaseRequestBuilder {
    ...
    public CountRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs/$count{?%24search,%24filter}", pathParameters);
    }
    /**
     * Instantiates a new CountRequestBuilder and sets the default values.
    ...
    public CountRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs/$count{?%24search,%24filter}", rawUrl);
    }
    /**
