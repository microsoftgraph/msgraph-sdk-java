package com.microsoft.graph.security.labels.retentionlabels.item.retentioneventtype;
...
public class RetentionEventTypeRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RetentionEventTypeRequestBuilder} and sets the default values.
    ...
    public RetentionEventTypeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/retentionEventType{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RetentionEventTypeRequestBuilder} and sets the default values.
    ...
    public RetentionEventTypeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/retentionEventType{?%24expand,%24select}", rawUrl);
    }
    /**
