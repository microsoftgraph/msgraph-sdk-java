...
public class PayloadItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link PayloadItemRequestBuilder} and sets the default values.
    ...
    public PayloadItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/attackSimulation/payloads/{payload%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PayloadItemRequestBuilder} and sets the default values.
    ...
    public PayloadItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/attackSimulation/payloads/{payload%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/payload-get?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/attackSimulation/payloads/{payload%2Did}{?%24expand,%24select}", pathParameters);
