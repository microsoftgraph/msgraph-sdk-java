...
public class TrackersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link TrackersRequestBuilder} and sets the default values.
    ...
    public TrackersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/trackers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TrackersRequestBuilder} and sets the default values.
