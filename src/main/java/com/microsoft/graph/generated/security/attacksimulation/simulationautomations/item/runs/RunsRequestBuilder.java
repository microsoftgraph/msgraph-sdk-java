...
public class RunsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public SimulationAutomationRunItemRequestBuilder bySimulationAutomationRunId(@jakarta.annotation.Nonnull final String simulationAutomationRunId) {
        Objects.requireNonNull(simulationAutomationRunId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("simulationAutomationRun%2Did", simulationAutomationRunId);
    ...
    public SimulationAutomationRunCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, SimulationAutomationRunCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public SimulationAutomationRun post(@jakarta.annotation.Nonnull final SimulationAutomationRun body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SimulationAutomationRun post(@jakarta.annotation.Nonnull final SimulationAutomationRun body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SimulationAutomationRun body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SimulationAutomationRun body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs", pathParameters);
