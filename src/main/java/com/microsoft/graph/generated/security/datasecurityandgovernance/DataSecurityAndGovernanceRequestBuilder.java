...
import com.microsoft.graph.security.datasecurityandgovernance.sensitivitylabels.SensitivityLabelsRequestBuilder;
...
public class DataSecurityAndGovernanceRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/dataSecurityAndGovernance{?%24expand,%24select}", pathParameters);
