...
public class LockPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link LockPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link LockPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static LockPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new LockPostRequestBody();
    }
    /**
