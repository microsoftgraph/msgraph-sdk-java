...
public class IsoCeilingPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link IsoCeilingPostRequestBody} and sets the default values.
     */
    public IsoCeilingPostRequestBody() {
     ...
     * @return a {@link IsoCeilingPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static IsoCeilingPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new IsoCeilingPostRequestBody();
    }
    /**
