package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.besselj;
...
public class BesselJPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BesselJPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link BesselJPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static BesselJPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
