package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.imcosh;
...
public class ImCoshPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImCoshPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImCoshPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImCoshPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
