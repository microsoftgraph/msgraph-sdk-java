package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.acot;
...
public class AcotRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AcotRequestBuilder} and sets the default values.
    ...
    public AcotRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/acot", pathParameters);
    }
    /**
     * Instantiates a new {@link AcotRequestBuilder} and sets the default values.
    ...
    public AcotRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/acot", rawUrl);
    }
    /**
     * Invoke action acot
