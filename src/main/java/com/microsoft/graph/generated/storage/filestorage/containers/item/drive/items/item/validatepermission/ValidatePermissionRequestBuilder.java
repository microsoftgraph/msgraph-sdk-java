package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.validatepermission;
...
public class ValidatePermissionRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ValidatePermissionRequestBuilder} and sets the default values.
    ...
    public ValidatePermissionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/validatePermission", pathParameters);
    }
    /**
     * Instantiates a new {@link ValidatePermissionRequestBuilder} and sets the default values.
    ...
    public ValidatePermissionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/validatePermission", rawUrl);
    }
    /**
     ...
     */
    public void post(@jakarta.annotation.Nonnull final ValidatePermissionPostRequestBody body) {
        post(body, null);
    }
    /**
     * Invoke action validatePermission
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    public void post(@jakarta.annotation.Nonnull final ValidatePermissionPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
