package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.bitxor;
...
public class BitxorPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BitxorPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link BitxorPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static BitxorPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
