...
public class PmtPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PmtPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PmtPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static PmtPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
