package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.gamma_inv;
...
public class GammaInvPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link GammaInvPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GammaInvPostRequestBody}
     */
    @jakarta.annotation.Nonnull
