package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.tbillyield;
...
public class TbillYieldPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link TbillYieldPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link TbillYieldPostRequestBody}
     */
    @jakarta.annotation.Nonnull
