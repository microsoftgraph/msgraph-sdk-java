...
public class DollarPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DollarPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DollarPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DollarPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public UntypedNode getDecimals() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("decimals", (n) -> { this.setDecimals(n.getObjectValue(UntypedNode::createFromDiscriminatorValue)); });
     ...
     */
    public void setDecimals(@jakarta.annotation.Nullable final UntypedNode value) {
