package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.protection;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.WorkbookWorksheetProtection;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.protection.protect.ProtectRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.protection.unprotect.UnprotectRequestBuilder;
