package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.bitlshift;
...
public class BitlshiftPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
