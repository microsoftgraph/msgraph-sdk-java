package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.besseli;
...
public class BesselIRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link BesselIRequestBuilder} and sets the default values.
    ...
    public BesselIRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/besselI", pathParameters);
    }
    /**
     * Instantiates a new {@link BesselIRequestBuilder} and sets the default values.
    ...
    public BesselIRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/besselI", rawUrl);
    }
    /**
    ...
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final BesselIPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final BesselIPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
