package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.z_test;
...
public class ZTestPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link ZTestPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ZTestPostRequestBody}
     */
    @jakarta.annotation.Nonnull
