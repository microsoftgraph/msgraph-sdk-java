package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.tbilleq;
...
public class TbillEqPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link TbillEqPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link TbillEqPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static TbillEqPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
