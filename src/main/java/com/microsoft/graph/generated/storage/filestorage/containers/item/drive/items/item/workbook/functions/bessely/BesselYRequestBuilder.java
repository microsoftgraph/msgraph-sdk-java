package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.bessely;
...
public class BesselYRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link BesselYRequestBuilder} and sets the default values.
    ...
    public BesselYRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/besselY", pathParameters);
    }
    /**
     * Instantiates a new {@link BesselYRequestBuilder} and sets the default values.
    ...
    public BesselYRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/besselY", rawUrl);
    }
    /**
