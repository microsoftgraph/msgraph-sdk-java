package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.hex2dec;
...
public class Hex2DecRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link Hex2DecRequestBuilder} and sets the default values.
    ...
    public Hex2DecRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/hex2Dec", pathParameters);
    }
    /**
     * Instantiates a new {@link Hex2DecRequestBuilder} and sets the default values.
    ...
    public Hex2DecRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/hex2Dec", rawUrl);
    }
    /**
