package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.dstdevp;
...
public class DstDevPPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DstDevPPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DstDevPPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DstDevPPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
