package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.rate;
...
public class RatePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link RatePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RatePostRequestBody}
     */
    @jakarta.annotation.Nonnull
