package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.month;
...
public class MonthPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MonthPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link MonthPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static MonthPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
