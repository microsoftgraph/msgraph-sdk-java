package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.averageifs;
...
public class AverageIfsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link AverageIfsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AverageIfsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
