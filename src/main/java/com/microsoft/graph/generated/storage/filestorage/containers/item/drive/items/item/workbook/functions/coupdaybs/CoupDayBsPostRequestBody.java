package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.coupdaybs;
...
public class CoupDayBsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CoupDayBsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CoupDayBsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CoupDayBsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
