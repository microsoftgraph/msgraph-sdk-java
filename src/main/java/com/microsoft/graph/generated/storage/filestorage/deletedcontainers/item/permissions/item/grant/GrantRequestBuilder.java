package com.microsoft.graph.storage.filestorage.deletedcontainers.item.permissions.item.grant;
...
public class GrantRequestBuilder extends BaseRequestBuilder {
    ...
    public GrantRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/permissions/{permission%2Did}/grant", pathParameters);
    }
    /**
     * Instantiates a new {@link GrantRequestBuilder} and sets the default values.
    ...
    public GrantRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/permissions/{permission%2Did}/grant", rawUrl);
    }
    /**
