package com.microsoft.graph.storage.filestorage.containers.item.drive.list.items.item.lastmodifiedbyuser;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.User;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.items.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.items.item.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
