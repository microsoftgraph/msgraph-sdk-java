...
public class ImCosPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImCosPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImCosPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImCosPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
