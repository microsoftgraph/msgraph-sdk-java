package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.right;
...
public class RightPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link RightPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RightPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RightPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
