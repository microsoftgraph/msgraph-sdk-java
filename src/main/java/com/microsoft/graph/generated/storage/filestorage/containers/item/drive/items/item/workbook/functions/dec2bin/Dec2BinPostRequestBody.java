package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.dec2bin;
...
public class Dec2BinPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Dec2BinPostRequestBody} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static Dec2BinPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
