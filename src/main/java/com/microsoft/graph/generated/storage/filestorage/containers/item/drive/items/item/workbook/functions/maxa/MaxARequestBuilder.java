package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.maxa;
...
public class MaxARequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MaxARequestBuilder} and sets the default values.
    ...
    public MaxARequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/maxA", pathParameters);
    }
    /**
     * Instantiates a new {@link MaxARequestBuilder} and sets the default values.
    ...
    public MaxARequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/maxA", rawUrl);
    }
    /**
     * Invoke action maxA
