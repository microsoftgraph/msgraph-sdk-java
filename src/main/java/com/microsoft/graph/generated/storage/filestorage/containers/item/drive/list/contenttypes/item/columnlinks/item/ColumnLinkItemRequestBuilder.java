package com.microsoft.graph.storage.filestorage.containers.item.drive.list.contenttypes.item.columnlinks.item;
...
public class ColumnLinkItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ColumnLinkItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columnLinks/{columnLink%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ColumnLinkItemRequestBuilder} and sets the default values.
    ...
    public ColumnLinkItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columnLinks/{columnLink%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
