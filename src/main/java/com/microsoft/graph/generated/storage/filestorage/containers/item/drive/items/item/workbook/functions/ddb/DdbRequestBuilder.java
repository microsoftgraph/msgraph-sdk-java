...
public class DdbRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link DdbRequestBuilder} and sets the default values.
    ...
    public DdbRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/ddb", pathParameters);
    }
    /**
     * Instantiates a new {@link DdbRequestBuilder} and sets the default values.
    ...
    public DdbRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/ddb", rawUrl);
    }
    /**
     * Invoke action ddb
