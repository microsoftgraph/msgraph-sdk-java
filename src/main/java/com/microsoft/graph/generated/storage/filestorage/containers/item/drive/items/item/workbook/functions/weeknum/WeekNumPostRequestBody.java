package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.weeknum;
...
public class WeekNumPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WeekNumPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link WeekNumPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static WeekNumPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
