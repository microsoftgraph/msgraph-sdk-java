package com.microsoft.graph.storage.filestorage.containers.item.lock;
...
public class LockRequestBuilder extends BaseRequestBuilder {
    ...
    public LockRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/lock", pathParameters);
    }
    /**
     * Instantiates a new {@link LockRequestBuilder} and sets the default values.
    ...
    public LockRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/lock", rawUrl);
    }
    /**
     * Invoke action lock
     ...
     */
    public void post(@jakarta.annotation.Nonnull final LockPostRequestBody body) {
        post(body, null);
    }
    /**
     * Invoke action lock
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    public void post(@jakarta.annotation.Nonnull final LockPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
