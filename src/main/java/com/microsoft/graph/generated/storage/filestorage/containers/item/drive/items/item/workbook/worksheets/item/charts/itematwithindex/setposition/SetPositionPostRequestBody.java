package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.charts.itematwithindex.setposition;
...
public class SetPositionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link SetPositionPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SetPositionPostRequestBody}
     */
    @jakarta.annotation.Nonnull
