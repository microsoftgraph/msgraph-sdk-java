package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.coupdaysnc;
...
public class CoupDaysNcPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CoupDaysNcPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CoupDaysNcPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CoupDaysNcPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
