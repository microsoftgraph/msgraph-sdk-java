package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.yield;
...
public class YieldPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link YieldPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link YieldPostRequestBody}
     */
    @jakarta.annotation.Nonnull
