...
public class ImCschPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImCschPostRequestBody} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ImCschPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
