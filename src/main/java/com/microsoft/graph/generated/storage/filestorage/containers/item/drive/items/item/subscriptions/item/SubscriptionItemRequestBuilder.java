package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.subscriptions.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.Subscription;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
...
public class SubscriptionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SubscriptionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/subscriptions/{subscription%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SubscriptionItemRequestBuilder} and sets the default values.
    ...
    public SubscriptionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/subscriptions/{subscription%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
