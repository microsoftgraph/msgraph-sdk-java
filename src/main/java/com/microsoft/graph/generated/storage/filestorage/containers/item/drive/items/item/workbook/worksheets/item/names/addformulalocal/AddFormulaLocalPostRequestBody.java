package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.names.addformulalocal;
...
public class AddFormulaLocalPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link AddFormulaLocalPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AddFormulaLocalPostRequestBody}
     */
    @jakarta.annotation.Nonnull
