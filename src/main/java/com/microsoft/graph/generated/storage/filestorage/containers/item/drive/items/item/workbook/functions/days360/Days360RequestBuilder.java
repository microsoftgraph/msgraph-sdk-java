...
public class Days360RequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link Days360RequestBuilder} and sets the default values.
    ...
    public Days360RequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/days360", pathParameters);
    }
    /**
     * Instantiates a new {@link Days360RequestBuilder} and sets the default values.
    ...
    public Days360RequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/days360", rawUrl);
    }
    /**
    ...
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final Days360PostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final Days360PostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
