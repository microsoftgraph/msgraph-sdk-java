package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.protection.protect;
...
public class ProtectPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ProtectPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ProtectPostRequestBody}
     */
    @jakarta.annotation.Nonnull
