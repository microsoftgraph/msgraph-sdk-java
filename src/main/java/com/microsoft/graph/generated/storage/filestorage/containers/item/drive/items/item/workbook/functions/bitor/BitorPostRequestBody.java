package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.bitor;
...
public class BitorPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BitorPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link BitorPostRequestBody}
     */
    @jakarta.annotation.Nonnull
