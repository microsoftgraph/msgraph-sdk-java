package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.bin2hex;
...
public class Bin2HexPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Bin2HexPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link Bin2HexPostRequestBody}
     */
    @jakarta.annotation.Nonnull
