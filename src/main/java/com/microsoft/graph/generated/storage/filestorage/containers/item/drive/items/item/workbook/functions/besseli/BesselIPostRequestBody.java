...
public class BesselIPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BesselIPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link BesselIPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static BesselIPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
