package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.subscriptions.item.reauthorize;
...
public class ReauthorizeRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ReauthorizeRequestBuilder} and sets the default values.
    ...
    public ReauthorizeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/subscriptions/{subscription%2Did}/reauthorize", pathParameters);
    }
    /**
     * Instantiates a new {@link ReauthorizeRequestBuilder} and sets the default values.
    ...
    public ReauthorizeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/subscriptions/{subscription%2Did}/reauthorize", rawUrl);
    }
    /**
