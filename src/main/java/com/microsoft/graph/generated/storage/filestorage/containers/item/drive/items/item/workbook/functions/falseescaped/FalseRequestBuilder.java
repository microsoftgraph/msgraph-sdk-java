package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.falseescaped;
...
public class FalseRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link FalseRequestBuilder} and sets the default values.
    ...
    public FalseRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/false", pathParameters);
    }
    /**
     * Instantiates a new {@link FalseRequestBuilder} and sets the default values.
    ...
    public FalseRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/false", rawUrl);
    }
    /**
     * Invoke action false
     ...
     */
    @jakarta.annotation.Nonnull
    public FalseRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
