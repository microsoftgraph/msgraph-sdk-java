package com.microsoft.graph.storage.filestorage.containers.item.drive.list;

import com.microsoft.graph.models.List;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.columns.ColumnsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.contenttypes.ContentTypesRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.drive.DriveRequestBuilder;
...
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.operations.OperationsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.subscriptions.SubscriptionsRequestBuilder;
...
public class ListRequestBuilder extends BaseRequestBuilder {
    ...
    public ListRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ListRequestBuilder} and sets the default values.
    ...
    public ListRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list{?%24expand,%24select}", rawUrl);
    }
    /**
