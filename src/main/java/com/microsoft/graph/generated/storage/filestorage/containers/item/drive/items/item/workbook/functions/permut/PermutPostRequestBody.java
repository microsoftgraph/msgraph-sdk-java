...
public class PermutPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PermutPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PermutPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static PermutPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
