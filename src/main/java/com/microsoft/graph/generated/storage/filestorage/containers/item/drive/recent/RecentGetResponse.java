package com.microsoft.graph.storage.filestorage.containers.item.drive.recent;
...
public class RecentGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link RecentGetResponse} and sets the default values.
     */
    ...
    public static RecentGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
