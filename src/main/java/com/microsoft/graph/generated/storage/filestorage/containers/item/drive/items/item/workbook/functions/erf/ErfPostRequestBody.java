package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.erf;
...
public class ErfPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link ErfPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ErfPostRequestBody}
     */
    @jakarta.annotation.Nonnull
