package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.hyperlink;
...
public class HyperlinkPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link HyperlinkPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link HyperlinkPostRequestBody}
     */
    @jakarta.annotation.Nonnull
