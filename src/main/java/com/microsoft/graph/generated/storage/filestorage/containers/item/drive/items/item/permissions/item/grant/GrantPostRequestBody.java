package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.permissions.item.grant;
...
public class GrantPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GrantPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GrantPostRequestBody}
     */
    @jakarta.annotation.Nonnull
     ...
     * @return a {@link java.util.List<DriveRecipient>}
     */
