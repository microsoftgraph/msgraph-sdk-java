package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.f_inv;
...
public class FInvPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link FInvPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link FInvPostRequestBody}
     */
    @jakarta.annotation.Nonnull
