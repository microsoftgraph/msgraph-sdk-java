package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.charts.item.title.format.fill;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.WorkbookChartFill;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.charts.item.title.format.fill.clear.ClearRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.item.charts.item.title.format.fill.setsolidcolor.SetSolidColorRequestBuilder;
