...
public class IrrPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link IrrPostRequestBody} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static IrrPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
