package com.microsoft.graph.storage.filestorage.containers.item.recyclebin.items.item.createdbyuser.serviceprovisioningerrors;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.ServiceProvisioningErrorCollectionResponse;
import com.microsoft.graph.storage.filestorage.containers.item.recyclebin.items.item.createdbyuser.serviceprovisioningerrors.count.CountRequestBuilder;
...
public class ServiceProvisioningErrorsRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceProvisioningErrorsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/recycleBin/items/{recycleBinItem%2Did}/createdByUser/serviceProvisioningErrors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ServiceProvisioningErrorsRequestBuilder} and sets the default values.
    ...
    public ServiceProvisioningErrorsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/recycleBin/items/{recycleBinItem%2Did}/createdByUser/serviceProvisioningErrors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
