package com.microsoft.graph.storage.filestorage.deletedcontainers.item.restore;
...
public class RestoreRequestBuilder extends BaseRequestBuilder {
    ...
    public RestoreRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/restore", pathParameters);
    }
    /**
     * Instantiates a new {@link RestoreRequestBuilder} and sets the default values.
    ...
    public RestoreRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/restore", rawUrl);
    }
    /**
    ...
    public FileStorageContainer post() {
        return post(null);
    }
    /**
     * Invoke action restore
     ...
     */
    @jakarta.annotation.Nullable
    public FileStorageContainer post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
