package com.microsoft.graph.storage.filestorage.containers.item.drive.list.contenttypes.addcopyfromcontenttypehub;
...
public class AddCopyFromContentTypeHubRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AddCopyFromContentTypeHubRequestBuilder} and sets the default values.
    ...
    public AddCopyFromContentTypeHubRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopyFromContentTypeHub", pathParameters);
    }
    /**
     * Instantiates a new {@link AddCopyFromContentTypeHubRequestBuilder} and sets the default values.
    ...
    public AddCopyFromContentTypeHubRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopyFromContentTypeHub", rawUrl);
    }
    /**
