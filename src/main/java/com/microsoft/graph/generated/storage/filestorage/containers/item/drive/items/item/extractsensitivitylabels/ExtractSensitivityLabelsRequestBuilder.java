package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.extractsensitivitylabels;
...
public class ExtractSensitivityLabelsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ExtractSensitivityLabelsRequestBuilder} and sets the default values.
    ...
    public ExtractSensitivityLabelsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/extractSensitivityLabels", pathParameters);
    }
    /**
     * Instantiates a new {@link ExtractSensitivityLabelsRequestBuilder} and sets the default values.
    ...
    public ExtractSensitivityLabelsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/extractSensitivityLabels", rawUrl);
    }
    /**
     * Invoke action extractSensitivityLabels
     * @return a {@link ExtractSensitivityLabelsResult}
