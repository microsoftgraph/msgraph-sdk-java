package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.imln;
...
public class ImLnPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImLnPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImLnPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImLnPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
