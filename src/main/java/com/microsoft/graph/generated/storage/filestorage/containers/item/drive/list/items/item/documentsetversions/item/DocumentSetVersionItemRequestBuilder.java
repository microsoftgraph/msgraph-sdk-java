package com.microsoft.graph.storage.filestorage.containers.item.drive.list.items.item.documentsetversions.item;

import com.microsoft.graph.models.DocumentSetVersion;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.items.item.documentsetversions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.list.items.item.documentsetversions.item.restore.RestoreRequestBuilder;
...
public class DocumentSetVersionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DocumentSetVersionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DocumentSetVersionItemRequestBuilder} and sets the default values.
    ...
    public DocumentSetVersionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
