package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.rows;
...
public class RowsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RowsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RowsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RowsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
