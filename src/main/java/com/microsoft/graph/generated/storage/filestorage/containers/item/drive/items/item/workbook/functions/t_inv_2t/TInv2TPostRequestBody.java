package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.t_inv_2t;
...
public class TInv2TPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TInv2TPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link TInv2TPostRequestBody}
     */
    @jakarta.annotation.Nonnull
