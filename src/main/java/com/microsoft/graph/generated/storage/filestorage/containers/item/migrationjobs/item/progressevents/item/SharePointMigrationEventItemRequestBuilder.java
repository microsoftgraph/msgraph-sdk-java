package com.microsoft.graph.storage.filestorage.containers.item.migrationjobs.item.progressevents.item;
...
public class SharePointMigrationEventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SharePointMigrationEventItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs/{sharePointMigrationJob%2Did}/progressEvents/{sharePointMigrationEvent%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SharePointMigrationEventItemRequestBuilder} and sets the default values.
    ...
    public SharePointMigrationEventItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs/{sharePointMigrationJob%2Did}/progressEvents/{sharePointMigrationEvent%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs/{sharePointMigrationJob%2Did}/progressEvents/{sharePointMigrationEvent%2Did}{?%24expand,%24select}", pathParameters);
