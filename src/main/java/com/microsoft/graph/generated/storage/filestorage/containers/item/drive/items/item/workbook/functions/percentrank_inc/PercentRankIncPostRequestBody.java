...
public class PercentRankIncPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PercentRankIncPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PercentRankIncPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static PercentRankIncPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
