package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.Workbook;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.application.ApplicationRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.closesession.CloseSessionRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.comments.CommentsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.createsession.CreateSessionRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.FunctionsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.names.NamesRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.operations.OperationsRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.refreshsession.RefreshSessionRequestBuilder;
...
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.tables.TablesRequestBuilder;
import com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.worksheets.WorksheetsRequestBuilder;
