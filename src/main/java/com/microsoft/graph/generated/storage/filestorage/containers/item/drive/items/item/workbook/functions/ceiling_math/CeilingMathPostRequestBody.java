package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.ceiling_math;
...
public class CeilingMathPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CeilingMathPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CeilingMathPostRequestBody}
     */
    @jakarta.annotation.Nonnull
