package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.exp;
...
public class ExpRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ExpRequestBuilder} and sets the default values.
    ...
    public ExpRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/exp", pathParameters);
    }
    /**
     * Instantiates a new {@link ExpRequestBuilder} and sets the default values.
    ...
    public ExpRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/exp", rawUrl);
    }
    /**
     * Invoke action exp
    ...
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final ExpPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final ExpPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public ExpRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
