package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.ecma_ceiling;
...
public class EcmaCeilingRequestBuilder extends BaseRequestBuilder {
    ...
    public EcmaCeilingRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/ecma_Ceiling", pathParameters);
    }
    /**
     * Instantiates a new {@link EcmaCeilingRequestBuilder} and sets the default values.
    ...
    public EcmaCeilingRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/ecma_Ceiling", rawUrl);
    }
    /**
    ...
    public EcmaCeilingRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        ...
        return new EcmaCeilingRequestBuilder(rawUrl, requestAdapter);
    }
    /**
