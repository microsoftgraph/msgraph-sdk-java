package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.standardize;
...
public class StandardizePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link StandardizePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link StandardizePostRequestBody}
     */
    @jakarta.annotation.Nonnull
