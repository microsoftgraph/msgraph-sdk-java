package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.createuploadsession;
...
public class CreateUploadSessionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("item", (n) -> { this.setItem(n.getObjectValue(DriveItemUploadableProperties::createFromDiscriminatorValue)); });
     ...
     */
    public void setItem(@jakarta.annotation.Nullable final DriveItemUploadableProperties value) {
