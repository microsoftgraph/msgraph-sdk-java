package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.quartile_exc;
...
public class QuartileExcPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link QuartileExcPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link QuartileExcPostRequestBody}
     */
    @jakarta.annotation.Nonnull
