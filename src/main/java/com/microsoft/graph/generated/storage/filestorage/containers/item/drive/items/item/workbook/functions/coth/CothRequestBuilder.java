package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.coth;
...
public class CothRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CothRequestBuilder} and sets the default values.
    ...
    public CothRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/coth", pathParameters);
    }
    /**
     * Instantiates a new {@link CothRequestBuilder} and sets the default values.
    ...
    public CothRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/coth", rawUrl);
    }
    /**
     * Invoke action coth
