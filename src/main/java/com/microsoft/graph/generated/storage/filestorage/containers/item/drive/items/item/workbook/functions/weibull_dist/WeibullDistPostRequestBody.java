...
public class WeibullDistPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WeibullDistPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link WeibullDistPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static WeibullDistPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
