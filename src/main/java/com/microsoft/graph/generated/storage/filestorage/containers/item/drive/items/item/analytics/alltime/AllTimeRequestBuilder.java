package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.analytics.alltime;
...
public class AllTimeRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AllTimeRequestBuilder} and sets the default values.
    ...
    public AllTimeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/analytics/allTime{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AllTimeRequestBuilder} and sets the default values.
    ...
    public AllTimeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/analytics/allTime{?%24expand,%24select}", rawUrl);
    }
    /**
