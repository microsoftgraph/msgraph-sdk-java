...
public class ImLog2PostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImLog2PostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImLog2PostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImLog2PostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
