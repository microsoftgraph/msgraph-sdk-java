package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.dcounta;
...
public class DcountAPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DcountAPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DcountAPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DcountAPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
