package com.microsoft.graph.storage.filestorage.containers.item.drive.items.item.workbook.functions.left;
...
public class LeftPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link LeftPostRequestBody} and sets the default values.
     */
