...
public class YearPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link YearPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link YearPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static YearPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
