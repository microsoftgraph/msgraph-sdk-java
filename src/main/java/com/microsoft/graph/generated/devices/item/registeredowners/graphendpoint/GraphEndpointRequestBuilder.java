package com.microsoft.graph.devices.item.registeredowners.graphendpoint;

import com.microsoft.graph.devices.item.registeredowners.graphendpoint.count.CountRequestBuilder;
...
public class GraphEndpointRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphEndpointRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.endpoint{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphEndpointRequestBuilder} and sets the default values.
    ...
    public GraphEndpointRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.endpoint{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
