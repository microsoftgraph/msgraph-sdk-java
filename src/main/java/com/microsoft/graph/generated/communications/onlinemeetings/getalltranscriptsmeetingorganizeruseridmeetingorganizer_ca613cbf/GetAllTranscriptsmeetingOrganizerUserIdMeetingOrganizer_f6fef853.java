package com.microsoft.graph.communications.onlinemeetings.getalltranscriptsmeetingorganizeruseridmeetingorganizer_ca613cbf;
...
public class GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853 extends BaseRequestBuilder {
     ...
     */
    public GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/getAllTranscripts(meetingOrganizerUserId='@meetingOrganizerUserId',startDateTime=@startDateTime,endDateTime=@endDateTime){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,endDateTime*,meetingOrganizerUserId*,startDateTime*}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853} and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_561b408a get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
