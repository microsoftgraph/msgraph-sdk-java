...
public class UpdateRecordingStatusPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UpdateRecordingStatusPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link UpdateRecordingStatusPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static UpdateRecordingStatusPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final RecordingStatus value) {
