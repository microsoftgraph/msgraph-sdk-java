...
public class GetPresencesByUserIdPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetPresencesByUserIdPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetPresencesByUserIdPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetPresencesByUserIdPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
