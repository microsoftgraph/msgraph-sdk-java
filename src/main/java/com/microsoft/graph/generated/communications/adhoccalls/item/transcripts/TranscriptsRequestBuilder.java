package com.microsoft.graph.communications.adhoccalls.item.transcripts;

import com.microsoft.graph.communications.adhoccalls.item.transcripts.count.CountRequestBuilder;
import com.microsoft.graph.communications.adhoccalls.item.transcripts.delta.DeltaRequestBuilder;
import com.microsoft.graph.communications.adhoccalls.item.transcripts.item.CallTranscriptItemRequestBuilder;
...
public class TranscriptsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link CallTranscriptItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link TranscriptsRequestBuilder} and sets the default values.
    ...
    public CallTranscriptCollectionResponse get() {
        return get(null);
    }
    /**
     * The transcripts of a call. Read-only.
     ...
     */
    @jakarta.annotation.Nullable
    public CallTranscriptCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, CallTranscriptCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public CallTranscript post(@jakarta.annotation.Nonnull final CallTranscript body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CallTranscript post(@jakarta.annotation.Nonnull final CallTranscript body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/transcripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CallTranscript body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/transcripts", pathParameters);
