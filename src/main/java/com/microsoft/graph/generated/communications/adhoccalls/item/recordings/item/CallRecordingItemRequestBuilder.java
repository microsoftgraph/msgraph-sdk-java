package com.microsoft.graph.communications.adhoccalls.item.recordings.item;

import com.microsoft.graph.communications.adhoccalls.item.recordings.item.content.ContentRequestBuilder;
...
public class CallRecordingItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CallRecordingItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings/{callRecording%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link CallRecordingItemRequestBuilder} and sets the default values.
    ...
    public CallRecordingItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings/{callRecording%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings/{callRecording%2Did}{?%24expand,%24select}", pathParameters);
