package com.microsoft.graph.communications.presences.item.setmanuallocation;
...
public class SetManualLocationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SetManualLocationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/presence-setmanuallocation?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/presence-setmanuallocation?view=graph-rest-1.0">Find more info here</a>
     */
    public void post(@jakarta.annotation.Nonnull final SetManualLocationPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SetManualLocationPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
