package com.microsoft.graph.communications.onlinemeetings.getallrecordingsmeetingorganizeruseridmeetingorganizeru_233783e7;
...
public class GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4 extends BaseRequestBuilder {
     ...
     */
    public GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/getAllRecordings(meetingOrganizerUserId='@meetingOrganizerUserId',startDateTime=@startDateTime,endDateTime=@endDateTime){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,endDateTime*,meetingOrganizerUserId*,startDateTime*}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4} and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_d8a14a3e get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
