package com.microsoft.graph.communications.onlinemeetingconversations.item.starter.replies.item.conversation;
...
public class ConversationRequestBuilder extends BaseRequestBuilder {
    ...
    public ConversationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/starter/replies/{engagementConversationMessage%2Did}/conversation{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ConversationRequestBuilder} and sets the default values.
    ...
    public ConversationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/starter/replies/{engagementConversationMessage%2Did}/conversation{?%24expand,%24select}", rawUrl);
    }
    /**
