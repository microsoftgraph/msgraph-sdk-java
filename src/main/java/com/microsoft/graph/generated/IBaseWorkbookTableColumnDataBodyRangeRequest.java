...
/**
 * The interface for the Base Workbook Table Column Data Body Range Request.
 */
public interface IBaseWorkbookTableColumnDataBodyRangeRequest {
     ...
     */
    IWorkbookTableColumnDataBodyRangeRequest select(final String value);
     ...
     * @return The updated request
     */
    IWorkbookTableColumnDataBodyRangeRequest expand(final String value);
