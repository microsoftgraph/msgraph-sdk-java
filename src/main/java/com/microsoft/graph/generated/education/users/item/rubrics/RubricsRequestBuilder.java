...
public class RubricsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link EducationRubricItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public EducationRubricItemRequestBuilder byEducationRubricId(@jakarta.annotation.Nonnull final String educationRubricId) {
    ...
    /**
     * Instantiates a new {@link RubricsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public RubricsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/rubrics{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RubricsRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public RubricsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/rubrics{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationRubric body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationRubric body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/users/{educationUser%2Did}/rubrics", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link RubricsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public RubricsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
