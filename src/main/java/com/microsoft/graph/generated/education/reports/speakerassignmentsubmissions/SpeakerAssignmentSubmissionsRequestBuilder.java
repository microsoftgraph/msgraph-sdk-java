package com.microsoft.graph.education.reports.speakerassignmentsubmissions;

import com.microsoft.graph.education.reports.speakerassignmentsubmissions.count.CountRequestBuilder;
import com.microsoft.graph.education.reports.speakerassignmentsubmissions.item.SpeakerAssignmentSubmissionItemRequestBuilder;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.SpeakerAssignmentSubmission;
import com.microsoft.graph.models.SpeakerAssignmentSubmissionCollectionResponse;
...
public class SpeakerAssignmentSubmissionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SpeakerAssignmentSubmissionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/reportsroot-list-speakerassignmentsubmissions?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nullable
    public SpeakerAssignmentSubmissionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public SpeakerAssignmentSubmission post(@jakarta.annotation.Nonnull final SpeakerAssignmentSubmission body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/reports/speakerAssignmentSubmissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SpeakerAssignmentSubmission body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/reports/speakerAssignmentSubmissions", pathParameters);
