package com.microsoft.graph.education.me.assignments.item.submissions.item.resources.item.dependentresources;

import com.microsoft.graph.education.me.assignments.item.submissions.item.resources.item.dependentresources.count.CountRequestBuilder;
import com.microsoft.graph.education.me.assignments.item.submissions.item.resources.item.dependentresources.item.EducationSubmissionResourceItemRequestBuilder;
...
public class DependentResourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public DependentResourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/resources/{educationSubmissionResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DependentResourcesRequestBuilder} and sets the default values.
    ...
    public DependentResourcesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/resources/{educationSubmissionResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
