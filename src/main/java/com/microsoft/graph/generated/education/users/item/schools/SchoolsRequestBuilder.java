package com.microsoft.graph.education.users.item.schools;

import com.microsoft.graph.education.users.item.schools.count.CountRequestBuilder;
...
public class SchoolsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SchoolsRequestBuilder} and sets the default values.
    ...
    public SchoolsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/schools{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SchoolsRequestBuilder} and sets the default values.
    ...
    public SchoolsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/schools{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
