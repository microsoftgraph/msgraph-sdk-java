package com.microsoft.graph.education.classes.item.assignments.item.resources.item.dependentresources;

import com.microsoft.graph.education.classes.item.assignments.item.resources.item.dependentresources.count.CountRequestBuilder;
import com.microsoft.graph.education.classes.item.assignments.item.resources.item.dependentresources.item.EducationAssignmentResourceItemRequestBuilder;
...
public class DependentResourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public DependentResourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DependentResourcesRequestBuilder} and sets the default values.
    ...
    public DependentResourcesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationassignmentresource-list-dependentresources?view=graph-rest-1.0">Find more info here</a>
     */
