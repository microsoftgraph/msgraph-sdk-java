package com.microsoft.graph.education.reports.readingassignmentsubmissions;

import com.microsoft.graph.education.reports.readingassignmentsubmissions.count.CountRequestBuilder;
import com.microsoft.graph.education.reports.readingassignmentsubmissions.item.ReadingAssignmentSubmissionItemRequestBuilder;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.ReadingAssignmentSubmission;
import com.microsoft.graph.models.ReadingAssignmentSubmissionCollectionResponse;
...
public class ReadingAssignmentSubmissionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/reportsroot-list-readingassignmentsubmissions?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/reports/readingAssignmentSubmissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ReadingAssignmentSubmission body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/reports/readingAssignmentSubmissions", pathParameters);
