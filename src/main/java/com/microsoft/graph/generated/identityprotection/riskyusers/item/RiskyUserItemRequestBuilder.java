...
public class RiskyUserItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link RiskyUserItemRequestBuilder} and sets the default values.
    ...
    public RiskyUserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link RiskyUserItemRequestBuilder} and sets the default values.
    ...
    public RiskyUserItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}{?%24expand,%24select}", pathParameters);
