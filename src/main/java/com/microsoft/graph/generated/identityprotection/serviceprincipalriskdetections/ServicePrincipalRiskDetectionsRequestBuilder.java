...
public class ServicePrincipalRiskDetectionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ServicePrincipalRiskDetectionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityProtection/servicePrincipalRiskDetections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ServicePrincipalRiskDetectionsRequestBuilder and sets the default values.
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a ServicePrincipalRiskDetectionsRequestBuilder
     */
    @jakarta.annotation.Nonnull
