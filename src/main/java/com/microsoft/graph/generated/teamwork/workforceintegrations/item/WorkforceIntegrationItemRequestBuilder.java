...
public class WorkforceIntegrationItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WorkforceIntegrationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorkforceIntegrationItemRequestBuilder} and sets the default values.
    ...
    public WorkforceIntegrationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}{?%24expand,%24select}", pathParameters);
