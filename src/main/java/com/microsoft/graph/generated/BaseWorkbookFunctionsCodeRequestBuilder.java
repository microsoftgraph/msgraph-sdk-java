...
/**
 * The class for the Base Workbook Functions Code Request Builder.
 */
public class BaseWorkbookFunctionsCodeRequestBuilder extends BaseActionRequestBuilder {
     ...
     * @return The IWorkbookFunctionsCodeRequest instance
     */
    public IWorkbookFunctionsCodeRequest buildRequest(final java.util.List<Option> requestOptions) {
