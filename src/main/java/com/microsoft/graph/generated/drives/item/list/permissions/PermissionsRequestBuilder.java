package com.microsoft.graph.drives.item.list.permissions;

import com.microsoft.graph.drives.item.list.permissions.count.CountRequestBuilder;
import com.microsoft.graph.drives.item.list.permissions.item.PermissionItemRequestBuilder;
