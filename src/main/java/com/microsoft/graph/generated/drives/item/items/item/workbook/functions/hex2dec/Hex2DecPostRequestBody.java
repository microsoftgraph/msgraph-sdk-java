...
public class Hex2DecPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Hex2DecPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link Hex2DecPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static Hex2DecPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
