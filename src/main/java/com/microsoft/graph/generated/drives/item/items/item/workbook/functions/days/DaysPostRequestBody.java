...
public class DaysPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DaysPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DaysPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DaysPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
