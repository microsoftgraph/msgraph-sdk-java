package com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.rangewithaddress.usedrangewithvaluesonly;
...
public class UsedRangeWithValuesOnlyRequestBuilder extends BaseRequestBuilder {
    ...
    public UsedRangeWithValuesOnlyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final Boolean valuesOnly) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range(address='{address}')/usedRange(valuesOnly={valuesOnly})", pathParameters);
    ...
    public UsedRangeWithValuesOnlyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range(address='{address}')/usedRange(valuesOnly={valuesOnly})", rawUrl);
    }
    /**
