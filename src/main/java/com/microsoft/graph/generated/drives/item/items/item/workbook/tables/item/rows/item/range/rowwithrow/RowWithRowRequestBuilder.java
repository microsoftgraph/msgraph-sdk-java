package com.microsoft.graph.drives.item.items.item.workbook.tables.item.rows.item.range.rowwithrow;
...
public class RowWithRowRequestBuilder extends BaseRequestBuilder {
    ...
    public RowWithRowRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final Integer row) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}/range()/row(row={row})", pathParameters);
    ...
    public RowWithRowRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}/range()/row(row={row})", rawUrl);
    }
    /**
     * Invoke function row
