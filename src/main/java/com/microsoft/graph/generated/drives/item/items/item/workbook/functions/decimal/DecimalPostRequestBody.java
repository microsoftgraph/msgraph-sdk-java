...
public class DecimalPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DecimalPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DecimalPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DecimalPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
