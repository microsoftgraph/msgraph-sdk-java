package com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.headerrowrange.intersectionwithanotherrange;
...
public class IntersectionWithAnotherRangeRequestBuilder extends BaseRequestBuilder {
    ...
    public IntersectionWithAnotherRangeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String anotherRange) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/headerRowRange()/intersection(anotherRange='{anotherRange}')", pathParameters);
    ...
    public IntersectionWithAnotherRangeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/headerRowRange()/intersection(anotherRange='{anotherRange}')", rawUrl);
    }
    /**
