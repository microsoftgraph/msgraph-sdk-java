package com.microsoft.graph.drives.item.items.item.workbook.tables.itematwithindex.reapplyfilters;
...
public class ReapplyFiltersRequestBuilder extends BaseRequestBuilder {
    ...
    public ReapplyFiltersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/itemAt(index={index})/reapplyFilters", pathParameters);
    }
    /**
     * Instantiates a new ReapplyFiltersRequestBuilder and sets the default values.
    ...
    public ReapplyFiltersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/itemAt(index={index})/reapplyFilters", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a ReapplyFiltersRequestBuilder
     */
    @jakarta.annotation.Nonnull
