...
public class TPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link TPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static TPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
