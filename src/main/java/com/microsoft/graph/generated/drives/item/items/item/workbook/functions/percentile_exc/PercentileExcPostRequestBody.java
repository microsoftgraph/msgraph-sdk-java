...
public class PercentileExcPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PercentileExcPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PercentileExcPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static PercentileExcPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("k", (n) -> { this.setK(n.getObjectValue(UntypedNode::createFromDiscriminatorValue)); });
     ...
     */
    public void setK(@jakarta.annotation.Nullable final UntypedNode value) {
