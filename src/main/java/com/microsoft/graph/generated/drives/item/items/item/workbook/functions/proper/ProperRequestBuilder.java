...
public class ProperRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ProperRequestBuilder} and sets the default values.
    ...
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final ProperPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final ProperPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public ProperRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
