...
public class CeilingPreciseRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CeilingPreciseRequestBuilder} and sets the default values.
    ...
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final CeilingPrecisePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final CeilingPrecisePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
