package com.microsoft.graph.drives.item.items.item.workbook.functions.hex2bin;
...
public class Hex2BinPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Hex2BinPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link Hex2BinPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static Hex2BinPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
