package com.microsoft.graph.drives.item.list.items.item.permissions;

import com.microsoft.graph.drives.item.list.items.item.permissions.count.CountRequestBuilder;
import com.microsoft.graph.drives.item.list.items.item.permissions.item.PermissionItemRequestBuilder;
