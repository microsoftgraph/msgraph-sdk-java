...
public class EdatePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EdatePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link EdatePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static EdatePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
