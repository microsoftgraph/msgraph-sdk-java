...
public class TDistRTPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TDistRTPostRequestBody} and sets the default values.
     */
    public TDistRTPostRequestBody() {
     ...
     * @return a {@link TDistRTPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static TDistRTPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new TDistRTPostRequestBody();
    }
    /**
