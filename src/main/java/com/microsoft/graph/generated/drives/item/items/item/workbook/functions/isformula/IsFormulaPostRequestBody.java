...
public class IsFormulaPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link IsFormulaPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link IsFormulaPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static IsFormulaPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
