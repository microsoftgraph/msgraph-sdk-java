...
public class ApplyDynamicFilterRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ApplyDynamicFilterRequestBuilder} and sets the default values.
    ...
    public ApplyDynamicFilterRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyDynamicFilter", pathParameters);
    }
    /**
     * Instantiates a new {@link ApplyDynamicFilterRequestBuilder} and sets the default values.
    ...
    public ApplyDynamicFilterRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyDynamicFilter", rawUrl);
    }
    /**
