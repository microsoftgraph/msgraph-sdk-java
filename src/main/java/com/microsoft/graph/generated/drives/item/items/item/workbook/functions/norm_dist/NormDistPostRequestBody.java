...
public class NormDistPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link NormDistPostRequestBody} and sets the default values.
     */
    public NormDistPostRequestBody() {
     ...
     * @return a {@link NormDistPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static NormDistPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new NormDistPostRequestBody();
    }
    /**
