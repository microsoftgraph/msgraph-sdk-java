...
public class CountIfsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CountIfsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CountIfsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CountIfsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
