...
public class RoundDownPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RoundDownPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RoundDownPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RoundDownPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
