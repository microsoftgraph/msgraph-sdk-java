package com.microsoft.graph.drives.item.items.item.workbook.functions.imsech;
...
public class ImSechPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImSechPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImSechPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImSechPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
