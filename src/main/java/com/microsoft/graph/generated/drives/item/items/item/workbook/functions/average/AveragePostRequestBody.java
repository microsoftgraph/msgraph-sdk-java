...
public class AveragePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AveragePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AveragePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static AveragePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
