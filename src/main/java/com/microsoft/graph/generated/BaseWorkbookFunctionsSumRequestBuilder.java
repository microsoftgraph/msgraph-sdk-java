...
public class BaseWorkbookFunctionsSumRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSumRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsSumRequest instance
     */
    public IWorkbookFunctionsSumRequest buildRequest(final java.util.List<Option> requestOptions) {
