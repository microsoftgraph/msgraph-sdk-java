package com.microsoft.graph.applications.item.unsetverifiedpublisher;
...
public class UnsetVerifiedPublisherRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentidentityblueprint-unsetverifiedpublisher?view=graph-rest-1.0">Find more info here</a>
     */
    public void post() {
        post(null);
    }
