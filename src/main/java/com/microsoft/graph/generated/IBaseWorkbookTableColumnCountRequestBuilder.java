...
/**
 * The interface for the Base Workbook Table Column Count Request Builder.
 */
public interface IBaseWorkbookTableColumnCountRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookTableColumnCountRequest instance
     */
    IWorkbookTableColumnCountRequest buildRequest(final java.util.List<Option> requestOptions);
}
