package com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.items;

import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.items.count.CountRequestBuilder;
import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.items.delta.DeltaRequestBuilder;
import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.items.item.MailboxItemItemRequestBuilder;
import com.microsoft.graph.models.MailboxItemCollectionResponse;
...
public class ItemsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/mailboxfolder-list-items?view=graph-rest-1.0">Find more info here</a>
     */
