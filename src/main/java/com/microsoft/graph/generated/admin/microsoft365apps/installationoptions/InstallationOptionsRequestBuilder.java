package com.microsoft.graph.admin.microsoft365apps.installationoptions;
...
public class InstallationOptionsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link InstallationOptionsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public InstallationOptionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/microsoft365Apps/installationOptions", pathParameters);
    }
    /**
     * Instantiates a new {@link InstallationOptionsRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public InstallationOptionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/microsoft365Apps/installationOptions", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/microsoft365Apps/installationOptions{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final M365AppsInstallationOptions body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public InstallationOptionsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
