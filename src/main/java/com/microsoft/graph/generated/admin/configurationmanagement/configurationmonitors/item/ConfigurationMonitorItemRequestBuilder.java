...
public class ConfigurationMonitorItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ConfigurationMonitorItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationMonitors/{configurationMonitor%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ConfigurationMonitorItemRequestBuilder} and sets the default values.
    ...
    public ConfigurationMonitorItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationMonitors/{configurationMonitor%2Did}", rawUrl);
    }
    /**
     * Delete a configurationMonitor object permanently. A deleted configurationMonitor can&apos;t be restored.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/configurationmonitor-delete?view=graph-rest-1.0">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/configurationmonitor-get?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @return a {@link ConfigurationMonitor}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/configurationmonitor-update?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/configurationManagement/configurationMonitors/{configurationMonitor%2Did}{?%24expand,%24select}", pathParameters);
