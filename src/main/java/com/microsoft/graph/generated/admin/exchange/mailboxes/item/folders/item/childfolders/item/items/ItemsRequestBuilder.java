package com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.item.items;

import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.count.CountRequestBuilder;
import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.delta.DeltaRequestBuilder;
import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.item.MailboxItemItemRequestBuilder;
