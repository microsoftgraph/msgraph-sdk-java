...
public class MarkReadPostResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MarkReadPostResponse} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MarkReadPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
