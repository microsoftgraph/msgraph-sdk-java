package com.microsoft.graph.admin.exchange.mailboxes.item.folders.item;

import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.ChildFoldersRequestBuilder;
import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.items.ItemsRequestBuilder;
import com.microsoft.graph.models.MailboxFolder;
...
public class MailboxFolderItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link MailboxFolderItemRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MailboxFolderItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link MailboxFolderItemRequestBuilder} and sets the default values.
