...
public class FavoritePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FavoritePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link FavoritePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static FavoritePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
