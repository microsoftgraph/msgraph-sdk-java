package com.microsoft.graph.admin.people.profilesourceswithsourceid;
...
public class ProfileSourcesWithSourceIdRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/profilesource-delete?view=graph-rest-1.0">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link ProfileSource}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/profilesource-update?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
