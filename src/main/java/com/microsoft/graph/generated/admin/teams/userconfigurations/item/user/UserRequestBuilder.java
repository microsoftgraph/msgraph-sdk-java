package com.microsoft.graph.admin.teams.userconfigurations.item.user;

import com.microsoft.graph.admin.teams.userconfigurations.item.user.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.admin.teams.userconfigurations.item.user.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserRequestBuilder extends BaseRequestBuilder {
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserRequestBuilder} and sets the default values.
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user{?%24expand,%24select}", rawUrl);
    }
    /**
