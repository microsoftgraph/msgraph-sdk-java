package com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.item;

import com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.ItemsRequestBuilder;
...
public class MailboxFolderItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MailboxFolderItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/{mailboxFolder%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link MailboxFolderItemRequestBuilder} and sets the default values.
