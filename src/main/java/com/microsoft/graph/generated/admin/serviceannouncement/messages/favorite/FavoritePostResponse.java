...
public class FavoritePostResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FavoritePostResponse} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static FavoritePostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
