...
public class UnfavoritePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UnfavoritePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link UnfavoritePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static UnfavoritePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
