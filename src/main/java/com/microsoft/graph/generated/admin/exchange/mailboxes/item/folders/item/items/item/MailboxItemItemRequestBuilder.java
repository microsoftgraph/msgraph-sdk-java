package com.microsoft.graph.admin.exchange.mailboxes.item.folders.item.items.item;
...
public class MailboxItemItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/mailboxfolder-delete-items?view=graph-rest-1.0">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/mailboxitem-get?view=graph-rest-1.0">Find more info here</a>
     */
