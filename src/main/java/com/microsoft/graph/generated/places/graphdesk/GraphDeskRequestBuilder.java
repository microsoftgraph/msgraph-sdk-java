package com.microsoft.graph.places.graphdesk;

import com.microsoft.graph.models.DeskCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.places.graphdesk.count.CountRequestBuilder;
...
public class GraphDeskRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphDeskRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/graph.desk{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphDeskRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public DeskCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
