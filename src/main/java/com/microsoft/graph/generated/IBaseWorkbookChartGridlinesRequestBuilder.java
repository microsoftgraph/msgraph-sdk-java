...
/**
 * The interface for the Base Workbook Chart Gridlines Request Builder.
 */
public interface IBaseWorkbookChartGridlinesRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookChartGridlinesRequest buildRequest(final java.util.List<Option> requestOptions);
