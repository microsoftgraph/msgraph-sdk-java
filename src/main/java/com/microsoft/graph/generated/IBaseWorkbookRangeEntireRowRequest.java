...
/**
 * The interface for the Base Workbook Range Entire Row Request.
 */
public interface IBaseWorkbookRangeEntireRowRequest {
     ...
     */
    IWorkbookRangeEntireRowRequest select(final String value);
     ...
     * @return The updated request
     */
    IWorkbookRangeEntireRowRequest expand(final String value);
