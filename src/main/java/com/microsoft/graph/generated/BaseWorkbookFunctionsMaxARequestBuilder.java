...
/**
 * The class for the Base Workbook Functions Max ARequest Builder.
 */
public class BaseWorkbookFunctionsMaxARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsMaxARequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsMaxARequest instance
     */
    public IWorkbookFunctionsMaxARequest buildRequest(final java.util.List<Option> requestOptions) {
