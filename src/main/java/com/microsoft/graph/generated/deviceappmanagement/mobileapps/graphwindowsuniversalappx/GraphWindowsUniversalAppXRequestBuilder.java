package com.microsoft.graph.deviceappmanagement.mobileapps.graphwindowsuniversalappx;

import com.microsoft.graph.deviceappmanagement.mobileapps.graphwindowsuniversalappx.count.CountRequestBuilder;
...
public class GraphWindowsUniversalAppXRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphWindowsUniversalAppXRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsUniversalAppX{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphWindowsUniversalAppXRequestBuilder} and sets the default values.
    ...
    public GraphWindowsUniversalAppXRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsUniversalAppX{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get the items of type microsoft.graph.windowsUniversalAppX in the microsoft.graph.mobileApp collection
     * @return a {@link WindowsUniversalAppXCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public WindowsUniversalAppXCollectionResponse get() {
        return get(null);
    }
    /**
     * Get the items of type microsoft.graph.windowsUniversalAppX in the microsoft.graph.mobileApp collection
     ...
     */
    @jakarta.annotation.Nullable
    public WindowsUniversalAppXCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
