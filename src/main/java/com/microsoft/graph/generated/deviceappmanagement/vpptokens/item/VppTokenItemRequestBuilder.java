...
public class VppTokenItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link SyncLicensesRequestBuilder}
     */
    ...
    /**
     * Instantiates a new {@link VppTokenItemRequestBuilder} and sets the default values.
    ...
    public VppTokenItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link VppTokenItemRequestBuilder} and sets the default values.
    ...
    public VppTokenItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     * Deletes a vppToken.
     ...
     */
    @jakarta.annotation.Nullable
    public VppToken get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public VppToken patch(@jakarta.annotation.Nonnull final VppToken body) {
     ...
     */
    @jakarta.annotation.Nullable
    public VppToken patch(@jakarta.annotation.Nonnull final VppToken body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final VppToken body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}", pathParameters);
