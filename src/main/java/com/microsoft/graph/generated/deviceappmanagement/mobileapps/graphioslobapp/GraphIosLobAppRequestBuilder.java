package com.microsoft.graph.deviceappmanagement.mobileapps.graphioslobapp;

import com.microsoft.graph.deviceappmanagement.mobileapps.graphioslobapp.count.CountRequestBuilder;
...
public class GraphIosLobAppRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link GraphIosLobAppRequestBuilder} and sets the default values.
    ...
    public GraphIosLobAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.iosLobApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphIosLobAppRequestBuilder} and sets the default values.
    ...
    public GraphIosLobAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.iosLobApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get the items of type microsoft.graph.iosLobApp in the microsoft.graph.mobileApp collection
     * @return a {@link IosLobAppCollectionResponse}
    ...
    public IosLobAppCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, IosLobAppCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     * Get the items of type microsoft.graph.iosLobApp in the microsoft.graph.mobileApp collection
