package com.microsoft.graph.deviceappmanagement.mobileapps.graphmacoslobapp;

import com.microsoft.graph.deviceappmanagement.mobileapps.graphmacoslobapp.count.CountRequestBuilder;
...
public class GraphMacOSLobAppRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link GraphMacOSLobAppRequestBuilder} and sets the default values.
    ...
    public GraphMacOSLobAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.macOSLobApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphMacOSLobAppRequestBuilder} and sets the default values.
    ...
    public GraphMacOSLobAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.macOSLobApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get the items of type microsoft.graph.macOSLobApp in the microsoft.graph.mobileApp collection
     * @return a {@link MacOSLobAppCollectionResponse}
    ...
    public MacOSLobAppCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, MacOSLobAppCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     * Get the items of type microsoft.graph.macOSLobApp in the microsoft.graph.mobileApp collection
