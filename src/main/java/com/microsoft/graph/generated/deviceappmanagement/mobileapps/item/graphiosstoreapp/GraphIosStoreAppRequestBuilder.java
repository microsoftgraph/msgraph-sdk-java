package com.microsoft.graph.deviceappmanagement.mobileapps.item.graphiosstoreapp;

import com.microsoft.graph.deviceappmanagement.mobileapps.item.graphiosstoreapp.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.deviceappmanagement.mobileapps.item.graphiosstoreapp.categories.CategoriesRequestBuilder;
...
public class GraphIosStoreAppRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link GraphIosStoreAppRequestBuilder} and sets the default values.
    ...
    public GraphIosStoreAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.iosStoreApp{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphIosStoreAppRequestBuilder} and sets the default values.
    ...
    public GraphIosStoreAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.iosStoreApp{?%24expand,%24select}", rawUrl);
    }
    /**
     * Get the item of type microsoft.graph.mobileApp as microsoft.graph.iosStoreApp
     * @return a {@link IosStoreApp}
    ...
    public IosStoreApp get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, IosStoreApp::createFromDiscriminatorValue);
    }
    /**
     * Get the item of type microsoft.graph.mobileApp as microsoft.graph.iosStoreApp
