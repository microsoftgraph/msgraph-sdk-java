package com.microsoft.graph.deviceappmanagement.mobileapps.item.graphmacoslobapp.categories.item;
...
public class MobileAppCategoryItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MobileAppCategoryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/categories/{mobileAppCategory%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link MobileAppCategoryItemRequestBuilder} and sets the default values.
    ...
    public MobileAppCategoryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/categories/{mobileAppCategory%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
