package com.microsoft.graph.deviceappmanagement.mobileapps.graphiosvppapp;

import com.microsoft.graph.deviceappmanagement.mobileapps.graphiosvppapp.count.CountRequestBuilder;
...
public class GraphIosVppAppRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphIosVppAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.iosVppApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphIosVppAppRequestBuilder} and sets the default values.
    ...
    public GraphIosVppAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.iosVppApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get the items of type microsoft.graph.iosVppApp in the microsoft.graph.mobileApp collection
     * @return a {@link IosVppAppCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public IosVppAppCollectionResponse get() {
        return get(null);
    }
    /**
     * Get the items of type microsoft.graph.iosVppApp in the microsoft.graph.mobileApp collection
     ...
     */
    @jakarta.annotation.Nullable
    public IosVppAppCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
