...
public class GetUserIdsWithFlaggedAppRegistrationgetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link GetUserIdsWithFlaggedAppRegistrationgetResponse} and sets the default values.
     */
    public GetUserIdsWithFlaggedAppRegistrationgetResponse() {
        super();
    }
    /**
    ...
    public static GetUserIdsWithFlaggedAppRegistrationgetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
