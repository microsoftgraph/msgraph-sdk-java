...
public class GraphIosLobAppRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphIosLobAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.iosLobApp{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphIosLobAppRequestBuilder} and sets the default values.
    ...
    public GraphIosLobAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.iosLobApp{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public IosLobApp get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
