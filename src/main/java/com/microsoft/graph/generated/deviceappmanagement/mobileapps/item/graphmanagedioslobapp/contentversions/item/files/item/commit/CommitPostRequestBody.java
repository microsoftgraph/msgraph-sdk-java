...
public class CommitPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link CommitPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CommitPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CommitPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("fileEncryptionInfo", (n) -> { this.setFileEncryptionInfo(n.getObjectValue(FileEncryptionInfo::createFromDiscriminatorValue)); });
