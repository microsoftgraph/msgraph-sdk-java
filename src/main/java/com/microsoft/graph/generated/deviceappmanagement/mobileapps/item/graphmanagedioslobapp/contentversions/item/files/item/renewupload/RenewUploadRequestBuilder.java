package com.microsoft.graph.deviceappmanagement.mobileapps.item.graphmanagedioslobapp.contentversions.item.files.item.renewupload;
...
public class RenewUploadRequestBuilder extends BaseRequestBuilder {
    ...
    public RenewUploadRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedIOSLobApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}/renewUpload", pathParameters);
    }
    /**
     * Instantiates a new RenewUploadRequestBuilder and sets the default values.
    ...
    public RenewUploadRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedIOSLobApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}/renewUpload", rawUrl);
    }
    /**
