...
public class TermStoresRequestBuilder extends BaseRequestBuilder {
    ...
    public TermStoresRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/termStores{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TermStoresRequestBuilder} and sets the default values.
    ...
    public TermStoresRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/termStores{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
