package com.microsoft.graph.groups.item.sites.item.pages.item.graphsitepage;

import com.microsoft.graph.groups.item.sites.item.pages.item.graphsitepage.canvaslayout.CanvasLayoutRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.pages.item.graphsitepage.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.pages.item.graphsitepage.lastmodifiedbyuser.LastModifiedByUserRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.pages.item.graphsitepage.webparts.WebPartsRequestBuilder;
...
public class GraphSitePageRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphSitePageRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphSitePageRequestBuilder} and sets the default values.
    ...
    public GraphSitePageRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage{?%24expand,%24select}", rawUrl);
    }
    /**
