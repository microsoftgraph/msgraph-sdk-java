package com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item;

import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.instances.InstancesRequestBuilder;
...
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EventItemRequestBuilder} and sets the default values.
