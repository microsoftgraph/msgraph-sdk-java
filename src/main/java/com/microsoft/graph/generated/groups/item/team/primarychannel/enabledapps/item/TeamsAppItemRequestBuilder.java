package com.microsoft.graph.groups.item.team.primarychannel.enabledapps.item;
...
public class TeamsAppItemRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamsAppItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/enabledApps/{teamsApp%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsAppItemRequestBuilder} and sets the default values.
