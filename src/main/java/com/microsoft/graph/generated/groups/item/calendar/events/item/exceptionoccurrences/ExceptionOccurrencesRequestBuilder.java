package com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences;

import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.EventItemRequestBuilder;
...
public class ExceptionOccurrencesRequestBuilder extends BaseRequestBuilder {
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExceptionOccurrencesRequestBuilder} and sets the default values.
