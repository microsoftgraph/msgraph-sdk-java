package com.microsoft.graph.groups.item.onenote.notebooks.item.sectiongroups.item.sectiongroups;

import com.microsoft.graph.groups.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.item.SectionGroupItemRequestBuilder;
...
public class SectionGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SectionGroupsRequestBuilder and sets the default values.
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
