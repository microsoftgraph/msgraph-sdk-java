...
public class ReplyPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ReplyPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ReplyPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public Post getPost() {
        return this.backingStore.get("post");
    }
    /**
    ...
    public void setPost(@jakarta.annotation.Nullable final Post value) {
        this.backingStore.set("post", value);
    }
}
