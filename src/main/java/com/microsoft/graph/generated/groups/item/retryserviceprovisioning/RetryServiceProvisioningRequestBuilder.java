package com.microsoft.graph.groups.item.retryserviceprovisioning;
...
public class RetryServiceProvisioningRequestBuilder extends BaseRequestBuilder {
    ...
    public RetryServiceProvisioningRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/retryServiceProvisioning", pathParameters);
    }
    /**
     * Instantiates a new RetryServiceProvisioningRequestBuilder and sets the default values.
    ...
    public RetryServiceProvisioningRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/retryServiceProvisioning", rawUrl);
    }
    /**
     * Retry the group service provisioning.
     * @see <a href="https://learn.microsoft.com/graph/api/group-retryserviceprovisioning?view=graph-rest-1.0">Find more info here</a>
     */
    public void post() {
        post(null);
    }
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a RetryServiceProvisioningRequestBuilder
     */
    @jakarta.annotation.Nonnull
