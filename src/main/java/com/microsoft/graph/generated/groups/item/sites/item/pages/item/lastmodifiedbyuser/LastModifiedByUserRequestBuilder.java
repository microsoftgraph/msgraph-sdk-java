package com.microsoft.graph.groups.item.sites.item.pages.item.lastmodifiedbyuser;

import com.microsoft.graph.groups.item.sites.item.pages.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.pages.item.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class LastModifiedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/lastModifiedByUser{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link LastModifiedByUserRequestBuilder} and sets the default values.
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/lastModifiedByUser{?%24expand,%24select}", rawUrl);
    }
    /**
