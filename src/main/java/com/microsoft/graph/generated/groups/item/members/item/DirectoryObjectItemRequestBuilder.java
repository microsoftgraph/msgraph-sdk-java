package com.microsoft.graph.groups.item.members.item;

import com.microsoft.graph.groups.item.members.item.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.groups.item.members.item.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.groups.item.members.item.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.groups.item.members.item.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.groups.item.members.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.groups.item.members.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.groups.item.members.item.ref.RefRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}", pathParameters);
    }
    /**
     * Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
    ...
    public DirectoryObjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}", rawUrl);
    }
}
