package com.microsoft.graph.groups.item.sites.item.lists.item.items.item.permissions.item.grant;
...
public class GrantRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GrantRequestBuilder} and sets the default values.
    ...
    public GrantRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/permissions/{permission%2Did}/grant", pathParameters);
    }
    /**
     * Instantiates a new {@link GrantRequestBuilder} and sets the default values.
    ...
    public GrantRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/permissions/{permission%2Did}/grant", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GrantPostRequestBody body) {
