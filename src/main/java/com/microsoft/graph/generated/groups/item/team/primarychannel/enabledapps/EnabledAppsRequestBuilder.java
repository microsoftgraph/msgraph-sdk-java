package com.microsoft.graph.groups.item.team.primarychannel.enabledapps;

import com.microsoft.graph.groups.item.team.primarychannel.enabledapps.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.team.primarychannel.enabledapps.item.TeamsAppItemRequestBuilder;
...
public class EnabledAppsRequestBuilder extends BaseRequestBuilder {
    ...
    public EnabledAppsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/enabledApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link EnabledAppsRequestBuilder} and sets the default values.
