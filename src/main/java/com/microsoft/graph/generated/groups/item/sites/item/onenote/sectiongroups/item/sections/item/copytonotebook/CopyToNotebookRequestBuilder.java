package com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.copytonotebook;
...
public class CopyToNotebookRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CopyToNotebookRequestBuilder} and sets the default values.
    ...
    public CopyToNotebookRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToNotebook", pathParameters);
    }
    /**
     * Instantiates a new {@link CopyToNotebookRequestBuilder} and sets the default values.
    ...
    public CopyToNotebookRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToNotebook", rawUrl);
    }
    /**
    ...
    public OnenoteOperation post(@jakarta.annotation.Nonnull final CopyToNotebookPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public OnenoteOperation post(@jakarta.annotation.Nonnull final CopyToNotebookPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public CopyToNotebookRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
