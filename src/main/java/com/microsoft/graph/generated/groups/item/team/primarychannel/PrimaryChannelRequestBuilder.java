...
import com.microsoft.graph.groups.item.team.primarychannel.startmigration.StartMigrationRequestBuilder;
import com.microsoft.graph.groups.item.team.primarychannel.tabs.TabsRequestBuilder;
import com.microsoft.graph.groups.item.team.primarychannel.unarchive.UnarchiveRequestBuilder;
...
public class PrimaryChannelRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/team/primaryChannel{?%24expand,%24select}", pathParameters);
