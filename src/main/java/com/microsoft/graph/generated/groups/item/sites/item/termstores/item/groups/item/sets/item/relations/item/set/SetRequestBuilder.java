package com.microsoft.graph.groups.item.sites.item.termstores.item.groups.item.sets.item.relations.item.set;
...
public class SetRequestBuilder extends BaseRequestBuilder {
    ...
    public SetRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}/sets/{set%2Did}/relations/{relation%2Did}/set{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SetRequestBuilder} and sets the default values.
    ...
    public SetRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}/sets/{set%2Did}/relations/{relation%2Did}/set{?%24expand,%24select}", rawUrl);
    }
    /**
