package com.microsoft.graph.identity.authenticationeventsflows.item.graphexternalusersselfservicesignupeventsflow.onauthenticationmethodloadstart.graphonauthenticationmethodloadstartexternalusersselfse_ac9906a2;

import com.microsoft.graph.identity.authenticationeventsflows.item.graphexternalusersselfservicesignupeventsflow.onauthenticationmethodloadstart.graphonauthenticationmethodloadstartexternalusersselfse_ac9906a2.identityproviders.IdentityProvidersRequestBuilder;
...
/**
 * Casts the previous resource to onAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp. Original name: GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUpRequestBuilder
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155 extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155(rawUrl, requestAdapter);
    }
    /**
