...
import com.microsoft.graph.models.WhatIfAnalysisResult;
...
public class EvaluatePostResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link EvaluatePostResponse} and sets the default values.
     */
    public EvaluatePostResponse() {
        super();
    }
    /**
    ...
    public static EvaluatePostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
