...
public class IdentityApiConnectorItemRequestBuilder extends BaseRequestBuilder {
    ...
    public IdentityApiConnectorItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/apiConnectors/{identityApiConnector%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link IdentityApiConnectorItemRequestBuilder} and sets the default values.
    ...
    public IdentityApiConnectorItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/apiConnectors/{identityApiConnector%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/apiConnectors/{identityApiConnector%2Did}{?%24expand,%24select}", pathParameters);
