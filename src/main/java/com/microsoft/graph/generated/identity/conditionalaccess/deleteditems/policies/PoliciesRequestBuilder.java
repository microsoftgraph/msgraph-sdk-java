package com.microsoft.graph.identity.conditionalaccess.deleteditems.policies;

import com.microsoft.graph.identity.conditionalaccess.deleteditems.policies.count.CountRequestBuilder;
import com.microsoft.graph.identity.conditionalaccess.deleteditems.policies.item.ConditionalAccessPolicyItemRequestBuilder;
...
public class PoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/conditionalAccess/deletedItems/policies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConditionalAccessPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identity/conditionalAccess/deletedItems/policies", pathParameters);
