...
public class SetOrderPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SetOrderPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SetOrderPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public AssignmentOrder getNewAssignmentOrder() {
        return this.backingStore.get("newAssignmentOrder");
    }
    /**
    ...
    public void setNewAssignmentOrder(@jakarta.annotation.Nullable final AssignmentOrder value) {
        this.backingStore.set("newAssignmentOrder", value);
    }
}
