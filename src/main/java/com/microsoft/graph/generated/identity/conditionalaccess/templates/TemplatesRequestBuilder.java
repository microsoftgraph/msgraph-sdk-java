...
public class TemplatesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ConditionalAccessTemplateItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public TemplatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/conditionalAccess/templates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TemplatesRequestBuilder} and sets the default values.
    ...
    public TemplatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/conditionalAccess/templates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public ConditionalAccessTemplateCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ConditionalAccessTemplateCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     * Get a list of the conditionalAccessTemplate objects and their properties.
