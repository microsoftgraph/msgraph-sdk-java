...
public class GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba(rawUrl, requestAdapter);
    }
    /**
