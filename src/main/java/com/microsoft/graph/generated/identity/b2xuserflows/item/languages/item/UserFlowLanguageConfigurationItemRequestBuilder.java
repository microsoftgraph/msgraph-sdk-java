...
public class UserFlowLanguageConfigurationItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link UserFlowLanguageConfigurationItemRequestBuilder} and sets the default values.
    ...
    public UserFlowLanguageConfigurationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserFlowLanguageConfigurationItemRequestBuilder} and sets the default values.
    ...
    public UserFlowLanguageConfigurationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}{?%24expand,%24select}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link UserFlowLanguageConfigurationItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
