package com.microsoft.graph.identity.riskprevention.fraudprotectionproviders;

import com.microsoft.graph.identity.riskprevention.fraudprotectionproviders.count.CountRequestBuilder;
import com.microsoft.graph.identity.riskprevention.fraudprotectionproviders.item.FraudProtectionProviderItemRequestBuilder;
import com.microsoft.graph.models.FraudProtectionProvider;
import com.microsoft.graph.models.FraudProtectionProviderCollectionResponse;
...
public class FraudProtectionProvidersRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/riskpreventioncontainer-list-fraudprotectionproviders?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/riskpreventioncontainer-post-fraudprotectionproviders?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/riskPrevention/fraudProtectionProviders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final FraudProtectionProvider body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identity/riskPrevention/fraudProtectionProviders", pathParameters);
