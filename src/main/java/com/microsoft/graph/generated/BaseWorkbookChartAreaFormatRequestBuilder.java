...
/**
 * The class for the Base Workbook Chart Area Format Request Builder.
 */
public class BaseWorkbookChartAreaFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartAreaFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartAreaFormatRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartAreaFormatRequest buildRequest(final java.util.List<Option> requestOptions) {
