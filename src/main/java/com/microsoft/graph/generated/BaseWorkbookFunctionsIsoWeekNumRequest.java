...
public class BaseWorkbookFunctionsIsoWeekNumRequest extends BaseRequest implements IBaseWorkbookFunctionsIsoWeekNumRequest {
    protected final WorkbookFunctionsIsoWeekNumBody mBody;
     ...
     */
    public BaseWorkbookFunctionsIsoWeekNumRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsIsoWeekNumBody();
    }
