...
public class BaseCalendarGroupRequestBuilder extends BaseRequestBuilder implements IBaseCalendarGroupRequestBuilder {
     ...
     */
    public BaseCalendarGroupRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public ICalendarGroupRequest buildRequest(final java.util.List<Option> requestOptions) {
