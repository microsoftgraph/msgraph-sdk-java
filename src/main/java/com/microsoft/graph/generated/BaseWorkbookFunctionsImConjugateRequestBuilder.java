...
public class BaseWorkbookFunctionsImConjugateRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImConjugateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImConjugateRequest instance
     */
    public IWorkbookFunctionsImConjugateRequest buildRequest(final java.util.List<Option> requestOptions) {
