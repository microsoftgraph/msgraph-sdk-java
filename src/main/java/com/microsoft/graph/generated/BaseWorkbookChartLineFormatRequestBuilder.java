...
public class BaseWorkbookChartLineFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartLineFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartLineFormatRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartLineFormatRequest buildRequest(final java.util.List<Option> requestOptions) {
