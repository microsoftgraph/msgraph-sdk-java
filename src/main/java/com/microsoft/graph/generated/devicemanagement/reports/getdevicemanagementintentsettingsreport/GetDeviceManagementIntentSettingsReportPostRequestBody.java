...
public class GetDeviceManagementIntentSettingsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link GetDeviceManagementIntentSettingsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDeviceManagementIntentSettingsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDeviceManagementIntentSettingsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
