...
import com.microsoft.graph.devicemanagement.userexperienceanalyticsapphealthosversionperformance.item.UserExperienceAnalyticsAppHealthOSVersionPerformanceIte_42b8290d;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UserExperienceAnalyticsAppHealthOSVersionPerformance;
import com.microsoft.graph.models.UserExperienceAnalyticsAppHealthOSVersionPerformanceCol_47ddb2da;
...
public class UserExperienceAnalyticsAppHealthOSVersionPerformanceReq_fdb3de6d extends BaseRequestBuilder {
    /**
     ...
     * @return a {@link UserExperienceAnalyticsAppHealthOSVersionPerformanceIte_42b8290d}
     */
    @jakarta.annotation.Nonnull
    public UserExperienceAnalyticsAppHealthOSVersionPerformanceIte_42b8290d byUserExperienceAnalyticsAppHealthOSVersionPerformanceId(@jakarta.annotation.Nonnull final String userExperienceAnalyticsAppHealthOSVersionPerformanceId) {
        ...
        return new UserExperienceAnalyticsAppHealthOSVersionPerformanceIte_42b8290d(urlTplParams, requestAdapter);
    }
    /**
     * Instantiates a new {@link UserExperienceAnalyticsAppHealthOSVersionPerformanceReq_fdb3de6d} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public UserExperienceAnalyticsAppHealthOSVersionPerformanceReq_fdb3de6d(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public UserExperienceAnalyticsAppHealthOSVersionPerformanceReq_fdb3de6d(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "", rawUrl);
    }
    /**
     * User experience analytics appHealth OS version Performance
     * @return a {@link UserExperienceAnalyticsAppHealthOSVersionPerformanceCol_47ddb2da}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsAppHealthOSVersionPerformanceCol_47ddb2da get() {
        return get(null);
    }
    /**
     * User experience analytics appHealth OS version Performance
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsAppHealthOSVersionPerformanceCol_47ddb2da get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, UserExperienceAnalyticsAppHealthOSVersionPerformanceCol_47ddb2da::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public UserExperienceAnalyticsAppHealthOSVersionPerformanceReq_fdb3de6d withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new UserExperienceAnalyticsAppHealthOSVersionPerformanceReq_fdb3de6d(rawUrl, requestAdapter);
    }
    /**
     * User experience analytics appHealth OS version Performance
     */
