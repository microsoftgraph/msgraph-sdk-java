...
public class GetDeviceNonComplianceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetDeviceNonComplianceReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDeviceNonComplianceReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDeviceNonComplianceReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
