...
public class AssignUserToDevicePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AssignUserToDevicePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AssignUserToDevicePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static AssignUserToDevicePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
