...
public class GetConfigurationPolicyNonComplianceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link GetConfigurationPolicyNonComplianceReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetConfigurationPolicyNonComplianceReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetConfigurationPolicyNonComplianceReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
