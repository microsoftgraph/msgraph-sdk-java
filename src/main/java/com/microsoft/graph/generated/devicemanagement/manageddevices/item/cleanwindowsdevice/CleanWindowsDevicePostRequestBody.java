...
public class CleanWindowsDevicePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CleanWindowsDevicePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CleanWindowsDevicePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CleanWindowsDevicePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
