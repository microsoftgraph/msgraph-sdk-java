...
public class ExportJobsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link DeviceManagementExportJobItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public ExportJobsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/reports/exportJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExportJobsRequestBuilder} and sets the default values.
    ...
    public ExportJobsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/reports/exportJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public DeviceManagementExportJobCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, DeviceManagementExportJobCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     * Create a new deviceManagementExportJob object.
     * @param body The request body
     * @return a {@link DeviceManagementExportJob}
     * @throws ODataError When receiving a 4XX or 5XX status code
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementExportJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/reports/exportJobs", pathParameters);
