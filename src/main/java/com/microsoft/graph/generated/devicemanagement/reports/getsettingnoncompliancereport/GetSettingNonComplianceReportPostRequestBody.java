...
public class GetSettingNonComplianceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetSettingNonComplianceReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetSettingNonComplianceReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetSettingNonComplianceReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
