...
public class WorkFromAnywhereMetricsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link WorkFromAnywhereMetricsRequestBuilder} and sets the default values.
    ...
    public WorkFromAnywhereMetricsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/workFromAnywhereMetrics{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorkFromAnywhereMetricsRequestBuilder} and sets the default values.
    ...
    public WorkFromAnywhereMetricsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/workFromAnywhereMetrics{?%24expand,%24select}", rawUrl);
    }
    /**
