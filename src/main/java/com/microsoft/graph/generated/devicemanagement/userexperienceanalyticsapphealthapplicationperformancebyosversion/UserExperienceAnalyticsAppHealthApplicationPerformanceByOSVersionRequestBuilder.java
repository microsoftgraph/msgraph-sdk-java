...
public class UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder} and sets the default values.
     ...
     * @return a {@link UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse get() {
        return get(null);
    }
    /**
     * User experience analytics appHealth Application Performance by OS Version
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse::createFromDiscriminatorValue);
    }
    /**
