package com.microsoft.graph.devicemanagement.resourceoperations.item;
...
public class ResourceOperationItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ResourceOperationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/resourceOperations/{resourceOperation%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ResourceOperationItemRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ResourceOperationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/resourceOperations/{resourceOperation%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     * Deletes a resourceOperation.
     * @see <a href="https://learn.microsoft.com/graph/api/intune-rbac-resourceoperation-delete?view=graph-rest-1.0">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/intune-rbac-resourceoperation-get?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @return a ResourceOperation
     * @see <a href="https://learn.microsoft.com/graph/api/intune-rbac-resourceoperation-update?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
