package com.microsoft.graph.devicemanagement.reports.retrievedeviceappinstallationstatusreport;
...
public class RetrieveDeviceAppInstallationStatusReportRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public RetrieveDeviceAppInstallationStatusReportRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public InputStream post(@jakarta.annotation.Nonnull final RetrieveDeviceAppInstallationStatusReportPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RetrieveDeviceAppInstallationStatusReportPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
