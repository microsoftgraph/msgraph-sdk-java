...
public class GetOmaSettingPlainTextValueWithSecretReferenceValueIdRe_c9047fb2 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetOmaSettingPlainTextValueWithSecretReferenceValueIdRe_c9047fb2} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @param secretReferenceValueId Usage: secretReferenceValueId=&apos;{secretReferenceValueId}&apos;
     */
    public GetOmaSettingPlainTextValueWithSecretReferenceValueIdRe_c9047fb2(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String secretReferenceValueId) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetOmaSettingPlainTextValueWithSecretReferenceValueIdRe_c9047fb2(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetOmaSettingPlainTextValueWithSecretReferenceValueIdRe_c9047fb2 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetOmaSettingPlainTextValueWithSecretReferenceValueIdRe_c9047fb2(rawUrl, requestAdapter);
    }
    /**
