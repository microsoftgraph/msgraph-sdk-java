...
public class GetCompliancePolicyNonComplianceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetCompliancePolicyNonComplianceReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetCompliancePolicyNonComplianceReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetCompliancePolicyNonComplianceReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
