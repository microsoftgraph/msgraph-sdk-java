...
public class GetAuditCategoriesgetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link GetAuditCategoriesgetResponse} and sets the default values.
     */
    public GetAuditCategoriesgetResponse() {
        super();
    }
    /**
    ...
    public static GetAuditCategoriesgetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
