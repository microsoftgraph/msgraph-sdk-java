...
public class BaseEventMessageRequestBuilder extends BaseRequestBuilder implements IBaseEventMessageRequestBuilder {
     ...
     */
    public BaseEventMessageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IEventMessageRequest buildRequest(final java.util.List<Option> requestOptions) {
