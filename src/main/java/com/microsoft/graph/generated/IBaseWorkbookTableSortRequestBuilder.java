...
/**
 * The interface for the Base Workbook Table Sort Request Builder.
 */
public interface IBaseWorkbookTableSortRequestBuilder extends IRequestBuilder {
    ...
    IWorkbookTableSortApplyRequestBuilder getApply(final java.util.List<WorkbookSortField> fields, final Boolean matchCase, final String method);
