package com.microsoft.graph.sites.item.onenote.sections.item.pages.item.parentnotebook;
...
public class ParentNotebookRequestBuilder extends BaseRequestBuilder {
    ...
    public ParentNotebookRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentNotebook{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ParentNotebookRequestBuilder} and sets the default values.
    ...
    public ParentNotebookRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentNotebook{?%24expand,%24select}", rawUrl);
    }
    /**
