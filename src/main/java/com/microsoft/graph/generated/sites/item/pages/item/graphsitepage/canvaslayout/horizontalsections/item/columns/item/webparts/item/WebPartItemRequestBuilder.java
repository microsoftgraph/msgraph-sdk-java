package com.microsoft.graph.sites.item.pages.item.graphsitepage.canvaslayout.horizontalsections.item.columns.item.webparts.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.WebPart;
import com.microsoft.graph.sites.item.pages.item.graphsitepage.canvaslayout.horizontalsections.item.columns.item.webparts.item.getpositionofwebpart.GetPositionOfWebPartRequestBuilder;
