package com.microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.pages.item.onenotepatchcontent;
...
public class OnenotePatchContentPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link OnenotePatchContentPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link OnenotePatchContentPostRequestBody}
     */
    @jakarta.annotation.Nonnull
     ...
     * @return a {@link java.util.List<OnenotePatchContentCommand>}
     */
