...
/**
 * The interface for the Base Workbook Chart Area Format Request Builder.
 */
public interface IBaseWorkbookChartAreaFormatRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     */
