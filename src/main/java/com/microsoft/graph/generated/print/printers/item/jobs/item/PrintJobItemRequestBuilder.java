package com.microsoft.graph.print.printers.item.jobs.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.PrintJob;
import com.microsoft.graph.print.printers.item.jobs.item.abort.AbortRequestBuilder;
import com.microsoft.graph.print.printers.item.jobs.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.print.printers.item.jobs.item.documents.DocumentsRequestBuilder;
import com.microsoft.graph.print.printers.item.jobs.item.redirect.RedirectRequestBuilder;
import com.microsoft.graph.print.printers.item.jobs.item.start.StartRequestBuilder;
import com.microsoft.graph.print.printers.item.jobs.item.tasks.TasksRequestBuilder;
...
public class PrintJobItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PrintJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrintJobItemRequestBuilder} and sets the default values.
    ...
    public PrintJobItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printjob-get?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @return a {@link PrintJob}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printjob-update?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}{?%24expand,%24select}", pathParameters);
