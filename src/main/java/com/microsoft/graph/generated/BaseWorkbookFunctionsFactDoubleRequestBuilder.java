...
public class BaseWorkbookFunctionsFactDoubleRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsFactDoubleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsFactDoubleRequest instance
     */
    public IWorkbookFunctionsFactDoubleRequest buildRequest(final java.util.List<Option> requestOptions) {
