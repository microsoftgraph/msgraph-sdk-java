...
public class DirectoryRoleTemplatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DirectoryRoleTemplateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DirectoryRoleTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DirectoryRoleTemplateCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DirectoryRoleTemplate> post(@javax.annotation.Nonnull final DirectoryRoleTemplate body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DirectoryRoleTemplate> executionException = new java.util.concurrent.CompletableFuture<DirectoryRoleTemplate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
