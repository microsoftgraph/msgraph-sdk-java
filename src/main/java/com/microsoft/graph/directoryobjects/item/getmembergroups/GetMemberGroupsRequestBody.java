...
public class GetMemberGroupsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getMemberGroupsRequestBody
     */
    @javax.annotation.Nonnull
    public static GetMemberGroupsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMemberGroupsRequestBody currentObject = this;
