...
public class SchemaRequestBuilder {
     ...
     * @return a CompletableFuture of schema
     */
    public java.util.concurrent.CompletableFuture<Schema> patch(@javax.annotation.Nonnull final Schema body, @javax.annotation.Nullable final java.util.function.Consumer<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of schema
     */
    public java.util.concurrent.CompletableFuture<Schema> patch(@javax.annotation.Nonnull final Schema body, @javax.annotation.Nullable final java.util.function.Consumer<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
