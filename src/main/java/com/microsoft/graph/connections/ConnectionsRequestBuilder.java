...
public class ConnectionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ExternalConnection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ExternalConnectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalConnectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ExternalConnectionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ExternalConnection> post(@javax.annotation.Nonnull final ExternalConnection body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalConnection> executionException = new java.util.concurrent.CompletableFuture<ExternalConnection>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
