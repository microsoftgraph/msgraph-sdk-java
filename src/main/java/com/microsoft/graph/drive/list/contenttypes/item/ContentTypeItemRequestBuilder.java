package com.microsoft.graph.drive.list.contenttypes.item;

import com.microsoft.graph.drive.list.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.base.BaseRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.basetypes.BaseTypesRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.columnlinks.ColumnLinksRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.columnlinks.item.ColumnLinkItemRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.columnpositions.ColumnPositionsRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.columns.ColumnsRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.copytodefaultcontentlocation.CopyToDefaultContentLocationRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.ispublished.IsPublishedRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.publish.PublishRequestBuilder;
import com.microsoft.graph.drive.list.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.list.contentTypes.item.baseTypes.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.list.contentTypes.item.columnLinks.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.list.contentTypes.item.columnPositions.item collection
     * @param id Unique identifier of the item
     * @return a ColumnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.drive.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder columnPositions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new com.microsoft.graph.drive.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the com.Microsoft.Graph.drive.list.contentTypes.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a ColumnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.drive.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new com.microsoft.graph.drive.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
