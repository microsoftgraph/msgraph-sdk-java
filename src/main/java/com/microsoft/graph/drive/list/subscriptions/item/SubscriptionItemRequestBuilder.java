package com.microsoft.graph.drive.list.subscriptions.item;

import com.microsoft.graph.drive.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
