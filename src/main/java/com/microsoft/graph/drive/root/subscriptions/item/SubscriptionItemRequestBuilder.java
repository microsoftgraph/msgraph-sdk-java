package com.microsoft.graph.drive.root.subscriptions.item;

import com.microsoft.graph.drive.root.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
