package microsoft.graph.drive.root.listitem;
...
import microsoft.graph.drive.root.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.drive.root.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.drive.root.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.drive.root.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.drive.root.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.drive.root.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.drive.root.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.drive.root.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.drive.root.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drive.root.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.drive.root.listItem.versions.item collection
     * @param id Unique identifier of the item
