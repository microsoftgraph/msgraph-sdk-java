package com.microsoft.graph.drive.root.listitem;

import com.microsoft.graph.drive.root.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drive.root.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import com.microsoft.graph.drive.root.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import com.microsoft.graph.drive.root.listitem.driveitem.DriveItemRequestBuilder;
import com.microsoft.graph.drive.root.listitem.fields.FieldsRequestBuilder;
import com.microsoft.graph.drive.root.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import com.microsoft.graph.drive.root.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.drive.root.listitem.versions.item.ListItemVersionItemRequestBuilder;
import com.microsoft.graph.drive.root.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.root.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.root.listItem.versions.item collection
     * @param id Unique identifier of the item
