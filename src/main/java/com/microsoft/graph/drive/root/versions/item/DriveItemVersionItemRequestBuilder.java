package microsoft.graph.drive.root.versions.item;
...
import microsoft.graph.drive.root.versions.item.content.ContentRequestBuilder;
import microsoft.graph.drive.root.versions.item.restoreversion.RestoreVersionRequestBuilder;
