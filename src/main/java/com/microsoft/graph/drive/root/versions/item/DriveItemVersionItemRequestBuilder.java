package com.microsoft.graph.drive.root.versions.item;

import com.microsoft.graph.drive.root.versions.item.content.ContentRequestBuilder;
import com.microsoft.graph.drive.root.versions.item.restoreversion.RestoreVersionRequestBuilder;
