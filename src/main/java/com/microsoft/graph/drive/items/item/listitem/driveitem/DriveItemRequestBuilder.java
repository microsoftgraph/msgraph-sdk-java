package com.microsoft.graph.drive.items.item.listitem.driveitem;

import com.microsoft.graph.drive.items.item.listitem.driveitem.content.ContentRequestBuilder;
