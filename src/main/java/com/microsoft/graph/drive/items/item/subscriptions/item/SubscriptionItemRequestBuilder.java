package microsoft.graph.drive.items.item.subscriptions.item;
...
import microsoft.graph.drive.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
