package com.microsoft.graph.drive.items.item.listitem;

import com.microsoft.graph.drive.items.item.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.driveitem.DriveItemRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.fields.FieldsRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.items.item.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.items.item.listItem.versions.item collection
     * @param id Unique identifier of the item
