package com.microsoft.graph.drive.items.item.versions.item;

import com.microsoft.graph.drive.items.item.versions.item.content.ContentRequestBuilder;
import com.microsoft.graph.drive.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
