package microsoft.graph.drive.items.item.versions.item;
...
import microsoft.graph.drive.items.item.versions.item.content.ContentRequestBuilder;
import microsoft.graph.drive.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
