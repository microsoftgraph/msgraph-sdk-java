...
public class AndroidManagedAppProtectionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AndroidManagedAppProtection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AndroidManagedAppProtectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AndroidManagedAppProtectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AndroidManagedAppProtectionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AndroidManagedAppProtection> post(@javax.annotation.Nonnull final AndroidManagedAppProtection body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AndroidManagedAppProtection> executionException = new java.util.concurrent.CompletableFuture<AndroidManagedAppProtection>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
