...
public class DeploymentSummaryRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ManagedAppPolicyDeploymentSummary body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppPolicyDeploymentSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedAppPolicyDeploymentSummary> executionException = new java.util.concurrent.CompletableFuture<ManagedAppPolicyDeploymentSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
