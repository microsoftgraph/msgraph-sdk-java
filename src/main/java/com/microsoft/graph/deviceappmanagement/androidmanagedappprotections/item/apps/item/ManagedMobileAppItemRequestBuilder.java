...
public class ManagedMobileAppItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ManagedMobileApp body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagedMobileApp> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedMobileApp> executionException = new java.util.concurrent.CompletableFuture<ManagedMobileApp>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
