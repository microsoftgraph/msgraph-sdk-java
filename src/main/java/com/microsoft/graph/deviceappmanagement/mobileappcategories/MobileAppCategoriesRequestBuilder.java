...
public class MobileAppCategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MobileAppCategoryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileAppCategoryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MobileAppCategoryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MobileAppCategory> post(@javax.annotation.Nonnull final MobileAppCategory body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileAppCategory> executionException = new java.util.concurrent.CompletableFuture<MobileAppCategory>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
