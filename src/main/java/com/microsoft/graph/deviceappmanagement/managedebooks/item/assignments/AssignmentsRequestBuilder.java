...
public class AssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedEBookAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedEBookAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedEBookAssignmentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedEBookAssignment> post(@javax.annotation.Nonnull final ManagedEBookAssignment body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedEBookAssignment> executionException = new java.util.concurrent.CompletableFuture<ManagedEBookAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
