...
public class ManagedEBooksRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedEBookCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedEBookCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedEBookCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedEBook> post(@javax.annotation.Nonnull final ManagedEBook body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedEBook> executionException = new java.util.concurrent.CompletableFuture<ManagedEBook>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
