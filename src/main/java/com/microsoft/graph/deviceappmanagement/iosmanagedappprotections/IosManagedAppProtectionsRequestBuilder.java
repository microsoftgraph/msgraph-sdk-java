...
public class IosManagedAppProtectionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final IosManagedAppProtection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IosManagedAppProtectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IosManagedAppProtectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IosManagedAppProtectionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<IosManagedAppProtection> post(@javax.annotation.Nonnull final IosManagedAppProtection body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<IosManagedAppProtection> executionException = new java.util.concurrent.CompletableFuture<IosManagedAppProtection>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
