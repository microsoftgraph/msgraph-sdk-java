...
public class IosManagedAppProtectionItemRequestBuilder {
     ...
     * @return a CompletableFuture of iosManagedAppProtection
     */
    public java.util.concurrent.CompletableFuture<IosManagedAppProtection> patch(@javax.annotation.Nonnull final IosManagedAppProtection body, @javax.annotation.Nullable final java.util.function.Consumer<IosManagedAppProtectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of iosManagedAppProtection
     */
    public java.util.concurrent.CompletableFuture<IosManagedAppProtection> patch(@javax.annotation.Nonnull final IosManagedAppProtection body, @javax.annotation.Nullable final java.util.function.Consumer<IosManagedAppProtectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
