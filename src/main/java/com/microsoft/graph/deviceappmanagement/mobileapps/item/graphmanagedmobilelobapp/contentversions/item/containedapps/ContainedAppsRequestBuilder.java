package com.microsoft.graph.deviceappmanagement.mobileapps.item.graphmanagedmobilelobapp.contentversions.item.containedapps;

import com.microsoft.graph.deviceappmanagement.mobileapps.item.graphmanagedmobilelobapp.contentversions.item.containedapps.count.CountRequestBuilder;
import com.microsoft.graph.deviceappmanagement.mobileapps.item.graphmanagedmobilelobapp.contentversions.item.containedapps.item.MobileContainedAppItemRequestBuilder;
...
public class ContainedAppsRequestBuilder extends BaseRequestBuilder {
    ...
    public ContainedAppsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedMobileLobApp/contentVersions/{mobileAppContent%2Did}/containedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ContainedAppsRequestBuilder and sets the default values.
    ...
    public ContainedAppsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedMobileLobApp/contentVersions/{mobileAppContent%2Did}/containedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
