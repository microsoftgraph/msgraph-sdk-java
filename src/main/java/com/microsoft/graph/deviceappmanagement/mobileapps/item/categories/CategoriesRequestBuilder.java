package microsoft.graph.deviceappmanagement.mobileapps.item.categories;
...
import microsoft.graph.deviceappmanagement.mobileapps.item.categories.count.CountRequestBuilder;
...
public class CategoriesRequestBuilder {
     ...
     * @return a CompletableFuture of MobileAppCategoryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<MobileAppCategoryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of MobileAppCategoryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<MobileAppCategoryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
