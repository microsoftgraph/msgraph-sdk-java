...
public class ManagedMobileLobAppRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedMobileLobAppCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedMobileLobAppCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedMobileLobAppCollectionResponse>();
