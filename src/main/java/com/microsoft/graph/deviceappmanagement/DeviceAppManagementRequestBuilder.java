...
public class DeviceAppManagementRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-partnerintegration-deviceappmanagement-get?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     * @return a CompletableFuture of deviceAppManagement
     * @see <a href="https://docs.microsoft.com/graph/api/intune-books-deviceappmanagement-update?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
