...
public class ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilder {
     ...
     * @return a CompletableFuture of managedDeviceMobileAppConfigurationAssignment
     */
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignment> patch(@javax.annotation.Nonnull final ManagedDeviceMobileAppConfigurationAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
