...
public class AssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignment> post(@javax.annotation.Nonnull final ManagedDeviceMobileAppConfigurationAssignment body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignment> executionException = new java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
