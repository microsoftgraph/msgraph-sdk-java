...
public class ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationDeviceStatus> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationDeviceStatus> executionException = new java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationDeviceStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
