...
public class DeviceStatusSummaryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationDeviceSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationDeviceSummary> executionException = new java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationDeviceSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
