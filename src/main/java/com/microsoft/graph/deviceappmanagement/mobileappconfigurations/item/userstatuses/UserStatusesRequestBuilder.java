package microsoft.graph.deviceappmanagement.mobileappconfigurations.item.userstatuses;
...
import microsoft.graph.deviceappmanagement.mobileappconfigurations.item.userstatuses.count.CountRequestBuilder;
import microsoft.graph.models.ManagedDeviceMobileAppConfigurationUserStatus;
import microsoft.graph.models.ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse;
...
public class UserStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<UserStatusesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of managedDeviceMobileAppConfigurationUserStatus
     */
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationUserStatus> post(@javax.annotation.Nonnull final ManagedDeviceMobileAppConfigurationUserStatus body, @javax.annotation.Nullable final java.util.function.Consumer<UserStatusesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
