package microsoft.graph.deviceappmanagement.vpptokens.item.synclicenses;
...
public class SyncLicensesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SyncLicensesRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @return a CompletableFuture of vppToken
     */
    public java.util.concurrent.CompletableFuture<VppToken> post(@javax.annotation.Nullable final java.util.function.Consumer<SyncLicensesRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of vppToken
     */
    public java.util.concurrent.CompletableFuture<VppToken> post(@javax.annotation.Nullable final java.util.function.Consumer<SyncLicensesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
