...
public class VppTokenItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final VppToken body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<VppToken> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<VppToken> executionException = new java.util.concurrent.CompletableFuture<VppToken>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
