...
public class VppTokensRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<VppTokenCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<VppTokenCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<VppTokenCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VppToken body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VppToken body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
