package microsoft.graph.deviceappmanagement.vpptokens;
...
import microsoft.graph.deviceappmanagement.vpptokens.count.CountRequestBuilder;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.models.VppToken;
import microsoft.graph.models.VppTokenCollectionResponse;
...
public class VppTokensRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<VppTokenCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, VppTokenCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of VppTokenCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<VppTokenCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<VppTokensRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, VppTokenCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of vppToken
     */
    public java.util.concurrent.CompletableFuture<VppToken> post(@javax.annotation.Nonnull final VppToken body, @javax.annotation.Nullable final java.util.function.Consumer<VppTokensRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
