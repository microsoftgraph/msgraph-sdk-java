...
public class TargetedManagedAppConfigurationItemRequestBuilder {
     ...
     * @return a CompletableFuture of targetedManagedAppConfiguration
     */
    public java.util.concurrent.CompletableFuture<TargetedManagedAppConfiguration> patch(@javax.annotation.Nonnull final TargetedManagedAppConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<TargetedManagedAppConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
