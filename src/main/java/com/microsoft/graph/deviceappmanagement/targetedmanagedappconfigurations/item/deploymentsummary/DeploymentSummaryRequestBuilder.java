package microsoft.graph.deviceappmanagement.targetedmanagedappconfigurations.item.deploymentsummary;
...
public class DeploymentSummaryRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<DeploymentSummaryRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppPolicyDeploymentSummary> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedAppPolicyDeploymentSummary::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of managedAppPolicyDeploymentSummary
     */
    public java.util.concurrent.CompletableFuture<ManagedAppPolicyDeploymentSummary> get(@javax.annotation.Nullable final java.util.function.Consumer<DeploymentSummaryRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedAppPolicyDeploymentSummary::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ManagedAppPolicyDeploymentSummary body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ManagedAppPolicyDeploymentSummary body, @javax.annotation.Nullable final java.util.function.Consumer<DeploymentSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
