...
public class TargetedManagedAppConfigurationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TargetedManagedAppConfigurationCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TargetedManagedAppConfigurationCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TargetedManagedAppConfigurationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<TargetedManagedAppConfigurationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TargetedManagedAppConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TargetedManagedAppConfigurationCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<TargetedManagedAppConfiguration> post(@javax.annotation.Nonnull final TargetedManagedAppConfiguration body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TargetedManagedAppConfiguration::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<TargetedManagedAppConfiguration> post(@javax.annotation.Nonnull final TargetedManagedAppConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<TargetedManagedAppConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        ...
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TargetedManagedAppConfiguration::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
