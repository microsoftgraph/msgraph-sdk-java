...
public class GetUserIdsWithFlaggedAppRegistrationResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUserIdsWithFlaggedAppRegistrationResponse
     */
    @javax.annotation.Nonnull
    public static GetUserIdsWithFlaggedAppRegistrationResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
