...
public class OperationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ManagedAppOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppOperationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedAppOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedAppOperationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppOperation> post(@javax.annotation.Nonnull final ManagedAppOperation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedAppOperation> executionException = new java.util.concurrent.CompletableFuture<ManagedAppOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
