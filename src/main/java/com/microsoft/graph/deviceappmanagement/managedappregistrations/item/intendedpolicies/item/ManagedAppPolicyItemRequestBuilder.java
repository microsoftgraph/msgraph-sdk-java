...
public class ManagedAppPolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of managedAppPolicy
     */
    public java.util.concurrent.CompletableFuture<ManagedAppPolicy> patch(@javax.annotation.Nonnull final ManagedAppPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ManagedAppPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
