package microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.targetedmanagedappprotection;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.targetedmanagedappprotection.assign.AssignRequestBuilder;
import microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.targetedmanagedappprotection.targetapps.TargetAppsRequestBuilder;
