...
public class ManagedAppOperationItemRequestBuilder {
     ...
     * @return a CompletableFuture of managedAppOperation
     */
    public java.util.concurrent.CompletableFuture<ManagedAppOperation> patch(@javax.annotation.Nonnull final ManagedAppOperation body, @javax.annotation.Nullable final java.util.function.Consumer<ManagedAppOperationItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
