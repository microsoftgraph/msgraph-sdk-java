package microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item;
...
import microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.managedappprotection.ManagedAppProtectionRequestBuilder;
import microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.targetapps.TargetAppsRequestBuilder;
import microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.targetedmanagedappprotection.TargetedManagedAppProtectionRequestBuilder;
import microsoft.graph.deviceappmanagement.managedappregistrations.item.appliedpolicies.item.windowsinformationprotection.WindowsInformationProtectionRequestBuilder;
