...
public class GetUserIdsWithFlaggedAppRegistrationRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> executionException = new java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
