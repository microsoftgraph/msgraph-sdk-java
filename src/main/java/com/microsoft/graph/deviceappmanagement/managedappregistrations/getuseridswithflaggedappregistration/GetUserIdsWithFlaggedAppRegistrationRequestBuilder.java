...
public class GetUserIdsWithFlaggedAppRegistrationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetUserIdsWithFlaggedAppRegistrationResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of getUserIdsWithFlaggedAppRegistrationResponse
     */
    public java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetUserIdsWithFlaggedAppRegistrationRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetUserIdsWithFlaggedAppRegistrationResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
