...
public class GetUserIdsWithFlaggedAppRegistrationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse> executionException = new java.util.concurrent.CompletableFuture<GetUserIdsWithFlaggedAppRegistrationResponse>();
