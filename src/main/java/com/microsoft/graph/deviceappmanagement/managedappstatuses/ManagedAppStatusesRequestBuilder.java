package microsoft.graph.deviceappmanagement.managedappstatuses;
...
import microsoft.graph.deviceappmanagement.managedappstatuses.count.CountRequestBuilder;
import microsoft.graph.models.ManagedAppStatus;
import microsoft.graph.models.ManagedAppStatusCollectionResponse;
...
public class ManagedAppStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedAppStatusCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ManagedAppStatusCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ManagedAppStatusesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedAppStatusCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppStatus> post(@javax.annotation.Nonnull final ManagedAppStatus body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedAppStatus::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of managedAppStatus
     */
    public java.util.concurrent.CompletableFuture<ManagedAppStatus> post(@javax.annotation.Nonnull final ManagedAppStatus body, @javax.annotation.Nullable final java.util.function.Consumer<ManagedAppStatusesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, ManagedAppStatus::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
