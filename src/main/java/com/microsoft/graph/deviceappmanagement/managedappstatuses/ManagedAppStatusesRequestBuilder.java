...
public class ManagedAppStatusesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/intune-mam-managedappstatusraw-list?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppStatus> post(@javax.annotation.Nonnull final ManagedAppStatus body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ManagedAppStatus> executionException = new java.util.concurrent.CompletableFuture<ManagedAppStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ManagedAppStatus> post(@javax.annotation.Nonnull final ManagedAppStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ManagedAppStatus body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ManagedAppStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
