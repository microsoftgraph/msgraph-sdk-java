...
public class ManagedAppStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedAppStatusCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppStatus> post(@javax.annotation.Nonnull final ManagedAppStatus body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedAppStatus> executionException = new java.util.concurrent.CompletableFuture<ManagedAppStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
