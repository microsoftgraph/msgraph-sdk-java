package microsoft.graph.deviceappmanagement.mdmwindowsinformationprotectionpolicies;
...
import microsoft.graph.deviceappmanagement.mdmwindowsinformationprotectionpolicies.count.CountRequestBuilder;
import microsoft.graph.models.MdmWindowsInformationProtectionPolicy;
import microsoft.graph.models.MdmWindowsInformationProtectionPolicyCollectionResponse;
...
public class MdmWindowsInformationProtectionPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MdmWindowsInformationProtectionPolicy body) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicyCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MdmWindowsInformationProtectionPolicyCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of MdmWindowsInformationProtectionPolicyCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicyCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<MdmWindowsInformationProtectionPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, MdmWindowsInformationProtectionPolicyCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicy> post(@javax.annotation.Nonnull final MdmWindowsInformationProtectionPolicy body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MdmWindowsInformationProtectionPolicy::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicy> post(@javax.annotation.Nonnull final MdmWindowsInformationProtectionPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<MdmWindowsInformationProtectionPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        ...
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MdmWindowsInformationProtectionPolicy::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
