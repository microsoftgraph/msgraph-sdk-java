...
public class MdmWindowsInformationProtectionPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicyCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicy> post(@javax.annotation.Nonnull final MdmWindowsInformationProtectionPolicy body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicy> executionException = new java.util.concurrent.CompletableFuture<MdmWindowsInformationProtectionPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
