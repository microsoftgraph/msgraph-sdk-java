package com.microsoft.graph.deviceappmanagement.mdmwindowsinformationprotectionpolicies.item.assignments;

import com.microsoft.graph.deviceappmanagement.mdmwindowsinformationprotectionpolicies.item.assignments.count.CountRequestBuilder;
import com.microsoft.graph.deviceappmanagement.mdmwindowsinformationprotectionpolicies.item.assignments.item.TargetedManagedAppPolicyAssignmentItemRequestBuilder;
