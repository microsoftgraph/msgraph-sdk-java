...
public class ProtectedAppLockerFilesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public WindowsInformationProtectionAppLockerFileItemRequestBuilder byWindowsInformationProtectionAppLockerFileId(@javax.annotation.Nonnull final String windowsInformationProtectionAppLockerFileId) {
    ...
    public ProtectedAppLockerFilesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public ProtectedAppLockerFilesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLockerFileCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLockerFileCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLockerFileCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLockerFile> post(@javax.annotation.Nonnull final WindowsInformationProtectionAppLockerFile body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionAppLockerFile> post(@javax.annotation.Nonnull final WindowsInformationProtectionAppLockerFile body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WindowsInformationProtectionAppLockerFile body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WindowsInformationProtectionAppLockerFile body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
