package microsoft.graph.deviceappmanagement.managedapppolicies.item;
...
import microsoft.graph.deviceappmanagement.managedapppolicies.item.managedappprotection.ManagedAppProtectionRequestBuilder;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.targetapps.TargetAppsRequestBuilder;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.targetedmanagedappprotection.TargetedManagedAppProtectionRequestBuilder;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.windowsinformationprotection.WindowsInformationProtectionRequestBuilder;
...
public class ManagedAppPolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<ManagedAppPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of managedAppPolicy
     */
    public java.util.concurrent.CompletableFuture<ManagedAppPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<ManagedAppPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ManagedAppPolicy body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ManagedAppPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ManagedAppPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ManagedAppPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ManagedAppPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
