package microsoft.graph.deviceappmanagement.managedapppolicies.item.windowsinformationprotection;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.windowsinformationprotection.assign.AssignRequestBuilder;
