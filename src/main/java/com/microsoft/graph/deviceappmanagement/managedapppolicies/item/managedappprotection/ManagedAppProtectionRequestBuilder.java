package microsoft.graph.deviceappmanagement.managedapppolicies.item.managedappprotection;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.managedappprotection.targetapps.TargetAppsRequestBuilder;
