package microsoft.graph.deviceappmanagement.managedapppolicies.item.targetedmanagedappprotection;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.targetedmanagedappprotection.assign.AssignRequestBuilder;
import microsoft.graph.deviceappmanagement.managedapppolicies.item.targetedmanagedappprotection.targetapps.TargetAppsRequestBuilder;
