...
public class DefaultManagedAppProtectionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DefaultManagedAppProtection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DefaultManagedAppProtectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DefaultManagedAppProtectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DefaultManagedAppProtectionCollectionResponse>();
