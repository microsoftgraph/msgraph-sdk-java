...
public class GroupLifecyclePolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of groupLifecyclePolicy
     */
    public java.util.concurrent.CompletableFuture<GroupLifecyclePolicy> patch(@javax.annotation.Nonnull final GroupLifecyclePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<GroupLifecyclePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
