...
public class RemoveGroupRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a removeGroupRequestBody
     */
    @javax.annotation.Nonnull
    public static RemoveGroupRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveGroupRequestBody currentObject = this;
