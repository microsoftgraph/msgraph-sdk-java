...
public class RemoveGroupPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static RemoveGroupPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
