...
public class RemoveGroupResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a removeGroupResponse
     */
    @javax.annotation.Nonnull
    public static RemoveGroupResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveGroupResponse currentObject = this;
