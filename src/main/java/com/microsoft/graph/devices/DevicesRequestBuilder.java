...
public class DevicesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Device body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Device> post(@javax.annotation.Nonnull final Device body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Device> executionException = new java.util.concurrent.CompletableFuture<Device>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
