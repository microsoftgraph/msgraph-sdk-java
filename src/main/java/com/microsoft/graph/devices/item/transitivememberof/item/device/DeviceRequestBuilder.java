package microsoft.graph.devices.item.transitivememberof.item.device;
...
import microsoft.graph.devices.item.transitivememberof.item.device.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.devices.item.transitivememberof.item.device.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.devices.item.transitivememberof.item.device.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.devices.item.transitivememberof.item.device.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.devices.item.transitivememberof.item.device.restore.RestoreRequestBuilder;
