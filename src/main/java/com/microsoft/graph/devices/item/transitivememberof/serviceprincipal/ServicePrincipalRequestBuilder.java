package microsoft.graph.devices.item.transitivememberof.serviceprincipal;
...
import microsoft.graph.devices.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
