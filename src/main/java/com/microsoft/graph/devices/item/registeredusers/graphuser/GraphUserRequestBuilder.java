package com.microsoft.graph.devices.item.registeredusers.graphuser;

import com.microsoft.graph.devices.item.registeredusers.graphuser.count.CountRequestBuilder;
