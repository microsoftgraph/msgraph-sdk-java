package com.microsoft.graph.devices.item.registeredowners.graphapproleassignment;

import com.microsoft.graph.devices.item.registeredowners.graphapproleassignment.count.CountRequestBuilder;
...
public class GraphAppRoleAssignmentRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphAppRoleAssignmentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphAppRoleAssignmentRequestBuilder and sets the default values.
    ...
    public GraphAppRoleAssignmentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
