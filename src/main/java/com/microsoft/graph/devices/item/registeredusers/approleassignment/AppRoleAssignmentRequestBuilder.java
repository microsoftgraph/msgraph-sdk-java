package com.microsoft.graph.devices.item.registeredusers.approleassignment;

import com.microsoft.graph.devices.item.registeredusers.approleassignment.count.CountRequestBuilder;
