package microsoft.graph.devices.item.registeredusers.approleassignment;
...
import microsoft.graph.devices.item.registeredusers.approleassignment.count.CountRequestBuilder;
