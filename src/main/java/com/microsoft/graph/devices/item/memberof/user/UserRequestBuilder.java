package com.microsoft.graph.devices.item.memberof.user;

import com.microsoft.graph.devices.item.memberof.user.count.CountRequestBuilder;
...
public class UserRequestBuilder {
    ...
    public UserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/microsoft.graph.user{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
