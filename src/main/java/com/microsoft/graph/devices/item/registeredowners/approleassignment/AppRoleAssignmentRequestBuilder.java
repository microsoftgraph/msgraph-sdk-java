package com.microsoft.graph.devices.item.registeredowners.approleassignment;

import com.microsoft.graph.devices.item.registeredowners.approleassignment.count.CountRequestBuilder;
