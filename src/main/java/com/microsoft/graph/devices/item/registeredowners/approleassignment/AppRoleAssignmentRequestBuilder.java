package microsoft.graph.devices.item.registeredowners.approleassignment;
...
import microsoft.graph.devices.item.registeredowners.approleassignment.count.CountRequestBuilder;
