package com.microsoft.graph.devices.item.memberof.item.user;
...
public class UserRequestBuilder {
    ...
    public UserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
