package com.microsoft.graph.devices.item.transitivememberof.user;

import com.microsoft.graph.devices.item.transitivememberof.user.count.CountRequestBuilder;
