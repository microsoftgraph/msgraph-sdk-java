...
import com.microsoft.graph.devices.item.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.devices.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.devices.item.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.devices.item.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.devices.item.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.devices.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.devices.item.memberof.user.UserRequestBuilder;
