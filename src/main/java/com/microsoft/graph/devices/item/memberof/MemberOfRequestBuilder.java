package microsoft.graph.devices.item.memberof;
...
import microsoft.graph.devices.item.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.devices.item.memberof.count.CountRequestBuilder;
import microsoft.graph.devices.item.memberof.device.DeviceRequestBuilder;
import microsoft.graph.devices.item.memberof.group.GroupRequestBuilder;
import microsoft.graph.devices.item.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.devices.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.devices.item.memberof.user.UserRequestBuilder;
