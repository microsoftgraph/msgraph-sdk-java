...
import com.microsoft.graph.devices.item.memberof.item.application.ApplicationRequestBuilder;
import com.microsoft.graph.devices.item.memberof.item.device.DeviceRequestBuilder;
import com.microsoft.graph.devices.item.memberof.item.group.GroupRequestBuilder;
import com.microsoft.graph.devices.item.memberof.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.devices.item.memberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.devices.item.memberof.item.user.UserRequestBuilder;
