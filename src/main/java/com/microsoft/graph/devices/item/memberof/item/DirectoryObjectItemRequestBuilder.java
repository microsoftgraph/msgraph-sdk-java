package microsoft.graph.devices.item.memberof.item;
...
import microsoft.graph.devices.item.memberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.devices.item.memberof.item.device.DeviceRequestBuilder;
import microsoft.graph.devices.item.memberof.item.group.GroupRequestBuilder;
import microsoft.graph.devices.item.memberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.devices.item.memberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.devices.item.memberof.item.user.UserRequestBuilder;
