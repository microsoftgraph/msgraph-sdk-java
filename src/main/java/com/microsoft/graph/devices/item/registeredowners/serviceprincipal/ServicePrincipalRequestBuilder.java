package microsoft.graph.devices.item.registeredowners.serviceprincipal;
...
import microsoft.graph.devices.item.registeredowners.serviceprincipal.count.CountRequestBuilder;
