package com.microsoft.graph.devices.item.registeredowners.serviceprincipal;

import com.microsoft.graph.devices.item.registeredowners.serviceprincipal.count.CountRequestBuilder;
