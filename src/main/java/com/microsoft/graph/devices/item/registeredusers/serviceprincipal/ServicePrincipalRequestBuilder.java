package microsoft.graph.devices.item.registeredusers.serviceprincipal;
...
import microsoft.graph.devices.item.registeredusers.serviceprincipal.count.CountRequestBuilder;
