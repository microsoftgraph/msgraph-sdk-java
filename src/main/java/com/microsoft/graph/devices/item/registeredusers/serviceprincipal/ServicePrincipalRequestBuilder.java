package com.microsoft.graph.devices.item.registeredusers.serviceprincipal;

import com.microsoft.graph.devices.item.registeredusers.serviceprincipal.count.CountRequestBuilder;
