...
public class ContactsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OrgContact body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OrgContact> post(@javax.annotation.Nonnull final OrgContact body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<OrgContact> executionException = new java.util.concurrent.CompletableFuture<OrgContact>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
