package microsoft.graph.contacts.item.memberof;
...
import microsoft.graph.contacts.item.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.contacts.item.memberof.count.CountRequestBuilder;
import microsoft.graph.contacts.item.memberof.device.DeviceRequestBuilder;
import microsoft.graph.contacts.item.memberof.group.GroupRequestBuilder;
import microsoft.graph.contacts.item.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.contacts.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.contacts.item.memberof.user.UserRequestBuilder;
