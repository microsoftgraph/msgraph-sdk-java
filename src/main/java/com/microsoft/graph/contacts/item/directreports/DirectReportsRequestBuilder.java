package com.microsoft.graph.contacts.item.directreports;

import com.microsoft.graph.contacts.item.directreports.count.CountRequestBuilder;
import com.microsoft.graph.contacts.item.directreports.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.contacts.item.directreports.user.UserRequestBuilder;
...
public class DirectReportsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<DirectReportsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final DirectReportsRequestBuilderGetRequestConfiguration requestConfig = new DirectReportsRequestBuilderGetRequestConfiguration();
     ...
     * @return a CompletableFuture of DirectoryObjectCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DirectoryObjectCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DirectReportsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public class DirectReportsRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public DirectReportsRequestBuilderGetQueryParameters queryParameters = new DirectReportsRequestBuilderGetQueryParameters();
        /**
