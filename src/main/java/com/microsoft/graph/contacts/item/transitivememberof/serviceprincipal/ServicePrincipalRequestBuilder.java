package microsoft.graph.contacts.item.transitivememberof.serviceprincipal;
...
import microsoft.graph.contacts.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
