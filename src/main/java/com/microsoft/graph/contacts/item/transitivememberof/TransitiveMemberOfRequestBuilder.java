package microsoft.graph.contacts.item.transitivememberof;
...
import microsoft.graph.contacts.item.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.contacts.item.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.contacts.item.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.contacts.item.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.contacts.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.contacts.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.contacts.item.transitivememberof.user.UserRequestBuilder;
