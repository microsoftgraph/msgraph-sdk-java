package com.microsoft.graph.contacts.item.transitivememberof.user;

import com.microsoft.graph.contacts.item.transitivememberof.user.count.CountRequestBuilder;
...
public class UserRequestBuilder {
    ...
    public UserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
