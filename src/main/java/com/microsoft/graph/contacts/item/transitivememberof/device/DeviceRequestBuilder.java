package microsoft.graph.contacts.item.transitivememberof.device;
...
import microsoft.graph.contacts.item.transitivememberof.device.count.CountRequestBuilder;
