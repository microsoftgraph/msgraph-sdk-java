package com.microsoft.graph.contacts.item.memberof.serviceprincipal;

import com.microsoft.graph.contacts.item.memberof.serviceprincipal.count.CountRequestBuilder;
