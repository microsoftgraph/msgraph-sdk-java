package microsoft.graph.contacts.item.memberof.serviceprincipal;
...
import microsoft.graph.contacts.item.memberof.serviceprincipal.count.CountRequestBuilder;
