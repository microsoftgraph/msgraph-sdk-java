package com.microsoft.graph.contacts.item.transitivememberof.item.device;
...
public class DeviceRequestBuilder {
    ...
    public DeviceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}";
