...
public class EdiscoveryReviewSetRequestBuilder extends BaseRequestBuilder<EdiscoveryReviewSet> {
     ...
     */
    @Nonnull
    public EdiscoveryReviewSetExportRequestBuilder export(@Nonnull final EdiscoveryReviewSetExportParameterSet parameters) {
        return new EdiscoveryReviewSetExportRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.security.export"), getClient(), null, parameters);
    }
}
