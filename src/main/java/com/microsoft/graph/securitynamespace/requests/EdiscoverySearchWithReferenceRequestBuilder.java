...
/**
 * The class for the Ediscovery Search With Reference Request Builder.
 */
public class EdiscoverySearchWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<EdiscoverySearch, EdiscoverySearchWithReferenceRequest, EdiscoverySearchReferenceRequestBuilder> {
     ...
     */
    public EdiscoverySearchWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, EdiscoverySearchWithReferenceRequest.class, EdiscoverySearchReferenceRequestBuilder.class);
    }
}
