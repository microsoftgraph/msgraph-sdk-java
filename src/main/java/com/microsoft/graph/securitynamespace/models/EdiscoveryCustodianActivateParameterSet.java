...
/**
 * The class for the Ediscovery Custodian Activate Parameter Set.
 */
public class EdiscoveryCustodianActivateParameterSet {

    /**
     * Instiaciates a new EdiscoveryCustodianActivateParameterSet
     */
     ...
     */
    protected EdiscoveryCustodianActivateParameterSet(@Nonnull final EdiscoveryCustodianActivateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the EdiscoveryCustodianActivateParameterSet
     */
    public static final class EdiscoveryCustodianActivateParameterSetBuilder {
        /**
         * Instanciates a new EdiscoveryCustodianActivateParameterSetBuilder
         */
        @Nullable
