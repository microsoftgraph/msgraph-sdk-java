...
/**
 * The class for the Ediscovery Review Tag As Hierarchy Parameter Set.
 */
public class EdiscoveryReviewTagAsHierarchyParameterSet {

    /**
     * Instiaciates a new EdiscoveryReviewTagAsHierarchyParameterSet
     */
     ...
     */
    protected EdiscoveryReviewTagAsHierarchyParameterSet(@Nonnull final EdiscoveryReviewTagAsHierarchyParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the EdiscoveryReviewTagAsHierarchyParameterSet
     */
    public static final class EdiscoveryReviewTagAsHierarchyParameterSetBuilder {
        /**
         * Instanciates a new EdiscoveryReviewTagAsHierarchyParameterSetBuilder
         */
        @Nullable
