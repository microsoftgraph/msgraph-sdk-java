...
public class AuthenticationMethodConfigurationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AuthenticationMethodConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethodConfigurationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethodConfigurationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethodConfigurationCollectionResponse>();
