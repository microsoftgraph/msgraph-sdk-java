...
public class AuthenticationMethodsPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethodsPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethodsPolicy> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethodsPolicy>();
