...
/**
 * The class for the Teams App Removed Event Message Detail.
 */
public class TeamsAppRemovedEventMessageDetail extends EventMessageDetail implements IJsonBackedObject {
