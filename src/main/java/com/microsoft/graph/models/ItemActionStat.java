...
public class ItemActionStat implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actionCount", (n) -> { currentObject.setActionCount(n.getIntegerValue()); });
        deserializerMap.put("actorCount", (n) -> { currentObject.setActorCount(n.getIntegerValue()); });
