...
public class ParentalControlSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("countriesBlockedForMinors", (n) -> { currentObject.setCountriesBlockedForMinors(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("legalAgeGroupRule", (n) -> { currentObject.setLegalAgeGroupRule(n.getStringValue()); });
