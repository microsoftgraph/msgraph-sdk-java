...
public class SharePointOneDriveOptions implements AdditionalDataHolder, Parsable {
    ...
    public static SharePointOneDriveOptions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nullable
    public SearchContent getIncludeContent() {
     ...
     */
    @javax.annotation.Nonnull
    public void setIncludeContent(@javax.annotation.Nullable final SearchContent value) {
