...
import com.microsoft.graph.models.AppHostedMediaConfig;
import com.microsoft.graph.models.ServiceHostedMediaConfig;
...
public class MediaConfig implements AdditionalDataHolder, Parsable {
    ...
    public static MediaConfig createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
