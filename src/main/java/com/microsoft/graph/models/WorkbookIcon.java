...
public class WorkbookIcon implements AdditionalDataHolder, Parsable {
    ...
    public static WorkbookIcon createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("set", (n) -> { currentObject.setSet(n.getStringValue()); });
    ...
    public void serialize(@javax.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("set", this.getSet());
     ...
     */
    @javax.annotation.Nonnull
    public void setSet(@javax.annotation.Nullable final String value) {
        this._set = value;
    }
}
