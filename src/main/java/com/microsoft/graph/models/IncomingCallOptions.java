...
public class IncomingCallOptions extends CallOptions implements Parsable {
    ...
    public static IncomingCallOptions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final IncomingCallOptions currentObject = this;
