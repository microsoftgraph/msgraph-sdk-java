...
public class Group extends DirectoryObject implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acceptedSenders", (n) -> { currentObject.setAcceptedSenders(n.getCollectionOfObjectValues(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("allowExternalSenders", (n) -> { currentObject.setAllowExternalSenders(n.getBooleanValue()); });
        ...
        deserializerMap.put("assignedLabels", (n) -> { currentObject.setAssignedLabels(n.getCollectionOfObjectValues(AssignedLabel::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("autoSubscribeNewMembers", (n) -> { currentObject.setAutoSubscribeNewMembers(n.getBooleanValue()); });
        ...
        deserializerMap.put("conversations", (n) -> { currentObject.setConversations(n.getCollectionOfObjectValues(Conversation::createFromDiscriminatorValue)); });
        deserializerMap.put("createdDateTime", (n) -> { currentObject.setCreatedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("createdOnBehalfOf", (n) -> { currentObject.setCreatedOnBehalfOf(n.getObjectValue(DirectoryObject::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("groupLifecyclePolicies", (n) -> { currentObject.setGroupLifecyclePolicies(n.getCollectionOfObjectValues(GroupLifecyclePolicy::createFromDiscriminatorValue)); });
        deserializerMap.put("groupTypes", (n) -> { currentObject.setGroupTypes(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("hasMembersWithLicenseErrors", (n) -> { currentObject.setHasMembersWithLicenseErrors(n.getBooleanValue()); });
        deserializerMap.put("hideFromAddressLists", (n) -> { currentObject.setHideFromAddressLists(n.getBooleanValue()); });
        deserializerMap.put("hideFromOutlookClients", (n) -> { currentObject.setHideFromOutlookClients(n.getBooleanValue()); });
        deserializerMap.put("isArchived", (n) -> { currentObject.setIsArchived(n.getBooleanValue()); });
        deserializerMap.put("isAssignableToRole", (n) -> { currentObject.setIsAssignableToRole(n.getBooleanValue()); });
        deserializerMap.put("isSubscribedByMail", (n) -> { currentObject.setIsSubscribedByMail(n.getBooleanValue()); });
        deserializerMap.put("licenseProcessingState", (n) -> { currentObject.setLicenseProcessingState(n.getObjectValue(LicenseProcessingState::createFromDiscriminatorValue)); });
        deserializerMap.put("mail", (n) -> { currentObject.setMail(n.getStringValue()); });
        deserializerMap.put("mailEnabled", (n) -> { currentObject.setMailEnabled(n.getBooleanValue()); });
        ...
        deserializerMap.put("members", (n) -> { currentObject.setMembers(n.getCollectionOfObjectValues(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("membershipRule", (n) -> { currentObject.setMembershipRule(n.getStringValue()); });
        deserializerMap.put("membershipRuleProcessingState", (n) -> { currentObject.setMembershipRuleProcessingState(n.getStringValue()); });
        deserializerMap.put("membersWithLicenseErrors", (n) -> { currentObject.setMembersWithLicenseErrors(n.getCollectionOfObjectValues(DirectoryObject::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("onPremisesNetBiosName", (n) -> { currentObject.setOnPremisesNetBiosName(n.getStringValue()); });
        ...
        deserializerMap.put("planner", (n) -> { currentObject.setPlanner(n.getObjectValue(PlannerGroup::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("rejectedSenders", (n) -> { currentObject.setRejectedSenders(n.getCollectionOfObjectValues(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("renewedDateTime", (n) -> { currentObject.setRenewedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("securityEnabled", (n) -> { currentObject.setSecurityEnabled(n.getBooleanValue()); });
        deserializerMap.put("securityIdentifier", (n) -> { currentObject.setSecurityIdentifier(n.getStringValue()); });
        deserializerMap.put("settings", (n) -> { currentObject.setSettings(n.getCollectionOfObjectValues(GroupSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("sites", (n) -> { currentObject.setSites(n.getCollectionOfObjectValues(Site::createFromDiscriminatorValue)); });
        deserializerMap.put("team", (n) -> { currentObject.setTeam(n.getObjectValue(Team::createFromDiscriminatorValue)); });
        deserializerMap.put("theme", (n) -> { currentObject.setTheme(n.getStringValue()); });
        ...
        deserializerMap.put("transitiveMembers", (n) -> { currentObject.setTransitiveMembers(n.getCollectionOfObjectValues(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("unseenCount", (n) -> { currentObject.setUnseenCount(n.getIntegerValue()); });
        deserializerMap.put("visibility", (n) -> { currentObject.setVisibility(n.getStringValue()); });
