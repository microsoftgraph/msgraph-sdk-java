...
public class User extends DirectoryObject implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("externalUserStateChangeDateTime", (n) -> { currentObject.setExternalUserStateChangeDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("insights", (n) -> { currentObject.setInsights(n.getObjectValue(OfficeGraphInsights::createFromDiscriminatorValue)); });
