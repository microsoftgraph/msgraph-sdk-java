...
public class BookingCustomerInformationBase implements AdditionalDataHolder, Parsable {
    ...
    public BookingCustomerInformationBase() {
        ...
        this.setType("#microsoft.graph.bookingCustomerInformationBase");
    }
    /**
    ...
    public static BookingCustomerInformationBase createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
