...
/**
 * The class for the User Experience Analytics Settings.
 */
public class UserExperienceAnalyticsSettings implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public Boolean configurationManagerDataConnectorConfigured;
