...
public class DeviceManagementReportsGetHistoricalReportParameterSet {
    ...
    public static final class DeviceManagementReportsGetHistoricalReportParameterSetBuilder {
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetHistoricalReportParameterSetBuilder withSelect(@Nullable final java.util.List<String> val) {
            this.select = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetHistoricalReportParameterSetBuilder withGroupBy(@Nullable final java.util.List<String> val) {
            this.groupBy = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetHistoricalReportParameterSetBuilder withOrderBy(@Nullable final java.util.List<String> val) {
            this.orderBy = val;
            return this;
        }
        /**
