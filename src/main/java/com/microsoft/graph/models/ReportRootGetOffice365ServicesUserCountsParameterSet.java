...
/**
 * The class for the Report Root Get Office365Services User Counts Parameter Set.
 */
public class ReportRootGetOffice365ServicesUserCountsParameterSet {
    ...
    public static final class ReportRootGetOffice365ServicesUserCountsParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetOffice365ServicesUserCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetOffice365ServicesUserCountsParameterSetBuilder
         */
        @Nullable
