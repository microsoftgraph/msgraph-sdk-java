...
/**
 * The class for the Phone Authentication Method Enable Sms Sign In Parameter Set.
 */
public class PhoneAuthenticationMethodEnableSmsSignInParameterSet {

    /**
     * Instiaciates a new PhoneAuthenticationMethodEnableSmsSignInParameterSet
     */
     ...
     */
    protected PhoneAuthenticationMethodEnableSmsSignInParameterSet(@Nonnull final PhoneAuthenticationMethodEnableSmsSignInParameterSetBuilder builder) {
    }
    /**
    ...
    public static final class PhoneAuthenticationMethodEnableSmsSignInParameterSetBuilder {
        /**
         * Instanciates a new PhoneAuthenticationMethodEnableSmsSignInParameterSetBuilder
         */
        @Nullable
