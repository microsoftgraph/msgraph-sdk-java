...
public class ApprovalFilterByCurrentUserParameterSet {
     ...
     */
    protected ApprovalFilterByCurrentUserParameterSet(@Nonnull final ApprovalFilterByCurrentUserParameterSetBuilder builder) {
        this.on = builder.on;
    }
    /**
    ...
    public static final class ApprovalFilterByCurrentUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public ApprovalFilterByCurrentUserParameterSetBuilder withOn(@Nullable final ApprovalFilterByCurrentUserOptions val) {
            this.on = val;
            return this;
        }
        /**
