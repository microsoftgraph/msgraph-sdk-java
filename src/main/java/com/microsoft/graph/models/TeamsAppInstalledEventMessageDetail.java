...
/**
 * The class for the Teams App Installed Event Message Detail.
 */
public class TeamsAppInstalledEventMessageDetail extends EventMessageDetail implements IJsonBackedObject {
