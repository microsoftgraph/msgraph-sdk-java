...
public class EmployeeOrgData implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("costCenter", (n) -> { currentObject.setCostCenter(n.getStringValue()); });
        deserializerMap.put("division", (n) -> { currentObject.setDivision(n.getStringValue()); });
