...
public class MainError implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("details", (n) -> { currentObject.setDetails(n.getCollectionOfObjectValues(ErrorDetails::createFromDiscriminatorValue)); });
        deserializerMap.put("innererror", (n) -> { currentObject.setInnererror(n.getObjectValue(InnerError::createFromDiscriminatorValue)); });
