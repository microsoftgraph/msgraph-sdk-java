...
public class ServicePrincipalCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static ServicePrincipalCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(ServicePrincipal::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<ServicePrincipal> getValue() {
        return this._value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<ServicePrincipal> value) {
        this._value = value;
    }
}
