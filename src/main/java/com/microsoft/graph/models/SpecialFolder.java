...
public class SpecialFolder implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static SpecialFolder createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
