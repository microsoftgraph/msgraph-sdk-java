...
public class EducationUser extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("assignments", (n) -> { currentObject.setAssignments(n.getCollectionOfObjectValues(EducationAssignment::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("externalSource", (n) -> { currentObject.setExternalSource(n.getEnumValue(EducationExternalSource.class)); });
        deserializerMap.put("externalSourceDetail", (n) -> { currentObject.setExternalSourceDetail(n.getStringValue()); });
        ...
        deserializerMap.put("mailingAddress", (n) -> { currentObject.setMailingAddress(n.getObjectValue(PhysicalAddress::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("onPremisesInfo", (n) -> { currentObject.setOnPremisesInfo(n.getObjectValue(EducationOnPremisesInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("primaryRole", (n) -> { currentObject.setPrimaryRole(n.getEnumValue(EducationUserRole.class)); });
        ...
        deserializerMap.put("relatedContacts", (n) -> { currentObject.setRelatedContacts(n.getCollectionOfObjectValues(RelatedContact::createFromDiscriminatorValue)); });
        deserializerMap.put("residenceAddress", (n) -> { currentObject.setResidenceAddress(n.getObjectValue(PhysicalAddress::createFromDiscriminatorValue)); });
        deserializerMap.put("rubrics", (n) -> { currentObject.setRubrics(n.getCollectionOfObjectValues(EducationRubric::createFromDiscriminatorValue)); });
        deserializerMap.put("schools", (n) -> { currentObject.setSchools(n.getCollectionOfObjectValues(EducationSchool::createFromDiscriminatorValue)); });
        deserializerMap.put("showInAddressList", (n) -> { currentObject.setShowInAddressList(n.getBooleanValue()); });
        deserializerMap.put("student", (n) -> { currentObject.setStudent(n.getObjectValue(EducationStudent::createFromDiscriminatorValue)); });
        deserializerMap.put("surname", (n) -> { currentObject.setSurname(n.getStringValue()); });
        deserializerMap.put("taughtClasses", (n) -> { currentObject.setTaughtClasses(n.getCollectionOfObjectValues(EducationClass::createFromDiscriminatorValue)); });
        deserializerMap.put("teacher", (n) -> { currentObject.setTeacher(n.getObjectValue(EducationTeacher::createFromDiscriminatorValue)); });
