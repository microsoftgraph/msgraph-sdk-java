...
public class ArticleIndicatorCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static ArticleIndicatorCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<ArticleIndicator> value) {
        this.value = value;
    }
}
