...
/**
 * The class for the Workbook Filter Clear Parameter Set.
 */
public class WorkbookFilterClearParameterSet {
     ...
     */
    @Nonnull
    public static WorkbookFilterClearParameterSetBuilder newBuilder() {
        return new WorkbookFilterClearParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookFilterClearParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFilterClearParameterSet build() {
            return new WorkbookFilterClearParameterSet(this);
        }
    }
    /**
