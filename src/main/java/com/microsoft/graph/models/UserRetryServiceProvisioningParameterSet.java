...
public class UserRetryServiceProvisioningParameterSet {
    ...
    /**
     * Instiaciates a new UserRetryServiceProvisioningParameterSet
     */
     ...
     */
    protected UserRetryServiceProvisioningParameterSet(@Nonnull final UserRetryServiceProvisioningParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the UserRetryServiceProvisioningParameterSet
     */
    public static final class UserRetryServiceProvisioningParameterSetBuilder {
        /**
         * Instanciates a new UserRetryServiceProvisioningParameterSetBuilder
         */
        @Nullable
