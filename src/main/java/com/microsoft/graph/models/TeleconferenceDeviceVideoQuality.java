...
public class TeleconferenceDeviceVideoQuality extends TeleconferenceDeviceMediaQuality implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("averageInboundBitRate", (n) -> { currentObject.setAverageInboundBitRate(n.getDoubleValue()); });
        deserializerMap.put("averageInboundFrameRate", (n) -> { currentObject.setAverageInboundFrameRate(n.getDoubleValue()); });
        deserializerMap.put("averageOutboundBitRate", (n) -> { currentObject.setAverageOutboundBitRate(n.getDoubleValue()); });
        deserializerMap.put("averageOutboundFrameRate", (n) -> { currentObject.setAverageOutboundFrameRate(n.getDoubleValue()); });
