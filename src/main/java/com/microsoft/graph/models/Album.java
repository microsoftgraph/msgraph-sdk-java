...
public class Album implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public static Album createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getCoverImageItemId() {
        return this.getBackingStore().get("coverImageItemId");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("coverImageItemId", (n) -> { this.setCoverImageItemId(n.getStringValue()); });
    ...
    public void setCoverImageItemId(@jakarta.annotation.Nullable final String value) {
        this.getBackingStore().set("coverImageItemId", value);
    }
    /**
