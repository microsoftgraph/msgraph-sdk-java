...
public class TeamsAppAuthorization implements AdditionalDataHolder, Parsable {
    ...
    public static TeamsAppAuthorization createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRequiredPermissionSet(@javax.annotation.Nullable final TeamsAppPermissionSet value) {
