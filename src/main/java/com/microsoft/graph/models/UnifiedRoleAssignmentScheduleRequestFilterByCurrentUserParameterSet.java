...
/**
 * The class for the Unified Role Assignment Schedule Request Filter By Current User Parameter Set.
 */
public class UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSet {
    ...
    /**
     * Instiaciates a new UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSet
     */
     ...
     */
    protected UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSet(@Nonnull final UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder builder) {
        this.on = builder.on;
    }
    /**
    ...
    public static final class UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder withOn(@Nullable final RoleAssignmentScheduleRequestFilterByCurrentUserOptions val) {
            this.on = val;
            return this;
        }
        /**
         * Instanciates a new UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder
         */
        @Nullable
        protected UnifiedRoleAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder(){}
        /**
