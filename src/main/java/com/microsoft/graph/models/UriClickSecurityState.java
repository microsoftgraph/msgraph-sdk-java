...
public class UriClickSecurityState implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("clickAction", (n) -> { currentObject.setClickAction(n.getStringValue()); });
        deserializerMap.put("clickDateTime", (n) -> { currentObject.setClickDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("uriDomain", (n) -> { currentObject.setUriDomain(n.getStringValue()); });
        deserializerMap.put("verdict", (n) -> { currentObject.setVerdict(n.getStringValue()); });
