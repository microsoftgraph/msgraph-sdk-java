...
/**
 * The class for the Service Health Issue Incident Report Parameter Set.
 */
public class ServiceHealthIssueIncidentReportParameterSet {
     ...
     */
    protected ServiceHealthIssueIncidentReportParameterSet(@Nonnull final ServiceHealthIssueIncidentReportParameterSetBuilder builder) {
    }
    /**
    ...
    public static final class ServiceHealthIssueIncidentReportParameterSetBuilder {
        /**
         * Instanciates a new ServiceHealthIssueIncidentReportParameterSetBuilder
         */
        @Nullable
