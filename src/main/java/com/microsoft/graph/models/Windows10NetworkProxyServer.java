...
public class Windows10NetworkProxyServer implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("exceptions", (n) -> { currentObject.setExceptions(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("useForLocalAddresses", (n) -> { currentObject.setUseForLocalAddresses(n.getBooleanValue()); });
