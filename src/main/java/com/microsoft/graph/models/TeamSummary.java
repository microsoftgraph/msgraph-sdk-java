...
public class TeamSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("guestsCount", (n) -> { currentObject.setGuestsCount(n.getIntegerValue()); });
        deserializerMap.put("membersCount", (n) -> { currentObject.setMembersCount(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("ownersCount", (n) -> { currentObject.setOwnersCount(n.getIntegerValue()); });
