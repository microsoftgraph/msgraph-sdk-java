...
/**
 * The class for the Privileged Access Group Assignment Schedule Instance Filter By Current User Parameter Set.
 */
public class PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSet {
    ...
    /**
     * Instiaciates a new PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSet
     */
     ...
     */
    protected PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSet(@Nonnull final PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSetBuilder builder) {
        this.on = builder.on;
    }
    /**
    ...
    /**
     * Fluent builder for the PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSet
     */
    public static final class PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSetBuilder withOn(@Nullable final AssignmentScheduleInstanceFilterByCurrentUserOptions val) {
            this.on = val;
            return this;
        }
        /**
         * Instanciates a new PrivilegedAccessGroupAssignmentScheduleInstanceFilterByCurrentUserParameterSetBuilder
         */
        @Nullable
