...
import com.microsoft.graph.models.DisableAndDeleteUserApplyAction;
import com.microsoft.graph.models.RemoveAccessApplyAction;
...
public class AccessReviewApplyAction implements AdditionalDataHolder, Parsable {
    ...
    public static AccessReviewApplyAction createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AccessReviewApplyAction currentObject = this;
