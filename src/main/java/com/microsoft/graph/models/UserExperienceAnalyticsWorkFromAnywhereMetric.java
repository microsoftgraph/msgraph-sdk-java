...
/**
 * The class for the User Experience Analytics Work From Anywhere Metric.
 */
public class UserExperienceAnalyticsWorkFromAnywhereMetric extends Entity implements IJsonBackedObject {
