...
public class RiskyServicePrincipalHistoryItemCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static RiskyServicePrincipalHistoryItemCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nonnull
    public void setValue(@jakarta.annotation.Nullable final java.util.List<RiskyServicePrincipalHistoryItem> value) {
        this.value = value;
    }
}
