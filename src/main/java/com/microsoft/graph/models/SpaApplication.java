...
public class SpaApplication implements AdditionalDataHolder, Parsable {
    ...
    public static SpaApplication createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SpaApplication currentObject = this;
