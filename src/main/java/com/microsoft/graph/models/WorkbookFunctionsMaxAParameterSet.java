...
/**
 * The class for the Workbook Functions Max AParameter Set.
 */
public class WorkbookFunctionsMaxAParameterSet {
    /**
     * The values.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsMaxAParameterSetBuilder newBuilder() {
        return new WorkbookFunctionsMaxAParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookFunctionsMaxAParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsMaxAParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsMaxAParameterSetBuilder
         */
        @Nullable
         ...
         */
        @Nonnull
        public WorkbookFunctionsMaxAParameterSet build() {
            return new WorkbookFunctionsMaxAParameterSet(this);
        }
    }
    /**
