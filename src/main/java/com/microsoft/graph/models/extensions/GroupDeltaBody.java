...
/**
 * The class for the Group Delta Body.
 */
public class GroupDeltaBody {
     ...
     */
    @Nonnull
    public static GroupDeltaBodyBuilder newBuilder() {
        return new GroupDeltaBodyBuilder();
    }
    /**
    ...
    public static final class GroupDeltaBodyBuilder {
         ...
         */
        @Nonnull
        public GroupDeltaBody build() {
            return new GroupDeltaBody(this);
        }
    }
    /**
