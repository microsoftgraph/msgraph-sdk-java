...
public class EventAcceptParameterSet {
    ...
    private EventAcceptParameterSet(@Nonnull final EventAcceptParameterSetBuilder builder) {
     ...
     */
    public static final class EventAcceptParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private EventAcceptParameterSetBuilder(){}
        /**
