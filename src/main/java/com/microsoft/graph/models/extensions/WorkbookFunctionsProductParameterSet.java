...
public class WorkbookFunctionsProductParameterSet {
    ...
    private WorkbookFunctionsProductParameterSet(@Nonnull final WorkbookFunctionsProductParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsProductParameterSet
     */
    public static final class WorkbookFunctionsProductParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsProductParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        private WorkbookFunctionsProductParameterSetBuilder(){}
        /**
