...
/**
 * The class for the Workbook Functions Im Sech Parameter Set.
 */
public class WorkbookFunctionsImSechParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsImSechParameterSet
     */
    public WorkbookFunctionsImSechParameterSet() {}
    private WorkbookFunctionsImSechParameterSet(@Nonnull final WorkbookFunctionsImSechParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsImSechParameterSet
     */
    public static final class WorkbookFunctionsImSechParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImSechParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
        private WorkbookFunctionsImSechParameterSetBuilder(){}
        /**
