...
/**
 * The class for the Domain Verify Parameter Set.
 */
public class DomainVerifyParameterSet {
     ...
     */
    @Nonnull
    public static DomainVerifyParameterSetBuilder newBuilder() {
        return new DomainVerifyParameterSetBuilder();
    }
    /**
     * Fluent builder for the DomainVerifyParameterSet
     */
    public static final class DomainVerifyParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public DomainVerifyParameterSet build() {
            return new DomainVerifyParameterSet(this);
        }
    }
    /**
