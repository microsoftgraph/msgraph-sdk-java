...
/**
 * The class for the Report Root Get Yammer Groups Activity Detail Parameter Set.
 */
public class ReportRootGetYammerGroupsActivityDetailParameterSet {
    /**
     * The date.
     * 
     */
     ...
     */
    @Nonnull
    public static ReportRootGetYammerGroupsActivityDetailParameterSetBuilder newBuilder() {
        return new ReportRootGetYammerGroupsActivityDetailParameterSetBuilder();
    }
    /**
    ...
    public static final class ReportRootGetYammerGroupsActivityDetailParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetYammerGroupsActivityDetailParameterSetBuilder withDate(@Nullable final com.microsoft.graph.core.DateOnly val) {
            this.date = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public ReportRootGetYammerGroupsActivityDetailParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetYammerGroupsActivityDetailParameterSetBuilder
         */
        @Nullable
         ...
         */
        @Nonnull
        public ReportRootGetYammerGroupsActivityDetailParameterSet build() {
            return new ReportRootGetYammerGroupsActivityDetailParameterSet(this);
        }
    }
    /**
