...
/**
 * The class for the Directory Object Get Available Extension Properties Parameter Set.
 */
public class DirectoryObjectGetAvailableExtensionPropertiesParameterSet {
     ...
     */
    public static final class DirectoryObjectGetAvailableExtensionPropertiesParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public DirectoryObjectGetAvailableExtensionPropertiesParameterSetBuilder withIsSyncedFromOnPremises(@Nullable final Boolean val) {
