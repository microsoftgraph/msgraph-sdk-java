 ...
 */
public class WorkbookFunctionsTbillYieldBody {
    /**
     * The settlement.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsTbillYieldBodyBuilder newBuilder() {
        return new WorkbookFunctionsTbillYieldBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsTbillYieldBody
     */
    public static final class WorkbookFunctionsTbillYieldBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsTbillYieldBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsTbillYieldBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsTbillYieldBodyBuilder withPr(@Nullable final com.google.gson.JsonElement val) {
            this.pr = val;
            return this;
        }
        private WorkbookFunctionsTbillYieldBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsTbillYieldBody build() {
            return new WorkbookFunctionsTbillYieldBody(this);
        }
    }
    /**
