...
/**
 * The class for the Workbook Functions Is NAParameter Set.
 */
public class WorkbookFunctionsIsNAParameterSet {
    ...
    private WorkbookFunctionsIsNAParameterSet(@Nonnull final WorkbookFunctionsIsNAParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookFunctionsIsNAParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsIsNAParameterSetBuilder withValue(@Nullable final com.google.gson.JsonElement val) {
            this.value = val;
            return this;
        }
        private WorkbookFunctionsIsNAParameterSetBuilder(){}
        /**
