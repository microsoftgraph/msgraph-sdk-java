...
/**
 * The class for the Search Entity Query Body.
 */
public class SearchEntityQueryBody {
    /**
     * The requests.
     * 
     */
     ...
     */
    @Nonnull
    public static SearchEntityQueryBodyBuilder newBuilder() {
        return new SearchEntityQueryBodyBuilder();
    }
    /**
     * Fluent builder for the SearchEntityQueryBody
     */
    public static final class SearchEntityQueryBodyBuilder {
         ...
         */
        @Nonnull
        public SearchEntityQueryBodyBuilder withRequests(@Nullable final java.util.List<SearchRequest> val) {
            this.requests = val;
            return this;
        }
        private SearchEntityQueryBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public SearchEntityQueryBody build() {
            return new SearchEntityQueryBody(this);
        }
    }
    /**
