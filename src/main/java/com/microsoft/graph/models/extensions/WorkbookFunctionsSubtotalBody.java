...
public class WorkbookFunctionsSubtotalBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsSubtotalBodyBuilder newBuilder() {
        return new WorkbookFunctionsSubtotalBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsSubtotalBody
     */
    public static final class WorkbookFunctionsSubtotalBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsSubtotalBodyBuilder withFunctionNum(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsSubtotalBodyBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        private WorkbookFunctionsSubtotalBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsSubtotalBody build() {
            return new WorkbookFunctionsSubtotalBody(this);
        }
    }
    /**
