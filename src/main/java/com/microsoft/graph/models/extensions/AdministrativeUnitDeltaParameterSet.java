...
/**
 * The class for the Administrative Unit Delta Parameter Set.
 */
public class AdministrativeUnitDeltaParameterSet {
    ...
    /**
     * Instiaciates a new AdministrativeUnitDeltaParameterSet
     */
    public AdministrativeUnitDeltaParameterSet() {}
    private AdministrativeUnitDeltaParameterSet(@Nonnull final AdministrativeUnitDeltaParameterSetBuilder builder) {
     ...
     */
    public static final class AdministrativeUnitDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public AdministrativeUnitDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public AdministrativeUnitDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
            this.deltaToken = this.getDeltaTokenFromLink(val);
            return this;
        }
        private AdministrativeUnitDeltaParameterSetBuilder(){}
        /**
