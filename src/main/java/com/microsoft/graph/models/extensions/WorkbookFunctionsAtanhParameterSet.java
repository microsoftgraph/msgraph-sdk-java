...
public class WorkbookFunctionsAtanhParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsAtanhParameterSet
     */
    public WorkbookFunctionsAtanhParameterSet() {}
    private WorkbookFunctionsAtanhParameterSet(@Nonnull final WorkbookFunctionsAtanhParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsAtanhParameterSet
     */
    public static final class WorkbookFunctionsAtanhParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsAtanhParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        private WorkbookFunctionsAtanhParameterSetBuilder(){}
        /**
