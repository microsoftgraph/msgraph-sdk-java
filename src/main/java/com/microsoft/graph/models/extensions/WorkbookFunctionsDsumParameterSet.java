...
/**
 * The class for the Workbook Functions Dsum Parameter Set.
 */
public class WorkbookFunctionsDsumParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsDsumParameterSet
     */
    public WorkbookFunctionsDsumParameterSet() {}
    private WorkbookFunctionsDsumParameterSet(@Nonnull final WorkbookFunctionsDsumParameterSetBuilder builder) {
    ...
    public static final class WorkbookFunctionsDsumParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDsumParameterSetBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDsumParameterSetBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDsumParameterSetBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDsumParameterSetBuilder(){}
        /**
