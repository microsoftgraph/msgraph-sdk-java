...
public class WorkbookFunctionsLeftbBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsLeftbBodyBuilder newBuilder() {
        return new WorkbookFunctionsLeftbBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsLeftbBody
     */
    public static final class WorkbookFunctionsLeftbBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsLeftbBodyBuilder withText(@Nullable final com.google.gson.JsonElement val) {
            this.text = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsLeftbBodyBuilder withNumBytes(@Nullable final com.google.gson.JsonElement val) {
            this.numBytes = val;
            return this;
        }
        private WorkbookFunctionsLeftbBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsLeftbBody build() {
            return new WorkbookFunctionsLeftbBody(this);
        }
    }
    /**
