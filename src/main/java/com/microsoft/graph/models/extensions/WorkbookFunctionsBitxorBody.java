...
public class WorkbookFunctionsBitxorBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsBitxorBodyBuilder newBuilder() {
        return new WorkbookFunctionsBitxorBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsBitxorBody
     */
    public static final class WorkbookFunctionsBitxorBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsBitxorBodyBuilder withNumber1(@Nullable final com.google.gson.JsonElement val) {
            this.number1 = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsBitxorBodyBuilder withNumber2(@Nullable final com.google.gson.JsonElement val) {
            this.number2 = val;
            return this;
        }
        private WorkbookFunctionsBitxorBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsBitxorBody build() {
            return new WorkbookFunctionsBitxorBody(this);
        }
    }
    /**
