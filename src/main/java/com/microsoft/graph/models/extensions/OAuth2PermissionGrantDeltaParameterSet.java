...
public class OAuth2PermissionGrantDeltaParameterSet {
     ...
     */
    public static final class OAuth2PermissionGrantDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public OAuth2PermissionGrantDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public OAuth2PermissionGrantDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
