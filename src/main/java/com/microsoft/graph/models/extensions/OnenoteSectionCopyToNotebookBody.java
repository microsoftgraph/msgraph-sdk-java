...
public class OnenoteSectionCopyToNotebookBody {
     ...
     */
    @Nonnull
    public static OnenoteSectionCopyToNotebookBodyBuilder newBuilder() {
        return new OnenoteSectionCopyToNotebookBodyBuilder();
    }
    /**
     * Fluent builder for the OnenoteSectionCopyToNotebookBody
     */
    public static final class OnenoteSectionCopyToNotebookBodyBuilder {
         ...
         */
        @Nonnull
        public OnenoteSectionCopyToNotebookBodyBuilder withId(@Nullable final String val) {
            this.id = val;
            return this;
        }
         ...
         */
        @Nonnull
        public OnenoteSectionCopyToNotebookBodyBuilder withGroupId(@Nullable final String val) {
            this.groupId = val;
            return this;
        }
         ...
         */
        @Nonnull
        public OnenoteSectionCopyToNotebookBodyBuilder withRenameAs(@Nullable final String val) {
            this.renameAs = val;
            return this;
        }
         ...
         */
        @Nonnull
        public OnenoteSectionCopyToNotebookBodyBuilder withSiteCollectionId(@Nullable final String val) {
         ...
         */
        @Nonnull
        public OnenoteSectionCopyToNotebookBodyBuilder withSiteId(@Nullable final String val) {
            this.siteId = val;
            return this;
        }
        private OnenoteSectionCopyToNotebookBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public OnenoteSectionCopyToNotebookBody build() {
            return new OnenoteSectionCopyToNotebookBody(this);
        }
    }
    /**
