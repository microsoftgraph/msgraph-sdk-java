...
public class WorkbookFunctionsCoupPcdBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsCoupPcdBodyBuilder newBuilder() {
        return new WorkbookFunctionsCoupPcdBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsCoupPcdBody
     */
    public static final class WorkbookFunctionsCoupPcdBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupPcdBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupPcdBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupPcdBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupPcdBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsCoupPcdBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsCoupPcdBody build() {
            return new WorkbookFunctionsCoupPcdBody(this);
        }
    }
    /**
