...
public class ManagedDeviceMobileAppConfigurationAssignBody {
     ...
     */
    @Nonnull
    public static ManagedDeviceMobileAppConfigurationAssignBodyBuilder newBuilder() {
        return new ManagedDeviceMobileAppConfigurationAssignBodyBuilder();
    }
    /**
     * Fluent builder for the ManagedDeviceMobileAppConfigurationAssignBody
     */
    public static final class ManagedDeviceMobileAppConfigurationAssignBodyBuilder {
         ...
         */
        @Nonnull
        public ManagedDeviceMobileAppConfigurationAssignBodyBuilder withAssignments(@Nullable final java.util.List<ManagedDeviceMobileAppConfigurationAssignment> val) {
            this.assignments = val;
            return this;
        }
        private ManagedDeviceMobileAppConfigurationAssignBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public ManagedDeviceMobileAppConfigurationAssignBody build() {
            return new ManagedDeviceMobileAppConfigurationAssignBody(this);
        }
    }
    /**
