 ...
 */
public class WorkbookFunctionsDaverageBody {
    /**
     * The database.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDaverageBodyBuilder newBuilder() {
        return new WorkbookFunctionsDaverageBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDaverageBody
     */
    public static final class WorkbookFunctionsDaverageBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaverageBodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaverageBodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaverageBodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDaverageBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDaverageBody build() {
            return new WorkbookFunctionsDaverageBody(this);
        }
    }
    /**
