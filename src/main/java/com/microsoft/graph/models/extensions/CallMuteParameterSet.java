...
public class CallMuteParameterSet {
    ...
    private CallMuteParameterSet(@Nonnull final CallMuteParameterSetBuilder builder) {
     ...
     */
    public static final class CallMuteParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private CallMuteParameterSetBuilder(){}
        /**
