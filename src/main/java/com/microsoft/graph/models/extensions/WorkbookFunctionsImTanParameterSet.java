...
/**
 * The class for the Workbook Functions Im Tan Parameter Set.
 */
public class WorkbookFunctionsImTanParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsImTanParameterSet
     */
    public WorkbookFunctionsImTanParameterSet() {}
    private WorkbookFunctionsImTanParameterSet(@Nonnull final WorkbookFunctionsImTanParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsImTanParameterSet
     */
    public static final class WorkbookFunctionsImTanParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImTanParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
        private WorkbookFunctionsImTanParameterSetBuilder(){}
        /**
