...
/**
 * The class for the Organization Set Mobile Device Management Authority Parameter Set.
 */
public class OrganizationSetMobileDeviceManagementAuthorityParameterSet {
     ...
     */
    @Nonnull
    public static OrganizationSetMobileDeviceManagementAuthorityParameterSetBuilder newBuilder() {
        return new OrganizationSetMobileDeviceManagementAuthorityParameterSetBuilder();
    }
    /**
     * Fluent builder for the OrganizationSetMobileDeviceManagementAuthorityParameterSet
     */
    public static final class OrganizationSetMobileDeviceManagementAuthorityParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public OrganizationSetMobileDeviceManagementAuthorityParameterSet build() {
            return new OrganizationSetMobileDeviceManagementAuthorityParameterSet(this);
        }
    }
    /**
