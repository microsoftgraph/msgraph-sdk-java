...
public class WorkbookFunctionsExactBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsExactBodyBuilder newBuilder() {
        return new WorkbookFunctionsExactBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsExactBody
     */
    public static final class WorkbookFunctionsExactBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsExactBodyBuilder withText1(@Nullable final com.google.gson.JsonElement val) {
            this.text1 = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsExactBodyBuilder withText2(@Nullable final com.google.gson.JsonElement val) {
            this.text2 = val;
            return this;
        }
        private WorkbookFunctionsExactBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsExactBody build() {
            return new WorkbookFunctionsExactBody(this);
        }
    }
    /**
