...
/**
 * The class for the Workbook Functions Dvar PParameter Set.
 */
public class WorkbookFunctionsDvarPParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsDvarPParameterSet
     */
    public WorkbookFunctionsDvarPParameterSet() {}
    private WorkbookFunctionsDvarPParameterSet(@Nonnull final WorkbookFunctionsDvarPParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsDvarPParameterSet
     */
    public static final class WorkbookFunctionsDvarPParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDvarPParameterSetBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDvarPParameterSetBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDvarPParameterSetBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDvarPParameterSetBuilder(){}
        /**
