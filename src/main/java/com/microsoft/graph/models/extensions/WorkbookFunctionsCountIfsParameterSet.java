...
public class WorkbookFunctionsCountIfsParameterSet {
     ...
     */
    public static final class WorkbookFunctionsCountIfsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCountIfsParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
