...
/**
 * The class for the Directory Role Delta Parameter Set.
 */
public class DirectoryRoleDeltaParameterSet {
     ...
     */
    public static final class DirectoryRoleDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public DirectoryRoleDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DirectoryRoleDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
