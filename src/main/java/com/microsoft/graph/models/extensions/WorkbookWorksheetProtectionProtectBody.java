...
public class WorkbookWorksheetProtectionProtectBody {
     ...
     */
    @Nonnull
    public static WorkbookWorksheetProtectionProtectBodyBuilder newBuilder() {
        return new WorkbookWorksheetProtectionProtectBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookWorksheetProtectionProtectBody
     */
    public static final class WorkbookWorksheetProtectionProtectBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookWorksheetProtectionProtectBodyBuilder withOptions(@Nullable final WorkbookWorksheetProtectionOptions val) {
            this.options = val;
            return this;
        }
        private WorkbookWorksheetProtectionProtectBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookWorksheetProtectionProtectBody build() {
            return new WorkbookWorksheetProtectionProtectBody(this);
        }
    }
    /**
