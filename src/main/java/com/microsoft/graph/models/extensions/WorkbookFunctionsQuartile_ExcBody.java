 ...
 */
public class WorkbookFunctionsQuartile_ExcBody {
    /**
     * The array.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsQuartile_ExcBodyBuilder newBuilder() {
        return new WorkbookFunctionsQuartile_ExcBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsQuartile_ExcBody
     */
    public static final class WorkbookFunctionsQuartile_ExcBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsQuartile_ExcBodyBuilder withArray(@Nullable final com.google.gson.JsonElement val) {
            this.array = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsQuartile_ExcBodyBuilder withQuart(@Nullable final com.google.gson.JsonElement val) {
            this.quart = val;
            return this;
        }
        private WorkbookFunctionsQuartile_ExcBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsQuartile_ExcBody build() {
            return new WorkbookFunctionsQuartile_ExcBody(this);
        }
    }
    /**
