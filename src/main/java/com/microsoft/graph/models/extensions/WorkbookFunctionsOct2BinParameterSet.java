...
public class WorkbookFunctionsOct2BinParameterSet {
     ...
     */
    public static final class WorkbookFunctionsOct2BinParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOct2BinParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOct2BinParameterSetBuilder withPlaces(@Nullable final com.google.gson.JsonElement val) {
            this.places = val;
            return this;
        }
