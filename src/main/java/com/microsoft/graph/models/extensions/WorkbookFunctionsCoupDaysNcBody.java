 ...
 */
public class WorkbookFunctionsCoupDaysNcBody {
    /**
     * The settlement.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsCoupDaysNcBodyBuilder newBuilder() {
        return new WorkbookFunctionsCoupDaysNcBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsCoupDaysNcBody
     */
    public static final class WorkbookFunctionsCoupDaysNcBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupDaysNcBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupDaysNcBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupDaysNcBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupDaysNcBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsCoupDaysNcBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsCoupDaysNcBody build() {
            return new WorkbookFunctionsCoupDaysNcBody(this);
        }
    }
    /**
