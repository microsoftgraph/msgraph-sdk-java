...
public class WorkbookFunctionsDvarPBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDvarPBodyBuilder newBuilder() {
        return new WorkbookFunctionsDvarPBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDvarPBody
     */
    public static final class WorkbookFunctionsDvarPBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDvarPBodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDvarPBodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDvarPBodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDvarPBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDvarPBody build() {
            return new WorkbookFunctionsDvarPBody(this);
        }
    }
    /**
