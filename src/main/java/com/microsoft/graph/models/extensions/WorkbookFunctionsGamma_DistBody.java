...
public class WorkbookFunctionsGamma_DistBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsGamma_DistBodyBuilder newBuilder() {
        return new WorkbookFunctionsGamma_DistBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsGamma_DistBody
     */
    public static final class WorkbookFunctionsGamma_DistBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistBodyBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistBodyBuilder withAlpha(@Nullable final com.google.gson.JsonElement val) {
            this.alpha = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistBodyBuilder withBeta(@Nullable final com.google.gson.JsonElement val) {
            this.beta = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistBodyBuilder withCumulative(@Nullable final com.google.gson.JsonElement val) {
            this.cumulative = val;
            return this;
        }
        private WorkbookFunctionsGamma_DistBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistBody build() {
            return new WorkbookFunctionsGamma_DistBody(this);
        }
    }
    /**
