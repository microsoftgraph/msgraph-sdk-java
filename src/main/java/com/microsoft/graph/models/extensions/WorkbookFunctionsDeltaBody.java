...
public class WorkbookFunctionsDeltaBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDeltaBodyBuilder newBuilder() {
        return new WorkbookFunctionsDeltaBodyBuilder();
    }
    /**
    ...
    public static final class WorkbookFunctionsDeltaBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDeltaBodyBuilder withNumber1(@Nullable final com.google.gson.JsonElement val) {
            this.number1 = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDeltaBodyBuilder withNumber2(@Nullable final com.google.gson.JsonElement val) {
            this.number2 = val;
            return this;
        }
        private WorkbookFunctionsDeltaBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDeltaBody build() {
            return new WorkbookFunctionsDeltaBody(this);
        }
    }
    /**
