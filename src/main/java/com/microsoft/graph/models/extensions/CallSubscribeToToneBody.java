...
public class CallSubscribeToToneBody {
     ...
     */
    @Nonnull
    public static CallSubscribeToToneBodyBuilder newBuilder() {
        return new CallSubscribeToToneBodyBuilder();
    }
    /**
     * Fluent builder for the CallSubscribeToToneBody
     */
    public static final class CallSubscribeToToneBodyBuilder {
         ...
         */
        @Nonnull
        public CallSubscribeToToneBodyBuilder withClientContext(@Nullable final String val) {
            this.clientContext = val;
            return this;
        }
        private CallSubscribeToToneBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public CallSubscribeToToneBody build() {
            return new CallSubscribeToToneBody(this);
        }
    }
    /**
