...
/**
 * The class for the Windows Information Protection Assign Parameter Set.
 */
public class WindowsInformationProtectionAssignParameterSet {
     ...
     */
    public static final class WindowsInformationProtectionAssignParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WindowsInformationProtectionAssignParameterSetBuilder withAssignments(@Nullable final java.util.List<TargetedManagedAppPolicyAssignment> val) {
