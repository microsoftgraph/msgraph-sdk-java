...
public class DirectoryObjectGetMemberObjectsBody {
     ...
     */
    @Nonnull
    public static DirectoryObjectGetMemberObjectsBodyBuilder newBuilder() {
        return new DirectoryObjectGetMemberObjectsBodyBuilder();
    }
    /**
     * Fluent builder for the DirectoryObjectGetMemberObjectsBody
     */
    public static final class DirectoryObjectGetMemberObjectsBodyBuilder {
         ...
         */
        @Nonnull
        public DirectoryObjectGetMemberObjectsBodyBuilder withSecurityEnabledOnly(@Nullable final Boolean val) {
            this.securityEnabledOnly = val;
            return this;
        }
        private DirectoryObjectGetMemberObjectsBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DirectoryObjectGetMemberObjectsBody build() {
            return new DirectoryObjectGetMemberObjectsBody(this);
        }
    }
    /**
