...
public class WorkbookFunctionsDstDevPBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDstDevPBodyBuilder newBuilder() {
        return new WorkbookFunctionsDstDevPBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDstDevPBody
     */
    public static final class WorkbookFunctionsDstDevPBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDstDevPBodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDstDevPBodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDstDevPBodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDstDevPBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDstDevPBody build() {
            return new WorkbookFunctionsDstDevPBody(this);
        }
    }
    /**
