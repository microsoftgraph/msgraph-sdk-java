...
public class UserAssignLicenseBody {
     ...
     */
    @Nonnull
    public static UserAssignLicenseBodyBuilder newBuilder() {
        return new UserAssignLicenseBodyBuilder();
    }
    /**
     * Fluent builder for the UserAssignLicenseBody
     */
    public static final class UserAssignLicenseBodyBuilder {
         ...
         */
        @Nonnull
        public UserAssignLicenseBodyBuilder withAddLicenses(@Nullable final java.util.List<AssignedLicense> val) {
         ...
         */
        @Nonnull
        public UserAssignLicenseBodyBuilder withRemoveLicenses(@Nullable final java.util.List<java.util.UUID> val) {
            this.removeLicenses = val;
            return this;
        }
        private UserAssignLicenseBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public UserAssignLicenseBody build() {
            return new UserAssignLicenseBody(this);
        }
    }
    /**
