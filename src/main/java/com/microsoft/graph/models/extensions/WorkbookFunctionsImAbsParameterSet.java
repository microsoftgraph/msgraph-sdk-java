...
/**
 * The class for the Workbook Functions Im Abs Parameter Set.
 */
public class WorkbookFunctionsImAbsParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsImAbsParameterSet
     */
    public WorkbookFunctionsImAbsParameterSet() {}
    private WorkbookFunctionsImAbsParameterSet(@Nonnull final WorkbookFunctionsImAbsParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsImAbsParameterSet
     */
    public static final class WorkbookFunctionsImAbsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImAbsParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
        private WorkbookFunctionsImAbsParameterSetBuilder(){}
        /**
