...
public class WorkbookFunctionsFvBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsFvBodyBuilder newBuilder() {
        return new WorkbookFunctionsFvBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsFvBody
     */
    public static final class WorkbookFunctionsFvBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvBodyBuilder withNper(@Nullable final com.google.gson.JsonElement val) {
            this.nper = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvBodyBuilder withPmt(@Nullable final com.google.gson.JsonElement val) {
            this.pmt = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvBodyBuilder withPv(@Nullable final com.google.gson.JsonElement val) {
            this.pv = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvBodyBuilder withType(@Nullable final com.google.gson.JsonElement val) {
            this.type = val;
            return this;
        }
        private WorkbookFunctionsFvBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsFvBody build() {
            return new WorkbookFunctionsFvBody(this);
        }
    }
    /**
