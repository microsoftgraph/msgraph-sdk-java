...
public class WorkbookFunctionsReplaceBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsReplaceBodyBuilder newBuilder() {
        return new WorkbookFunctionsReplaceBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsReplaceBody
     */
    public static final class WorkbookFunctionsReplaceBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsReplaceBodyBuilder withOldText(@Nullable final com.google.gson.JsonElement val) {
            this.oldText = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReplaceBodyBuilder withStartNum(@Nullable final com.google.gson.JsonElement val) {
            this.startNum = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReplaceBodyBuilder withNumChars(@Nullable final com.google.gson.JsonElement val) {
            this.numChars = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReplaceBodyBuilder withNewText(@Nullable final com.google.gson.JsonElement val) {
            this.newText = val;
            return this;
        }
        private WorkbookFunctionsReplaceBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsReplaceBody build() {
            return new WorkbookFunctionsReplaceBody(this);
        }
    }
    /**
