...
public class WorkbookFunctionsReptBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsReptBodyBuilder newBuilder() {
        return new WorkbookFunctionsReptBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsReptBody
     */
    public static final class WorkbookFunctionsReptBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsReptBodyBuilder withText(@Nullable final com.google.gson.JsonElement val) {
            this.text = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReptBodyBuilder withNumberTimes(@Nullable final com.google.gson.JsonElement val) {
            this.numberTimes = val;
            return this;
        }
        private WorkbookFunctionsReptBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsReptBody build() {
            return new WorkbookFunctionsReptBody(this);
        }
    }
    /**
