...
/**
 * The class for the Report Root Get Skype For Business Organizer Activity Minute Counts Parameter Set.
 */
public class ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsParameterSet {
    ...
    private ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsParameterSet(@Nonnull final ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsParameterSetBuilder builder) {
     ...
     */
    public static final class ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        private ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsParameterSetBuilder(){}
        /**
