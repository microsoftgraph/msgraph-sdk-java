...
public class ManagedDeviceCleanWindowsDeviceBody {
     ...
     */
    @Nonnull
    public static ManagedDeviceCleanWindowsDeviceBodyBuilder newBuilder() {
        return new ManagedDeviceCleanWindowsDeviceBodyBuilder();
    }
    /**
     * Fluent builder for the ManagedDeviceCleanWindowsDeviceBody
     */
    public static final class ManagedDeviceCleanWindowsDeviceBodyBuilder {
         ...
         */
        @Nonnull
        public ManagedDeviceCleanWindowsDeviceBodyBuilder withKeepUserData(@Nullable final Boolean val) {
            this.keepUserData = val;
            return this;
        }
        private ManagedDeviceCleanWindowsDeviceBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public ManagedDeviceCleanWindowsDeviceBody build() {
            return new ManagedDeviceCleanWindowsDeviceBody(this);
        }
    }
    /**
