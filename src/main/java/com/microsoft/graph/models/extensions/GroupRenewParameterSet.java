...
public class GroupRenewParameterSet {
    ...
    private GroupRenewParameterSet(@Nonnull final GroupRenewParameterSetBuilder builder) {
    }
    /**
     ...
     */
    public static final class GroupRenewParameterSetBuilder extends BaseMethodParameterSetBuilder {
        private GroupRenewParameterSetBuilder(){}
        /**
