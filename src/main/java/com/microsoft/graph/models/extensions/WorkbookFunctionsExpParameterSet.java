...
/**
 * The class for the Workbook Functions Exp Parameter Set.
 */
public class WorkbookFunctionsExpParameterSet {
     ...
     */
    public static final class WorkbookFunctionsExpParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsExpParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
