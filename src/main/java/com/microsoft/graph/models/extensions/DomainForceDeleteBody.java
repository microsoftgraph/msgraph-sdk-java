 ...
 */
public class DomainForceDeleteBody {
    /**
     ...
     */
    @Nonnull
    public static DomainForceDeleteBodyBuilder newBuilder() {
        return new DomainForceDeleteBodyBuilder();
    }
    /**
     * Fluent builder for the DomainForceDeleteBody
     */
    public static final class DomainForceDeleteBodyBuilder {
         ...
         */
        @Nonnull
        public DomainForceDeleteBodyBuilder withDisableUserAccounts(@Nullable final Boolean val) {
            this.disableUserAccounts = val;
            return this;
        }
        private DomainForceDeleteBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DomainForceDeleteBody build() {
            return new DomainForceDeleteBody(this);
        }
    }
    /**
