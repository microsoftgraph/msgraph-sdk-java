...
public class CallCancelMediaProcessingBody {
     ...
     */
    @Nonnull
    public static CallCancelMediaProcessingBodyBuilder newBuilder() {
        return new CallCancelMediaProcessingBodyBuilder();
    }
    /**
     * Fluent builder for the CallCancelMediaProcessingBody
     */
    public static final class CallCancelMediaProcessingBodyBuilder {
         ...
         */
        @Nonnull
        public CallCancelMediaProcessingBodyBuilder withClientContext(@Nullable final String val) {
            this.clientContext = val;
            return this;
        }
        private CallCancelMediaProcessingBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public CallCancelMediaProcessingBody build() {
            return new CallCancelMediaProcessingBody(this);
        }
    }
    /**
