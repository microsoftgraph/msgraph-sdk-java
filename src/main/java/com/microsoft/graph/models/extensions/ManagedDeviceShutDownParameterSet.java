...
/**
 * The class for the Managed Device Shut Down Parameter Set.
 */
public class ManagedDeviceShutDownParameterSet {
     ...
     */
    public static final class ManagedDeviceShutDownParameterSetBuilder extends BaseMethodParameterSetBuilder {
