...
public class WorkbookFunctionsNorm_DistParameterSet {
    ...
    private WorkbookFunctionsNorm_DistParameterSet(@Nonnull final WorkbookFunctionsNorm_DistParameterSetBuilder builder) {
        this.x = builder.x;
     ...
     */
    public static final class WorkbookFunctionsNorm_DistParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private WorkbookFunctionsNorm_DistParameterSetBuilder(){}
        /**
