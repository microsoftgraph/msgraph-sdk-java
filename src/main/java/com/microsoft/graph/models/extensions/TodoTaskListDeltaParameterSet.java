...
public class TodoTaskListDeltaParameterSet {
     ...
     */
    public static final class TodoTaskListDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public TodoTaskListDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public TodoTaskListDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
