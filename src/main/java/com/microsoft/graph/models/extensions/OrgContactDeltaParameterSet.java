...
/**
 * The class for the Org Contact Delta Parameter Set.
 */
public class OrgContactDeltaParameterSet {
     ...
     */
    @Nonnull
    public static OrgContactDeltaParameterSetBuilder newBuilder() {
        return new OrgContactDeltaParameterSetBuilder();
    }
    /**
    ...
    public static final class OrgContactDeltaParameterSetBuilder {
         ...
         */
        @Nonnull
        public OrgContactDeltaParameterSet build() {
            return new OrgContactDeltaParameterSet(this);
        }
    }
    /**
