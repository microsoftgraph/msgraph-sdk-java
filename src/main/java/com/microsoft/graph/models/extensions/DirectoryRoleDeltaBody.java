...
/**
 * The class for the Directory Role Delta Body.
 */
public class DirectoryRoleDeltaBody {
     ...
     */
    @Nonnull
    public static DirectoryRoleDeltaBodyBuilder newBuilder() {
        return new DirectoryRoleDeltaBodyBuilder();
    }
    /**
    ...
    public static final class DirectoryRoleDeltaBodyBuilder {
         ...
         */
        @Nonnull
        public DirectoryRoleDeltaBody build() {
            return new DirectoryRoleDeltaBody(this);
        }
    }
    /**
