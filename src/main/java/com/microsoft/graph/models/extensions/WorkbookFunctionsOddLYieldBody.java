...
public class WorkbookFunctionsOddLYieldBody {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsOddLYieldBody
     */
    public WorkbookFunctionsOddLYieldBody() {}
    private WorkbookFunctionsOddLYieldBody(@Nonnull final WorkbookFunctionsOddLYieldBodyBuilder builder) {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsOddLYieldBodyBuilder newBuilder() {
        return new WorkbookFunctionsOddLYieldBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsOddLYieldBody
     */
    public static final class WorkbookFunctionsOddLYieldBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withLastInterest(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withPr(@Nullable final com.google.gson.JsonElement val) {
            this.pr = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsOddLYieldBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsOddLYieldBody build() {
            return new WorkbookFunctionsOddLYieldBody(this);
        }
    }
    /**
