...
public class WorkbookFunctionsTimevalueBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsTimevalueBodyBuilder newBuilder() {
        return new WorkbookFunctionsTimevalueBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsTimevalueBody
     */
    public static final class WorkbookFunctionsTimevalueBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsTimevalueBodyBuilder withTimeText(@Nullable final com.google.gson.JsonElement val) {
            this.timeText = val;
            return this;
        }
        private WorkbookFunctionsTimevalueBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsTimevalueBody build() {
            return new WorkbookFunctionsTimevalueBody(this);
        }
    }
    /**
