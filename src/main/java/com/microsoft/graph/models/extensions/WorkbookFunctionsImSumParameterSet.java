...
/**
 * The class for the Workbook Functions Im Sum Parameter Set.
 */
public class WorkbookFunctionsImSumParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsImSumParameterSet
     */
    public WorkbookFunctionsImSumParameterSet() {}
    private WorkbookFunctionsImSumParameterSet(@Nonnull final WorkbookFunctionsImSumParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookFunctionsImSumParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImSumParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        private WorkbookFunctionsImSumParameterSetBuilder(){}
        /**
