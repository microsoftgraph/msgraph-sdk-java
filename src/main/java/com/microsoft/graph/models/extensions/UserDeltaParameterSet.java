...
public class UserDeltaParameterSet {
     ...
     */
    public static final class UserDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public UserDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public UserDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
