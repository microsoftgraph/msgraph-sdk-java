...
public class WorkbookFunctionsDsumBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDsumBodyBuilder newBuilder() {
        return new WorkbookFunctionsDsumBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDsumBody
     */
    public static final class WorkbookFunctionsDsumBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDsumBodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDsumBodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDsumBodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDsumBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDsumBody build() {
            return new WorkbookFunctionsDsumBody(this);
        }
    }
    /**
