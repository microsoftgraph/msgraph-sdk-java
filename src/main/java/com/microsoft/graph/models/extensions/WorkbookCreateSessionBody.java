 ...
 */
public class WorkbookCreateSessionBody {
    /**
     * The persist Changes.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookCreateSessionBodyBuilder newBuilder() {
        return new WorkbookCreateSessionBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookCreateSessionBody
     */
    public static final class WorkbookCreateSessionBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookCreateSessionBodyBuilder withPersistChanges(@Nullable final Boolean val) {
            this.persistChanges = val;
            return this;
        }
        private WorkbookCreateSessionBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookCreateSessionBody build() {
            return new WorkbookCreateSessionBody(this);
        }
    }
    /**
