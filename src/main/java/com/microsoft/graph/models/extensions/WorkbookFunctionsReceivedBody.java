...
public class WorkbookFunctionsReceivedBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsReceivedBodyBuilder newBuilder() {
        return new WorkbookFunctionsReceivedBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsReceivedBody
     */
    public static final class WorkbookFunctionsReceivedBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsReceivedBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReceivedBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReceivedBodyBuilder withInvestment(@Nullable final com.google.gson.JsonElement val) {
            this.investment = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReceivedBodyBuilder withDiscount(@Nullable final com.google.gson.JsonElement val) {
            this.discount = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsReceivedBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsReceivedBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsReceivedBody build() {
            return new WorkbookFunctionsReceivedBody(this);
        }
    }
    /**
