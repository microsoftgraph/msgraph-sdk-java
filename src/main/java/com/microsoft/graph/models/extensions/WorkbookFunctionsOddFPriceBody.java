...
public class WorkbookFunctionsOddFPriceBody {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsOddFPriceBody
     */
    public WorkbookFunctionsOddFPriceBody() {}
    private WorkbookFunctionsOddFPriceBody(@Nonnull final WorkbookFunctionsOddFPriceBodyBuilder builder) {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsOddFPriceBodyBuilder newBuilder() {
        return new WorkbookFunctionsOddFPriceBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsOddFPriceBody
     */
    public static final class WorkbookFunctionsOddFPriceBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withIssue(@Nullable final com.google.gson.JsonElement val) {
            this.issue = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withFirstCoupon(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withYld(@Nullable final com.google.gson.JsonElement val) {
            this.yld = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsOddFPriceBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsOddFPriceBody build() {
            return new WorkbookFunctionsOddFPriceBody(this);
        }
    }
    /**
