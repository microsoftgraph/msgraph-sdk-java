...
/**
 * The class for the Workbook Functions Im Sec Parameter Set.
 */
public class WorkbookFunctionsImSecParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsImSecParameterSet
     */
    public WorkbookFunctionsImSecParameterSet() {}
    private WorkbookFunctionsImSecParameterSet(@Nonnull final WorkbookFunctionsImSecParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsImSecParameterSet
     */
    public static final class WorkbookFunctionsImSecParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImSecParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
        private WorkbookFunctionsImSecParameterSetBuilder(){}
        /**
