...
public class ReportRootGetOneDriveUsageFileCountsParameterSet {
     ...
     */
    public static final class ReportRootGetOneDriveUsageFileCountsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetOneDriveUsageFileCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
