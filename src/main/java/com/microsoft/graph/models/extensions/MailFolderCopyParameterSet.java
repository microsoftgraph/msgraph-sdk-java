...
public class MailFolderCopyParameterSet {
     ...
     */
    public static final class MailFolderCopyParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public MailFolderCopyParameterSetBuilder withDestinationId(@Nullable final String val) {
