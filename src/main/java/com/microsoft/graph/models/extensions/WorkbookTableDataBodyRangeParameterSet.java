...
/**
 * The class for the Workbook Table Data Body Range Parameter Set.
 */
public class WorkbookTableDataBodyRangeParameterSet {
     ...
     */
    @Nonnull
    public static WorkbookTableDataBodyRangeParameterSetBuilder newBuilder() {
        return new WorkbookTableDataBodyRangeParameterSetBuilder();
    }
    /**
     * Fluent builder for the WorkbookTableDataBodyRangeParameterSet
     */
    public static final class WorkbookTableDataBodyRangeParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookTableDataBodyRangeParameterSet build() {
            return new WorkbookTableDataBodyRangeParameterSet(this);
        }
    }
    /**
