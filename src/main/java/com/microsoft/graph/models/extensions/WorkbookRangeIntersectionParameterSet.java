...
public class WorkbookRangeIntersectionParameterSet {
    ...
    private WorkbookRangeIntersectionParameterSet(@Nonnull final WorkbookRangeIntersectionParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookRangeIntersectionParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private WorkbookRangeIntersectionParameterSetBuilder(){}
        /**
