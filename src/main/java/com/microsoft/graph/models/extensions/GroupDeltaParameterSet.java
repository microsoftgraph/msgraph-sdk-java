...
/**
 * The class for the Group Delta Parameter Set.
 */
public class GroupDeltaParameterSet {
     ...
     */
    public static final class GroupDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public GroupDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public GroupDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
