...
public class WorkbookFunctionsDbBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDbBodyBuilder newBuilder() {
        return new WorkbookFunctionsDbBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDbBody
     */
    public static final class WorkbookFunctionsDbBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDbBodyBuilder withCost(@Nullable final com.google.gson.JsonElement val) {
            this.cost = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDbBodyBuilder withSalvage(@Nullable final com.google.gson.JsonElement val) {
            this.salvage = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDbBodyBuilder withLife(@Nullable final com.google.gson.JsonElement val) {
            this.life = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDbBodyBuilder withPeriod(@Nullable final com.google.gson.JsonElement val) {
            this.period = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDbBodyBuilder withMonth(@Nullable final com.google.gson.JsonElement val) {
            this.month = val;
            return this;
        }
        private WorkbookFunctionsDbBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDbBody build() {
            return new WorkbookFunctionsDbBody(this);
        }
    }
    /**
