...
public class WorkbookFunctionsNotBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsNotBodyBuilder newBuilder() {
        return new WorkbookFunctionsNotBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsNotBody
     */
    public static final class WorkbookFunctionsNotBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsNotBodyBuilder withLogical(@Nullable final com.google.gson.JsonElement val) {
            this.logical = val;
            return this;
        }
        private WorkbookFunctionsNotBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsNotBody build() {
            return new WorkbookFunctionsNotBody(this);
        }
    }
    /**
