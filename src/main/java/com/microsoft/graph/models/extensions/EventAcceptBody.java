...
public class EventAcceptBody {
     ...
     */
    @Nonnull
    public static EventAcceptBodyBuilder newBuilder() {
        return new EventAcceptBodyBuilder();
    }
    /**
     * Fluent builder for the EventAcceptBody
     */
    public static final class EventAcceptBodyBuilder {
         ...
         */
        @Nonnull
        public EventAcceptBodyBuilder withComment(@Nullable final String val) {
            this.comment = val;
            return this;
        }
         ...
         */
        @Nonnull
        public EventAcceptBodyBuilder withSendResponse(@Nullable final Boolean val) {
            this.sendResponse = val;
            return this;
        }
        private EventAcceptBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public EventAcceptBody build() {
            return new EventAcceptBody(this);
        }
    }
    /**
