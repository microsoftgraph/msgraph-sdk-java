...
public class WorkbookRangeCellParameterSet {
    ...
    private WorkbookRangeCellParameterSet(@Nonnull final WorkbookRangeCellParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookRangeCellParameterSetBuilder extends BaseMethodParameterSetBuilder {
        private Integer row;
        /**
         * Sets the Row
        ...
        private WorkbookRangeCellParameterSetBuilder(){}
        /**
