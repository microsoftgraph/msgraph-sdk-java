...
public class WorkbookFunctionsPdurationBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsPdurationBodyBuilder newBuilder() {
        return new WorkbookFunctionsPdurationBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsPdurationBody
     */
    public static final class WorkbookFunctionsPdurationBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPdurationBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPdurationBodyBuilder withPv(@Nullable final com.google.gson.JsonElement val) {
            this.pv = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPdurationBodyBuilder withFv(@Nullable final com.google.gson.JsonElement val) {
            this.fv = val;
            return this;
        }
        private WorkbookFunctionsPdurationBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsPdurationBody build() {
            return new WorkbookFunctionsPdurationBody(this);
        }
    }
    /**
