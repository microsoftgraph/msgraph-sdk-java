...
public class WorkbookFunctionsFindBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsFindBodyBuilder newBuilder() {
        return new WorkbookFunctionsFindBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsFindBody
     */
    public static final class WorkbookFunctionsFindBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsFindBodyBuilder withFindText(@Nullable final com.google.gson.JsonElement val) {
            this.findText = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFindBodyBuilder withWithinText(@Nullable final com.google.gson.JsonElement val) {
            this.withinText = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFindBodyBuilder withStartNum(@Nullable final com.google.gson.JsonElement val) {
            this.startNum = val;
            return this;
        }
        private WorkbookFunctionsFindBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsFindBody build() {
            return new WorkbookFunctionsFindBody(this);
        }
    }
    /**
