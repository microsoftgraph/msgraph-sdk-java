...
public class ApplicationDeltaParameterSet {
     ...
     */
    public static final class ApplicationDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ApplicationDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public ApplicationDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
