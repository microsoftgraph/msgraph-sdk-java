...
/**
 * The class for the Report Root Get Skype For Business Activity User Counts Parameter Set.
 */
public class ReportRootGetSkypeForBusinessActivityUserCountsParameterSet {
     ...
     */
    public static final class ReportRootGetSkypeForBusinessActivityUserCountsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetSkypeForBusinessActivityUserCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
