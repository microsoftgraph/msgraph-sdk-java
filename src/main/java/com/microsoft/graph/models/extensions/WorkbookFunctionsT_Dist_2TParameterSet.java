...
public class WorkbookFunctionsT_Dist_2TParameterSet {
    ...
    private WorkbookFunctionsT_Dist_2TParameterSet(@Nonnull final WorkbookFunctionsT_Dist_2TParameterSetBuilder builder) {
        this.x = builder.x;
     ...
     */
    public static final class WorkbookFunctionsT_Dist_2TParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsT_Dist_2TParameterSetBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsT_Dist_2TParameterSetBuilder withDegFreedom(@Nullable final com.google.gson.JsonElement val) {
            this.degFreedom = val;
            return this;
        }
        private WorkbookFunctionsT_Dist_2TParameterSetBuilder(){}
        /**
