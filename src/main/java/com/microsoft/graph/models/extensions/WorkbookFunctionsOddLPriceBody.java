...
public class WorkbookFunctionsOddLPriceBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsOddLPriceBodyBuilder newBuilder() {
        return new WorkbookFunctionsOddLPriceBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsOddLPriceBody
     */
    public static final class WorkbookFunctionsOddLPriceBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
        private com.google.gson.JsonElement lastInterest;
        /**
         * Sets the name LastInterest
         * @param val the value to set it to
         * @return the current builder object
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withLastInterest(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withYld(@Nullable final com.google.gson.JsonElement val) {
            this.yld = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsOddLPriceBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsOddLPriceBody build() {
            return new WorkbookFunctionsOddLPriceBody(this);
        }
    }
    /**
