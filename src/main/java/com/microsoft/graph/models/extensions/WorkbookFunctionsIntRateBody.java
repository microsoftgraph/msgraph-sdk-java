...
/**
 * The class for the Workbook Functions Int Rate Body.
 */
public class WorkbookFunctionsIntRateBody {
    /**
     * The settlement.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsIntRateBodyBuilder newBuilder() {
        return new WorkbookFunctionsIntRateBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsIntRateBody
     */
    public static final class WorkbookFunctionsIntRateBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsIntRateBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsIntRateBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
        private com.google.gson.JsonElement investment;
        /**
         * Sets the name Investment
         * @param val the value to set it to
         * @return the current builder object
         */
        @Nonnull
        public WorkbookFunctionsIntRateBodyBuilder withInvestment(@Nullable final com.google.gson.JsonElement val) {
            this.investment = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsIntRateBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsIntRateBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsIntRateBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsIntRateBody build() {
            return new WorkbookFunctionsIntRateBody(this);
        }
    }
    /**
