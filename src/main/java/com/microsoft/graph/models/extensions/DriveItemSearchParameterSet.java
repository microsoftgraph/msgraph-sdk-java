...
public class DriveItemSearchParameterSet {
    ...
    private DriveItemSearchParameterSet(@Nonnull final DriveItemSearchParameterSetBuilder builder) {
        this.q = builder.q;
    }
    /**
     ...
     */
    public static final class DriveItemSearchParameterSetBuilder extends BaseMethodParameterSetBuilder {
        private String q;
        /**
         * Sets the Q
        ...
        private DriveItemSearchParameterSetBuilder(){}
        /**
