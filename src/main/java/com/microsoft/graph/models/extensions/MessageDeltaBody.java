...
/**
 * The class for the Message Delta Body.
 */
public class MessageDeltaBody {
     ...
     */
    @Nonnull
    public static MessageDeltaBodyBuilder newBuilder() {
        return new MessageDeltaBodyBuilder();
    }
    /**
    ...
    public static final class MessageDeltaBodyBuilder {
         ...
         */
        @Nonnull
        public MessageDeltaBody build() {
            return new MessageDeltaBody(this);
        }
    }
    /**
