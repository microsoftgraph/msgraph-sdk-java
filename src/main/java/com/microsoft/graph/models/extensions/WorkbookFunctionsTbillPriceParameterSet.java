...
public class WorkbookFunctionsTbillPriceParameterSet {
    ...
    private WorkbookFunctionsTbillPriceParameterSet(@Nonnull final WorkbookFunctionsTbillPriceParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookFunctionsTbillPriceParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsTbillPriceParameterSetBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsTbillPriceParameterSetBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsTbillPriceParameterSetBuilder withDiscount(@Nullable final com.google.gson.JsonElement val) {
            this.discount = val;
            return this;
        }
        private WorkbookFunctionsTbillPriceParameterSetBuilder(){}
        /**
