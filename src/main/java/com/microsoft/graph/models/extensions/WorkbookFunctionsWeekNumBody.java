...
public class WorkbookFunctionsWeekNumBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsWeekNumBodyBuilder newBuilder() {
        return new WorkbookFunctionsWeekNumBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsWeekNumBody
     */
    public static final class WorkbookFunctionsWeekNumBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsWeekNumBodyBuilder withSerialNumber(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsWeekNumBodyBuilder withReturnType(@Nullable final com.google.gson.JsonElement val) {
            this.returnType = val;
            return this;
        }
        private WorkbookFunctionsWeekNumBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsWeekNumBody build() {
            return new WorkbookFunctionsWeekNumBody(this);
        }
    }
    /**
