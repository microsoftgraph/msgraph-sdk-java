...
/**
 * The class for the Application Remove Password Parameter Set.
 */
public class ApplicationRemovePasswordParameterSet {
     ...
     */
    public static final class ApplicationRemovePasswordParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ApplicationRemovePasswordParameterSetBuilder withKeyId(@Nullable final java.util.UUID val) {
            this.keyId = val;
            return this;
        }
