...
public class EventCancelBody {
     ...
     */
    @Nonnull
    public static EventCancelBodyBuilder newBuilder() {
        return new EventCancelBodyBuilder();
    }
    /**
     * Fluent builder for the EventCancelBody
     */
    public static final class EventCancelBodyBuilder {
         ...
         */
        @Nonnull
        public EventCancelBodyBuilder withComment(@Nullable final String val) {
            this.comment = val;
            return this;
        }
        private EventCancelBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public EventCancelBody build() {
            return new EventCancelBody(this);
        }
    }
    /**
