...
/**
 * The class for the Report Root Get Share Point Site Usage Site Counts Parameter Set.
 */
public class ReportRootGetSharePointSiteUsageSiteCountsParameterSet {
     ...
     */
    public static final class ReportRootGetSharePointSiteUsageSiteCountsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetSharePointSiteUsageSiteCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
