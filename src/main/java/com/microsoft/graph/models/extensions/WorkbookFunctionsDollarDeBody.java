 ...
 */
public class WorkbookFunctionsDollarDeBody {
    /**
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDollarDeBodyBuilder newBuilder() {
        return new WorkbookFunctionsDollarDeBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDollarDeBody
     */
    public static final class WorkbookFunctionsDollarDeBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDollarDeBodyBuilder withFractionalDollar(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDollarDeBodyBuilder withFraction(@Nullable final com.google.gson.JsonElement val) {
            this.fraction = val;
            return this;
        }
        private WorkbookFunctionsDollarDeBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDollarDeBody build() {
            return new WorkbookFunctionsDollarDeBody(this);
        }
    }
    /**
