 ...
 */
public class WorkbookChartAddBody {
    /**
     * The type.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookChartAddBodyBuilder newBuilder() {
        return new WorkbookChartAddBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookChartAddBody
     */
    public static final class WorkbookChartAddBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookChartAddBodyBuilder withType(@Nullable final String val) {
            this.type = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookChartAddBodyBuilder withSourceData(@Nullable final com.google.gson.JsonElement val) {
            this.sourceData = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookChartAddBodyBuilder withSeriesBy(@Nullable final String val) {
            this.seriesBy = val;
            return this;
        }
        private WorkbookChartAddBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookChartAddBody build() {
            return new WorkbookChartAddBody(this);
        }
    }
    /**
