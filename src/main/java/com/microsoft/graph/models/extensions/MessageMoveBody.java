...
public class MessageMoveBody {
     ...
     */
    @Nonnull
    public static MessageMoveBodyBuilder newBuilder() {
        return new MessageMoveBodyBuilder();
    }
    /**
     * Fluent builder for the MessageMoveBody
     */
    public static final class MessageMoveBodyBuilder {
         ...
         */
        @Nonnull
        public MessageMoveBodyBuilder withDestinationId(@Nullable final String val) {
            this.destinationId = val;
            return this;
        }
        private MessageMoveBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public MessageMoveBody build() {
            return new MessageMoveBody(this);
        }
    }
    /**
