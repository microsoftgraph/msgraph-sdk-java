...
public class WorkbookFunctionsTParameterSet {
    ...
    private WorkbookFunctionsTParameterSet(@Nonnull final WorkbookFunctionsTParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookFunctionsTParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private WorkbookFunctionsTParameterSetBuilder(){}
        /**
