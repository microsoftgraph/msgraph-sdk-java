...
public class WorkbookFunctionsGammaLnParameterSet {
    ...
    private WorkbookFunctionsGammaLnParameterSet(@Nonnull final WorkbookFunctionsGammaLnParameterSetBuilder builder) {
        this.x = builder.x;
    }
    /**
     ...
     */
    public static final class WorkbookFunctionsGammaLnParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private WorkbookFunctionsGammaLnParameterSetBuilder(){}
        /**
