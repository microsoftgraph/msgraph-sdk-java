...
/**
 * The class for the Workbook Functions Daverage Parameter Set.
 */
public class WorkbookFunctionsDaverageParameterSet {
     ...
     */
    public static final class WorkbookFunctionsDaverageParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaverageParameterSetBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaverageParameterSetBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaverageParameterSetBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
