...
public class WorkbookFunctionsChiSq_DistBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsChiSq_DistBodyBuilder newBuilder() {
        return new WorkbookFunctionsChiSq_DistBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsChiSq_DistBody
     */
    public static final class WorkbookFunctionsChiSq_DistBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsChiSq_DistBodyBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsChiSq_DistBodyBuilder withDegFreedom(@Nullable final com.google.gson.JsonElement val) {
            this.degFreedom = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsChiSq_DistBodyBuilder withCumulative(@Nullable final com.google.gson.JsonElement val) {
            this.cumulative = val;
            return this;
        }
        private WorkbookFunctionsChiSq_DistBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsChiSq_DistBody build() {
            return new WorkbookFunctionsChiSq_DistBody(this);
        }
    }
    /**
