...
public class DeviceConfigurationAssignBody {
     ...
     */
    @Nonnull
    public static DeviceConfigurationAssignBodyBuilder newBuilder() {
        return new DeviceConfigurationAssignBodyBuilder();
    }
    /**
     * Fluent builder for the DeviceConfigurationAssignBody
     */
    public static final class DeviceConfigurationAssignBodyBuilder {
         ...
         */
        @Nonnull
        public DeviceConfigurationAssignBodyBuilder withAssignments(@Nullable final java.util.List<DeviceConfigurationAssignment> val) {
            this.assignments = val;
            return this;
        }
        private DeviceConfigurationAssignBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DeviceConfigurationAssignBody build() {
            return new DeviceConfigurationAssignBody(this);
        }
    }
    /**
