...
public class WorkbookFunctionsDdbBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDdbBodyBuilder newBuilder() {
        return new WorkbookFunctionsDdbBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDdbBody
     */
    public static final class WorkbookFunctionsDdbBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDdbBodyBuilder withCost(@Nullable final com.google.gson.JsonElement val) {
            this.cost = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDdbBodyBuilder withSalvage(@Nullable final com.google.gson.JsonElement val) {
            this.salvage = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDdbBodyBuilder withLife(@Nullable final com.google.gson.JsonElement val) {
            this.life = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDdbBodyBuilder withPeriod(@Nullable final com.google.gson.JsonElement val) {
            this.period = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDdbBodyBuilder withFactor(@Nullable final com.google.gson.JsonElement val) {
            this.factor = val;
            return this;
        }
        private WorkbookFunctionsDdbBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDdbBody build() {
            return new WorkbookFunctionsDdbBody(this);
        }
    }
    /**
