...
/**
 * The class for the Application Add Password Body.
 */
public class ApplicationAddPasswordBody {
    /**
     ...
     */
    @Nonnull
    public static ApplicationAddPasswordBodyBuilder newBuilder() {
        return new ApplicationAddPasswordBodyBuilder();
    }
    /**
     * Fluent builder for the ApplicationAddPasswordBody
     */
    public static final class ApplicationAddPasswordBodyBuilder {
         ...
         */
        @Nonnull
        public ApplicationAddPasswordBodyBuilder withPasswordCredential(@Nullable final PasswordCredential val) {
            this.passwordCredential = val;
            return this;
        }
        private ApplicationAddPasswordBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public ApplicationAddPasswordBody build() {
            return new ApplicationAddPasswordBody(this);
        }
    }
    /**
