...
/**
 * The class for the Report Root Get Yammer Activity User Counts Parameter Set.
 */
public class ReportRootGetYammerActivityUserCountsParameterSet {
    ...
    private ReportRootGetYammerActivityUserCountsParameterSet(@Nonnull final ReportRootGetYammerActivityUserCountsParameterSetBuilder builder) {
     ...
     */
    public static final class ReportRootGetYammerActivityUserCountsParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetYammerActivityUserCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        private ReportRootGetYammerActivityUserCountsParameterSetBuilder(){}
        /**
