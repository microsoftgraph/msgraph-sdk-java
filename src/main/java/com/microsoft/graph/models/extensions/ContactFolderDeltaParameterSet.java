...
public class ContactFolderDeltaParameterSet {
     ...
     */
    public static final class ContactFolderDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public ContactFolderDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public ContactFolderDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
