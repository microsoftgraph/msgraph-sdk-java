...
/**
 * The class for the Targeted Managed App Protection Assign Parameter Set.
 */
public class TargetedManagedAppProtectionAssignParameterSet {
    /**
     * The assignments.
     * 
     */
     ...
     */
    @Nonnull
    public static TargetedManagedAppProtectionAssignParameterSetBuilder newBuilder() {
        return new TargetedManagedAppProtectionAssignParameterSetBuilder();
    }
    /**
     * Fluent builder for the TargetedManagedAppProtectionAssignParameterSet
     */
    public static final class TargetedManagedAppProtectionAssignParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public TargetedManagedAppProtectionAssignParameterSetBuilder withAssignments(@Nullable final java.util.List<TargetedManagedAppPolicyAssignment> val) {
         ...
         */
        @Nonnull
        public TargetedManagedAppProtectionAssignParameterSet build() {
            return new TargetedManagedAppProtectionAssignParameterSet(this);
        }
    }
    /**
