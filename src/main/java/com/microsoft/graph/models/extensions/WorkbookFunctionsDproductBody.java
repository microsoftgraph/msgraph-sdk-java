 ...
 */
public class WorkbookFunctionsDproductBody {
    /**
     * The database.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDproductBodyBuilder newBuilder() {
        return new WorkbookFunctionsDproductBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDproductBody
     */
    public static final class WorkbookFunctionsDproductBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDproductBodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDproductBodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDproductBodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDproductBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDproductBody build() {
            return new WorkbookFunctionsDproductBody(this);
        }
    }
    /**
