...
public class WorkbookFunctionsPpmtBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsPpmtBodyBuilder newBuilder() {
        return new WorkbookFunctionsPpmtBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsPpmtBody
     */
    public static final class WorkbookFunctionsPpmtBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPpmtBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPpmtBodyBuilder withPer(@Nullable final com.google.gson.JsonElement val) {
            this.per = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPpmtBodyBuilder withNper(@Nullable final com.google.gson.JsonElement val) {
            this.nper = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPpmtBodyBuilder withPv(@Nullable final com.google.gson.JsonElement val) {
            this.pv = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPpmtBodyBuilder withFv(@Nullable final com.google.gson.JsonElement val) {
            this.fv = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPpmtBodyBuilder withType(@Nullable final com.google.gson.JsonElement val) {
            this.type = val;
            return this;
        }
        private WorkbookFunctionsPpmtBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsPpmtBody build() {
            return new WorkbookFunctionsPpmtBody(this);
        }
    }
    /**
