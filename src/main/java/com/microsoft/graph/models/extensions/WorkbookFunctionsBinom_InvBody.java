...
public class WorkbookFunctionsBinom_InvBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsBinom_InvBodyBuilder newBuilder() {
        return new WorkbookFunctionsBinom_InvBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsBinom_InvBody
     */
    public static final class WorkbookFunctionsBinom_InvBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsBinom_InvBodyBuilder withTrials(@Nullable final com.google.gson.JsonElement val) {
            this.trials = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsBinom_InvBodyBuilder withProbabilityS(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsBinom_InvBodyBuilder withAlpha(@Nullable final com.google.gson.JsonElement val) {
            this.alpha = val;
            return this;
        }
        private WorkbookFunctionsBinom_InvBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsBinom_InvBody build() {
            return new WorkbookFunctionsBinom_InvBody(this);
        }
    }
    /**
