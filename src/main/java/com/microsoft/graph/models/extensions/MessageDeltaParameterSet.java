...
public class MessageDeltaParameterSet {
     ...
     */
    public static final class MessageDeltaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public MessageDeltaParameterSetBuilder withDeltaToken(@Nullable final String val) {
            this.deltaToken = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public MessageDeltaParameterSetBuilder withDeltaLink(@Nullable final String val) {
