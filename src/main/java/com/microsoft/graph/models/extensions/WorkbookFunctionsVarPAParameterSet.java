...
/**
 * The class for the Workbook Functions Var PAParameter Set.
 */
public class WorkbookFunctionsVarPAParameterSet {
     ...
     */
    public static final class WorkbookFunctionsVarPAParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsVarPAParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
