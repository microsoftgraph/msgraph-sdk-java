...
public class WorkbookFunctionsDiscBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDiscBodyBuilder newBuilder() {
        return new WorkbookFunctionsDiscBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDiscBody
     */
    public static final class WorkbookFunctionsDiscBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDiscBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDiscBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDiscBodyBuilder withPr(@Nullable final com.google.gson.JsonElement val) {
            this.pr = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDiscBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDiscBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsDiscBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDiscBody build() {
            return new WorkbookFunctionsDiscBody(this);
        }
    }
    /**
