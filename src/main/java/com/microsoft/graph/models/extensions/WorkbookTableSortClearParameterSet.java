...
/**
 * The class for the Workbook Table Sort Clear Parameter Set.
 */
public class WorkbookTableSortClearParameterSet {
     ...
     */
    public static final class WorkbookTableSortClearParameterSetBuilder extends BaseMethodParameterSetBuilder {
