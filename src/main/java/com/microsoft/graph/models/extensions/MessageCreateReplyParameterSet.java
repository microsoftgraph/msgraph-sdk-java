...
/**
 * The class for the Message Create Reply Parameter Set.
 */
public class MessageCreateReplyParameterSet {
    ...
    /**
     * Instiaciates a new MessageCreateReplyParameterSet
     */
    public MessageCreateReplyParameterSet() {}
    private MessageCreateReplyParameterSet(@Nonnull final MessageCreateReplyParameterSetBuilder builder) {
     ...
     */
    public static final class MessageCreateReplyParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public MessageCreateReplyParameterSetBuilder withMessage(@Nullable final Message val) {
            this.message = val;
            return this;
        }
         ...
         */
        @Nonnull
        public MessageCreateReplyParameterSetBuilder withComment(@Nullable final String val) {
            this.comment = val;
            return this;
        }
        private MessageCreateReplyParameterSetBuilder(){}
        /**
