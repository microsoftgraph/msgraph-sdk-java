...
public class ServicePrincipalRemoveKeyBody {
     ...
     */
    @Nonnull
    public static ServicePrincipalRemoveKeyBodyBuilder newBuilder() {
        return new ServicePrincipalRemoveKeyBodyBuilder();
    }
    /**
     * Fluent builder for the ServicePrincipalRemoveKeyBody
     */
    public static final class ServicePrincipalRemoveKeyBodyBuilder {
         ...
         */
        @Nonnull
        public ServicePrincipalRemoveKeyBodyBuilder withKeyId(@Nullable final java.util.UUID val) {
            this.keyId = val;
            return this;
        }
         ...
         */
        @Nonnull
        public ServicePrincipalRemoveKeyBodyBuilder withProof(@Nullable final String val) {
            this.proof = val;
            return this;
        }
        private ServicePrincipalRemoveKeyBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public ServicePrincipalRemoveKeyBody build() {
            return new ServicePrincipalRemoveKeyBody(this);
        }
    }
    /**
