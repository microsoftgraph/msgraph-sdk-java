...
/**
 * The class for the Workbook Range Bounding Rect Body.
 */
public class WorkbookRangeBoundingRectBody {
    /**
     * The another Range.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookRangeBoundingRectBodyBuilder newBuilder() {
        return new WorkbookRangeBoundingRectBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookRangeBoundingRectBody
     */
    public static final class WorkbookRangeBoundingRectBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookRangeBoundingRectBodyBuilder withAnotherRange(@Nullable final String val) {
            this.anotherRange = val;
            return this;
        }
        private WorkbookRangeBoundingRectBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookRangeBoundingRectBody build() {
            return new WorkbookRangeBoundingRectBody(this);
        }
    }
    /**
