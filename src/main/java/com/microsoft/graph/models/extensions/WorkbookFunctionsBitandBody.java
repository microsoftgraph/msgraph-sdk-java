 ...
 */
public class WorkbookFunctionsBitandBody {
    /**
     * The number1.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsBitandBodyBuilder newBuilder() {
        return new WorkbookFunctionsBitandBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsBitandBody
     */
    public static final class WorkbookFunctionsBitandBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsBitandBodyBuilder withNumber1(@Nullable final com.google.gson.JsonElement val) {
            this.number1 = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsBitandBodyBuilder withNumber2(@Nullable final com.google.gson.JsonElement val) {
            this.number2 = val;
            return this;
        }
        private WorkbookFunctionsBitandBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsBitandBody build() {
            return new WorkbookFunctionsBitandBody(this);
        }
    }
    /**
