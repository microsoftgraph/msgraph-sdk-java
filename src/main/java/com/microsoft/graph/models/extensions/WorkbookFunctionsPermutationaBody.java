...
public class WorkbookFunctionsPermutationaBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsPermutationaBodyBuilder newBuilder() {
        return new WorkbookFunctionsPermutationaBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsPermutationaBody
     */
    public static final class WorkbookFunctionsPermutationaBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPermutationaBodyBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPermutationaBodyBuilder withNumberChosen(@Nullable final com.google.gson.JsonElement val) {
            this.numberChosen = val;
            return this;
        }
        private WorkbookFunctionsPermutationaBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsPermutationaBody build() {
            return new WorkbookFunctionsPermutationaBody(this);
        }
    }
    /**
