...
public class WorkbookFunctionsDec2BinParameterSet {
    ...
    private WorkbookFunctionsDec2BinParameterSet(@Nonnull final WorkbookFunctionsDec2BinParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookFunctionsDec2BinParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDec2BinParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDec2BinParameterSetBuilder withPlaces(@Nullable final com.google.gson.JsonElement val) {
            this.places = val;
            return this;
        }
        private WorkbookFunctionsDec2BinParameterSetBuilder(){}
        /**
