...
public class WorkbookFunctionsDcountABody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDcountABodyBuilder newBuilder() {
        return new WorkbookFunctionsDcountABodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDcountABody
     */
    public static final class WorkbookFunctionsDcountABodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDcountABodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDcountABodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDcountABodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDcountABodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDcountABody build() {
            return new WorkbookFunctionsDcountABody(this);
        }
    }
    /**
