 ...
 */
public class ReportRootGetMailboxUsageStorageParameterSet {
    /**
     * The period.
     * 
     */
     ...
     */
    @Nonnull
    public static ReportRootGetMailboxUsageStorageParameterSetBuilder newBuilder() {
        return new ReportRootGetMailboxUsageStorageParameterSetBuilder();
    }
    /**
    ...
    public static final class ReportRootGetMailboxUsageStorageParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetMailboxUsageStorageParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public ReportRootGetMailboxUsageStorageParameterSet build() {
            return new ReportRootGetMailboxUsageStorageParameterSet(this);
        }
    }
    /**
