...
/**
 * The class for the Workbook Table Total Row Range Parameter Set.
 */
public class WorkbookTableTotalRowRangeParameterSet {
    ...
    private WorkbookTableTotalRowRangeParameterSet(@Nonnull final WorkbookTableTotalRowRangeParameterSetBuilder builder) {
    }
    /**
     ...
     */
    public static final class WorkbookTableTotalRowRangeParameterSetBuilder extends BaseMethodParameterSetBuilder {
        private WorkbookTableTotalRowRangeParameterSetBuilder(){}
        /**
