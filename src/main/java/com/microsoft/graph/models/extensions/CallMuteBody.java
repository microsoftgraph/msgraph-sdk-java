...
public class CallMuteBody {
     ...
     */
    @Nonnull
    public static CallMuteBodyBuilder newBuilder() {
        return new CallMuteBodyBuilder();
    }
    /**
     * Fluent builder for the CallMuteBody
     */
    public static final class CallMuteBodyBuilder {
         ...
         */
        @Nonnull
        public CallMuteBodyBuilder withClientContext(@Nullable final String val) {
            this.clientContext = val;
            return this;
        }
        private CallMuteBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public CallMuteBody build() {
            return new CallMuteBody(this);
        }
    }
    /**
