...
public class WorkbookFunctionsMdurationBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsMdurationBodyBuilder newBuilder() {
        return new WorkbookFunctionsMdurationBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsMdurationBody
     */
    public static final class WorkbookFunctionsMdurationBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsMdurationBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsMdurationBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsMdurationBodyBuilder withCoupon(@Nullable final com.google.gson.JsonElement val) {
            this.coupon = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsMdurationBodyBuilder withYld(@Nullable final com.google.gson.JsonElement val) {
            this.yld = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsMdurationBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsMdurationBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsMdurationBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsMdurationBody build() {
            return new WorkbookFunctionsMdurationBody(this);
        }
    }
    /**
