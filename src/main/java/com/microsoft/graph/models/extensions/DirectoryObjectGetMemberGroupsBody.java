 ...
 */
public class DirectoryObjectGetMemberGroupsBody {
    /**
     ...
     */
    @Nonnull
    public static DirectoryObjectGetMemberGroupsBodyBuilder newBuilder() {
        return new DirectoryObjectGetMemberGroupsBodyBuilder();
    }
    /**
     * Fluent builder for the DirectoryObjectGetMemberGroupsBody
     */
    public static final class DirectoryObjectGetMemberGroupsBodyBuilder {
         ...
         */
        @Nonnull
        public DirectoryObjectGetMemberGroupsBodyBuilder withSecurityEnabledOnly(@Nullable final Boolean val) {
            this.securityEnabledOnly = val;
            return this;
        }
        private DirectoryObjectGetMemberGroupsBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DirectoryObjectGetMemberGroupsBody build() {
            return new DirectoryObjectGetMemberGroupsBody(this);
        }
    }
    /**
