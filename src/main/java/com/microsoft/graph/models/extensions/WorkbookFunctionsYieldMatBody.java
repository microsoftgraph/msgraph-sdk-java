...
public class WorkbookFunctionsYieldMatBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsYieldMatBodyBuilder newBuilder() {
        return new WorkbookFunctionsYieldMatBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsYieldMatBody
     */
    public static final class WorkbookFunctionsYieldMatBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBodyBuilder withIssue(@Nullable final com.google.gson.JsonElement val) {
            this.issue = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBodyBuilder withPr(@Nullable final com.google.gson.JsonElement val) {
            this.pr = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsYieldMatBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsYieldMatBody build() {
            return new WorkbookFunctionsYieldMatBody(this);
        }
    }
    /**
