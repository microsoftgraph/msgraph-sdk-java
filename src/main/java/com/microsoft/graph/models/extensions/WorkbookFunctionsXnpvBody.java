...
public class WorkbookFunctionsXnpvBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsXnpvBodyBuilder newBuilder() {
        return new WorkbookFunctionsXnpvBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsXnpvBody
     */
    public static final class WorkbookFunctionsXnpvBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsXnpvBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsXnpvBodyBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsXnpvBodyBuilder withDates(@Nullable final com.google.gson.JsonElement val) {
            this.dates = val;
            return this;
        }
        private WorkbookFunctionsXnpvBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsXnpvBody build() {
            return new WorkbookFunctionsXnpvBody(this);
        }
    }
    /**
