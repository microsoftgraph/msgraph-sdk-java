...
public class WorkbookWorksheetCellParameterSet {
    ...
    private WorkbookWorksheetCellParameterSet(@Nonnull final WorkbookWorksheetCellParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookWorksheetCellParameterSetBuilder extends BaseMethodParameterSetBuilder {
        private Integer row;
        /**
         * Sets the Row
        ...
        private WorkbookWorksheetCellParameterSetBuilder(){}
        /**
