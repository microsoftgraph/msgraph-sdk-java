...
public class WorkbookFunctionsDaysBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDaysBodyBuilder newBuilder() {
        return new WorkbookFunctionsDaysBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDaysBody
     */
    public static final class WorkbookFunctionsDaysBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaysBodyBuilder withEndDate(@Nullable final com.google.gson.JsonElement val) {
            this.endDate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDaysBodyBuilder withStartDate(@Nullable final com.google.gson.JsonElement val) {
            this.startDate = val;
            return this;
        }
        private WorkbookFunctionsDaysBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDaysBody build() {
            return new WorkbookFunctionsDaysBody(this);
        }
    }
    /**
