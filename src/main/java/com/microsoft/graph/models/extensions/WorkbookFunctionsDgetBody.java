...
public class WorkbookFunctionsDgetBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDgetBodyBuilder newBuilder() {
        return new WorkbookFunctionsDgetBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDgetBody
     */
    public static final class WorkbookFunctionsDgetBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDgetBodyBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDgetBodyBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDgetBodyBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        private WorkbookFunctionsDgetBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsDgetBody build() {
            return new WorkbookFunctionsDgetBody(this);
        }
    }
    /**
