 ...
 */
public class DeviceCompliancePolicyScheduleActionsForRulesBody {
    /**
     ...
     */
    @Nonnull
    public static DeviceCompliancePolicyScheduleActionsForRulesBodyBuilder newBuilder() {
        return new DeviceCompliancePolicyScheduleActionsForRulesBodyBuilder();
    }
    /**
     * Fluent builder for the DeviceCompliancePolicyScheduleActionsForRulesBody
     */
    public static final class DeviceCompliancePolicyScheduleActionsForRulesBodyBuilder {
         ...
         */
        @Nonnull
        public DeviceCompliancePolicyScheduleActionsForRulesBodyBuilder withDeviceComplianceScheduledActionForRules(@Nullable final java.util.List<DeviceComplianceScheduledActionForRule> val) {
            this.deviceComplianceScheduledActionForRules = val;
            return this;
        }
        private DeviceCompliancePolicyScheduleActionsForRulesBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DeviceCompliancePolicyScheduleActionsForRulesBody build() {
            return new DeviceCompliancePolicyScheduleActionsForRulesBody(this);
        }
    }
    /**
