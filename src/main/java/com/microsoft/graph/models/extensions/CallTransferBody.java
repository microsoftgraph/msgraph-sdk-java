...
public class CallTransferBody {
     ...
     */
    @Nonnull
    public static CallTransferBodyBuilder newBuilder() {
        return new CallTransferBodyBuilder();
    }
    /**
     * Fluent builder for the CallTransferBody
     */
    public static final class CallTransferBodyBuilder {
         ...
         */
        @Nonnull
        public CallTransferBodyBuilder withTransferTarget(@Nullable final InvitationParticipantInfo val) {
            this.transferTarget = val;
            return this;
        }
        private CallTransferBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public CallTransferBody build() {
            return new CallTransferBody(this);
        }
    }
    /**
