...
/**
 * The class for the Notebook Get Recent Notebooks Body.
 */
public class NotebookGetRecentNotebooksBody {
    /**
     ...
     */
    @Nonnull
    public static NotebookGetRecentNotebooksBodyBuilder newBuilder() {
        return new NotebookGetRecentNotebooksBodyBuilder();
    }
    /**
     * Fluent builder for the NotebookGetRecentNotebooksBody
     */
    public static final class NotebookGetRecentNotebooksBodyBuilder {
         ...
         */
        @Nonnull
        public NotebookGetRecentNotebooksBodyBuilder withIncludePersonalNotebooks(@Nullable final Boolean val) {
            this.includePersonalNotebooks = val;
            return this;
        }
        private NotebookGetRecentNotebooksBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public NotebookGetRecentNotebooksBody build() {
            return new NotebookGetRecentNotebooksBody(this);
        }
    }
    /**
