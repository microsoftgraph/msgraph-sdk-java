...
public class DriveItemCreateLinkBody {
     ...
     */
    @Nonnull
    public static DriveItemCreateLinkBodyBuilder newBuilder() {
        return new DriveItemCreateLinkBodyBuilder();
    }
    /**
     * Fluent builder for the DriveItemCreateLinkBody
     */
    public static final class DriveItemCreateLinkBodyBuilder {
         ...
         */
        @Nonnull
        public DriveItemCreateLinkBodyBuilder withType(@Nullable final String val) {
            this.type = val;
            return this;
        }
         ...
         */
        @Nonnull
        public DriveItemCreateLinkBodyBuilder withScope(@Nullable final String val) {
            this.scope = val;
            return this;
        }
         ...
         */
        @Nonnull
        public DriveItemCreateLinkBodyBuilder withExpirationDateTime(@Nullable final java.util.Calendar val) {
         ...
         */
        @Nonnull
        public DriveItemCreateLinkBodyBuilder withPassword(@Nullable final String val) {
            this.password = val;
            return this;
        }
         ...
         */
        @Nonnull
        public DriveItemCreateLinkBodyBuilder withMessage(@Nullable final String val) {
            this.message = val;
            return this;
        }
        private DriveItemCreateLinkBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DriveItemCreateLinkBody build() {
            return new DriveItemCreateLinkBody(this);
        }
    }
    /**
