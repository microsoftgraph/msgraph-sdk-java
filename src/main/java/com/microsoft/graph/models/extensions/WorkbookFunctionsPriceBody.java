...
public class WorkbookFunctionsPriceBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsPriceBodyBuilder newBuilder() {
        return new WorkbookFunctionsPriceBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsPriceBody
     */
    public static final class WorkbookFunctionsPriceBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withYld(@Nullable final com.google.gson.JsonElement val) {
            this.yld = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPriceBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsPriceBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsPriceBody build() {
            return new WorkbookFunctionsPriceBody(this);
        }
    }
    /**
