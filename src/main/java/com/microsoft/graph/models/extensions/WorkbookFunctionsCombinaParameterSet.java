...
/**
 * The class for the Workbook Functions Combina Parameter Set.
 */
public class WorkbookFunctionsCombinaParameterSet {
     ...
     */
    public static final class WorkbookFunctionsCombinaParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCombinaParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsCombinaParameterSetBuilder withNumberChosen(@Nullable final com.google.gson.JsonElement val) {
