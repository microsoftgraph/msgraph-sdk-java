...
public class DeviceManagementExchangeConnectorSyncBody {
     ...
     */
    @Nonnull
    public static DeviceManagementExchangeConnectorSyncBodyBuilder newBuilder() {
        return new DeviceManagementExchangeConnectorSyncBodyBuilder();
    }
    /**
     * Fluent builder for the DeviceManagementExchangeConnectorSyncBody
     */
    public static final class DeviceManagementExchangeConnectorSyncBodyBuilder {
         ...
         */
        @Nonnull
        public DeviceManagementExchangeConnectorSyncBodyBuilder withSyncType(@Nullable final DeviceManagementExchangeConnectorSyncType val) {
            this.syncType = val;
            return this;
        }
        private DeviceManagementExchangeConnectorSyncBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public DeviceManagementExchangeConnectorSyncBody build() {
            return new DeviceManagementExchangeConnectorSyncBody(this);
        }
    }
    /**
