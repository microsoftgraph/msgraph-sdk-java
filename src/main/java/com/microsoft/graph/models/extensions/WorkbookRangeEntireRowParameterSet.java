...
/**
 * The class for the Workbook Range Entire Row Parameter Set.
 */
public class WorkbookRangeEntireRowParameterSet {
     ...
     */
    public static final class WorkbookRangeEntireRowParameterSetBuilder extends BaseMethodParameterSetBuilder {
