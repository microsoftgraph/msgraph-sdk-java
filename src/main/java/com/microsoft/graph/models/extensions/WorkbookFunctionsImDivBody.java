...
public class WorkbookFunctionsImDivBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsImDivBodyBuilder newBuilder() {
        return new WorkbookFunctionsImDivBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsImDivBody
     */
    public static final class WorkbookFunctionsImDivBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImDivBodyBuilder withInumber1(@Nullable final com.google.gson.JsonElement val) {
            this.inumber1 = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsImDivBodyBuilder withInumber2(@Nullable final com.google.gson.JsonElement val) {
            this.inumber2 = val;
            return this;
        }
        private WorkbookFunctionsImDivBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsImDivBody build() {
            return new WorkbookFunctionsImDivBody(this);
        }
    }
    /**
