...
/**
 * The class for the Workbook Functions Sech Parameter Set.
 */
public class WorkbookFunctionsSechParameterSet {
     ...
     */
    public static final class WorkbookFunctionsSechParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsSechParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
