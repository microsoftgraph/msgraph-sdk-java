...
public class WorkbookFunctionsDurationParameterSet {
     ...
     */
    public static final class WorkbookFunctionsDurationParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDurationParameterSetBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDurationParameterSetBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDurationParameterSetBuilder withCoupon(@Nullable final com.google.gson.JsonElement val) {
            this.coupon = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDurationParameterSetBuilder withYld(@Nullable final com.google.gson.JsonElement val) {
            this.yld = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDurationParameterSetBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsDurationParameterSetBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
