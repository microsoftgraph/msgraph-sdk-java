...
public class WorkbookFunctionsPoisson_DistBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsPoisson_DistBodyBuilder newBuilder() {
        return new WorkbookFunctionsPoisson_DistBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsPoisson_DistBody
     */
    public static final class WorkbookFunctionsPoisson_DistBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPoisson_DistBodyBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPoisson_DistBodyBuilder withMean(@Nullable final com.google.gson.JsonElement val) {
            this.mean = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPoisson_DistBodyBuilder withCumulative(@Nullable final com.google.gson.JsonElement val) {
            this.cumulative = val;
            return this;
        }
        private WorkbookFunctionsPoisson_DistBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsPoisson_DistBody build() {
            return new WorkbookFunctionsPoisson_DistBody(this);
        }
    }
    /**
