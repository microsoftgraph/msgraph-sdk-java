...
public class WorkbookFunctionsBesselYParameterSet {
    ...
    private WorkbookFunctionsBesselYParameterSet(@Nonnull final WorkbookFunctionsBesselYParameterSetBuilder builder) {
        this.x = builder.x;
        this.n = builder.n;
    }
    /**
     ...
     */
    public static final class WorkbookFunctionsBesselYParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private WorkbookFunctionsBesselYParameterSetBuilder(){}
        /**
