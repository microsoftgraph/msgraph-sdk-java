...
/**
 * The class for the Workbook Functions Im Log2Parameter Set.
 */
public class WorkbookFunctionsImLog2ParameterSet {
     ...
     */
    public static final class WorkbookFunctionsImLog2ParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImLog2ParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
