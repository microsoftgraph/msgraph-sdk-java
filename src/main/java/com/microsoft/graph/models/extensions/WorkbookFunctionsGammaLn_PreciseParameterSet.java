...
public class WorkbookFunctionsGammaLn_PreciseParameterSet {
    ...
    private WorkbookFunctionsGammaLn_PreciseParameterSet(@Nonnull final WorkbookFunctionsGammaLn_PreciseParameterSetBuilder builder) {
        this.x = builder.x;
    }
    /**
     ...
     */
    public static final class WorkbookFunctionsGammaLn_PreciseParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private WorkbookFunctionsGammaLn_PreciseParameterSetBuilder(){}
        /**
