...
public class MessageReplyAllParameterSet {
    ...
    private MessageReplyAllParameterSet(@Nonnull final MessageReplyAllParameterSetBuilder builder) {
     ...
     */
    public static final class MessageReplyAllParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private MessageReplyAllParameterSetBuilder(){}
        /**
