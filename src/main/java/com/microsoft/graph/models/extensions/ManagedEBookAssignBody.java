...
public class ManagedEBookAssignBody {
     ...
     */
    @Nonnull
    public static ManagedEBookAssignBodyBuilder newBuilder() {
        return new ManagedEBookAssignBodyBuilder();
    }
    /**
     * Fluent builder for the ManagedEBookAssignBody
     */
    public static final class ManagedEBookAssignBodyBuilder {
         ...
         */
        @Nonnull
        public ManagedEBookAssignBodyBuilder withManagedEBookAssignments(@Nullable final java.util.List<ManagedEBookAssignment> val) {
            this.managedEBookAssignments = val;
            return this;
        }
        private ManagedEBookAssignBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public ManagedEBookAssignBody build() {
            return new ManagedEBookAssignBody(this);
        }
    }
    /**
