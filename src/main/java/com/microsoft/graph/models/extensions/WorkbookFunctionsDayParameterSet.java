...
/**
 * The class for the Workbook Functions Day Parameter Set.
 */
public class WorkbookFunctionsDayParameterSet {
    /**
     * The serial Number.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsDayParameterSetBuilder newBuilder() {
        return new WorkbookFunctionsDayParameterSetBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsDayParameterSet
     */
    public static final class WorkbookFunctionsDayParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDayParameterSetBuilder withSerialNumber(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDayParameterSet build() {
            return new WorkbookFunctionsDayParameterSet(this);
        }
    }
    /**
