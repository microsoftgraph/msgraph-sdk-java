...
public class WorkbookFunctionsFvscheduleBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsFvscheduleBodyBuilder newBuilder() {
        return new WorkbookFunctionsFvscheduleBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsFvscheduleBody
     */
    public static final class WorkbookFunctionsFvscheduleBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvscheduleBodyBuilder withPrincipal(@Nullable final com.google.gson.JsonElement val) {
            this.principal = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsFvscheduleBodyBuilder withSchedule(@Nullable final com.google.gson.JsonElement val) {
            this.schedule = val;
            return this;
        }
        private WorkbookFunctionsFvscheduleBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsFvscheduleBody build() {
            return new WorkbookFunctionsFvscheduleBody(this);
        }
    }
    /**
