...
public class WorkbookFunctionsPercentRank_IncBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsPercentRank_IncBodyBuilder newBuilder() {
        return new WorkbookFunctionsPercentRank_IncBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsPercentRank_IncBody
     */
    public static final class WorkbookFunctionsPercentRank_IncBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPercentRank_IncBodyBuilder withArray(@Nullable final com.google.gson.JsonElement val) {
            this.array = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPercentRank_IncBodyBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPercentRank_IncBodyBuilder withSignificance(@Nullable final com.google.gson.JsonElement val) {
            this.significance = val;
            return this;
        }
        private WorkbookFunctionsPercentRank_IncBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsPercentRank_IncBody build() {
            return new WorkbookFunctionsPercentRank_IncBody(this);
        }
    }
    /**
