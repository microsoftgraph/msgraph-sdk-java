...
public class GroupValidatePropertiesBody {
     ...
     */
    @Nonnull
    public static GroupValidatePropertiesBodyBuilder newBuilder() {
        return new GroupValidatePropertiesBodyBuilder();
    }
    /**
     * Fluent builder for the GroupValidatePropertiesBody
     */
    public static final class GroupValidatePropertiesBodyBuilder {
         ...
         */
        @Nonnull
        public GroupValidatePropertiesBodyBuilder withDisplayName(@Nullable final String val) {
         ...
         */
        @Nonnull
        public GroupValidatePropertiesBodyBuilder withMailNickname(@Nullable final String val) {
         ...
         */
        @Nonnull
        public GroupValidatePropertiesBodyBuilder withOnBehalfOfUserId(@Nullable final java.util.UUID val) {
            this.onBehalfOfUserId = val;
            return this;
        }
        private GroupValidatePropertiesBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public GroupValidatePropertiesBody build() {
            return new GroupValidatePropertiesBody(this);
        }
    }
    /**
