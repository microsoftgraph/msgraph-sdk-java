...
public class WorkbookFunctionsPercentile_IncParameterSet {
    ...
    private WorkbookFunctionsPercentile_IncParameterSet(@Nonnull final WorkbookFunctionsPercentile_IncParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsPercentile_IncParameterSet
     */
    public static final class WorkbookFunctionsPercentile_IncParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPercentile_IncParameterSetBuilder withArray(@Nullable final com.google.gson.JsonElement val) {
            this.array = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsPercentile_IncParameterSetBuilder withK(@Nullable final com.google.gson.JsonElement val) {
            this.k = val;
            return this;
        }
        private WorkbookFunctionsPercentile_IncParameterSetBuilder(){}
        /**
