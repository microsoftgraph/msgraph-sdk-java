...
public class WorkbookApplicationCalculateBody {
     ...
     */
    @Nonnull
    public static WorkbookApplicationCalculateBodyBuilder newBuilder() {
        return new WorkbookApplicationCalculateBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookApplicationCalculateBody
     */
    public static final class WorkbookApplicationCalculateBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookApplicationCalculateBodyBuilder withCalculationType(@Nullable final String val) {
            this.calculationType = val;
            return this;
        }
        private WorkbookApplicationCalculateBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookApplicationCalculateBody build() {
            return new WorkbookApplicationCalculateBody(this);
        }
    }
    /**
