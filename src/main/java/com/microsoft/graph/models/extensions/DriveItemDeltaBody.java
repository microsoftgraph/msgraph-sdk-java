...
/**
 * The class for the Drive Item Delta Body.
 */
public class DriveItemDeltaBody {
     ...
     */
    @Nonnull
    public static DriveItemDeltaBodyBuilder newBuilder() {
        return new DriveItemDeltaBodyBuilder();
    }
    /**
    ...
    public static final class DriveItemDeltaBodyBuilder {
         ...
         */
        @Nonnull
        public DriveItemDeltaBody build() {
            return new DriveItemDeltaBody(this);
        }
    }
    /**
