...
public class EventCancelParameterSet {
    ...
    private EventCancelParameterSet(@Nonnull final EventCancelParameterSetBuilder builder) {
     ...
     */
    public static final class EventCancelParameterSetBuilder extends BaseMethodParameterSetBuilder {
        ...
        private EventCancelParameterSetBuilder(){}
        /**
