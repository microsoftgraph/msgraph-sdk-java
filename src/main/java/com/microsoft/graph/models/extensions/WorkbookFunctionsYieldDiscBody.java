...
public class WorkbookFunctionsYieldDiscBody {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsYieldDiscBody
     */
    public WorkbookFunctionsYieldDiscBody() {}
    private WorkbookFunctionsYieldDiscBody(@Nonnull final WorkbookFunctionsYieldDiscBodyBuilder builder) {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsYieldDiscBodyBuilder newBuilder() {
        return new WorkbookFunctionsYieldDiscBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsYieldDiscBody
     */
    public static final class WorkbookFunctionsYieldDiscBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldDiscBodyBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldDiscBodyBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldDiscBodyBuilder withPr(@Nullable final com.google.gson.JsonElement val) {
            this.pr = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldDiscBodyBuilder withRedemption(@Nullable final com.google.gson.JsonElement val) {
            this.redemption = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsYieldDiscBodyBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        private WorkbookFunctionsYieldDiscBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsYieldDiscBody build() {
            return new WorkbookFunctionsYieldDiscBody(this);
        }
    }
    /**
