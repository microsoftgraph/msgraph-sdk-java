...
public class WorkbookFunctionsGamma_DistParameterSet {
     ...
     */
    public static final class WorkbookFunctionsGamma_DistParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistParameterSetBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistParameterSetBuilder withAlpha(@Nullable final com.google.gson.JsonElement val) {
            this.alpha = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistParameterSetBuilder withBeta(@Nullable final com.google.gson.JsonElement val) {
            this.beta = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsGamma_DistParameterSetBuilder withCumulative(@Nullable final com.google.gson.JsonElement val) {
            this.cumulative = val;
            return this;
        }
