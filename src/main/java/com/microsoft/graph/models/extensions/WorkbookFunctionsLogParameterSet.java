...
/**
 * The class for the Workbook Functions Log Parameter Set.
 */
public class WorkbookFunctionsLogParameterSet {
    ...
    private WorkbookFunctionsLogParameterSet(@Nonnull final WorkbookFunctionsLogParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookFunctionsLogParameterSetBuilder extends BaseMethodParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsLogParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsLogParameterSetBuilder withBase(@Nullable final com.google.gson.JsonElement val) {
            this.base = val;
            return this;
        }
        private WorkbookFunctionsLogParameterSetBuilder(){}
        /**
