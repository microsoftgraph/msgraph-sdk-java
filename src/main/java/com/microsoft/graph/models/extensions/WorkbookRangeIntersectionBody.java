...
/**
 * The class for the Workbook Range Intersection Body.
 */
public class WorkbookRangeIntersectionBody {
    /**
     * The another Range.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookRangeIntersectionBodyBuilder newBuilder() {
        return new WorkbookRangeIntersectionBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookRangeIntersectionBody
     */
    public static final class WorkbookRangeIntersectionBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookRangeIntersectionBodyBuilder withAnotherRange(@Nullable final String val) {
            this.anotherRange = val;
            return this;
        }
        private WorkbookRangeIntersectionBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookRangeIntersectionBody build() {
            return new WorkbookRangeIntersectionBody(this);
        }
    }
    /**
