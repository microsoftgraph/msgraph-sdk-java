...
public class WorkbookRangeRowParameterSet {
    ...
    private WorkbookRangeRowParameterSet(@Nonnull final WorkbookRangeRowParameterSetBuilder builder) {
     ...
     */
    public static final class WorkbookRangeRowParameterSetBuilder extends BaseMethodParameterSetBuilder {
        private Integer row;
        /**
         * Sets the Row
        ...
        private WorkbookRangeRowParameterSetBuilder(){}
        /**
