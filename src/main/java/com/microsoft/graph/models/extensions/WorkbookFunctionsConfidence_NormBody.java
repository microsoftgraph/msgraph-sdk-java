...
public class WorkbookFunctionsConfidence_NormBody {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsConfidence_NormBodyBuilder newBuilder() {
        return new WorkbookFunctionsConfidence_NormBodyBuilder();
    }
    /**
     * Fluent builder for the WorkbookFunctionsConfidence_NormBody
     */
    public static final class WorkbookFunctionsConfidence_NormBodyBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsConfidence_NormBodyBuilder withAlpha(@Nullable final com.google.gson.JsonElement val) {
            this.alpha = val;
            return this;
        }
         ...
         */
        @Nonnull
        public WorkbookFunctionsConfidence_NormBodyBuilder withStandardDev(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsConfidence_NormBodyBuilder withSize(@Nullable final com.google.gson.JsonElement val) {
            this.size = val;
            return this;
        }
        private WorkbookFunctionsConfidence_NormBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public WorkbookFunctionsConfidence_NormBody build() {
            return new WorkbookFunctionsConfidence_NormBody(this);
        }
    }
    /**
