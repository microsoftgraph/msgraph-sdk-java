...
/**
 * The class for the Participant Invite Body.
 */
public class ParticipantInviteBody {
    /**
     * The participants.
     * 
     */
     ...
     */
    @Nonnull
    public static ParticipantInviteBodyBuilder newBuilder() {
        return new ParticipantInviteBodyBuilder();
    }
    /**
     * Fluent builder for the ParticipantInviteBody
     */
    public static final class ParticipantInviteBodyBuilder {
         ...
         */
        @Nonnull
        public ParticipantInviteBodyBuilder withParticipants(@Nullable final java.util.List<InvitationParticipantInfo> val) {
         ...
         */
        @Nonnull
        public ParticipantInviteBodyBuilder withClientContext(@Nullable final String val) {
            this.clientContext = val;
            return this;
        }
        private ParticipantInviteBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public ParticipantInviteBody build() {
            return new ParticipantInviteBody(this);
        }
    }
    /**
