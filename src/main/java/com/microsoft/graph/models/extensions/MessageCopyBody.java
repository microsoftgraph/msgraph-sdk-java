...
public class MessageCopyBody {
     ...
     */
    @Nonnull
    public static MessageCopyBodyBuilder newBuilder() {
        return new MessageCopyBodyBuilder();
    }
    /**
     * Fluent builder for the MessageCopyBody
     */
    public static final class MessageCopyBodyBuilder {
         ...
         */
        @Nonnull
        public MessageCopyBodyBuilder withDestinationId(@Nullable final String val) {
            this.destinationId = val;
            return this;
        }
        private MessageCopyBodyBuilder(){}
        /**
         * Buils the resulting body object to be passed to the request
         * @return the body object to pass to the request
         */
        @Nonnull
        public MessageCopyBody build() {
            return new MessageCopyBody(this);
        }
    }
    /**
