...
public class TeamFunSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowCustomMemes", (n) -> { currentObject.setAllowCustomMemes(n.getBooleanValue()); });
        deserializerMap.put("allowGiphy", (n) -> { currentObject.setAllowGiphy(n.getBooleanValue()); });
        deserializerMap.put("allowStickersAndMemes", (n) -> { currentObject.setAllowStickersAndMemes(n.getBooleanValue()); });
        deserializerMap.put("giphyContentRating", (n) -> { currentObject.setGiphyContentRating(n.getEnumValue(GiphyRatingType.class)); });
