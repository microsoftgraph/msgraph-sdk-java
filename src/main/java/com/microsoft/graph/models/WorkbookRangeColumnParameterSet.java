...
/**
 * The class for the Workbook Range Column Parameter Set.
 */
public class WorkbookRangeColumnParameterSet {
    ...
    public static final class WorkbookRangeColumnParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookRangeColumnParameterSetBuilder withColumn(@Nullable final Integer val) {
            this.column = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookRangeColumnParameterSetBuilder
         */
        @Nullable
