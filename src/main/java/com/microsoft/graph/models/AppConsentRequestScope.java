...
public class AppConsentRequestScope implements AdditionalDataHolder, Parsable {
    ...
    public static AppConsentRequestScope createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
