...
public class WorkbookTable extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { currentObject.setColumns(n.getCollectionOfObjectValues(WorkbookTableColumn::createFromDiscriminatorValue)); });
        deserializerMap.put("highlightFirstColumn", (n) -> { currentObject.setHighlightFirstColumn(n.getBooleanValue()); });
        deserializerMap.put("highlightLastColumn", (n) -> { currentObject.setHighlightLastColumn(n.getBooleanValue()); });
        deserializerMap.put("legacyId", (n) -> { currentObject.setLegacyId(n.getStringValue()); });
        deserializerMap.put("name", (n) -> { currentObject.setName(n.getStringValue()); });
        deserializerMap.put("rows", (n) -> { currentObject.setRows(n.getCollectionOfObjectValues(WorkbookTableRow::createFromDiscriminatorValue)); });
        deserializerMap.put("showBandedColumns", (n) -> { currentObject.setShowBandedColumns(n.getBooleanValue()); });
        deserializerMap.put("showBandedRows", (n) -> { currentObject.setShowBandedRows(n.getBooleanValue()); });
        deserializerMap.put("showFilterButton", (n) -> { currentObject.setShowFilterButton(n.getBooleanValue()); });
        deserializerMap.put("showHeaders", (n) -> { currentObject.setShowHeaders(n.getBooleanValue()); });
        deserializerMap.put("showTotals", (n) -> { currentObject.setShowTotals(n.getBooleanValue()); });
        deserializerMap.put("sort", (n) -> { currentObject.setSort(n.getObjectValue(WorkbookTableSort::createFromDiscriminatorValue)); });
