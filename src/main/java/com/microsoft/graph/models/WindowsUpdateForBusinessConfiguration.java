...
public class WindowsUpdateForBusinessConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowWindows11Upgrade", (n) -> { currentObject.setAllowWindows11Upgrade(n.getBooleanValue()); });
        deserializerMap.put("automaticUpdateMode", (n) -> { currentObject.setAutomaticUpdateMode(n.getEnumValue(AutomaticUpdateMode.class)); });
        deserializerMap.put("autoRestartNotificationDismissal", (n) -> { currentObject.setAutoRestartNotificationDismissal(n.getEnumValue(AutoRestartNotificationDismissalMethod.class)); });
        deserializerMap.put("businessReadyUpdatesOnly", (n) -> { currentObject.setBusinessReadyUpdatesOnly(n.getEnumValue(WindowsUpdateType.class)); });
        deserializerMap.put("deadlineForFeatureUpdatesInDays", (n) -> { currentObject.setDeadlineForFeatureUpdatesInDays(n.getIntegerValue()); });
        deserializerMap.put("deadlineForQualityUpdatesInDays", (n) -> { currentObject.setDeadlineForQualityUpdatesInDays(n.getIntegerValue()); });
        deserializerMap.put("deadlineGracePeriodInDays", (n) -> { currentObject.setDeadlineGracePeriodInDays(n.getIntegerValue()); });
        ...
        deserializerMap.put("driversExcluded", (n) -> { currentObject.setDriversExcluded(n.getBooleanValue()); });
        deserializerMap.put("engagedRestartDeadlineInDays", (n) -> { currentObject.setEngagedRestartDeadlineInDays(n.getIntegerValue()); });
        deserializerMap.put("engagedRestartSnoozeScheduleInDays", (n) -> { currentObject.setEngagedRestartSnoozeScheduleInDays(n.getIntegerValue()); });
        deserializerMap.put("engagedRestartTransitionScheduleInDays", (n) -> { currentObject.setEngagedRestartTransitionScheduleInDays(n.getIntegerValue()); });
        deserializerMap.put("featureUpdatesDeferralPeriodInDays", (n) -> { currentObject.setFeatureUpdatesDeferralPeriodInDays(n.getIntegerValue()); });
        deserializerMap.put("featureUpdatesPaused", (n) -> { currentObject.setFeatureUpdatesPaused(n.getBooleanValue()); });
        deserializerMap.put("featureUpdatesPauseExpiryDateTime", (n) -> { currentObject.setFeatureUpdatesPauseExpiryDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("featureUpdatesPauseStartDate", (n) -> { currentObject.setFeatureUpdatesPauseStartDate(n.getLocalDateValue()); });
        deserializerMap.put("featureUpdatesRollbackStartDateTime", (n) -> { currentObject.setFeatureUpdatesRollbackStartDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("featureUpdatesRollbackWindowInDays", (n) -> { currentObject.setFeatureUpdatesRollbackWindowInDays(n.getIntegerValue()); });
        deserializerMap.put("featureUpdatesWillBeRolledBack", (n) -> { currentObject.setFeatureUpdatesWillBeRolledBack(n.getBooleanValue()); });
        deserializerMap.put("installationSchedule", (n) -> { currentObject.setInstallationSchedule(n.getObjectValue(WindowsUpdateInstallScheduleType::createFromDiscriminatorValue)); });
        deserializerMap.put("microsoftUpdateServiceAllowed", (n) -> { currentObject.setMicrosoftUpdateServiceAllowed(n.getBooleanValue()); });
        deserializerMap.put("postponeRebootUntilAfterDeadline", (n) -> { currentObject.setPostponeRebootUntilAfterDeadline(n.getBooleanValue()); });
        deserializerMap.put("prereleaseFeatures", (n) -> { currentObject.setPrereleaseFeatures(n.getEnumValue(PrereleaseFeatures.class)); });
        deserializerMap.put("qualityUpdatesDeferralPeriodInDays", (n) -> { currentObject.setQualityUpdatesDeferralPeriodInDays(n.getIntegerValue()); });
        deserializerMap.put("qualityUpdatesPaused", (n) -> { currentObject.setQualityUpdatesPaused(n.getBooleanValue()); });
        deserializerMap.put("qualityUpdatesPauseExpiryDateTime", (n) -> { currentObject.setQualityUpdatesPauseExpiryDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("qualityUpdatesPauseStartDate", (n) -> { currentObject.setQualityUpdatesPauseStartDate(n.getLocalDateValue()); });
        deserializerMap.put("qualityUpdatesRollbackStartDateTime", (n) -> { currentObject.setQualityUpdatesRollbackStartDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("qualityUpdatesWillBeRolledBack", (n) -> { currentObject.setQualityUpdatesWillBeRolledBack(n.getBooleanValue()); });
        deserializerMap.put("scheduleImminentRestartWarningInMinutes", (n) -> { currentObject.setScheduleImminentRestartWarningInMinutes(n.getIntegerValue()); });
        deserializerMap.put("scheduleRestartWarningInHours", (n) -> { currentObject.setScheduleRestartWarningInHours(n.getIntegerValue()); });
        deserializerMap.put("skipChecksBeforeRestart", (n) -> { currentObject.setSkipChecksBeforeRestart(n.getBooleanValue()); });
        deserializerMap.put("updateNotificationLevel", (n) -> { currentObject.setUpdateNotificationLevel(n.getEnumValue(WindowsUpdateNotificationDisplayOption.class)); });
        deserializerMap.put("updateWeeks", (n) -> { currentObject.setUpdateWeeks(n.getEnumValue(WindowsUpdateForBusinessUpdateWeeks.class)); });
        deserializerMap.put("userPauseAccess", (n) -> { currentObject.setUserPauseAccess(n.getEnumValue(Enablement.class)); });
        deserializerMap.put("userWindowsUpdateScanAccess", (n) -> { currentObject.setUserWindowsUpdateScanAccess(n.getEnumValue(Enablement.class)); });
