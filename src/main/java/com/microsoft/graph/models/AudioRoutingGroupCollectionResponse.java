...
public class AudioRoutingGroupCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(2) {{
            ...
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(AudioRoutingGroup::createFromDiscriminatorValue)); });
        }};
    }
    /**
