...
public class ChannelDeletedEventMessageDetail extends EventMessageDetail implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ChannelDeletedEventMessageDetail currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("channelDisplayName", (n) -> { currentObject.setChannelDisplayName(n.getStringValue()); });
