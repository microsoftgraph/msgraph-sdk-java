...
public class EducationUserCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * The value property
     */
    private java.util.List<EducationUser> value;
    /**
    ...
    public static EducationUserCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(EducationUser::createFromDiscriminatorValue)); });
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<EducationUser> value) {
        this.value = value;
    }
}
