...
public class ConversationMemberRoleUpdatedEventMessageDetail extends EventMessageDetail implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("conversationMemberRoles", (n) -> { currentObject.setConversationMemberRoles(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("conversationMemberUser", (n) -> { currentObject.setConversationMemberUser(n.getObjectValue(TeamworkUserIdentity::createFromDiscriminatorValue)); });
