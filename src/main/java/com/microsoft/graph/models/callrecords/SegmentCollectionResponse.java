...
public class SegmentCollectionResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a void
     */
    public SegmentCollectionResponse() {
    ...
    public static SegmentCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SegmentCollectionResponse currentObject = this;
        return new HashMap<>(2) {{
            this.put("@odata.nextLink", (n) -> { currentObject.setOdataNextLink(n.getStringValue()); });
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(Segment::createFromDiscriminatorValue)); });
        }};
    }
    /**
