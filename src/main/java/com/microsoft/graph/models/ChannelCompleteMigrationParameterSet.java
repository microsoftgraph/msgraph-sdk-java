...
/**
 * The class for the Channel Complete Migration Parameter Set.
 */
public class ChannelCompleteMigrationParameterSet {

    /**
     * Instiaciates a new ChannelCompleteMigrationParameterSet
     */
     ...
     */
    protected ChannelCompleteMigrationParameterSet(@Nonnull final ChannelCompleteMigrationParameterSetBuilder builder) {
    }
    /**
    ...
    public static final class ChannelCompleteMigrationParameterSetBuilder {
        /**
         * Instanciates a new ChannelCompleteMigrationParameterSetBuilder
         */
        @Nullable
        protected ChannelCompleteMigrationParameterSetBuilder(){}
        /**
