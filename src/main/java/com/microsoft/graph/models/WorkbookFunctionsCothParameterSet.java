...
/**
 * The class for the Workbook Functions Coth Parameter Set.
 */
public class WorkbookFunctionsCothParameterSet {
    /**
     * The number.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsCothParameterSetBuilder newBuilder() {
        return new WorkbookFunctionsCothParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookFunctionsCothParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCothParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCothParameterSet build() {
            return new WorkbookFunctionsCothParameterSet(this);
        }
    }
    /**
