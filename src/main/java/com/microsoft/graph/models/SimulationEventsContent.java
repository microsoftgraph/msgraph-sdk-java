...
import com.microsoft.graph.models.SimulationEvent;
...
/**
 * The class for the Simulation Events Content.
 */
public class SimulationEventsContent implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<SimulationEvent> events;
