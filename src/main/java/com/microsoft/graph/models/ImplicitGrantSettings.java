...
public class ImplicitGrantSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enableAccessTokenIssuance", (n) -> { currentObject.setEnableAccessTokenIssuance(n.getBooleanValue()); });
        deserializerMap.put("enableIdTokenIssuance", (n) -> { currentObject.setEnableIdTokenIssuance(n.getBooleanValue()); });
