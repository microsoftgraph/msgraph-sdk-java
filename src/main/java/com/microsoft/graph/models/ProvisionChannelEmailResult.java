...
public class ProvisionChannelEmailResult implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static ProvisionChannelEmailResult createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
