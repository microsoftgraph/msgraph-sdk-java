...
/**
 * The class for the Subject Rights Request Get Final Report Parameter Set.
 */
public class SubjectRightsRequestGetFinalReportParameterSet {

    /**
     * Instiaciates a new SubjectRightsRequestGetFinalReportParameterSet
     */
     ...
     */
    protected SubjectRightsRequestGetFinalReportParameterSet(@Nonnull final SubjectRightsRequestGetFinalReportParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the SubjectRightsRequestGetFinalReportParameterSet
     */
    public static final class SubjectRightsRequestGetFinalReportParameterSetBuilder {
        /**
         * Instanciates a new SubjectRightsRequestGetFinalReportParameterSetBuilder
         */
        @Nullable
