...
/**
 * The class for the Workbook Functions Coup Num Parameter Set.
 */
public class WorkbookFunctionsCoupNumParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsCoupNumParameterSet
     */
     ...
     */
    protected WorkbookFunctionsCoupNumParameterSet(@Nonnull final WorkbookFunctionsCoupNumParameterSetBuilder builder) {
    ...
    public static final class WorkbookFunctionsCoupNumParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNumParameterSetBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNumParameterSetBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNumParameterSetBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNumParameterSetBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        /**
         ...
         */
        @Nullable
        protected WorkbookFunctionsCoupNumParameterSetBuilder(){}
        /**
