...
public class WorkbookFunctionsLogNorm_DistParameterSet {
    ...
    public static final class WorkbookFunctionsLogNorm_DistParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsLogNorm_DistParameterSetBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsLogNorm_DistParameterSetBuilder withMean(@Nullable final com.google.gson.JsonElement val) {
            this.mean = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsLogNorm_DistParameterSetBuilder withStandardDev(@Nullable final com.google.gson.JsonElement val) {
         ...
         */
        @Nonnull
        public WorkbookFunctionsLogNorm_DistParameterSetBuilder withCumulative(@Nullable final com.google.gson.JsonElement val) {
            this.cumulative = val;
            return this;
        }
        /**
