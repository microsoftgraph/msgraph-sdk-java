...
public class ComplianceInformation implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("certificationControls", (n) -> { currentObject.setCertificationControls(n.getCollectionOfObjectValues(CertificationControl::createFromDiscriminatorValue)); });
        deserializerMap.put("certificationName", (n) -> { currentObject.setCertificationName(n.getStringValue()); });
