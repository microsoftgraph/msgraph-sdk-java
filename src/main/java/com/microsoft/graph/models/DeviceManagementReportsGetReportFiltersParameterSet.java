...
/**
 * The class for the Device Management Reports Get Report Filters Parameter Set.
 */
public class DeviceManagementReportsGetReportFiltersParameterSet {
    ...
    /**
     * Instiaciates a new DeviceManagementReportsGetReportFiltersParameterSet
     */
     ...
     */
    protected DeviceManagementReportsGetReportFiltersParameterSet(@Nonnull final DeviceManagementReportsGetReportFiltersParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the DeviceManagementReportsGetReportFiltersParameterSet
     */
    public static final class DeviceManagementReportsGetReportFiltersParameterSetBuilder {
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withName(@Nullable final String val) {
            this.name = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withSelect(@Nullable final java.util.List<String> val) {
            this.select = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withSearch(@Nullable final String val) {
            this.search = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withGroupBy(@Nullable final java.util.List<String> val) {
            this.groupBy = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withOrderBy(@Nullable final java.util.List<String> val) {
            this.orderBy = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withSkip(@Nullable final Integer val) {
            this.skip = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withTop(@Nullable final Integer val) {
            this.top = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withSessionId(@Nullable final String val) {
            this.sessionId = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public DeviceManagementReportsGetReportFiltersParameterSetBuilder withFilter(@Nullable final String val) {
            this.filter = val;
            return this;
        }
        /**
         * Instanciates a new DeviceManagementReportsGetReportFiltersParameterSetBuilder
         */
        @Nullable
        protected DeviceManagementReportsGetReportFiltersParameterSetBuilder(){}
        /**
