...
public class MobileAppContentFileCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * The value property
     */
    private java.util.List<MobileAppContentFile> value;
    /**
    ...
    public static MobileAppContentFileCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(MobileAppContentFile::createFromDiscriminatorValue)); });
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<MobileAppContentFile> value) {
        this.value = value;
    }
}
