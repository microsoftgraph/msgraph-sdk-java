...
public class SynchronizationMetadataEntry implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private SynchronizationMetadata key;
    /**
    ...
    public static SynchronizationMetadataEntry createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
