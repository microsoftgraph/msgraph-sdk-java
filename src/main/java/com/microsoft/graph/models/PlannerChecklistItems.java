...
public class PlannerChecklistItems implements AdditionalDataHolder, Parsable {
    ...
    public static PlannerChecklistItems createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
