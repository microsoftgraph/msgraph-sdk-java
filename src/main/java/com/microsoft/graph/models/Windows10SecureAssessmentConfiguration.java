...
public class Windows10SecureAssessmentConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowPrinting", (n) -> { currentObject.setAllowPrinting(n.getBooleanValue()); });
        deserializerMap.put("allowScreenCapture", (n) -> { currentObject.setAllowScreenCapture(n.getBooleanValue()); });
        deserializerMap.put("allowTextSuggestion", (n) -> { currentObject.setAllowTextSuggestion(n.getBooleanValue()); });
        deserializerMap.put("configurationAccount", (n) -> { currentObject.setConfigurationAccount(n.getStringValue()); });
        deserializerMap.put("launchUri", (n) -> { currentObject.setLaunchUri(n.getStringValue()); });
