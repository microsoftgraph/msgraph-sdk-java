...
public class Message extends OutlookItem implements Parsable {
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getConversationIndex() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("conversationIndex", (n) -> { this.setConversationIndex(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("conversationIndex", this.getConversationIndex());
     ...
     */
    public void setConversationIndex(@jakarta.annotation.Nullable final Base64url value) {
