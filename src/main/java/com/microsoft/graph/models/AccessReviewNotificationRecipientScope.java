...
import com.microsoft.graph.models.AccessReviewNotificationRecipientQueryScope;
...
public class AccessReviewNotificationRecipientScope implements AdditionalDataHolder, Parsable {
    ...
    public static AccessReviewNotificationRecipientScope createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AccessReviewNotificationRecipientScope currentObject = this;
