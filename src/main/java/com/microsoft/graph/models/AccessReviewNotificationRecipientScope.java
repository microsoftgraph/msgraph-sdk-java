...
public class AccessReviewNotificationRecipientScope implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static AccessReviewNotificationRecipientScope createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
