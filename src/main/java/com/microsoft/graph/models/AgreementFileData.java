...
public class AgreementFileData implements AdditionalDataHolder, Parsable {
    ...
    public static AgreementFileData createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final Base64url value) {
        this.data = value;
    }
    /**
