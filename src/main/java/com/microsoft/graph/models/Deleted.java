...
public class Deleted implements AdditionalDataHolder, Parsable {
    ...
    public static Deleted createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final Deleted currentObject = this;
