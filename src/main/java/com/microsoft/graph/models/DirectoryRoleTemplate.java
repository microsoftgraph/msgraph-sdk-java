...
public class DirectoryRoleTemplate extends DirectoryObject implements Parsable {
    ...
    public static DirectoryRoleTemplate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DirectoryRoleTemplate currentObject = this;
