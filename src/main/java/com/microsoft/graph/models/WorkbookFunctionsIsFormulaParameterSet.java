...
public class WorkbookFunctionsIsFormulaParameterSet {
     ...
     */
    protected WorkbookFunctionsIsFormulaParameterSet(@Nonnull final WorkbookFunctionsIsFormulaParameterSetBuilder builder) {
    ...
    public static final class WorkbookFunctionsIsFormulaParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsIsFormulaParameterSetBuilder withReference(@Nullable final com.google.gson.JsonElement val) {
            this.reference = val;
            return this;
        }
        /**
