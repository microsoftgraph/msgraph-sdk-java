...
/**
 * The class for the Workbook Functions True Parameter Set.
 */
public class WorkbookFunctionsTrueParameterSet {
     ...
     */
    @Nonnull
    public static WorkbookFunctionsTrueParameterSetBuilder newBuilder() {
        return new WorkbookFunctionsTrueParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookFunctionsTrueParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsTrueParameterSet build() {
            return new WorkbookFunctionsTrueParameterSet(this);
        }
    }
    /**
