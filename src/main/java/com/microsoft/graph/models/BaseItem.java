...
public class BaseItem extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("createdByUser", (n) -> { currentObject.setCreatedByUser(n.getObjectValue(User::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("lastModifiedByUser", (n) -> { currentObject.setLastModifiedByUser(n.getObjectValue(User::createFromDiscriminatorValue)); });
