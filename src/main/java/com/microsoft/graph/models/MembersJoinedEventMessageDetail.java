...
/**
 * The class for the Members Joined Event Message Detail.
 */
public class MembersJoinedEventMessageDetail extends EventMessageDetail implements IJsonBackedObject {
