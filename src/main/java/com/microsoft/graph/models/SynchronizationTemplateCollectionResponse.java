...
public class SynchronizationTemplateCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static SynchronizationTemplateCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<SynchronizationTemplate> value) {
        this.value = value;
    }
}
