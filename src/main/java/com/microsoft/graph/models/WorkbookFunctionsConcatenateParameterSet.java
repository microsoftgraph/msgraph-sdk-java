...
/**
 * The class for the Workbook Functions Concatenate Parameter Set.
 */
public class WorkbookFunctionsConcatenateParameterSet {
    ...
    public static final class WorkbookFunctionsConcatenateParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsConcatenateParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        /**
