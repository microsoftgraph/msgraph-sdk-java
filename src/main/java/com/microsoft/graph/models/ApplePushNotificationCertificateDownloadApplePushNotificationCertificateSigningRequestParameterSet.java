...
/**
 * The class for the Apple Push Notification Certificate Download Apple Push Notification Certificate Signing Request Parameter Set.
 */
public class ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestParameterSet {
     ...
     */
    @Nonnull
    public static ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestParameterSetBuilder newBuilder() {
        return new ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestParameterSetBuilder();
    }
    /**
    ...
    public static final class ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestParameterSetBuilder {
         ...
         */
        @Nonnull
        public ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestParameterSet build() {
            return new ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestParameterSet(this);
        }
    }
    /**
