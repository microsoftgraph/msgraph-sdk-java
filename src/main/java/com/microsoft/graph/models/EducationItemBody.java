...
public class EducationItemBody implements AdditionalDataHolder, Parsable {
    ...
    public static EducationItemBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("contentType", (n) -> { currentObject.setContentType(n.getEnumValue(BodyType.class)); });
