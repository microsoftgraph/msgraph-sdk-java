...
public class ReportRootGetSharePointSiteUsageDetailParameterSet {
    ...
    public static final class ReportRootGetSharePointSiteUsageDetailParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetSharePointSiteUsageDetailParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetSharePointSiteUsageDetailParameterSetBuilder
         */
        @Nullable
