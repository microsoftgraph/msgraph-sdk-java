...
/**
 * The class for the Workbook Functions Acos Parameter Set.
 */
public class WorkbookFunctionsAcosParameterSet {
    ...
    public static final class WorkbookFunctionsAcosParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsAcosParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsAcosParameterSetBuilder
         */
        @Nullable
