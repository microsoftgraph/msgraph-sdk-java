...
public class SamlSingleSignOnSettings implements AdditionalDataHolder, Parsable {
    ...
    public static SamlSingleSignOnSettings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SamlSingleSignOnSettings currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("relayState", (n) -> { currentObject.setRelayState(n.getStringValue()); });
     ...
     */
    @javax.annotation.Nonnull
    public void setRelayState(@javax.annotation.Nullable final String value) {
