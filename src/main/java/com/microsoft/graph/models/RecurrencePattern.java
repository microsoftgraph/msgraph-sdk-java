...
public class RecurrencePattern implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("firstDayOfWeek", (n) -> { currentObject.setFirstDayOfWeek(n.getEnumValue(DayOfWeek.class)); });
        deserializerMap.put("index", (n) -> { currentObject.setIndex(n.getEnumValue(WeekIndex.class)); });
        deserializerMap.put("interval", (n) -> { currentObject.setInterval(n.getIntegerValue()); });
        deserializerMap.put("month", (n) -> { currentObject.setMonth(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(RecurrencePatternType.class)); });
