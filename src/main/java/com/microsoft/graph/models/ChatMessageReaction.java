...
public class ChatMessageReaction implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("reactionType", (n) -> { currentObject.setReactionType(n.getStringValue()); });
        deserializerMap.put("user", (n) -> { currentObject.setUser(n.getObjectValue(ChatMessageReactionIdentitySet::createFromDiscriminatorValue)); });
