...
public class UnifiedRole implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static UnifiedRole createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
