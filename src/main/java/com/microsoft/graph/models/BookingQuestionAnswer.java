...
public class BookingQuestionAnswer implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("answer", (n) -> { currentObject.setAnswer(n.getStringValue()); });
        ...
        deserializerMap.put("question", (n) -> { currentObject.setQuestion(n.getStringValue()); });
        deserializerMap.put("questionId", (n) -> { currentObject.setQuestionId(n.getStringValue()); });
        deserializerMap.put("selectedOptions", (n) -> { currentObject.setSelectedOptions(n.getCollectionOfPrimitiveValues(String.class)); });
