...
public class OnenotePagePreviewLinks implements AdditionalDataHolder, Parsable {
    ...
    public static OnenotePagePreviewLinks createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("previewImageUrl", (n) -> { currentObject.setPreviewImageUrl(n.getObjectValue(ExternalLink::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setPreviewImageUrl(@javax.annotation.Nullable final ExternalLink value) {
