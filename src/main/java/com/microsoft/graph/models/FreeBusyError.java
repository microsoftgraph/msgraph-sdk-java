...
public class FreeBusyError implements AdditionalDataHolder, Parsable {
    ...
    public static FreeBusyError createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("responseCode", (n) -> { currentObject.setResponseCode(n.getStringValue()); });
     ...
     */
    @javax.annotation.Nonnull
    public void setResponseCode(@javax.annotation.Nullable final String value) {
