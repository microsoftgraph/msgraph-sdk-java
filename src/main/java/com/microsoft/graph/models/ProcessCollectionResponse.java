...
public class ProcessCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ProcessCollectionResponse currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(Process::createFromDiscriminatorValue)); });
