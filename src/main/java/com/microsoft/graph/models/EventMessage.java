...
public class EventMessage extends Message implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("event", (n) -> { currentObject.setEvent(n.getObjectValue(Event::createFromDiscriminatorValue)); });
        deserializerMap.put("isAllDay", (n) -> { currentObject.setIsAllDay(n.getBooleanValue()); });
        deserializerMap.put("isDelegated", (n) -> { currentObject.setIsDelegated(n.getBooleanValue()); });
        deserializerMap.put("isOutOfDate", (n) -> { currentObject.setIsOutOfDate(n.getBooleanValue()); });
        deserializerMap.put("location", (n) -> { currentObject.setLocation(n.getObjectValue(Location::createFromDiscriminatorValue)); });
        deserializerMap.put("meetingMessageType", (n) -> { currentObject.setMeetingMessageType(n.getEnumValue(MeetingMessageType.class)); });
