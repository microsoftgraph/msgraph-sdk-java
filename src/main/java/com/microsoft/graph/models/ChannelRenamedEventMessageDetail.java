...
/**
 * The class for the Channel Renamed Event Message Detail.
 */
public class ChannelRenamedEventMessageDetail extends EventMessageDetail implements IJsonBackedObject {
