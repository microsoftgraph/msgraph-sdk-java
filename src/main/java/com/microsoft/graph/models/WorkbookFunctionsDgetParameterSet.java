...
/**
 * The class for the Workbook Functions Dget Parameter Set.
 */
public class WorkbookFunctionsDgetParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsDgetParameterSet
     */
     ...
     */
    protected WorkbookFunctionsDgetParameterSet(@Nonnull final WorkbookFunctionsDgetParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsDgetParameterSet
     */
    public static final class WorkbookFunctionsDgetParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDgetParameterSetBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsDgetParameterSetBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsDgetParameterSetBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        /**
