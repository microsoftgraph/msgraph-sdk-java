...
/**
 * The class for the Directory Definition Discover Parameter Set.
 */
public class DirectoryDefinitionDiscoverParameterSet {

    /**
     * Instiaciates a new DirectoryDefinitionDiscoverParameterSet
     */
     ...
     */
    protected DirectoryDefinitionDiscoverParameterSet(@Nonnull final DirectoryDefinitionDiscoverParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DirectoryDefinitionDiscoverParameterSet
     */
    public static final class DirectoryDefinitionDiscoverParameterSetBuilder {
        /**
         * Instanciates a new DirectoryDefinitionDiscoverParameterSetBuilder
         */
        @Nullable
