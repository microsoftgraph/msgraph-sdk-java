...
/**
 * The class for the Message Unpinned Event Message Detail.
 */
public class MessageUnpinnedEventMessageDetail extends EventMessageDetail implements IJsonBackedObject {
