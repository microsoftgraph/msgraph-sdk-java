...
public class ExtractSensitivityLabelsResult implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static ExtractSensitivityLabelsResult createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<SensitivityLabelAssignment>
     */
     ...
     */
    public void setLabels(@jakarta.annotation.Nullable final java.util.List<SensitivityLabelAssignment> value) {
