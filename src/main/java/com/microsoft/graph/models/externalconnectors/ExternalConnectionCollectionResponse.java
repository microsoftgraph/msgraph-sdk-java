...
public class ExternalConnectionCollectionResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> _additionalData;
    /** The nextLink property */
    private String _nextLink;
    /** The value property */
    private java.util.List<ExternalConnection> _value;
    /**
    ...
    public static ExternalConnectionCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExternalConnectionCollectionResponse currentObject = this;
        return new HashMap<>(2) {{
            this.put("@odata.nextLink", (n) -> { currentObject.setOdatanextLink(n.getStringValue()); });
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(ExternalConnection::createFromDiscriminatorValue)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final java.util.List<ExternalConnection> value) {
        this._value = value;
    }
}
