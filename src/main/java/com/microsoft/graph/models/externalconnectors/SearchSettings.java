...
public class SearchSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static SearchSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<DisplayTemplate>
     */
    @jakarta.annotation.Nullable
    public java.util.List<DisplayTemplate> getSearchResultTemplates() {
        return this.getBackingStore().get("searchResultTemplates");
    }
    /**
     ...
     */
    public void setSearchResultTemplates(@jakarta.annotation.Nullable final java.util.List<DisplayTemplate> value) {
        this.getBackingStore().set("searchResultTemplates", value);
    }
}
