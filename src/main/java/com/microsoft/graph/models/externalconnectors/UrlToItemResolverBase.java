...
public class UrlToItemResolverBase implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static UrlToItemResolverBase createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
