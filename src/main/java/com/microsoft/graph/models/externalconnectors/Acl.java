...
public class Acl implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("accessType", (n) -> { currentObject.setAccessType(n.getEnumValue(AccessType.class)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(AclType.class)); });
