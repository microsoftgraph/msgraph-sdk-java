...
public class CallParticipantInfo implements AdditionalDataHolder, Parsable {
    ...
    public static CallParticipantInfo createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CallParticipantInfo currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("participant", (n) -> { currentObject.setParticipant(n.getObjectValue(IdentitySet::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setParticipant(@javax.annotation.Nullable final IdentitySet value) {
