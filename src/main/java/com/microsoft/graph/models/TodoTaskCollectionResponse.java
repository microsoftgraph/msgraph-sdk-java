...
public class TodoTaskCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public static TodoTaskCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final TodoTaskCollectionResponse currentObject = this;
