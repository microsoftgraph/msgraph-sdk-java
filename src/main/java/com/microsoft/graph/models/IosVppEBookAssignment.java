...
public class IosVppEBookAssignment extends ManagedEBookAssignment implements Parsable {
    ...
    public static IosVppEBookAssignment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final IosVppEBookAssignment currentObject = this;
