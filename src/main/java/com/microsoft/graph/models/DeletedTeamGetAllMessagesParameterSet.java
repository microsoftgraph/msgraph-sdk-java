...
/**
 * The class for the Deleted Team Get All Messages Parameter Set.
 */
public class DeletedTeamGetAllMessagesParameterSet {

    /**
     * Instiaciates a new DeletedTeamGetAllMessagesParameterSet
     */
     ...
     */
    protected DeletedTeamGetAllMessagesParameterSet(@Nonnull final DeletedTeamGetAllMessagesParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeletedTeamGetAllMessagesParameterSet
     */
    public static final class DeletedTeamGetAllMessagesParameterSetBuilder {
        /**
         * Instanciates a new DeletedTeamGetAllMessagesParameterSetBuilder
         */
        @Nullable
