...
public class ApplicationTemplateInstantiateParameterSet {
    ...
    /**
     * Instiaciates a new ApplicationTemplateInstantiateParameterSet
     */
     ...
     */
    protected ApplicationTemplateInstantiateParameterSet(@Nonnull final ApplicationTemplateInstantiateParameterSetBuilder builder) {
    ...
    public static final class ApplicationTemplateInstantiateParameterSetBuilder {
         ...
         */
        @Nonnull
        public ApplicationTemplateInstantiateParameterSetBuilder withDisplayName(@Nullable final String val) {
            this.displayName = val;
            return this;
        }
        /**
         * Instanciates a new ApplicationTemplateInstantiateParameterSetBuilder
         */
        @Nullable
