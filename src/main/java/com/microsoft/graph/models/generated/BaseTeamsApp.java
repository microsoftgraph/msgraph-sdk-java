...
/**
 * The class for the Base Teams App.
 */
public class BaseTeamsApp extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("appDefinitions")) {
            final BaseTeamsAppDefinitionCollectionResponse response = new BaseTeamsAppDefinitionCollectionResponse();
