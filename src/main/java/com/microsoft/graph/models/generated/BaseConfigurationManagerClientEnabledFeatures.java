...
/**
 * The class for the Base Configuration Manager Client Enabled Features.
 */
public class BaseConfigurationManagerClientEnabledFeatures implements IJsonBackedObject {
