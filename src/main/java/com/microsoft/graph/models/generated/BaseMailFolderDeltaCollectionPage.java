...
/**
 * The class for the Base Mail Folder Delta Collection Page.
 */
public class BaseMailFolderDeltaCollectionPage extends BaseCollectionPage<MailFolder, IMailFolderDeltaCollectionRequestBuilder> implements IBaseMailFolderDeltaCollectionPage {
    ...
    /**
     * A collection page for MailFolderDelta.
     *
     * @param response The serialized BaseMailFolderDeltaCollectionResponse from the service
     * @param builder The request builder for the next collection page
     */
    public BaseMailFolderDeltaCollectionPage(final BaseMailFolderDeltaCollectionResponse response, final IMailFolderDeltaCollectionRequestBuilder builder) {
