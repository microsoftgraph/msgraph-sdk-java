...
/**
 * The class for the Base Device Compliance Scheduled Action For Rule.
 */
public class BaseDeviceComplianceScheduledActionForRule extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("scheduledActionConfigurations")) {
            final BaseDeviceComplianceActionItemCollectionResponse response = new BaseDeviceComplianceActionItemCollectionResponse();
