...
/**
 * The class for the Base App Catalogs.
 */
public class BaseAppCatalogs extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("teamsApps")) {
            final BaseTeamsAppCollectionResponse response = new BaseTeamsAppCollectionResponse();
