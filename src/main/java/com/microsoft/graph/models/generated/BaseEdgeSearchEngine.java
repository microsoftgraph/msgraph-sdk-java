...
/**
 * The class for the Base Edge Search Engine.
 */
public class BaseEdgeSearchEngine extends EdgeSearchEngineBase implements IJsonBackedObject {
     ...
     */
    @SerializedName("edgeSearchEngineType")
    @Expose
