...
/**
 * The class for the Base Device Compliance Policy.
 */
public class BaseDeviceCompliancePolicy extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("scheduledActionsForRule")) {
            final BaseDeviceComplianceScheduledActionForRuleCollectionResponse response = new BaseDeviceComplianceScheduledActionForRuleCollectionResponse();
        ...
        if (json.has("deviceStatuses")) {
            final BaseDeviceComplianceDeviceStatusCollectionResponse response = new BaseDeviceComplianceDeviceStatusCollectionResponse();
        ...
        if (json.has("userStatuses")) {
            final BaseDeviceComplianceUserStatusCollectionResponse response = new BaseDeviceComplianceUserStatusCollectionResponse();
        ...
        if (json.has("deviceSettingStateSummaries")) {
            final BaseSettingStateDeviceSummaryCollectionResponse response = new BaseSettingStateDeviceSummaryCollectionResponse();
        ...
        if (json.has("assignments")) {
            final BaseDeviceCompliancePolicyAssignmentCollectionResponse response = new BaseDeviceCompliancePolicyAssignmentCollectionResponse();
