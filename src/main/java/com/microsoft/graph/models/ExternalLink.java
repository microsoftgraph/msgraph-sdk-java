...
public class ExternalLink implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static ExternalLink createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getHref() {
        return this.getBackingStore().get("href");
    }
    /**
    ...
    public void setHref(@jakarta.annotation.Nullable final String value) {
        this.getBackingStore().set("href", value);
    }
    /**
