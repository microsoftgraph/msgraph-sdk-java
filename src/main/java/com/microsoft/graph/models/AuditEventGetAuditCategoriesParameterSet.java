...
/**
 * The class for the Audit Event Get Audit Categories Parameter Set.
 */
public class AuditEventGetAuditCategoriesParameterSet {

    /**
     * Instiaciates a new AuditEventGetAuditCategoriesParameterSet
     */
     ...
     */
    protected AuditEventGetAuditCategoriesParameterSet(@Nonnull final AuditEventGetAuditCategoriesParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the AuditEventGetAuditCategoriesParameterSet
     */
    public static final class AuditEventGetAuditCategoriesParameterSetBuilder {
        /**
         * Instanciates a new AuditEventGetAuditCategoriesParameterSetBuilder
         */
        @Nullable
