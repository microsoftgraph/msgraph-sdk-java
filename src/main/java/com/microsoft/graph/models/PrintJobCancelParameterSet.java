...
/**
 * The class for the Print Job Cancel Parameter Set.
 */
public class PrintJobCancelParameterSet {

    /**
     * Instiaciates a new PrintJobCancelParameterSet
     */
     ...
     */
    protected PrintJobCancelParameterSet(@Nonnull final PrintJobCancelParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PrintJobCancelParameterSet
     */
    public static final class PrintJobCancelParameterSetBuilder {
        /**
         * Instanciates a new PrintJobCancelParameterSetBuilder
         */
        @Nullable
