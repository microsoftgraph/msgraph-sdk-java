...
/**
 * The class for the Workbook Range Format Autofit Columns Parameter Set.
 */
public class WorkbookRangeFormatAutofitColumnsParameterSet {
     ...
     */
    @Nonnull
    public static WorkbookRangeFormatAutofitColumnsParameterSetBuilder newBuilder() {
        return new WorkbookRangeFormatAutofitColumnsParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookRangeFormatAutofitColumnsParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookRangeFormatAutofitColumnsParameterSet build() {
            return new WorkbookRangeFormatAutofitColumnsParameterSet(this);
        }
    }
    /**
