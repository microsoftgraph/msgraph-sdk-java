...
/**
 * The class for the Unified Role Assignment Schedule Request Cancel Parameter Set.
 */
public class UnifiedRoleAssignmentScheduleRequestCancelParameterSet {

    /**
     * Instiaciates a new UnifiedRoleAssignmentScheduleRequestCancelParameterSet
     */
     ...
     */
    protected UnifiedRoleAssignmentScheduleRequestCancelParameterSet(@Nonnull final UnifiedRoleAssignmentScheduleRequestCancelParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the UnifiedRoleAssignmentScheduleRequestCancelParameterSet
     */
    public static final class UnifiedRoleAssignmentScheduleRequestCancelParameterSetBuilder {
        /**
         * Instanciates a new UnifiedRoleAssignmentScheduleRequestCancelParameterSetBuilder
         */
        @Nullable
