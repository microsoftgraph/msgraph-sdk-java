...
public class LearningProviderCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static LearningProviderCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<LearningProvider> value) {
        this.value = value;
    }
}
