...
public class WorkbookChartPointCountParameterSet {
     ...
     */
    @Nonnull
    public static WorkbookChartPointCountParameterSetBuilder newBuilder() {
        return new WorkbookChartPointCountParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookChartPointCountParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookChartPointCountParameterSet build() {
            return new WorkbookChartPointCountParameterSet(this);
        }
    }
    /**
