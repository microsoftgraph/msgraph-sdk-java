...
/**
 * The class for the Workbook Functions Bin2Oct Parameter Set.
 */
public class WorkbookFunctionsBin2OctParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsBin2OctParameterSet
     */
     ...
     */
    protected WorkbookFunctionsBin2OctParameterSet(@Nonnull final WorkbookFunctionsBin2OctParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsBin2OctParameterSet
     */
    public static final class WorkbookFunctionsBin2OctParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsBin2OctParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsBin2OctParameterSetBuilder withPlaces(@Nullable final com.google.gson.JsonElement val) {
            this.places = val;
            return this;
        }
        /**
