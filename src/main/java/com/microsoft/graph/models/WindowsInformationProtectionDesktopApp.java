...
public class WindowsInformationProtectionDesktopApp extends WindowsInformationProtectionApp implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("binaryName", (n) -> { currentObject.setBinaryName(n.getStringValue()); });
        deserializerMap.put("binaryVersionHigh", (n) -> { currentObject.setBinaryVersionHigh(n.getStringValue()); });
        deserializerMap.put("binaryVersionLow", (n) -> { currentObject.setBinaryVersionLow(n.getStringValue()); });
