...
public class ItemActivityStatCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static ItemActivityStatCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ItemActivityStatCollectionResponse currentObject = this;
