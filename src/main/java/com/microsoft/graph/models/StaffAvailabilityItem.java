...
public class StaffAvailabilityItem implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public static StaffAvailabilityItem createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<AvailabilityItem>
     */
