...
public class FilterOperatorSchemaCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static FilterOperatorSchemaCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<FilterOperatorSchema>
     */
