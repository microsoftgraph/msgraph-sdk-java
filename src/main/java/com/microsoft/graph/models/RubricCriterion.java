...
public class RubricCriterion implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static RubricCriterion createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
