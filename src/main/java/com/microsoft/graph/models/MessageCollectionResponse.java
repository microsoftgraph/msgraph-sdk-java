...
public class MessageCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public static MessageCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MessageCollectionResponse currentObject = this;
