...
/**
 * The class for the Report Root Get Teams Team Activity Distribution Counts Parameter Set.
 */
public class ReportRootGetTeamsTeamActivityDistributionCountsParameterSet {
    ...
    /**
     * Instiaciates a new ReportRootGetTeamsTeamActivityDistributionCountsParameterSet
     */
     ...
     */
    protected ReportRootGetTeamsTeamActivityDistributionCountsParameterSet(@Nonnull final ReportRootGetTeamsTeamActivityDistributionCountsParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the ReportRootGetTeamsTeamActivityDistributionCountsParameterSet
     */
    public static final class ReportRootGetTeamsTeamActivityDistributionCountsParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetTeamsTeamActivityDistributionCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetTeamsTeamActivityDistributionCountsParameterSetBuilder
         */
        @Nullable
