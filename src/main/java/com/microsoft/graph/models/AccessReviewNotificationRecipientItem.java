...
public class AccessReviewNotificationRecipientItem implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("notificationRecipientScope", (n) -> { currentObject.setNotificationRecipientScope(n.getObjectValue(AccessReviewNotificationRecipientScope::createFromDiscriminatorValue)); });
        deserializerMap.put("notificationTemplateType", (n) -> { currentObject.setNotificationTemplateType(n.getStringValue()); });
