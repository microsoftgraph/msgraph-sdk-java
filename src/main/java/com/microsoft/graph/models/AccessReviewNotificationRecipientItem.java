...
/**
 * The class for the Access Review Notification Recipient Item.
 */
public class AccessReviewNotificationRecipientItem implements IJsonBackedObject {
    ...
    /**
     * The Notification Recipient Scope.
     * Determines the recipient of the notification email.
     */
    @SerializedName(value = "notificationRecipientScope", alternate = {"NotificationRecipientScope"})
    @Expose
	@Nullable
