...
/**
 * The class for the Base Channel.
 */
public class BaseChannel extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("tabs")) {
            final BaseTeamsTabCollectionResponse response = new BaseTeamsTabCollectionResponse();
