...
public class ReportRootGetYammerActivityUserDetailParameterSet {
    ...
    public static final class ReportRootGetYammerActivityUserDetailParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetYammerActivityUserDetailParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetYammerActivityUserDetailParameterSetBuilder
         */
        @Nullable
