...
public class ParticipantStopHoldMusicParameterSet {
     ...
     */
    protected ParticipantStopHoldMusicParameterSet(@Nonnull final ParticipantStopHoldMusicParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the ParticipantStopHoldMusicParameterSet
     */
    public static final class ParticipantStopHoldMusicParameterSetBuilder {
         ...
         */
        @Nonnull
        public ParticipantStopHoldMusicParameterSetBuilder withClientContext(@Nullable final String val) {
            this.clientContext = val;
            return this;
        }
        /**
         * Instanciates a new ParticipantStopHoldMusicParameterSetBuilder
         */
        @Nullable
        protected ParticipantStopHoldMusicParameterSetBuilder(){}
        /**
