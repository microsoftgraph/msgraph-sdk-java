...
/**
 * The class for the Access Package Assignment Filter By Current User Parameter Set.
 */
public class AccessPackageAssignmentFilterByCurrentUserParameterSet {
    ...
    /**
     * Instiaciates a new AccessPackageAssignmentFilterByCurrentUserParameterSet
     */
     ...
     */
    protected AccessPackageAssignmentFilterByCurrentUserParameterSet(@Nonnull final AccessPackageAssignmentFilterByCurrentUserParameterSetBuilder builder) {
        this.on = builder.on;
    }
    /**
    ...
    /**
     * Fluent builder for the AccessPackageAssignmentFilterByCurrentUserParameterSet
     */
    public static final class AccessPackageAssignmentFilterByCurrentUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public AccessPackageAssignmentFilterByCurrentUserParameterSetBuilder withOn(@Nullable final AccessPackageAssignmentFilterByCurrentUserOptions val) {
            this.on = val;
            return this;
        }
        /**
         * Instanciates a new AccessPackageAssignmentFilterByCurrentUserParameterSetBuilder
         */
        @Nullable
