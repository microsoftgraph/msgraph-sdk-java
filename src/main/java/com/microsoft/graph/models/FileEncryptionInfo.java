...
public class FileEncryptionInfo implements AdditionalDataHolder, Parsable {
    ...
    public Base64url getEncryptionKey() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("encryptionKey", (n) -> { this.setEncryptionKey(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        deserializerMap.put("fileDigest", (n) -> { this.setFileDigest(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        deserializerMap.put("fileDigestAlgorithm", (n) -> { this.setFileDigestAlgorithm(n.getStringValue()); });
        deserializerMap.put("initializationVector", (n) -> { this.setInitializationVector(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        deserializerMap.put("mac", (n) -> { this.setMac(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        deserializerMap.put("macKey", (n) -> { this.setMacKey(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getFileDigest() {
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("encryptionKey", this.getEncryptionKey());
        writer.writeObjectValue("fileDigest", this.getFileDigest());
        writer.writeStringValue("fileDigestAlgorithm", this.getFileDigestAlgorithm());
        writer.writeObjectValue("initializationVector", this.getInitializationVector());
        writer.writeObjectValue("mac", this.getMac());
        writer.writeObjectValue("macKey", this.getMacKey());
     ...
     */
    public void setEncryptionKey(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setFileDigest(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setInitializationVector(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setMac(@jakarta.annotation.Nullable final Base64url value) {
        this.mac = value;
    }
    /**
     ...
     */
    public void setMacKey(@jakarta.annotation.Nullable final Base64url value) {
        this.macKey = value;
    }
    /**
