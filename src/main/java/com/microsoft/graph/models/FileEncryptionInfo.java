...
public class FileEncryptionInfo implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public byte[] getEncryptionKey() {
        return this.getBackingStore().get("encryptionKey");
    }
    /**
    ...
    public byte[] getFileDigest() {
        return this.getBackingStore().get("fileDigest");
    }
    /**
    ...
    public String getFileDigestAlgorithm() {
        return this.getBackingStore().get("fileDigestAlgorithm");
    }
    /**
    ...
    public byte[] getInitializationVector() {
        return this.getBackingStore().get("initializationVector");
    }
    /**
    ...
    @jakarta.annotation.Nullable
    public byte[] getMac() {
        return this.getBackingStore().get("mac");
    }
    /**
    ...
    public byte[] getMacKey() {
        return this.getBackingStore().get("macKey");
    }
    /**
    ...
    public String getProfileIdentifier() {
        return this.getBackingStore().get("profileIdentifier");
    }
    /**
