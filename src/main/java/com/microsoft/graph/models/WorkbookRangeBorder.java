...
public class WorkbookRangeBorder extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sideIndex", (n) -> { currentObject.setSideIndex(n.getStringValue()); });
        deserializerMap.put("style", (n) -> { currentObject.setStyle(n.getStringValue()); });
        deserializerMap.put("weight", (n) -> { currentObject.setWeight(n.getStringValue()); });
