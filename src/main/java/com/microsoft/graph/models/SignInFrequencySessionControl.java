...
public class SignInFrequencySessionControl extends ConditionalAccessSessionControl implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationType", (n) -> { currentObject.setAuthenticationType(n.getEnumValue(SignInFrequencyAuthenticationType.class)); });
        deserializerMap.put("frequencyInterval", (n) -> { currentObject.setFrequencyInterval(n.getEnumValue(SignInFrequencyInterval.class)); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(SigninFrequencyType.class)); });
