...
/**
 * The class for the Authentication Strength Policy Usage Parameter Set.
 */
public class AuthenticationStrengthPolicyUsageParameterSet {

    /**
     * Instiaciates a new AuthenticationStrengthPolicyUsageParameterSet
     */
     ...
     */
    protected AuthenticationStrengthPolicyUsageParameterSet(@Nonnull final AuthenticationStrengthPolicyUsageParameterSetBuilder builder) {
    }
    /**
    ...
    public static final class AuthenticationStrengthPolicyUsageParameterSetBuilder {
        /**
         * Instanciates a new AuthenticationStrengthPolicyUsageParameterSetBuilder
         */
        @Nullable
