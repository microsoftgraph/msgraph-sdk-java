...
public class DeviceCompliancePolicyAssignmentCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public static DeviceCompliancePolicyAssignmentCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceCompliancePolicyAssignmentCollectionResponse currentObject = this;
