...
public class AppRoleAssignmentCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AppRoleAssignmentCollectionResponse currentObject = this;
        return new HashMap<>(2) {{
            this.put("@odata.nextLink", (n) -> { currentObject.setOdatanextLink(n.getStringValue()); });
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(AppRoleAssignment::createFromDiscriminatorValue)); });
        }};
    }
    /**
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<AppRoleAssignment> getValue() {
        return this._value;
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final java.util.List<AppRoleAssignment> value) {
        this._value = value;
    }
}
