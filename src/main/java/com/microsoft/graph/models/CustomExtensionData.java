...
public class CustomExtensionData implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a CustomExtensionData
     */
    @jakarta.annotation.Nonnull
    public static CustomExtensionData createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
