...
/**
 * The class for the Workbook Functions Lenb Parameter Set.
 */
public class WorkbookFunctionsLenbParameterSet {
     ...
     */
    protected WorkbookFunctionsLenbParameterSet(@Nonnull final WorkbookFunctionsLenbParameterSetBuilder builder) {
    ...
    public static final class WorkbookFunctionsLenbParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsLenbParameterSetBuilder withText(@Nullable final com.google.gson.JsonElement val) {
            this.text = val;
            return this;
        }
        /**
