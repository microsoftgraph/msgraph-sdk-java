...
public class WorkbookFunctionsCoupNcdParameterSet {
     ...
     */
    protected WorkbookFunctionsCoupNcdParameterSet(@Nonnull final WorkbookFunctionsCoupNcdParameterSetBuilder builder) {
    ...
    public static final class WorkbookFunctionsCoupNcdParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNcdParameterSetBuilder withSettlement(@Nullable final com.google.gson.JsonElement val) {
            this.settlement = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNcdParameterSetBuilder withMaturity(@Nullable final com.google.gson.JsonElement val) {
            this.maturity = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNcdParameterSetBuilder withFrequency(@Nullable final com.google.gson.JsonElement val) {
            this.frequency = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCoupNcdParameterSetBuilder withBasis(@Nullable final com.google.gson.JsonElement val) {
            this.basis = val;
            return this;
        }
        /**
