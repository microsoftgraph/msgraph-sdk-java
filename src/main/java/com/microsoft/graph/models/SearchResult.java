...
public class SearchResult implements AdditionalDataHolder, Parsable {
    ...
    public SearchResult() {
        ...
        this.setOdataType("#microsoft.graph.searchResult");
    }
    /**
    ...
    public static SearchResult createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("onClickTelemetryUrl", (n) -> { currentObject.setOnClickTelemetryUrl(n.getStringValue()); });
     ...
     */
    @javax.annotation.Nonnull
    public void setOnClickTelemetryUrl(@javax.annotation.Nullable final String value) {
