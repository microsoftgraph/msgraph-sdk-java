...
public class SearchResult implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("onClickTelemetryUrl", (n) -> { this.setOnClickTelemetryUrl(n.getStringValue()); });
    ...
    public String getOnClickTelemetryUrl() {
        return this.getBackingStore().get("onClickTelemetryUrl");
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("onClickTelemetryUrl", this.getOnClickTelemetryUrl());
     ...
     */
    public void setOnClickTelemetryUrl(@jakarta.annotation.Nullable final String value) {
        this.getBackingStore().set("onClickTelemetryUrl", value);
    }
}
