...
public class PhoneAuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> _additionalData;
    /** The OdataNextLink property */
    private String _odataNextLink;
    /** The value property */
    private java.util.List<PhoneAuthenticationMethod> _value;
    /**
    ...
    public static PhoneAuthenticationMethodCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PhoneAuthenticationMethodCollectionResponse currentObject = this;
        return new HashMap<>(2) {{
            this.put("@odata.nextLink", (n) -> { currentObject.setOdataNextLink(n.getStringValue()); });
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(PhoneAuthenticationMethod::createFromDiscriminatorValue)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final java.util.List<PhoneAuthenticationMethod> value) {
        this._value = value;
    }
}
