...
public class WorkbookFunctionsImSinhParameterSet {
     ...
     */
    protected WorkbookFunctionsImSinhParameterSet(@Nonnull final WorkbookFunctionsImSinhParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsImSinhParameterSet
     */
    public static final class WorkbookFunctionsImSinhParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImSinhParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsImSinhParameterSetBuilder
         */
        @Nullable
        protected WorkbookFunctionsImSinhParameterSetBuilder(){}
        /**
