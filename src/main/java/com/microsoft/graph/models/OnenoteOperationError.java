...
public class OnenoteOperationError implements AdditionalDataHolder, Parsable {
    ...
    public static OnenoteOperationError createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final OnenoteOperationError currentObject = this;
