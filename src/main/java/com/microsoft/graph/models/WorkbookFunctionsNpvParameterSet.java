...
/**
 * The class for the Workbook Functions Npv Parameter Set.
 */
public class WorkbookFunctionsNpvParameterSet {
    ...
    public static final class WorkbookFunctionsNpvParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsNpvParameterSetBuilder withRate(@Nullable final com.google.gson.JsonElement val) {
            this.rate = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsNpvParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsNpvParameterSetBuilder
         */
        @Nullable
