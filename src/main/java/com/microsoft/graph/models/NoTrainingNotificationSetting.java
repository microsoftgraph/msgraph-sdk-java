...
/**
 * The class for the No Training Notification Setting.
 */
public class NoTrainingNotificationSetting extends EndUserNotificationSetting implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public SimulationNotification simulationNotification;
