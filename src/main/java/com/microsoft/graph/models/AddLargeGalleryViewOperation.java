...
public class AddLargeGalleryViewOperation extends CommsOperation implements Parsable {
    ...
    public static AddLargeGalleryViewOperation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AddLargeGalleryViewOperation currentObject = this;
