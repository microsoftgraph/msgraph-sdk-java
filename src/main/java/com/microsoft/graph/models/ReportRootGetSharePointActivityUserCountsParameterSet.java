...
/**
 * The class for the Report Root Get Share Point Activity User Counts Parameter Set.
 */
public class ReportRootGetSharePointActivityUserCountsParameterSet {
    /**
     * The period.
     * 
     */
     ...
     */
    @Nonnull
    public static ReportRootGetSharePointActivityUserCountsParameterSetBuilder newBuilder() {
        return new ReportRootGetSharePointActivityUserCountsParameterSetBuilder();
    }
    /**
    ...
    public static final class ReportRootGetSharePointActivityUserCountsParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetSharePointActivityUserCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetSharePointActivityUserCountsParameterSetBuilder
         */
        @Nullable
         ...
         */
        @Nonnull
        public ReportRootGetSharePointActivityUserCountsParameterSet build() {
            return new ReportRootGetSharePointActivityUserCountsParameterSet(this);
        }
    }
    /**
