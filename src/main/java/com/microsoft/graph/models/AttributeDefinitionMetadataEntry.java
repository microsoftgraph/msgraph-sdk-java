...
public class AttributeDefinitionMetadataEntry implements AdditionalDataHolder, Parsable {
    ...
    public static AttributeDefinitionMetadataEntry createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setKey(@javax.annotation.Nullable final AttributeDefinitionMetadata value) {
        this.key = value;
    }
    /**
