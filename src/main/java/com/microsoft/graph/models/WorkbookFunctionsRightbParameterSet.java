...
public class WorkbookFunctionsRightbParameterSet {
    ...
    public static final class WorkbookFunctionsRightbParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsRightbParameterSetBuilder withText(@Nullable final com.google.gson.JsonElement val) {
            this.text = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsRightbParameterSetBuilder withNumBytes(@Nullable final com.google.gson.JsonElement val) {
            this.numBytes = val;
            return this;
        }
        /**
