...
public class PublicClientApplication implements AdditionalDataHolder, Parsable {
    ...
    public PublicClientApplication() {
        ...
        this.setOdataType("#microsoft.graph.publicClientApplication");
    }
    /**
    ...
    public static PublicClientApplication createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PublicClientApplication currentObject = this;
