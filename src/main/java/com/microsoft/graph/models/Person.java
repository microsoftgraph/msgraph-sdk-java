...
public class Person extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("birthday", (n) -> { currentObject.setBirthday(n.getStringValue()); });
        ...
        deserializerMap.put("imAddress", (n) -> { currentObject.setImAddress(n.getStringValue()); });
        deserializerMap.put("isFavorite", (n) -> { currentObject.setIsFavorite(n.getBooleanValue()); });
        ...
        deserializerMap.put("personNotes", (n) -> { currentObject.setPersonNotes(n.getStringValue()); });
        deserializerMap.put("personType", (n) -> { currentObject.setPersonType(n.getObjectValue(PersonType::createFromDiscriminatorValue)); });
        deserializerMap.put("phones", (n) -> { currentObject.setPhones(n.getCollectionOfObjectValues(Phone::createFromDiscriminatorValue)); });
        deserializerMap.put("postalAddresses", (n) -> { currentObject.setPostalAddresses(n.getCollectionOfObjectValues(Location::createFromDiscriminatorValue)); });
        deserializerMap.put("profession", (n) -> { currentObject.setProfession(n.getStringValue()); });
        deserializerMap.put("scoredEmailAddresses", (n) -> { currentObject.setScoredEmailAddresses(n.getCollectionOfObjectValues(ScoredEmailAddress::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("websites", (n) -> { currentObject.setWebsites(n.getCollectionOfObjectValues(Website::createFromDiscriminatorValue)); });
        deserializerMap.put("yomiCompany", (n) -> { currentObject.setYomiCompany(n.getStringValue()); });
