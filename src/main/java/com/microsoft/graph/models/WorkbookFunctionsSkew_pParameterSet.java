...
/**
 * The class for the Workbook Functions Skew_p Parameter Set.
 */
public class WorkbookFunctionsSkew_pParameterSet {
    ...
    public static final class WorkbookFunctionsSkew_pParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsSkew_pParameterSetBuilder withValues(@Nullable final com.google.gson.JsonElement val) {
            this.values = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsSkew_pParameterSetBuilder
         */
        @Nullable
