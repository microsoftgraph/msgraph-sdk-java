...
public class PrintSettings implements AdditionalDataHolder, Parsable {
    ...
    private Boolean _documentConversionEnabled;
    ...
    public static PrintSettings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PrintSettings currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("documentConversionEnabled", (n) -> { currentObject.setDocumentConversionEnabled(n.getBooleanValue()); });
     ...
     */
    @javax.annotation.Nonnull
    public void setDocumentConversionEnabled(@javax.annotation.Nullable final Boolean value) {
