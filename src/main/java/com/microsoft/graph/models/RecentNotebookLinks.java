...
public class RecentNotebookLinks implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static RecentNotebookLinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
