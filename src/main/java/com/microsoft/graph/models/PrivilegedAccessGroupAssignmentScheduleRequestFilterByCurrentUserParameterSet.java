...
/**
 * The class for the Privileged Access Group Assignment Schedule Request Filter By Current User Parameter Set.
 */
public class PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSet {
    ...
    /**
     * Instiaciates a new PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSet
     */
     ...
     */
    protected PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSet(@Nonnull final PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder builder) {
        this.on = builder.on;
    }
    /**
    ...
    /**
     * Fluent builder for the PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSet
     */
    public static final class PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder withOn(@Nullable final AssignmentScheduleRequestFilterByCurrentUserOptions val) {
            this.on = val;
            return this;
        }
        /**
         * Instanciates a new PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder
         */
        @Nullable
        protected PrivilegedAccessGroupAssignmentScheduleRequestFilterByCurrentUserParameterSetBuilder(){}
        /**
