...
public class CallMediaState implements AdditionalDataHolder, Parsable {
    ...
    public CallMediaState() {
        ...
        this.setOdataType("#microsoft.graph.callMediaState");
    }
    /**
    ...
    public static CallMediaState createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CallMediaState currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("audio", (n) -> { currentObject.setAudio(n.getEnumValue(MediaState.class)); });
    ...
    public void serialize(@javax.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeEnumValue("audio", this.getAudio());
