...
public class IosMobileAppConfiguration extends ManagedDeviceMobileAppConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("encodedSettingXml", (n) -> { currentObject.setEncodedSettingXml(n.getByteArrayValue()); });
        deserializerMap.put("settings", (n) -> { currentObject.setSettings(n.getCollectionOfObjectValues(AppConfigurationSettingItem::createFromDiscriminatorValue)); });
