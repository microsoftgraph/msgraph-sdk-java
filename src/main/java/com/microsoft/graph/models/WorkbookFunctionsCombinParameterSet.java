...
/**
 * The class for the Workbook Functions Combin Parameter Set.
 */
public class WorkbookFunctionsCombinParameterSet {
    ...
    public static final class WorkbookFunctionsCombinParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsCombinParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsCombinParameterSetBuilder withNumberChosen(@Nullable final com.google.gson.JsonElement val) {
            this.numberChosen = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsCombinParameterSetBuilder
         */
        @Nullable
