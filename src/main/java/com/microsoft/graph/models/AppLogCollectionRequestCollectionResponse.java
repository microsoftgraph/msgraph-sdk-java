...
public class AppLogCollectionRequestCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * The value property
     */
    private java.util.List<AppLogCollectionRequest> value;
    /**
    ...
    public static AppLogCollectionRequestCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<AppLogCollectionRequest> value) {
        this.value = value;
    }
}
