package microsoft.graph.rolemanagement.entitlementmanagement.roleassignmentschedules;
...
import microsoft.graph.rolemanagement.entitlementmanagement.roleassignmentschedules.count.CountRequestBuilder;
...
public class RoleAssignmentSchedulesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentScheduleCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, UnifiedRoleAssignmentScheduleCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of UnifiedRoleAssignmentScheduleCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentScheduleCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, UnifiedRoleAssignmentScheduleCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of unifiedRoleAssignmentSchedule
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentSchedule> post(@javax.annotation.Nonnull final UnifiedRoleAssignmentSchedule body, @javax.annotation.Nullable final java.util.function.Consumer<RoleAssignmentSchedulesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
