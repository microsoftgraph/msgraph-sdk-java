package com.microsoft.graph.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.targetschedule;
...
public class TargetScheduleRequestBuilder {
     ...
     * @return a CompletableFuture of unifiedRoleAssignmentSchedule
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentSchedule> get(@javax.annotation.Nullable final java.util.function.Consumer<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of unifiedRoleAssignmentSchedule
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentSchedule> get(@javax.annotation.Nullable final java.util.function.Consumer<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
