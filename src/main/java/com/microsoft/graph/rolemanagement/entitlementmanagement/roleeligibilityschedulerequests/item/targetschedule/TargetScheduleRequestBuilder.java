package microsoft.graph.rolemanagement.entitlementmanagement.roleeligibilityschedulerequests.item.targetschedule;
...
public class TargetScheduleRequestBuilder {
     ...
     * @return a CompletableFuture of unifiedRoleEligibilitySchedule
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleEligibilitySchedule> get(@javax.annotation.Nullable final java.util.function.Consumer<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
