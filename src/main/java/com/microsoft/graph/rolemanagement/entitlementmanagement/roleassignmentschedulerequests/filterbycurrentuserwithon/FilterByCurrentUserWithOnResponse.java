package microsoft.graph.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.filterbycurrentuserwithon;
...
public class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable {
    ...
    /** The value property */
    private java.util.List<UnifiedRoleAssignmentScheduleRequest> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(UnifiedRoleAssignmentScheduleRequest::createFromDiscriminatorValue)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final java.util.List<UnifiedRoleAssignmentScheduleRequest> value) {
        this._value = value;
    }
}
