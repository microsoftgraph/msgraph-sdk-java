...
public class FilterByCurrentUserWithOnRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<FilterByCurrentUserWithOnResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<FilterByCurrentUserWithOnResponse> executionException = new java.util.concurrent.CompletableFuture<FilterByCurrentUserWithOnResponse>();
