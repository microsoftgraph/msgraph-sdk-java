...
public class RoleEligibilitySchedulesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleCollectionResponse>();
