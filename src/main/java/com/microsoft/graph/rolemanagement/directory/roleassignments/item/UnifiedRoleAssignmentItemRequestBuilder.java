...
public class UnifiedRoleAssignmentItemRequestBuilder {
     ...
     * @return a CompletableFuture of unifiedRoleAssignment
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignment> patch(@javax.annotation.Nonnull final UnifiedRoleAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<UnifiedRoleAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
