...
public class RoleEligibilityScheduleInstancesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UnifiedRoleEligibilityScheduleInstance body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleInstanceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleInstanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleInstanceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleInstance> post(@javax.annotation.Nonnull final UnifiedRoleEligibilityScheduleInstance body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleInstance> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleEligibilityScheduleInstance>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
