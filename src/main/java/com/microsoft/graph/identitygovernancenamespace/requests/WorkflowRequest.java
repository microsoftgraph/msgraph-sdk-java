...
public class WorkflowRequest extends BaseRequest<Workflow> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Workflow> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Workflow> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Workflow> patchAsync(@Nonnull final Workflow sourceWorkflow) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Workflow> postAsync(@Nonnull final Workflow newWorkflow) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Workflow> putAsync(@Nonnull final Workflow newWorkflow) {
