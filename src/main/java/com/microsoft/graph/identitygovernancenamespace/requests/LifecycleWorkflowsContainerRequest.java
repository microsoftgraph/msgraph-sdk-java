...
public class LifecycleWorkflowsContainerRequest extends BaseRequest<LifecycleWorkflowsContainer> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> patchAsync(@Nonnull final LifecycleWorkflowsContainer sourceLifecycleWorkflowsContainer) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> postAsync(@Nonnull final LifecycleWorkflowsContainer newLifecycleWorkflowsContainer) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> putAsync(@Nonnull final LifecycleWorkflowsContainer newLifecycleWorkflowsContainer) {
