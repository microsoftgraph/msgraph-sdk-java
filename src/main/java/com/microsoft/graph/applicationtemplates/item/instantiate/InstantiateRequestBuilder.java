...
public class InstantiateRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final InstantiatePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ApplicationServicePrincipal> post(@javax.annotation.Nonnull final InstantiatePostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ApplicationServicePrincipal> executionException = new java.util.concurrent.CompletableFuture<ApplicationServicePrincipal>();
