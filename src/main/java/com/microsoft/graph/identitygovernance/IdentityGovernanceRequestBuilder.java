...
public class IdentityGovernanceRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final IdentityGovernance body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IdentityGovernance> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityGovernance> executionException = new java.util.concurrent.CompletableFuture<IdentityGovernance>();
