...
public class AppConsentRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AppConsentApprovalRoute body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AppConsentApprovalRoute> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppConsentApprovalRoute> executionException = new java.util.concurrent.CompletableFuture<AppConsentApprovalRoute>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
