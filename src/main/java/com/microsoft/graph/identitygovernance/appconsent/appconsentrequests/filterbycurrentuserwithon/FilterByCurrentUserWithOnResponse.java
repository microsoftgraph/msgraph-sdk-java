package microsoft.graph.identitygovernance.appconsent.appconsentrequests.filterbycurrentuserwithon;
...
public class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable {
    ...
    /** The value property */
    private java.util.List<AppConsentRequest> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(AppConsentRequest::createFromDiscriminatorValue)); });
        }};
    }
    /**
