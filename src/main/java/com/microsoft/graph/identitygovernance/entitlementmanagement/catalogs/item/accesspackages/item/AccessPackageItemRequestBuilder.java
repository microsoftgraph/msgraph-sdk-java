...
public class AccessPackageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.entitlementManagement.catalogs.item.accessPackages.item.accessPackagesIncompatibleWith.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.entitlementManagement.catalogs.item.accessPackages.item.assignmentPolicies.item collection
     * @param id Unique identifier of the item
