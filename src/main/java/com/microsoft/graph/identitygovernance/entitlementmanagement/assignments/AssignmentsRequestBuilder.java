...
public class AssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageAssignmentCollectionResponse>();
