...
public class ConnectedOrganizationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ConnectedOrganization body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ConnectedOrganizationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConnectedOrganizationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConnectedOrganizationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ConnectedOrganization> post(@javax.annotation.Nonnull final ConnectedOrganization body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConnectedOrganization> executionException = new java.util.concurrent.CompletableFuture<ConnectedOrganization>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
