...
public class AccessPackageQuestionItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public AccessPackageQuestion get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public AccessPackageQuestion patch(@jakarta.annotation.Nonnull final AccessPackageQuestion body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AccessPackageQuestion patch(@jakarta.annotation.Nonnull final AccessPackageQuestion body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
