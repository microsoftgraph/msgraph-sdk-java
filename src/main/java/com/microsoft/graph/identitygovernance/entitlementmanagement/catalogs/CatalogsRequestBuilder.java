...
public class CatalogsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessPackageCatalog body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageCatalogCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageCatalogCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageCatalogCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageCatalog> post(@javax.annotation.Nonnull final AccessPackageCatalog body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageCatalog> executionException = new java.util.concurrent.CompletableFuture<AccessPackageCatalog>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
