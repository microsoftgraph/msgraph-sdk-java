...
import microsoft.graph.identitygovernance.entitlementmanagement.accesspackages.item.assignmentpolicies.AssignmentPoliciesRequestBuilder;
import microsoft.graph.identitygovernance.entitlementmanagement.accesspackages.item.assignmentpolicies.item.AccessPackageAssignmentPolicyItemRequestBuilder;
import microsoft.graph.identitygovernance.entitlementmanagement.accesspackages.item.catalog.CatalogRequestBuilder;
