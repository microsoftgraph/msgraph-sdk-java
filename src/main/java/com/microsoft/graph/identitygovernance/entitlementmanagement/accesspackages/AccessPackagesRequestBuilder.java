...
public class AccessPackagesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessPackage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessPackage> post(@javax.annotation.Nonnull final AccessPackage body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackage> executionException = new java.util.concurrent.CompletableFuture<AccessPackage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
