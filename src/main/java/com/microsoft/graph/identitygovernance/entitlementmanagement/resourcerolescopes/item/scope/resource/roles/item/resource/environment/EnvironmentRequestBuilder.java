package com.microsoft.graph.identitygovernance.entitlementmanagement.resourcerolescopes.item.scope.resource.roles.item.resource.environment;
...
public class EnvironmentRequestBuilder extends BaseRequestBuilder {
    ...
    public EnvironmentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource/roles/{accessPackageResourceRole%2Did}/resource/environment{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new EnvironmentRequestBuilder and sets the default values.
    ...
    public EnvironmentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource/roles/{accessPackageResourceRole%2Did}/resource/environment{?%24select,%24expand}", rawUrl);
    }
    /**
