...
public class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse> executionException = new java.util.concurrent.CompletableFuture<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse>();
