...
public class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function additionalAccess
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function additionalAccess
