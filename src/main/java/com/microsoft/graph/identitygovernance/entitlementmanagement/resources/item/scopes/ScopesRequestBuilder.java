package com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.scopes;

import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.scopes.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.entitlementmanagement.resources.item.scopes.item.AccessPackageResourceScopeItemRequestBuilder;
...
public class ScopesRequestBuilder extends BaseRequestBuilder {
    ...
    public ScopesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}/scopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ScopesRequestBuilder and sets the default values.
    ...
    public ScopesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}/scopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
