...
public class ResourceRequestsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public AccessPackageResourceRequestItemRequestBuilder byAccessPackageResourceRequestId(@javax.annotation.Nonnull final String accessPackageResourceRequestId) {
    ...
    public ResourceRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public ResourceRequestsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageResourceRequestCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AccessPackageResourceRequestCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageResourceRequestCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageResourceRequest> post(@javax.annotation.Nonnull final AccessPackageResourceRequest body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AccessPackageResourceRequest> executionException = new java.util.concurrent.CompletableFuture<AccessPackageResourceRequest>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AccessPackageResourceRequest body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AccessPackageResourceRequest body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
