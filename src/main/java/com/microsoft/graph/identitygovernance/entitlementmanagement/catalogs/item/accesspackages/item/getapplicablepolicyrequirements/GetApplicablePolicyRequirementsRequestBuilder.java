package com.microsoft.graph.identitygovernance.entitlementmanagement.catalogs.item.accesspackages.item.getapplicablepolicyrequirements;
...
public class GetApplicablePolicyRequirementsRequestBuilder extends BaseRequestBuilder {
    ...
    public GetApplicablePolicyRequirementsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}/getApplicablePolicyRequirements", pathParameters);
    }
    /**
     * Instantiates a new GetApplicablePolicyRequirementsRequestBuilder and sets the default values.
    ...
    public GetApplicablePolicyRequirementsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}/getApplicablePolicyRequirements", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<GetApplicablePolicyRequirementsResponse> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetApplicablePolicyRequirementsResponse> executionException = new java.util.concurrent.CompletableFuture<GetApplicablePolicyRequirementsResponse>();
