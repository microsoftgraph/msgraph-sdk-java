...
public class FilterByCurrentUserWithOnResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    private java.util.List<Approval> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(Approval::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<Approval> getValue() {
        return this._value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<Approval> value) {
        this._value = value;
    }
}
