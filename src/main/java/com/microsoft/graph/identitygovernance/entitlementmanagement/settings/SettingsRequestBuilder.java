...
public class SettingsRequestBuilder {
     ...
     * @return a CompletableFuture of entitlementManagementSettings
     */
    public java.util.concurrent.CompletableFuture<EntitlementManagementSettings> patch(@javax.annotation.Nonnull final EntitlementManagementSettings body, @javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of entitlementManagementSettings
     */
    public java.util.concurrent.CompletableFuture<EntitlementManagementSettings> patch(@javax.annotation.Nonnull final EntitlementManagementSettings body, @javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
