...
public class SettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EntitlementManagementSettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EntitlementManagementSettings> executionException = new java.util.concurrent.CompletableFuture<EntitlementManagementSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
