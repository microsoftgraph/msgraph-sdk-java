...
public class ApprovalStageItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ApprovalStage body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ApprovalStage> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ApprovalStage> executionException = new java.util.concurrent.CompletableFuture<ApprovalStage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
