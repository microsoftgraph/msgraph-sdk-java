...
public class DecisionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessReviewInstanceDecisionItem body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewInstanceDecisionItemCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewInstanceDecisionItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessReviewInstanceDecisionItemCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewInstanceDecisionItem> post(@javax.annotation.Nonnull final AccessReviewInstanceDecisionItem body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewInstanceDecisionItem> executionException = new java.util.concurrent.CompletableFuture<AccessReviewInstanceDecisionItem>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
