package microsoft.graph.identitygovernance.accessreviews.historydefinitions.item.instances.item.generatedownloaduri;
...
public class GenerateDownloadUriRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<GenerateDownloadUriRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final GenerateDownloadUriRequestBuilderPostRequestConfiguration requestConfig = new GenerateDownloadUriRequestBuilderPostRequestConfiguration();
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryInstance> post() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewHistoryInstance::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of accessReviewHistoryInstance
     */
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryInstance> post(@javax.annotation.Nullable final java.util.function.Consumer<GenerateDownloadUriRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of accessReviewHistoryInstance
     */
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryInstance> post(@javax.annotation.Nullable final java.util.function.Consumer<GenerateDownloadUriRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewHistoryInstance::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
