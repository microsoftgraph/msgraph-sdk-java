...
public class DefinitionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessReviewScheduleDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinitionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinitionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinitionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinition> post(@javax.annotation.Nonnull final AccessReviewScheduleDefinition body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinition> executionException = new java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
