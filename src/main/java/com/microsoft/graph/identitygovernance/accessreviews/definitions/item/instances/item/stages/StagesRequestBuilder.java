...
public class StagesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessReviewStage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewStageCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewStageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessReviewStageCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AccessReviewStageCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewStage> post(@javax.annotation.Nonnull final AccessReviewStage body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewStage> executionException = new java.util.concurrent.CompletableFuture<AccessReviewStage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AccessReviewStage> post(@javax.annotation.Nonnull final AccessReviewStage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
