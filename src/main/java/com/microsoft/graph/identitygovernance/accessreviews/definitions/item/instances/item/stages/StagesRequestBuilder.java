package microsoft.graph.identitygovernance.accessreviews.definitions.item.instances.item.stages;
...
import microsoft.graph.identitygovernance.accessreviews.definitions.item.instances.item.stages.count.CountRequestBuilder;
import microsoft.graph.identitygovernance.accessreviews.definitions.item.instances.item.stages.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import microsoft.graph.models.AccessReviewStage;
import microsoft.graph.models.AccessReviewStageCollectionResponse;
...
public class StagesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewStageCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewStageCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of AccessReviewStageCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<AccessReviewStageCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<StagesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewStageCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewStage> post(@javax.annotation.Nonnull final AccessReviewStage body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewStage::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of accessReviewStage
     */
    public java.util.concurrent.CompletableFuture<AccessReviewStage> post(@javax.annotation.Nonnull final AccessReviewStage body, @javax.annotation.Nullable final java.util.function.Consumer<StagesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewStage::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
