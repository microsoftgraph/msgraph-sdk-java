...
public class HistoryDefinitionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<HistoryDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final HistoryDefinitionsRequestBuilderGetRequestConfiguration requestConfig = new HistoryDefinitionsRequestBuilderGetRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessReviewHistoryDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<HistoryDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final HistoryDefinitionsRequestBuilderPostRequestConfiguration requestConfig = new HistoryDefinitionsRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinitionCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewHistoryDefinitionCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinitionCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<HistoryDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewHistoryDefinitionCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinition> post(@javax.annotation.Nonnull final AccessReviewHistoryDefinition body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewHistoryDefinition::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of accessReviewHistoryDefinition
     */
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinition> post(@javax.annotation.Nonnull final AccessReviewHistoryDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<HistoryDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessReviewHistoryDefinition::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
