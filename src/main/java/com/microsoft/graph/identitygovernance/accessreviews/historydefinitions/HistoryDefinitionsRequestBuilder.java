...
public class HistoryDefinitionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinitionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinitionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinitionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinition> post(@javax.annotation.Nonnull final AccessReviewHistoryDefinition body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinition> executionException = new java.util.concurrent.CompletableFuture<AccessReviewHistoryDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
