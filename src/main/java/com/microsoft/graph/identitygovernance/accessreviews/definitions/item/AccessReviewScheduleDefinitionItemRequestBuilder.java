...
public class AccessReviewScheduleDefinitionItemRequestBuilder {
     ...
     * @return a CompletableFuture of accessReviewScheduleDefinition
     */
    public java.util.concurrent.CompletableFuture<AccessReviewScheduleDefinition> patch(@javax.annotation.Nonnull final AccessReviewScheduleDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<AccessReviewScheduleDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
