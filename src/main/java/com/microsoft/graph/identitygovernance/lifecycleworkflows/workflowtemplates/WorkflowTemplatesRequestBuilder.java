...
public class WorkflowTemplatesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a WorkflowTemplateCollectionResponse
    ...
    public WorkflowTemplateCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, WorkflowTemplateCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of the workflowTemplate objects and their properties. This API is available in the following national cloud deployments.
