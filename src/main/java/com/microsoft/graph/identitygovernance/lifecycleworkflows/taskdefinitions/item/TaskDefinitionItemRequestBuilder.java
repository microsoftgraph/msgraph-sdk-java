package com.microsoft.graph.identitygovernance.lifecycleworkflows.taskdefinitions.item;
 ...
 */
public class TaskDefinitionItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public TaskDefinitionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/taskDefinitions/{taskDefinition%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TaskDefinitionItemRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public TaskDefinitionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/identitygovernance-taskdefinition-get?view=graph-rest-1.0">Find more info here</a>
     */
