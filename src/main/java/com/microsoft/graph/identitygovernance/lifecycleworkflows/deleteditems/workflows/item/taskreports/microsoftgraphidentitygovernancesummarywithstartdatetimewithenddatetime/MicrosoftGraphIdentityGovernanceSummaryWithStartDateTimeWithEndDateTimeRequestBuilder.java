package com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.taskreports.microsoftgraphidentitygovernancesummarywithstartdatetimewithenddatetime;
...
public class MicrosoftGraphIdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TaskReportSummary> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TaskReportSummary> executionException = new java.util.concurrent.CompletableFuture<TaskReportSummary>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TaskReportSummary> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
