package com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.runs.item.userprocessingresults.item.taskprocessingresults.item.subject.serviceprovisioningerrors;

import com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.runs.item.userprocessingresults.item.taskprocessingresults.item.subject.serviceprovisioningerrors.count.CountRequestBuilder;
