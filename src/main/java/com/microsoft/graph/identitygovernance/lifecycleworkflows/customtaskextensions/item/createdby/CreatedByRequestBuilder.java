...
public class CreatedByRequestBuilder extends BaseRequestBuilder {
    ...
    public CreatedByRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}/createdBy{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CreatedByRequestBuilder and sets the default values.
