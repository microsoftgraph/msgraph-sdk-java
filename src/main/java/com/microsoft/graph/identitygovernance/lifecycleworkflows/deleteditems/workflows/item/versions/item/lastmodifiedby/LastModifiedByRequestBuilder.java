...
public class LastModifiedByRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/versions/{workflowVersion%2DversionNumber}/lastModifiedBy{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new LastModifiedByRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public LastModifiedByRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
