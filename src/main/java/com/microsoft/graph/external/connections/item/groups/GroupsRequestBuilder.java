...
public class GroupsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ExternalGroupCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalGroupCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ExternalGroupCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ExternalGroup> post(@javax.annotation.Nonnull final ExternalGroup body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalGroup> executionException = new java.util.concurrent.CompletableFuture<ExternalGroup>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
