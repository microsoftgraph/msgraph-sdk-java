...
public class OperationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ConnectionOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ConnectionOperationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConnectionOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConnectionOperationCollectionResponse>();
