...
public class QueryRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a queryRequestBody
     */
    @javax.annotation.Nonnull
    public static QueryRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final QueryRequestBody currentObject = this;
