...
public class AgreementAcceptancesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AgreementAcceptanceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AgreementAcceptanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AgreementAcceptanceCollectionResponse>();
