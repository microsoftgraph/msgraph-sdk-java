package microsoft.graph.agreementacceptances;
...
public class AgreementAcceptancesRequestBuilder {
     ...
     * @return a void
     */
    public AgreementAcceptancesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public AgreementAcceptancesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/agreementAcceptances{?%24search,%24select}";
     ...
     * @return a CompletableFuture of AgreementAcceptanceCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<AgreementAcceptanceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<AgreementAcceptancesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of agreementAcceptance
     */
    public java.util.concurrent.CompletableFuture<AgreementAcceptance> post(@javax.annotation.Nonnull final AgreementAcceptance body, @javax.annotation.Nullable final java.util.function.Consumer<AgreementAcceptancesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
