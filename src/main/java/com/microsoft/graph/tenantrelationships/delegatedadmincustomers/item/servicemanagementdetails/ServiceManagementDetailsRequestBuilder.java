...
public class ServiceManagementDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceManagementDetailsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public ServiceManagementDetailsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/delegatedadmincustomer-list-servicemanagementdetails?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetailCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetailCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetailCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetailCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetail> post(@javax.annotation.Nonnull final DelegatedAdminServiceManagementDetail body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetail> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetail>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminServiceManagementDetail> post(@javax.annotation.Nonnull final DelegatedAdminServiceManagementDetail body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminServiceManagementDetail body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminServiceManagementDetail body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
