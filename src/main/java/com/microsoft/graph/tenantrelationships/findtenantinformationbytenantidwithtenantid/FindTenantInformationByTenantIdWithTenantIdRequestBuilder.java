...
public class FindTenantInformationByTenantIdWithTenantIdRequestBuilder extends BaseRequestBuilder {
    ...
    public FindTenantInformationByTenantIdWithTenantIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String tenantId) {
     ...
     */
    @javax.annotation.Nullable
    public FindTenantInformationByTenantIdWithTenantIdRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
