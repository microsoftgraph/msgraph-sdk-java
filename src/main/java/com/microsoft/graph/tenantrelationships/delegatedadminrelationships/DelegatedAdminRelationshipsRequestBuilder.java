package com.microsoft.graph.tenantrelationships.delegatedadminrelationships;
 ...
 */
public class DelegatedAdminRelationshipsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public DelegatedAdminRelationshipItemRequestBuilder byDelegatedAdminRelationshipId(@jakarta.annotation.Nonnull final String delegatedAdminRelationshipId) {
    ...
    public DelegatedAdminRelationshipsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminRelationships{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DelegatedAdminRelationshipsRequestBuilder and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public DelegatedAdminRelationshipsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DelegatedAdminRelationship body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DelegatedAdminRelationship body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
