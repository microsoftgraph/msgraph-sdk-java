...
public class OperationsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public DelegatedAdminRelationshipOperationItemRequestBuilder byDelegatedAdminRelationshipOperationId(@javax.annotation.Nonnull final String delegatedAdminRelationshipOperationId) {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperationCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> post(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> post(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
