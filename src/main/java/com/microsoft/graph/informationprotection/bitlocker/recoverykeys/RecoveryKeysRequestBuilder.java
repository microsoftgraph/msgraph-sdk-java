...
public class RecoveryKeysRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<BitlockerRecoveryKeyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BitlockerRecoveryKeyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BitlockerRecoveryKeyCollectionResponse>();
