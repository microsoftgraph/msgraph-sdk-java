...
public class ThreatAssessmentResultItemRequestBuilder {
     ...
     * @return a CompletableFuture of threatAssessmentResult
     */
    public java.util.concurrent.CompletableFuture<ThreatAssessmentResult> patch(@javax.annotation.Nonnull final ThreatAssessmentResult body, @javax.annotation.Nullable final java.util.function.Consumer<ThreatAssessmentResultItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
