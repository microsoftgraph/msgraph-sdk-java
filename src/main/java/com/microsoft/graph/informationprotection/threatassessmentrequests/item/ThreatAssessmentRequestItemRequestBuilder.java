...
public class ThreatAssessmentRequestItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ThreatAssessmentRequest body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ThreatAssessmentRequest> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ThreatAssessmentRequest> executionException = new java.util.concurrent.CompletableFuture<ThreatAssessmentRequest>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
