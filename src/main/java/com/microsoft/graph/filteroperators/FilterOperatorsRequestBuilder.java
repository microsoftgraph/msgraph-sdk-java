...
public class FilterOperatorsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public FilterOperatorSchemaItemRequestBuilder byFilterOperatorSchemaId(@javax.annotation.Nonnull final String filterOperatorSchemaId) {
    ...
    public FilterOperatorsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public FilterOperatorsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<FilterOperatorSchemaCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<FilterOperatorSchemaCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<FilterOperatorSchemaCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FilterOperatorSchema> post(@javax.annotation.Nonnull final FilterOperatorSchema body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<FilterOperatorSchema> executionException = new java.util.concurrent.CompletableFuture<FilterOperatorSchema>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FilterOperatorSchema> post(@javax.annotation.Nonnull final FilterOperatorSchema body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final FilterOperatorSchema body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final FilterOperatorSchema body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
