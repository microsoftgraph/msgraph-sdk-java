package microsoft.graph.groups.item.threads.item.posts.item.extensions;
...
import microsoft.graph.groups.item.threads.item.posts.item.extensions.count.CountRequestBuilder;
