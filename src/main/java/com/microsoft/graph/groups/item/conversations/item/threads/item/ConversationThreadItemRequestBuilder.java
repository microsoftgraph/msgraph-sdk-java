package microsoft.graph.groups.item.conversations.item.threads.item;
...
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.PostItemRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.PostsRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.reply.ReplyRequestBuilder;
