 ...
 */
public class CreatedOnBehalfOfRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public CreatedOnBehalfOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/createdOnBehalfOf{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CreatedOnBehalfOfRequestBuilder and sets the default values.
    ...
    public CreatedOnBehalfOfRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/createdOnBehalfOf{?%24select,%24expand}", rawUrl);
    }
    /**
