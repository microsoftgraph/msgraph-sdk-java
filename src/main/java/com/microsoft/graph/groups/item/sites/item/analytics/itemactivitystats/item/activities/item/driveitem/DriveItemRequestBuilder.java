package com.microsoft.graph.groups.item.sites.item.analytics.itemactivitystats.item.activities.item.driveitem;

import com.microsoft.graph.groups.item.sites.item.analytics.itemactivitystats.item.activities.item.driveitem.content.ContentRequestBuilder;
