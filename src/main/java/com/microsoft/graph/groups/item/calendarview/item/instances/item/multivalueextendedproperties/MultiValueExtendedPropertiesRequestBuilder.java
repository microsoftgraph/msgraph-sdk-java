package microsoft.graph.groups.item.calendarview.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.groups.item.calendarview.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
