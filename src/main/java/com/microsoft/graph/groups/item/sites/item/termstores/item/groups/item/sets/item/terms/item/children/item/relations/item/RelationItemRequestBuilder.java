package microsoft.graph.groups.item.sites.item.termstores.item.groups.item.sets.item.terms.item.children.item.relations.item;
...
import microsoft.graph.groups.item.sites.item.termstores.item.groups.item.sets.item.terms.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.groups.item.sets.item.terms.item.children.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.groups.item.sets.item.terms.item.children.item.relations.item.toterm.ToTermRequestBuilder;
