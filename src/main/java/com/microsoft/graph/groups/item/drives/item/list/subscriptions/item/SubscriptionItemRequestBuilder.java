package microsoft.graph.groups.item.drives.item.list.subscriptions.item;
...
import microsoft.graph.groups.item.drives.item.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
