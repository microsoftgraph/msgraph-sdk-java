package com.microsoft.graph.groups.item.drives.item.list.subscriptions.item;

import com.microsoft.graph.groups.item.drives.item.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
