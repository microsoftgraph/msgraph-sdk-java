package com.microsoft.graph.groups.item.memberswithlicenseerrors.graphserviceprincipal;

import com.microsoft.graph.groups.item.memberswithlicenseerrors.graphserviceprincipal.count.CountRequestBuilder;
