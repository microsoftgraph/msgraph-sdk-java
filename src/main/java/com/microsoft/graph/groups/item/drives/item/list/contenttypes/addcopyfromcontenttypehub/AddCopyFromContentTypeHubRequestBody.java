...
public class AddCopyFromContentTypeHubRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a addCopyFromContentTypeHubRequestBody
     */
    @javax.annotation.Nonnull
    public static AddCopyFromContentTypeHubRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AddCopyFromContentTypeHubRequestBody currentObject = this;
