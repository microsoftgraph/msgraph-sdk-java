package microsoft.graph.groups.item.threads.item.posts.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.threads.item.posts.item.singlevalueextendedproperties.count.CountRequestBuilder;
