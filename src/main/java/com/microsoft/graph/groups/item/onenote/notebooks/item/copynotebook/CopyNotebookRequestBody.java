package microsoft.graph.groups.item.onenote.notebooks.item.copynotebook;
...
public class CopyNotebookRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a copyNotebookRequestBody
     */
    @javax.annotation.Nonnull
    public static CopyNotebookRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CopyNotebookRequestBody currentObject = this;
