...
public class RemoveRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RemovePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RemoveResponse> post(@javax.annotation.Nonnull final RemovePostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RemoveResponse> executionException = new java.util.concurrent.CompletableFuture<RemoveResponse>();
