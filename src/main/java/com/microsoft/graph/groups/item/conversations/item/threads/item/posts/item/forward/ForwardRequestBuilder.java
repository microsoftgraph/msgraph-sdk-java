...
public class ForwardRequestBuilder extends BaseRequestBuilder {
    ...
    public ForwardRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/forward", pathParameters);
    }
    /**
     * Instantiates a new ForwardRequestBuilder and sets the default values.
    ...
    public ForwardRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/forward", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/post-forward?view=graph-rest-1.0">Find more info here</a>
     */
