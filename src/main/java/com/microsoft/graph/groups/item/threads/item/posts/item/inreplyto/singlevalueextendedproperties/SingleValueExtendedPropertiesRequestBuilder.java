package microsoft.graph.groups.item.threads.item.posts.item.inreplyto.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.threads.item.posts.item.inreplyto.singlevalueextendedproperties.count.CountRequestBuilder;
