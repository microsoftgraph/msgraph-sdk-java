package microsoft.graph.groups.item.drives.item.items.item.subscriptions.item;
...
import microsoft.graph.groups.item.drives.item.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
