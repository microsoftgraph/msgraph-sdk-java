...
public class PlannerRequestBuilder {
     ...
     * @return a CompletableFuture of plannerGroup
     */
    public java.util.concurrent.CompletableFuture<PlannerGroup> patch(@javax.annotation.Nonnull final PlannerGroup body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of plannerGroup
     */
    public java.util.concurrent.CompletableFuture<PlannerGroup> patch(@javax.annotation.Nonnull final PlannerGroup body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
