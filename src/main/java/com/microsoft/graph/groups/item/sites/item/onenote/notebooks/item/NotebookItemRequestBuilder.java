package microsoft.graph.groups.item.sites.item.onenote.notebooks.item;
...
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.copynotebook.CopyNotebookRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sections.SectionsRequestBuilder;
