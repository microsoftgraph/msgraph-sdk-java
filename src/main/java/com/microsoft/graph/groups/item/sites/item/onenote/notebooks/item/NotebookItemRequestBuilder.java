...
import com.microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sections.item.OnenoteSectionItemRequestBuilder;
...
public class NotebookItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
