package microsoft.graph.groups.item.memberof.item.group;
...
import microsoft.graph.groups.item.memberof.item.group.addfavorite.AddFavoriteRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.checkgrantedpermissionsforapp.CheckGrantedPermissionsForAppRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.removefavorite.RemoveFavoriteRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.renew.RenewRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.resetunseencount.ResetUnseenCountRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.restore.RestoreRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.subscribebymail.SubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.unsubscribebymail.UnsubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.memberof.item.group.validateproperties.ValidatePropertiesRequestBuilder;
