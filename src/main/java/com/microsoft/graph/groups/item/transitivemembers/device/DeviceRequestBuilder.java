package com.microsoft.graph.groups.item.transitivemembers.device;

import com.microsoft.graph.groups.item.transitivemembers.device.count.CountRequestBuilder;
