...
import com.microsoft.graph.groups.item.transitivemembers.item.application.ApplicationRequestBuilder;
import com.microsoft.graph.groups.item.transitivemembers.item.device.DeviceRequestBuilder;
import com.microsoft.graph.groups.item.transitivemembers.item.group.GroupRequestBuilder;
import com.microsoft.graph.groups.item.transitivemembers.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.groups.item.transitivemembers.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.groups.item.transitivemembers.item.user.UserRequestBuilder;
