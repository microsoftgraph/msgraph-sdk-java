package microsoft.graph.groups.item.transitivemembers.item;
...
import microsoft.graph.groups.item.transitivemembers.item.application.ApplicationRequestBuilder;
import microsoft.graph.groups.item.transitivemembers.item.device.DeviceRequestBuilder;
import microsoft.graph.groups.item.transitivemembers.item.group.GroupRequestBuilder;
import microsoft.graph.groups.item.transitivemembers.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.groups.item.transitivemembers.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.groups.item.transitivemembers.item.user.UserRequestBuilder;
