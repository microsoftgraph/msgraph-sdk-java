package microsoft.graph.groups.item.sites.item.lists.item.contenttypes;
...
import microsoft.graph.groups.item.sites.item.lists.item.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.groups.item.sites.item.lists.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.groups.item.sites.item.lists.item.contenttypes.count.CountRequestBuilder;
import microsoft.graph.groups.item.sites.item.lists.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
