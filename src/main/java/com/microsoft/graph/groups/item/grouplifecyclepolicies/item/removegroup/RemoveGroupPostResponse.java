...
public class RemoveGroupPostResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static RemoveGroupPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
