package microsoft.graph.groups.item.drives.item.root.subscriptions;
...
import microsoft.graph.groups.item.drives.item.root.subscriptions.count.CountRequestBuilder;
