package com.microsoft.graph.groups.item.drives.item.root.subscriptions;

import com.microsoft.graph.groups.item.drives.item.root.subscriptions.count.CountRequestBuilder;
