package microsoft.graph.groups.item.drives.item.root.versions.item;
...
import microsoft.graph.groups.item.drives.item.root.versions.item.content.ContentRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.versions.item.restoreversion.RestoreVersionRequestBuilder;
