package microsoft.graph.groups.item.sites.item.lists.item.items.item.driveitem;
...
import microsoft.graph.groups.item.sites.item.lists.item.items.item.driveitem.content.ContentRequestBuilder;
