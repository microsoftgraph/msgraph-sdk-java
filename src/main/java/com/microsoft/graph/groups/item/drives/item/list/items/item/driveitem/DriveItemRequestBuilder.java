package microsoft.graph.groups.item.drives.item.list.items.item.driveitem;
...
import microsoft.graph.groups.item.drives.item.list.items.item.driveitem.content.ContentRequestBuilder;
