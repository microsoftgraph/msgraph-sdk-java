package com.microsoft.graph.groups.item.drives.item.list.items.item.driveitem;

import com.microsoft.graph.groups.item.drives.item.list.items.item.driveitem.content.ContentRequestBuilder;
