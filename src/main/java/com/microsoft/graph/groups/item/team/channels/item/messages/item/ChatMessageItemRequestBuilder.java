package com.microsoft.graph.groups.item.team.channels.item.messages.item;

import com.microsoft.graph.groups.item.team.channels.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
...
import com.microsoft.graph.groups.item.team.channels.item.messages.item.replies.RepliesRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.team.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.team.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
