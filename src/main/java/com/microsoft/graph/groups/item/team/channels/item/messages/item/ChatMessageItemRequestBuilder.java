...
import com.microsoft.graph.groups.item.team.channels.item.messages.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.groups.item.team.channels.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.groups.item.team.channels.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.groups.item.team.channels.item.messages.item.unsetreaction.UnsetReactionRequestBuilder;
...
public class ChatMessageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ChatMessageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ChatMessageItemRequestBuilder and sets the default values.
    ...
    public ChatMessageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
