package microsoft.graph.groups.item.transitivemembers.item.group.assignlicense;
...
public class AssignLicenseRequestBuilder {
    ...
    public AssignLicenseRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.assignLicense";
    ...
    public java.util.concurrent.CompletableFuture<Group> post(@javax.annotation.Nonnull final AssignLicensePostRequestBody body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, Group::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of group
     */
    public java.util.concurrent.CompletableFuture<Group> post(@javax.annotation.Nonnull final AssignLicensePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<AssignLicenseRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, Group::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
