package microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.terms;
...
import microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.terms.count.CountRequestBuilder;
