package microsoft.graph.groups.item.calendar.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.singlevalueextendedproperties.count.CountRequestBuilder;
