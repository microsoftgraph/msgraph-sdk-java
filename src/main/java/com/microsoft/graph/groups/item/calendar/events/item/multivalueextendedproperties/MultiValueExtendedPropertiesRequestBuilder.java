package microsoft.graph.groups.item.calendar.events.item.multivalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.events.item.multivalueextendedproperties.count.CountRequestBuilder;
