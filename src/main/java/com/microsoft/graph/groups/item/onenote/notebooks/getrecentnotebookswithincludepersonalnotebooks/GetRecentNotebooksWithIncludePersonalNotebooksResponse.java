package microsoft.graph.groups.item.onenote.notebooks.getrecentnotebookswithincludepersonalnotebooks;
...
import microsoft.graph.models.RecentNotebook;
/** Provides operations to call the getRecentNotebooks method.  */
public class GetRecentNotebooksWithIncludePersonalNotebooksResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private Map<String, Object> _additionalData;
    /** The value property  */
    private java.util.List<RecentNotebook> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetRecentNotebooksWithIncludePersonalNotebooksResponse currentObject = this;
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(RecentNotebook::createFromDiscriminatorValue)); });
        }};
    }
    /**
