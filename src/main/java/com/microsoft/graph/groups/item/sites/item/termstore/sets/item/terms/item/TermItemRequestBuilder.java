package microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item;
...
import microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.children.ChildrenRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.relations.RelationsRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.set.SetRequestBuilder;
