...
import com.microsoft.graph.groups.item.owners.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.groups.item.owners.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.groups.item.owners.graphgroup.GraphGroupRequestBuilder;
...
public class OwnersRequestBuilder extends BaseRequestBuilder {
    ...
    public OwnersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OwnersRequestBuilder and sets the default values.
    ...
    public OwnersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
