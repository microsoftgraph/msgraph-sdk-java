...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStores.item.groups.item.sets.item.children.item.children.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStores.item.groups.item.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
