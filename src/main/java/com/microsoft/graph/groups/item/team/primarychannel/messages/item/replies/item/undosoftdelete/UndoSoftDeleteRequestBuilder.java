package com.microsoft.graph.groups.item.team.primarychannel.messages.item.replies.item.undosoftdelete;
...
public class UndoSoftDeleteRequestBuilder extends BaseRequestBuilder {
    ...
    public UndoSoftDeleteRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/undoSoftDelete", pathParameters);
    }
    /**
     * Instantiates a new UndoSoftDeleteRequestBuilder and sets the default values.
