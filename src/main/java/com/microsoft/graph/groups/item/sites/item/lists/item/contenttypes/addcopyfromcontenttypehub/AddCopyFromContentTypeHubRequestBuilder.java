package com.microsoft.graph.groups.item.sites.item.lists.item.contenttypes.addcopyfromcontenttypehub;
...
public class AddCopyFromContentTypeHubRequestBuilder extends BaseRequestBuilder {
    ...
    public AddCopyFromContentTypeHubRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/addCopyFromContentTypeHub", pathParameters);
    }
    /**
     * Instantiates a new AddCopyFromContentTypeHubRequestBuilder and sets the default values.
