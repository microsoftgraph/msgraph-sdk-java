package microsoft.graph.groups.item.drives.item.root.subscriptions.item;
...
import microsoft.graph.groups.item.drives.item.root.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
