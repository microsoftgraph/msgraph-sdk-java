package microsoft.graph.groups.item.team.primarychannel.tabs.item;
...
import microsoft.graph.groups.item.team.primarychannel.tabs.item.teamsapp.TeamsAppRequestBuilder;
