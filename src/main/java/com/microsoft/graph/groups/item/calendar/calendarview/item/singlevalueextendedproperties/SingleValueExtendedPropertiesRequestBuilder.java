package microsoft.graph.groups.item.calendar.calendarview.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.calendarview.item.singlevalueextendedproperties.count.CountRequestBuilder;
