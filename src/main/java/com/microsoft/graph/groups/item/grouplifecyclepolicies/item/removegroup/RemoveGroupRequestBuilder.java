...
public class RemoveGroupRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RemoveGroupPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RemoveGroupResponse> post(@javax.annotation.Nonnull final RemoveGroupPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RemoveGroupResponse> executionException = new java.util.concurrent.CompletableFuture<RemoveGroupResponse>();
