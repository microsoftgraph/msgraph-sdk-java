package microsoft.graph.groups.item.drives.item.root;
...
import microsoft.graph.groups.item.drives.item.root.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.root.children.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.root.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.root.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.root.versions.item collection
     * @param id Unique identifier of the item
