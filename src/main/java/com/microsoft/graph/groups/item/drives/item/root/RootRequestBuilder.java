package com.microsoft.graph.groups.item.drives.item.root;

import com.microsoft.graph.groups.item.drives.item.root.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.checkin.CheckinRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.checkout.CheckoutRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.children.ChildrenRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.children.item.DriveItemItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.content.ContentRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.copy.CopyRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.createlink.CreateLinkRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.delta.DeltaRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.deltawithtoken.DeltaWithTokenRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.follow.FollowRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.invite.InviteRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.ListItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.permissions.item.PermissionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.preview.PreviewRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.restore.RestoreRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.searchwithq.SearchWithQRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.subscriptions.item.SubscriptionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.subscriptions.SubscriptionsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.thumbnails.item.ThumbnailSetItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.thumbnails.ThumbnailsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.unfollow.UnfollowRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.validatepermission.ValidatePermissionRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.versions.item.DriveItemVersionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.versions.VersionsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.children.item collection
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<RootRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of driveItem
     */
    public java.util.concurrent.CompletableFuture<DriveItem> get(@javax.annotation.Nullable final java.util.function.Consumer<RootRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DriveItem body, @javax.annotation.Nullable final java.util.function.Consumer<RootRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DriveItem body, @javax.annotation.Nullable final java.util.function.Consumer<RootRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.versions.item collection
     * @param id Unique identifier of the item
