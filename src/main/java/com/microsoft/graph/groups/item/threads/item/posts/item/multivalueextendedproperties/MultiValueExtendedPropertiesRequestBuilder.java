package microsoft.graph.groups.item.threads.item.posts.item.multivalueextendedproperties;
...
import microsoft.graph.groups.item.threads.item.posts.item.multivalueextendedproperties.count.CountRequestBuilder;
