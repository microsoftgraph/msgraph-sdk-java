package com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item;

import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.relations.item.RelationItemRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStore.sets.item.parentGroup.sets.item.terms.item.children.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStore.sets.item.parentGroup.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
