package microsoft.graph.groups.item.conversations.item.threads.item.posts.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.singlevalueextendedproperties.count.CountRequestBuilder;
