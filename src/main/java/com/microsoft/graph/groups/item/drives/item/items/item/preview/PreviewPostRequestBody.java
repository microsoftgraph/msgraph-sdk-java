package com.microsoft.graph.groups.item.drives.item.items.item.preview;
...
public class PreviewPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("page", (n) -> { currentObject.setPage(n.getStringValue()); });
        deserializerMap.put("zoom", (n) -> { currentObject.setZoom(n.getDoubleValue()); });
