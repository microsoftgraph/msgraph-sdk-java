package microsoft.graph.groups.item.events.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.events.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
