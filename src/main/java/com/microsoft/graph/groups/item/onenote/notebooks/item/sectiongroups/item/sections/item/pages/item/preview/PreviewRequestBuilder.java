package microsoft.graph.groups.item.onenote.notebooks.item.sectiongroups.item.sections.item.pages.item.preview;
...
import microsoft.graph.models.OnenotePagePreview;
...
public class PreviewRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OnenotePagePreview> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OnenotePagePreview::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<OnenotePagePreview> get(@javax.annotation.Nullable final java.util.function.Consumer<PreviewRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OnenotePagePreview::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
