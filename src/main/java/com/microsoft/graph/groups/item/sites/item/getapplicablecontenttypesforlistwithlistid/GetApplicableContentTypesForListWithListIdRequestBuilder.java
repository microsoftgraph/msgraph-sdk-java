package microsoft.graph.groups.item.sites.item.getapplicablecontenttypesforlistwithlistid;
...
public class GetApplicableContentTypesForListWithListIdRequestBuilder {
     ...
     * @return a void
     */
    public GetApplicableContentTypesForListWithListIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String listId) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/microsoft.graph.getApplicableContentTypesForList(listId='{listId}')";
     ...
     * @return a void
     */
    public GetApplicableContentTypesForListWithListIdRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/microsoft.graph.getApplicableContentTypesForList(listId='{listId}')";
    ...
    public java.util.concurrent.CompletableFuture<GetApplicableContentTypesForListWithListIdResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetApplicableContentTypesForListWithListIdResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of getApplicableContentTypesForListWithListIdResponse
     */
    public java.util.concurrent.CompletableFuture<GetApplicableContentTypesForListWithListIdResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetApplicableContentTypesForListWithListIdRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetApplicableContentTypesForListWithListIdResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
