package microsoft.graph.groups.item.sites.item.contenttypes.item;
...
import microsoft.graph.groups.item.sites.item.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.base.BaseRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.basetypes.BaseTypesRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.columnlinks.ColumnLinksRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.columnlinks.item.ColumnLinkItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.columnpositions.ColumnPositionsRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.columns.ColumnsRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.copytodefaultcontentlocation.CopyToDefaultContentLocationRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.ispublished.IsPublishedRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.publish.PublishRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.contentTypes.item.baseTypes.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.contentTypes.item.columnLinks.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.contentTypes.item.columnPositions.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.groups.item.sites.item.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder columnPositions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.contentTypes.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.groups.item.sites.item.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
