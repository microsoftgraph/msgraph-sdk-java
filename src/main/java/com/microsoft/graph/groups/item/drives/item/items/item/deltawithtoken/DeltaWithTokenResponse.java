package com.microsoft.graph.groups.item.drives.item.items.item.deltawithtoken;
...
public class DeltaWithTokenResponse extends BaseDeltaFunctionResponse implements Parsable {
    /** The value property */
