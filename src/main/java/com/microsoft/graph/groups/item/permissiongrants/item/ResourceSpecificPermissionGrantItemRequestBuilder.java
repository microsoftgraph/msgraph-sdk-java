...
public class ResourceSpecificPermissionGrantItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ResourceSpecificPermissionGrant body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ResourceSpecificPermissionGrant> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ResourceSpecificPermissionGrant> executionException = new java.util.concurrent.CompletableFuture<ResourceSpecificPermissionGrant>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
