...
public class CopyToSectionRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a copyToSectionRequestBody
     */
    @javax.annotation.Nonnull
    public static CopyToSectionRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CopyToSectionRequestBody currentObject = this;
