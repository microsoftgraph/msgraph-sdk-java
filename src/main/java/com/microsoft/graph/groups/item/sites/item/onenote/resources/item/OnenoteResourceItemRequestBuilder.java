package microsoft.graph.groups.item.sites.item.onenote.resources.item;
...
import microsoft.graph.groups.item.sites.item.onenote.resources.item.content.ContentRequestBuilder;
