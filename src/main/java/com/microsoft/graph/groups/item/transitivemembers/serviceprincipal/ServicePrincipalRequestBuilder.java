package microsoft.graph.groups.item.transitivemembers.serviceprincipal;
...
import microsoft.graph.groups.item.transitivemembers.serviceprincipal.count.CountRequestBuilder;
