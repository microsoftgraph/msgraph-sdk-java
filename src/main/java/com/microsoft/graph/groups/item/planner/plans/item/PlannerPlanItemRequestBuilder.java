package microsoft.graph.groups.item.planner.plans.item;
...
import microsoft.graph.groups.item.planner.plans.item.buckets.BucketsRequestBuilder;
import microsoft.graph.groups.item.planner.plans.item.buckets.item.PlannerBucketItemRequestBuilder;
import microsoft.graph.groups.item.planner.plans.item.details.DetailsRequestBuilder;
import microsoft.graph.groups.item.planner.plans.item.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.groups.item.planner.plans.item.tasks.TasksRequestBuilder;
