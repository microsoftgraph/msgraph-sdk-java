package microsoft.graph.groups.item.team.channels.item.messages.item.replies;
...
import microsoft.graph.groups.item.team.channels.item.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.groups.item.team.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
