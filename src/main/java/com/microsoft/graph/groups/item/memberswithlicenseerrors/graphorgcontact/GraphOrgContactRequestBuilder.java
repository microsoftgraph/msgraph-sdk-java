package com.microsoft.graph.groups.item.memberswithlicenseerrors.graphorgcontact;

import com.microsoft.graph.groups.item.memberswithlicenseerrors.graphorgcontact.count.CountRequestBuilder;
...
public class GraphOrgContactRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphOrgContactRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphOrgContactRequestBuilder and sets the default values.
    ...
    public GraphOrgContactRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
