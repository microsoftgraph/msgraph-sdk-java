package com.microsoft.graph.groups.item.sites.item.termstores.item.sets.item.children.item.relations.item;

import com.microsoft.graph.groups.item.sites.item.termstores.item.sets.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstores.item.sets.item.children.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstores.item.sets.item.children.item.relations.item.toterm.ToTermRequestBuilder;
