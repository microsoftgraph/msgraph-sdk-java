package microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children;
...
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.count.CountRequestBuilder;
