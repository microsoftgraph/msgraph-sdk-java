package microsoft.graph.groups.item.calendarview.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.calendarview.item.singlevalueextendedproperties.count.CountRequestBuilder;
