package com.microsoft.graph.groups.item.memberswithlicenseerrors.serviceprincipal;

import com.microsoft.graph.groups.item.memberswithlicenseerrors.serviceprincipal.count.CountRequestBuilder;
