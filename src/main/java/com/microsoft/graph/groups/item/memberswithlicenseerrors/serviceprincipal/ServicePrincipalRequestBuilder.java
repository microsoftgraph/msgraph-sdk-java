package microsoft.graph.groups.item.memberswithlicenseerrors.serviceprincipal;
...
import microsoft.graph.groups.item.memberswithlicenseerrors.serviceprincipal.count.CountRequestBuilder;
