package microsoft.graph.groups.item.planner.plans.item.buckets.item;
...
import microsoft.graph.groups.item.planner.plans.item.buckets.item.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.groups.item.planner.plans.item.buckets.item.tasks.TasksRequestBuilder;
...
public class PlannerBucketItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.planner.plans.item.buckets.item.tasks.item collection
