...
public class RelationItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final Relation body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Relation> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<Relation> executionException = new java.util.concurrent.CompletableFuture<Relation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
