package com.microsoft.graph.groups.item.drives.item.root.deltawithtoken;
...
public class DeltaWithTokenRequestBuilder {
    ...
    public DeltaWithTokenRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String token) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/microsoft.graph.delta(token='{token}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
    ...
    public java.util.concurrent.CompletableFuture<DeltaWithTokenResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<DeltaWithTokenResponse>() {{
    ...
    public class DeltaWithTokenRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public DeltaWithTokenRequestBuilderGetQueryParameters queryParameters = new DeltaWithTokenRequestBuilderGetQueryParameters();
        /**
