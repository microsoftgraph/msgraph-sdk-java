...
public class DeltaWithTokenRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeltaWithTokenResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeltaWithTokenResponse> executionException = new java.util.concurrent.CompletableFuture<DeltaWithTokenResponse>();
