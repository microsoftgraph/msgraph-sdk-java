package microsoft.graph.groups.item.sites.item.lists.item.subscriptions;
...
import microsoft.graph.groups.item.sites.item.lists.item.subscriptions.count.CountRequestBuilder;
