...
public class TermItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final Term body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Term> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<Term> executionException = new java.util.concurrent.CompletableFuture<Term>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
