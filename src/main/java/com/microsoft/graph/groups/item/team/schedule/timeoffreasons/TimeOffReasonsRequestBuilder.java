...
public class TimeOffReasonsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TimeOffReason body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TimeOffReasonCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TimeOffReasonCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TimeOffReasonCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TimeOffReason> post(@javax.annotation.Nonnull final TimeOffReason body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TimeOffReason> executionException = new java.util.concurrent.CompletableFuture<TimeOffReason>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
