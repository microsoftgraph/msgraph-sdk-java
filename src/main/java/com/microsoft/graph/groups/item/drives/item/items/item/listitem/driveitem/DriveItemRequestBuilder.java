package microsoft.graph.groups.item.drives.item.items.item.listitem.driveitem;
...
import microsoft.graph.groups.item.drives.item.items.item.listitem.driveitem.content.ContentRequestBuilder;
