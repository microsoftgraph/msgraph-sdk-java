package microsoft.graph.groups.item.team.channels.item.tabs.item;
...
import microsoft.graph.groups.item.team.channels.item.tabs.item.teamsapp.TeamsAppRequestBuilder;
