package microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item;
...
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
