package com.microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item;

import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item.set.SetRequestBuilder;
