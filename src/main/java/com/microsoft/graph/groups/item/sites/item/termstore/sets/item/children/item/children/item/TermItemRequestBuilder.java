package microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item;
...
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.item.set.SetRequestBuilder;
