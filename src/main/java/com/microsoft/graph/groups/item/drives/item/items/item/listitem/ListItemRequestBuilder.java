package microsoft.graph.groups.item.drives.item.items.item.listitem;
...
import microsoft.graph.groups.item.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.items.item.listItem.documentSetVersions.item collection
