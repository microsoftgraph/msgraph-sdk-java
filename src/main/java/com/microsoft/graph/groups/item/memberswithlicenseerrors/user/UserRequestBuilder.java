package microsoft.graph.groups.item.memberswithlicenseerrors.user;
...
import microsoft.graph.groups.item.memberswithlicenseerrors.user.count.CountRequestBuilder;
