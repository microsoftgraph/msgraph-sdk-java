package microsoft.graph.groups.item.transitivememberof;
...
import microsoft.graph.groups.item.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.user.UserRequestBuilder;
