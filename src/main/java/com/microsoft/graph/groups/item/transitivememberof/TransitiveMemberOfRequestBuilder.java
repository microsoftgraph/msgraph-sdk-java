package com.microsoft.graph.groups.item.transitivememberof;

import com.microsoft.graph.groups.item.transitivememberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.groups.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.transitivememberof.device.DeviceRequestBuilder;
import com.microsoft.graph.groups.item.transitivememberof.group.GroupRequestBuilder;
import com.microsoft.graph.groups.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.groups.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.groups.item.transitivememberof.user.UserRequestBuilder;
