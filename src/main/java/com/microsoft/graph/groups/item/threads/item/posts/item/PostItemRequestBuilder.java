package com.microsoft.graph.groups.item.threads.item.posts.item;

import com.microsoft.graph.groups.item.threads.item.posts.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.attachments.item.AttachmentItemRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.inreplyto.InReplyToRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.reply.ReplyRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.groups.item.threads.item.posts.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class PostItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.threads.item.posts.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.threads.item.posts.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.threads.item.posts.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.threads.item.posts.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
