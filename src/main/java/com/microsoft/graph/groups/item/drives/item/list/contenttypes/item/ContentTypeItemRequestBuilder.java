package com.microsoft.graph.groups.item.drives.item.list.contenttypes.item;

import com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.base.BaseRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.basetypes.BaseTypesRequestBuilder;
...
import com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder;
...
import com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.publish.PublishRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder columnPositions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new com.microsoft.graph.groups.item.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
