package microsoft.graph.groups.item.rejectedsenders;
...
import microsoft.graph.groups.item.rejectedsenders.count.CountRequestBuilder;
import microsoft.graph.groups.item.rejectedsenders.ref.RefRequestBuilder;
