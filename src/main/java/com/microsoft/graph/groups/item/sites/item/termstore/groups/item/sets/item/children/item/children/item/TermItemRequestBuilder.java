package com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.children.item.children.item;

import com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.children.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStore.groups.item.sets.item.children.item.children.item.relations.item collection
