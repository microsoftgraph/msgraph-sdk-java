...
public class SchedulingGroupsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SchedulingGroup body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SchedulingGroupCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SchedulingGroupCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SchedulingGroupCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<SchedulingGroup> post(@javax.annotation.Nonnull final SchedulingGroup body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<SchedulingGroup> executionException = new java.util.concurrent.CompletableFuture<SchedulingGroup>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
