package microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item;
...
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.children.ChildrenRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.relations.RelationsRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.termStores.item.sets.item.terms.item.children.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.termStores.item.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
