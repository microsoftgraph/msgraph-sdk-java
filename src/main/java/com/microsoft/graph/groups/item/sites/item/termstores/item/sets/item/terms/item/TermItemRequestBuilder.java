...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStores.item.sets.item.terms.item.children.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.termStores.item.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
