package microsoft.graph.groups.item.sites.item.termstore.sets.item.terms;
...
import microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.count.CountRequestBuilder;
