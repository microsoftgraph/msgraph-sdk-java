...
public class CopyToSectionGroupRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a copyToSectionGroupRequestBody
     */
    @javax.annotation.Nonnull
    public static CopyToSectionGroupRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CopyToSectionGroupRequestBody currentObject = this;
