package com.microsoft.graph.groups.item.drives.item.items.item.invite;
...
public class InviteRequestBuilder {
    ...
    public InviteRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.invite";
    ...
    public java.util.concurrent.CompletableFuture<InviteResponse> post(@javax.annotation.Nonnull final InvitePostRequestBody body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, InviteResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of inviteResponse
     */
    public java.util.concurrent.CompletableFuture<InviteResponse> post(@javax.annotation.Nonnull final InvitePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<InviteRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of inviteResponse
     */
    public java.util.concurrent.CompletableFuture<InviteResponse> post(@javax.annotation.Nonnull final InvitePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<InviteRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, InviteResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
