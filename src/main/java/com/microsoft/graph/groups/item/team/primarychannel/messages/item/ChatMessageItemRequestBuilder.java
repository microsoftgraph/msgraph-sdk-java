...
import com.microsoft.graph.groups.item.team.primarychannel.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.team.primaryChannel.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.team.primaryChannel.messages.item.replies.item collection
     * @param id Unique identifier of the item
