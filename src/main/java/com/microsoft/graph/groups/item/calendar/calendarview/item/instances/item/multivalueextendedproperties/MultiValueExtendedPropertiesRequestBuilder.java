package microsoft.graph.groups.item.calendar.calendarview.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.calendarview.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
