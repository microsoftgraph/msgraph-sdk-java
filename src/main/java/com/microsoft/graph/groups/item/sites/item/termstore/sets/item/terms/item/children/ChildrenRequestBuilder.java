package microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.children;
...
import microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.children.count.CountRequestBuilder;
