package microsoft.graph.groups.item.onenote.sectiongroups.item;
...
import microsoft.graph.groups.item.onenote.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.groups.item.onenote.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import microsoft.graph.groups.item.onenote.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.groups.item.onenote.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.groups.item.onenote.sectiongroups.item.sections.SectionsRequestBuilder;
