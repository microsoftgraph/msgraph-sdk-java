package microsoft.graph.groups.item.calendarview.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.calendarview.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
