package com.microsoft.graph.groups.item.drives.item.list.operations;

import com.microsoft.graph.groups.item.drives.item.list.operations.count.CountRequestBuilder;
...
public class OperationsRequestBuilder {
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RichLongRunningOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RichLongRunningOperationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RichLongRunningOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RichLongRunningOperationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<RichLongRunningOperation> post(@javax.annotation.Nonnull final RichLongRunningOperation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RichLongRunningOperation> executionException = new java.util.concurrent.CompletableFuture<RichLongRunningOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
