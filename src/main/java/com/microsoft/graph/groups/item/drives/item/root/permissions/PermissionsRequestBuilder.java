package com.microsoft.graph.groups.item.drives.item.root.permissions;

import com.microsoft.graph.groups.item.drives.item.root.permissions.count.CountRequestBuilder;
