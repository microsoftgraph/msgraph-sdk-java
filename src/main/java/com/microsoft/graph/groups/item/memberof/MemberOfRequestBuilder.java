...
import com.microsoft.graph.groups.item.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.groups.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.groups.item.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.groups.item.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.groups.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.groups.item.memberof.user.UserRequestBuilder;
