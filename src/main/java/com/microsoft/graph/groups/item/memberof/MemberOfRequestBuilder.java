package microsoft.graph.groups.item.memberof;
...
import microsoft.graph.groups.item.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.groups.item.memberof.count.CountRequestBuilder;
import microsoft.graph.groups.item.memberof.device.DeviceRequestBuilder;
import microsoft.graph.groups.item.memberof.group.GroupRequestBuilder;
import microsoft.graph.groups.item.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.groups.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.groups.item.memberof.user.UserRequestBuilder;
