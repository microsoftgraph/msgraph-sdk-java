package microsoft.graph.groups.item.assignlicense;
...
public class AssignLicenseRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a assignLicenseRequestBody
     */
    @javax.annotation.Nonnull
    public static AssignLicenseRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AssignLicenseRequestBody currentObject = this;
