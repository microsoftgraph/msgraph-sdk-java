package com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item;

import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.pages.PagesRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
...
public class OnenoteSectionItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.sites.item.onenote.sectionGroups.item.sections.item.pages.item collection
