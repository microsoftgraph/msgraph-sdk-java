package microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item;
...
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.children.ChildrenRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.sets.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.termStore.sets.item.children.item.children.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.termStore.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
