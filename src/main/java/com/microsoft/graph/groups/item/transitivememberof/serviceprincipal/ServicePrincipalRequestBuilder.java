package com.microsoft.graph.groups.item.transitivememberof.serviceprincipal;

import com.microsoft.graph.groups.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
