package microsoft.graph.groups.item.transitivememberof.serviceprincipal;
...
import microsoft.graph.groups.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
