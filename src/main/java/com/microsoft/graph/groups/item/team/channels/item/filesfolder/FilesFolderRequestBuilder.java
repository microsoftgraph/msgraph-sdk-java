package microsoft.graph.groups.item.team.channels.item.filesfolder;
...
import microsoft.graph.groups.item.team.channels.item.filesfolder.content.ContentRequestBuilder;
