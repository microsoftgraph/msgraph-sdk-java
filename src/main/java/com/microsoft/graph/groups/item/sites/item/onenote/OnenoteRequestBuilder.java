package microsoft.graph.groups.item.sites.item.onenote;
...
import microsoft.graph.groups.item.sites.item.onenote.notebooks.item.NotebookItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.notebooks.NotebooksRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.operations.item.OnenoteOperationItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.operations.OperationsRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.pages.PagesRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.resources.item.OnenoteResourceItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.resources.ResourcesRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.SectionsRequestBuilder;
