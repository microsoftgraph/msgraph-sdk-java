package com.microsoft.graph.groups.item.drives.item.items.item;

import com.microsoft.graph.groups.item.drives.item.items.item.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.checkin.CheckinRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.checkout.CheckoutRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.content.ContentRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.copy.CopyRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.createlink.CreateLinkRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.delta.DeltaRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.deltawithtoken.DeltaWithTokenRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.follow.FollowRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.invite.InviteRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.listitem.ListItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.permissions.item.PermissionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.preview.PreviewRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.restore.RestoreRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.searchwithq.SearchWithQRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.subscriptions.item.SubscriptionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.subscriptions.SubscriptionsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.thumbnails.item.ThumbnailSetItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.thumbnails.ThumbnailsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.unfollow.UnfollowRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.validatepermission.ValidatePermissionRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.versions.item.DriveItemVersionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.versions.VersionsRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.items.item.children.item collection
     ...
     * @return a CompletableFuture of driveItem
     */
    public java.util.concurrent.CompletableFuture<DriveItem> patch(@javax.annotation.Nonnull final DriveItem body, @javax.annotation.Nullable final java.util.function.Consumer<DriveItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.items.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.items.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.items.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.items.item.versions.item collection
     * @param id Unique identifier of the item
