...
import microsoft.graph.groups.item.drives.item.items.item.checkin.CheckinRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.checkout.CheckoutRequestBuilder;
...
import microsoft.graph.groups.item.drives.item.items.item.copy.CopyRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.createlink.CreateLinkRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.createuploadsession.CreateUploadSessionRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.delta.DeltaRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.deltawithtoken.DeltaWithTokenRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.follow.FollowRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.invite.InviteRequestBuilder;
...
import microsoft.graph.groups.item.drives.item.items.item.preview.PreviewRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.restore.RestoreRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.searchwithq.SearchWithQRequestBuilder;
...
import microsoft.graph.groups.item.drives.item.items.item.unfollow.UnfollowRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.validatepermission.ValidatePermissionRequestBuilder;
