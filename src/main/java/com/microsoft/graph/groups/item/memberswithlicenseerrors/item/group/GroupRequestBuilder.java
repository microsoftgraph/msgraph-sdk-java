package microsoft.graph.groups.item.memberswithlicenseerrors.item.group;
...
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.addfavorite.AddFavoriteRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.checkgrantedpermissionsforapp.CheckGrantedPermissionsForAppRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.removefavorite.RemoveFavoriteRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.renew.RenewRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.resetunseencount.ResetUnseenCountRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.restore.RestoreRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.subscribebymail.SubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.unsubscribebymail.UnsubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.memberswithlicenseerrors.item.group.validateproperties.ValidatePropertiesRequestBuilder;
