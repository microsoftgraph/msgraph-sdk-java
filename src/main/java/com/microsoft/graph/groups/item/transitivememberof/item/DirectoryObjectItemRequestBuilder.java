package microsoft.graph.groups.item.transitivememberof.item;
...
import microsoft.graph.groups.item.transitivememberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.device.DeviceRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.GroupRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.user.UserRequestBuilder;
