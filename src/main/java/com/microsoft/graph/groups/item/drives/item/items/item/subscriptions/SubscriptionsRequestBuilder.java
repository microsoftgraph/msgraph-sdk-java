package com.microsoft.graph.groups.item.drives.item.items.item.subscriptions;

import com.microsoft.graph.groups.item.drives.item.items.item.subscriptions.count.CountRequestBuilder;
...
public class SubscriptionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Subscription body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SubscriptionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SubscriptionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SubscriptionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Subscription> post(@javax.annotation.Nonnull final Subscription body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Subscription> executionException = new java.util.concurrent.CompletableFuture<Subscription>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
