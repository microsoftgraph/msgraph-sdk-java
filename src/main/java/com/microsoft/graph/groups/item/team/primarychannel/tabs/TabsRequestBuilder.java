...
public class TabsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TeamsTab body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TeamsTabCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TeamsTabCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TeamsTabCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TeamsTab> post(@javax.annotation.Nonnull final TeamsTab body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TeamsTab> executionException = new java.util.concurrent.CompletableFuture<TeamsTab>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
