package microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item;
...
import microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item.toterm.ToTermRequestBuilder;
