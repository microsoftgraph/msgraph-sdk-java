package microsoft.graph.groups.item.onenote.notebooks;
...
import microsoft.graph.groups.item.onenote.notebooks.count.CountRequestBuilder;
import microsoft.graph.groups.item.onenote.notebooks.getnotebookfromweburl.GetNotebookFromWebUrlRequestBuilder;
import microsoft.graph.groups.item.onenote.notebooks.getrecentnotebookswithincludepersonalnotebooks.GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder;
