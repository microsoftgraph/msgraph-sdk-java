package com.microsoft.graph.groups.item.onenote.notebooks;

import com.microsoft.graph.groups.item.onenote.notebooks.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.onenote.notebooks.getnotebookfromweburl.GetNotebookFromWebUrlRequestBuilder;
import com.microsoft.graph.groups.item.onenote.notebooks.getrecentnotebookswithincludepersonalnotebooks.GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder;
