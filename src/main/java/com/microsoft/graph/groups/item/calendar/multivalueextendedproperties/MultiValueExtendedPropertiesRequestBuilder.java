package microsoft.graph.groups.item.calendar.multivalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.multivalueextendedproperties.count.CountRequestBuilder;
