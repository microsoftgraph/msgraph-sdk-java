...
public class OnenoteResourceItemRequestBuilder {
     ...
     * @return a CompletableFuture of onenoteResource
     */
    public java.util.concurrent.CompletableFuture<OnenoteResource> patch(@javax.annotation.Nonnull final OnenoteResource body, @javax.annotation.Nullable final java.util.function.Consumer<OnenoteResourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
