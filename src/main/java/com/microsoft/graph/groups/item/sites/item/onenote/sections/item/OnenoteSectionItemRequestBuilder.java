package microsoft.graph.groups.item.sites.item.onenote.sections.item;
...
import microsoft.graph.groups.item.sites.item.onenote.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.groups.item.sites.item.onenote.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
...
public class OnenoteSectionItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.onenote.sections.item.pages.item collection
