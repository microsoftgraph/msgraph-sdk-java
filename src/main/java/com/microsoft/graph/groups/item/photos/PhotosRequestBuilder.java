...
public class PhotosRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ProfilePhotoCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProfilePhotoCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ProfilePhotoCollectionResponse>();
