package microsoft.graph.groups.item.calendar.events.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
