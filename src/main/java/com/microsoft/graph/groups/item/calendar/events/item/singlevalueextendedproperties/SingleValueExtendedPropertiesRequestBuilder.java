package com.microsoft.graph.groups.item.calendar.events.item.singlevalueextendedproperties;

import com.microsoft.graph.groups.item.calendar.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
