...
public class NotebookItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
