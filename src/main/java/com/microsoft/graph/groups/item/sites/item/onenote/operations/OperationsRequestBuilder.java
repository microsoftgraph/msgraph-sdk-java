package microsoft.graph.groups.item.sites.item.onenote.operations;
...
import microsoft.graph.groups.item.sites.item.onenote.operations.count.CountRequestBuilder;
