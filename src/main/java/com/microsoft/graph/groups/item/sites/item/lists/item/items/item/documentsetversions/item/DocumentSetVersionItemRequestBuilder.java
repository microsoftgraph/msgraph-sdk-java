package com.microsoft.graph.groups.item.sites.item.lists.item.items.item.documentsetversions.item;

import com.microsoft.graph.groups.item.sites.item.lists.item.items.item.documentsetversions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.lists.item.items.item.documentsetversions.item.restore.RestoreRequestBuilder;
