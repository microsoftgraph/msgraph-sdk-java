package microsoft.graph.groups.item.sites.item.contenttypes;
...
import microsoft.graph.groups.item.sites.item.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.count.CountRequestBuilder;
import microsoft.graph.groups.item.sites.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
