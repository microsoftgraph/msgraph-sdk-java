package microsoft.graph.groups.item.drives.item.items.item.children.item;
...
import microsoft.graph.groups.item.drives.item.items.item.children.item.content.ContentRequestBuilder;
