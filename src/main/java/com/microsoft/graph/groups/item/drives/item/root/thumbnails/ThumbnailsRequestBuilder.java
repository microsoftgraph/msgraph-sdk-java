package com.microsoft.graph.groups.item.drives.item.root.thumbnails;

import com.microsoft.graph.groups.item.drives.item.root.thumbnails.count.CountRequestBuilder;
