package com.microsoft.graph.groups.item.transitivememberof.user;

import com.microsoft.graph.groups.item.transitivememberof.user.count.CountRequestBuilder;
