...
public class SettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GroupSettingCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupSettingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<GroupSettingCollectionResponse>();
