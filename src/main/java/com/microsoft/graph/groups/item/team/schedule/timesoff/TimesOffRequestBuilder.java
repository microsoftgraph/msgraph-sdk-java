package microsoft.graph.groups.item.team.schedule.timesoff;
...
import microsoft.graph.groups.item.team.schedule.timesoff.count.CountRequestBuilder;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.models.TimeOff;
import microsoft.graph.models.TimeOffCollectionResponse;
...
public class TimesOffRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<TimesOffRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final TimesOffRequestBuilderGetRequestConfiguration requestConfig = new TimesOffRequestBuilderGetRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TimeOff body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TimeOff body, @javax.annotation.Nullable final java.util.function.Consumer<TimesOffRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final TimesOffRequestBuilderPostRequestConfiguration requestConfig = new TimesOffRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<TimeOffCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TimeOffCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<TimeOffCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TimesOffRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TimeOffCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of timeOff
     */
    public java.util.concurrent.CompletableFuture<TimeOff> post(@javax.annotation.Nonnull final TimeOff body, @javax.annotation.Nullable final java.util.function.Consumer<TimesOffRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
