package com.microsoft.graph.groups.item.memberof.serviceprincipal;

import com.microsoft.graph.groups.item.memberof.serviceprincipal.count.CountRequestBuilder;
