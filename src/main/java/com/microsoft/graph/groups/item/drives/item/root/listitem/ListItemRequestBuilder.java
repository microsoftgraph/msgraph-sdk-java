package com.microsoft.graph.groups.item.drives.item.root.listitem;

import com.microsoft.graph.groups.item.drives.item.root.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.driveitem.DriveItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.fields.FieldsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.versions.item.ListItemVersionItemRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.root.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.drives.item.root.listItem.versions.item collection
     * @param id Unique identifier of the item
