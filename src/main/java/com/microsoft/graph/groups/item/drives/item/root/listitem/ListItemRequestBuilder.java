package microsoft.graph.groups.item.drives.item.root.listitem;
...
import microsoft.graph.groups.item.drives.item.root.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.root.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.root.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.root.listItem.versions.item collection
     * @param id Unique identifier of the item
