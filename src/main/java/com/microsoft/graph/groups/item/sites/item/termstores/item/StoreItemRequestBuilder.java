package microsoft.graph.groups.item.sites.item.termstores.item;
...
import microsoft.graph.groups.item.sites.item.termstores.item.groups.GroupsRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.groups.item.GroupItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.SetItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.SetsRequestBuilder;
