package microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.children.item;
...
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.item.children.item.set.SetRequestBuilder;
