...
public class CopyToDefaultContentLocationRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a copyToDefaultContentLocationRequestBody
     */
    @javax.annotation.Nonnull
    public static CopyToDefaultContentLocationRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CopyToDefaultContentLocationRequestBody currentObject = this;
