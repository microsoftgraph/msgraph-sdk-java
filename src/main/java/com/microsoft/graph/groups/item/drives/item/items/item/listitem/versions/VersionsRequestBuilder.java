...
public class VersionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ListItemVersion body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ListItemVersionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ListItemVersionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ListItemVersionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ListItemVersion> post(@javax.annotation.Nonnull final ListItemVersion body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ListItemVersion> executionException = new java.util.concurrent.CompletableFuture<ListItemVersion>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
