package microsoft.graph.groups.item.events.item.multivalueextendedproperties;
...
import microsoft.graph.groups.item.events.item.multivalueextendedproperties.count.CountRequestBuilder;
