package microsoft.graph.groups.item.transitivememberof.item.group;
...
import microsoft.graph.groups.item.transitivememberof.item.group.addfavorite.AddFavoriteRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.checkgrantedpermissionsforapp.CheckGrantedPermissionsForAppRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.removefavorite.RemoveFavoriteRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.renew.RenewRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.resetunseencount.ResetUnseenCountRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.restore.RestoreRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.subscribebymail.SubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.unsubscribebymail.UnsubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.transitivememberof.item.group.validateproperties.ValidatePropertiesRequestBuilder;
