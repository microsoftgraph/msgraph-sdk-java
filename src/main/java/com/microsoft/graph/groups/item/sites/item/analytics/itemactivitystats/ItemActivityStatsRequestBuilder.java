...
public class ItemActivityStatsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public ItemActivityStatItemRequestBuilder byItemActivityStatId(@javax.annotation.Nonnull final String itemActivityStatId) {
    ...
    public ItemActivityStatsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public ItemActivityStatsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ItemActivityStatCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ItemActivityStatCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ItemActivityStatCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ItemActivityStat> post(@javax.annotation.Nonnull final ItemActivityStat body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ItemActivityStat> post(@javax.annotation.Nonnull final ItemActivityStat body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ItemActivityStat body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ItemActivityStat body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
