package microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms;
...
import microsoft.graph.groups.item.sites.item.termstores.item.sets.item.terms.count.CountRequestBuilder;
