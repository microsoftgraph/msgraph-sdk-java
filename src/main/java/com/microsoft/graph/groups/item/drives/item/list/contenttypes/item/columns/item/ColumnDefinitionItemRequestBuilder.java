...
public class ColumnDefinitionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ColumnDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ColumnDefinition> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ColumnDefinition> executionException = new java.util.concurrent.CompletableFuture<ColumnDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
