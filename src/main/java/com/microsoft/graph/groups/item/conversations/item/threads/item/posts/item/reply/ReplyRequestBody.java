package microsoft.graph.groups.item.conversations.item.threads.item.posts.item.reply;
...
public class ReplyRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a replyRequestBody
     */
    @javax.annotation.Nonnull
    public static ReplyRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ReplyRequestBody currentObject = this;
