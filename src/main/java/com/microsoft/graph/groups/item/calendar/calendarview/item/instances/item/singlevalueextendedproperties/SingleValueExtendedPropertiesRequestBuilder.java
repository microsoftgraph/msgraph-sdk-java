package microsoft.graph.groups.item.calendar.calendarview.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.calendarview.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
