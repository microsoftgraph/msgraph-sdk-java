...
public class CheckGrantedPermissionsForAppRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CheckGrantedPermissionsForAppResponse> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CheckGrantedPermissionsForAppResponse> executionException = new java.util.concurrent.CompletableFuture<CheckGrantedPermissionsForAppResponse>();
