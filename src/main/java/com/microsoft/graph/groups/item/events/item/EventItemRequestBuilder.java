...
import com.microsoft.graph.groups.item.events.item.attachments.item.AttachmentItemRequestBuilder;
...
import com.microsoft.graph.groups.item.events.item.extensions.item.ExtensionItemRequestBuilder;
...
import com.microsoft.graph.groups.item.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.groups.item.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.groups.item.events.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.groups.item.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
