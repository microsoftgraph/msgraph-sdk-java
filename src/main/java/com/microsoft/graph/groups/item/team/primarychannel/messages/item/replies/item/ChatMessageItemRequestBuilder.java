package microsoft.graph.groups.item.team.primarychannel.messages.item.replies.item;
...
import microsoft.graph.groups.item.team.primarychannel.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.groups.item.team.primarychannel.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.team.primaryChannel.messages.item.replies.item.hostedContents.item collection
