...
public class ProvisionEmailRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ProvisionChannelEmailResult> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProvisionChannelEmailResult> executionException = new java.util.concurrent.CompletableFuture<ProvisionChannelEmailResult>();
