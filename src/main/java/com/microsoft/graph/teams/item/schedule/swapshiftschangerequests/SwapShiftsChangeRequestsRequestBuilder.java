package microsoft.graph.teams.item.schedule.swapshiftschangerequests;
...
import microsoft.graph.teams.item.schedule.swapshiftschangerequests.count.CountRequestBuilder;
