package microsoft.graph.teams.item.channels.item.messages.item.replies.item;
...
import microsoft.graph.teams.item.channels.item.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.teams.item.channels.item.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
