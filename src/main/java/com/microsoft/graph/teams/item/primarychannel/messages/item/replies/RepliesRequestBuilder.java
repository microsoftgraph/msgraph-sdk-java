package microsoft.graph.teams.item.primarychannel.messages.item.replies;
...
import microsoft.graph.teams.item.primarychannel.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.teams.item.primarychannel.messages.item.replies.delta.DeltaRequestBuilder;
