package microsoft.graph.teams.item.schedule.openshiftchangerequests;
...
import microsoft.graph.teams.item.schedule.openshiftchangerequests.count.CountRequestBuilder;
