package microsoft.graph.teams.item.installedapps.item;
...
import microsoft.graph.teams.item.installedapps.item.teamsapp.TeamsAppRequestBuilder;
import microsoft.graph.teams.item.installedapps.item.teamsappdefinition.TeamsAppDefinitionRequestBuilder;
import microsoft.graph.teams.item.installedapps.item.upgrade.UpgradeRequestBuilder;
