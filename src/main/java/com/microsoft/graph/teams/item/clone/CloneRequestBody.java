package microsoft.graph.teams.item.clone;
...
import microsoft.graph.models.ClonableTeamParts;
import microsoft.graph.models.TeamVisibilityType;
/** Provides operations to call the clone method. */
public class CloneRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a cloneRequestBody
     */
    @javax.annotation.Nonnull
    public static CloneRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CloneRequestBody currentObject = this;
