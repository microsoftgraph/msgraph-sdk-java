package com.microsoft.graph.teams.item.permissiongrants.item.checkmemberobjects;
...
public class CheckMemberObjectsResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static CheckMemberObjectsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
