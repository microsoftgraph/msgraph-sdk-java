...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teams.item.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teams.item.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
