package microsoft.graph.teams.item.channels.item.messages.item.replies;
...
import microsoft.graph.teams.item.channels.item.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.teams.item.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
