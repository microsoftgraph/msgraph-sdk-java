package microsoft.graph.teams.item.primarychannel.messages.item.replies.item;
...
import microsoft.graph.teams.item.primarychannel.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.teams.item.primarychannel.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.teams.item.primaryChannel.messages.item.replies.item.hostedContents.item collection
