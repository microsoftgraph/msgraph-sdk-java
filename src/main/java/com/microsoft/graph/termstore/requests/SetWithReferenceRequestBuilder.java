 ...
 */
public class SetWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<Set, SetWithReferenceRequest, SetReferenceRequestBuilder> {
     ...
     */
    public SetWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SetWithReferenceRequest.class, SetReferenceRequestBuilder.class);
    }
}
