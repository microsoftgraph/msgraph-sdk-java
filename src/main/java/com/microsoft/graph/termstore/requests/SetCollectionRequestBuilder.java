...
public class SetCollectionRequestBuilder extends BaseCollectionRequestBuilder<Set, SetRequestBuilder, SetCollectionResponse, SetCollectionPage, SetCollectionRequest> {
     ...
     */
    public SetCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SetRequestBuilder.class, SetCollectionRequest.class);
    }
