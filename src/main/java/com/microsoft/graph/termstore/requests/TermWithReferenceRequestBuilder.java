 ...
 */
public class TermWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<Term, TermWithReferenceRequest, TermReferenceRequestBuilder> {
     ...
     */
    public TermWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, TermWithReferenceRequest.class, TermReferenceRequestBuilder.class);
    }
}
