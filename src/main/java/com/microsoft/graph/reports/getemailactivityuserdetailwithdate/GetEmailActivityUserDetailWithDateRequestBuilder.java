...
public class GetEmailActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public GetEmailActivityUserDetailWithDateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final LocalDate date) {
        super(requestAdapter, "{+baseurl}/reports/getEmailActivityUserDetail(date={date})", pathParameters);
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetEmailActivityUserDetailWithDateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/getEmailActivityUserDetail(date={date})", rawUrl);
    }
    /**
