...
public class UsersRegisteredByFeatureRequestBuilder extends BaseRequestBuilder {
    ...
    public UsersRegisteredByFeatureRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public UsersRegisteredByFeatureRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
