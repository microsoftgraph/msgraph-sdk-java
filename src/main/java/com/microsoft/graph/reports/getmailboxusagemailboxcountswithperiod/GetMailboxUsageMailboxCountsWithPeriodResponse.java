...
public class GetMailboxUsageMailboxCountsWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getMailboxUsageMailboxCountsWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetMailboxUsageMailboxCountsWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMailboxUsageMailboxCountsWithPeriodResponse currentObject = this;
