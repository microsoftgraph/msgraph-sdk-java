...
public class GetTeamsUserActivityUserDetailWithPeriodRequestBuilder {
    ...
    /**
     * Invoke function getTeamsUserActivityUserDetail
     * @return a CompletableFuture of getTeamsUserActivityUserDetailWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetTeamsUserActivityUserDetailWithPeriodResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetTeamsUserActivityUserDetailWithPeriodResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getTeamsUserActivityUserDetailWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetTeamsUserActivityUserDetailWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetTeamsUserActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getTeamsUserActivityUserDetailWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetTeamsUserActivityUserDetailWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetTeamsUserActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetTeamsUserActivityUserDetailWithPeriodResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
