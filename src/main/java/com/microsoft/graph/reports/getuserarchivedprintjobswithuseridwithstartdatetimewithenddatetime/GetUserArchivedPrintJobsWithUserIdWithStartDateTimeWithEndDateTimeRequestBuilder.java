...
public class GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeResponse> executionException = new java.util.concurrent.CompletableFuture<GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
