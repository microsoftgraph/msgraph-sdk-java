...
public class GetEmailActivityCountsWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a void
     */
    public GetEmailActivityCountsWithPeriodResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getEmailActivityCountsWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetEmailActivityCountsWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetEmailActivityCountsWithPeriodResponse currentObject = this;
