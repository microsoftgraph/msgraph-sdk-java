...
public class GetEmailActivityCountsWithPeriodRequestBuilder {
    ...
    /**
     * Invoke function getEmailActivityCounts
     * @return a CompletableFuture of getEmailActivityCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetEmailActivityCountsWithPeriodResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetEmailActivityCountsWithPeriodResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getEmailActivityCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetEmailActivityCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetEmailActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getEmailActivityCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetEmailActivityCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetEmailActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetEmailActivityCountsWithPeriodResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
