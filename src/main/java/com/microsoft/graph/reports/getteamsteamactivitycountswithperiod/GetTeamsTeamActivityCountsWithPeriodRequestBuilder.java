package com.microsoft.graph.reports.getteamsteamactivitycountswithperiod;
...
public class GetTeamsTeamActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    public GetTeamsTeamActivityCountsWithPeriodRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String period) {
        super(requestAdapter, "{+baseurl}/reports/getTeamsTeamActivityCounts(period='{period}')", pathParameters);
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetTeamsTeamActivityCountsWithPeriodRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
