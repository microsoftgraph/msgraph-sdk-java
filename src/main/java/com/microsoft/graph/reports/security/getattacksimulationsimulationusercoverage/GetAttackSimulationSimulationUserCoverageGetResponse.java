...
public class GetAttackSimulationSimulationUserCoverageGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * The value property
     */
     ...
     */
    public GetAttackSimulationSimulationUserCoverageGetResponse() {
        super();
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a GetAttackSimulationSimulationUserCoverageGetResponse
     */
    @jakarta.annotation.Nonnull
    public static GetAttackSimulationSimulationUserCoverageGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
