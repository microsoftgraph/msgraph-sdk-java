...
public class GetAttackSimulationTrainingUserCoverageRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetAttackSimulationTrainingUserCoverageResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetAttackSimulationTrainingUserCoverageResponse> executionException = new java.util.concurrent.CompletableFuture<GetAttackSimulationTrainingUserCoverageResponse>();
