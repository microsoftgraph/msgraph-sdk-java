...
public class GetAttackSimulationRepeatOffendersRequestBuilder {
    ...
    public GetAttackSimulationRepeatOffendersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/reports/security/getAttackSimulationRepeatOffenders(){?%24top,%24skip,%24search,%24filter,%24count}";
    ...
    public java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse> executionException = new java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
