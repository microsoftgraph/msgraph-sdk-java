...
public class GetAttackSimulationRepeatOffendersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse> executionException = new java.util.concurrent.CompletableFuture<GetAttackSimulationRepeatOffendersResponse>();
