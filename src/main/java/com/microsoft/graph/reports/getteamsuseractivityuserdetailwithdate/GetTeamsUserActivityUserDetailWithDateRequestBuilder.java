package microsoft.graph.reports.getteamsuseractivityuserdetailwithdate;
...
public class GetTeamsUserActivityUserDetailWithDateRequestBuilder {
    ...
    /**
     * Invoke function getTeamsUserActivityUserDetail
     * @return a CompletableFuture of getTeamsUserActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetTeamsUserActivityUserDetailWithDateResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetTeamsUserActivityUserDetailWithDateResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getTeamsUserActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetTeamsUserActivityUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getTeamsUserActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetTeamsUserActivityUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetTeamsUserActivityUserDetailWithDateResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
