...
public class GetMailboxUsageStorageWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getMailboxUsageStorageWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetMailboxUsageStorageWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMailboxUsageStorageWithPeriodResponse currentObject = this;
