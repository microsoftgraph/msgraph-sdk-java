...
public class DailyPrintUsageByPrinterRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrintUsageByPrinterCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintUsageByPrinterCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrintUsageByPrinterCollectionResponse>();
