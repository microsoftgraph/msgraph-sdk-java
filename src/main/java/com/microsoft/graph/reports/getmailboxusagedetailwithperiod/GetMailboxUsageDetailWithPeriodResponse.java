package microsoft.graph.reports.getmailboxusagedetailwithperiod;
...
public class GetMailboxUsageDetailWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getMailboxUsageDetailWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetMailboxUsageDetailWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMailboxUsageDetailWithPeriodResponse currentObject = this;
