package microsoft.graph.applications.item.owners.serviceprincipal;
...
import microsoft.graph.applications.item.owners.serviceprincipal.count.CountRequestBuilder;
