...
public class SetVerifiedPublisherRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a setVerifiedPublisherRequestBody
     */
    @javax.annotation.Nonnull
    public static SetVerifiedPublisherRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SetVerifiedPublisherRequestBody currentObject = this;
