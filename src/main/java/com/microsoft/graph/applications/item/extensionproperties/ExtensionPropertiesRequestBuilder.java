package microsoft.graph.applications.item.extensionproperties;
...
import microsoft.graph.applications.item.extensionproperties.count.CountRequestBuilder;
import microsoft.graph.models.ExtensionProperty;
import microsoft.graph.models.ExtensionPropertyCollectionResponse;
...
public class ExtensionPropertiesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<ExtensionPropertiesRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ExtensionProperty body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ExtensionProperty body, @javax.annotation.Nullable final java.util.function.Consumer<ExtensionPropertiesRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ExtensionPropertyCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ExtensionPropertyCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<ExtensionPropertyCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ExtensionPropertiesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ExtensionPropertyCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<ExtensionProperty> post(@javax.annotation.Nonnull final ExtensionProperty body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ExtensionProperty::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of extensionProperty
     */
    public java.util.concurrent.CompletableFuture<ExtensionProperty> post(@javax.annotation.Nonnull final ExtensionProperty body, @javax.annotation.Nullable final java.util.function.Consumer<ExtensionPropertiesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, ExtensionProperty::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
