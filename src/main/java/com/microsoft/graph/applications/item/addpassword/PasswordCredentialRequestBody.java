package microsoft.graph.applications.item.addpassword;
...
public class PasswordCredentialRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a PasswordCredentialRequestBody
     */
    @javax.annotation.Nonnull
    public static PasswordCredentialRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PasswordCredentialRequestBody currentObject = this;
