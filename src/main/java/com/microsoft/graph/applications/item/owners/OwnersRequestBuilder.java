package microsoft.graph.applications.item.owners;
...
import microsoft.graph.applications.item.owners.approleassignment.AppRoleAssignmentRequestBuilder;
import microsoft.graph.applications.item.owners.count.CountRequestBuilder;
import microsoft.graph.applications.item.owners.endpoint.EndpointRequestBuilder;
import microsoft.graph.applications.item.owners.ref.RefRequestBuilder;
import microsoft.graph.applications.item.owners.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.applications.item.owners.user.UserRequestBuilder;
