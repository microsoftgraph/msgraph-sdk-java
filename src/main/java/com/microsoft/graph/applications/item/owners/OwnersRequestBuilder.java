package com.microsoft.graph.applications.item.owners;

import com.microsoft.graph.applications.item.owners.count.CountRequestBuilder;
import com.microsoft.graph.applications.item.owners.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.applications.item.owners.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.applications.item.owners.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.applications.item.owners.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.applications.item.owners.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.applications.item.owners.ref.RefRequestBuilder;
...
public class OwnersRequestBuilder extends BaseRequestBuilder {
    ...
    public OwnersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OwnersRequestBuilder and sets the default values.
    ...
    public OwnersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/application-list-owners?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
