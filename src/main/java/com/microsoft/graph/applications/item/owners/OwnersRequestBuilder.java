...
import com.microsoft.graph.applications.item.owners.approleassignment.AppRoleAssignmentRequestBuilder;
import com.microsoft.graph.applications.item.owners.count.CountRequestBuilder;
import com.microsoft.graph.applications.item.owners.endpoint.EndpointRequestBuilder;
import com.microsoft.graph.applications.item.owners.ref.RefRequestBuilder;
import com.microsoft.graph.applications.item.owners.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.applications.item.owners.user.UserRequestBuilder;
