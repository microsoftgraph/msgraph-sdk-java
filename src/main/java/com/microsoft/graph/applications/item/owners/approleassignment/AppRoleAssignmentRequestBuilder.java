package microsoft.graph.applications.item.owners.approleassignment;
...
import microsoft.graph.applications.item.owners.approleassignment.count.CountRequestBuilder;
