package com.microsoft.graph.applications.item.owners.approleassignment;

import com.microsoft.graph.applications.item.owners.approleassignment.count.CountRequestBuilder;
