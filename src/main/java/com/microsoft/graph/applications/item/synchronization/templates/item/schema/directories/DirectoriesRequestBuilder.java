package com.microsoft.graph.applications.item.synchronization.templates.item.schema.directories;

import com.microsoft.graph.applications.item.synchronization.templates.item.schema.directories.count.CountRequestBuilder;
import com.microsoft.graph.applications.item.synchronization.templates.item.schema.directories.item.DirectoryDefinitionItemRequestBuilder;
...
public class DirectoriesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DirectoryDefinition body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DirectoryDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
