package com.microsoft.graph.applications.item.owners.user;

import com.microsoft.graph.applications.item.owners.user.count.CountRequestBuilder;
...
public class UserRequestBuilder {
    ...
    public UserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/applications/{application%2Did}/owners/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
