package microsoft.graph.education.classes.item.assignments.item.submissions.item.outcomes;
...
import microsoft.graph.education.classes.item.assignments.item.submissions.item.outcomes.count.CountRequestBuilder;
