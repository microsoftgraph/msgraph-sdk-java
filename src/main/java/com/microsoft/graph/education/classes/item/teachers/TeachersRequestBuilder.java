...
public class TeachersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EducationUserCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationUserCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EducationUserCollectionResponse>();
