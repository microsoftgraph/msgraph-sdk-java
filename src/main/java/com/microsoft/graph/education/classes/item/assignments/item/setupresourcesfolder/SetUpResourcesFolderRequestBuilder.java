package microsoft.graph.education.classes.item.assignments.item.setupresourcesfolder;
...
public class SetUpResourcesFolderRequestBuilder {
     ...
     * @return a CompletableFuture of educationAssignment
     */
    public java.util.concurrent.CompletableFuture<EducationAssignment> post(@javax.annotation.Nullable final java.util.function.Consumer<SetUpResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of educationAssignment
     */
    public java.util.concurrent.CompletableFuture<EducationAssignment> post(@javax.annotation.Nullable final java.util.function.Consumer<SetUpResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
