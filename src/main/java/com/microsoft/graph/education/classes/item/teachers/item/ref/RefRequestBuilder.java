...
public class RefRequestBuilder extends BaseRequestBuilder {
    ...
    public RefRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/teachers/{educationUser%2Did}/$ref{?%40id*}", pathParameters);
    }
    /**
     * Instantiates a new RefRequestBuilder and sets the default values.
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/educationclass-delete-teachers?view=graph-rest-1.0">Find more info here</a>
     */
