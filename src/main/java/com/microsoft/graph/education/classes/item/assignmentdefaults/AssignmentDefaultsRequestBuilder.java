...
public class AssignmentDefaultsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EducationAssignmentDefaults> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationAssignmentDefaults> executionException = new java.util.concurrent.CompletableFuture<EducationAssignmentDefaults>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
