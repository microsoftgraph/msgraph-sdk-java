package com.microsoft.graph.education.classes.item.assignments.item.setupfeedbackresourcesfolder;
...
public class SetUpFeedbackResourcesFolderRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration requestConfig = new SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EducationAssignment> post(@javax.annotation.Nullable final java.util.function.Consumer<SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
