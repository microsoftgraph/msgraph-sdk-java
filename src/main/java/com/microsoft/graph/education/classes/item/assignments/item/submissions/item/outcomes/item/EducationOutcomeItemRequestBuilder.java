...
public class EducationOutcomeItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final EducationOutcome body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EducationOutcome> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationOutcome> executionException = new java.util.concurrent.CompletableFuture<EducationOutcome>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
