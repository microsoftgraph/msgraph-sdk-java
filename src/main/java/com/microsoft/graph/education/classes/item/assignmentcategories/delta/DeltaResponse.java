...
public class DeltaResponse extends BaseDeltaFunctionResponse implements Parsable {
    /** The value property */
    private java.util.List<EducationCategory> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(EducationCategory::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<EducationCategory> value) {
        this._value = value;
    }
}
