package microsoft.graph.education.me.assignments.item.submissions.item;
...
import microsoft.graph.education.me.assignments.item.submissions.item.outcomes.item.EducationOutcomeItemRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.outcomes.OutcomesRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.reassign.ReassignRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.resources.ResourcesRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.return_escaped.ReturnRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.setupresourcesfolder.SetUpResourcesFolderRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.submit.SubmitRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.submittedresources.SubmittedResourcesRequestBuilder;
import microsoft.graph.education.me.assignments.item.submissions.item.unsubmit.UnsubmitRequestBuilder;
...
public class EducationSubmissionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public microsoft.graph.education.me.assignments.item.submissions.item.resources.item.EducationSubmissionResourceItemRequestBuilder resources(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
     ...
     */
    @javax.annotation.Nonnull
    public microsoft.graph.education.me.assignments.item.submissions.item.submittedresources.item.EducationSubmissionResourceItemRequestBuilder submittedResources(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("educationSubmissionResource%2Did", id);
