package com.microsoft.graph.education.me.assignments.item.categories;

import com.microsoft.graph.education.me.assignments.item.categories.count.CountRequestBuilder;
import com.microsoft.graph.education.me.assignments.item.categories.delta.DeltaRequestBuilder;
import com.microsoft.graph.education.me.assignments.item.categories.ref.RefRequestBuilder;
...
public class CategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EducationCategoryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EducationCategoryCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of EducationCategoryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<EducationCategoryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, EducationCategoryCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of educationCategory
     */
    public java.util.concurrent.CompletableFuture<EducationCategory> post(@javax.annotation.Nonnull final EducationCategory body, @javax.annotation.Nullable final java.util.function.Consumer<CategoriesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
