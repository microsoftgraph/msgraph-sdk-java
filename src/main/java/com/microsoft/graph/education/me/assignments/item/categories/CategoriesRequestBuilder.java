...
public class CategoriesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EducationCategory body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EducationCategoryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationCategoryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EducationCategoryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EducationCategory> post(@javax.annotation.Nonnull final EducationCategory body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationCategory> executionException = new java.util.concurrent.CompletableFuture<EducationCategory>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
