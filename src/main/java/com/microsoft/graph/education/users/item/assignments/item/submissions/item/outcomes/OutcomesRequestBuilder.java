package microsoft.graph.education.users.item.assignments.item.submissions.item.outcomes;
...
import microsoft.graph.education.users.item.assignments.item.submissions.item.outcomes.count.CountRequestBuilder;
