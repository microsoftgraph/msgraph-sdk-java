package microsoft.graph.education.users.item.taughtclasses;
...
import microsoft.graph.education.users.item.taughtclasses.count.CountRequestBuilder;
...
public class TaughtClassesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<TaughtClassesRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final TaughtClassesRequestBuilderGetRequestConfiguration requestConfig = new TaughtClassesRequestBuilderGetRequestConfiguration();
