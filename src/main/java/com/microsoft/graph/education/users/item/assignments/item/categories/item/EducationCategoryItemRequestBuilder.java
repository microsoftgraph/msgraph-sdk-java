package microsoft.graph.education.users.item.assignments.item.categories.item;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.education.users.item.assignments.item.categories.item.ref.RefRequestBuilder;
