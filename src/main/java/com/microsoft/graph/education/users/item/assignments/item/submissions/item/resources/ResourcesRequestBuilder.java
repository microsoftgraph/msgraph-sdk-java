package microsoft.graph.education.users.item.assignments.item.submissions.item.resources;
...
import microsoft.graph.education.users.item.assignments.item.submissions.item.resources.count.CountRequestBuilder;
