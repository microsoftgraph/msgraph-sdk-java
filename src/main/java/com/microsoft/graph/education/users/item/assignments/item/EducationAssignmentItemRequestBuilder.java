package microsoft.graph.education.users.item.assignments.item;
...
import microsoft.graph.education.users.item.assignments.item.categories.CategoriesRequestBuilder;
import microsoft.graph.education.users.item.assignments.item.categories.item.EducationCategoryItemRequestBuilder;
import microsoft.graph.education.users.item.assignments.item.publish.PublishRequestBuilder;
