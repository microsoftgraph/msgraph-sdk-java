...
public class RubricsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EducationRubricCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationRubricCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EducationRubricCollectionResponse>();
