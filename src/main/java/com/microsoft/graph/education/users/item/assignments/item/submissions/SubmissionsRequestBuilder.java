package com.microsoft.graph.education.users.item.assignments.item.submissions;

import com.microsoft.graph.education.users.item.assignments.item.submissions.count.CountRequestBuilder;
