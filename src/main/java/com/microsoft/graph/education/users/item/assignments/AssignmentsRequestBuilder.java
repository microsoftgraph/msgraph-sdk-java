package microsoft.graph.education.users.item.assignments;
...
import microsoft.graph.education.users.item.assignments.count.CountRequestBuilder;
import microsoft.graph.education.users.item.assignments.delta.DeltaRequestBuilder;
