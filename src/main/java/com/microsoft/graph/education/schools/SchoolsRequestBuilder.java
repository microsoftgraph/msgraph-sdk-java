...
public class SchoolsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EducationSchool body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EducationSchoolCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationSchoolCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EducationSchoolCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EducationSchool> post(@javax.annotation.Nonnull final EducationSchool body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationSchool> executionException = new java.util.concurrent.CompletableFuture<EducationSchool>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
