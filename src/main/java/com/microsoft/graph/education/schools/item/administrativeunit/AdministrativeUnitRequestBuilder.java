...
public class AdministrativeUnitRequestBuilder {
    ...
    public AdministrativeUnitRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public AdministrativeUnitRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/education/schools/{educationSchool%2Did}/administrativeUnit{?%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<AdministrativeUnitRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AdministrativeUnit body, @javax.annotation.Nullable final java.util.function.Consumer<AdministrativeUnitRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final AdministrativeUnitRequestBuilderPatchRequestConfiguration requestConfig = new AdministrativeUnitRequestBuilderPatchRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AdministrativeUnit> get(@javax.annotation.Nullable final java.util.function.Consumer<AdministrativeUnitRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AdministrativeUnit> patch(@javax.annotation.Nonnull final AdministrativeUnit body, @javax.annotation.Nullable final java.util.function.Consumer<AdministrativeUnitRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
    ...
    public class AdministrativeUnitRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public AdministrativeUnitRequestBuilderGetQueryParameters queryParameters = new AdministrativeUnitRequestBuilderGetQueryParameters();
        /**
