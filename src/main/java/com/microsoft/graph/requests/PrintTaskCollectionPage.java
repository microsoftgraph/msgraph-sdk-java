...
public class PrintTaskCollectionPage extends BaseCollectionPage<PrintTask, PrintTaskCollectionRequestBuilder> {
     ...
     */
    public PrintTaskCollectionPage(@Nonnull final PrintTaskCollectionResponse response, @Nonnull final PrintTaskCollectionRequestBuilder builder) {
     ...
     */
    public PrintTaskCollectionPage(@Nonnull final java.util.List<PrintTask> pageContents, @Nullable final PrintTaskCollectionRequestBuilder nextRequestBuilder) {
