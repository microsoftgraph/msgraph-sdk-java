...
import com.microsoft.graph.requests.WorkbookFunctionsModRequest;
...
public class WorkbookFunctionsModRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsModRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public WorkbookFunctionsModRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsModRequest request = new WorkbookFunctionsModRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
