...
public class PostRequestBuilder extends BaseRequestBuilder<Post> {
    ...
    public PostRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.PostRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public PostForwardRequestBuilder forward(@Nonnull final PostForwardParameterSet parameters) {
     ...
     */
    @Nonnull
    public PostReplyRequestBuilder reply(@Nonnull final PostReplyParameterSet parameters) {
