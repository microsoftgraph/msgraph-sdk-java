...
public class ReportRootDeviceConfigurationUserActivityRequestBuilder extends BaseFunctionRequestBuilder<Report> {
     ...
     */
    public ReportRootDeviceConfigurationUserActivityRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationUserActivityRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
