...
/**
 * The class for the Windows Microsoft Edge App Request Builder.
 */
public class WindowsMicrosoftEdgeAppRequestBuilder extends BaseRequestBuilder<WindowsMicrosoftEdgeApp> {

    /**
     * The request builder for the WindowsMicrosoftEdgeApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsMicrosoftEdgeAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsMicrosoftEdgeAppRequest instance
     */
    @Nonnull
    public WindowsMicrosoftEdgeAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsMicrosoftEdgeAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsMicrosoftEdgeAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
