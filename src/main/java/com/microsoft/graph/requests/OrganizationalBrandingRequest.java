...
public class OrganizationalBrandingRequest extends BaseRequest<OrganizationalBranding> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationalBranding> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationalBranding> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationalBranding> postAsync(@Nonnull final OrganizationalBranding newOrganizationalBranding) {
        return sendAsync(HttpMethod.POST, newOrganizationalBranding);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationalBranding> putAsync(@Nonnull final OrganizationalBranding newOrganizationalBranding) {
        return sendAsync(HttpMethod.PUT, newOrganizationalBranding);
    }
