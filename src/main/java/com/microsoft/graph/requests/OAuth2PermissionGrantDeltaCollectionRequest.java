...
import com.microsoft.graph.requests.OAuth2PermissionGrantDeltaCollectionRequestBuilder;
...
public class OAuth2PermissionGrantDeltaCollectionRequest extends BaseDeltaCollectionRequest<OAuth2PermissionGrant, OAuth2PermissionGrantDeltaCollectionResponse, OAuth2PermissionGrantDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest skipToken(@Nonnull final String skipToken) {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
