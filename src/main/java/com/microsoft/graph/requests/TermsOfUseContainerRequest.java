...
public class TermsOfUseContainerRequest extends BaseRequest<TermsOfUseContainer> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TermsOfUseContainer> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TermsOfUseContainer> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TermsOfUseContainer> patchAsync(@Nonnull final TermsOfUseContainer sourceTermsOfUseContainer) {
        return sendAsync(HttpMethod.PATCH, sourceTermsOfUseContainer);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TermsOfUseContainer> postAsync(@Nonnull final TermsOfUseContainer newTermsOfUseContainer) {
        return sendAsync(HttpMethod.POST, newTermsOfUseContainer);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TermsOfUseContainer> putAsync(@Nonnull final TermsOfUseContainer newTermsOfUseContainer) {
        return sendAsync(HttpMethod.PUT, newTermsOfUseContainer);
    }
