...
import com.microsoft.graph.requests.WorkbookFunctionsDaverageRequest;
 ...
 */
public class WorkbookFunctionsDaverageRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDaverageRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsDaverageParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsDaverage
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsDaverageRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDaverageParameterSet parameters) {
        super(requestUrl, client, requestOptions);
