 ...
 */
public class OrganizationalBrandingPropertiesSquareLogoStreamRequest extends BaseStreamRequest<OrganizationalBrandingProperties> {
     ...
     */
    public OrganizationalBrandingPropertiesSquareLogoStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
