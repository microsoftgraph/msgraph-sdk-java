...
public class DeviceComplianceUserStatusRequest extends BaseRequest<DeviceComplianceUserStatus> {
     ...
     */
    public DeviceComplianceUserStatusRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nullable
    public DeviceComplianceUserStatus patch(@Nonnull final DeviceComplianceUserStatus sourceDeviceComplianceUserStatus) throws ClientException {
     ...
     */
    @Nullable
    public DeviceComplianceUserStatus put(@Nonnull final DeviceComplianceUserStatus newDeviceComplianceUserStatus) throws ClientException {
     ...
     */
     @Nonnull
     public DeviceComplianceUserStatusRequest expand(@Nonnull final String value) {
