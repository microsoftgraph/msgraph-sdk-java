 ...
 */
public class ChannelReferenceRequestBuilder extends BaseReferenceRequestBuilder<Channel, ChannelReferenceRequest> {
     ...
     */
    public ChannelReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ChannelReferenceRequest.class);
    }
}
