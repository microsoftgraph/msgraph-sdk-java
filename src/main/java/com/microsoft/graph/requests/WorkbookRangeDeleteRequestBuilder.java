...
import com.microsoft.graph.requests.WorkbookRangeDeleteRequest;
...
public class WorkbookRangeDeleteRequestBuilder extends BaseActionRequestBuilder<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookRangeDeleteRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookRangeDeleteRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookRangeDeleteRequest request = new WorkbookRangeDeleteRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
