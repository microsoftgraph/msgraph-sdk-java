...
import com.microsoft.graph.models.TokenIssuancePolicy;
import com.microsoft.graph.requests.TokenIssuancePolicyWithReferenceRequest;
import com.microsoft.graph.requests.TokenIssuancePolicyReferenceRequestBuilder;
import com.microsoft.graph.requests.TokenIssuancePolicyWithReferenceRequestBuilder;
import com.microsoft.graph.requests.TokenIssuancePolicyCollectionWithReferencesRequest;
import com.microsoft.graph.requests.TokenIssuancePolicyCollectionWithReferencesRequest;
...
public class TokenIssuancePolicyCollectionWithReferencesRequest extends BaseCollectionWithReferencesRequest<TokenIssuancePolicy, TokenIssuancePolicyWithReferenceRequest, TokenIssuancePolicyReferenceRequestBuilder, TokenIssuancePolicyWithReferenceRequestBuilder, TokenIssuancePolicyCollectionResponse, TokenIssuancePolicyCollectionWithReferencesPage, TokenIssuancePolicyCollectionWithReferencesRequest> {
     ...
     */
    @Nonnull
    public TokenIssuancePolicyCollectionWithReferencesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public TokenIssuancePolicyCollectionWithReferencesRequest count() {
        addCountOption(true);
        return this;
    }
}
