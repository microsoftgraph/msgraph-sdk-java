...
import com.microsoft.graph.models.WorkbookRangeSortApplyParameterSet;
...
public class WorkbookRangeSortRequestBuilder extends BaseRequestBuilder<WorkbookRangeSort> {
    ...
    public WorkbookRangeSortRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WorkbookRangeSortRequest(getRequestUrl(), getClient(), requestOptions);
    }
