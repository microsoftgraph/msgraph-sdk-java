 ...
 */
public class TeamsAppInstallationUpgradeRequestBuilder extends BaseActionRequestBuilder<TeamsAppInstallation> {
     ...
     */
    @Nonnull
    public TeamsAppInstallationUpgradeRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
