...
public class MessageReplyRequest extends BaseRequest<Void> {
     ...
     */
    public MessageReplyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MessageReplyParameterSet parameters) {
    ...
    @Nullable
    protected MessageReplyParameterSet body;
    /**
     * Creates the MessageReply
     *
