 ...
 */
public class PrintDocumentStreamRequest extends BaseStreamRequest<PrintDocument> {
     ...
     */
    public PrintDocumentStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<PrintDocument> putAsync(@Nonnull final byte[] fileContents) {
     ...
     */
    @Nullable
    public PrintDocument put(@Nonnull final byte[] fileContents) throws ClientException {
