...
import com.microsoft.graph.requests.WorkbookFunctionsSubtotalRequest;
...
public class WorkbookFunctionsSubtotalRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsSubtotalRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsSubtotalParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsSubtotalParameterSet body;
    /**
