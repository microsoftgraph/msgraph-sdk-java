...
import com.microsoft.graph.requests.DomainCollectionResponse;
 ...
 */
public class DomainCollectionRequest extends BaseEntityCollectionRequest<Domain, DomainCollectionResponse, DomainCollectionPage> {
     ...
     */
    @Nonnull
    public DomainCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DomainCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
