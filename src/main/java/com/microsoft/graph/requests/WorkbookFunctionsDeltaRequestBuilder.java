...
import com.microsoft.graph.requests.WorkbookFunctionsDeltaRequest;
...
public class WorkbookFunctionsDeltaRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDeltaRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsDeltaParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsDelta
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsDeltaRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDeltaParameterSet parameters) {
        super(requestUrl, client, requestOptions);
    ...
    public WorkbookFunctionsDeltaRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsDeltaRequest request = new WorkbookFunctionsDeltaRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
