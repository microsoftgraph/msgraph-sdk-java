...
import com.microsoft.graph.requests.WorkbookFunctionsLenbRequest;
...
public class WorkbookFunctionsLenbRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsLenbRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsLenbParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsLenbParameterSet body;
    /**
