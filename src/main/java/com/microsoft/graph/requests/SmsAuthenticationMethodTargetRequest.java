...
public class SmsAuthenticationMethodTargetRequest extends BaseRequest<SmsAuthenticationMethodTarget> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SmsAuthenticationMethodTarget> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SmsAuthenticationMethodTarget> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SmsAuthenticationMethodTarget> patchAsync(@Nonnull final SmsAuthenticationMethodTarget sourceSmsAuthenticationMethodTarget) {
        return sendAsync(HttpMethod.PATCH, sourceSmsAuthenticationMethodTarget);
    }
    ...
    public java.util.concurrent.CompletableFuture<SmsAuthenticationMethodTarget> postAsync(@Nonnull final SmsAuthenticationMethodTarget newSmsAuthenticationMethodTarget) {
        return sendAsync(HttpMethod.POST, newSmsAuthenticationMethodTarget);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SmsAuthenticationMethodTarget> putAsync(@Nonnull final SmsAuthenticationMethodTarget newSmsAuthenticationMethodTarget) {
        return sendAsync(HttpMethod.PUT, newSmsAuthenticationMethodTarget);
    }
