...
public class PrinterShareCollectionRequestBuilder extends BaseCollectionRequestBuilder<PrinterShare, PrinterShareRequestBuilder, PrinterShareCollectionResponse, PrinterShareCollectionPage, PrinterShareCollectionRequest> {
     ...
     */
    public PrinterShareCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PrinterShareRequestBuilder.class, PrinterShareCollectionRequest.class);
    }
