...
public class Windows81GeneralConfigurationRequestBuilder extends BaseRequestBuilder<Windows81GeneralConfiguration> {
     ...
     */
    public Windows81GeneralConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows81GeneralConfigurationRequest instance
     */
    @Nonnull
    public Windows81GeneralConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows81GeneralConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows81GeneralConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
