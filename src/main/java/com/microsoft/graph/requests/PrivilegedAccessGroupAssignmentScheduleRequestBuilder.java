...
/**
 * The class for the Privileged Access Group Assignment Schedule Request Builder.
 */
public class PrivilegedAccessGroupAssignmentScheduleRequestBuilder extends BaseRequestBuilder<PrivilegedAccessGroupAssignmentSchedule> {

    /**
     * The request builder for the PrivilegedAccessGroupAssignmentSchedule
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public PrivilegedAccessGroupAssignmentScheduleRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the PrivilegedAccessGroupAssignmentScheduleRequest instance
     */
    @Nonnull
    public PrivilegedAccessGroupAssignmentScheduleRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PrivilegedAccessGroupAssignmentScheduleRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.PrivilegedAccessGroupAssignmentScheduleRequest(getRequestUrl(), getClient(), requestOptions);
    }
