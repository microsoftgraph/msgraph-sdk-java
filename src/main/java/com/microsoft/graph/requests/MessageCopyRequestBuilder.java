...
import com.microsoft.graph.requests.MessageCopyRequest;
...
public class MessageCopyRequestBuilder extends BaseActionRequestBuilder<Message> {
     ...
     */
    public MessageCopyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
