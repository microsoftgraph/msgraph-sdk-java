...
import com.microsoft.graph.requests.DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest;
...
public class DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequestBuilder extends BaseFunctionRequestBuilder<Boolean> {
     ...
     */
    public DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
