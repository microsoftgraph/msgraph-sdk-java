...
import com.microsoft.graph.requests.EventDeclineRequest;
...
public class EventDeclineRequest extends BaseRequest<Void> {
     ...
     */
    public EventDeclineRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

	/** The body for the method */
    @Nullable
    public EventDeclineParameterSet body;
    /**
