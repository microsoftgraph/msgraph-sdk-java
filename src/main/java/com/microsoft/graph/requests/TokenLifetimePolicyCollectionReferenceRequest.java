...
public class TokenLifetimePolicyCollectionReferenceRequest extends BaseCollectionWithReferencesRequest<TokenLifetimePolicy, TokenLifetimePolicyWithReferenceRequest, TokenLifetimePolicyReferenceRequestBuilder, TokenLifetimePolicyWithReferenceRequestBuilder, TokenLifetimePolicyCollectionResponse, TokenLifetimePolicyCollectionWithReferencesPage, TokenLifetimePolicyCollectionWithReferencesRequest> {
    ...
    public java.util.concurrent.CompletableFuture<TokenLifetimePolicy> futurePost(@Nonnull final TokenLifetimePolicy newTokenLifetimePolicy) {
        ...
        return new TokenLifetimePolicyWithReferenceRequestBuilder(requestUrl, getBaseRequest().getClient(), /* Options */ null)
            ...
            .futurePost(newTokenLifetimePolicy, body);
    }
     ...
     */
    @Nonnull
    public TokenLifetimePolicyCollectionReferenceRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public TokenLifetimePolicyCollectionReferenceRequest count() {
        addCountOption(true);
        return this;
    }
}
