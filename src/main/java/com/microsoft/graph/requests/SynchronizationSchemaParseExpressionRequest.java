...
public class SynchronizationSchemaParseExpressionRequest extends BaseRequest<ParseExpressionResponse> {
     ...
     */
    public SynchronizationSchemaParseExpressionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ParseExpressionResponse.class);
    }

	/** The body for the method */
    @Nullable
    public SynchronizationSchemaParseExpressionParameterSet body;
    /**
     * Invokes the method and returns a future with the result
     * @return a future with the result
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ParseExpressionResponse> postAsync() {
