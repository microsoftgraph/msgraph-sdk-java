 ...
 */
public class ReportRootGetYammerGroupsActivityDetailRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetYammerGroupsActivityDetailRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
