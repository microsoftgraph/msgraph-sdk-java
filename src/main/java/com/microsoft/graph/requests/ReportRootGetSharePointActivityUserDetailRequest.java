 ...
 */
public class ReportRootGetSharePointActivityUserDetailRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetSharePointActivityUserDetailRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
