...
/**
 * The class for the Organizational Branding Properties Custom CSSStream Request.
 */
public class OrganizationalBrandingPropertiesCustomCSSStreamRequest extends BaseStreamRequest<OrganizationalBrandingProperties> {

    /**
     * The request for the OrganizationalBrandingPropertiesCustomCSSStream
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public OrganizationalBrandingPropertiesCustomCSSStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
