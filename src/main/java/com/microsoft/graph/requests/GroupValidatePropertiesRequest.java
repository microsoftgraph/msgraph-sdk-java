...
import com.microsoft.graph.requests.GroupValidatePropertiesRequest;
...
public class GroupValidatePropertiesRequest extends BaseRequest<Void> {
     ...
     */
    public GroupValidatePropertiesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final GroupValidatePropertiesParameterSet parameters) {
