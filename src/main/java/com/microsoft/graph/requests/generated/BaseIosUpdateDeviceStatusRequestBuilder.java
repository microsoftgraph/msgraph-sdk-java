...
/**
 * The class for the Base Ios Update Device Status Request Builder.
 */
public class BaseIosUpdateDeviceStatusRequestBuilder extends BaseRequestBuilder implements IBaseIosUpdateDeviceStatusRequestBuilder {
     ...
     */
    public BaseIosUpdateDeviceStatusRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
