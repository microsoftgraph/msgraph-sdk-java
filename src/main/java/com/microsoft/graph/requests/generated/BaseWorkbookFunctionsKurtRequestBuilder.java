...
public class BaseWorkbookFunctionsKurtRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsKurtRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsKurtRequest instance
     */
    public IWorkbookFunctionsKurtRequest buildRequest(final java.util.List<Option> requestOptions) {
