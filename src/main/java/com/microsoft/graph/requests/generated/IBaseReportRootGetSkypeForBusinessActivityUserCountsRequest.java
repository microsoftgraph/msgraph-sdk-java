...
/**
 * The interface for the Base Report Root Get Skype For Business Activity User Counts Request.
 */
public interface IBaseReportRootGetSkypeForBusinessActivityUserCountsRequest {
     ...
     */
    IReportRootGetSkypeForBusinessActivityUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessActivityUserCountsRequest expand(final String value);
