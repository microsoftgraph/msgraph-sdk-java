...
/**
 * The class for the Base Teams App Installation Collection Request Builder.
 */
public class BaseTeamsAppInstallationCollectionRequestBuilder extends BaseRequestBuilder implements IBaseTeamsAppInstallationCollectionRequestBuilder {
     ...
     */
    public BaseTeamsAppInstallationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITeamsAppInstallationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
