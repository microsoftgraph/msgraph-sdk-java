...
public class BaseWorkbookFunctionsBin2HexRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsBin2HexRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement places) {
     ...
     * @return The IWorkbookFunctionsBin2HexRequest instance
     */
    public IWorkbookFunctionsBin2HexRequest buildRequest(final java.util.List<Option> requestOptions) {
