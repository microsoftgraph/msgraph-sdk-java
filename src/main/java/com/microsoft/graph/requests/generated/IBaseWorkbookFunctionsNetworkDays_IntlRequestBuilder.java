...
/**
 * The interface for the Base Workbook Functions Network Days_Intl Request Builder.
 */
public interface IBaseWorkbookFunctionsNetworkDays_IntlRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsNetworkDays_IntlRequest instance
     */
    IWorkbookFunctionsNetworkDays_IntlRequest buildRequest(final java.util.List<Option> requestOptions);
}
