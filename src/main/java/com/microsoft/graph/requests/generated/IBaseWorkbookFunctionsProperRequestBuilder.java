...
/**
 * The interface for the Base Workbook Functions Proper Request Builder.
 */
public interface IBaseWorkbookFunctionsProperRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsProperRequest instance
     */
    IWorkbookFunctionsProperRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
