...
/**
 * The interface for the Base Teams App Request.
 */
public interface IBaseTeamsAppRequest extends IHttpRequest {
     ...
     */
    IBaseTeamsAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseTeamsAppRequest expand(final String value);
