...
/**
 * The class for the Base Team Request.
 */
public class BaseTeamRequest extends BaseRequest implements IBaseTeamRequest {
     ...
     */
    public BaseTeamRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<Team> responseClass) {
