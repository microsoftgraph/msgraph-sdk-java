...
/**
 * The class for the Base Report Root Get Teams Device Usage Distribution User Counts Request Builder.
 */
public class BaseReportRootGetTeamsDeviceUsageDistributionUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetTeamsDeviceUsageDistributionUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
