...
/**
 * The interface for the Base Workbook Functions F_Dist Request.
 */
public interface IBaseWorkbookFunctionsF_DistRequest {
     ...
     */
    IWorkbookFunctionsF_DistRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookFunctionsF_DistRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsF_DistRequest expand(final String value);
