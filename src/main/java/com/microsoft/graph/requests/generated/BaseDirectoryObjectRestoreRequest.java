...
/**
 * The class for the Base Directory Object Restore Request.
 */
public class BaseDirectoryObjectRestoreRequest extends BaseRequest implements IBaseDirectoryObjectRestoreRequest {
     ...
     */
    public BaseDirectoryObjectRestoreRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
