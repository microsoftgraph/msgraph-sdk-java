...
/**
 * The class for the Base Security Request.
 */
public class BaseSecurityRequest extends BaseRequest implements IBaseSecurityRequest {
     ...
     */
    public BaseSecurityRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<Security> responseClass) {
