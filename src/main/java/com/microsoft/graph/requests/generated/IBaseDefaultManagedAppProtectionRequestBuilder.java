...
/**
 * The interface for the Base Default Managed App Protection Request Builder.
 */
public interface IBaseDefaultManagedAppProtectionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
