...
/**
 * The interface for the Base Workbook Functions Permutationa Request Builder.
 */
public interface IBaseWorkbookFunctionsPermutationaRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsPermutationaRequest instance
     */
    IWorkbookFunctionsPermutationaRequest buildRequest(final java.util.List<Option> requestOptions);
}
