...
/**
 * The class for the Base Software Update Status Summary Request Builder.
 */
public class BaseSoftwareUpdateStatusSummaryRequestBuilder extends BaseRequestBuilder implements IBaseSoftwareUpdateStatusSummaryRequestBuilder {
     ...
     */
    public BaseSoftwareUpdateStatusSummaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public ISoftwareUpdateStatusSummaryRequest buildRequest() {
