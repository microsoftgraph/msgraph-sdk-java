...
/**
 * The interface for the Base Report Root Get Office365Active User Counts Request Builder.
 */
public interface IBaseReportRootGetOffice365ActiveUserCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return the IReportRootGetOffice365ActiveUserCountsRequest instance
     */
    IReportRootGetOffice365ActiveUserCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
