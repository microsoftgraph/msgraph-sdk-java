...
/**
 * The class for the Base Report Root Managed Device Enrollment Failure Details Request.
 */
public class BaseReportRootManagedDeviceEnrollmentFailureDetailsRequest extends BaseRequest implements IBaseReportRootManagedDeviceEnrollmentFailureDetailsRequest {
     ...
     */
    public BaseReportRootManagedDeviceEnrollmentFailureDetailsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
