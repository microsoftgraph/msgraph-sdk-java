...
/**
 * The interface for the Base Windows Update For Business Configuration Request Builder.
 */
public interface IBaseWindowsUpdateForBusinessConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
