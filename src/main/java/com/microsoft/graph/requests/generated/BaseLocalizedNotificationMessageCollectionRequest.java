...
/**
 * The class for the Base Localized Notification Message Collection Request.
 */
public class BaseLocalizedNotificationMessageCollectionRequest extends BaseCollectionRequest<BaseLocalizedNotificationMessageCollectionResponse, ILocalizedNotificationMessageCollectionPage> implements IBaseLocalizedNotificationMessageCollectionRequest {
     ...
     */
    public BaseLocalizedNotificationMessageCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseLocalizedNotificationMessageCollectionResponse.class, ILocalizedNotificationMessageCollectionPage.class);
    }
    ...
    public ILocalizedNotificationMessageCollectionPage get() throws ClientException {
        final BaseLocalizedNotificationMessageCollectionResponse response = send();
    ...
    public ILocalizedNotificationMessageCollectionPage buildFromResponse(final BaseLocalizedNotificationMessageCollectionResponse response) {
