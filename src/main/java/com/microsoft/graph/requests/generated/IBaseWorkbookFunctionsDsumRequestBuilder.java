...
/**
 * The interface for the Base Workbook Functions Dsum Request Builder.
 */
public interface IBaseWorkbookFunctionsDsumRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsDsumRequest instance
     */
    IWorkbookFunctionsDsumRequest buildRequest(final java.util.List<Option> requestOptions);
}
