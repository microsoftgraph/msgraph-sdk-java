...
/**
 * The interface for the Base Report Root Get Mailbox Usage Mailbox Counts Request Builder.
 */
public interface IBaseReportRootGetMailboxUsageMailboxCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return the IReportRootGetMailboxUsageMailboxCountsRequest instance
     */
    IReportRootGetMailboxUsageMailboxCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
