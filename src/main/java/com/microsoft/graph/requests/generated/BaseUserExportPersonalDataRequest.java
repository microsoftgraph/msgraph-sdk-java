...
/**
 * The class for the Base User Export Personal Data Request.
 */
public class BaseUserExportPersonalDataRequest extends BaseRequest implements IBaseUserExportPersonalDataRequest {
     ...
     */
    public BaseUserExportPersonalDataRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
