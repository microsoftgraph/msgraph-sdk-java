...
public class BaseWorkbookChartSetDataRequest extends BaseRequest implements IBaseWorkbookChartSetDataRequest {
     ...
     */
    public BaseWorkbookChartSetDataRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookChartSetDataRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookChartSetDataRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookChartSetDataRequest expand(final String value) {
