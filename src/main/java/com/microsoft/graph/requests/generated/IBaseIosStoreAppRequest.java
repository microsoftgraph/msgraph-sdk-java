...
/**
 * The interface for the Base Ios Store App Request.
 */
public interface IBaseIosStoreAppRequest extends IHttpRequest {
     ...
     */
    IBaseIosStoreAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseIosStoreAppRequest expand(final String value);
