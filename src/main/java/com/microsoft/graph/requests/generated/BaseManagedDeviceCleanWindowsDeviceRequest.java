...
/**
 * The class for the Base Managed Device Clean Windows Device Request.
 */
public class BaseManagedDeviceCleanWindowsDeviceRequest extends BaseRequest implements IBaseManagedDeviceCleanWindowsDeviceRequest {
     ...
     */
    public BaseManagedDeviceCleanWindowsDeviceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
