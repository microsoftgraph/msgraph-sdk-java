...
/**
 * The class for the Base Team Request Builder.
 */
public class BaseTeamRequestBuilder extends BaseRequestBuilder implements IBaseTeamRequestBuilder {
     ...
     */
    public BaseTeamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
