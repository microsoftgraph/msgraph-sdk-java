...
/**
 * The class for the Base Drive Item Preview Request.
 */
public class BaseDriveItemPreviewRequest extends BaseRequest implements IBaseDriveItemPreviewRequest {
     ...
     */
    public BaseDriveItemPreviewRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
