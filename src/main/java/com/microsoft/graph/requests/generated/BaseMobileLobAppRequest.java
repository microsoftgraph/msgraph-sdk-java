...
/**
 * The class for the Base Mobile Lob App Request.
 */
public class BaseMobileLobAppRequest extends BaseRequest implements IBaseMobileLobAppRequest {
     ...
     */
    public BaseMobileLobAppRequest(final String requestUrl,
