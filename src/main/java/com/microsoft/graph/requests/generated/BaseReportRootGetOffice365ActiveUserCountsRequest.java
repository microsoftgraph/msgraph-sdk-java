...
/**
 * The class for the Base Report Root Get Office365Active User Counts Request.
 */
public class BaseReportRootGetOffice365ActiveUserCountsRequest extends BaseRequest implements IBaseReportRootGetOffice365ActiveUserCountsRequest {
     ...
     */
    public BaseReportRootGetOffice365ActiveUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IReportRootGetOffice365ActiveUserCountsRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActiveUserCountsRequest expand(final String value) {
