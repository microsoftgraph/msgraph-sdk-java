...
/**
 * The class for the Base Outlook Category Request Builder.
 */
public class BaseOutlookCategoryRequestBuilder extends BaseRequestBuilder implements IBaseOutlookCategoryRequestBuilder {
     ...
     */
    public BaseOutlookCategoryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
