...
/**
 * The class for the Base Workbook Named Item Range Request.
 */
public class BaseWorkbookNamedItemRangeRequest extends BaseRequest implements IBaseWorkbookNamedItemRangeRequest {
     ...
     */
    public BaseWorkbookNamedItemRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
