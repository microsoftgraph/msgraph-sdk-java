...
/**
 * The interface for the Base Workbook Table Range Request.
 */
public interface IBaseWorkbookTableRangeRequest {
     ...
     */
    IWorkbookTableRangeRequest select(final String value);
     ...
     * @return The updated request
     */
    IWorkbookTableRangeRequest expand(final String value);
