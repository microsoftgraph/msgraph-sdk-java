...
/**
 * The interface for the Base Terms And Conditions Request Builder.
 */
public interface IBaseTermsAndConditionsRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the ITermsAndConditionsRequest instance
     */
    ITermsAndConditionsRequest buildRequest(final java.util.List<? extends Option> requestOptions);
