...
/**
 * The class for the Base Report Root Get One Drive Activity User Counts Request.
 */
public class BaseReportRootGetOneDriveActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetOneDriveActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetOneDriveActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    /**
     * Puts the ReportRootGetOneDriveActivityUserCounts
     *
     ...
     */
    public IReportRootGetOneDriveActivityUserCountsRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetOneDriveActivityUserCountsRequest)this;
    }
     ...
     * @return the updated request
     */
    public IReportRootGetOneDriveActivityUserCountsRequest expand(final String value) {
