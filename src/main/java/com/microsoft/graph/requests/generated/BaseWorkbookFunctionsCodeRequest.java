...
/**
 * The class for the Base Workbook Functions Code Request.
 */
public class BaseWorkbookFunctionsCodeRequest extends BaseRequest implements IBaseWorkbookFunctionsCodeRequest {
     ...
     */
    public BaseWorkbookFunctionsCodeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
