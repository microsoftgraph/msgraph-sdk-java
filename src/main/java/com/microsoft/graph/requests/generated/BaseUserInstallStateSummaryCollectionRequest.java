...
/**
 * The class for the Base User Install State Summary Collection Request.
 */
public class BaseUserInstallStateSummaryCollectionRequest extends BaseCollectionRequest<BaseUserInstallStateSummaryCollectionResponse, IUserInstallStateSummaryCollectionPage> implements IBaseUserInstallStateSummaryCollectionRequest {
     ...
     */
    public BaseUserInstallStateSummaryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseUserInstallStateSummaryCollectionResponse.class, IUserInstallStateSummaryCollectionPage.class);
    }
    ...
    public IUserInstallStateSummaryCollectionPage get() throws ClientException {
        final BaseUserInstallStateSummaryCollectionResponse response = send();
    ...
    public IUserInstallStateSummaryCollectionPage buildFromResponse(final BaseUserInstallStateSummaryCollectionResponse response) {
