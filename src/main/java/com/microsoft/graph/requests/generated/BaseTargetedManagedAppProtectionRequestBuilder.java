...
/**
 * The class for the Base Targeted Managed App Protection Request Builder.
 */
public class BaseTargetedManagedAppProtectionRequestBuilder extends BaseRequestBuilder implements IBaseTargetedManagedAppProtectionRequestBuilder {
     ...
     */
    public BaseTargetedManagedAppProtectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
