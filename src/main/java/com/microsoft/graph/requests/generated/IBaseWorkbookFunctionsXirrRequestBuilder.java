...
/**
 * The interface for the Base Workbook Functions Xirr Request Builder.
 */
public interface IBaseWorkbookFunctionsXirrRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsXirrRequest instance
     */
    IWorkbookFunctionsXirrRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
