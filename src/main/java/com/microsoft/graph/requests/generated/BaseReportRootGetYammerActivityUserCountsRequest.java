...
/**
 * The class for the Base Report Root Get Yammer Activity User Counts Request.
 */
public class BaseReportRootGetYammerActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetYammerActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetYammerActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IReportRootGetYammerActivityUserCountsRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetYammerActivityUserCountsRequest expand(final String value) {
