...
/**
 * The class for the Base Workbook Chart Series Request Builder.
 */
public class BaseWorkbookChartSeriesRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartSeriesRequestBuilder {
     ...
     */
    public BaseWorkbookChartSeriesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartSeriesRequest buildRequest(final java.util.List<Option> requestOptions) {
