...
/**
 * The class for the Base Report Root Get Yammer Groups Activity Detail Request.
 */
public class BaseReportRootGetYammerGroupsActivityDetailRequest extends BaseRequest implements IBaseReportRootGetYammerGroupsActivityDetailRequest {
     ...
     */
    public BaseReportRootGetYammerGroupsActivityDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetYammerGroupsActivityDetail
    ...
    /**
     * Puts the ReportRootGetYammerGroupsActivityDetail
     *
     ...
     */
    public IReportRootGetYammerGroupsActivityDetailRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetYammerGroupsActivityDetailRequest expand(final String value) {
