...
/**
 * The class for the Base User Install State Summary Request Builder.
 */
public class BaseUserInstallStateSummaryRequestBuilder extends BaseRequestBuilder implements IBaseUserInstallStateSummaryRequestBuilder {
     ...
     */
    public BaseUserInstallStateSummaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IUserInstallStateSummaryRequest buildRequest() {
