...
/**
 * The class for the Base Ios Device Features Configuration Request Builder.
 */
public class BaseIosDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder implements IBaseIosDeviceFeaturesConfigurationRequestBuilder {
     ...
     */
    public BaseIosDeviceFeaturesConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
