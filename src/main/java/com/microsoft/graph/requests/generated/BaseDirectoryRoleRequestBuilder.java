...
public class BaseDirectoryRoleRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRoleRequestBuilder {
     ...
     */
    public BaseDirectoryRoleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IDirectoryRoleRequest buildRequest(final java.util.List<Option> requestOptions) {
