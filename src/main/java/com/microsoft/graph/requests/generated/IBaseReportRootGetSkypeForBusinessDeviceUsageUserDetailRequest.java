...
/**
 * The interface for the Base Report Root Get Skype For Business Device Usage User Detail Request.
 */
public interface IBaseReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest {
     ...
     */
    IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest expand(final String value);
