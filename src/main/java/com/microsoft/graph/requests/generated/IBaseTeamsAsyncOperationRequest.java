...
/**
 * The interface for the Base Teams Async Operation Request.
 */
public interface IBaseTeamsAsyncOperationRequest extends IHttpRequest {
     ...
     */
    IBaseTeamsAsyncOperationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseTeamsAsyncOperationRequest expand(final String value);
