...
public class BaseReportRootGetOffice365ActivationsUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365ActivationsUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IReportRootGetOffice365ActivationsUserCountsRequest instance
     */
    public IReportRootGetOffice365ActivationsUserCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
