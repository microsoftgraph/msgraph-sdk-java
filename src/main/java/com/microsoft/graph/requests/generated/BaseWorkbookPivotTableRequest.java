...
/**
 * The class for the Base Workbook Pivot Table Request.
 */
public class BaseWorkbookPivotTableRequest extends BaseRequest implements IBaseWorkbookPivotTableRequest {
     ...
     */
    public BaseWorkbookPivotTableRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<WorkbookPivotTable> responseClass) {
