...
public class BaseWorkbookFunctionsSqrtRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSqrtRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsSqrtRequest instance
     */
    public IWorkbookFunctionsSqrtRequest buildRequest(final java.util.List<Option> requestOptions) {
