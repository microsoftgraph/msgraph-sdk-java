...
public class BaseReportRootGetOffice365ActiveUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365ActiveUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetOffice365ActiveUserCountsRequest instance
     */
    public IReportRootGetOffice365ActiveUserCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
