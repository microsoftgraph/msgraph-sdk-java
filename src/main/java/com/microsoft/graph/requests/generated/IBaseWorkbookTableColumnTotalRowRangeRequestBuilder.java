...
/**
 * The interface for the Base Workbook Table Column Total Row Range Request Builder.
 */
public interface IBaseWorkbookTableColumnTotalRowRangeRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookTableColumnTotalRowRangeRequest instance
     */
    IWorkbookTableColumnTotalRowRangeRequest buildRequest(final java.util.List<Option> requestOptions);
}
