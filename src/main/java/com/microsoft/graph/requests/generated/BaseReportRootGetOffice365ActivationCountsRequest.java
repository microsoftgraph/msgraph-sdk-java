...
/**
 * The class for the Base Report Root Get Office365Activation Counts Request.
 */
public class BaseReportRootGetOffice365ActivationCountsRequest extends BaseRequest implements IBaseReportRootGetOffice365ActivationCountsRequest {
     ...
     */
    public BaseReportRootGetOffice365ActivationCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetOffice365ActivationCounts
    ...
    /**
     * Puts the ReportRootGetOffice365ActivationCounts
     *
     ...
     */
    public IReportRootGetOffice365ActivationCountsRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActivationCountsRequest expand(final String value) {
