...
/**
 * The class for the Base User Get Managed App Diagnostic Statuses Collection Page.
 */
public class BaseUserGetManagedAppDiagnosticStatusesCollectionPage extends BaseCollectionPage<ManagedAppDiagnosticStatus, IUserGetManagedAppDiagnosticStatusesCollectionRequestBuilder> implements IBaseUserGetManagedAppDiagnosticStatusesCollectionPage {
     ...
     */
    public BaseUserGetManagedAppDiagnosticStatusesCollectionPage(final BaseUserGetManagedAppDiagnosticStatusesCollectionResponse response, final IUserGetManagedAppDiagnosticStatusesCollectionRequestBuilder builder) {
