...
/**
 * The class for the Base Report Root Managed Device Enrollment Top Failures Request Builder.
 */
public class BaseReportRootManagedDeviceEnrollmentTopFailuresRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootManagedDeviceEnrollmentTopFailuresRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public BaseReportRootManagedDeviceEnrollmentTopFailuresRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
