...
/**
 * The interface for the Base Report Root Managed Device Enrollment Top Failures Request Builder.
 */
public interface IBaseReportRootManagedDeviceEnrollmentTopFailuresRequestBuilder extends IRequestBuilder {
     ...
     * @return the IReportRootManagedDeviceEnrollmentTopFailuresRequest instance
     */
    IReportRootManagedDeviceEnrollmentTopFailuresRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
