...
/**
 * The class for the Base Teams App Definition Reference Request.
 */
public class BaseTeamsAppDefinitionReferenceRequest extends BaseRequest implements IBaseTeamsAppDefinitionReferenceRequest {
     ...
     */
    public BaseTeamsAppDefinitionReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
