...
/**
 * The class for the Base Teams App Reference Request.
 */
public class BaseTeamsAppReferenceRequest extends BaseRequest implements IBaseTeamsAppReferenceRequest {
     ...
     */
    public BaseTeamsAppReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
