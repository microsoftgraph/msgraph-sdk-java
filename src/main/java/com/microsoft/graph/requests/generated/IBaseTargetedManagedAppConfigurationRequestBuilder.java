...
/**
 * The interface for the Base Targeted Managed App Configuration Request Builder.
 */
public interface IBaseTargetedManagedAppConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
