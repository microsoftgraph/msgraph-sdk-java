...
/**
 * The class for the Base Teams App Installation Request Builder.
 */
public class BaseTeamsAppInstallationRequestBuilder extends BaseRequestBuilder implements IBaseTeamsAppInstallationRequestBuilder {
     ...
     */
    public BaseTeamsAppInstallationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
