...
/**
 * The class for the Base Teams App Installation Upgrade Request.
 */
public class BaseTeamsAppInstallationUpgradeRequest extends BaseRequest implements IBaseTeamsAppInstallationUpgradeRequest {
     ...
     */
    public BaseTeamsAppInstallationUpgradeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
