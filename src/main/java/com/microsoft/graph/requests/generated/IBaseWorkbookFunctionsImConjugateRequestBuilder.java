...
/**
 * The interface for the Base Workbook Functions Im Conjugate Request Builder.
 */
public interface IBaseWorkbookFunctionsImConjugateRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsImConjugateRequest instance
     */
    IWorkbookFunctionsImConjugateRequest buildRequest(final java.util.List<Option> requestOptions);
}
