...
public class BaseWorkbookChartGridlinesRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartGridlinesRequestBuilder {
     ...
     */
    public BaseWorkbookChartGridlinesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartGridlinesRequest buildRequest(final java.util.List<Option> requestOptions) {
