...
/**
 * The class for the Base Device Configuration User Status Collection Request.
 */
public class BaseDeviceConfigurationUserStatusCollectionRequest extends BaseCollectionRequest<BaseDeviceConfigurationUserStatusCollectionResponse, IDeviceConfigurationUserStatusCollectionPage> implements IBaseDeviceConfigurationUserStatusCollectionRequest {
     ...
     */
    public BaseDeviceConfigurationUserStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceConfigurationUserStatusCollectionPage get() throws ClientException {
        final BaseDeviceConfigurationUserStatusCollectionResponse response = send();
    ...
    public IDeviceConfigurationUserStatusCollectionPage buildFromResponse(final BaseDeviceConfigurationUserStatusCollectionResponse response) {
