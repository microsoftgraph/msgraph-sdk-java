...
/**
 * The class for the Base Teams App Definition With Reference Request.
 */
public class BaseTeamsAppDefinitionWithReferenceRequest extends BaseRequest implements IBaseTeamsAppDefinitionWithReferenceRequest {
     ...
     */
    public BaseTeamsAppDefinitionWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
