...
/**
 * The class for the Base Shared Insight Collection Request.
 */
public class BaseSharedInsightCollectionRequest extends BaseCollectionRequest<BaseSharedInsightCollectionResponse, ISharedInsightCollectionPage> implements IBaseSharedInsightCollectionRequest {
     ...
     */
    public BaseSharedInsightCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseSharedInsightCollectionResponse.class, ISharedInsightCollectionPage.class);
    }
    ...
    public ISharedInsightCollectionPage get() throws ClientException {
        final BaseSharedInsightCollectionResponse response = send();
    ...
    public ISharedInsightCollectionPage buildFromResponse(final BaseSharedInsightCollectionResponse response) {
