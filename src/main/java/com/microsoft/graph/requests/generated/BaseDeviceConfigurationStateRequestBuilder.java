...
/**
 * The class for the Base Device Configuration State Request Builder.
 */
public class BaseDeviceConfigurationStateRequestBuilder extends BaseRequestBuilder implements IBaseDeviceConfigurationStateRequestBuilder {
     ...
     */
    public BaseDeviceConfigurationStateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
