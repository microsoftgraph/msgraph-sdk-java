...
public class BaseWorkbookNamedItemRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookNamedItemRequestBuilder {
     ...
     */
    public BaseWorkbookNamedItemRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookNamedItemRequest buildRequest(final java.util.List<Option> requestOptions) {
