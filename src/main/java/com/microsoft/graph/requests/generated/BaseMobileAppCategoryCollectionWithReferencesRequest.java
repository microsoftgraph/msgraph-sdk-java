...
/**
 * The class for the Base Mobile App Category Collection With References Request.
 */
public class BaseMobileAppCategoryCollectionWithReferencesRequest extends BaseCollectionRequest<BaseMobileAppCategoryCollectionResponse, IMobileAppCategoryCollectionPage> implements IBaseMobileAppCategoryCollectionWithReferencesRequest {
     ...
     */
    public BaseMobileAppCategoryCollectionWithReferencesRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IMobileAppCategoryCollectionWithReferencesPage get() throws ClientException {
        final BaseMobileAppCategoryCollectionResponse response = send();
    ...
    public IMobileAppCategoryCollectionWithReferencesPage buildFromResponse(final BaseMobileAppCategoryCollectionResponse response) {
