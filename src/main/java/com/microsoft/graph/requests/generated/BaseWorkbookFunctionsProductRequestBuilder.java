...
/**
 * The class for the Base Workbook Functions Product Request Builder.
 */
public class BaseWorkbookFunctionsProductRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsProductRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return the IWorkbookFunctionsProductRequest instance
     */
    public IWorkbookFunctionsProductRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
