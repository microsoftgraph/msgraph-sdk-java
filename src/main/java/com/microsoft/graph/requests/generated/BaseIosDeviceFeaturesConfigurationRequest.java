...
/**
 * The class for the Base Ios Device Features Configuration Request.
 */
public class BaseIosDeviceFeaturesConfigurationRequest extends BaseRequest implements IBaseIosDeviceFeaturesConfigurationRequest {
     ...
     */
    public BaseIosDeviceFeaturesConfigurationRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<IosDeviceFeaturesConfiguration> responseClass) {
