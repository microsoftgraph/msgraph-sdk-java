...
/**
 * The interface for the Base Device Enrollment Configuration Assign Request Builder.
 */
public interface IBaseDeviceEnrollmentConfigurationAssignRequestBuilder extends IRequestBuilder {
     ...
     * @return the IDeviceEnrollmentConfigurationAssignRequest instance
     */
    IDeviceEnrollmentConfigurationAssignRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
