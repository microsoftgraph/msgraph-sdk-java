...
/**
 * The class for the Base Directory Request Builder.
 */
public class BaseDirectoryRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRequestBuilder {
     ...
     */
    public BaseDirectoryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
