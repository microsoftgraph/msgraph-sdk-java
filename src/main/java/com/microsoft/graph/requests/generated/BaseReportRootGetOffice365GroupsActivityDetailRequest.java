...
/**
 * The class for the Base Report Root Get Office365Groups Activity Detail Request.
 */
public class BaseReportRootGetOffice365GroupsActivityDetailRequest extends BaseRequest implements IBaseReportRootGetOffice365GroupsActivityDetailRequest {
     ...
     */
    public BaseReportRootGetOffice365GroupsActivityDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetOffice365GroupsActivityDetail
    ...
    /**
     * Puts the ReportRootGetOffice365GroupsActivityDetail
     *
