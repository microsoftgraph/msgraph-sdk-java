...
/**
 * The class for the Base Report Root Get One Drive Usage Storage Request.
 */
public class BaseReportRootGetOneDriveUsageStorageRequest extends BaseRequest implements IBaseReportRootGetOneDriveUsageStorageRequest {
     ...
     */
    public BaseReportRootGetOneDriveUsageStorageRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
