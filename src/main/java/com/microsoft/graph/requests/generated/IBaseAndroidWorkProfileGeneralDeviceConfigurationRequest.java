...
/**
 * The interface for the Base Android Work Profile General Device Configuration Request.
 */
public interface IBaseAndroidWorkProfileGeneralDeviceConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseAndroidWorkProfileGeneralDeviceConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseAndroidWorkProfileGeneralDeviceConfigurationRequest expand(final String value);
