...
/**
 * The class for the Base Alert Collection Request.
 */
public class BaseAlertCollectionRequest extends BaseCollectionRequest<BaseAlertCollectionResponse, IAlertCollectionPage> implements IBaseAlertCollectionRequest {
     ...
     */
    public BaseAlertCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAlertCollectionPage get() throws ClientException {
        final BaseAlertCollectionResponse response = send();
    ...
    public IAlertCollectionPage buildFromResponse(final BaseAlertCollectionResponse response) {
