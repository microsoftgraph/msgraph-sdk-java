...
/**
 * The interface for the Base Mac OSCustom Configuration Request.
 */
public interface IBaseMacOSCustomConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseMacOSCustomConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMacOSCustomConfigurationRequest expand(final String value);
