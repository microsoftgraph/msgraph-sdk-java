...
/**
 * The interface for the Base Report Root Get Yammer Groups Activity Counts Request.
 */
public interface IBaseReportRootGetYammerGroupsActivityCountsRequest {
     ...
     */
    IReportRootGetYammerGroupsActivityCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetYammerGroupsActivityCountsRequest expand(final String value);
