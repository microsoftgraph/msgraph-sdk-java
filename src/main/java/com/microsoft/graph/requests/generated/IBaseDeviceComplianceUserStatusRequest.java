...
/**
 * The interface for the Base Device Compliance User Status Request.
 */
public interface IBaseDeviceComplianceUserStatusRequest extends IHttpRequest {
     ...
     */
    IBaseDeviceComplianceUserStatusRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceComplianceUserStatusRequest expand(final String value);
