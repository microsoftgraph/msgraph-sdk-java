...
/**
 * The class for the Base Role Definition Request.
 */
public class BaseRoleDefinitionRequest extends BaseRequest implements IBaseRoleDefinitionRequest {
     ...
     */
    public BaseRoleDefinitionRequest(final String requestUrl,
