...
/**
 * The class for the Base Terms And Conditions Assignment Collection Request.
 */
public class BaseTermsAndConditionsAssignmentCollectionRequest extends BaseCollectionRequest<BaseTermsAndConditionsAssignmentCollectionResponse, ITermsAndConditionsAssignmentCollectionPage> implements IBaseTermsAndConditionsAssignmentCollectionRequest {
     ...
     */
    public BaseTermsAndConditionsAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITermsAndConditionsAssignmentCollectionPage get() throws ClientException {
        final BaseTermsAndConditionsAssignmentCollectionResponse response = send();
    ...
    public ITermsAndConditionsAssignmentCollectionPage buildFromResponse(final BaseTermsAndConditionsAssignmentCollectionResponse response) {
