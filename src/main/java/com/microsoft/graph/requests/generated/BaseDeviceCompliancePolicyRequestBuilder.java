...
/**
 * The class for the Base Device Compliance Policy Request Builder.
 */
public class BaseDeviceCompliancePolicyRequestBuilder extends BaseRequestBuilder implements IBaseDeviceCompliancePolicyRequestBuilder {
     ...
     */
    public BaseDeviceCompliancePolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
