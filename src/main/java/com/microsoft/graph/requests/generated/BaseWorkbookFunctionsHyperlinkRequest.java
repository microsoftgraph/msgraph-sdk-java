...
public class BaseWorkbookFunctionsHyperlinkRequest extends BaseRequest implements IBaseWorkbookFunctionsHyperlinkRequest {
     ...
     */
    public BaseWorkbookFunctionsHyperlinkRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookFunctionsHyperlinkRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsHyperlinkRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsHyperlinkRequest expand(final String value) {
