...
/**
 * The class for the Base Workbook Functions Trim Mean Request Builder.
 */
public class BaseWorkbookFunctionsTrimMeanRequestBuilder extends BaseActionRequestBuilder {
     ...
     * @return The IWorkbookFunctionsTrimMeanRequest instance
     */
    public IWorkbookFunctionsTrimMeanRequest buildRequest(final java.util.List<Option> requestOptions) {
