...
/**
 * The class for the Base Teams App Installation Upgrade Request Builder.
 */
public class BaseTeamsAppInstallationUpgradeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseTeamsAppInstallationUpgradeRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
