...
/**
 * The interface for the Base Mac OSDevice Features Configuration Request.
 */
public interface IBaseMacOSDeviceFeaturesConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseMacOSDeviceFeaturesConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMacOSDeviceFeaturesConfigurationRequest expand(final String value);
