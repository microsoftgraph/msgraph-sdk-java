...
/**
 * The interface for the Base Report Root Get One Drive Activity File Counts Request.
 */
public interface IBaseReportRootGetOneDriveActivityFileCountsRequest {
    ...
    /**
     * Puts the ReportRootGetOneDriveActivityFileCounts
     *
     ...
     */
    IReportRootGetOneDriveActivityFileCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetOneDriveActivityFileCountsRequest expand(final String value);
