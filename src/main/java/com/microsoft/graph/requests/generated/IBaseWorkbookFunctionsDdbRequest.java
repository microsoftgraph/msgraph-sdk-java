...
/**
 * The interface for the Base Workbook Functions Ddb Request.
 */
public interface IBaseWorkbookFunctionsDdbRequest {
     ...
     */
    IWorkbookFunctionsDdbRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookFunctionsDdbRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsDdbRequest expand(final String value);
