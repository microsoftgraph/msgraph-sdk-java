...
/**
 * The interface for the Base Windows Information Protection Request.
 */
public interface IBaseWindowsInformationProtectionRequest extends IHttpRequest {
     ...
     */
    IBaseWindowsInformationProtectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseWindowsInformationProtectionRequest expand(final String value);
