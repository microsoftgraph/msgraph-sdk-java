...
/**
 * The interface for the Base Android Managed App Registration Request.
 */
public interface IBaseAndroidManagedAppRegistrationRequest extends IHttpRequest {
     ...
     */
    IBaseAndroidManagedAppRegistrationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseAndroidManagedAppRegistrationRequest expand(final String value);
