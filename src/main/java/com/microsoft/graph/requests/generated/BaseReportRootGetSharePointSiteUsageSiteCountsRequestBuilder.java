...
public class BaseReportRootGetSharePointSiteUsageSiteCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageSiteCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetSharePointSiteUsageSiteCountsRequest instance
     */
    public IReportRootGetSharePointSiteUsageSiteCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
