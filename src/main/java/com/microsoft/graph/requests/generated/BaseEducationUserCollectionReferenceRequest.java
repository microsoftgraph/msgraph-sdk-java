...
/**
 * The class for the Base Education User Collection Reference Request.
 */
public class BaseEducationUserCollectionReferenceRequest extends BaseCollectionRequest<BaseEducationUserCollectionResponse, IEducationUserCollectionPage> implements IBaseEducationUserCollectionReferenceRequest {
     ...
     */
    public BaseEducationUserCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
