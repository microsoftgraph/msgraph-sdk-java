...
/**
 * The class for the Base Device Configuration State Collection Request Builder.
 */
public class BaseDeviceConfigurationStateCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDeviceConfigurationStateCollectionRequestBuilder {
     ...
     */
    public BaseDeviceConfigurationStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceConfigurationStateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new DeviceConfigurationStateCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IDeviceConfigurationStateRequestBuilder byId(final String id) {
