...
public class BaseReportRootGetOneDriveUsageStorageRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOneDriveUsageStorageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetOneDriveUsageStorageRequest instance
     */
    public IReportRootGetOneDriveUsageStorageRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
