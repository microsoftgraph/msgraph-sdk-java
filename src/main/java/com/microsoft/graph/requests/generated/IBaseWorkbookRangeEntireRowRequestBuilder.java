...
/**
 * The interface for the Base Workbook Range Entire Row Request Builder.
 */
public interface IBaseWorkbookRangeEntireRowRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookRangeEntireRowRequest instance
     */
    IWorkbookRangeEntireRowRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
