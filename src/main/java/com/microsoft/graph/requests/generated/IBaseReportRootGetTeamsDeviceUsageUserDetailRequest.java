...
/**
 * The interface for the Base Report Root Get Teams Device Usage User Detail Request.
 */
public interface IBaseReportRootGetTeamsDeviceUsageUserDetailRequest {
    ...
    /**
     * Puts the ReportRootGetTeamsDeviceUsageUserDetail
     *
     ...
     */
    IReportRootGetTeamsDeviceUsageUserDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetTeamsDeviceUsageUserDetailRequest expand(final String value);
