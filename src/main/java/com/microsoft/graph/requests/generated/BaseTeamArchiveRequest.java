...
/**
 * The class for the Base Team Archive Request.
 */
public class BaseTeamArchiveRequest extends BaseRequest implements IBaseTeamArchiveRequest {
     ...
     */
    public BaseTeamArchiveRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
