...
/**
 * The interface for the Base Windows Update For Business Configuration Request.
 */
public interface IBaseWindowsUpdateForBusinessConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseWindowsUpdateForBusinessConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseWindowsUpdateForBusinessConfigurationRequest expand(final String value);
