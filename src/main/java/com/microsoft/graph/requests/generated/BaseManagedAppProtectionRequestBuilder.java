...
/**
 * The class for the Base Managed App Protection Request Builder.
 */
public class BaseManagedAppProtectionRequestBuilder extends BaseRequestBuilder implements IBaseManagedAppProtectionRequestBuilder {
     ...
     */
    public BaseManagedAppProtectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
