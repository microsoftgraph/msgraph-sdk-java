...
public class BaseWorkbookNamedItemAddFormulaLocalRequest extends BaseRequest implements IBaseWorkbookNamedItemAddFormulaLocalRequest {
     ...
     */
    public BaseWorkbookNamedItemAddFormulaLocalRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookNamedItemAddFormulaLocalRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookNamedItemAddFormulaLocalRequest)this;
    }
     ...
     * @return The updated request
     */
    public IWorkbookNamedItemAddFormulaLocalRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookNamedItemAddFormulaLocalRequest expand(final String value) {
