...
/**
 * The interface for the Base Workbook Functions Not Request Builder.
 */
public interface IBaseWorkbookFunctionsNotRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsNotRequest instance
     */
    IWorkbookFunctionsNotRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
