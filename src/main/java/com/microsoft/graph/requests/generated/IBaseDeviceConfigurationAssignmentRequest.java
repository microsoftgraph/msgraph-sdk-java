...
/**
 * The interface for the Base Device Configuration Assignment Request.
 */
public interface IBaseDeviceConfigurationAssignmentRequest extends IHttpRequest {
     ...
     */
    void get(final ICallback<DeviceConfigurationAssignment> callback);
     ...
     */
    void delete(final ICallback<DeviceConfigurationAssignment> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void patch(final DeviceConfigurationAssignment sourceDeviceConfigurationAssignment, final ICallback<DeviceConfigurationAssignment> callback);
     ...
     */
    IBaseDeviceConfigurationAssignmentRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceConfigurationAssignmentRequest expand(final String value);
