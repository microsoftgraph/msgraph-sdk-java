...
/**
 * The interface for the Base User Install State Summary Request.
 */
public interface IBaseUserInstallStateSummaryRequest extends IHttpRequest {
     ...
     */
    IBaseUserInstallStateSummaryRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseUserInstallStateSummaryRequest expand(final String value);
