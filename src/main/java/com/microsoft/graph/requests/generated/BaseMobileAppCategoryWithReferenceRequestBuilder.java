...
/**
 * The class for the Base Mobile App Category With Reference Request Builder.
 */
public class BaseMobileAppCategoryWithReferenceRequestBuilder extends BaseRequestBuilder implements IBaseMobileAppCategoryWithReferenceRequestBuilder {
     ...
     */
    public BaseMobileAppCategoryWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
