...
/**
 * The interface for the Base Workbook Functions Kurt Request.
 */
public interface IBaseWorkbookFunctionsKurtRequest {
     ...
     */
    IWorkbookFunctionsKurtRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookFunctionsKurtRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsKurtRequest expand(final String value);
