...
/**
 * The class for the Base Workbook Range View Range Request.
 */
public class BaseWorkbookRangeViewRangeRequest extends BaseRequest implements IBaseWorkbookRangeViewRangeRequest {
     ...
     */
    public BaseWorkbookRangeViewRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
