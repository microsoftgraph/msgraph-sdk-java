...
/**
 * The class for the Base Setting State Device Summary Request Builder.
 */
public class BaseSettingStateDeviceSummaryRequestBuilder extends BaseRequestBuilder implements IBaseSettingStateDeviceSummaryRequestBuilder {
     ...
     */
    public BaseSettingStateDeviceSummaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
