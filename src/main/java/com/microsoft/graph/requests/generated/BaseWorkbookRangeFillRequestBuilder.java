...
public class BaseWorkbookRangeFillRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookRangeFillRequestBuilder {
     ...
     */
    public BaseWorkbookRangeFillRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IWorkbookRangeFillRequest buildRequest(final java.util.List<Option> requestOptions) {
