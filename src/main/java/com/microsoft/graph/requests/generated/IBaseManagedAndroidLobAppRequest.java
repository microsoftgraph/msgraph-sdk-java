...
/**
 * The interface for the Base Managed Android Lob App Request.
 */
public interface IBaseManagedAndroidLobAppRequest extends IHttpRequest {
     ...
     */
    IBaseManagedAndroidLobAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseManagedAndroidLobAppRequest expand(final String value);
