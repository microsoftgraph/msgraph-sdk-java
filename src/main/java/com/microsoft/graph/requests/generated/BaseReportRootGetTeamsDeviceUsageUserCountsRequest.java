...
/**
 * The class for the Base Report Root Get Teams Device Usage User Counts Request.
 */
public class BaseReportRootGetTeamsDeviceUsageUserCountsRequest extends BaseRequest implements IBaseReportRootGetTeamsDeviceUsageUserCountsRequest {
     ...
     */
    public BaseReportRootGetTeamsDeviceUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
