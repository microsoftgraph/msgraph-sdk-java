...
/**
 * The class for the Base Drive Item Preview Request Builder.
 */
public class BaseDriveItemPreviewRequestBuilder extends BaseActionRequestBuilder {
     ...
     * @param zoom the zoom
     */
    public BaseDriveItemPreviewRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String page, final Double zoom) {
