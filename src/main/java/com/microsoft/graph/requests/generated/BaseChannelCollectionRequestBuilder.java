...
/**
 * The class for the Base Channel Collection Request Builder.
 */
public class BaseChannelCollectionRequestBuilder extends BaseRequestBuilder implements IBaseChannelCollectionRequestBuilder {
     ...
     */
    public BaseChannelCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
