...
/**
 * The class for the Base On Premises Conditional Access Settings Request Builder.
 */
public class BaseOnPremisesConditionalAccessSettingsRequestBuilder extends BaseRequestBuilder implements IBaseOnPremisesConditionalAccessSettingsRequestBuilder {
     ...
     */
    public BaseOnPremisesConditionalAccessSettingsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
