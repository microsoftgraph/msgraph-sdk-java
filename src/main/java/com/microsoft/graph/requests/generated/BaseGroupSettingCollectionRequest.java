...
/**
 * The class for the Base Group Setting Collection Request.
 */
public class BaseGroupSettingCollectionRequest extends BaseCollectionRequest<BaseGroupSettingCollectionResponse, IGroupSettingCollectionPage> implements IBaseGroupSettingCollectionRequest {
     ...
     */
    public BaseGroupSettingCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IGroupSettingCollectionPage get() throws ClientException {
        final BaseGroupSettingCollectionResponse response = send();
    ...
    public IGroupSettingCollectionPage buildFromResponse(final BaseGroupSettingCollectionResponse response) {
