...
/**
 * The class for the Base Report Root Get Office365Active User Detail Request.
 */
public class BaseReportRootGetOffice365ActiveUserDetailRequest extends BaseRequest implements IBaseReportRootGetOffice365ActiveUserDetailRequest {
     ...
     */
    public BaseReportRootGetOffice365ActiveUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetOffice365ActiveUserDetail
    ...
    /**
     * Puts the ReportRootGetOffice365ActiveUserDetail
     *
     ...
     */
    public IReportRootGetOffice365ActiveUserDetailRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetOffice365ActiveUserDetailRequest)this;
    }
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActiveUserDetailRequest expand(final String value) {
