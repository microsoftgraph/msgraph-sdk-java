...
/**
 * The class for the Base Microsoft Store For Business App Request.
 */
public class BaseMicrosoftStoreForBusinessAppRequest extends BaseRequest implements IBaseMicrosoftStoreForBusinessAppRequest {
     ...
     */
    public BaseMicrosoftStoreForBusinessAppRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<MicrosoftStoreForBusinessApp> responseClass) {
