...
public class BaseWorkbookFunctionsImExpRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImExpRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImExpRequest instance
     */
    public IWorkbookFunctionsImExpRequest buildRequest(final java.util.List<Option> requestOptions) {
