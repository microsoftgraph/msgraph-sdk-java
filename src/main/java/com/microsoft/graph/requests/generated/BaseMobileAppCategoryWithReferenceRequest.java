...
/**
 * The class for the Base Mobile App Category With Reference Request.
 */
public class BaseMobileAppCategoryWithReferenceRequest extends BaseRequest implements IBaseMobileAppCategoryWithReferenceRequest {
     ...
     */
    public BaseMobileAppCategoryWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
