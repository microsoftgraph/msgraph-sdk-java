...
/**
 * The class for the Base Teams App With Reference Request.
 */
public class BaseTeamsAppWithReferenceRequest extends BaseRequest implements IBaseTeamsAppWithReferenceRequest {
     ...
     */
    public BaseTeamsAppWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
