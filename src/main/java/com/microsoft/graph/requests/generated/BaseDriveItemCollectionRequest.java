...
/**
 * The class for the Base Drive Item Collection Request.
 */
public class BaseDriveItemCollectionRequest extends BaseCollectionRequest<BaseDriveItemCollectionResponse, IDriveItemCollectionPage> implements IBaseDriveItemCollectionRequest {
     ...
     */
    public BaseDriveItemCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDriveItemCollectionPage get() throws ClientException {
        final BaseDriveItemCollectionResponse response = send();
