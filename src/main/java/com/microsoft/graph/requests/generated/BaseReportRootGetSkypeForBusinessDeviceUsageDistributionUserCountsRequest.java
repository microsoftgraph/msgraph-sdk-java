...
/**
 * The class for the Base Report Root Get Skype For Business Device Usage Distribution User Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCounts
    ...
    /**
     * Puts the ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCounts
     *
     ...
     */
    public IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest expand(final String value) {
