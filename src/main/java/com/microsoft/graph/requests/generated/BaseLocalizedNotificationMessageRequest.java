...
/**
 * The class for the Base Localized Notification Message Request.
 */
public class BaseLocalizedNotificationMessageRequest extends BaseRequest implements IBaseLocalizedNotificationMessageRequest {
     ...
     */
    public BaseLocalizedNotificationMessageRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<LocalizedNotificationMessage> responseClass) {
