...
/**
 * The interface for the Base Teams Tab Request.
 */
public interface IBaseTeamsTabRequest extends IHttpRequest {
     ...
     */
    IBaseTeamsTabRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseTeamsTabRequest expand(final String value);
