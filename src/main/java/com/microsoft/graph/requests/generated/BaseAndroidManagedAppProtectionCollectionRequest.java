...
/**
 * The class for the Base Android Managed App Protection Collection Request.
 */
public class BaseAndroidManagedAppProtectionCollectionRequest extends BaseCollectionRequest<BaseAndroidManagedAppProtectionCollectionResponse, IAndroidManagedAppProtectionCollectionPage> implements IBaseAndroidManagedAppProtectionCollectionRequest {
     ...
     */
    public BaseAndroidManagedAppProtectionCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAndroidManagedAppProtectionCollectionPage get() throws ClientException {
        final BaseAndroidManagedAppProtectionCollectionResponse response = send();
    ...
    public IAndroidManagedAppProtectionCollectionPage buildFromResponse(final BaseAndroidManagedAppProtectionCollectionResponse response) {
        ...
        final AndroidManagedAppProtectionCollectionPage page = new AndroidManagedAppProtectionCollectionPage(response, builder);
