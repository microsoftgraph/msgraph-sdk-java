...
/**
 * The interface for the Base Teams App Definition With Reference Request.
 */
public interface IBaseTeamsAppDefinitionWithReferenceRequest extends IHttpRequest {
    ...
    IBaseTeamsAppDefinitionWithReferenceRequest select(final String value);

    IBaseTeamsAppDefinitionWithReferenceRequest expand(final String value);
