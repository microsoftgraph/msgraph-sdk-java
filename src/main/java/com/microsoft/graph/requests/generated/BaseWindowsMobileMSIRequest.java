...
/**
 * The class for the Base Windows Mobile MSIRequest.
 */
public class BaseWindowsMobileMSIRequest extends BaseRequest implements IBaseWindowsMobileMSIRequest {
     ...
     */
    public BaseWindowsMobileMSIRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<WindowsMobileMSI> responseClass) {
