...
/**
 * The class for the Base Group Lifecycle Policy Remove Group Request.
 */
public class BaseGroupLifecyclePolicyRemoveGroupRequest extends BaseRequest implements IBaseGroupLifecyclePolicyRemoveGroupRequest {
     ...
     */
    public BaseGroupLifecyclePolicyRemoveGroupRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IGroupLifecyclePolicyRemoveGroupRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IGroupLifecyclePolicyRemoveGroupRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IGroupLifecyclePolicyRemoveGroupRequest expand(final String value) {
