...
/**
 * The interface for the Base Team Request.
 */
public interface IBaseTeamRequest extends IHttpRequest {
     ...
     */
    void get(final ICallback<Team> callback);
     ...
     */
    void delete(final ICallback<Team> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void patch(final Team sourceTeam, final ICallback<Team> callback);
     ...
     */
    IBaseTeamRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseTeamRequest expand(final String value);
