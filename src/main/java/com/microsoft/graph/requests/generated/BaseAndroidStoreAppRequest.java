...
/**
 * The class for the Base Android Store App Request.
 */
public class BaseAndroidStoreAppRequest extends BaseRequest implements IBaseAndroidStoreAppRequest {
     ...
     */
    public BaseAndroidStoreAppRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<AndroidStoreApp> responseClass) {
