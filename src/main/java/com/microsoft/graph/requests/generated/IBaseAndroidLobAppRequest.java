...
/**
 * The interface for the Base Android Lob App Request.
 */
public interface IBaseAndroidLobAppRequest extends IHttpRequest {
     ...
     */
    IBaseAndroidLobAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseAndroidLobAppRequest expand(final String value);
