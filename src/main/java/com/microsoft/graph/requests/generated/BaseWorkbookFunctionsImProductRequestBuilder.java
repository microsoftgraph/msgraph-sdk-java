...
public class BaseWorkbookFunctionsImProductRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImProductRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsImProductRequest instance
     */
    public IWorkbookFunctionsImProductRequest buildRequest(final java.util.List<Option> requestOptions) {
