...
/**
 * The class for the Base Workbook Range Last Column Request.
 */
public class BaseWorkbookRangeLastColumnRequest extends BaseRequest implements IBaseWorkbookRangeLastColumnRequest {
     ...
     */
    public BaseWorkbookRangeLastColumnRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookRangeLastColumnRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookRangeLastColumnRequest expand(final String value) {
