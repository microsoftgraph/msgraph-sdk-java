...
/**
 * The class for the Base Team Archive Request Builder.
 */
public class BaseTeamArchiveRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseTeamArchiveRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Boolean shouldSetSpoSiteReadOnlyForMembers) {
     ...
     * @return the ITeamArchiveRequest instance
     */
    public ITeamArchiveRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
