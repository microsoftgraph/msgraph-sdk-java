...
/**
 * The interface for the Base Device Configuration State Request.
 */
public interface IBaseDeviceConfigurationStateRequest extends IHttpRequest {
     ...
     */
    IBaseDeviceConfigurationStateRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceConfigurationStateRequest expand(final String value);
