...
/**
 * The class for the Base Report Root Get Share Point Site Usage Storage Request Builder.
 */
public class BaseReportRootGetSharePointSiteUsageStorageRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageStorageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetSharePointSiteUsageStorageRequest instance
     */
    public IReportRootGetSharePointSiteUsageStorageRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
