...
/**
 * The interface for the Base Targeted Managed App Policy Assignment Request.
 */
public interface IBaseTargetedManagedAppPolicyAssignmentRequest extends IHttpRequest {
     ...
     */
    IBaseTargetedManagedAppPolicyAssignmentRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseTargetedManagedAppPolicyAssignmentRequest expand(final String value);
