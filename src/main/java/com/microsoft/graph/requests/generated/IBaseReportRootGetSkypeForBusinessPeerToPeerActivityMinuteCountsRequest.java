...
/**
 * The interface for the Base Report Root Get Skype For Business Peer To Peer Activity Minute Counts Request.
 */
public interface IBaseReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest {
     ...
     */
    IReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest expand(final String value);
