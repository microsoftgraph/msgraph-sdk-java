...
/**
 * The interface for the Base Workbook Functions Coup Days Nc Request Builder.
 */
public interface IBaseWorkbookFunctionsCoupDaysNcRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsCoupDaysNcRequest instance
     */
    IWorkbookFunctionsCoupDaysNcRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
