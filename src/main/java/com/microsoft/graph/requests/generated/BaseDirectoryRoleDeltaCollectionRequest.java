...
/**
 * The class for the Base Directory Role Delta Collection Request.
 */
public class BaseDirectoryRoleDeltaCollectionRequest extends BaseCollectionRequest<BaseDirectoryRoleDeltaCollectionResponse, IDirectoryRoleDeltaCollectionPage> implements IBaseDirectoryRoleDeltaCollectionRequest {
     ...
     */
    public BaseDirectoryRoleDeltaCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDirectoryRoleDeltaCollectionPage get() throws ClientException {
        final BaseDirectoryRoleDeltaCollectionResponse response = send();
        return buildFromResponse(response);
    }


    public IDirectoryRoleDeltaCollectionPage buildFromResponse(final BaseDirectoryRoleDeltaCollectionResponse response) {
