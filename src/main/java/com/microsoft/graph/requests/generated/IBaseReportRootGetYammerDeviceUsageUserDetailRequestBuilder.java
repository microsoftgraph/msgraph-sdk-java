...
/**
 * The interface for the Base Report Root Get Yammer Device Usage User Detail Request Builder.
 */
public interface IBaseReportRootGetYammerDeviceUsageUserDetailRequestBuilder extends IRequestBuilder {
     ...
     * @return the IReportRootGetYammerDeviceUsageUserDetailRequest instance
     */
    IReportRootGetYammerDeviceUsageUserDetailRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
