...
/**
 * The interface for the Base Windows10Compliance Policy Request.
 */
public interface IBaseWindows10CompliancePolicyRequest extends IHttpRequest {
     ...
     */
    IBaseWindows10CompliancePolicyRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseWindows10CompliancePolicyRequest expand(final String value);
