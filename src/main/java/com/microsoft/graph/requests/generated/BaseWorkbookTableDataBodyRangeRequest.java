...
/**
 * The class for the Base Workbook Table Data Body Range Request.
 */
public class BaseWorkbookTableDataBodyRangeRequest extends BaseRequest implements IBaseWorkbookTableDataBodyRangeRequest {
     ...
     */
    public BaseWorkbookTableDataBodyRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
