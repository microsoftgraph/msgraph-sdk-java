...
/**
 * The class for the Base Default Managed App Protection Request Builder.
 */
public class BaseDefaultManagedAppProtectionRequestBuilder extends BaseRequestBuilder implements IBaseDefaultManagedAppProtectionRequestBuilder {
     ...
     */
    public BaseDefaultManagedAppProtectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
