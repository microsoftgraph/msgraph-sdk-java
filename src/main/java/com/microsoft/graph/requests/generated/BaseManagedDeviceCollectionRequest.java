...
/**
 * The class for the Base Managed Device Collection Request.
 */
public class BaseManagedDeviceCollectionRequest extends BaseCollectionRequest<BaseManagedDeviceCollectionResponse, IManagedDeviceCollectionPage> implements IBaseManagedDeviceCollectionRequest {
     ...
     */
    public BaseManagedDeviceCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IManagedDeviceCollectionPage buildFromResponse(final BaseManagedDeviceCollectionResponse response) {
