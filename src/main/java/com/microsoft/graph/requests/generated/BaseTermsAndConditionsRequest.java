...
/**
 * The class for the Base Terms And Conditions Request.
 */
public class BaseTermsAndConditionsRequest extends BaseRequest implements IBaseTermsAndConditionsRequest {
     ...
     */
    public BaseTermsAndConditionsRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<TermsAndConditions> responseClass) {
