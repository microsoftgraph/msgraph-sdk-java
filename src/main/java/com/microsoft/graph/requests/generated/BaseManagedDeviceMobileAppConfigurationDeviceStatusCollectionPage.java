...
/**
 * The class for the Base Managed Device Mobile App Configuration Device Status Collection Page.
 */
public class BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage extends BaseCollectionPage<ManagedDeviceMobileAppConfigurationDeviceStatus, IManagedDeviceMobileAppConfigurationDeviceStatusCollectionRequestBuilder> implements IBaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage {
     ...
     */
    public BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage(final BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse response, final IManagedDeviceMobileAppConfigurationDeviceStatusCollectionRequestBuilder builder) {
