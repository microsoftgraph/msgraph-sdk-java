...
/**
 * The class for the Base Managed Device Recover Passcode Request.
 */
public class BaseManagedDeviceRecoverPasscodeRequest extends BaseRequest implements IBaseManagedDeviceRecoverPasscodeRequest {
     ...
     */
    public BaseManagedDeviceRecoverPasscodeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
