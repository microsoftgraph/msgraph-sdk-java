...
/**
 * The class for the Base Report Root Get Office365Groups Activity File Counts Request.
 */
public class BaseReportRootGetOffice365GroupsActivityFileCountsRequest extends BaseRequest implements IBaseReportRootGetOffice365GroupsActivityFileCountsRequest {
     ...
     */
    public BaseReportRootGetOffice365GroupsActivityFileCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
