...
/**
 * The class for the Base Mobile App Category Reference Request.
 */
public class BaseMobileAppCategoryReferenceRequest extends BaseRequest implements IBaseMobileAppCategoryReferenceRequest {
     ...
     */
    public BaseMobileAppCategoryReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
