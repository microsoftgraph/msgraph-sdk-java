...
/**
 * The interface for the Base Report Root Get Share Point Site Usage Site Counts Request.
 */
public interface IBaseReportRootGetSharePointSiteUsageSiteCountsRequest {
     ...
     */
    IReportRootGetSharePointSiteUsageSiteCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSharePointSiteUsageSiteCountsRequest expand(final String value);
