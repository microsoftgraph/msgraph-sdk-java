...
/**
 * The interface for the Base Localized Notification Message Request.
 */
public interface IBaseLocalizedNotificationMessageRequest extends IHttpRequest {
     ...
     */
    IBaseLocalizedNotificationMessageRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseLocalizedNotificationMessageRequest expand(final String value);
