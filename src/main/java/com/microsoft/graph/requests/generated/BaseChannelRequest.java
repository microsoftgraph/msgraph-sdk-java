...
/**
 * The class for the Base Channel Request.
 */
public class BaseChannelRequest extends BaseRequest implements IBaseChannelRequest {
     ...
     */
    public BaseChannelRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<Channel> responseClass) {
