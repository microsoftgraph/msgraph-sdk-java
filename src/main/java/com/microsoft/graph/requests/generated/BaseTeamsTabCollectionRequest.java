...
/**
 * The class for the Base Teams Tab Collection Request.
 */
public class BaseTeamsTabCollectionRequest extends BaseCollectionRequest<BaseTeamsTabCollectionResponse, ITeamsTabCollectionPage> implements IBaseTeamsTabCollectionRequest {
     ...
     */
    public BaseTeamsTabCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITeamsTabCollectionPage get() throws ClientException {
        final BaseTeamsTabCollectionResponse response = send();
    ...
    public ITeamsTabCollectionPage buildFromResponse(final BaseTeamsTabCollectionResponse response) {
