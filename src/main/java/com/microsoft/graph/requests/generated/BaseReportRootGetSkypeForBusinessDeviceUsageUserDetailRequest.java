...
/**
 * The class for the Base Report Root Get Skype For Business Device Usage User Detail Request.
 */
public class BaseReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    /**
     * Puts the ReportRootGetSkypeForBusinessDeviceUsageUserDetail
     *
     ...
     */
    public IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest)this;
    }
     ...
     * @return the updated request
     */
    public IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest expand(final String value) {
