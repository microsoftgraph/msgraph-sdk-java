...
/**
 * The interface for the Base Teams App With Reference Request.
 */
public interface IBaseTeamsAppWithReferenceRequest extends IHttpRequest {
    ...
    IBaseTeamsAppWithReferenceRequest select(final String value);

    IBaseTeamsAppWithReferenceRequest expand(final String value);
