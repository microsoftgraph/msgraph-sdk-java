...
/**
 * The interface for the Base Workbook Range Column Request Builder.
 */
public interface IBaseWorkbookRangeColumnRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookRangeColumnRequest instance
     */
    IWorkbookRangeColumnRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
