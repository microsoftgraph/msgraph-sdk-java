...
/**
 * The interface for the Base Workbook Functions Eo Month Request.
 */
public interface IBaseWorkbookFunctionsEoMonthRequest {
     ...
     */
    IWorkbookFunctionsEoMonthRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookFunctionsEoMonthRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsEoMonthRequest expand(final String value);
