...
/**
 * The class for the Base Resource Operation Request Builder.
 */
public class BaseResourceOperationRequestBuilder extends BaseRequestBuilder implements IBaseResourceOperationRequestBuilder {
     ...
     */
    public BaseResourceOperationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
