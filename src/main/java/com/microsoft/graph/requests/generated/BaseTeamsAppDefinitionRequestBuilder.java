...
/**
 * The class for the Base Teams App Definition Request Builder.
 */
public class BaseTeamsAppDefinitionRequestBuilder extends BaseRequestBuilder implements IBaseTeamsAppDefinitionRequestBuilder {
     ...
     */
    public BaseTeamsAppDefinitionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
