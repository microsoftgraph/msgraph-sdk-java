...
/**
 * The interface for the Base Device Management Verify Windows Enrollment Auto Discovery Request Builder.
 */
public interface IBaseDeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequestBuilder extends IRequestBuilder {
     ...
     * @return the IDeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest instance
     */
    IDeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
