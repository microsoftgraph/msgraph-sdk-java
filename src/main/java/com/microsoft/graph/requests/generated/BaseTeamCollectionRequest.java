...
/**
 * The class for the Base Team Collection Request.
 */
public class BaseTeamCollectionRequest extends BaseCollectionRequest<BaseTeamCollectionResponse, ITeamCollectionPage> implements IBaseTeamCollectionRequest {
     ...
     */
    public BaseTeamCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseTeamCollectionResponse.class, ITeamCollectionPage.class);
    }
    ...
    public ITeamCollectionPage get() throws ClientException {
        final BaseTeamCollectionResponse response = send();
    ...
    public ITeamCollectionPage buildFromResponse(final BaseTeamCollectionResponse response) {
