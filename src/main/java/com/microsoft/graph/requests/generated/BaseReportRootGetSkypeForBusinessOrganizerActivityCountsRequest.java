...
/**
 * The class for the Base Report Root Get Skype For Business Organizer Activity Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessOrganizerActivityCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessOrganizerActivityCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessOrganizerActivityCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
