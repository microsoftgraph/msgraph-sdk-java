...
public class BaseWorkbookFunctionsImSinhRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSinhRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImSinhRequest instance
     */
    public IWorkbookFunctionsImSinhRequest buildRequest(final java.util.List<Option> requestOptions) {
