...
public class BaseReportRootGetOffice365GroupsActivityStorageRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365GroupsActivityStorageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
