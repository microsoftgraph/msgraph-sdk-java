...
/**
 * The class for the Base Report Root Get Skype For Business Organizer Activity User Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
