...
/**
 * The class for the Base Team Unarchive Request Builder.
 */
public class BaseTeamUnarchiveRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseTeamUnarchiveRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
