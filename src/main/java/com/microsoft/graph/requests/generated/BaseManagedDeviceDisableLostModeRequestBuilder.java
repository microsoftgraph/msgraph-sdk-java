...
/**
 * The class for the Base Managed Device Disable Lost Mode Request Builder.
 */
public class BaseManagedDeviceDisableLostModeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseManagedDeviceDisableLostModeRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
