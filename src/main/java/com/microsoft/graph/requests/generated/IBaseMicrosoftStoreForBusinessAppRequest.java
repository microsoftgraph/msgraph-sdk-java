...
/**
 * The interface for the Base Microsoft Store For Business App Request.
 */
public interface IBaseMicrosoftStoreForBusinessAppRequest extends IHttpRequest {
     ...
     */
    IBaseMicrosoftStoreForBusinessAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMicrosoftStoreForBusinessAppRequest expand(final String value);
