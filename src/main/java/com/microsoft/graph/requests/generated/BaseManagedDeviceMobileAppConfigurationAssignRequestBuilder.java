...
/**
 * The class for the Base Managed Device Mobile App Configuration Assign Request Builder.
 */
public class BaseManagedDeviceMobileAppConfigurationAssignRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseManagedDeviceMobileAppConfigurationAssignRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<ManagedDeviceMobileAppConfigurationAssignment> assignments) {
     ...
     * @return the IManagedDeviceMobileAppConfigurationAssignRequest instance
     */
    public IManagedDeviceMobileAppConfigurationAssignRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
