...
/**
 * The class for the Base Onenote Operation Collection Response.
 */
public class BaseOnenoteOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OnenoteOperation within this collection page
     */
