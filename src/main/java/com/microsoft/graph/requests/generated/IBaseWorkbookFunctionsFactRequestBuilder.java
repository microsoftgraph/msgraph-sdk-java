...
/**
 * The interface for the Base Workbook Functions Fact Request Builder.
 */
public interface IBaseWorkbookFunctionsFactRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsFactRequest instance
     */
    IWorkbookFunctionsFactRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
