...
/**
 * The class for the Base Windows Update For Business Configuration Request Builder.
 */
public class BaseWindowsUpdateForBusinessConfigurationRequestBuilder extends BaseRequestBuilder implements IBaseWindowsUpdateForBusinessConfigurationRequestBuilder {
     ...
     */
    public BaseWindowsUpdateForBusinessConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
