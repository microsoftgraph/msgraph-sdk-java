...
/**
 * The interface for the Base Managed Mobile App Request.
 */
public interface IBaseManagedMobileAppRequest extends IHttpRequest {
     ...
     */
    IBaseManagedMobileAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseManagedMobileAppRequest expand(final String value);
