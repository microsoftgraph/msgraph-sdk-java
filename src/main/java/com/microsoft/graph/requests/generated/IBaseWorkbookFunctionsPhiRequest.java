...
/**
 * The interface for the Base Workbook Functions Phi Request.
 */
public interface IBaseWorkbookFunctionsPhiRequest {
     ...
     */
    IWorkbookFunctionsPhiRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookFunctionsPhiRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsPhiRequest expand(final String value);
