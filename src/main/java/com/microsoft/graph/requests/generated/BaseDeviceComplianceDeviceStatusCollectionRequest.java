...
/**
 * The class for the Base Device Compliance Device Status Collection Request.
 */
public class BaseDeviceComplianceDeviceStatusCollectionRequest extends BaseCollectionRequest<BaseDeviceComplianceDeviceStatusCollectionResponse, IDeviceComplianceDeviceStatusCollectionPage> implements IBaseDeviceComplianceDeviceStatusCollectionRequest {
     ...
     */
    public BaseDeviceComplianceDeviceStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceComplianceDeviceStatusCollectionPage get() throws ClientException {
        final BaseDeviceComplianceDeviceStatusCollectionResponse response = send();
    ...
    public IDeviceComplianceDeviceStatusCollectionPage buildFromResponse(final BaseDeviceComplianceDeviceStatusCollectionResponse response) {
