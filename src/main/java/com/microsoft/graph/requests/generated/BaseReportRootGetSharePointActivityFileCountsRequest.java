...
/**
 * The class for the Base Report Root Get Share Point Activity File Counts Request.
 */
public class BaseReportRootGetSharePointActivityFileCountsRequest extends BaseRequest implements IBaseReportRootGetSharePointActivityFileCountsRequest {
     ...
     */
    public BaseReportRootGetSharePointActivityFileCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
