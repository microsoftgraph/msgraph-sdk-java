...
/**
 * The class for the Base Device Configuration Collection Request.
 */
public class BaseDeviceConfigurationCollectionRequest extends BaseCollectionRequest<BaseDeviceConfigurationCollectionResponse, IDeviceConfigurationCollectionPage> implements IBaseDeviceConfigurationCollectionRequest {
     ...
     */
    public BaseDeviceConfigurationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseDeviceConfigurationCollectionResponse.class, IDeviceConfigurationCollectionPage.class);
    }
    ...
    public IDeviceConfigurationCollectionPage get() throws ClientException {
        final BaseDeviceConfigurationCollectionResponse response = send();
    ...
    public IDeviceConfigurationCollectionPage buildFromResponse(final BaseDeviceConfigurationCollectionResponse response) {
