...
/**
 * The interface for the Base Android Managed App Protection Request.
 */
public interface IBaseAndroidManagedAppProtectionRequest extends IHttpRequest {
     ...
     */
    IBaseAndroidManagedAppProtectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseAndroidManagedAppProtectionRequest expand(final String value);
