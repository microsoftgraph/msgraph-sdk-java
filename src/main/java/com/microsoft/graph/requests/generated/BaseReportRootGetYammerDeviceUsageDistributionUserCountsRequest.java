...
/**
 * The class for the Base Report Root Get Yammer Device Usage Distribution User Counts Request.
 */
public class BaseReportRootGetYammerDeviceUsageDistributionUserCountsRequest extends BaseRequest implements IBaseReportRootGetYammerDeviceUsageDistributionUserCountsRequest {
     ...
     */
    public BaseReportRootGetYammerDeviceUsageDistributionUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
