...
/**
 * The interface for the Base Managed Device Bypass Activation Lock Request Builder.
 */
public interface IBaseManagedDeviceBypassActivationLockRequestBuilder extends IRequestBuilder {
     ...
     * @return the IManagedDeviceBypassActivationLockRequest instance
     */
    IManagedDeviceBypassActivationLockRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
