...
/**
 * The interface for the Base Team Unarchive Request Builder.
 */
public interface IBaseTeamUnarchiveRequestBuilder extends IRequestBuilder {
     ...
     * @return the ITeamUnarchiveRequest instance
     */
    ITeamUnarchiveRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
