...
/**
 * The interface for the Base Detected App Request.
 */
public interface IBaseDetectedAppRequest extends IHttpRequest {
     ...
     */
    IBaseDetectedAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDetectedAppRequest expand(final String value);
