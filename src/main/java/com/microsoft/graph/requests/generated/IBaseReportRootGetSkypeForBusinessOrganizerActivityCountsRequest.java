...
/**
 * The interface for the Base Report Root Get Skype For Business Organizer Activity Counts Request.
 */
public interface IBaseReportRootGetSkypeForBusinessOrganizerActivityCountsRequest {
     ...
     */
    IReportRootGetSkypeForBusinessOrganizerActivityCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessOrganizerActivityCountsRequest expand(final String value);
