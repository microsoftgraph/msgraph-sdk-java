...
/**
 * The class for the Base Managed Device Mobile App Configuration Assign Request.
 */
public class BaseManagedDeviceMobileAppConfigurationAssignRequest extends BaseRequest implements IBaseManagedDeviceMobileAppConfigurationAssignRequest {
     ...
     */
    public BaseManagedDeviceMobileAppConfigurationAssignRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
