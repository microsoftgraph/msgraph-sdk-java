...
/**
 * The interface for the Base Device Management Exchange Connector Request.
 */
public interface IBaseDeviceManagementExchangeConnectorRequest extends IHttpRequest {
     ...
     */
    void get(final ICallback<DeviceManagementExchangeConnector> callback);
     ...
     */
    void delete(final ICallback<DeviceManagementExchangeConnector> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void patch(final DeviceManagementExchangeConnector sourceDeviceManagementExchangeConnector, final ICallback<DeviceManagementExchangeConnector> callback);
     ...
     */
    IBaseDeviceManagementExchangeConnectorRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceManagementExchangeConnectorRequest expand(final String value);
