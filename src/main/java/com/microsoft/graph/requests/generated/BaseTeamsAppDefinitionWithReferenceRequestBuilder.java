...
/**
 * The class for the Base Teams App Definition With Reference Request Builder.
 */
public class BaseTeamsAppDefinitionWithReferenceRequestBuilder extends BaseRequestBuilder implements IBaseTeamsAppDefinitionWithReferenceRequestBuilder {
     ...
     */
    public BaseTeamsAppDefinitionWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
