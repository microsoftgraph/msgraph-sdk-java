...
/**
 * The class for the Base Report Root Get Yammer Activity User Detail Request.
 */
public class BaseReportRootGetYammerActivityUserDetailRequest extends BaseRequest implements IBaseReportRootGetYammerActivityUserDetailRequest {
     ...
     */
    public BaseReportRootGetYammerActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetYammerActivityUserDetail
    ...
    /**
     * Puts the ReportRootGetYammerActivityUserDetail
     *
     ...
     */
    public IReportRootGetYammerActivityUserDetailRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetYammerActivityUserDetailRequest expand(final String value) {
