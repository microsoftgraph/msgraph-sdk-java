...
/**
 * The interface for the Base Team Archive Request Builder.
 */
public interface IBaseTeamArchiveRequestBuilder extends IRequestBuilder {
     ...
     * @return the ITeamArchiveRequest instance
     */
    ITeamArchiveRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
