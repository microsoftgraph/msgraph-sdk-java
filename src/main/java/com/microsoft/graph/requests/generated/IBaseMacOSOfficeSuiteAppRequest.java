...
/**
 * The interface for the Base Mac OSOffice Suite App Request.
 */
public interface IBaseMacOSOfficeSuiteAppRequest extends IHttpRequest {
     ...
     */
    IBaseMacOSOfficeSuiteAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMacOSOfficeSuiteAppRequest expand(final String value);
