...
/**
 * The interface for the Base Android Work Profile Custom Configuration Request.
 */
public interface IBaseAndroidWorkProfileCustomConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseAndroidWorkProfileCustomConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseAndroidWorkProfileCustomConfigurationRequest expand(final String value);
