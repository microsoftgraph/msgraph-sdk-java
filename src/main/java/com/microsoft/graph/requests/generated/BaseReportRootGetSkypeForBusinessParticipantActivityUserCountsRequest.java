...
/**
 * The class for the Base Report Root Get Skype For Business Participant Activity User Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessParticipantActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessParticipantActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessParticipantActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
