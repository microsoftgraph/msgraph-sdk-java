...
/**
 * The interface for the Base Default Managed App Protection Collection Request.
 */
public interface IBaseDefaultManagedAppProtectionCollectionRequest {
     ...
     */
    IDefaultManagedAppProtectionCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IDefaultManagedAppProtectionCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IDefaultManagedAppProtectionCollectionRequest top(final int value);
