...
/**
 * The class for the Base Teams Async Operation Collection Request.
 */
public class BaseTeamsAsyncOperationCollectionRequest extends BaseCollectionRequest<BaseTeamsAsyncOperationCollectionResponse, ITeamsAsyncOperationCollectionPage> implements IBaseTeamsAsyncOperationCollectionRequest {
     ...
     */
    public BaseTeamsAsyncOperationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITeamsAsyncOperationCollectionPage get() throws ClientException {
        final BaseTeamsAsyncOperationCollectionResponse response = send();
    ...
    public ITeamsAsyncOperationCollectionPage buildFromResponse(final BaseTeamsAsyncOperationCollectionResponse response) {
