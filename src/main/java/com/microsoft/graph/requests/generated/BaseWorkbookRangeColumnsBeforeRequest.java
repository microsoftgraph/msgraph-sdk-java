...
/**
 * The class for the Base Workbook Range Columns Before Request.
 */
public class BaseWorkbookRangeColumnsBeforeRequest extends BaseRequest implements IBaseWorkbookRangeColumnsBeforeRequest {
     ...
     */
    public BaseWorkbookRangeColumnsBeforeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
