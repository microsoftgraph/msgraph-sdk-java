...
/**
 * The class for the Base Report Root Get Yammer Activity Counts Request.
 */
public class BaseReportRootGetYammerActivityCountsRequest extends BaseRequest implements IBaseReportRootGetYammerActivityCountsRequest {
     ...
     */
    public BaseReportRootGetYammerActivityCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
