...
/**
 * The interface for the Base Workbook Table Reapply Filters Request Builder.
 */
public interface IBaseWorkbookTableReapplyFiltersRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookTableReapplyFiltersRequest instance
     */
    IWorkbookTableReapplyFiltersRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
