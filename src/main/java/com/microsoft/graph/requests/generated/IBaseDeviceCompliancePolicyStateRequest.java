...
/**
 * The interface for the Base Device Compliance Policy State Request.
 */
public interface IBaseDeviceCompliancePolicyStateRequest extends IHttpRequest {
     ...
     */
    IBaseDeviceCompliancePolicyStateRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceCompliancePolicyStateRequest expand(final String value);
