...
/**
 * The class for the Base Device Compliance Scheduled Action For Rule Collection Request.
 */
public class BaseDeviceComplianceScheduledActionForRuleCollectionRequest extends BaseCollectionRequest<BaseDeviceComplianceScheduledActionForRuleCollectionResponse, IDeviceComplianceScheduledActionForRuleCollectionPage> implements IBaseDeviceComplianceScheduledActionForRuleCollectionRequest {
     ...
     */
    public BaseDeviceComplianceScheduledActionForRuleCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceComplianceScheduledActionForRuleCollectionPage get() throws ClientException {
        final BaseDeviceComplianceScheduledActionForRuleCollectionResponse response = send();
    ...
    public IDeviceComplianceScheduledActionForRuleCollectionPage buildFromResponse(final BaseDeviceComplianceScheduledActionForRuleCollectionResponse response) {
