...
/**
 * The interface for the Base Windows Information Protection Assign Request Builder.
 */
public interface IBaseWindowsInformationProtectionAssignRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWindowsInformationProtectionAssignRequest instance
     */
    IWindowsInformationProtectionAssignRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
