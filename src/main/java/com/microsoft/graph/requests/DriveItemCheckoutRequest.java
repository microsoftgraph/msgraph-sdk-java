...
import com.microsoft.graph.requests.DriveItemCheckoutRequest;
...
public class DriveItemCheckoutRequest extends BaseRequest<Void> {
     ...
     */
    public DriveItemCheckoutRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

    /**
     * Creates the DriveItemCheckout
     *
