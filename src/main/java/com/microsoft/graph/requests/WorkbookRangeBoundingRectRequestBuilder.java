...
import com.microsoft.graph.requests.WorkbookRangeBoundingRectRequest;
...
public class WorkbookRangeBoundingRectRequestBuilder extends BaseFunctionRequestBuilder<WorkbookRange> {
     ...
     */
    public WorkbookRangeBoundingRectRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
