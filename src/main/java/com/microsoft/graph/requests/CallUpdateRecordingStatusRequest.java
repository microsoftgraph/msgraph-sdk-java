...
public class CallUpdateRecordingStatusRequest extends BaseRequest<UpdateRecordingStatusOperation> {
     ...
     */
    public CallUpdateRecordingStatusRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallUpdateRecordingStatusParameterSet parameters) {
