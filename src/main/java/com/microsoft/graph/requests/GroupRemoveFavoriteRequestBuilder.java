...
import com.microsoft.graph.requests.GroupRemoveFavoriteRequest;
 ...
 */
public class GroupRemoveFavoriteRequestBuilder extends BaseActionRequestBuilder<Group> {
     ...
     */
    public GroupRemoveFavoriteRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GroupRemoveFavoriteRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
