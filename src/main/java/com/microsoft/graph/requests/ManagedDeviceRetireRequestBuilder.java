...
public class ManagedDeviceRetireRequestBuilder extends BaseActionRequestBuilder<ManagedDevice> {
     ...
     */
    public ManagedDeviceRetireRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ManagedDeviceRetireRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
