...
public class WorkbookRangeBorderItemAtRequestBuilder extends BaseFunctionRequestBuilder<WorkbookRangeBorder> {
     ...
     */
    public WorkbookRangeBorderItemAtRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
