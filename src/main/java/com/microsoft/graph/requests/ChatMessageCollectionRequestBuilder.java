...
public class ChatMessageCollectionRequestBuilder extends BaseCollectionRequestBuilder<ChatMessage, ChatMessageRequestBuilder, ChatMessageCollectionResponse, ChatMessageCollectionPage, ChatMessageCollectionRequest> {
     ...
     */
    public ChatMessageCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ChatMessageRequestBuilder.class, ChatMessageCollectionRequest.class);
    }
