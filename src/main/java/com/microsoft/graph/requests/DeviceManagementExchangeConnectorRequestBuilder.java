...
public class DeviceManagementExchangeConnectorRequestBuilder extends BaseRequestBuilder<DeviceManagementExchangeConnector> {
    ...
    public DeviceManagementExchangeConnectorRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.DeviceManagementExchangeConnectorRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public DeviceManagementExchangeConnectorSyncRequestBuilder sync(@Nonnull final DeviceManagementExchangeConnectorSyncParameterSet parameters) {
        return new DeviceManagementExchangeConnectorSyncRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.sync"), getClient(), null, parameters);
    }
}
