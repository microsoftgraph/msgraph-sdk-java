...
public class WindowsPhone81GeneralConfigurationRequestBuilder extends BaseRequestBuilder<WindowsPhone81GeneralConfiguration> {
     ...
     */
    public WindowsPhone81GeneralConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81GeneralConfigurationRequest instance
     */
    @Nonnull
    public WindowsPhone81GeneralConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81GeneralConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsPhone81GeneralConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
