...
/**
 * The class for the Printer Share Collection With References Request.
 */
public class PrinterShareCollectionWithReferencesRequest extends BaseCollectionWithReferencesRequest<PrinterShare, PrinterShareWithReferenceRequest, PrinterShareReferenceRequestBuilder, PrinterShareWithReferenceRequestBuilder, PrinterShareCollectionResponse, PrinterShareCollectionWithReferencesPage, PrinterShareCollectionWithReferencesRequest> {
     ...
     */
    public PrinterShareCollectionWithReferencesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public PrinterShareCollectionWithReferencesRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public PrinterShareCollectionWithReferencesRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public PrinterShareCollectionWithReferencesRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public PrinterShareCollectionWithReferencesRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public PrinterShareCollectionWithReferencesRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public PrinterShareCollectionWithReferencesRequest count(final boolean value) {
