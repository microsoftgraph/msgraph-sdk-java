...
public class IdentityUserFlowAttributeRequest extends BaseRequest<IdentityUserFlowAttribute> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttribute> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttribute> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttribute> patchAsync(@Nonnull final IdentityUserFlowAttribute sourceIdentityUserFlowAttribute) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttribute> putAsync(@Nonnull final IdentityUserFlowAttribute newIdentityUserFlowAttribute) {
