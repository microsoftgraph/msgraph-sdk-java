...
import com.microsoft.graph.requests.MessageSendRequest;
...
public class MessageSendRequest extends BaseRequest<Void> {
     ...
     */
    public MessageSendRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
