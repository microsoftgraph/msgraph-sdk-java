...
import com.microsoft.graph.requests.WorkbookFilterApplyValuesFilterRequest;
...
public class WorkbookFilterApplyValuesFilterRequestBuilder extends BaseActionRequestBuilder<WorkbookFilter> {
     ...
     */
    public WorkbookFilterApplyValuesFilterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public WorkbookFilterApplyValuesFilterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyValuesFilterParameterSet parameters) {
        super(requestUrl, client, requestOptions);
    ...
    public WorkbookFilterApplyValuesFilterRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFilterApplyValuesFilterRequest request = new WorkbookFilterApplyValuesFilterRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
