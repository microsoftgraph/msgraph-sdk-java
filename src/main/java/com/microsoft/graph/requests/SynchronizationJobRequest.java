...
public class SynchronizationJobRequest extends BaseRequest<SynchronizationJob> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SynchronizationJob> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SynchronizationJob> deleteAsync() {
     ...
     */
    @Nullable
    public SynchronizationJob delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SynchronizationJob> patchAsync(@Nonnull final SynchronizationJob sourceSynchronizationJob) {
        return sendAsync(HttpMethod.PATCH, sourceSynchronizationJob);
    }
    ...
    public java.util.concurrent.CompletableFuture<SynchronizationJob> postAsync(@Nonnull final SynchronizationJob newSynchronizationJob) {
        return sendAsync(HttpMethod.POST, newSynchronizationJob);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SynchronizationJob> putAsync(@Nonnull final SynchronizationJob newSynchronizationJob) {
        return sendAsync(HttpMethod.PUT, newSynchronizationJob);
    }
