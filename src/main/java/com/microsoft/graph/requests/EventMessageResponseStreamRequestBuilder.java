...
/**
 * The class for the Event Message Response Stream Request Builder.
 */
public class EventMessageResponseStreamRequestBuilder extends BaseRequestBuilder<InputStream> {
     ...
     */
    public EventMessageResponseStreamRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the EventMessageResponseStreamRequest instance
     */
    @Nonnull
    public EventMessageResponseStreamRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EventMessageResponseStreamRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new EventMessageResponseStreamRequest(getRequestUrl(), getClient(), requestOptions);
    }
