...
import com.microsoft.graph.requests.ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest;
 ...
 */
public class ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder extends BaseFunctionRequestBuilder<java.io.InputStream> {
     ...
     */
    public ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest request = new ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
