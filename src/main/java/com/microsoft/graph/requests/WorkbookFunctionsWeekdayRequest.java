...
import com.microsoft.graph.requests.WorkbookFunctionsWeekdayRequest;
...
public class WorkbookFunctionsWeekdayRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsWeekdayRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsWeekdayParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsWeekdayParameterSet body;
    /**
