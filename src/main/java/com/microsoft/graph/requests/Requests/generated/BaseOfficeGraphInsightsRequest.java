...
/**
 * The class for the Base Office Graph Insights Request.
 */
public class BaseOfficeGraphInsightsRequest extends BaseRequest implements IBaseOfficeGraphInsightsRequest {
     ...
     */
    public BaseOfficeGraphInsightsRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<OfficeGraphInsights> responseClass) {
