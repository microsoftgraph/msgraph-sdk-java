...
/**
 * The class for the Base Report Root Managed Device Enrollment Failure Details Request Builder.
 */
public class BaseReportRootManagedDeviceEnrollmentFailureDetailsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootManagedDeviceEnrollmentFailureDetailsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public BaseReportRootManagedDeviceEnrollmentFailureDetailsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Integer skip, final Integer top, final String filter, final String skipToken) {
        super(requestUrl, client, requestOptions);
