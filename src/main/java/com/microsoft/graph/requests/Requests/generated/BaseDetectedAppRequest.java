...
/**
 * The class for the Base Detected App Request.
 */
public class BaseDetectedAppRequest extends BaseRequest implements IBaseDetectedAppRequest {
     ...
     */
    public BaseDetectedAppRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<DetectedApp> responseClass) {
