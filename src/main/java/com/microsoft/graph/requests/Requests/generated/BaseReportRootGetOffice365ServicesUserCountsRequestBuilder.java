...
/**
 * The class for the Base Report Root Get Office365Services User Counts Request Builder.
 */
public class BaseReportRootGetOffice365ServicesUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365ServicesUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetOffice365ServicesUserCountsRequest instance
     */
    public IReportRootGetOffice365ServicesUserCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
