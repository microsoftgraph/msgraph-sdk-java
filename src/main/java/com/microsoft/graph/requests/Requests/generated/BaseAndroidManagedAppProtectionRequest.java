...
/**
 * The class for the Base Android Managed App Protection Request.
 */
public class BaseAndroidManagedAppProtectionRequest extends BaseRequest implements IBaseAndroidManagedAppProtectionRequest {
     ...
     */
    public BaseAndroidManagedAppProtectionRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<AndroidManagedAppProtection> responseClass) {
     ...
     */
     public IAndroidManagedAppProtectionRequest select(final String value) {
     ...
     * @return the updated request
     */
     public IAndroidManagedAppProtectionRequest expand(final String value) {
