...
/**
 * The class for the Base Workbook Range View Collection Response.
 */
public class BaseWorkbookRangeViewCollectionResponse implements IJsonBackedObject {

    /**
     * The list of WorkbookRangeView within this collection page
     */
