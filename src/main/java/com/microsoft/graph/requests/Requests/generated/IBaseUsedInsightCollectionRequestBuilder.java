...
/**
 * The interface for the Base Used Insight Collection Request Builder.
 */
public interface IBaseUsedInsightCollectionRequestBuilder extends IRequestBuilder {
    ...
    IUsedInsightCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
