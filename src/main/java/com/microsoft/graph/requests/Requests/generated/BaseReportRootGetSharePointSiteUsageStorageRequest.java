...
/**
 * The class for the Base Report Root Get Share Point Site Usage Storage Request.
 */
public class BaseReportRootGetSharePointSiteUsageStorageRequest extends BaseRequest implements IBaseReportRootGetSharePointSiteUsageStorageRequest {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageStorageRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
