...
/**
 * The class for the Base Windows Defender Advanced Threat Protection Configuration Request.
 */
public class BaseWindowsDefenderAdvancedThreatProtectionConfigurationRequest extends BaseRequest implements IBaseWindowsDefenderAdvancedThreatProtectionConfigurationRequest {
     ...
     */
    public BaseWindowsDefenderAdvancedThreatProtectionConfigurationRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<WindowsDefenderAdvancedThreatProtectionConfiguration> responseClass) {
