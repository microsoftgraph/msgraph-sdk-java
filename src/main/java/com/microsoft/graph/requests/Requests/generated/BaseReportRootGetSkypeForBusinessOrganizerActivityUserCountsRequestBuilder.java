...
/**
 * The class for the Base Report Root Get Skype For Business Organizer Activity User Counts Request Builder.
 */
public class BaseReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
