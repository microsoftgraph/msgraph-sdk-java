...
/**
 * The class for the Base Terms And Conditions Collection Request.
 */
public class BaseTermsAndConditionsCollectionRequest extends BaseCollectionRequest<BaseTermsAndConditionsCollectionResponse, ITermsAndConditionsCollectionPage> implements IBaseTermsAndConditionsCollectionRequest {
     ...
     */
    public BaseTermsAndConditionsCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITermsAndConditionsCollectionPage get() throws ClientException {
        final BaseTermsAndConditionsCollectionResponse response = send();
    ...
    public ITermsAndConditionsCollectionPage buildFromResponse(final BaseTermsAndConditionsCollectionResponse response) {
