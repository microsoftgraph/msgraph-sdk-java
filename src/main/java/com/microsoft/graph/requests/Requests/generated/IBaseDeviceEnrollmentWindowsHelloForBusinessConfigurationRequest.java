...
/**
 * The interface for the Base Device Enrollment Windows Hello For Business Configuration Request.
 */
public interface IBaseDeviceEnrollmentWindowsHelloForBusinessConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseDeviceEnrollmentWindowsHelloForBusinessConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceEnrollmentWindowsHelloForBusinessConfigurationRequest expand(final String value);
