...
/**
 * The class for the Base Workbook Worksheet Protection Unprotect Request.
 */
public class BaseWorkbookWorksheetProtectionUnprotectRequest extends BaseRequest implements IBaseWorkbookWorksheetProtectionUnprotectRequest {
     ...
     */
    public BaseWorkbookWorksheetProtectionUnprotectRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
