...
/**
 * The class for the Base Report Root Get Yammer Device Usage User Counts Request.
 */
public class BaseReportRootGetYammerDeviceUsageUserCountsRequest extends BaseRequest implements IBaseReportRootGetYammerDeviceUsageUserCountsRequest {

    /**
     * The request for this ReportRootGetYammerDeviceUsageUserCounts
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public BaseReportRootGetYammerDeviceUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetYammerDeviceUsageUserCounts
    ...
    /**
     * Puts the ReportRootGetYammerDeviceUsageUserCounts
     *
     ...
     */
    public IReportRootGetYammerDeviceUsageUserCountsRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetYammerDeviceUsageUserCountsRequest)this;
    }
     ...
     * @return the updated request
     */
    public IReportRootGetYammerDeviceUsageUserCountsRequest expand(final String value) {
