...
/**
 * The interface for the Base Managed EBook Assign Request Builder.
 */
public interface IBaseManagedEBookAssignRequestBuilder extends IRequestBuilder {
     ...
     * @return the IManagedEBookAssignRequest instance
     */
    IManagedEBookAssignRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
