...
/**
 * The class for the Base Workbook Functions Rank_Eq Request.
 */
public class BaseWorkbookFunctionsRank_EqRequest extends BaseRequest implements IBaseWorkbookFunctionsRank_EqRequest {
     ...
     */
    public BaseWorkbookFunctionsRank_EqRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookFunctionsRank_EqRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsRank_EqRequest top(final int value) {
