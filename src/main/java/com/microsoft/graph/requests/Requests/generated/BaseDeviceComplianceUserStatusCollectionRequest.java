...
/**
 * The class for the Base Device Compliance User Status Collection Request.
 */
public class BaseDeviceComplianceUserStatusCollectionRequest extends BaseCollectionRequest<BaseDeviceComplianceUserStatusCollectionResponse, IDeviceComplianceUserStatusCollectionPage> implements IBaseDeviceComplianceUserStatusCollectionRequest {
     ...
     */
    public BaseDeviceComplianceUserStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseDeviceComplianceUserStatusCollectionResponse.class, IDeviceComplianceUserStatusCollectionPage.class);
    }
    ...
    public IDeviceComplianceUserStatusCollectionPage get() throws ClientException {
        final BaseDeviceComplianceUserStatusCollectionResponse response = send();
    ...
    public IDeviceComplianceUserStatusCollectionPage buildFromResponse(final BaseDeviceComplianceUserStatusCollectionResponse response) {
