...
/**
 * The class for the Base Managed Device Mobile App Configuration Device Status Collection Request.
 */
public class BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionRequest extends BaseCollectionRequest<BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse, IManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage> implements IBaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionRequest {
     ...
     */
    public BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse.class, IManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage.class);
    }
    ...
    public IManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage get() throws ClientException {
        final BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse response = send();
    ...
    public IManagedDeviceMobileAppConfigurationDeviceStatusCollectionPage buildFromResponse(final BaseManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse response) {
