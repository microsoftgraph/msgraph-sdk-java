...
/**
 * The class for the Base Teams App Collection Request.
 */
public class BaseTeamsAppCollectionRequest extends BaseCollectionRequest<BaseTeamsAppCollectionResponse, ITeamsAppCollectionPage> implements IBaseTeamsAppCollectionRequest {
     ...
     */
    public BaseTeamsAppCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseTeamsAppCollectionResponse.class, ITeamsAppCollectionPage.class);
    }
    ...
    public ITeamsAppCollectionPage get() throws ClientException {
        final BaseTeamsAppCollectionResponse response = send();
    ...
    public ITeamsAppCollectionPage buildFromResponse(final BaseTeamsAppCollectionResponse response) {
