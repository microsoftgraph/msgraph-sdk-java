...
/**
 * The class for the Base Report Root Get Share Point Activity Pages Request.
 */
public class BaseReportRootGetSharePointActivityPagesRequest extends BaseRequest implements IBaseReportRootGetSharePointActivityPagesRequest {
     ...
     */
    public BaseReportRootGetSharePointActivityPagesRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetSharePointActivityPages
    ...
    /**
     * Puts the ReportRootGetSharePointActivityPages
     *
