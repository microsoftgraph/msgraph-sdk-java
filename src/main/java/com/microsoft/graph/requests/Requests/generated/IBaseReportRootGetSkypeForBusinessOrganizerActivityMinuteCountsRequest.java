...
/**
 * The interface for the Base Report Root Get Skype For Business Organizer Activity Minute Counts Request.
 */
public interface IBaseReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest {
     ...
     */
    IReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest expand(final String value);
