...
/**
 * The class for the Base Shared PCConfiguration Request Builder.
 */
public class BaseSharedPCConfigurationRequestBuilder extends BaseRequestBuilder implements IBaseSharedPCConfigurationRequestBuilder {
     ...
     */
    public BaseSharedPCConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
