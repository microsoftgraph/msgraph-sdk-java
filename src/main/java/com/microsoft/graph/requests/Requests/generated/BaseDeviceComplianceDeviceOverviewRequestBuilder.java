...
/**
 * The class for the Base Device Compliance Device Overview Request Builder.
 */
public class BaseDeviceComplianceDeviceOverviewRequestBuilder extends BaseRequestBuilder implements IBaseDeviceComplianceDeviceOverviewRequestBuilder {
     ...
     */
    public BaseDeviceComplianceDeviceOverviewRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
