...
public class BaseReportRootGetOneDriveActivityFileCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOneDriveActivityFileCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetOneDriveActivityFileCountsRequest instance
     */
    public IReportRootGetOneDriveActivityFileCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
