...
/**
 * The interface for the Base Workbook Functions Im Product Request Builder.
 */
public interface IBaseWorkbookFunctionsImProductRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsImProductRequest instance
     */
    IWorkbookFunctionsImProductRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
