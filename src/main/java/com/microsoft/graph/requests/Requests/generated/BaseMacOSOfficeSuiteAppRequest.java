...
/**
 * The class for the Base Mac OSOffice Suite App Request.
 */
public class BaseMacOSOfficeSuiteAppRequest extends BaseRequest implements IBaseMacOSOfficeSuiteAppRequest {
     ...
     */
    public BaseMacOSOfficeSuiteAppRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<MacOSOfficeSuiteApp> responseClass) {
