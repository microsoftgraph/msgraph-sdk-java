...
/**
 * The class for the Base Education User Collection Request.
 */
public class BaseEducationUserCollectionRequest extends BaseCollectionRequest<BaseEducationUserCollectionResponse, IEducationUserCollectionPage> implements IBaseEducationUserCollectionRequest {
     ...
     */
    public BaseEducationUserCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IEducationUserCollectionPage buildFromResponse(final BaseEducationUserCollectionResponse response) {
