...
/**
 * The class for the Base Workbook Functions Now Request.
 */
public class BaseWorkbookFunctionsNowRequest extends BaseRequest implements IBaseWorkbookFunctionsNowRequest {
     ...
     */
    public BaseWorkbookFunctionsNowRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
