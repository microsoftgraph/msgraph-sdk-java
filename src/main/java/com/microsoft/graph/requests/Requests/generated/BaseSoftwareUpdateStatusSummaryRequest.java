...
/**
 * The class for the Base Software Update Status Summary Request.
 */
public class BaseSoftwareUpdateStatusSummaryRequest extends BaseRequest implements IBaseSoftwareUpdateStatusSummaryRequest {
     ...
     */
    public BaseSoftwareUpdateStatusSummaryRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<SoftwareUpdateStatusSummary> responseClass) {
