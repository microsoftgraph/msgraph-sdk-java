...
/**
 * The interface for the Base Managed Device Mobile App Configuration Request.
 */
public interface IBaseManagedDeviceMobileAppConfigurationRequest extends IHttpRequest {
     ...
     */
    void get(final ICallback<ManagedDeviceMobileAppConfiguration> callback);
     ...
     */
    void delete(final ICallback<ManagedDeviceMobileAppConfiguration> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void patch(final ManagedDeviceMobileAppConfiguration sourceManagedDeviceMobileAppConfiguration, final ICallback<ManagedDeviceMobileAppConfiguration> callback);
     ...
     */
    IBaseManagedDeviceMobileAppConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseManagedDeviceMobileAppConfigurationRequest expand(final String value);
