...
/**
 * The class for the Base Role Definition Collection Request Builder.
 */
public class BaseRoleDefinitionCollectionRequestBuilder extends BaseRequestBuilder implements IBaseRoleDefinitionCollectionRequestBuilder {
     ...
     */
    public BaseRoleDefinitionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IRoleDefinitionCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
