...
/**
 * The class for the Base Managed Mobile App Collection Request.
 */
public class BaseManagedMobileAppCollectionRequest extends BaseCollectionRequest<BaseManagedMobileAppCollectionResponse, IManagedMobileAppCollectionPage> implements IBaseManagedMobileAppCollectionRequest {
     ...
     */
    public BaseManagedMobileAppCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseManagedMobileAppCollectionResponse.class, IManagedMobileAppCollectionPage.class);
    }
    ...
    public IManagedMobileAppCollectionPage get() throws ClientException {
        final BaseManagedMobileAppCollectionResponse response = send();
    ...
    public IManagedMobileAppCollectionPage buildFromResponse(final BaseManagedMobileAppCollectionResponse response) {
