...
/**
 * The class for the Base Ios Managed App Protection Collection Request.
 */
public class BaseIosManagedAppProtectionCollectionRequest extends BaseCollectionRequest<BaseIosManagedAppProtectionCollectionResponse, IIosManagedAppProtectionCollectionPage> implements IBaseIosManagedAppProtectionCollectionRequest {
     ...
     */
    public BaseIosManagedAppProtectionCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IIosManagedAppProtectionCollectionPage get() throws ClientException {
        final BaseIosManagedAppProtectionCollectionResponse response = send();
     ...
     */
    public IIosManagedAppProtectionCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IIosManagedAppProtectionCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IIosManagedAppProtectionCollectionRequest top(final int value) {
        addQueryOption(new QueryOption("$top", value + ""));
        return (IosManagedAppProtectionCollectionRequest)this;
    }

    public IIosManagedAppProtectionCollectionPage buildFromResponse(final BaseIosManagedAppProtectionCollectionResponse response) {
        ...
        final IosManagedAppProtectionCollectionPage page = new IosManagedAppProtectionCollectionPage(response, builder);
