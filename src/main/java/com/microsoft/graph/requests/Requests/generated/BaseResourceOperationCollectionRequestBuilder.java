...
/**
 * The class for the Base Resource Operation Collection Request Builder.
 */
public class BaseResourceOperationCollectionRequestBuilder extends BaseRequestBuilder implements IBaseResourceOperationCollectionRequestBuilder {
     ...
     */
    public BaseResourceOperationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
