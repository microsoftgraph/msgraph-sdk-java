...
/**
 * The class for the Base Report Root Get Teams Device Usage Distribution User Counts Request.
 */
public class BaseReportRootGetTeamsDeviceUsageDistributionUserCountsRequest extends BaseRequest implements IBaseReportRootGetTeamsDeviceUsageDistributionUserCountsRequest {
     ...
     */
    public BaseReportRootGetTeamsDeviceUsageDistributionUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetTeamsDeviceUsageDistributionUserCounts
    ...
    /**
     * Puts the ReportRootGetTeamsDeviceUsageDistributionUserCounts
     *
