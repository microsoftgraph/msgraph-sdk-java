...
/**
 * The class for the Base Contract Collection Response.
 */
public class BaseContractCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Contract within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Contract> value;
