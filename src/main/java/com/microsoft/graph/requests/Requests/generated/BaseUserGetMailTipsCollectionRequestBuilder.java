...
public class BaseUserGetMailTipsCollectionRequestBuilder extends BaseActionRequestBuilder implements IBaseUserGetMailTipsCollectionRequestBuilder {
     ...
     */
    public BaseUserGetMailTipsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<String> emailAddresses, final EnumSet<MailTipsType> mailTipsOptions) {
