...
/**
 * The interface for the Base Mobile App Category With Reference Request.
 */
public interface IBaseMobileAppCategoryWithReferenceRequest extends IHttpRequest {
    ...
    IBaseMobileAppCategoryWithReferenceRequest select(final String value);

    IBaseMobileAppCategoryWithReferenceRequest expand(final String value);
