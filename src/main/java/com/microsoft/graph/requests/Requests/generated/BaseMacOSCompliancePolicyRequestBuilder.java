...
/**
 * The class for the Base Mac OSCompliance Policy Request Builder.
 */
public class BaseMacOSCompliancePolicyRequestBuilder extends BaseRequestBuilder implements IBaseMacOSCompliancePolicyRequestBuilder {
     ...
     */
    public BaseMacOSCompliancePolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IMacOSCompliancePolicyRequest buildRequest() {
