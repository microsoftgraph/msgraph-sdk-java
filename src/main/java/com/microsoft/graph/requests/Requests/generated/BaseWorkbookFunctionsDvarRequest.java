...
public class BaseWorkbookFunctionsDvarRequest extends BaseRequest implements IBaseWorkbookFunctionsDvarRequest {
     ...
     */
    public BaseWorkbookFunctionsDvarRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookFunctionsDvarRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookFunctionsDvarRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDvarRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDvarRequest expand(final String value) {
