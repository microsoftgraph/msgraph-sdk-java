...
/**
 * The class for the Base Data Policy Operation Collection Request.
 */
public class BaseDataPolicyOperationCollectionRequest extends BaseCollectionRequest<BaseDataPolicyOperationCollectionResponse, IDataPolicyOperationCollectionPage> implements IBaseDataPolicyOperationCollectionRequest {
     ...
     */
    public BaseDataPolicyOperationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDataPolicyOperationCollectionPage get() throws ClientException {
        final BaseDataPolicyOperationCollectionResponse response = send();
    ...
    public IDataPolicyOperationCollectionPage buildFromResponse(final BaseDataPolicyOperationCollectionResponse response) {
