...
/**
 * The interface for the Base Enrollment Configuration Assignment Request.
 */
public interface IBaseEnrollmentConfigurationAssignmentRequest extends IHttpRequest {
     ...
     */
    IBaseEnrollmentConfigurationAssignmentRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseEnrollmentConfigurationAssignmentRequest expand(final String value);
