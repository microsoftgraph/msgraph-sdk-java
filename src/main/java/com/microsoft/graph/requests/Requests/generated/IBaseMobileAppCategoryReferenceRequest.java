...
/**
 * The interface for the Base Mobile App Category Reference Request.
 */
public interface IBaseMobileAppCategoryReferenceRequest extends IHttpRequest {
     ...
     */
    IBaseMobileAppCategoryReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMobileAppCategoryReferenceRequest expand(final String value);
