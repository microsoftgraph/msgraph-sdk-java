...
/**
 * The interface for the Base Education User Collection With References Request.
 */
public interface IBaseEducationUserCollectionWithReferencesRequest {

    void get(final ICallback<IEducationUserCollectionWithReferencesPage> callback);
