...
/**
 * The interface for the Base Workbook Functions Mid Request Builder.
 */
public interface IBaseWorkbookFunctionsMidRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsMidRequest instance
     */
    IWorkbookFunctionsMidRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
