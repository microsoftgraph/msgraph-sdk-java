...
/**
 * The class for the Base Device App Management Sync Microsoft Store For Business Apps Request.
 */
public class BaseDeviceAppManagementSyncMicrosoftStoreForBusinessAppsRequest extends BaseRequest implements IBaseDeviceAppManagementSyncMicrosoftStoreForBusinessAppsRequest {
     ...
     */
    public BaseDeviceAppManagementSyncMicrosoftStoreForBusinessAppsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
