...
/**
 * The class for the Base Workbook Chart Gridlines Request.
 */
public class BaseWorkbookChartGridlinesRequest extends BaseRequest implements IBaseWorkbookChartGridlinesRequest {
     ...
     */
    public BaseWorkbookChartGridlinesRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<WorkbookChartGridlines> responseClass) {
