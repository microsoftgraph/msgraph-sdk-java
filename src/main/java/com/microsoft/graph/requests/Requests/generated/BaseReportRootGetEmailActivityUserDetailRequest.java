...
/**
 * The class for the Base Report Root Get Email Activity User Detail Request.
 */
public class BaseReportRootGetEmailActivityUserDetailRequest extends BaseRequest implements IBaseReportRootGetEmailActivityUserDetailRequest {
     ...
     */
    public BaseReportRootGetEmailActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetEmailActivityUserDetail
    ...
    /**
     * Puts the ReportRootGetEmailActivityUserDetail
     *
     ...
     */
    public IReportRootGetEmailActivityUserDetailRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetEmailActivityUserDetailRequest)this;
    }
     ...
     * @return the updated request
     */
    public IReportRootGetEmailActivityUserDetailRequest expand(final String value) {
