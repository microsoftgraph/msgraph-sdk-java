...
/**
 * The class for the Base Shared Insight Request.
 */
public class BaseSharedInsightRequest extends BaseRequest implements IBaseSharedInsightRequest {
     ...
     */
    public BaseSharedInsightRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<SharedInsight> responseClass) {
