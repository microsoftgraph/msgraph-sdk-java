...
/**
 * The class for the Base Ios Lob App Request Builder.
 */
public class BaseIosLobAppRequestBuilder extends BaseRequestBuilder implements IBaseIosLobAppRequestBuilder {
     ...
     */
    public BaseIosLobAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
