...
/**
 * The interface for the Base Notification Message Template Request.
 */
public interface IBaseNotificationMessageTemplateRequest extends IHttpRequest {
     ...
     */
    IBaseNotificationMessageTemplateRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseNotificationMessageTemplateRequest expand(final String value);
