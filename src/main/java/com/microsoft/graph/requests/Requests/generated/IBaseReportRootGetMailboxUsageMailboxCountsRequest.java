...
/**
 * The interface for the Base Report Root Get Mailbox Usage Mailbox Counts Request.
 */
public interface IBaseReportRootGetMailboxUsageMailboxCountsRequest {
     ...
     */
    IReportRootGetMailboxUsageMailboxCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetMailboxUsageMailboxCountsRequest expand(final String value);
