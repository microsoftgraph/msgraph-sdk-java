...
/**
 * The class for the Base Device Configuration State Collection Request.
 */
public class BaseDeviceConfigurationStateCollectionRequest extends BaseCollectionRequest<BaseDeviceConfigurationStateCollectionResponse, IDeviceConfigurationStateCollectionPage> implements IBaseDeviceConfigurationStateCollectionRequest {
     ...
     */
    public BaseDeviceConfigurationStateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceConfigurationStateCollectionPage get() throws ClientException {
        final BaseDeviceConfigurationStateCollectionResponse response = send();
    ...
    public IDeviceConfigurationStateCollectionPage buildFromResponse(final BaseDeviceConfigurationStateCollectionResponse response) {
