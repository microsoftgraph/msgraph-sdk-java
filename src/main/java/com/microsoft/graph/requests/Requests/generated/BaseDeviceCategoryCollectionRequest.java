...
/**
 * The class for the Base Device Category Collection Request.
 */
public class BaseDeviceCategoryCollectionRequest extends BaseCollectionRequest<BaseDeviceCategoryCollectionResponse, IDeviceCategoryCollectionPage> implements IBaseDeviceCategoryCollectionRequest {
     ...
     */
    public BaseDeviceCategoryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceCategoryCollectionPage get() throws ClientException {
        final BaseDeviceCategoryCollectionResponse response = send();
    ...
    public IDeviceCategoryCollectionPage buildFromResponse(final BaseDeviceCategoryCollectionResponse response) {
