...
/**
 * The class for the Base Device Configuration Assignment Request.
 */
public class BaseDeviceConfigurationAssignmentRequest extends BaseRequest implements IBaseDeviceConfigurationAssignmentRequest {
     ...
     */
    public BaseDeviceConfigurationAssignmentRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<DeviceConfigurationAssignment> responseClass) {
     ...
     */
    public void get(final ICallback<DeviceConfigurationAssignment> callback) {
     ...
     */
    public void delete(final ICallback<DeviceConfigurationAssignment> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final DeviceConfigurationAssignment sourceDeviceConfigurationAssignment, final ICallback<DeviceConfigurationAssignment> callback) {
