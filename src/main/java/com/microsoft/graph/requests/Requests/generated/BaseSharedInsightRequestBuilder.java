...
/**
 * The class for the Base Shared Insight Request Builder.
 */
public class BaseSharedInsightRequestBuilder extends BaseRequestBuilder implements IBaseSharedInsightRequestBuilder {
     ...
     */
    public BaseSharedInsightRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
