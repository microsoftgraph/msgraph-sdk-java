...
/**
 * The class for the Base Device Compliance Policy Setting State Summary Collection Request.
 */
public class BaseDeviceCompliancePolicySettingStateSummaryCollectionRequest extends BaseCollectionRequest<BaseDeviceCompliancePolicySettingStateSummaryCollectionResponse, IDeviceCompliancePolicySettingStateSummaryCollectionPage> implements IBaseDeviceCompliancePolicySettingStateSummaryCollectionRequest {
     ...
     */
    public BaseDeviceCompliancePolicySettingStateSummaryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseDeviceCompliancePolicySettingStateSummaryCollectionResponse.class, IDeviceCompliancePolicySettingStateSummaryCollectionPage.class);
    }
    ...
    public IDeviceCompliancePolicySettingStateSummaryCollectionPage get() throws ClientException {
        final BaseDeviceCompliancePolicySettingStateSummaryCollectionResponse response = send();
    ...
    public IDeviceCompliancePolicySettingStateSummaryCollectionPage buildFromResponse(final BaseDeviceCompliancePolicySettingStateSummaryCollectionResponse response) {
