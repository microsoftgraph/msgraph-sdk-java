...
/**
 * The class for the Base Outlook Category Collection Request.
 */
public class BaseOutlookCategoryCollectionRequest extends BaseCollectionRequest<BaseOutlookCategoryCollectionResponse, IOutlookCategoryCollectionPage> implements IBaseOutlookCategoryCollectionRequest {
     ...
     */
    public BaseOutlookCategoryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IOutlookCategoryCollectionPage get() throws ClientException {
        final BaseOutlookCategoryCollectionResponse response = send();
    ...
    public IOutlookCategoryCollectionPage buildFromResponse(final BaseOutlookCategoryCollectionResponse response) {
