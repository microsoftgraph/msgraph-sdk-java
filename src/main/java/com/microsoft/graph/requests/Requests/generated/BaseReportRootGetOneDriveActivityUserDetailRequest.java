...
/**
 * The class for the Base Report Root Get One Drive Activity User Detail Request.
 */
public class BaseReportRootGetOneDriveActivityUserDetailRequest extends BaseRequest implements IBaseReportRootGetOneDriveActivityUserDetailRequest {
     ...
     */
    public BaseReportRootGetOneDriveActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
