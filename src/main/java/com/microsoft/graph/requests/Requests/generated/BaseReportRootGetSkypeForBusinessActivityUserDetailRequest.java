...
/**
 * The class for the Base Report Root Get Skype For Business Activity User Detail Request.
 */
public class BaseReportRootGetSkypeForBusinessActivityUserDetailRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessActivityUserDetailRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
