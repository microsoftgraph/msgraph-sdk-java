...
public class BaseWorkbookFunctionsHourRequest extends BaseRequest implements IBaseWorkbookFunctionsHourRequest {
     ...
     */
    public BaseWorkbookFunctionsHourRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookFunctionsHourRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (WorkbookFunctionsHourRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsHourRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsHourRequest expand(final String value) {
