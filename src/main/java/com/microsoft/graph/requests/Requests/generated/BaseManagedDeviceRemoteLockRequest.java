...
/**
 * The class for the Base Managed Device Remote Lock Request.
 */
public class BaseManagedDeviceRemoteLockRequest extends BaseRequest implements IBaseManagedDeviceRemoteLockRequest {
     ...
     */
    public BaseManagedDeviceRemoteLockRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
