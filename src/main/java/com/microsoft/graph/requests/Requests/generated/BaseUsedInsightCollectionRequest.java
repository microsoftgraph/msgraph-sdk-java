...
/**
 * The class for the Base Used Insight Collection Request.
 */
public class BaseUsedInsightCollectionRequest extends BaseCollectionRequest<BaseUsedInsightCollectionResponse, IUsedInsightCollectionPage> implements IBaseUsedInsightCollectionRequest {
     ...
     */
    public BaseUsedInsightCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IUsedInsightCollectionPage get() throws ClientException {
        final BaseUsedInsightCollectionResponse response = send();
    ...
    public IUsedInsightCollectionPage buildFromResponse(final BaseUsedInsightCollectionResponse response) {
