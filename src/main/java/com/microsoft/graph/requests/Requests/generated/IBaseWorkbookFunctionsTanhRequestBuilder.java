...
/**
 * The interface for the Base Workbook Functions Tanh Request Builder.
 */
public interface IBaseWorkbookFunctionsTanhRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsTanhRequest instance
     */
    IWorkbookFunctionsTanhRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
