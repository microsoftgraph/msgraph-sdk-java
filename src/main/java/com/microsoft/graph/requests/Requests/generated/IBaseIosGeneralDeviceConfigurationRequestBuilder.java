...
/**
 * The interface for the Base Ios General Device Configuration Request Builder.
 */
public interface IBaseIosGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
