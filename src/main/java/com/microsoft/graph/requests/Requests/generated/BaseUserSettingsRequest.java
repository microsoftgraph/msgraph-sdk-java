...
/**
 * The class for the Base User Settings Request.
 */
public class BaseUserSettingsRequest extends BaseRequest implements IBaseUserSettingsRequest {
     ...
     */
    public BaseUserSettingsRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<UserSettings> responseClass) {
