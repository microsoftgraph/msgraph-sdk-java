...
/**
 * The interface for the Base Trending Collection Request.
 */
public interface IBaseTrendingCollectionRequest {
     ...
     */
    ITrendingCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ITrendingCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ITrendingCollectionRequest top(final int value);
