...
/**
 * The interface for the Base Windows81General Configuration Request.
 */
public interface IBaseWindows81GeneralConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseWindows81GeneralConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseWindows81GeneralConfigurationRequest expand(final String value);
