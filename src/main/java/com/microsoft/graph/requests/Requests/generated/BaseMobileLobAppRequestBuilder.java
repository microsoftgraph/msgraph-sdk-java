...
/**
 * The class for the Base Mobile Lob App Request Builder.
 */
public class BaseMobileLobAppRequestBuilder extends BaseRequestBuilder implements IBaseMobileLobAppRequestBuilder {
     ...
     */
    public BaseMobileLobAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IMobileLobAppRequest instance
     */
    public IMobileLobAppRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
