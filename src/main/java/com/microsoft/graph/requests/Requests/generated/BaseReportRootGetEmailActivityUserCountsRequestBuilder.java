...
/**
 * The class for the Base Report Root Get Email Activity User Counts Request Builder.
 */
public class BaseReportRootGetEmailActivityUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetEmailActivityUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
