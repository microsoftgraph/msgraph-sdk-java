...
/**
 * The class for the Base Managed Device Mobile App Configuration User Status Collection Request.
 */
public class BaseManagedDeviceMobileAppConfigurationUserStatusCollectionRequest extends BaseCollectionRequest<BaseManagedDeviceMobileAppConfigurationUserStatusCollectionResponse, IManagedDeviceMobileAppConfigurationUserStatusCollectionPage> implements IBaseManagedDeviceMobileAppConfigurationUserStatusCollectionRequest {
     ...
     */
    public BaseManagedDeviceMobileAppConfigurationUserStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseManagedDeviceMobileAppConfigurationUserStatusCollectionResponse.class, IManagedDeviceMobileAppConfigurationUserStatusCollectionPage.class);
    }
    ...
    public IManagedDeviceMobileAppConfigurationUserStatusCollectionPage get() throws ClientException {
        final BaseManagedDeviceMobileAppConfigurationUserStatusCollectionResponse response = send();
    ...
    public IManagedDeviceMobileAppConfigurationUserStatusCollectionPage buildFromResponse(final BaseManagedDeviceMobileAppConfigurationUserStatusCollectionResponse response) {
