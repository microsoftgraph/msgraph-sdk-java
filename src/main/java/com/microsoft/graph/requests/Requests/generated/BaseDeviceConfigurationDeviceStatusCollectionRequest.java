...
/**
 * The class for the Base Device Configuration Device Status Collection Request.
 */
public class BaseDeviceConfigurationDeviceStatusCollectionRequest extends BaseCollectionRequest<BaseDeviceConfigurationDeviceStatusCollectionResponse, IDeviceConfigurationDeviceStatusCollectionPage> implements IBaseDeviceConfigurationDeviceStatusCollectionRequest {
     ...
     */
    public BaseDeviceConfigurationDeviceStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceConfigurationDeviceStatusCollectionPage get() throws ClientException {
        final BaseDeviceConfigurationDeviceStatusCollectionResponse response = send();
    ...
    public IDeviceConfigurationDeviceStatusCollectionPage buildFromResponse(final BaseDeviceConfigurationDeviceStatusCollectionResponse response) {
