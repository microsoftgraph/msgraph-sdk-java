...
/**
 * The class for the Base User Settings Request Builder.
 */
public class BaseUserSettingsRequestBuilder extends BaseRequestBuilder implements IBaseUserSettingsRequestBuilder {
     ...
     */
    public BaseUserSettingsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IUserSettingsRequest buildRequest() {
