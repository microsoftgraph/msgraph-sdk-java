...
/**
 * The class for the Base Apple Push Notification Certificate Request Builder.
 */
public class BaseApplePushNotificationCertificateRequestBuilder extends BaseRequestBuilder implements IBaseApplePushNotificationCertificateRequestBuilder {
     ...
     */
    public BaseApplePushNotificationCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
