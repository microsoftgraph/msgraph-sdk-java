...
/**
 * The interface for the Base Workbook Functions Is Error Request Builder.
 */
public interface IBaseWorkbookFunctionsIsErrorRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsIsErrorRequest instance
     */
    IWorkbookFunctionsIsErrorRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
