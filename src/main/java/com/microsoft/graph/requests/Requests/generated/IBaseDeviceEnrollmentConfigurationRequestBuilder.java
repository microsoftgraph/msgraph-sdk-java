...
/**
 * The interface for the Base Device Enrollment Configuration Request Builder.
 */
public interface IBaseDeviceEnrollmentConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
