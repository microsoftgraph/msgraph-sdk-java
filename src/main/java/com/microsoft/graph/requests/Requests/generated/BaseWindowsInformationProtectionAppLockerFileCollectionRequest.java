...
/**
 * The class for the Base Windows Information Protection App Locker File Collection Request.
 */
public class BaseWindowsInformationProtectionAppLockerFileCollectionRequest extends BaseCollectionRequest<BaseWindowsInformationProtectionAppLockerFileCollectionResponse, IWindowsInformationProtectionAppLockerFileCollectionPage> implements IBaseWindowsInformationProtectionAppLockerFileCollectionRequest {
     ...
     */
    public BaseWindowsInformationProtectionAppLockerFileCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseWindowsInformationProtectionAppLockerFileCollectionResponse.class, IWindowsInformationProtectionAppLockerFileCollectionPage.class);
    }
    ...
    public IWindowsInformationProtectionAppLockerFileCollectionPage get() throws ClientException {
        final BaseWindowsInformationProtectionAppLockerFileCollectionResponse response = send();
    ...
    public IWindowsInformationProtectionAppLockerFileCollectionPage buildFromResponse(final BaseWindowsInformationProtectionAppLockerFileCollectionResponse response) {
