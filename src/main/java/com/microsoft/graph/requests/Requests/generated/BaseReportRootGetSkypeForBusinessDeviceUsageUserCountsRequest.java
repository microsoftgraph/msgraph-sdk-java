...
/**
 * The class for the Base Report Root Get Skype For Business Device Usage User Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetSkypeForBusinessDeviceUsageUserCounts
    ...
    /**
     * Puts the ReportRootGetSkypeForBusinessDeviceUsageUserCounts
     *
     ...
     */
    public IReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest)this;
    }
     ...
     * @return the updated request
     */
    public IReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest expand(final String value) {
