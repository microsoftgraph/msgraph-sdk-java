...
/**
 * The class for the Base Managed EBook Request.
 */
public class BaseManagedEBookRequest extends BaseRequest implements IBaseManagedEBookRequest {
     ...
     */
    public BaseManagedEBookRequest(final String requestUrl,
