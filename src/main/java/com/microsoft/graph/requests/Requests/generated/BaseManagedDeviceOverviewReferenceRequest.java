...
/**
 * The class for the Base Managed Device Overview Reference Request.
 */
public class BaseManagedDeviceOverviewReferenceRequest extends BaseRequest implements IBaseManagedDeviceOverviewReferenceRequest {
     ...
     */
    public BaseManagedDeviceOverviewReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
