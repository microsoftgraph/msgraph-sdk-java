...
/**
 * The interface for the Base Workbook Functions Weibull_Dist Request.
 */
public interface IBaseWorkbookFunctionsWeibull_DistRequest {
     ...
     */
    IWorkbookFunctionsWeibull_DistRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookFunctionsWeibull_DistRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsWeibull_DistRequest expand(final String value);
