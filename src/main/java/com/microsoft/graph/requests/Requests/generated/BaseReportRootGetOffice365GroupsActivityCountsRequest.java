...
/**
 * The class for the Base Report Root Get Office365Groups Activity Counts Request.
 */
public class BaseReportRootGetOffice365GroupsActivityCountsRequest extends BaseRequest implements IBaseReportRootGetOffice365GroupsActivityCountsRequest {
     ...
     */
    public BaseReportRootGetOffice365GroupsActivityCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
