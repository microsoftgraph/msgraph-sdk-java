...
/**
 * The class for the Base Used Insight Request.
 */
public class BaseUsedInsightRequest extends BaseRequest implements IBaseUsedInsightRequest {
     ...
     */
    public BaseUsedInsightRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<UsedInsight> responseClass) {
