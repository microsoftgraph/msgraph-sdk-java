...
/**
 * The class for the Base Managed Mobile App Request Builder.
 */
public class BaseManagedMobileAppRequestBuilder extends BaseRequestBuilder implements IBaseManagedMobileAppRequestBuilder {
     ...
     */
    public BaseManagedMobileAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
