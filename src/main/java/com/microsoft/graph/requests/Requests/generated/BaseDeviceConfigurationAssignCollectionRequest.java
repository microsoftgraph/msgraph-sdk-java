...
/**
 * The class for the Base Device Configuration Assign Collection Request.
 */
public class BaseDeviceConfigurationAssignCollectionRequest extends BaseCollectionRequest<BaseDeviceConfigurationAssignCollectionResponse, IDeviceConfigurationAssignCollectionPage> implements IBaseDeviceConfigurationAssignCollectionRequest {
     ...
     */
    public BaseDeviceConfigurationAssignCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceConfigurationAssignCollectionPage post() throws ClientException {
        final BaseDeviceConfigurationAssignCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public IDeviceConfigurationAssignCollectionPage buildFromResponse(final BaseDeviceConfigurationAssignCollectionResponse response) {
