...
/**
 * The interface for the Base Windows10Enterprise Modern App Management Configuration Request.
 */
public interface IBaseWindows10EnterpriseModernAppManagementConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseWindows10EnterpriseModernAppManagementConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseWindows10EnterpriseModernAppManagementConfigurationRequest expand(final String value);
