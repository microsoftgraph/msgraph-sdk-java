...
public class BaseWorkbookFunctionsEcma_CeilingRequest extends BaseRequest implements IBaseWorkbookFunctionsEcma_CeilingRequest {
     ...
     */
    public BaseWorkbookFunctionsEcma_CeilingRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWorkbookFunctionsEcma_CeilingRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsEcma_CeilingRequest top(final int value) {
