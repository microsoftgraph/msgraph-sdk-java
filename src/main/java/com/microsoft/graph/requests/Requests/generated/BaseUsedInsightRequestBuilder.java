...
/**
 * The class for the Base Used Insight Request Builder.
 */
public class BaseUsedInsightRequestBuilder extends BaseRequestBuilder implements IBaseUsedInsightRequestBuilder {
     ...
     */
    public BaseUsedInsightRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
