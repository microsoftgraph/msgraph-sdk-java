...
/**
 * The interface for the Base Device Compliance Scheduled Action For Rule Request Builder.
 */
public interface IBaseDeviceComplianceScheduledActionForRuleRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
