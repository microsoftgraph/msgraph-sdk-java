...
public class RiskyUserRequest extends BaseRequest<RiskyUser> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RiskyUser> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RiskyUser> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RiskyUser> patchAsync(@Nonnull final RiskyUser sourceRiskyUser) {
        return sendAsync(HttpMethod.PATCH, sourceRiskyUser);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RiskyUser> postAsync(@Nonnull final RiskyUser newRiskyUser) {
        return sendAsync(HttpMethod.POST, newRiskyUser);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RiskyUser> putAsync(@Nonnull final RiskyUser newRiskyUser) {
        return sendAsync(HttpMethod.PUT, newRiskyUser);
    }
