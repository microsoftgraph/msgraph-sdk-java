...
/**
 * The interface for the Printer Share Reference Request Builder.
 */
public interface IPrinterShareReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPrinterShareReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPrinterShareReferenceRequest instance
     */
    IPrinterShareReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
