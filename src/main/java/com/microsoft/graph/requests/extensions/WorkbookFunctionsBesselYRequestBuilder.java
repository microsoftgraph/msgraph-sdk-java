...
public class WorkbookFunctionsBesselYRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     * @param n the n
     */
    public WorkbookFunctionsBesselYRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final com.google.gson.JsonElement x, @Nullable final com.google.gson.JsonElement n) {
