...
public class OutlookUserSupportedTimeZonesCollectionRequest extends BaseFunctionCollectionRequest<TimeZoneInformation, OutlookUserSupportedTimeZonesCollectionResponse, OutlookUserSupportedTimeZonesCollectionPage> {
     ...
     */
    @Nonnull
    public OutlookUserSupportedTimeZonesCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OutlookUserSupportedTimeZonesCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public OutlookUserSupportedTimeZonesCollectionRequest skipToken(@Nonnull final String skipToken) {
