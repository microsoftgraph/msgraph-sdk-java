...
public class WorkbookRangeOffsetRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookRangeOffsetRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeOffsetRangeRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeOffsetRangeRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
