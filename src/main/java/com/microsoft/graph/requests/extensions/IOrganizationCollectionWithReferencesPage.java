...
/**
 * The interface for the Organization Collection With References Page.
 */
public interface IOrganizationCollectionWithReferencesPage extends IBaseCollectionPage<Organization, IOrganizationCollectionWithReferencesRequestBuilder> {
}
