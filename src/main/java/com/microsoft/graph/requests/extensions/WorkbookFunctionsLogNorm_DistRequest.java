...
public class WorkbookFunctionsLogNorm_DistRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsLogNorm_DistRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsLogNorm_DistBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsLogNorm_DistBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsLogNorm_DistRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsLogNorm_DistRequest count() {
        addCountOption(true);
        return this;
    }
