 ...
 */
public class ContactDeltaCollectionResponse implements ICollectionResponse<Contact>, IJsonBackedObject {
    ...
    @Expose
    public java.util.List<Contact> value;

    /**
     * The list of Contact within this collection page
     */
    @Override
    public java.util.List<Contact> values() {
        return value;
    }
