...
/**
 * The interface for the Workbook Table With Reference Request Builder.
 */
public interface IWorkbookTableWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookTableWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookTableWithReferenceRequest instance
     */
    IWorkbookTableWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IWorkbookTableReferenceRequestBuilder reference();
