...
public class UserWipeManagedAppRegistrationsByDeviceTagRequestBuilder extends BaseActionRequestBuilder<User> {
    ...
    private UserWipeManagedAppRegistrationsByDeviceTagBody body;
    /**
     ...
     */
    public UserWipeManagedAppRegistrationsByDeviceTagRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserWipeManagedAppRegistrationsByDeviceTagBody parameters) {
