 ...
 */
public class LinkedResourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of LinkedResource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<LinkedResource> value;
