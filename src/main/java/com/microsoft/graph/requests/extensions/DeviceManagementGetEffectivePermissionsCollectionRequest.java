 ...
 */
public class DeviceManagementGetEffectivePermissionsCollectionRequest extends BaseCollectionRequest<RolePermission, DeviceManagementGetEffectivePermissionsCollectionResponse> {
    ...
    public void get(final ICallback<? super BaseCollectionPage<RolePermission>> callback) {
    ...
    public BaseCollectionPage<RolePermission> get() throws ClientException {
        final DeviceManagementGetEffectivePermissionsCollectionResponse response = send();
        return buildFromResponse(response);
    }


    public BaseCollectionPage<RolePermission> buildFromResponse(final DeviceManagementGetEffectivePermissionsCollectionResponse response) {
        ...
        final BaseCollectionPage<RolePermission> page = new BaseCollectionPage<RolePermission>(response, builder);
