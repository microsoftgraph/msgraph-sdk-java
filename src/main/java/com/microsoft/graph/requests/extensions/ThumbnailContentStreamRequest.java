...
public class ThumbnailContentStreamRequest extends BaseStreamRequest<Thumbnail> {
     ...
     */
    public ThumbnailContentStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @param fileContents the contents of the stream to upload
          * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final byte[] fileContents, @Nonnull final ICallback<? super Thumbnail> callback) {
     ...
     */
    @Nullable
    public Thumbnail put(@Nonnull final byte[] fileContents) throws ClientException {
