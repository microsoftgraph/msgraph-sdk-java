...
public class OnenoteSectionCopyToSectionGroupRequest extends BaseRequest implements IOnenoteSectionCopyToSectionGroupRequest {
     ...
     */
    public OnenoteSectionCopyToSectionGroupRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IOnenoteSectionCopyToSectionGroupRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IOnenoteSectionCopyToSectionGroupRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IOnenoteSectionCopyToSectionGroupRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IOnenoteSectionCopyToSectionGroupRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IOnenoteSectionCopyToSectionGroupRequest orderBy(final String value) {
