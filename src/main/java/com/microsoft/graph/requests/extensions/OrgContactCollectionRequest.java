...
public class OrgContactCollectionRequest extends BaseCollectionRequest<OrgContactCollectionResponse, OrgContactCollectionPage> {
    ...
    public void get(final ICallback<? super OrgContactCollectionPage> callback) {
    ...
    public OrgContactCollectionPage buildFromResponse(final OrgContactCollectionResponse response) {
