 ...
 */
public class WorkbookFilterApplyDynamicFilterRequest extends BaseRequest implements IWorkbookFilterApplyDynamicFilterRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFilterApplyDynamicFilterRequest orderBy(final String value) {
