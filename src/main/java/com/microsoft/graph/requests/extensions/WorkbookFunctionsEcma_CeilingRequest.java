...
public class WorkbookFunctionsEcma_CeilingRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsEcma_CeilingRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsEcma_CeilingBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsEcma_CeilingBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsEcma_CeilingRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsEcma_CeilingRequest count() {
        addCountOption(true);
        return this;
    }
