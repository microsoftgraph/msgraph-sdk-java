...
public class WorkbookRangeEntireRowRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookRangeEntireRowRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeEntireRowRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeEntireRowRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
