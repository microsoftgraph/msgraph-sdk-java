...
/**
 * The interface for the Workbook Reference Request Builder.
 */
public interface IWorkbookReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookReferenceRequest instance
     */
    IWorkbookReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
