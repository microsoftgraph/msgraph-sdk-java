 ...
 */
public class ManagedMobileLobAppCollectionResponse implements ICollectionResponse<ManagedMobileLobApp>, IJsonBackedObject {

    /**
     * The list of ManagedMobileLobApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ManagedMobileLobApp> value;

    /**
     * The list of ManagedMobileLobApp within this collection page
     */
    @Override
    public java.util.List<ManagedMobileLobApp> values() {
        return value;
    }
