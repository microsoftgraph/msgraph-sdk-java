...
import com.microsoft.graph.models.extensions.WorkbookTableRowItemAtBody;
...
public class WorkbookTableRowItemAtRequest extends BaseRequest<WorkbookTableRow> {
     ...
     */
    @Nonnull
    public WorkbookTableRowItemAtRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableRowItemAtRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableRowItemAtRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
