...
/**
 * The class for the Workbook Range View Reference Request.
 */
public class WorkbookRangeViewReferenceRequest extends BaseRequest implements IWorkbookRangeViewReferenceRequest {
     ...
     */
    public WorkbookRangeViewReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWorkbookRangeViewReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (WorkbookRangeViewReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookRangeViewReferenceRequest expand(final String value) {
     ...
     *
     * @param srcWorkbookRangeView the WorkbookRangeView reference to PUT
    ...
    public WorkbookRangeView put(WorkbookRangeView srcWorkbookRangeView) throws ClientException {
        return send(HttpMethod.PUT, srcWorkbookRangeView);
    }
}
