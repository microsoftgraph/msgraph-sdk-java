...
public class TargetedManagedAppConfigurationTargetAppsRequest extends BaseRequest<Void> {
     ...
     */
    public TargetedManagedAppConfigurationTargetAppsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TargetedManagedAppConfigurationTargetAppsBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected TargetedManagedAppConfigurationTargetAppsBody body;
    /**
