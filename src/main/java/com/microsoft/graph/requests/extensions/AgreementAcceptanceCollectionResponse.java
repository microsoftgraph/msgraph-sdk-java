 ...
 */
public class AgreementAcceptanceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AgreementAcceptance within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AgreementAcceptance> value;
