...
public class WebAppRequestBuilder extends BaseRequestBuilder<WebApp> {
     ...
     */
    public WebAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WebAppRequest instance
     */
    public WebAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
