...
public class WorkbookRangeBorderCountRequest extends BaseRequest<Integer> {
     ...
     */
    @Nonnull
    public WorkbookRangeBorderCountRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeBorderCountRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeBorderCountRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
