 ...
 */
public class DirectoryRoleDeltaCollectionResponse implements ICollectionResponse<DirectoryRole>, IJsonBackedObject {

    /**
     * The list of DirectoryRole within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DirectoryRole> value;

    /**
     * The list of DirectoryRole within this collection page
     */
    @Override
    public java.util.List<DirectoryRole> values() {
        return value;
    }
