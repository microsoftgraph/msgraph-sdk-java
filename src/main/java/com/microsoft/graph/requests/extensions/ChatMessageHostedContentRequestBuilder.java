...
public class ChatMessageHostedContentRequestBuilder extends BaseRequestBuilder<ChatMessageHostedContent> {
     ...
     */
    public ChatMessageHostedContentRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ChatMessageHostedContentRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ChatMessageHostedContentRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
