 ...
 */
public interface IWorkbookTableColumnHeaderRowRangeRequest extends IHttpRequest {
     ...
     */
    IWorkbookTableColumnHeaderRowRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookTableColumnHeaderRowRangeRequest expand(final String value);
