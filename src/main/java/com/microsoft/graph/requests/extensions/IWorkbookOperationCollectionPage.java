...
/**
 * The interface for the Workbook Operation Collection Page.
 */
public interface IWorkbookOperationCollectionPage extends IBaseCollectionPage<WorkbookOperation, IWorkbookOperationCollectionRequestBuilder> {
}
