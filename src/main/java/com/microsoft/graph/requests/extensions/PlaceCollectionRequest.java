 ...
 */
public class PlaceCollectionRequest extends BaseCollectionRequest<Place, PlaceCollectionResponse> {
    ...
    public BaseCollectionPage<Place> get() throws ClientException {
    ...
    public BaseCollectionPage<Place> buildFromResponse(final PlaceCollectionResponse response) {
        ...
        final BaseCollectionPage<Place> page = new BaseCollectionPage<Place>(response, builder);
