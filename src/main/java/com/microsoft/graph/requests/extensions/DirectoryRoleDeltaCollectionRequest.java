 ...
 */
public class DirectoryRoleDeltaCollectionRequest extends BaseCollectionRequest<DirectoryRole, DirectoryRoleDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<DirectoryRole> buildFromResponse(final DirectoryRoleDeltaCollectionResponse response) {
