...
public interface IDeviceConfigurationDeviceStatusCollectionRequest extends IHttpRequest {
     ...
     * @return the updated request
     */
    IDeviceConfigurationDeviceStatusCollectionRequest skip(final int value);
	 ...
	 * @return the updated request
	 */
	IDeviceConfigurationDeviceStatusCollectionRequest skipToken(final String skipToken);
}
