 ...
 */
public class ContentTypeCollectionRequest extends BaseCollectionRequest<ContentTypeCollectionResponse, IContentTypeCollectionPage> implements IContentTypeCollectionRequest {
     ...
     */
    public ContentTypeCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
