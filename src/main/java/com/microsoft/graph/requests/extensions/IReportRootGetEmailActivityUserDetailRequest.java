 ...
 */
public interface IReportRootGetEmailActivityUserDetailRequest extends IHttpRequest {
     ...
     */
    IReportRootGetEmailActivityUserDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetEmailActivityUserDetailRequest expand(final String value);
