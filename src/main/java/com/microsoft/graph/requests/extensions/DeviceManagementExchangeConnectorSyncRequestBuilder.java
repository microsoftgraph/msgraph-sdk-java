...
public class DeviceManagementExchangeConnectorSyncRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public DeviceManagementExchangeConnectorSyncRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the DeviceManagementExchangeConnectorSyncRequest instance
     */
    public DeviceManagementExchangeConnectorSyncRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
