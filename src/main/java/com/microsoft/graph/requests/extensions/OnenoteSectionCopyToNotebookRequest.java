...
public class OnenoteSectionCopyToNotebookRequest extends BaseRequest<OnenoteOperation> {
     ...
     */
    public OnenoteSectionCopyToNotebookRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final OnenoteSectionCopyToNotebookParameterSet parameters) {
