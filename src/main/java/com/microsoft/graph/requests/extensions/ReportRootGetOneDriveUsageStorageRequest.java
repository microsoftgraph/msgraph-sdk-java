...
import com.microsoft.graph.requests.generated.BaseReportRootGetOneDriveUsageStorageRequest;
...
public class ReportRootGetOneDriveUsageStorageRequest extends BaseReportRootGetOneDriveUsageStorageRequest implements IReportRootGetOneDriveUsageStorageRequest {
     ...
     */
    public ReportRootGetOneDriveUsageStorageRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
