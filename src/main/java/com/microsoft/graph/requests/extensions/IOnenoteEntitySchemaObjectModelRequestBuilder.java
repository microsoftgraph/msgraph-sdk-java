...
public interface IOnenoteEntitySchemaObjectModelRequestBuilder extends IRequestBuilder {
     ...
     */
    IOnenoteEntitySchemaObjectModelRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOnenoteEntitySchemaObjectModelRequest instance
     */
    IOnenoteEntitySchemaObjectModelRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
