 ...
 */
public interface IGroupLifecyclePolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IGroupLifecyclePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
