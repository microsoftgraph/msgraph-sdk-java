 ...
 */
public interface IDomainDnsRecordRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDomainDnsRecordRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
