...
public class PlannerTaskReferenceRequestBuilder extends BaseRequestBuilder implements IPlannerTaskReferenceRequestBuilder {
     ...
     */
    public PlannerTaskReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IPlannerTaskReferenceRequest buildRequest() {
     ...
     * @return the IPlannerTaskReferenceRequest instance
     */
    public IPlannerTaskReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
