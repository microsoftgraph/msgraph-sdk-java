...
public class IosDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder<IosDeviceFeaturesConfiguration> {
     ...
     */
    public IosDeviceFeaturesConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IosDeviceFeaturesConfigurationRequest instance
     */
    public IosDeviceFeaturesConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
