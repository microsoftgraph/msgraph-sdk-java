 ...
 */
public class TermsAndConditionsWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public TermsAndConditionsWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the TermsAndConditionsWithReferenceRequest instance
     */
    @Nonnull
    public TermsAndConditionsWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TermsAndConditionsWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new TermsAndConditionsWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public TermsAndConditionsReferenceRequestBuilder reference(){
