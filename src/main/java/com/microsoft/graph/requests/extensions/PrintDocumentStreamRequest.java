 ...
 */
public class PrintDocumentStreamRequest extends BaseStreamRequest<PrintDocument> implements IPrintDocumentStreamRequest {
     ...
     */
    public PrintDocumentStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @param fileContents the contents of the stream to upload
          * @param callback the callback to be called after success or failure
     */
    public void put(final byte[] fileContents, final ICallback<? super PrintDocument> callback) {
     ...
     * @throws ClientException an exception occurs if there was an error while the request was sent
     */
    public PrintDocument put(final byte[] fileContents) throws ClientException {
