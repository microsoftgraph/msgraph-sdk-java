...
public class UserReprocessLicenseAssignmentRequest extends BaseRequest<User> {
     ...
     */
    @Nonnull
    public UserReprocessLicenseAssignmentRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public UserReprocessLicenseAssignmentRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public UserReprocessLicenseAssignmentRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
