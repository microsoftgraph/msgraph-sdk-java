...
/**
 * The interface for the Time Off Collection Page.
 */
public interface ITimeOffCollectionPage extends IBaseCollectionPage<TimeOff, ITimeOffCollectionRequestBuilder> {
}
