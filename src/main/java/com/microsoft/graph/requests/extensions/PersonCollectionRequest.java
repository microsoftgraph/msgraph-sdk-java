...
public class PersonCollectionRequest extends BaseCollectionRequest<PersonCollectionResponse, PersonCollectionPage> {
    ...
    public void get(final ICallback<? super PersonCollectionPage> callback) {
    ...
    public PersonCollectionPage buildFromResponse(final PersonCollectionResponse response) {
