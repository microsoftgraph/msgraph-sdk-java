...
public interface IUserReminderViewCollectionRequestBuilder extends IRequestBuilder {
     ...
     */
    IUserReminderViewCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserRequest instance
     */
    IUserReminderViewCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
