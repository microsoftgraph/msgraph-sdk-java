...
public interface ITermsAndConditionsWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ITermsAndConditionsWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ITermsAndConditionsWithReferenceRequest instance
     */
    ITermsAndConditionsWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
