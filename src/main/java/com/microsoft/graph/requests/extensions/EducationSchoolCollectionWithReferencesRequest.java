...
public class EducationSchoolCollectionWithReferencesRequest extends BaseCollectionRequest<EducationSchoolCollectionResponse, EducationSchoolCollectionPage> {
     ...
     */
    public EducationSchoolCollectionWithReferencesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, EducationSchoolCollectionResponse.class, EducationSchoolCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super EducationSchoolCollectionWithReferencesPage> callback) {
    ...
    @Nonnull
    public EducationSchoolCollectionWithReferencesRequest expand(@Nonnull final String value) {
        addQueryOption(new com.microsoft.graph.options.QueryOption("$expand", value));
        return this;
    }

    @Nonnull
    public EducationSchoolCollectionWithReferencesRequest filter(@Nonnull final String value) {
        addQueryOption(new com.microsoft.graph.options.QueryOption("$filter", value));
        return this;
    }

    @Nonnull
    public EducationSchoolCollectionWithReferencesRequest orderBy(@Nonnull final String value) {
        addQueryOption(new com.microsoft.graph.options.QueryOption("$orderby", value));
        return this;
    }

    @Nonnull
    public EducationSchoolCollectionWithReferencesRequest select(@Nonnull final String value) {
    ...
    @Nonnull
    public EducationSchoolCollectionWithReferencesPage buildFromResponse(@Nonnull final EducationSchoolCollectionResponse response) {
