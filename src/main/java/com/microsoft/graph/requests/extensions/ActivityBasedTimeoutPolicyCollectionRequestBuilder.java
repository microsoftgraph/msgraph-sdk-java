...
public class ActivityBasedTimeoutPolicyCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ActivityBasedTimeoutPolicyCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ActivityBasedTimeoutPolicyCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ActivityBasedTimeoutPolicyCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ActivityBasedTimeoutPolicyRequestBuilder byId(@Nonnull final String id) {
