...
/**
 * The class for the Audit Log Root Reference Request Builder.
 */
public class AuditLogRootReferenceRequestBuilder extends BaseRequestBuilder implements IAuditLogRootReferenceRequestBuilder {
     ...
     */
    public AuditLogRootReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAuditLogRootReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAuditLogRootReferenceRequest instance
     */
    public IAuditLogRootReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new AuditLogRootReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
