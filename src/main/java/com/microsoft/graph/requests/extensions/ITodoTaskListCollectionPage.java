...
/**
 * The interface for the Todo Task List Collection Page.
 */
public interface ITodoTaskListCollectionPage extends IBaseCollectionPage<TodoTaskList, ITodoTaskListCollectionRequestBuilder> {
}
