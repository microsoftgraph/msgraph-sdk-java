...
public class UserDeltaCollectionRequestBuilder extends BaseFunctionCollectionRequestBuilder<User, UserDeltaCollectionRequestBuilder, UserDeltaCollectionResponse, UserDeltaCollectionPage, UserDeltaCollectionRequest> {
    ...
    public UserDeltaCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, UserDeltaCollectionRequestBuilder.class, UserDeltaCollectionResponse.class, UserDeltaCollectionPage.class, UserDeltaCollectionRequest.class);
    }
