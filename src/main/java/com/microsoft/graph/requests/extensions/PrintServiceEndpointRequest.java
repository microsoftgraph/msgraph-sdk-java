 ...
 */
public class PrintServiceEndpointRequest extends BaseRequest implements IPrintServiceEndpointRequest {
     ...
     */
    public PrintServiceEndpointRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public PrintServiceEndpoint patch(final PrintServiceEndpoint sourcePrintServiceEndpoint) throws ClientException {
     ...
     */
     public IPrintServiceEndpointRequest select(final String value) {
