 ...
 */
public interface IWorkbookRangeCellRequest extends IHttpRequest {
     ...
     */
    IWorkbookRangeCellRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookRangeCellRequest expand(final String value);
