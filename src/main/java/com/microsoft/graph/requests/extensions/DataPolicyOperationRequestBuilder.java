...
public class DataPolicyOperationRequestBuilder extends BaseRequestBuilder<DataPolicyOperation> {
     ...
     */
    public DataPolicyOperationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the DataPolicyOperationRequest instance
     */
    public DataPolicyOperationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
