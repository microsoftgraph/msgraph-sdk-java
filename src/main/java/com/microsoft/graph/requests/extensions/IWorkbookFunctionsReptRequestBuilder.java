...
public interface IWorkbookFunctionsReptRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsReptRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsReptRequest instance
     */
    IWorkbookFunctionsReptRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
