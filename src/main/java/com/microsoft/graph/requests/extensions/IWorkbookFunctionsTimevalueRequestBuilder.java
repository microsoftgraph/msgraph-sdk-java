 ...
 */
public interface IWorkbookFunctionsTimevalueRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsTimevalueRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
