...
public class ManagedDeviceMobileAppConfigurationUserSummaryRequest extends BaseRequest<ManagedDeviceMobileAppConfigurationUserSummary> {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationUserSummaryRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationUserSummaryRequest count() {
        addCountOption(true);
        return this;
    }
}
