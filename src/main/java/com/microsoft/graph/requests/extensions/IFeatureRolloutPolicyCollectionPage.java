...
/**
 * The interface for the Feature Rollout Policy Collection Page.
 */
public interface IFeatureRolloutPolicyCollectionPage extends IBaseCollectionPage<FeatureRolloutPolicy, IFeatureRolloutPolicyCollectionRequestBuilder> {
}
