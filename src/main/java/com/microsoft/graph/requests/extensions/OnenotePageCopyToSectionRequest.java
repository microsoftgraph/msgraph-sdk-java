...
public class OnenotePageCopyToSectionRequest extends BaseRequest<OnenoteOperation> {
     ...
     */
    public OnenotePageCopyToSectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final OnenotePageCopyToSectionBody parameters) {
        super(requestUrl, client, requestOptions, OnenoteOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected OnenotePageCopyToSectionBody body;
    /**
     ...
     */
    @Nonnull
    public OnenotePageCopyToSectionRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OnenotePageCopyToSectionRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OnenotePageCopyToSectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OnenotePageCopyToSectionRequest count() {
        addCountOption(true);
        return this;
    }
