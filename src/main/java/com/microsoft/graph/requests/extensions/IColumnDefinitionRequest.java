...
public interface IColumnDefinitionRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    ColumnDefinition put(final ColumnDefinition newColumnDefinition) throws ClientException;
     ...
     */
    IColumnDefinitionRequest select(final String value);
     ...
     * @return the updated request
     */
    IColumnDefinitionRequest expand(final String value);
