 ...
 */
public class TodoTaskListCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TodoTaskList within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TodoTaskList> value;
