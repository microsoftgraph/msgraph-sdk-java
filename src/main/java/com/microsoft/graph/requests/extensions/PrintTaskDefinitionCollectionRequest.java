...
public class PrintTaskDefinitionCollectionRequest extends BaseCollectionRequest<PrintTaskDefinitionCollectionResponse, IPrintTaskDefinitionCollectionPage> implements IPrintTaskDefinitionCollectionRequest {
     ...
     */
    public PrintTaskDefinitionCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IPrintTaskDefinitionCollectionPage get() throws ClientException {
        final PrintTaskDefinitionCollectionResponse response = send();
     ...
     */
    public IPrintTaskDefinitionCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IPrintTaskDefinitionCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IPrintTaskDefinitionCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IPrintTaskDefinitionCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPrintTaskDefinitionCollectionRequest top(final int value) {
    ...
    public IPrintTaskDefinitionCollectionPage buildFromResponse(final PrintTaskDefinitionCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new PrintTaskDefinitionCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final PrintTaskDefinitionCollectionPage page = new PrintTaskDefinitionCollectionPage(response, builder);
