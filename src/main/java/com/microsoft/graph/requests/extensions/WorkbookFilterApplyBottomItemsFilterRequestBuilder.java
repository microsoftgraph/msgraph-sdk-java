...
public class WorkbookFilterApplyBottomItemsFilterRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFilterApplyBottomItemsFilterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final Integer count) {
