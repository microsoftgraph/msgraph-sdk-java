...
public class GroupSettingTemplateCollectionRequest extends BaseCollectionRequest<GroupSettingTemplateCollectionResponse, IGroupSettingTemplateCollectionPage> implements IGroupSettingTemplateCollectionRequest {
     ...
     */
    public GroupSettingTemplateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IGroupSettingTemplateCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IGroupSettingTemplateCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IGroupSettingTemplateCollectionRequest top(final int value) {
    ...
    public IGroupSettingTemplateCollectionPage buildFromResponse(final GroupSettingTemplateCollectionResponse response) {
        ...
        final GroupSettingTemplateCollectionPage page = new GroupSettingTemplateCollectionPage(response, builder);
