...
public class ManagedAppPolicyCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ManagedAppPolicyCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedAppPolicyCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ManagedAppPolicyCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ManagedAppPolicyRequestBuilder byId(@Nonnull final String id) {
