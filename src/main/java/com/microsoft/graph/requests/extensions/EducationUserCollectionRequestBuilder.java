...
public class EducationUserCollectionRequestBuilder extends BaseCollectionRequestBuilder<EducationUser, EducationUserRequestBuilder, EducationUserCollectionResponse, EducationUserCollectionPage, EducationUserCollectionRequest> {
    ...
    public EducationUserCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, EducationUserRequestBuilder.class, EducationUserCollectionResponse.class, EducationUserCollectionPage.class, EducationUserCollectionRequest.class);
    }
