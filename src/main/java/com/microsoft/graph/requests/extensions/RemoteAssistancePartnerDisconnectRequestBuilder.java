 ...
 */
public class RemoteAssistancePartnerDisconnectRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public RemoteAssistancePartnerDisconnectRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the RemoteAssistancePartnerDisconnectRequest instance
     */
    public RemoteAssistancePartnerDisconnectRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
