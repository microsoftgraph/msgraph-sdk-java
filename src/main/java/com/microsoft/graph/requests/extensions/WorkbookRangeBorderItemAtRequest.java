...
public class WorkbookRangeBorderItemAtRequest extends BaseRequest<WorkbookRangeBorder> {
     ...
     */
    @Nonnull
    public WorkbookRangeBorderItemAtRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeBorderItemAtRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeBorderItemAtRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
