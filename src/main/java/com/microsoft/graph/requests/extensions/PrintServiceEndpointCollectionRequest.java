...
public class PrintServiceEndpointCollectionRequest extends BaseCollectionRequest<PrintServiceEndpointCollectionResponse, IPrintServiceEndpointCollectionPage> implements IPrintServiceEndpointCollectionRequest {
     ...
     */
    public PrintServiceEndpointCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IPrintServiceEndpointCollectionPage get() throws ClientException {
        final PrintServiceEndpointCollectionResponse response = send();
     ...
     */
    public IPrintServiceEndpointCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IPrintServiceEndpointCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPrintServiceEndpointCollectionRequest top(final int value) {
    ...
    public IPrintServiceEndpointCollectionPage buildFromResponse(final PrintServiceEndpointCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new PrintServiceEndpointCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final PrintServiceEndpointCollectionPage page = new PrintServiceEndpointCollectionPage(response, builder);
