 ...
 */
public class UserGetManagedAppDiagnosticStatusesCollectionRequest extends BaseCollectionRequest<ManagedAppDiagnosticStatus, UserGetManagedAppDiagnosticStatusesCollectionResponse> {
    ...
    public void get(final ICallback<? super BaseCollectionPage<ManagedAppDiagnosticStatus>> callback) {
    ...
    public BaseCollectionPage<ManagedAppDiagnosticStatus> get() throws ClientException {
        final UserGetManagedAppDiagnosticStatusesCollectionResponse response = send();
        return buildFromResponse(response);
    }


    public BaseCollectionPage<ManagedAppDiagnosticStatus> buildFromResponse(final UserGetManagedAppDiagnosticStatusesCollectionResponse response) {
        ...
        final BaseCollectionPage<ManagedAppDiagnosticStatus> page = new BaseCollectionPage<ManagedAppDiagnosticStatus>(response, builder);
