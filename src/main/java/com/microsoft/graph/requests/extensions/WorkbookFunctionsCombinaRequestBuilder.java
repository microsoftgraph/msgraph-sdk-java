 ...
 */
public class WorkbookFunctionsCombinaRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsCombinaRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsCombinaRequest instance
     */
    public WorkbookFunctionsCombinaRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
