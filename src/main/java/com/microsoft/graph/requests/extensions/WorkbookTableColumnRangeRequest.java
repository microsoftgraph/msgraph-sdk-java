...
public class WorkbookTableColumnRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    public WorkbookTableColumnRangeRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnRangeRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableColumnRangeRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
