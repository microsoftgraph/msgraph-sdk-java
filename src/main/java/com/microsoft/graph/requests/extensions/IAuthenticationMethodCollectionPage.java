...
/**
 * The interface for the Authentication Method Collection Page.
 */
public interface IAuthenticationMethodCollectionPage extends IBaseCollectionPage<AuthenticationMethod, IAuthenticationMethodCollectionRequestBuilder> {
}
