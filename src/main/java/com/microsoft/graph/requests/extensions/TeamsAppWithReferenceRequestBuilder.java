...
public class TeamsAppWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public TeamsAppWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TeamsAppWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
