...
public class UserRevokeSignInSessionsRequestBuilder extends BaseActionRequestBuilder<Boolean> {
     ...
     */
    public UserRevokeSignInSessionsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public UserRevokeSignInSessionsRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
