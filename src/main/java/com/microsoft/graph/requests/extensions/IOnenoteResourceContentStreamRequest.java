...
/**
 * The interface for the Onenote Resource Content Stream Request.
 */
public interface IOnenoteResourceContentStreamRequest extends IHttpStreamRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final byte[] fileContents, final ICallback<? super OnenoteResource> callback);
