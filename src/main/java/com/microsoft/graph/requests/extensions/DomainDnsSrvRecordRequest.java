 ...
 */
public class DomainDnsSrvRecordRequest extends BaseRequest implements IDomainDnsSrvRecordRequest {
     ...
     */
    public void delete(final ICallback<DomainDnsSrvRecord> callback) {
