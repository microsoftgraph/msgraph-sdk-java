...
public class WorkbookFunctionsHypGeom_DistRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsHypGeom_DistRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsHypGeom_DistRequest instance
     */
    public WorkbookFunctionsHypGeom_DistRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
