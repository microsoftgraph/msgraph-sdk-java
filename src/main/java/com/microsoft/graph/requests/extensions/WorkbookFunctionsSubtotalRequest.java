...
public class WorkbookFunctionsSubtotalRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsSubtotalRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsSubtotalBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsSubtotalBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsSubtotalRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsSubtotalRequest count() {
        addCountOption(true);
        return this;
    }
