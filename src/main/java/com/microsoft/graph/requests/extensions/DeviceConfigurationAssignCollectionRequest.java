 ...
 */
public class DeviceConfigurationAssignCollectionRequest extends BaseCollectionRequest<DeviceConfigurationAssignment, DeviceConfigurationAssignCollectionResponse> {
    ...
    public DeviceConfigurationAssignCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceConfigurationAssignment.class, DeviceConfigurationAssignCollectionResponse.class, (Class<BaseCollectionPage<DeviceConfigurationAssignment>>) (new BaseCollectionPage<DeviceConfigurationAssignment>(new java.util.ArrayList<DeviceConfigurationAssignment>(), null).getClass()));
        body = new DeviceConfigurationAssignBody();
    }


    public void post(final ICallback<? super BaseCollectionPage<DeviceConfigurationAssignment>> callback) {
    ...
    public BaseCollectionPage<DeviceConfigurationAssignment> post() throws ClientException {
        final DeviceConfigurationAssignCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public BaseCollectionPage<DeviceConfigurationAssignment> buildFromResponse(final DeviceConfigurationAssignCollectionResponse response) {
