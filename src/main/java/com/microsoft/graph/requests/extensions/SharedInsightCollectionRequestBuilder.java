 ...
 */
public class SharedInsightCollectionRequestBuilder extends BaseRequestBuilder<SharedInsight> {
     ...
     */
    public SharedInsightCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public SharedInsightCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new SharedInsightCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public SharedInsightRequestBuilder byId(final String id) {
