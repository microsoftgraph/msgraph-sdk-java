...
import com.microsoft.graph.models.extensions.ManagedDeviceWipeParameterSet;
...
public class ManagedDeviceWipeRequestBuilder extends BaseActionRequestBuilder<ManagedDevice> {
    ...
    private ManagedDeviceWipeParameterSet body;
    /**
     ...
     */
    public ManagedDeviceWipeRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceWipeParameterSet parameters) {
