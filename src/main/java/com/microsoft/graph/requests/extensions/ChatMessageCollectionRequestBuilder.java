 ...
 */
public class ChatMessageCollectionRequestBuilder extends BaseRequestBuilder<ChatMessage> {
     ...
     */
    public ChatMessageCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public ChatMessageCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ChatMessageCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public ChatMessageRequestBuilder byId(final String id) {
