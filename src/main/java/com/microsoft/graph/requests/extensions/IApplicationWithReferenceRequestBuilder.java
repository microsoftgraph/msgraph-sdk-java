...
/**
 * The interface for the Application With Reference Request Builder.
 */
public interface IApplicationWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     * @return the IApplicationWithReferenceRequest instance
     */
    IApplicationWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IApplicationReferenceRequestBuilder reference();
