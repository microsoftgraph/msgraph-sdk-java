...
public class WorkbookFunctionsProductRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsProductRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsProductRequest instance
     */
    public WorkbookFunctionsProductRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
