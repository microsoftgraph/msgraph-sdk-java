...
public class ThumbnailSetCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ThumbnailSetCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ThumbnailSetCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ThumbnailSetCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ThumbnailSetRequestBuilder byId(@Nonnull final String id) {
