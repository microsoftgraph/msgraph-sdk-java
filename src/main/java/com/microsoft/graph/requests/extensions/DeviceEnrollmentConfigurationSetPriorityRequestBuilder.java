...
public class DeviceEnrollmentConfigurationSetPriorityRequestBuilder extends BaseActionRequestBuilder<DeviceEnrollmentConfiguration> {
    ...
    private DeviceEnrollmentConfigurationSetPriorityBody body;
    /**
     ...
     */
    public DeviceEnrollmentConfigurationSetPriorityRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DeviceEnrollmentConfigurationSetPriorityBody parameters) {
