...
public class DriveItemRestoreRequest extends BaseRequest<DriveItem> {
     ...
     */
    public DriveItemRestoreRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DriveItemRestoreBody parameters) {
        super(requestUrl, client, requestOptions, DriveItem.class);
        body = parameters;
    }

	/** The body for the method */
    protected DriveItemRestoreBody body;
    /**
     ...
     */
    @Nonnull
    public DriveItemRestoreRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DriveItemRestoreRequest count() {
        addCountOption(true);
        return this;
    }
