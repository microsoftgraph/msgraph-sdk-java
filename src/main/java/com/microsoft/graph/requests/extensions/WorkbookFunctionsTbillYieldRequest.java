 ...
 */
public class WorkbookFunctionsTbillYieldRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsTbillYieldRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsTbillYieldRequest expand(final String value) {
