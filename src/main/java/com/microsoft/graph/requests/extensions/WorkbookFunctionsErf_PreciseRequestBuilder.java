...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsErf_PreciseRequestBuilder;
...
public class WorkbookFunctionsErf_PreciseRequestBuilder extends BaseWorkbookFunctionsErf_PreciseRequestBuilder implements IWorkbookFunctionsErf_PreciseRequestBuilder {
     ...
     * @param x the x
     */
    public WorkbookFunctionsErf_PreciseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.google.gson.JsonElement x) {
