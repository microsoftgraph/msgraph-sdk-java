...
public class ReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest extends BaseRequest<Report> {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
