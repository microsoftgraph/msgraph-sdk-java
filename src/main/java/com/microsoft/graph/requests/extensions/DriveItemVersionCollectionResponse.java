 ...
 */
public class DriveItemVersionCollectionResponse implements ICollectionResponse<DriveItemVersion>, IJsonBackedObject {

    /**
     * The list of DriveItemVersion within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DriveItemVersion> value;

    /**
     * The list of DriveItemVersion within this collection page
     */
    @Override
    public java.util.List<DriveItemVersion> values() {
        return value;
    }
