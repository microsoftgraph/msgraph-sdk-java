...
public class WindowsInformationProtectionAppLockerFileCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WindowsInformationProtectionAppLockerFileCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionAppLockerFileCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionAppLockerFileCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WindowsInformationProtectionAppLockerFileCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public WindowsInformationProtectionAppLockerFileRequestBuilder byId(@Nonnull final String id) {
