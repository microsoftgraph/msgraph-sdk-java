 ...
 */
public interface IMessageForwardRequest extends IHttpRequest {
     ...
     */
    IMessageForwardRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IMessageForwardRequest top(final int value);
