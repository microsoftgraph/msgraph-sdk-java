 ...
 */
public class ReportRootGetSharePointActivityFileCountsRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetSharePointActivityFileCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetSharePointActivityFileCounts
    ...
    /**
     * Puts the ReportRootGetSharePointActivityFileCounts
     *
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityFileCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityFileCountsRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityFileCountsRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityFileCountsRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityFileCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityFileCountsRequest count() {
        addCountOption(true);
        return this;
    }
}
