 ...
 */
public class CalendarCollectionResponse implements ICollectionResponse<Calendar>, IJsonBackedObject {
    ...
    @Expose
    public java.util.List<Calendar> value;

    /**
     * The list of Calendar within this collection page
     */
    @Override
    public java.util.List<Calendar> values() {
        return value;
    }
