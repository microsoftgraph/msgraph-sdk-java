 ...
 */
public class ConversationThreadCollectionResponse implements ICollectionResponse<ConversationThread>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<ConversationThread> values() {
        return value;
    }
