...
public class ServicePrincipalReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ServicePrincipalReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ServicePrincipalReferenceRequest instance
     */
    public ServicePrincipalReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
