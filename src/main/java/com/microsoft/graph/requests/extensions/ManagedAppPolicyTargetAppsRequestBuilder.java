...
public class ManagedAppPolicyTargetAppsRequestBuilder extends BaseActionRequestBuilder implements IManagedAppPolicyTargetAppsRequestBuilder {
     ...
     * @param apps the apps
     */
    public ManagedAppPolicyTargetAppsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final java.util.List<ManagedMobileApp> apps) {
