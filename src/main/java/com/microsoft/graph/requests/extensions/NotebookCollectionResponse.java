 ...
 */
public class NotebookCollectionResponse implements ICollectionResponse<Notebook>, IJsonBackedObject {

    /**
     * The list of Notebook within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Notebook> value;

    /**
     * The list of Notebook within this collection page
     */
    @Override
    public java.util.List<Notebook> values() {
        return value;
    }
