 ...
 */
public class WorkbookFunctionsQuartile_ExcRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsQuartile_ExcRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsQuartile_ExcRequest expand(final String value) {
