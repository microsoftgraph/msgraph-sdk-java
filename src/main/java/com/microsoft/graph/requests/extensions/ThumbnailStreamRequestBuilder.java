...
import com.microsoft.graph.requests.generated.BaseThumbnailStreamRequestBuilder;
...
public class ThumbnailStreamRequestBuilder extends BaseThumbnailStreamRequestBuilder implements IThumbnailStreamRequestBuilder {
     ...
     */
    public ThumbnailStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
