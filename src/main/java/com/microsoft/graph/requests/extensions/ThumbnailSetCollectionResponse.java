...
/**
 * The class for the Thumbnail Set Collection Response.
 */
public class ThumbnailSetCollectionResponse implements ICollectionResponse<ThumbnailSet>, IJsonBackedObject {
    ...
    @Expose
    public java.util.List<ThumbnailSet> value;

    /**
     * The list of ThumbnailSet within this collection page
     */
    @Override
    public java.util.List<ThumbnailSet> values() {
        return value;
    }
