 ...
 */
public class UserTranslateExchangeIdsCollectionResponse implements ICollectionResponse<ConvertIdResult>, IJsonBackedObject {

    /**
     * The list of ConvertIdResult within this collection page
     */
     ...
     */
    @Override
    public java.util.List<ConvertIdResult> values() {
        return value;
    }
