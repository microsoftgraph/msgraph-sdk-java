...
/**
 * The interface for the Organization Collection Reference Request.
 */
public interface IOrganizationCollectionReferenceRequest {
    IOrganizationCollectionReferenceRequest select(final String value);

    IOrganizationCollectionReferenceRequest top(final int value);
