...
public class CalendarSharingMessageAcceptRequest extends BaseRequest<Calendar> {
     ...
     */
    @Nonnull
    public CalendarSharingMessageAcceptRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public CalendarSharingMessageAcceptRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public CalendarSharingMessageAcceptRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
