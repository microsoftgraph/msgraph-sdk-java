...
public class DriveItemCheckinRequestBuilder extends BaseActionRequestBuilder implements IDriveItemCheckinRequestBuilder {
     ...
     */
    public DriveItemCheckinRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String checkInAs, final String comment) {
     ...
     * @return the IDriveItemCheckinRequest instance
     */
    public IDriveItemCheckinRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
