...
/**
 * The class for the Device App Management With Reference Request Builder.
 */
public class DeviceAppManagementWithReferenceRequestBuilder extends BaseRequestBuilder implements IDeviceAppManagementWithReferenceRequestBuilder {
     ...
     */
    public DeviceAppManagementWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IDeviceAppManagementWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IDeviceAppManagementWithReferenceRequest instance
     */
    public IDeviceAppManagementWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DeviceAppManagementWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IDeviceAppManagementReferenceRequestBuilder reference(){
        return new DeviceAppManagementReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
