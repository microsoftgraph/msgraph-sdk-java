...
import com.microsoft.graph.models.extensions.MailFolderCopyBody;
...
public class MailFolderRequestBuilder extends BaseRequestBuilder<MailFolder> {
     ...
     */
    @Nonnull
    public MailFolderCopyRequestBuilder copy(@Nonnull final MailFolderCopyBody parameters) {
     ...
     */
    @Nonnull
    public MailFolderMoveRequestBuilder move(@Nonnull final MailFolderMoveBody parameters) {
