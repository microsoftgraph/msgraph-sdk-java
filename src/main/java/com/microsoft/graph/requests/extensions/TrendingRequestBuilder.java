...
public class TrendingRequestBuilder extends BaseRequestBuilder<Trending> {
     ...
     */
    public TrendingRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the TrendingRequest instance
     */
    public TrendingRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
