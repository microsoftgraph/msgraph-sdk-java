...
public class ManagedAppRegistrationCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ManagedAppRegistrationCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ManagedAppRegistrationCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedAppRegistrationCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ManagedAppRegistrationCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ManagedAppRegistrationRequestBuilder byId(@Nonnull final String id) {
