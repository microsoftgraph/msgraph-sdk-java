...
public class CallRejectRequest extends BaseRequest<Void> {
     ...
     */
    public CallRejectRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallRejectParameterSet parameters) {
