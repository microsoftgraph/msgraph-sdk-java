...
/**
 * The interface for the Printer Share Collection Reference Request.
 */
public interface IPrinterShareCollectionReferenceRequest {
    ...
    IPrinterShareCollectionReferenceRequest select(final String value);

    IPrinterShareCollectionReferenceRequest top(final int value);
