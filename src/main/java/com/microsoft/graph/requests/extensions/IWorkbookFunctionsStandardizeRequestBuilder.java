 ...
 */
public interface IWorkbookFunctionsStandardizeRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsStandardizeRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
