...
public class EventCancelRequest extends BaseRequest<Void> {
     ...
     */
    public EventCancelRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public EventCancelRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EventCancelRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public EventCancelRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public EventCancelRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public EventCancelRequest expand(@Nonnull final String value) {
