...
public class DeviceManagementTroubleshootingEventRequestBuilder extends BaseRequestBuilder<DeviceManagementTroubleshootingEvent> {
     ...
     */
    public DeviceManagementTroubleshootingEventRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceManagementTroubleshootingEventRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceManagementTroubleshootingEventRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
