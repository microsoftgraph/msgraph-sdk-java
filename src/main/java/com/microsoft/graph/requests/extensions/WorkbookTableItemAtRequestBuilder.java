...
import com.microsoft.graph.models.extensions.WorkbookTableItemAtBody;
...
public class WorkbookTableItemAtRequestBuilder extends BaseFunctionRequestBuilder<WorkbookTable> {
     ...
     */
    public WorkbookTableItemAtRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookTableItemAtBody parameters) {
