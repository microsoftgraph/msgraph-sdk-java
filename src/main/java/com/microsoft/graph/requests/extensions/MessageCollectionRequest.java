 ...
 */
public class MessageCollectionRequest extends BaseCollectionRequest<Message, MessageCollectionResponse> {
    ...
    public BaseCollectionPage<Message> buildFromResponse(final MessageCollectionResponse response) {
