...
public class SchedulingGroupCollectionRequestBuilder extends BaseCollectionRequestBuilder<SchedulingGroup, SchedulingGroupRequestBuilder, SchedulingGroupCollectionResponse, SchedulingGroupCollectionPage, SchedulingGroupCollectionRequest> {
    ...
    public SchedulingGroupCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SchedulingGroupRequestBuilder.class, SchedulingGroupCollectionResponse.class, SchedulingGroupCollectionPage.class, SchedulingGroupCollectionRequest.class);
    }
