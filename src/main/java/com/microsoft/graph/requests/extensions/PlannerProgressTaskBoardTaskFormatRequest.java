...
public class PlannerProgressTaskBoardTaskFormatRequest extends BaseRequest implements IPlannerProgressTaskBoardTaskFormatRequest {
     ...
     */
    public void delete(final ICallback<PlannerProgressTaskBoardTaskFormat> callback) {
     ...
     * @return the updated request
     */
     public IPlannerProgressTaskBoardTaskFormatRequest filter(final String value) {
