 ...
 */
public class ConversationMemberCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ConversationMemberCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ConversationMemberCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ConversationMemberCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ConversationMemberRequestBuilder byId(@Nonnull final String id) {
