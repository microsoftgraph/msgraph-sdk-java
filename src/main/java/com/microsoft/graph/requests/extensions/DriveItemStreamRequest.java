 ...
 */
public class DriveItemStreamRequest extends BaseStreamRequest<DriveItem> implements IDriveItemStreamRequest {
     ...
     */
    public DriveItemStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
