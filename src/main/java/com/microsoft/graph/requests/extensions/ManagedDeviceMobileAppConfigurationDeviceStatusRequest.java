...
public class ManagedDeviceMobileAppConfigurationDeviceStatusRequest extends BaseRequest<ManagedDeviceMobileAppConfigurationDeviceStatus> {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationDeviceStatusRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationDeviceStatusRequest count() {
        addCountOption(true);
        return this;
    }
}
