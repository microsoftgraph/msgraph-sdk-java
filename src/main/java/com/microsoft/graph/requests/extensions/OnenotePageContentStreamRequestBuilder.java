 ...
 */
public class OnenotePageContentStreamRequestBuilder extends BaseRequestBuilder<InputStream> {
     ...
     */
    @Nonnull
    public OnenotePageContentStreamRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OnenotePageContentStreamRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
