 ...
 */
public class NotificationMessageTemplateCollectionRequest extends BaseCollectionRequest<NotificationMessageTemplateCollectionResponse, INotificationMessageTemplateCollectionPage> implements INotificationMessageTemplateCollectionRequest {
     ...
     */
    public NotificationMessageTemplateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public INotificationMessageTemplateCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public INotificationMessageTemplateCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public INotificationMessageTemplateCollectionRequest top(final int value) {
