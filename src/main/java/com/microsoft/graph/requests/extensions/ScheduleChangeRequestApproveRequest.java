...
public class ScheduleChangeRequestApproveRequest extends BaseRequest<Void> {
     ...
     */
    public ScheduleChangeRequestApproveRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ScheduleChangeRequestApproveBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ScheduleChangeRequestApproveBody body;
    /**
