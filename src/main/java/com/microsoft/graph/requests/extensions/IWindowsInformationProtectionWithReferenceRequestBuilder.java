...
/**
 * The interface for the Windows Information Protection With Reference Request Builder.
 */
public interface IWindowsInformationProtectionWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindowsInformationProtectionWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsInformationProtectionWithReferenceRequest instance
     */
    IWindowsInformationProtectionWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IWindowsInformationProtectionReferenceRequestBuilder reference();
