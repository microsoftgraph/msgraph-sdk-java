 ...
 */
public class WorkbookChartSeriesCollectionResponse implements ICollectionResponse<WorkbookChartSeries>, IJsonBackedObject {
    ...
    @Expose
    public java.util.List<WorkbookChartSeries> value;

    /**
     * The list of WorkbookChartSeries within this collection page
     */
    @Override
    public java.util.List<WorkbookChartSeries> values() {
        return value;
    }
