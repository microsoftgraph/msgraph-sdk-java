...
public interface IDriveItemDeltaCollectionRequestBuilder extends IRequestBuilder {
     ...
     */
    IDriveItemDeltaCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserRequest instance
     */
    IDriveItemDeltaCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
