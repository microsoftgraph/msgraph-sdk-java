...
public class GroupRenewRequestBuilder extends BaseActionRequestBuilder<Group> {
     ...
     */
    public GroupRenewRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
