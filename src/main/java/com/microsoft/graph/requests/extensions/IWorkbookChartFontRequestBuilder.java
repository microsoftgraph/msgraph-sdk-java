 ...
 */
public interface IWorkbookChartFontRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWorkbookChartFontRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
