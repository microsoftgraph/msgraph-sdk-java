...
public class ReportRootManagedDeviceEnrollmentTopFailuresRequest extends BaseRequest<Report> {
     ...
     */
    @Nonnull
    public ReportRootManagedDeviceEnrollmentTopFailuresRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootManagedDeviceEnrollmentTopFailuresRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootManagedDeviceEnrollmentTopFailuresRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
