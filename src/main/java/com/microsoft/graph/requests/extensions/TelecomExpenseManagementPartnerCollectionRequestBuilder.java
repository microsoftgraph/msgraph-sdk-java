...
public class TelecomExpenseManagementPartnerCollectionRequestBuilder extends BaseCollectionRequestBuilder<TelecomExpenseManagementPartner, TelecomExpenseManagementPartnerRequestBuilder, TelecomExpenseManagementPartnerCollectionResponse, TelecomExpenseManagementPartnerCollectionPage, TelecomExpenseManagementPartnerCollectionRequest> {
    ...
    public TelecomExpenseManagementPartnerCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, TelecomExpenseManagementPartnerRequestBuilder.class, TelecomExpenseManagementPartnerCollectionResponse.class, TelecomExpenseManagementPartnerCollectionPage.class, TelecomExpenseManagementPartnerCollectionRequest.class);
    }
