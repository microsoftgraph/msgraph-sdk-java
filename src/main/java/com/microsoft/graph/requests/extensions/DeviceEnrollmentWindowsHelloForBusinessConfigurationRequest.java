...
public class DeviceEnrollmentWindowsHelloForBusinessConfigurationRequest extends BaseRequest<DeviceEnrollmentWindowsHelloForBusinessConfiguration> {
     ...
     */
    @Nonnull
    public DeviceEnrollmentWindowsHelloForBusinessConfigurationRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentWindowsHelloForBusinessConfigurationRequest count() {
        addCountOption(true);
        return this;
    }
}
