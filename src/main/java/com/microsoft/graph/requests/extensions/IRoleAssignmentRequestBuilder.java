 ...
 */
public interface IRoleAssignmentRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IRoleAssignmentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
