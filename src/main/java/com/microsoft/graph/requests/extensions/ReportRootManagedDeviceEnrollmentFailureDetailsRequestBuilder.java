...
public class ReportRootManagedDeviceEnrollmentFailureDetailsRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootManagedDeviceEnrollmentFailureDetailsRequestBuilder {
    ...
    public ReportRootManagedDeviceEnrollmentFailureDetailsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Integer skip, final Integer top, final String filter, final String skipToken) {
        ...
        functionOptions.add(new FunctionOption("filter", filter));
        functionOptions.add(new FunctionOption("skipToken", skipToken));
    }
     ...
     * @return the IReportRootManagedDeviceEnrollmentFailureDetailsRequest instance
     */
    public IReportRootManagedDeviceEnrollmentFailureDetailsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
