 ...
 */
public class LicenseDetailsCollectionResponse implements ICollectionResponse<LicenseDetails>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<LicenseDetails> values() {
        return value;
    }
