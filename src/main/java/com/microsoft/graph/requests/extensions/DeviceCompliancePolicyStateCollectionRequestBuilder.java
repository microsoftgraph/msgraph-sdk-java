...
public class DeviceCompliancePolicyStateCollectionRequestBuilder extends BaseCollectionRequestBuilder<DeviceCompliancePolicyState, DeviceCompliancePolicyStateRequestBuilder, DeviceCompliancePolicyStateCollectionResponse, DeviceCompliancePolicyStateCollectionPage, DeviceCompliancePolicyStateCollectionRequest> {
    ...
    public DeviceCompliancePolicyStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceCompliancePolicyStateRequestBuilder.class, DeviceCompliancePolicyStateCollectionResponse.class, DeviceCompliancePolicyStateCollectionPage.class, DeviceCompliancePolicyStateCollectionRequest.class);
    }
