...
public class GroupValidatePropertiesRequest extends BaseRequest<Void> {
     ...
     */
    public GroupValidatePropertiesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final GroupValidatePropertiesBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected GroupValidatePropertiesBody body;
    /**
