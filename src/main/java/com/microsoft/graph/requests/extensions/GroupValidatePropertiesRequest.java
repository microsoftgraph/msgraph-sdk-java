...
public class GroupValidatePropertiesRequest extends BaseRequest<Void> {
    ...
    /**
     * The request for this GroupValidateProperties
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public GroupValidatePropertiesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GroupValidatePropertiesRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public GroupValidatePropertiesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public GroupValidatePropertiesRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public GroupValidatePropertiesRequest expand(@Nonnull final String value) {
