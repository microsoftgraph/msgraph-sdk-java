...
public class DeviceManagementTroubleshootingEventRequest extends BaseRequest implements IDeviceManagementTroubleshootingEventRequest {
     ...
     * @return the updated request
     */
     public IDeviceManagementTroubleshootingEventRequest filter(final String value) {
     ...
     * @return the updated request
     */
     public IDeviceManagementTroubleshootingEventRequest orderBy(final String value) {
