...
/**
 * The class for the Print Connector Collection Response.
 */
public class PrintConnectorCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintConnector within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintConnector> value;
