 ...
 */
public class AuthenticationMethodConfigurationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AuthenticationMethodConfiguration within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AuthenticationMethodConfiguration> value;
