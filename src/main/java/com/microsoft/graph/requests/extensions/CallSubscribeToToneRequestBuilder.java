...
public class CallSubscribeToToneRequestBuilder extends BaseActionRequestBuilder<SubscribeToToneOperation> {
    ...
    private CallSubscribeToToneBody body;
    /**
     ...
     */
    public CallSubscribeToToneRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallSubscribeToToneBody parameters) {
