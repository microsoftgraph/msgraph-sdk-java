...
/**
 * The interface for the Print Service Collection Page.
 */
public interface IPrintServiceCollectionPage extends IBaseCollectionPage<PrintService, IPrintServiceCollectionRequestBuilder> {
}
