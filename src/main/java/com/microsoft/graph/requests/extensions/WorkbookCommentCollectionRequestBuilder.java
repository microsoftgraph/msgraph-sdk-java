...
public class WorkbookCommentCollectionRequestBuilder extends BaseRequestBuilder implements IWorkbookCommentCollectionRequestBuilder {
     ...
     */
    public WorkbookCommentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IWorkbookCommentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
