...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsCleanRequest;
...
public class WorkbookFunctionsCleanRequest extends BaseWorkbookFunctionsCleanRequest implements IWorkbookFunctionsCleanRequest {
     ...
     */
    public WorkbookFunctionsCleanRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
