...
public class WorkbookChartSetPositionRequestBuilder extends BaseActionRequestBuilder<WorkbookChart> {
    ...
    private WorkbookChartSetPositionBody body;
    /**
     ...
     */
    public WorkbookChartSetPositionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartSetPositionBody parameters) {
