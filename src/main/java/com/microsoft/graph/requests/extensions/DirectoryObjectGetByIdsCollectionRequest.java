 ...
 */
public class DirectoryObjectGetByIdsCollectionRequest extends BaseCollectionRequest<DirectoryObject, DirectoryObjectGetByIdsCollectionResponse> {
    ...
    public DirectoryObjectGetByIdsCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DirectoryObject.class, DirectoryObjectGetByIdsCollectionResponse.class, (Class<BaseCollectionPage<DirectoryObject>>) (new BaseCollectionPage<DirectoryObject>(new java.util.ArrayList<DirectoryObject>(), null).getClass()));
        body = new DirectoryObjectGetByIdsBody();
    }


    public void post(final ICallback<? super BaseCollectionPage<DirectoryObject>> callback) {
    ...
    public BaseCollectionPage<DirectoryObject> post() throws ClientException {
        final DirectoryObjectGetByIdsCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public BaseCollectionPage<DirectoryObject> buildFromResponse(final DirectoryObjectGetByIdsCollectionResponse response) {
        ...
        final BaseCollectionPage<DirectoryObject> page = new BaseCollectionPage<DirectoryObject>(response, builder);
