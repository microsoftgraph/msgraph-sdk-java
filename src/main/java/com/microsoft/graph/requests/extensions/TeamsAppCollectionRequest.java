...
public class TeamsAppCollectionRequest extends BaseCollectionRequest<TeamsAppCollectionResponse, TeamsAppCollectionPage> {
    ...
    public void get(final ICallback<? super TeamsAppCollectionPage> callback) {
    ...
    public TeamsAppCollectionPage buildFromResponse(final TeamsAppCollectionResponse response) {
