 ...
 */
public class TeamsAppCollectionRequest extends BaseCollectionRequest<TeamsAppCollectionResponse, TeamsAppCollectionPage> {
     ...
     */
    public TeamsAppCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, TeamsAppCollectionResponse.class, TeamsAppCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super TeamsAppCollectionPage> callback) {
    ...
    @Nonnull
    public TeamsAppCollectionPage get() throws ClientException {
     ...
     */
    @Nonnull
    public TeamsAppCollectionRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public TeamsAppCollectionRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public TeamsAppCollectionRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public TeamsAppCollectionRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public TeamsAppCollectionRequest skipToken(@Nonnull final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (TeamsAppCollectionRequest)this;
    }
    @Nonnull
    public TeamsAppCollectionPage buildFromResponse(@Nonnull final TeamsAppCollectionResponse response) {
