...
public class IosCertificateProfileRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public IosCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IosCertificateProfileRequest instance
     */
    public IosCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
