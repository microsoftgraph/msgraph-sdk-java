...
public class UserWipeManagedAppRegistrationsByDeviceTagRequest extends BaseRequest<Void> {
     ...
     */
    public UserWipeManagedAppRegistrationsByDeviceTagRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserWipeManagedAppRegistrationsByDeviceTagBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected UserWipeManagedAppRegistrationsByDeviceTagBody body;
    /**
