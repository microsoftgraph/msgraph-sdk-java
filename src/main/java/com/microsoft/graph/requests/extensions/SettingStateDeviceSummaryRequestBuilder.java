...
public class SettingStateDeviceSummaryRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SettingStateDeviceSummaryRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the SettingStateDeviceSummaryRequest instance
     */
    public SettingStateDeviceSummaryRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
