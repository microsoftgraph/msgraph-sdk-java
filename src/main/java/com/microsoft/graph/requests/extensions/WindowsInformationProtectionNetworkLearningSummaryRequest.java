...
public class WindowsInformationProtectionNetworkLearningSummaryRequest extends BaseRequest<WindowsInformationProtectionNetworkLearningSummary> {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionNetworkLearningSummaryRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionNetworkLearningSummaryRequest count() {
        addCountOption(true);
        return this;
    }
}
