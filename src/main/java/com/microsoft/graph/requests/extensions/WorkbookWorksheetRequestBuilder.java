...
import com.microsoft.graph.models.extensions.WorkbookWorksheetUsedRangeBody;
import com.microsoft.graph.models.extensions.WorkbookWorksheetRangeBody;
...
public class WorkbookWorksheetRequestBuilder extends BaseRequestBuilder<WorkbookWorksheet> {
     ...
     */
    @Nonnull
    public WorkbookWorksheetCellRequestBuilder cell(@Nonnull final WorkbookWorksheetCellBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetUsedRangeRequestBuilder usedRange(@Nonnull final WorkbookWorksheetUsedRangeBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetRangeRequestBuilder range(@Nonnull final WorkbookWorksheetRangeBody parameters) {
