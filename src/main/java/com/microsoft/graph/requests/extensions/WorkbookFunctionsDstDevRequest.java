 ...
 */
public class WorkbookFunctionsDstDevRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsDstDevRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsDstDevRequest expand(final String value) {
