 ...
 */
public class ChatCollectionResponse implements ICollectionResponse<Chat>, IJsonBackedObject {

    /**
     * The list of Chat within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Chat> value;

    /**
     * The list of Chat within this collection page
     */
    @Override
    public java.util.List<Chat> values() {
        return value;
    }
