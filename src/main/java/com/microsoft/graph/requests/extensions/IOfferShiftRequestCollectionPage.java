...
/**
 * The interface for the Offer Shift Request Collection Page.
 */
public interface IOfferShiftRequestCollectionPage extends IBaseCollectionPage<OfferShiftRequest, IOfferShiftRequestCollectionRequestBuilder> {
}
