 ...
 */
public class PostCollectionRequest extends BaseEntityCollectionRequest<Post, PostCollectionResponse, PostCollectionPage> {
     ...
     */
    @Nonnull
    public PostCollectionRequest count(final boolean value) {
