 ...
 */
public interface IAndroidManagedAppRegistrationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidManagedAppRegistrationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
