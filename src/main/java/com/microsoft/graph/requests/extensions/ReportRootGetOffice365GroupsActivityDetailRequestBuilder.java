 ...
 */
public class ReportRootGetOffice365GroupsActivityDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     * @param date the date
     */
    public ReportRootGetOffice365GroupsActivityDetailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final com.microsoft.graph.core.DateOnly date) {
     ...
     */
    public ReportRootGetOffice365GroupsActivityDetailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final String period) {
        super(requestUrl, client, requestOptions);
