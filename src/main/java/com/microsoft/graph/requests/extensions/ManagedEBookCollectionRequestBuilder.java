...
public class ManagedEBookCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ManagedEBookCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ManagedEBookCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedEBookCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ManagedEBookCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ManagedEBookRequestBuilder byId(@Nonnull final String id) {
