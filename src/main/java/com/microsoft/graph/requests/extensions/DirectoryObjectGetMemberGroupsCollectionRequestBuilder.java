...
public class DirectoryObjectGetMemberGroupsCollectionRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    @Nonnull
    public DirectoryObjectGetMemberGroupsCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DirectoryObjectGetMemberGroupsCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
