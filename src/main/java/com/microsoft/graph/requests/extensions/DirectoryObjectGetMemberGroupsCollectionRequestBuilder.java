...
import com.microsoft.graph.requests.generated.BaseDirectoryObjectGetMemberGroupsCollectionRequestBuilder;
...
public class DirectoryObjectGetMemberGroupsCollectionRequestBuilder extends BaseDirectoryObjectGetMemberGroupsCollectionRequestBuilder implements IDirectoryObjectGetMemberGroupsCollectionRequestBuilder {
     ...
     */
    public DirectoryObjectGetMemberGroupsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Boolean securityEnabledOnly) {
