...
public class WorkbookRangeClearRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookRangeClearRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookRangeClearRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeClearRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeClearRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookRangeClearRequest expand(@Nonnull final String value) {
