...
public class WorkbookRangeClearRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookRangeClearRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookRangeClearParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookRangeClearParameterSet body;
    /**
     * Creates the WorkbookRangeClear
     *
