...
public class DomainDnsCnameRecordRequest extends BaseRequest<DomainDnsCnameRecord> {
     ...
     */
    public void get(@Nonnull final ICallback<? super DomainDnsCnameRecord> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super DomainDnsCnameRecord> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final DomainDnsCnameRecord sourceDomainDnsCnameRecord, @Nonnull final ICallback<? super DomainDnsCnameRecord> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final DomainDnsCnameRecord newDomainDnsCnameRecord, @Nonnull final ICallback<? super DomainDnsCnameRecord> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final DomainDnsCnameRecord newDomainDnsCnameRecord, @Nonnull final ICallback<? super DomainDnsCnameRecord> callback) {
     ...
     */
    @Nonnull
    public DomainDnsCnameRecordRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DomainDnsCnameRecordRequest count() {
        addCountOption(true);
        return this;
    }
}
