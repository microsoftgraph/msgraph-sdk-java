...
public interface IWorkbookCreateSessionRequest extends IHttpRequest {
     ...
     */
    IWorkbookCreateSessionRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IWorkbookCreateSessionRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookCreateSessionRequest expand(final String value);
