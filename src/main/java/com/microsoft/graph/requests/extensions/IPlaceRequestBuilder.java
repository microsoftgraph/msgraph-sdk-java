...
/**
 * The interface for the Place Request Builder.
 */
public interface IPlaceRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IPlaceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
