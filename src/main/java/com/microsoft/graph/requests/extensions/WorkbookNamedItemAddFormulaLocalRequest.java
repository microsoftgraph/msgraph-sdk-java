...
public class WorkbookNamedItemAddFormulaLocalRequest extends BaseRequest<WorkbookNamedItem> {
     ...
     */
    public WorkbookNamedItemAddFormulaLocalRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookNamedItemAddFormulaLocalBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookNamedItem.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookNamedItemAddFormulaLocalBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookNamedItemAddFormulaLocalRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookNamedItemAddFormulaLocalRequest count() {
        addCountOption(true);
        return this;
    }
