 ...
 */
public class UsedInsightCollectionRequest extends BaseCollectionRequest<UsedInsight, UsedInsightCollectionResponse> {
    ...
    public BaseCollectionPage<UsedInsight> get() throws ClientException {
    ...
    public BaseCollectionPage<UsedInsight> buildFromResponse(final UsedInsightCollectionResponse response) {
        ...
        final BaseCollectionPage<UsedInsight> page = new BaseCollectionPage<UsedInsight>(response, builder);
