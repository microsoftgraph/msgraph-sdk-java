 ...
 */
public class AlertCollectionResponse implements ICollectionResponse<Alert>, IJsonBackedObject {

    /**
     * The list of Alert within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Alert> value;

    /**
     * The list of Alert within this collection page
     */
    @Override
    public java.util.List<Alert> values() {
        return value;
    }
