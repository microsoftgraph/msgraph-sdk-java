...
/**
 * The interface for the Home Realm Discovery Policy Collection With References Request.
 */
public interface IHomeRealmDiscoveryPolicyCollectionWithReferencesRequest extends IHttpRequest {
    ...
    IHomeRealmDiscoveryPolicyCollectionWithReferencesRequest expand(final String value);
    
    IHomeRealmDiscoveryPolicyCollectionWithReferencesRequest select(final String value);

    IHomeRealmDiscoveryPolicyCollectionWithReferencesRequest top(final int value);
