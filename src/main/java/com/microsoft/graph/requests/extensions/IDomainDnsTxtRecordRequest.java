...
public interface IDomainDnsTxtRecordRequest extends IHttpRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final DomainDnsTxtRecord newDomainDnsTxtRecord, final ICallback<? super DomainDnsTxtRecord> callback);
     ...
     */
    IDomainDnsTxtRecordRequest select(final String value);
     ...
     * @return the updated request
     */
    IDomainDnsTxtRecordRequest expand(final String value);
