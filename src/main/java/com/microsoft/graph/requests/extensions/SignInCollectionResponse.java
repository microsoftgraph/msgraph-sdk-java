 ...
 */
public class SignInCollectionResponse implements ICollectionResponse<SignIn>, IJsonBackedObject {

    /**
     * The list of SignIn within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SignIn> value;

    /**
     * The list of SignIn within this collection page
     */
    @Override
    public java.util.List<SignIn> values() {
        return value;
    }
