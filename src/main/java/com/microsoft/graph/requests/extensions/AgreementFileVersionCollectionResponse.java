...
/**
 * The class for the Agreement File Version Collection Response.
 */
public class AgreementFileVersionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AgreementFileVersion within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AgreementFileVersion> value;
