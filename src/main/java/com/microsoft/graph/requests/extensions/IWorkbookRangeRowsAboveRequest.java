...
/**
 * The interface for the Workbook Range Rows Above Request.
 */
public interface IWorkbookRangeRowsAboveRequest extends IHttpRequest {
     ...
     */
    IWorkbookRangeRowsAboveRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookRangeRowsAboveRequest expand(final String value);
