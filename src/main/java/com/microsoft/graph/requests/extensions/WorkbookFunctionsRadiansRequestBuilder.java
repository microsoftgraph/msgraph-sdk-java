...
public class WorkbookFunctionsRadiansRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsRadiansBody body;
    /**
     ...
     */
    public WorkbookFunctionsRadiansRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsRadiansBody parameters) {
