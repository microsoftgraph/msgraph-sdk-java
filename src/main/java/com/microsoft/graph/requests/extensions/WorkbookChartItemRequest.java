...
public class WorkbookChartItemRequest extends BaseRequest<WorkbookChart> {
     ...
     */
    public WorkbookChartItemRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookChartItemRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookChartItemRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookChartItemRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
