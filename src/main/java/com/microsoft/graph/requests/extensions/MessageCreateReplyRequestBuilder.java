...
import com.microsoft.graph.requests.generated.BaseMessageCreateReplyRequestBuilder;
...
public class MessageCreateReplyRequestBuilder extends BaseMessageCreateReplyRequestBuilder implements IMessageCreateReplyRequestBuilder {
     ...
     */
    public MessageCreateReplyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
