...
/**
 * The interface for the Planner Plan Reference Request Builder.
 */
public interface IPlannerPlanReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPlannerPlanReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPlannerPlanReferenceRequest instance
     */
    IPlannerPlanReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
