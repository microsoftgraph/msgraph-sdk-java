 ...
 */
public class WorkbookFunctionsQuartile_IncRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsQuartile_IncRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsQuartile_IncRequest expand(final String value) {
