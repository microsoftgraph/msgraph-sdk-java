 ...
 */
public class WorkbookFunctionsImTanRequest extends BaseRequest implements IWorkbookFunctionsImTanRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsImTanRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsImTanRequest orderBy(final String value) {
