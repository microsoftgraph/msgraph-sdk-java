 ...
 */
public class WorkbookFunctionsMidRequest extends BaseRequest implements IWorkbookFunctionsMidRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsMidRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsMidRequest orderBy(final String value) {
