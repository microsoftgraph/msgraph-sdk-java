 ...
 */
public class WorkbookChartTitleFormatRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WorkbookChartTitleFormatRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookChartTitleFormatRequest instance
     */
    public WorkbookChartTitleFormatRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
