 ...
 */
public class ReportRootGetSkypeForBusinessActivityUserDetailRequest extends BaseRequest<Report> {
    /**
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootGetSkypeForBusinessActivityUserDetailRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
