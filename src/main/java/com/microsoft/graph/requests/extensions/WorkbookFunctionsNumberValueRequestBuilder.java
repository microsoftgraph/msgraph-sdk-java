...
public class WorkbookFunctionsNumberValueRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsNumberValueBody body;
    /**
     ...
     */
    public WorkbookFunctionsNumberValueRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsNumberValueBody parameters) {
