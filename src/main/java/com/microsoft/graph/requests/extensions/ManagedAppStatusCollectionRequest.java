...
public class ManagedAppStatusCollectionRequest extends BaseCollectionRequest<ManagedAppStatusCollectionResponse, ManagedAppStatusCollectionPage> {
    ...
    public void get(final ICallback<? super ManagedAppStatusCollectionPage> callback) {
    ...
    public ManagedAppStatusCollectionPage buildFromResponse(final ManagedAppStatusCollectionResponse response) {
