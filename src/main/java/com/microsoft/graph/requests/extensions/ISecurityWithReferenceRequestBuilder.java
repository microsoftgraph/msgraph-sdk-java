...
/**
 * The interface for the Security With Reference Request Builder.
 */
public interface ISecurityWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ISecurityWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ISecurityWithReferenceRequest instance
     */
    ISecurityWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    ISecurityReferenceRequestBuilder reference();
