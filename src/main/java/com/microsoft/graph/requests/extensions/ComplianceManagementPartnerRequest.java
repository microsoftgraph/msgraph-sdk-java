...
import com.microsoft.graph.requests.extensions.IComplianceManagementPartnerRequest;
import com.microsoft.graph.requests.extensions.ComplianceManagementPartnerRequest;
...
public class ComplianceManagementPartnerRequest extends BaseRequest implements IComplianceManagementPartnerRequest {
     ...
     */
    public ComplianceManagementPartnerRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<ComplianceManagementPartner> callback) {
     ...
     */
    public void delete(final ICallback<ComplianceManagementPartner> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final ComplianceManagementPartner sourceComplianceManagementPartner, final ICallback<ComplianceManagementPartner> callback) {
