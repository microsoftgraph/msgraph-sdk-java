...
public class DeviceConfigurationCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public DeviceConfigurationCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceConfigurationCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DeviceConfigurationCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public DeviceConfigurationRequestBuilder byId(@Nonnull final String id) {
