 ...
 */
public class ReportRootGetOffice365ServicesUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public ReportRootGetOffice365ServicesUserCountsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ReportRootGetOffice365ServicesUserCountsRequest instance
     */
    public ReportRootGetOffice365ServicesUserCountsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
