...
/**
 * The class for the Mobile Lob App With Reference Request.
 */
public class MobileLobAppWithReferenceRequest extends BaseRequest implements IMobileLobAppWithReferenceRequest {
     ...
     */
    public MobileLobAppWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, MobileLobApp.class);
    }

    public void post(final MobileLobApp newMobileLobApp, final IJsonBackedObject payload, final ICallback<? super MobileLobApp> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public MobileLobApp post(final MobileLobApp newMobileLobApp, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newMobileLobApp;
        }
        return null;
    }
     ...
     */
    public IMobileLobAppWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IMobileLobAppWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IMobileLobAppWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (MobileLobAppWithReferenceRequest)this;
    }
}
