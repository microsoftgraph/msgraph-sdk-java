 ...
 */
public interface IUserChangePasswordRequest extends IHttpRequest {
     ...
     */
    IUserChangePasswordRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IUserChangePasswordRequest top(final int value);
