...
public class WorkbookRangeCellRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    public WorkbookRangeCellRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookRangeCellRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeCellRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeCellRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
