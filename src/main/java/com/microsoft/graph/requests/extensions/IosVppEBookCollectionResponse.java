...
/**
 * The class for the Ios Vpp EBook Collection Response.
 */
public class IosVppEBookCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IosVppEBook within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IosVppEBook> value;
