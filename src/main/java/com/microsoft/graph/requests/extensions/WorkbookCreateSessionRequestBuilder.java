...
public class WorkbookCreateSessionRequestBuilder extends BaseWorkbookCreateSessionRequestBuilder implements IWorkbookCreateSessionRequestBuilder {
     ...
     */
    public WorkbookCreateSessionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final Boolean persistChanges) {
