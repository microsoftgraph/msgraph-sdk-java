 ...
 */
public class ManagedDeviceLocateDeviceRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public ManagedDeviceLocateDeviceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ManagedDeviceLocateDeviceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
