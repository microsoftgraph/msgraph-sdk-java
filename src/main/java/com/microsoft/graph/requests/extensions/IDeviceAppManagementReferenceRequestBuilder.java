...
/**
 * The interface for the Device App Management Reference Request Builder.
 */
public interface IDeviceAppManagementReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceAppManagementReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceAppManagementReferenceRequest instance
     */
    IDeviceAppManagementReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
