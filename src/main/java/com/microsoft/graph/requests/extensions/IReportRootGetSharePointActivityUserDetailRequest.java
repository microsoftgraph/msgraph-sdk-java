 ...
 */
public interface IReportRootGetSharePointActivityUserDetailRequest extends IHttpRequest {
     ...
     */
    IReportRootGetSharePointActivityUserDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSharePointActivityUserDetailRequest expand(final String value);
