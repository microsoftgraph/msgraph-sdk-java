...
public class WorkbookChartItemAtRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public WorkbookChartItemAtRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final Integer index) {
