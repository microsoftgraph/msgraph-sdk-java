...
public class WindowsInformationProtectionPolicyCollectionRequest extends BaseCollectionRequest<WindowsInformationProtectionPolicyCollectionResponse, WindowsInformationProtectionPolicyCollectionPage> {
    ...
    public void get(final ICallback<? super WindowsInformationProtectionPolicyCollectionPage> callback) {
    ...
    public WindowsInformationProtectionPolicyCollectionPage buildFromResponse(final WindowsInformationProtectionPolicyCollectionResponse response) {
