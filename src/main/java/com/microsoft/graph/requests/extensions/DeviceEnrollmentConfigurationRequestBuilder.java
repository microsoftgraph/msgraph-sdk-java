...
public class DeviceEnrollmentConfigurationRequestBuilder extends BaseRequestBuilder<DeviceEnrollmentConfiguration> {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationAssignRequestBuilder assign(@Nonnull final DeviceEnrollmentConfigurationAssignBody parameters) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationSetPriorityRequestBuilder setPriority(@Nonnull final DeviceEnrollmentConfigurationSetPriorityBody parameters) {
