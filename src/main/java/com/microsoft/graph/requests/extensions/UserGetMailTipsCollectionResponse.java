 ...
 */
public class UserGetMailTipsCollectionResponse implements ICollectionResponse<MailTips>, IJsonBackedObject {

    /**
     * The list of MailTips within this collection page
     */
     ...
     */
    @Override
    public java.util.List<MailTips> values() {
        return value;
    }
