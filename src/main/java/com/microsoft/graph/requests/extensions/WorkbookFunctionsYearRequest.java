 ...
 */
public class WorkbookFunctionsYearRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsYearRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsYearBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsYearBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsYearRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsYearRequest count() {
        addCountOption(true);
        return this;
    }
