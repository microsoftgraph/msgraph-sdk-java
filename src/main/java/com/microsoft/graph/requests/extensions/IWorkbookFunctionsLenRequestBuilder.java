...
public interface IWorkbookFunctionsLenRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsLenRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsLenRequest instance
     */
    IWorkbookFunctionsLenRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
