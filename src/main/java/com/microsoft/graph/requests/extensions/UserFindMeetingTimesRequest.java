...
public class UserFindMeetingTimesRequest extends BaseRequest<MeetingTimeSuggestionsResult> {
     ...
     */
    public UserFindMeetingTimesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserFindMeetingTimesBody parameters) {
        super(requestUrl, client, requestOptions, MeetingTimeSuggestionsResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected UserFindMeetingTimesBody body;
    /**
