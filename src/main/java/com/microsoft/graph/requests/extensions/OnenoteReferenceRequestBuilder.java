...
/**
 * The class for the Onenote Reference Request Builder.
 */
public class OnenoteReferenceRequestBuilder extends BaseRequestBuilder implements IOnenoteReferenceRequestBuilder {
     ...
     */
    public OnenoteReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IOnenoteReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IOnenoteReferenceRequest instance
     */
    public IOnenoteReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new OnenoteReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
