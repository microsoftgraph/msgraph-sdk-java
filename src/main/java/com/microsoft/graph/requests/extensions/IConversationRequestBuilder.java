 ...
 */
public interface IConversationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IConversationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IConversationRequest instance
     */
    IConversationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
