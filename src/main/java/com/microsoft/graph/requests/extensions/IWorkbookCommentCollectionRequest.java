...
/**
 * The interface for the Workbook Comment Collection Request.
 */
public interface IWorkbookCommentCollectionRequest extends IHttpRequest {
     ...
     */
    IWorkbookCommentCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IWorkbookCommentCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookCommentCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IWorkbookCommentCollectionRequest skip(final int value);
