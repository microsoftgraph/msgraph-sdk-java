...
public class OpenShiftChangeRequestRequest extends BaseRequest implements IOpenShiftChangeRequestRequest {
     ...
     */
    public OpenShiftChangeRequestRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
     public IOpenShiftChangeRequestRequest orderBy(final String value) {
