...
public class ComplianceManagementPartnerCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ComplianceManagementPartnerCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ComplianceManagementPartnerCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ComplianceManagementPartnerCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ComplianceManagementPartnerRequestBuilder byId(@Nonnull final String id) {
