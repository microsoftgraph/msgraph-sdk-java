 ...
 */
public interface IWorkbookTableHeaderRowRangeRequest extends IHttpRequest {
     ...
     */
    IWorkbookTableHeaderRowRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookTableHeaderRowRangeRequest expand(final String value);
