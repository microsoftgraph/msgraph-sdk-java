...
public class SearchEntityQueryCollectionRequest extends BaseCollectionRequest<SearchEntityQueryCollectionResponse, ISearchEntityQueryCollectionPage> implements ISearchEntityQueryCollectionRequest {
     ...
     */
    public SearchEntityQueryCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ISearchEntityQueryCollectionPage buildFromResponse(final SearchEntityQueryCollectionResponse response) {
        final ISearchEntityQueryCollectionRequestBuilder builder;
        if (response.nextLink != null) {
            builder = new SearchEntityQueryCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null, (java.util.List<SearchRequest>) null);
        } else {
            builder = null;
        }
        final ISearchEntityQueryCollectionPage page = new SearchEntityQueryCollectionPage(response, builder);
     ...
     */
    public ISearchEntityQueryCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ISearchEntityQueryCollectionRequest top(final int value) {
     ...
     * @return the updated request
     */
    public ISearchEntityQueryCollectionRequest expand(final String value) {
