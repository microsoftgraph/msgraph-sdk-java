...
public class MessageCreateReplyAllRequestBuilder extends BaseActionRequestBuilder<Message> {
     ...
     */
    public MessageCreateReplyAllRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final Message message, @Nullable final String comment) {
