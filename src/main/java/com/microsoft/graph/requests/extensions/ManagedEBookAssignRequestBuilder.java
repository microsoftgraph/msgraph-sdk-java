...
import com.microsoft.graph.requests.generated.BaseManagedEBookAssignRequestBuilder;
 ...
 */
public class ManagedEBookAssignRequestBuilder extends BaseManagedEBookAssignRequestBuilder implements IManagedEBookAssignRequestBuilder {
    ...
    public ManagedEBookAssignRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<ManagedEBookAssignment> managedEBookAssignments) {
        super(requestUrl, client, requestOptions, managedEBookAssignments);
    }
}
