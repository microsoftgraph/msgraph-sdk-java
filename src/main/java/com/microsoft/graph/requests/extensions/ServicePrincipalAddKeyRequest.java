...
public class ServicePrincipalAddKeyRequest extends BaseRequest<KeyCredential> {
     ...
     */
    public ServicePrincipalAddKeyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ServicePrincipalAddKeyBody parameters) {
        super(requestUrl, client, requestOptions, KeyCredential.class);
        body = parameters;
    }

	/** The body for the method */
    protected ServicePrincipalAddKeyBody body;
    /**
     ...
     */
    @Nonnull
    public ServicePrincipalAddKeyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ServicePrincipalAddKeyRequest count() {
        addCountOption(true);
        return this;
    }
