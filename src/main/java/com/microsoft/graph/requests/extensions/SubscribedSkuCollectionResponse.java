...
/**
 * The class for the Subscribed Sku Collection Response.
 */
public class SubscribedSkuCollectionResponse implements ICollectionResponse<SubscribedSku>, IJsonBackedObject {

    /**
     * The list of SubscribedSku within this collection page
     */
     ...
     */
    @Override
    public java.util.List<SubscribedSku> values() {
        return value;
    }
