...
public class UserActivityCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public UserActivityCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UserActivityCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new UserActivityCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public UserActivityRequestBuilder byId(@Nonnull final String id) {
