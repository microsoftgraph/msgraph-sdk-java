 ...
 */
public class ConversationCollectionRequest extends BaseCollectionRequest<ConversationCollectionResponse, ConversationCollectionPage> {
    ...
    public ConversationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ConversationCollectionResponse.class, ConversationCollectionPage.class);
    }

    public void get(final ICallback<? super ConversationCollectionPage> callback) {
    ...
    public ConversationCollectionPage get() throws ClientException {
    ...
    public ConversationCollectionPage buildFromResponse(final ConversationCollectionResponse response) {
