...
public class TeamRequestBuilder extends BaseRequestBuilder<Team> {
     ...
     */
    @Nonnull
    public TeamArchiveRequestBuilder archive(@Nonnull final TeamArchiveBody parameters) {
     ...
     */
    @Nonnull
    public TeamCloneRequestBuilder clone(@Nonnull final TeamCloneBody parameters) {
