...
public class WorkbookChartFillSetSolidColorRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookChartFillSetSolidColorRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final String color) {
