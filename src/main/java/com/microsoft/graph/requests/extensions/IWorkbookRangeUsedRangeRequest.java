 ...
 */
public interface IWorkbookRangeUsedRangeRequest extends IHttpRequest {
     ...
     */
    IWorkbookRangeUsedRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookRangeUsedRangeRequest expand(final String value);
