...
public class DriveItemCreateUploadSessionRequestBuilder extends BaseActionRequestBuilder<UploadSession> {
     ...
     */
    public DriveItemCreateUploadSessionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the DriveItemCreateUploadSessionRequest instance
     */
    public DriveItemCreateUploadSessionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
