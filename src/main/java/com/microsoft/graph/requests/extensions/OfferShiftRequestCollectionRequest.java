 ...
 */
public class OfferShiftRequestCollectionRequest extends BaseCollectionRequest<OfferShiftRequestCollectionResponse, OfferShiftRequestCollectionPage> {
    ...
    public OfferShiftRequestCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OfferShiftRequestCollectionResponse.class, OfferShiftRequestCollectionPage.class);
    }

    public void get(final ICallback<? super OfferShiftRequestCollectionPage> callback) {
    ...
    public OfferShiftRequestCollectionPage get() throws ClientException {
    ...
    public OfferShiftRequestCollectionPage buildFromResponse(final OfferShiftRequestCollectionResponse response) {
