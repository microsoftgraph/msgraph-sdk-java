...
public class WorkbookFunctionsStDev_SRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsStDev_SBody body;
    /**
     ...
     */
    public WorkbookFunctionsStDev_SRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsStDev_SBody parameters) {
