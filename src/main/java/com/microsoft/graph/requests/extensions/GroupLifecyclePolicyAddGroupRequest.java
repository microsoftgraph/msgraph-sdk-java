...
public class GroupLifecyclePolicyAddGroupRequest extends BaseRequest<Boolean> {
     ...
     */
    public GroupLifecyclePolicyAddGroupRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final GroupLifecyclePolicyAddGroupBody parameters) {
        super(requestUrl, client, requestOptions, Boolean.class);
        body = parameters;
    }

	/** The body for the method */
    protected GroupLifecyclePolicyAddGroupBody body;
    /**
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyAddGroupRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyAddGroupRequest count() {
        addCountOption(true);
        return this;
    }
