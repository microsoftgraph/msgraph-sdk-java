 ...
 */
public class TeamsTabCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public TeamsTabCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TeamsTabCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new TeamsTabCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public TeamsTabRequestBuilder byId(@Nonnull final String id) {
