 ...
 */
public class ThumbnailStreamRequest extends BaseStreamRequest<Thumbnail> implements IThumbnailStreamRequest {
     ...
     */
    public ThumbnailStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
