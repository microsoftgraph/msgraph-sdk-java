...
import com.microsoft.graph.requests.generated.BaseWindowsInformationProtectionRequest;
 ...
 */
public class WindowsInformationProtectionRequest extends BaseWindowsInformationProtectionRequest implements IWindowsInformationProtectionRequest {
     ...
     * @param requestOptions the options for this request
     */
    public WindowsInformationProtectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
