...
public class SignInCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public SignInCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public SignInCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new SignInCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public SignInRequestBuilder byId(@Nonnull final String id) {
