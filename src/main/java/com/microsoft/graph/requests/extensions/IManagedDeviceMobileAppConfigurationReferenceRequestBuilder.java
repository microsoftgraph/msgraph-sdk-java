...
/**
 * The interface for the Managed Device Mobile App Configuration Reference Request Builder.
 */
public interface IManagedDeviceMobileAppConfigurationReferenceRequestBuilder extends IRequestBuilder {

    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IManagedDeviceMobileAppConfigurationReferenceRequest instance
     */
    IManagedDeviceMobileAppConfigurationReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IManagedDeviceMobileAppConfigurationReferenceRequest instance
     */
    IManagedDeviceMobileAppConfigurationReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
