 ...
 */
public class ReportRootGetSharePointActivityUserCountsRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetSharePointActivityUserCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetSharePointActivityUserCounts
    ...
    /**
     * Puts the ReportRootGetSharePointActivityUserCounts
     *
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserCountsRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserCountsRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserCountsRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserCountsRequest count() {
        addCountOption(true);
        return this;
    }
}
