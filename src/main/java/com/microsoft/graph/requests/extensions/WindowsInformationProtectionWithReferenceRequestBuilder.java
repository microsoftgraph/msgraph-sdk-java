...
/**
 * The class for the Windows Information Protection With Reference Request Builder.
 */
public class WindowsInformationProtectionWithReferenceRequestBuilder extends BaseRequestBuilder implements IWindowsInformationProtectionWithReferenceRequestBuilder {
     ...
     */
    public WindowsInformationProtectionWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IWindowsInformationProtectionWithReferenceRequest instance
     */
    public IWindowsInformationProtectionWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsInformationProtectionWithReferenceRequest instance
     */
    public IWindowsInformationProtectionWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WindowsInformationProtectionWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IWindowsInformationProtectionReferenceRequestBuilder reference(){
        return new WindowsInformationProtectionReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
