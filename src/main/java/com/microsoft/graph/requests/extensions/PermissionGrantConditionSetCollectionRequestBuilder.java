...
public class PermissionGrantConditionSetCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public PermissionGrantConditionSetCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PermissionGrantConditionSetCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PermissionGrantConditionSetCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public PermissionGrantConditionSetRequestBuilder byId(@Nonnull final String id) {
