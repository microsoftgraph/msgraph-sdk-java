 ...
 */
public class Win32LobAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Win32LobApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Win32LobApp> value;
