 ...
 */
public class CalendarGroupCollectionResponse implements ICollectionResponse<CalendarGroup>, IJsonBackedObject {

    /**
     * The list of CalendarGroup within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CalendarGroup> value;

    /**
     * The list of CalendarGroup within this collection page
     */
    @Override
    public java.util.List<CalendarGroup> values() {
        return value;
    }
