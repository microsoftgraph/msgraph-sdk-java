...
public class TokenLifetimePolicyCollectionReferenceRequestBuilder extends BaseCollectionReferenceRequestBuilder<TokenLifetimePolicy, TokenLifetimePolicyReferenceRequestBuilder, TokenLifetimePolicyCollectionResponse, TokenLifetimePolicyCollectionWithReferencesPage, TokenLifetimePolicyCollectionReferenceRequest> {
    ...
    public TokenLifetimePolicyCollectionReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, TokenLifetimePolicyReferenceRequestBuilder.class, TokenLifetimePolicyCollectionReferenceRequest.class);
    }
}
