...
/**
 * The interface for the Print Usage By Printer Collection Page.
 */
public interface IPrintUsageByPrinterCollectionPage extends IBaseCollectionPage<PrintUsageByPrinter, IPrintUsageByPrinterCollectionRequestBuilder> {
}
