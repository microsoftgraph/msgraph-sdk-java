...
public class ComplianceManagementPartnerRequestBuilder extends BaseRequestBuilder<ComplianceManagementPartner> {
     ...
     */
    public ComplianceManagementPartnerRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ComplianceManagementPartnerRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ComplianceManagementPartnerRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
