...
public class ManagedDeviceOverviewWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ManagedDeviceOverviewWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedDeviceOverviewWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
