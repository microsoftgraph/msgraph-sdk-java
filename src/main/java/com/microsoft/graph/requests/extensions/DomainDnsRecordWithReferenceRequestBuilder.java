...
/**
 * The class for the Domain Dns Record With Reference Request Builder.
 */
public class DomainDnsRecordWithReferenceRequestBuilder extends BaseRequestBuilder implements IDomainDnsRecordWithReferenceRequestBuilder {
     ...
     */
    public DomainDnsRecordWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IDomainDnsRecordWithReferenceRequest instance
     */
    public IDomainDnsRecordWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IDomainDnsRecordWithReferenceRequest instance
     */
    public IDomainDnsRecordWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DomainDnsRecordWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IDomainDnsRecordReferenceRequestBuilder reference(){
        return new DomainDnsRecordReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
