...
public class DriveItemValidatePermissionRequest extends BaseRequest<Void> {
     ...
     */
    public DriveItemValidatePermissionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DriveItemValidatePermissionParameterSet parameters) {
