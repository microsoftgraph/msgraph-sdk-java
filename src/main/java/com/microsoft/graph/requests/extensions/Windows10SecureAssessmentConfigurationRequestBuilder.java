...
public class Windows10SecureAssessmentConfigurationRequestBuilder extends BaseRequestBuilder<Windows10SecureAssessmentConfiguration> {
     ...
     */
    public Windows10SecureAssessmentConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the Windows10SecureAssessmentConfigurationRequest instance
     */
    public Windows10SecureAssessmentConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
