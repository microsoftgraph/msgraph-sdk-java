 ...
 */
public class ReportRootGetMailboxUsageMailboxCountsRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetMailboxUsageMailboxCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageMailboxCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageMailboxCountsRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageMailboxCountsRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageMailboxCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageMailboxCountsRequest count() {
        addCountOption(true);
        return this;
    }
}
