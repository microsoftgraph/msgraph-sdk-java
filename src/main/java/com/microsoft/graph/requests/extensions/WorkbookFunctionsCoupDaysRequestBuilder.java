...
public class WorkbookFunctionsCoupDaysRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsCoupDaysBody body;
    /**
     ...
     */
    public WorkbookFunctionsCoupDaysRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsCoupDaysBody parameters) {
