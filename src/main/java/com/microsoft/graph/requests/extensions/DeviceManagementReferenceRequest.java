...
/**
 * The class for the Device Management Reference Request.
 */
public class DeviceManagementReferenceRequest extends BaseRequest implements IDeviceManagementReferenceRequest {
     ...
     */
    public DeviceManagementReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IDeviceManagementReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (DeviceManagementReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IDeviceManagementReferenceRequest expand(final String value) {
     ...
     *
     * @param srcDeviceManagement the DeviceManagement reference to PUT
     * @param callback the callback to be called after success or failure
     */
    public void put(DeviceManagement srcDeviceManagement, final ICallback<? super DeviceManagement> callback) {
        send(HttpMethod.PUT, callback, srcDeviceManagement);
    }
     ...
     */
    public DeviceManagement put(DeviceManagement srcDeviceManagement) throws ClientException {
        return send(HttpMethod.PUT, srcDeviceManagement);
    }
}
