...
public class ManagedDeviceUpdateWindowsDeviceAccountRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public ManagedDeviceUpdateWindowsDeviceAccountRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ManagedDeviceUpdateWindowsDeviceAccountRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedDeviceUpdateWindowsDeviceAccountRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public ManagedDeviceUpdateWindowsDeviceAccountRequest expand(@Nonnull final String value) {
