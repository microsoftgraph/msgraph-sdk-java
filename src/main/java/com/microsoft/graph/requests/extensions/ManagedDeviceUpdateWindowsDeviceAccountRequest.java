...
public class ManagedDeviceUpdateWindowsDeviceAccountRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceUpdateWindowsDeviceAccountRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceUpdateWindowsDeviceAccountBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ManagedDeviceUpdateWindowsDeviceAccountBody body;
    /**
