...
public class CallRecordResponseRequest extends BaseRequest<RecordOperation> {
     ...
     */
    public CallRecordResponseRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallRecordResponseBody parameters) {
        super(requestUrl, client, requestOptions, RecordOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected CallRecordResponseBody body;
    /**
     ...
     */
    @Nonnull
    public CallRecordResponseRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public CallRecordResponseRequest count() {
        addCountOption(true);
        return this;
    }
