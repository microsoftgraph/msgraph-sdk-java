...
public class MessageReplyAllRequestBuilder extends BaseActionRequestBuilder<Message> {
    ...
    private MessageReplyAllBody body;
    /**
     ...
     */
    public MessageReplyAllRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MessageReplyAllBody parameters) {
     ...
     */
    @Nonnull
    public MessageReplyAllRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MessageReplyAllRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
