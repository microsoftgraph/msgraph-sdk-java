...
public class MessageReplyAllRequestBuilder extends BaseActionRequestBuilder<Message> {
     ...
     */
    public MessageReplyAllRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final Message message, @Nullable final String comment) {
