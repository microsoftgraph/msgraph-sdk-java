...
public class WorkbookFunctionsPriceMatRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsPriceMatBody body;
    /**
     ...
     */
    public WorkbookFunctionsPriceMatRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsPriceMatBody parameters) {
