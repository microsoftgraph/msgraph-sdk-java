...
public class FileAttachmentStreamRequestBuilder extends BaseRequestBuilder implements IFileAttachmentStreamRequestBuilder {
     ...
     */
    public FileAttachmentStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IFileAttachmentStreamRequest instance
     */
    public IFileAttachmentStreamRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
