 ...
 */
public class WorkbookFunctionsFvscheduleRequest extends BaseRequest implements IWorkbookFunctionsFvscheduleRequest {
     ...
     */
    public IWorkbookFunctionsFvscheduleRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsFvscheduleRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsFvscheduleRequest expand(final String value) {
