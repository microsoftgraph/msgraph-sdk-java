...
public class WorkbookFunctionsFvscheduleRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsFvscheduleRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsFvscheduleBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsFvscheduleBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsFvscheduleRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsFvscheduleRequest count() {
        addCountOption(true);
        return this;
    }
