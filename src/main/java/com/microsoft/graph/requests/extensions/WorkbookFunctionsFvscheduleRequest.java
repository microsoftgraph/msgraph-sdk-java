...
public class WorkbookFunctionsFvscheduleRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsFvscheduleRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsFvscheduleParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsFvscheduleParameterSet body;
    /**
