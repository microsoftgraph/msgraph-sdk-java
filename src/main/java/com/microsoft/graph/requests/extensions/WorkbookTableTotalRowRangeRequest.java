...
import com.microsoft.graph.requests.generated.BaseWorkbookTableTotalRowRangeRequest;
...
public class WorkbookTableTotalRowRangeRequest extends BaseWorkbookTableTotalRowRangeRequest implements IWorkbookTableTotalRowRangeRequest {
     ...
     */
    public WorkbookTableTotalRowRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
