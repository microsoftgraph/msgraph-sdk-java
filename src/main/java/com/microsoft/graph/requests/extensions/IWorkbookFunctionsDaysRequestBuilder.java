 ...
 */
public interface IWorkbookFunctionsDaysRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsDaysRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
