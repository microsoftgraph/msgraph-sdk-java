 ...
 */
public class ManagedDeviceMobileAppConfigurationCollectionResponse implements ICollectionResponse<ManagedDeviceMobileAppConfiguration>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<ManagedDeviceMobileAppConfiguration> values() {
        return value;
    }
