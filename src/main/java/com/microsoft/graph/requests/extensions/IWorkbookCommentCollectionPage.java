...
/**
 * The interface for the Workbook Comment Collection Page.
 */
public interface IWorkbookCommentCollectionPage extends IBaseCollectionPage<WorkbookComment, IWorkbookCommentCollectionRequestBuilder> {
}
