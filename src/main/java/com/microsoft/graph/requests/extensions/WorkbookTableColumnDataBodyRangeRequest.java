 ...
 */
public class WorkbookTableColumnDataBodyRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookTableColumnDataBodyRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnDataBodyRangeRequest count() {
        addCountOption(true);
        return this;
    }
}
