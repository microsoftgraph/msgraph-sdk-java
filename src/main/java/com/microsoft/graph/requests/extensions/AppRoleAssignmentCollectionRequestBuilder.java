...
public class AppRoleAssignmentCollectionRequestBuilder extends BaseRequestBuilder implements IAppRoleAssignmentCollectionRequestBuilder {
     ...
     */
    public AppRoleAssignmentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAppRoleAssignmentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
