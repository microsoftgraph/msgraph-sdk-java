...
/**
 * The interface for the Workbook Chart Point Reference Request.
 */
public interface IWorkbookChartPointReferenceRequest extends IHttpRequest {

    void delete(final ICallback<? super WorkbookChartPoint> callback);

    WorkbookChartPoint delete() throws ClientException;
     ...
     */
    IWorkbookChartPointReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookChartPointReferenceRequest expand(final String value);
