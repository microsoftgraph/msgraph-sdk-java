...
import com.microsoft.graph.requests.generated.BaseCalendarGroupCollectionRequest;
...
public class CalendarGroupCollectionRequest extends BaseCalendarGroupCollectionRequest implements ICalendarGroupCollectionRequest {
     ...
     */
    public CalendarGroupCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
