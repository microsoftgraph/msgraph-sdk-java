...
public class CallCancelMediaProcessingRequest extends BaseRequest<CancelMediaProcessingOperation> {
     ...
     */
    public CallCancelMediaProcessingRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallCancelMediaProcessingBody parameters) {
        super(requestUrl, client, requestOptions, CancelMediaProcessingOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected CallCancelMediaProcessingBody body;
    /**
     ...
     */
    @Nonnull
    public CallCancelMediaProcessingRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public CallCancelMediaProcessingRequest count() {
        addCountOption(true);
        return this;
    }
