 ...
 */
public interface IWorkbookRangeLastRowRequest extends IHttpRequest {
     ...
     */
    IWorkbookRangeLastRowRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookRangeLastRowRequest expand(final String value);
