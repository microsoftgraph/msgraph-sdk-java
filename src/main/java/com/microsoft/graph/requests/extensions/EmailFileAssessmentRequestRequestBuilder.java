...
public class EmailFileAssessmentRequestRequestBuilder extends BaseRequestBuilder implements IEmailFileAssessmentRequestRequestBuilder {
     ...
     */
    public EmailFileAssessmentRequestRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IEmailFileAssessmentRequestRequest buildRequest() {
