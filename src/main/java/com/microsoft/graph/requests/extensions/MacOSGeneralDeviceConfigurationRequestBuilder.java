 ...
 */
public class MacOSGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public MacOSGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the MacOSGeneralDeviceConfigurationRequest instance
     */
    public MacOSGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
