...
/**
 * The interface for the Risky User History Item Request Builder.
 */
public interface IRiskyUserHistoryItemRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IRiskyUserHistoryItemRequest instance
     */
    IRiskyUserHistoryItemRequest buildRequest();
