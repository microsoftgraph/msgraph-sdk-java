...
public class EventTentativelyAcceptRequest extends BaseRequest<Void> {
     ...
     */
    public EventTentativelyAcceptRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final EventTentativelyAcceptBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected EventTentativelyAcceptBody body;
    /**
