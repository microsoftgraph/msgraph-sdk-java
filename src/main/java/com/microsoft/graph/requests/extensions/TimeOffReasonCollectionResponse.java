 ...
 */
public class TimeOffReasonCollectionResponse implements ICollectionResponse<TimeOffReason>, IJsonBackedObject {

    /**
     * The list of TimeOffReason within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TimeOffReason> value;

    /**
     * The list of TimeOffReason within this collection page
     */
    @Override
    public java.util.List<TimeOffReason> values() {
        return value;
    }
