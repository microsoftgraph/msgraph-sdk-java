...
/**
 * The class for the Room List With Reference Request.
 */
public class RoomListWithReferenceRequest extends BaseRequest implements IRoomListWithReferenceRequest {
     ...
     */
    public RoomListWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, RoomList.class);
    }

    public void post(final RoomList newRoomList, final IJsonBackedObject payload, final ICallback<? super RoomList> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public RoomList post(final RoomList newRoomList, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IRoomListWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IRoomListWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IRoomListWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (RoomListWithReferenceRequest)this;
    }
}
