...
public interface IWorkbookFunctionsXirrRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsXirrRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsXirrRequest instance
     */
    IWorkbookFunctionsXirrRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
