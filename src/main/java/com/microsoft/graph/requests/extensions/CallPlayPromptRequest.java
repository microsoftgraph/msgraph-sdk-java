...
public class CallPlayPromptRequest extends BaseRequest<PlayPromptOperation> {
     ...
     */
    public CallPlayPromptRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallPlayPromptBody parameters) {
        super(requestUrl, client, requestOptions, PlayPromptOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected CallPlayPromptBody body;
    /**
     ...
     */
    @Nonnull
    public CallPlayPromptRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public CallPlayPromptRequest count() {
        addCountOption(true);
        return this;
    }
