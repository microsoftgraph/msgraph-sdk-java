 ...
 */
public interface IReportRootGetSharePointSiteUsageStorageRequest extends IHttpRequest {
     ...
     */
    IReportRootGetSharePointSiteUsageStorageRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSharePointSiteUsageStorageRequest expand(final String value);
