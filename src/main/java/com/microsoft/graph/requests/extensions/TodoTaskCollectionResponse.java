 ...
 */
public class TodoTaskCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TodoTask within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TodoTask> value;
