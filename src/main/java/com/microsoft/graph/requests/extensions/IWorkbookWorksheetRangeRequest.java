 ...
 */
public interface IWorkbookWorksheetRangeRequest extends IHttpRequest {
     ...
     */
    IWorkbookWorksheetRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookWorksheetRangeRequest expand(final String value);
