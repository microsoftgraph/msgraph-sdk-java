...
/**
 * The interface for the Workbook Worksheet With Reference Request Builder.
 */
public interface IWorkbookWorksheetWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookWorksheetWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookWorksheetWithReferenceRequest instance
     */
    IWorkbookWorksheetWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IWorkbookWorksheetReferenceRequestBuilder reference();
