...
/**
 * The interface for the Channel With Reference Request Builder.
 */
public interface IChannelWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IChannelWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IChannelWithReferenceRequest instance
     */
    IChannelWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IChannelReferenceRequestBuilder reference();
