 ...
 */
public class OutlookCategoryCollectionResponse implements ICollectionResponse<OutlookCategory>, IJsonBackedObject {

    /**
     * The list of OutlookCategory within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OutlookCategory> value;

    /**
     * The list of OutlookCategory within this collection page
     */
    @Override
    public java.util.List<OutlookCategory> values() {
        return value;
    }
