...
public class WorkbookWorksheetAddRequest extends BaseRequest<WorkbookWorksheet> {
     ...
     */
    public WorkbookWorksheetAddRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookWorksheetAddBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookWorksheet.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookWorksheetAddBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookWorksheetAddRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetAddRequest count() {
        addCountOption(true);
        return this;
    }
