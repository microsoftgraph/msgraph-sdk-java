...
import com.microsoft.graph.models.extensions.WorkbookWorksheetAddParameterSet;
...
public class WorkbookWorksheetAddRequest extends BaseRequest<WorkbookWorksheet> {
     ...
     */
    public WorkbookWorksheetAddRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookWorksheetAddParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookWorksheetAddParameterSet body;
    /**
     * Invokes the method and returns a future with the result
     * @return a future with the result
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookWorksheet> futurePost() {
