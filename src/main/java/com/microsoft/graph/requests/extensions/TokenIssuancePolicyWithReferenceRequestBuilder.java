...
public class TokenIssuancePolicyWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public TokenIssuancePolicyWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TokenIssuancePolicyWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
