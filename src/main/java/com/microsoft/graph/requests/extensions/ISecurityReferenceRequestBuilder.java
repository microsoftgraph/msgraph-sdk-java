...
/**
 * The interface for the Security Reference Request Builder.
 */
public interface ISecurityReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ISecurityReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ISecurityReferenceRequest instance
     */
    ISecurityReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
