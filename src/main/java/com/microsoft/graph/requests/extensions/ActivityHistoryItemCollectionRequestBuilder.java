...
public class ActivityHistoryItemCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ActivityHistoryItemCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ActivityHistoryItemCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ActivityHistoryItemCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ActivityHistoryItemRequestBuilder byId(@Nonnull final String id) {
