...
public class ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest extends BaseRequest<Report> {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
