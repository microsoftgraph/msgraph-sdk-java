...
public class EventAcceptRequestBuilder extends BaseActionRequestBuilder implements IEventAcceptRequestBuilder {
     ...
     */
    public EventAcceptRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Boolean sendResponse, final String comment) {
