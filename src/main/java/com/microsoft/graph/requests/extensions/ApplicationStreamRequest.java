...
/**
 * The class for the Application Stream Request.
 */
public class ApplicationStreamRequest extends BaseStreamRequest<Application> implements IApplicationStreamRequest {

    /**
     * The request for the ApplicationStream
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public ApplicationStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
