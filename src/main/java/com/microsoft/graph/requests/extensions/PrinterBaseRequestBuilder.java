...
public class PrinterBaseRequestBuilder extends BaseRequestBuilder implements IPrinterBaseRequestBuilder {
     ...
     */
    public PrinterBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IPrinterBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPrinterBaseRequest instance
     */
    public IPrinterBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.PrinterBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
