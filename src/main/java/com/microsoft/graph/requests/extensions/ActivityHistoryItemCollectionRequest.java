...
public class ActivityHistoryItemCollectionRequest extends BaseCollectionRequest<ActivityHistoryItemCollectionResponse, IActivityHistoryItemCollectionPage> implements IActivityHistoryItemCollectionRequest {
     ...
     */
    public ActivityHistoryItemCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IActivityHistoryItemCollectionRequest select(final String value) {
