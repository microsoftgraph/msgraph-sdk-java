...
public class WorkbookFilterApplyTopPercentFilterRequestBuilder extends BaseActionRequestBuilder<WorkbookFilter> {
     ...
     */
    public WorkbookFilterApplyTopPercentFilterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final Integer percent) {
