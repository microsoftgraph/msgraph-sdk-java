...
public class WorkbookFunctionsCleanRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsCleanBody body;
    /**
     ...
     */
    public WorkbookFunctionsCleanRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsCleanBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsCleanRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
