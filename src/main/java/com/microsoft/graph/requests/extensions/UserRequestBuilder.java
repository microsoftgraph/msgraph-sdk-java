...
public class UserRequestBuilder extends BaseRequestBuilder<User> {
     ...
     */
    @Nonnull
    public UserAssignLicenseRequestBuilder assignLicense(@Nonnull final UserAssignLicenseBody parameters) {
     ...
     */
    @Nonnull
    public UserChangePasswordRequestBuilder changePassword(@Nonnull final UserChangePasswordBody parameters) {
     ...
     */
    @Nonnull
    public UserFindMeetingTimesRequestBuilder findMeetingTimes(@Nonnull final UserFindMeetingTimesBody parameters) {
     ...
     */
    @Nonnull
    public UserGetMailTipsCollectionRequestBuilder getMailTips(@Nonnull final UserGetMailTipsBody parameters) {
     ...
     */
    @Nonnull
    public UserSendMailRequestBuilder sendMail(@Nonnull final UserSendMailBody parameters) {
     ...
     */
    @Nonnull
    public UserTranslateExchangeIdsCollectionRequestBuilder translateExchangeIds(@Nonnull final UserTranslateExchangeIdsBody parameters) {
     ...
     */
    @Nonnull
    public UserWipeManagedAppRegistrationsByDeviceTagRequestBuilder wipeManagedAppRegistrationsByDeviceTag(@Nonnull final UserWipeManagedAppRegistrationsByDeviceTagBody parameters) {
     ...
     */
    @Nonnull
    public UserExportPersonalDataRequestBuilder exportPersonalData(@Nonnull final UserExportPersonalDataBody parameters) {
     ...
     */
    @Nonnull
    public UserReminderViewCollectionRequestBuilder reminderView(@Nonnull final UserReminderViewBody parameters) {
