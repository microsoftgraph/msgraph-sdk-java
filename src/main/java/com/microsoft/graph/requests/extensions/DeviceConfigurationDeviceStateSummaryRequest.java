...
public class DeviceConfigurationDeviceStateSummaryRequest extends BaseRequest<DeviceConfigurationDeviceStateSummary> {
     ...
     */
    public void get(@Nonnull final ICallback<? super DeviceConfigurationDeviceStateSummary> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super DeviceConfigurationDeviceStateSummary> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final DeviceConfigurationDeviceStateSummary sourceDeviceConfigurationDeviceStateSummary, @Nonnull final ICallback<? super DeviceConfigurationDeviceStateSummary> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final DeviceConfigurationDeviceStateSummary newDeviceConfigurationDeviceStateSummary, @Nonnull final ICallback<? super DeviceConfigurationDeviceStateSummary> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final DeviceConfigurationDeviceStateSummary newDeviceConfigurationDeviceStateSummary, @Nonnull final ICallback<? super DeviceConfigurationDeviceStateSummary> callback) {
     ...
     */
    @Nonnull
    public DeviceConfigurationDeviceStateSummaryRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceConfigurationDeviceStateSummaryRequest count() {
        addCountOption(true);
        return this;
    }
}
