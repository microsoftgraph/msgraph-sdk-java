...
public class WorkbookFunctionsGammaLn_PreciseRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsGammaLn_PreciseBody body;
    /**
     ...
     */
    public WorkbookFunctionsGammaLn_PreciseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsGammaLn_PreciseBody parameters) {
