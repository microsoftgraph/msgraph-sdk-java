...
public class DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest extends BaseRequest<Boolean> {
     ...
     */
    @Nonnull
    public DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public DeviceManagementVerifyWindowsEnrollmentAutoDiscoveryRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
