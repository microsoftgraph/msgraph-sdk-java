...
/**
 * The interface for the Planner User With Reference Request Builder.
 */
public interface IPlannerUserWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPlannerUserWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPlannerUserWithReferenceRequest instance
     */
    IPlannerUserWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IPlannerUserReferenceRequestBuilder reference();
