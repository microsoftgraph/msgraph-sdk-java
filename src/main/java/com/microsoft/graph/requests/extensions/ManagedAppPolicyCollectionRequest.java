...
public class ManagedAppPolicyCollectionRequest extends BaseCollectionRequest<ManagedAppPolicyCollectionResponse, IManagedAppPolicyCollectionPage> implements IManagedAppPolicyCollectionRequest {
    ...
    public ManagedAppPolicyCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ManagedAppPolicyCollectionResponse.class, IManagedAppPolicyCollectionPage.class);
    }

    public void get(final ICallback<? super IManagedAppPolicyCollectionPage> callback) {
     ...
     */
    public IManagedAppPolicyCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IManagedAppPolicyCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IManagedAppPolicyCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IManagedAppPolicyCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IManagedAppPolicyCollectionRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IManagedAppPolicyCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IManagedAppPolicyCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IManagedAppPolicyCollectionRequest)this;
    }
    public IManagedAppPolicyCollectionPage buildFromResponse(final ManagedAppPolicyCollectionResponse response) {
        final IManagedAppPolicyCollectionRequestBuilder builder;
