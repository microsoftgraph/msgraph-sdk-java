...
public class CalendarPermissionCollectionRequestBuilder extends BaseRequestBuilder implements ICalendarPermissionCollectionRequestBuilder {
     ...
     */
    public CalendarPermissionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ICalendarPermissionCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
