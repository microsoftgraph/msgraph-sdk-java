 ...
 */
public class DirectoryObjectGetAvailableExtensionPropertiesCollectionRequest extends BaseCollectionRequest<ExtensionProperty, DirectoryObjectGetAvailableExtensionPropertiesCollectionResponse> {
    ...
    public void post(final ICallback<? super BaseCollectionPage<ExtensionProperty>> callback) {
    ...
    public BaseCollectionPage<ExtensionProperty> post() throws ClientException {
        final DirectoryObjectGetAvailableExtensionPropertiesCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public BaseCollectionPage<ExtensionProperty> buildFromResponse(final DirectoryObjectGetAvailableExtensionPropertiesCollectionResponse response) {
