...
public class TeamArchiveRequestBuilder extends BaseActionRequestBuilder<Team> {
     ...
     */
    public TeamArchiveRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TeamArchiveBody parameters) {
