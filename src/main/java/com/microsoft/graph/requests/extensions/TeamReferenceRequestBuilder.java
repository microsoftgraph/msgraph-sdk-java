 ...
 */
public class TeamReferenceRequestBuilder extends BaseRequestBuilder implements ITeamReferenceRequestBuilder {
     ...
     */
    public TeamReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public ITeamReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ITeamReferenceRequest instance
     */
    public ITeamReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new TeamReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
