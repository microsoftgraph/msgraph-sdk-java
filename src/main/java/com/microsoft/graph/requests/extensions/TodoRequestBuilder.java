...
public class TodoRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public TodoRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the TodoRequest instance
     */
    public TodoRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public TodoTaskListRequestBuilder lists(final String id) {
