 ...
 */
public interface IReportRootGetSkypeForBusinessActivityCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetSkypeForBusinessActivityCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessActivityCountsRequest expand(final String value);
