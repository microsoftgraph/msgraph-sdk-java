...
public class CalendarPermissionCollectionRequest extends BaseCollectionRequest<CalendarPermissionCollectionResponse, CalendarPermissionCollectionPage> {
    ...
    public void get(final ICallback<? super CalendarPermissionCollectionPage> callback) {
    ...
    public CalendarPermissionCollectionPage buildFromResponse(final CalendarPermissionCollectionResponse response) {
