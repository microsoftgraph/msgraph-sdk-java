...
public class ApplicationCollectionRequestBuilder extends BaseRequestBuilder implements IApplicationCollectionRequestBuilder {
     ...
     */
    public ApplicationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IApplicationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
