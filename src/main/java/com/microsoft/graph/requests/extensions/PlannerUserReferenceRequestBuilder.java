...
/**
 * The class for the Planner User Reference Request Builder.
 */
public class PlannerUserReferenceRequestBuilder extends BaseRequestBuilder implements IPlannerUserReferenceRequestBuilder {
     ...
     */
    public PlannerUserReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return The IPlannerUserReferenceRequest instance
     */
    public IPlannerUserReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPlannerUserReferenceRequest instance
     */
    public IPlannerUserReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerUserReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
