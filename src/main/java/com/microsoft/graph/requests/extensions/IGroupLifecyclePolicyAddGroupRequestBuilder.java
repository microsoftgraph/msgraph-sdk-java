 ...
 */
public interface IGroupLifecyclePolicyAddGroupRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupLifecyclePolicyAddGroupRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
