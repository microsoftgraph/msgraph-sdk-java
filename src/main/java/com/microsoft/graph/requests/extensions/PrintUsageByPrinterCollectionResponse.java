...
/**
 * The class for the Print Usage By Printer Collection Response.
 */
public class PrintUsageByPrinterCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintUsageByPrinter within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintUsageByPrinter> value;
