 ...
 */
public class ManagedAppRegistrationCollectionRequest extends BaseCollectionRequest<ManagedAppRegistrationCollectionResponse, ManagedAppRegistrationCollectionPage> {
    ...
    public void get(final ICallback<? super ManagedAppRegistrationCollectionPage> callback) {
    ...
    public ManagedAppRegistrationCollectionPage get() throws ClientException {
    ...
    public ManagedAppRegistrationCollectionPage buildFromResponse(final ManagedAppRegistrationCollectionResponse response) {
