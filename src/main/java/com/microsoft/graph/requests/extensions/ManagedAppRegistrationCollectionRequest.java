...
public class ManagedAppRegistrationCollectionRequest extends BaseCollectionRequest<ManagedAppRegistrationCollectionResponse, ManagedAppRegistrationCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super ManagedAppRegistrationCollectionPage> callback) {
    ...
    @Nonnull
    public ManagedAppRegistrationCollectionPage buildFromResponse(@Nonnull final ManagedAppRegistrationCollectionResponse response) {
