...
public class WorkbookWorksheetCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public WorkbookWorksheetCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WorkbookWorksheetCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public WorkbookWorksheetRequestBuilder byId(@Nonnull final String id) {
    ...
    @Nonnull
    public WorkbookWorksheetAddRequestBuilder add(@Nullable final String name) {
