 ...
 */
public class WindowsInformationProtectionAppLearningSummaryCollectionRequest extends BaseCollectionRequest<WindowsInformationProtectionAppLearningSummaryCollectionResponse, WindowsInformationProtectionAppLearningSummaryCollectionPage> {
    ...
    public WindowsInformationProtectionAppLearningSummaryCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsInformationProtectionAppLearningSummaryCollectionResponse.class, WindowsInformationProtectionAppLearningSummaryCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super WindowsInformationProtectionAppLearningSummaryCollectionPage> callback) {
    ...
    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryCollectionPage get() throws ClientException {
    ...
    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryCollectionPage buildFromResponse(@Nonnull final WindowsInformationProtectionAppLearningSummaryCollectionResponse response) {
