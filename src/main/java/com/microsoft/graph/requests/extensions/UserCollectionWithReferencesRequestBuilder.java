 ...
 */
public class UserCollectionWithReferencesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public UserCollectionWithReferencesRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UserCollectionWithReferencesRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new UserCollectionWithReferencesRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public UserWithReferenceRequestBuilder byId(@Nonnull final String id) {
        return new UserWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment(id), getClient(), getOptions());
    }

    @Nonnull
    public UserCollectionReferenceRequestBuilder references(){
