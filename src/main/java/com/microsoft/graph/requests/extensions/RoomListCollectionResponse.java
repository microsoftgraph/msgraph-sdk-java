...
/**
 * The class for the Room List Collection Response.
 */
public class RoomListCollectionResponse implements IJsonBackedObject {

    /**
     * The list of RoomList within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<RoomList> value;
