...
public class TeamsAppDefinitionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public TeamsAppDefinitionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the TeamsAppDefinitionRequest instance
     */
    public TeamsAppDefinitionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
