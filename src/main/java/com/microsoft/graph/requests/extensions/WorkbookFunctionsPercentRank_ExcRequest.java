 ...
 */
public class WorkbookFunctionsPercentRank_ExcRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsPercentRank_ExcRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsPercentRank_ExcRequest expand(final String value) {
