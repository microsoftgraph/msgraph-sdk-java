 ...
 */
public class OutlookUserSupportedTimeZonesCollectionResponse implements ICollectionResponse<TimeZoneInformation>, IJsonBackedObject {

    /**
     * The list of TimeZoneInformation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TimeZoneInformation> value;

    /**
     * The list of TimeZoneInformation within this collection page
     */
    @Override
    public java.util.List<TimeZoneInformation> values() {
        return value;
    }
