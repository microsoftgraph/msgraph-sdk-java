...
import com.microsoft.graph.requests.generated.BaseBaseItemCollectionRequestBuilder;
...
public class BaseItemCollectionRequestBuilder extends BaseBaseItemCollectionRequestBuilder implements IBaseItemCollectionRequestBuilder {
     ...
     */
    public BaseItemCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
