...
public class BaseItemCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public BaseItemCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public BaseItemCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new BaseItemCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public BaseItemRequestBuilder byId(@Nonnull final String id) {
