 ...
 */
public class RestrictedSignInCollectionResponse implements ICollectionResponse<RestrictedSignIn>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<RestrictedSignIn> values() {
        return value;
    }
