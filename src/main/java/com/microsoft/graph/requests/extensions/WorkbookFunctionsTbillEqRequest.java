 ...
 */
public class WorkbookFunctionsTbillEqRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsTbillEqRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsTbillEqRequest expand(final String value) {
