 ...
 */
public class EventDeltaCollectionResponse implements ICollectionResponse<Event>, IJsonBackedObject {

    /**
     * The list of Event within this collection page
     */
     ...
     */
    @Override
    public java.util.List<Event> values() {
        return value;
    }
