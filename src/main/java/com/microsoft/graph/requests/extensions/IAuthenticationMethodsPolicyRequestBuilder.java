...
/**
 * The interface for the Authentication Methods Policy Request Builder.
 */
public interface IAuthenticationMethodsPolicyRequestBuilder extends IRequestBuilder {
     ...
     */
    IAuthenticationMethodsPolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAuthenticationMethodsPolicyRequest instance
     */
    IAuthenticationMethodsPolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
