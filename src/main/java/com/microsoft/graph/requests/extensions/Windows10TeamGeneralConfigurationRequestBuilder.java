...
public class Windows10TeamGeneralConfigurationRequestBuilder extends BaseRequestBuilder<Windows10TeamGeneralConfiguration> {
     ...
     */
    public Windows10TeamGeneralConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the Windows10TeamGeneralConfigurationRequest instance
     */
    public Windows10TeamGeneralConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
