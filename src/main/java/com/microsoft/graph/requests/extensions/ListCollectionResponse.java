 ...
 */
public class ListCollectionResponse implements ICollectionResponse<List>, IJsonBackedObject {

    /**
     * The list of List within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<List> value;
