...
/**
 * The interface for the Service Principal Collection Request Builder.
 */
public interface IServicePrincipalCollectionRequestBuilder extends IRequestBuilder {
     ...
     */
    IServicePrincipalCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserRequest instance
     */
    IServicePrincipalCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
