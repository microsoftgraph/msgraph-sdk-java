...
public class WorkbookChartPointItemAtRequestBuilder extends BaseFunctionRequestBuilder<WorkbookChartPoint> {
     ...
     */
    public WorkbookChartPointItemAtRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartPointItemAtBody parameters) {
