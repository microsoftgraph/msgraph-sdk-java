...
/**
 * The interface for the Drive Item With Reference Request Builder.
 */
public interface IDriveItemWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IDriveItemWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDriveItemWithReferenceRequest instance
     */
    IDriveItemWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IDriveItemReferenceRequestBuilder reference();
