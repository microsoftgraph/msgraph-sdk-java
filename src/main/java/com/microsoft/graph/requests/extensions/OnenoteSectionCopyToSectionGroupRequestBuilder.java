...
public class OnenoteSectionCopyToSectionGroupRequestBuilder extends BaseActionRequestBuilder<OnenoteOperation> {
    ...
    private OnenoteSectionCopyToSectionGroupBody body;
    /**
     ...
     */
    public OnenoteSectionCopyToSectionGroupRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final OnenoteSectionCopyToSectionGroupBody parameters) {
