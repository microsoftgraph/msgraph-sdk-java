 ...
 */
public interface IActivityHistoryItemRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IActivityHistoryItemRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     */
    IUserActivityWithReferenceRequestBuilder activity();
