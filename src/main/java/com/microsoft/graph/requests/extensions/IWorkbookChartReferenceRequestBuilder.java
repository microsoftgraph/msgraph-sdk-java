...
/**
 * The interface for the Workbook Chart Reference Request Builder.
 */
public interface IWorkbookChartReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookChartReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookChartReferenceRequest instance
     */
    IWorkbookChartReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
