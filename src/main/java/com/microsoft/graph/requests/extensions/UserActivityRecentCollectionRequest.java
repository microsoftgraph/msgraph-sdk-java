 ...
 */
public class UserActivityRecentCollectionRequest extends BaseCollectionRequest<UserActivity, UserActivityRecentCollectionResponse> {
    ...
    public BaseCollectionPage<UserActivity> buildFromResponse(final UserActivityRecentCollectionResponse response) {
