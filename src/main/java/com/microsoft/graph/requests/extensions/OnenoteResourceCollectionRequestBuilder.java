...
public class OnenoteResourceCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public OnenoteResourceCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OnenoteResourceCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new OnenoteResourceCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public OnenoteResourceRequestBuilder byId(@Nonnull final String id) {
