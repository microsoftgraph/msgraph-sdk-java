 ...
 */
public interface IReportRootGetYammerActivityCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetYammerActivityCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetYammerActivityCountsRequest expand(final String value);
