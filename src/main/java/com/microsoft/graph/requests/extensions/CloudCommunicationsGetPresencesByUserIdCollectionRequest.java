 ...
 */
public class CloudCommunicationsGetPresencesByUserIdCollectionRequest extends BaseCollectionRequest<Presence, CloudCommunicationsGetPresencesByUserIdCollectionResponse, CloudCommunicationsGetPresencesByUserIdCollectionPage> {
     ...
     */
    public CloudCommunicationsGetPresencesByUserIdCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public void post(@Nonnull final ICallback<? super CloudCommunicationsGetPresencesByUserIdCollectionPage> callback) {
     ...
     */
    @Nullable
    public CloudCommunicationsGetPresencesByUserIdCollectionPage post() throws ClientException {
