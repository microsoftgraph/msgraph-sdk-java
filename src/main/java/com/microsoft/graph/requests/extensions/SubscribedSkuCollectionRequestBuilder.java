...
import com.microsoft.graph.requests.generated.BaseSubscribedSkuCollectionRequestBuilder;
...
public class SubscribedSkuCollectionRequestBuilder extends BaseSubscribedSkuCollectionRequestBuilder implements ISubscribedSkuCollectionRequestBuilder {
     ...
     */
    public SubscribedSkuCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
