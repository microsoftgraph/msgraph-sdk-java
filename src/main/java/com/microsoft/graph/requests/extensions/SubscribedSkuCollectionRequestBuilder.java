...
public class SubscribedSkuCollectionRequestBuilder extends BaseCollectionRequestBuilder<SubscribedSku, SubscribedSkuRequestBuilder, SubscribedSkuCollectionResponse, SubscribedSkuCollectionPage, SubscribedSkuCollectionRequest> {
    ...
    public SubscribedSkuCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SubscribedSkuRequestBuilder.class, SubscribedSkuCollectionResponse.class, SubscribedSkuCollectionPage.class, SubscribedSkuCollectionRequest.class);
    }
