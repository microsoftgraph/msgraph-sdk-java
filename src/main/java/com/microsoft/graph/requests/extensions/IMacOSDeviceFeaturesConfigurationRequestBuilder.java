 ...
 */
public interface IMacOSDeviceFeaturesConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSDeviceFeaturesConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
