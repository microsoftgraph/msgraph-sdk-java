 ...
 */
public class IosCompliancePolicyRequestBuilder extends BaseRequestBuilder implements IIosCompliancePolicyRequestBuilder {
     ...
     */
    public IosCompliancePolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IIosCompliancePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IIosCompliancePolicyRequest instance
     */
    public IIosCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
