 ...
 */
public interface IReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest expand(final String value);
