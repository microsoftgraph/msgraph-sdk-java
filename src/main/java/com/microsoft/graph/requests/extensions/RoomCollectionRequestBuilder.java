...
public class RoomCollectionRequestBuilder extends BaseRequestBuilder implements IRoomCollectionRequestBuilder {
     ...
     */
    public RoomCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IRoomCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IRoomCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
