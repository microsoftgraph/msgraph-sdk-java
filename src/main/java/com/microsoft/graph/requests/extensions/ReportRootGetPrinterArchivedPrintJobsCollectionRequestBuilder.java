...
public class ReportRootGetPrinterArchivedPrintJobsCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetPrinterArchivedPrintJobsCollectionRequestBuilder {
     ...
     */
    public ReportRootGetPrinterArchivedPrintJobsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String printerId, final java.util.Calendar startDateTime, final java.util.Calendar endDateTime) {
     ...
     */
    public IReportRootGetPrinterArchivedPrintJobsCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
