 ...
 */
public class PostForwardRequest extends BaseRequest implements IPostForwardRequest {
     ...
     * @return the updated request
     */
    public IPostForwardRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IPostForwardRequest orderBy(final String value) {
