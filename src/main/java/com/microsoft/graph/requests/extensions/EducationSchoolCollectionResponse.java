 ...
 */
public class EducationSchoolCollectionResponse implements ICollectionResponse<EducationSchool>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<EducationSchool> values() {
        return value;
    }
