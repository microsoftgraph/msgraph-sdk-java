...
/**
 * The interface for the Planner Reference Request.
 */
public interface IPlannerReferenceRequest extends IHttpRequest {

    void delete(final ICallback<? super Planner> callback);

    Planner delete() throws ClientException;
     ...
     */
    IPlannerReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IPlannerReferenceRequest expand(final String value);

    /**
     * Puts the Planner
     *
     * @param srcPlanner the Planner to PUT
     * @param callback the callback to be called after success or failure
     */
    void put(Planner srcPlanner, final ICallback<? super Planner> callback);
     ...
     */
    Planner put(Planner srcPlanner) throws ClientException;
}
