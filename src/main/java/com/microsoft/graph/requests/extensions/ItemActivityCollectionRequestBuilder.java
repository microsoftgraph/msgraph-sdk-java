...
public class ItemActivityCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ItemActivityCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ItemActivityCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ItemActivityCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ItemActivityRequestBuilder byId(@Nonnull final String id) {
