 ...
 */
public class TeamCollectionResponse implements ICollectionResponse<Team>, IJsonBackedObject {

    /**
     * The list of Team within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Team> value;

    /**
     * The list of Team within this collection page
     */
    @Override
    public java.util.List<Team> values() {
        return value;
    }
