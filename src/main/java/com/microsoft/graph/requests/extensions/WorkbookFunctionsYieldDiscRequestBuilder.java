...
public class WorkbookFunctionsYieldDiscRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsYieldDiscBody body;
    /**
     ...
     */
    public WorkbookFunctionsYieldDiscRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsYieldDiscBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsYieldDiscRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
