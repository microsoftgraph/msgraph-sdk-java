...
/**
 * The class for the App Catalogs With Reference Request.
 */
public class AppCatalogsWithReferenceRequest extends BaseRequest implements IAppCatalogsWithReferenceRequest {
     ...
     */
    public AppCatalogsWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AppCatalogs.class);
    }

    public void post(final AppCatalogs newAppCatalogs, final IJsonBackedObject payload, final ICallback<? super AppCatalogs> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public AppCatalogs post(final AppCatalogs newAppCatalogs, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newAppCatalogs;
        }
        return null;
    }
     ...
     */
    public IAppCatalogsWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IAppCatalogsWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IAppCatalogsWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (AppCatalogsWithReferenceRequest)this;
    }
}
