 ...
 */
public interface IReportRootGetYammerActivityUserDetailRequest extends IHttpRequest {
     ...
     */
    IReportRootGetYammerActivityUserDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetYammerActivityUserDetailRequest expand(final String value);
