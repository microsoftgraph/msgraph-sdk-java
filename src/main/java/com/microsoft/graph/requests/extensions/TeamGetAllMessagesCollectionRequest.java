 ...
 */
public class TeamGetAllMessagesCollectionRequest extends BaseFunctionCollectionRequest<ChatMessage, TeamGetAllMessagesCollectionResponse, TeamGetAllMessagesCollectionPage> {
     ...
     */
    @Nonnull
    public TeamGetAllMessagesCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public TeamGetAllMessagesCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public TeamGetAllMessagesCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
