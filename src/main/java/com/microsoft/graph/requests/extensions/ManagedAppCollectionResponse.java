...
/**
 * The class for the Managed App Collection Response.
 */
public class ManagedAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ManagedApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ManagedApp> value;
