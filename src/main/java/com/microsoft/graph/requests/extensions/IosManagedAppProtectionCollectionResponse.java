 ...
 */
public class IosManagedAppProtectionCollectionResponse implements ICollectionResponse<IosManagedAppProtection>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<IosManagedAppProtection> values() {
        return value;
    }
