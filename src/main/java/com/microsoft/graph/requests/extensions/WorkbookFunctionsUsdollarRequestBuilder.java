...
public class WorkbookFunctionsUsdollarRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsUsdollarBody body;
    /**
     ...
     */
    public WorkbookFunctionsUsdollarRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsUsdollarBody parameters) {
