 ...
 */
public class WorkbookFunctionsBitlshiftRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsBitlshiftRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsBitlshiftRequest expand(final String value) {
