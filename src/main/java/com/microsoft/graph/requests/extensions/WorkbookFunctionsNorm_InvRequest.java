...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsNorm_InvRequest;
...
public class WorkbookFunctionsNorm_InvRequest extends BaseWorkbookFunctionsNorm_InvRequest implements IWorkbookFunctionsNorm_InvRequest {
     ...
     */
    public WorkbookFunctionsNorm_InvRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
