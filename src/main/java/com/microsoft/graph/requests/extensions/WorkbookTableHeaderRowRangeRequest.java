 ...
 */
public class WorkbookTableHeaderRowRangeRequest extends BaseRequest<WorkbookRange> {
    /**
     ...
     */
    @Nonnull
    public WorkbookTableHeaderRowRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableHeaderRowRangeRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableHeaderRowRangeRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
