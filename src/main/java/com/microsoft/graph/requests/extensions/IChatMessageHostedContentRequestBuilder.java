...
/**
 * The interface for the Chat Message Hosted Content Request Builder.
 */
public interface IChatMessageHostedContentRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IChatMessageHostedContentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
