 ...
 */
public class WorkbookOperationRequest extends BaseRequest {
     ...
     */
     public WorkbookOperationRequest select(final String value) {
     ...
     * @return the updated request
     */
     public WorkbookOperationRequest expand(final String value) {
