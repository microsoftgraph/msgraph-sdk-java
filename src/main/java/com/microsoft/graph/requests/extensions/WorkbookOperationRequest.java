...
public class WorkbookOperationRequest extends BaseRequest implements IWorkbookOperationRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final WorkbookOperation newWorkbookOperation, final ICallback<WorkbookOperation> callback) {
     ...
     * @return the updated request
     */
     public IWorkbookOperationRequest filter(final String value) {
