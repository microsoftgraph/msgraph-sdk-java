...
public class WorkbookFunctionsMirrRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMirrRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMirrBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsMirrBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsMirrRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsMirrRequest count() {
        addCountOption(true);
        return this;
    }
