...
/**
 * The interface for the Named Location Request Builder.
 */
public interface INamedLocationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    INamedLocationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
