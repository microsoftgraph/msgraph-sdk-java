...
public class WorkbookFunctionsReplaceBRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsReplaceBRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsReplaceBRequest instance
     */
    public WorkbookFunctionsReplaceBRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
