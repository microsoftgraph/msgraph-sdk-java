 ...
 */
public interface IWorkbookFunctionsIsNARequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsIsNARequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
