...
/**
 * The interface for the Print Connector Reference Request Builder.
 */
public interface IPrintConnectorReferenceRequestBuilder extends IRequestBuilder {
     ...
     * @return the IPrintConnectorReferenceRequest instance
     */
    IPrintConnectorReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
