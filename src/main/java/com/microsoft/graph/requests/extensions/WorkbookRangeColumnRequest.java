...
public class WorkbookRangeColumnRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    public WorkbookRangeColumnRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookRangeColumnRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeColumnRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeColumnRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeColumnRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeColumnRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeColumnRequest count() {
        addCountOption(true);
        return this;
    }
}
