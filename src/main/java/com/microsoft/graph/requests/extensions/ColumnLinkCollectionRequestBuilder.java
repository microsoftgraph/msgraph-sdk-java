...
public class ColumnLinkCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ColumnLinkCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ColumnLinkCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ColumnLinkCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ColumnLinkCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ColumnLinkRequestBuilder byId(@Nonnull final String id) {
