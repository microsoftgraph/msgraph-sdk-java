...
public class SiteGetByPathRequestBuilder extends BaseFunctionRequestBuilder<Site> {
     ...
     */
    public SiteGetByPathRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final SiteGetByPathBody parameters) {
