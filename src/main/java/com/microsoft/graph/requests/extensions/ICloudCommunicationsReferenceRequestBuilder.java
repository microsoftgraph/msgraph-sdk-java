...
/**
 * The interface for the Cloud Communications Reference Request Builder.
 */
public interface ICloudCommunicationsReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ICloudCommunicationsReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ICloudCommunicationsReferenceRequest instance
     */
    ICloudCommunicationsReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
