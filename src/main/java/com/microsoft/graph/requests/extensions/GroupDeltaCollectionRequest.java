 ...
 */
public class GroupDeltaCollectionRequest extends BaseCollectionRequest<Group, GroupDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<Group> buildFromResponse(final GroupDeltaCollectionResponse response) {
