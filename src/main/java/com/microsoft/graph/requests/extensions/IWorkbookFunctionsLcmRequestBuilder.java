...
public interface IWorkbookFunctionsLcmRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsLcmRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsLcmRequest instance
     */
    IWorkbookFunctionsLcmRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
