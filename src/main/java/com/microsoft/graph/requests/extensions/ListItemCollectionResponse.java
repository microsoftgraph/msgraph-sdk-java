 ...
 */
public class ListItemCollectionResponse implements ICollectionResponse<ListItem>, IJsonBackedObject {

    /**
     * The list of ListItem within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ListItem> value;

    /**
     * The list of ListItem within this collection page
     */
    @Override
    public java.util.List<ListItem> values() {
        return value;
    }
