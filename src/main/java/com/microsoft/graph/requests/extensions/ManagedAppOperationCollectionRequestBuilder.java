...
public class ManagedAppOperationCollectionRequestBuilder extends BaseCollectionRequestBuilder<ManagedAppOperation, ManagedAppOperationRequestBuilder, ManagedAppOperationCollectionResponse, ManagedAppOperationCollectionPage, ManagedAppOperationCollectionRequest> {
    ...
    public ManagedAppOperationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ManagedAppOperationRequestBuilder.class, ManagedAppOperationCollectionResponse.class, ManagedAppOperationCollectionPage.class, ManagedAppOperationCollectionRequest.class);
    }
