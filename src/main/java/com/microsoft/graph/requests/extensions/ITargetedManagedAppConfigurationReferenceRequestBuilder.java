...
/**
 * The interface for the Targeted Managed App Configuration Reference Request Builder.
 */
public interface ITargetedManagedAppConfigurationReferenceRequestBuilder extends IRequestBuilder {

    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the ITargetedManagedAppConfigurationReferenceRequest instance
     */
    ITargetedManagedAppConfigurationReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ITargetedManagedAppConfigurationReferenceRequest instance
     */
    ITargetedManagedAppConfigurationReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
