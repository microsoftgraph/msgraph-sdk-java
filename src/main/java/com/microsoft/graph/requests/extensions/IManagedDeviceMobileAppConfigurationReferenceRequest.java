...
/**
 * The interface for the Managed Device Mobile App Configuration Reference Request.
 */
public interface IManagedDeviceMobileAppConfigurationReferenceRequest extends IHttpRequest {

    void delete(final ICallback<? super ManagedDeviceMobileAppConfiguration> callback);

    ManagedDeviceMobileAppConfiguration delete() throws ClientException;
     ...
     */
    IManagedDeviceMobileAppConfigurationReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IManagedDeviceMobileAppConfigurationReferenceRequest expand(final String value);

    /**
     * Puts the ManagedDeviceMobileAppConfiguration
     *
     * @param srcManagedDeviceMobileAppConfiguration the ManagedDeviceMobileAppConfiguration to PUT
     * @param callback the callback to be called after success or failure
     */
    void put(ManagedDeviceMobileAppConfiguration srcManagedDeviceMobileAppConfiguration, final ICallback<? super ManagedDeviceMobileAppConfiguration> callback);
     ...
     */
    ManagedDeviceMobileAppConfiguration put(ManagedDeviceMobileAppConfiguration srcManagedDeviceMobileAppConfiguration) throws ClientException;
}
