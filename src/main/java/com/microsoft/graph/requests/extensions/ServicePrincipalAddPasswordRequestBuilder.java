...
public class ServicePrincipalAddPasswordRequestBuilder extends BaseActionRequestBuilder implements IServicePrincipalAddPasswordRequestBuilder {
     ...
     */
    public ServicePrincipalAddPasswordRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final PasswordCredential passwordCredential) {
     ...
     * @return the IServicePrincipalAddPasswordRequest instance
     */
    public IServicePrincipalAddPasswordRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
