 ...
 */
public class PrinterShareCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrinterShare within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrinterShare> value;
