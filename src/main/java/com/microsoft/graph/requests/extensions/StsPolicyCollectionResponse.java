...
/**
 * The class for the Sts Policy Collection Response.
 */
public class StsPolicyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of StsPolicy within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<StsPolicy> value;
