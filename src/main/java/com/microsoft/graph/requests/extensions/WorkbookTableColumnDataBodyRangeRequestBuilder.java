 ...
 */
public class WorkbookTableColumnDataBodyRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public WorkbookTableColumnDataBodyRangeRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnDataBodyRangeRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
