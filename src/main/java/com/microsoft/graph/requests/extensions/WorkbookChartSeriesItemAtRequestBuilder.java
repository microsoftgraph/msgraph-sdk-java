...
public class WorkbookChartSeriesItemAtRequestBuilder extends BaseFunctionRequestBuilder<WorkbookChartSeries> {
     ...
     */
    public WorkbookChartSeriesItemAtRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartSeriesItemAtBody parameters) {
