 ...
 */
public class ReportRootGetMailboxUsageDetailRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetMailboxUsageDetailRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetMailboxUsageDetail
    ...
    /**
     * Puts the ReportRootGetMailboxUsageDetail
     *
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageDetailRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageDetailRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageDetailRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageDetailRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageDetailRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageDetailRequest count() {
        addCountOption(true);
        return this;
    }
}
