 ...
 */
public class ManagedMobileAppCollectionResponse implements ICollectionResponse<ManagedMobileApp>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<ManagedMobileApp> values() {
        return value;
    }
