...
public class WorkbookFunctionsDollarRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsDollarRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsDollarRequest instance
     */
    public WorkbookFunctionsDollarRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
