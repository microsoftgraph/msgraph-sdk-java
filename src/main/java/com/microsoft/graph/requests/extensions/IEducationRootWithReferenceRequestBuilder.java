...
/**
 * The interface for the Education Root With Reference Request Builder.
 */
public interface IEducationRootWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IEducationRootWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IEducationRootWithReferenceRequest instance
     */
    IEducationRootWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IEducationRootReferenceRequestBuilder reference();
