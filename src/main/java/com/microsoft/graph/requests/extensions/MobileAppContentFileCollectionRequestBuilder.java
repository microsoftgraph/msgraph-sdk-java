...
public class MobileAppContentFileCollectionRequestBuilder extends BaseCollectionRequestBuilder<MobileAppContentFile, MobileAppContentFileRequestBuilder, MobileAppContentFileCollectionResponse, MobileAppContentFileCollectionPage, MobileAppContentFileCollectionRequest> {
    ...
    public MobileAppContentFileCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, MobileAppContentFileRequestBuilder.class, MobileAppContentFileCollectionResponse.class, MobileAppContentFileCollectionPage.class, MobileAppContentFileCollectionRequest.class);
    }
