...
/**
 * The class for the Policy Base Collection Response.
 */
public class PolicyBaseCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PolicyBase within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PolicyBase> value;
