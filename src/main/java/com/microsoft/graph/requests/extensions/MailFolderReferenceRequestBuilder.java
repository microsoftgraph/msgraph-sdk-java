...
/**
 * The class for the Mail Folder Reference Request Builder.
 */
public class MailFolderReferenceRequestBuilder extends BaseRequestBuilder implements IMailFolderReferenceRequestBuilder {
     ...
     */
    public MailFolderReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMailFolderReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMailFolderReferenceRequest instance
     */
    public IMailFolderReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new MailFolderReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
