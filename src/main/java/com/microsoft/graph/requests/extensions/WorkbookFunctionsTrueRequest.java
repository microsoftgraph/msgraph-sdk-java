...
public class WorkbookFunctionsTrueRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    @Nonnull
    public WorkbookFunctionsTrueRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsTrueRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookFunctionsTrueRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
