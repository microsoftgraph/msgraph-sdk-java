...
import com.microsoft.graph.requests.generated.BaseWorkbookRangeFontRequestBuilder;
...
public class WorkbookRangeFontRequestBuilder extends BaseWorkbookRangeFontRequestBuilder implements IWorkbookRangeFontRequestBuilder {
     ...
     */
    public WorkbookRangeFontRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
