 ...
 */
public class OpenShiftCollectionRequest extends BaseEntityCollectionRequest<OpenShift, OpenShiftCollectionResponse, OpenShiftCollectionPage> {
     ...
     */
    @Nonnull
    public OpenShiftCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OpenShiftCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
