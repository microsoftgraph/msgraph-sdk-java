...
/**
 * The class for the Workbook Chart Title Format With Reference Request.
 */
public class WorkbookChartTitleFormatWithReferenceRequest extends BaseRequest implements IWorkbookChartTitleFormatWithReferenceRequest {
     ...
     */
    public WorkbookChartTitleFormatWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookChartTitleFormat.class);
    }

    public void post(final WorkbookChartTitleFormat newWorkbookChartTitleFormat, final IJsonBackedObject payload, final ICallback<? super WorkbookChartTitleFormat> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public WorkbookChartTitleFormat post(final WorkbookChartTitleFormat newWorkbookChartTitleFormat, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newWorkbookChartTitleFormat;
        }
        return null;
    }
     ...
     */
    public IWorkbookChartTitleFormatWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IWorkbookChartTitleFormatWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookChartTitleFormatWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (WorkbookChartTitleFormatWithReferenceRequest)this;
    }
}
