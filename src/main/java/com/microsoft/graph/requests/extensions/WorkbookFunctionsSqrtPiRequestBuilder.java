...
public class WorkbookFunctionsSqrtPiRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsSqrtPiBody body;
    /**
     ...
     */
    public WorkbookFunctionsSqrtPiRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsSqrtPiBody parameters) {
