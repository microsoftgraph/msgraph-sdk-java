...
public class GroupRequestBuilder extends BaseRequestBuilder<Group> {
     ...
     */
    @Nonnull
    public GroupAssignLicenseRequestBuilder assignLicense(@Nonnull final GroupAssignLicenseBody parameters) {
     ...
     */
    @Nonnull
    public GroupValidatePropertiesRequestBuilder validateProperties(@Nonnull final GroupValidatePropertiesBody parameters) {
