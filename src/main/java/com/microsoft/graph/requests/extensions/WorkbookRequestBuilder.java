...
import com.microsoft.graph.models.extensions.WorkbookSessionInfoResourceBody;
...
public class WorkbookRequestBuilder extends BaseRequestBuilder<Workbook> {
     ...
     */
    @Nonnull
    public WorkbookCreateSessionRequestBuilder createSession(@Nonnull final WorkbookCreateSessionBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookSessionInfoResourceRequestBuilder sessionInfoResource(@Nonnull final WorkbookSessionInfoResourceBody parameters) {
