...
public class OutlookCategoryCollectionRequestBuilder extends BaseCollectionRequestBuilder<OutlookCategory, OutlookCategoryRequestBuilder, OutlookCategoryCollectionResponse, OutlookCategoryCollectionPage, OutlookCategoryCollectionRequest> {
    ...
    public OutlookCategoryCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OutlookCategoryRequestBuilder.class, OutlookCategoryCollectionResponse.class, OutlookCategoryCollectionPage.class, OutlookCategoryCollectionRequest.class);
    }
