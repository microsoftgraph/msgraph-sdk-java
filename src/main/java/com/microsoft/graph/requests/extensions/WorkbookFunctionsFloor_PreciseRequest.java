 ...
 */
public class WorkbookFunctionsFloor_PreciseRequest extends BaseRequest implements IWorkbookFunctionsFloor_PreciseRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsFloor_PreciseRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsFloor_PreciseRequest orderBy(final String value) {
