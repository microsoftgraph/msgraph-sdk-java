 ...
 */
public class DeviceCategoryCollectionResponse implements ICollectionResponse<DeviceCategory>, IJsonBackedObject {

    /**
     * The list of DeviceCategory within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DeviceCategory> value;

    /**
     * The list of DeviceCategory within this collection page
     */
    @Override
    public java.util.List<DeviceCategory> values() {
        return value;
    }
