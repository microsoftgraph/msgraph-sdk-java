...
public class WorkbookTableColumnAddRequest extends BaseRequest<WorkbookTableColumn> {
     ...
     */
    public WorkbookTableColumnAddRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookTableColumnAddBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookTableColumn.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookTableColumnAddBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookTableColumnAddRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnAddRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableColumnAddRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
