...
public interface IWorkbookFunctionsRightRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsRightRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsRightRequest instance
     */
    IWorkbookFunctionsRightRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
