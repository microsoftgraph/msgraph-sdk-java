 ...
 */
public class DirectoryObjectGetMemberObjectsCollectionRequest extends BaseCollectionRequest<String, DirectoryObjectGetMemberObjectsCollectionResponse> {
    ...
    public BaseCollectionPage<String> buildFromResponse(final DirectoryObjectGetMemberObjectsCollectionResponse response) {
