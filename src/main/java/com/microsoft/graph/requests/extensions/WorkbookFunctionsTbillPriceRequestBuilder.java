...
public class WorkbookFunctionsTbillPriceRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsTbillPriceBody body;
    /**
     ...
     */
    public WorkbookFunctionsTbillPriceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsTbillPriceBody parameters) {
