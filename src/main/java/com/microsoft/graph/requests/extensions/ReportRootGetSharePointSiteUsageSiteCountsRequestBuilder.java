 ...
 */
public class ReportRootGetSharePointSiteUsageSiteCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public ReportRootGetSharePointSiteUsageSiteCountsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ReportRootGetSharePointSiteUsageSiteCountsRequest instance
     */
    public ReportRootGetSharePointSiteUsageSiteCountsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
