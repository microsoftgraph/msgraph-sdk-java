 ...
 */
public interface IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest expand(final String value);
