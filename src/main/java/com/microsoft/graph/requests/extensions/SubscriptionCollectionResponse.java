...
/**
 * The class for the Subscription Collection Response.
 */
public class SubscriptionCollectionResponse implements ICollectionResponse<Subscription>, IJsonBackedObject {
    ...
    @Expose
    public java.util.List<Subscription> value;

    /**
     * The list of Subscription within this collection page
     */
    @Override
    public java.util.List<Subscription> values() {
        return value;
    }
