...
/**
 * The interface for the Todo Task List Delta Collection Request.
 */
public interface ITodoTaskListDeltaCollectionRequest extends IHttpRequest {
     ...
     */
    ITodoTaskListDeltaCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ITodoTaskListDeltaCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ITodoTaskListDeltaCollectionRequest top(final int value);
