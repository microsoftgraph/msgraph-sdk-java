...
public class WorkbookChartPointItemAtRequest extends BaseRequest<WorkbookChartPoint> {
     ...
     */
    @Nonnull
    public WorkbookChartPointItemAtRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookChartPointItemAtRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookChartPointItemAtRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
