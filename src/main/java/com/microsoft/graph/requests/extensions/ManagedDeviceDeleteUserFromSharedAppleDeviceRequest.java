...
public class ManagedDeviceDeleteUserFromSharedAppleDeviceRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceDeleteUserFromSharedAppleDeviceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceDeleteUserFromSharedAppleDeviceBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ManagedDeviceDeleteUserFromSharedAppleDeviceBody body;
    /**
