...
/**
 * The interface for the Chat Reference Request Builder.
 */
public interface IChatReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IChatReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
