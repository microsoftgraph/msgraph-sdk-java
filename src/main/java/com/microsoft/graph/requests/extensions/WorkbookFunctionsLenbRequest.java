...
public class WorkbookFunctionsLenbRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsLenbRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsLenbBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsLenbBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsLenbRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsLenbRequest count() {
        addCountOption(true);
        return this;
    }
