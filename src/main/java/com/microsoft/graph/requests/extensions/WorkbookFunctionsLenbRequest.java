...
public class WorkbookFunctionsLenbRequest extends BaseRequest implements IWorkbookFunctionsLenbRequest {
     ...
     */
    public WorkbookFunctionsLenbRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsLenbRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsLenbRequest orderBy(final String value) {
