...
public class ApplicationRemoveKeyRequest extends BaseRequest<Void> {
     ...
     */
    public ApplicationRemoveKeyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ApplicationRemoveKeyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ApplicationRemoveKeyRequest count() {
        addCountOption(true);
        return this;
    }
    /**
