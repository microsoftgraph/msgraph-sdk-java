...
public class ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    @Nonnull
    public ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
