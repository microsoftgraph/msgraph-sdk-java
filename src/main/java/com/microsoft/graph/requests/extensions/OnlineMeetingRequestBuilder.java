...
public class OnlineMeetingRequestBuilder extends BaseRequestBuilder implements IOnlineMeetingRequestBuilder {
     ...
     */
    public OnlineMeetingRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IOnlineMeetingRequest buildRequest() {
