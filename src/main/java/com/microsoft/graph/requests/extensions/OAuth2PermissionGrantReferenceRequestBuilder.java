...
public class OAuth2PermissionGrantReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
