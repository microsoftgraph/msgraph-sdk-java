...
/**
 * The interface for the Attachment Create Upload Session Request.
 */
public interface IAttachmentCreateUploadSessionRequest extends IHttpRequest {
     ...
     */
    IAttachmentCreateUploadSessionRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IAttachmentCreateUploadSessionRequest top(final int value);
     ...
     * @return the updated request
     */
    IAttachmentCreateUploadSessionRequest expand(final String value);
