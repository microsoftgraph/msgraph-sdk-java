...
import com.microsoft.graph.requests.extensions.WorkforceIntegrationRequest;
...
public class WorkforceIntegrationRequest extends BaseRequest implements IWorkforceIntegrationRequest {
     ...
     */
    public WorkforceIntegrationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
