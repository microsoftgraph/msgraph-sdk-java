...
public class DeviceCompliancePolicyCollectionRequest extends BaseCollectionRequest<DeviceCompliancePolicyCollectionResponse, DeviceCompliancePolicyCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super DeviceCompliancePolicyCollectionPage> callback) {
    ...
    @Nonnull
    public DeviceCompliancePolicyCollectionPage buildFromResponse(@Nonnull final DeviceCompliancePolicyCollectionResponse response) {
