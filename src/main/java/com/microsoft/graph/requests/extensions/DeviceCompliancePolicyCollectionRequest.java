 ...
 */
public class DeviceCompliancePolicyCollectionRequest extends BaseCollectionRequest<DeviceCompliancePolicyCollectionResponse, DeviceCompliancePolicyCollectionPage> {
    ...
    public DeviceCompliancePolicyCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceCompliancePolicyCollectionResponse.class, DeviceCompliancePolicyCollectionPage.class);
    }

    public void get(final ICallback<? super DeviceCompliancePolicyCollectionPage> callback) {
    ...
    public DeviceCompliancePolicyCollectionPage get() throws ClientException {
     ...
     */
    public DeviceCompliancePolicyCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public DeviceCompliancePolicyCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public DeviceCompliancePolicyCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public DeviceCompliancePolicyCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public DeviceCompliancePolicyCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (DeviceCompliancePolicyCollectionRequest)this;
    }
    public DeviceCompliancePolicyCollectionPage buildFromResponse(final DeviceCompliancePolicyCollectionResponse response) {
        final DeviceCompliancePolicyCollectionRequestBuilder builder;
