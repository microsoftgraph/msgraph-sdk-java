...
public class ManagedAppProtectionTargetAppsRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedAppProtectionTargetAppsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedAppProtectionTargetAppsParameterSet parameters) {
