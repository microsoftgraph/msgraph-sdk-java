 ...
 */
public class WindowsInformationProtectionAppLearningSummaryCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WindowsInformationProtectionAppLearningSummaryCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryRequestBuilder byId(@Nonnull final String id) {
