...
/**
 * The interface for the Print Document Stream Request.
 */
public interface IPrintDocumentStreamRequest extends IHttpStreamRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final byte[] fileContents, final ICallback<? super PrintDocument> callback);
     ...
     * @throws ClientException an exception occurs if there was an error while the request was sent
     */
    PrintDocument put(final byte[] fileContents) throws ClientException;
}
