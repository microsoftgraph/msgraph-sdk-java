...
public class ParticipantInviteRequest extends BaseRequest<InviteParticipantsOperation> {
     ...
     */
    public ParticipantInviteRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ParticipantInviteBody parameters) {
        super(requestUrl, client, requestOptions, InviteParticipantsOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected ParticipantInviteBody body;
    /**
     ...
     */
    @Nonnull
    public ParticipantInviteRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ParticipantInviteRequest count() {
        addCountOption(true);
        return this;
    }
