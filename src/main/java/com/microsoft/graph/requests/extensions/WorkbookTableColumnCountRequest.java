...
public class WorkbookTableColumnCountRequest extends BaseRequest<Integer> {
     ...
     */
    @Nonnull
    public WorkbookTableColumnCountRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnCountRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableColumnCountRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
