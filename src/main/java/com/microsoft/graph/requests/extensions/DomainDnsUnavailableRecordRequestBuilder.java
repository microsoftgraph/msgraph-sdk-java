...
public class DomainDnsUnavailableRecordRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public DomainDnsUnavailableRecordRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the DomainDnsUnavailableRecordRequest instance
     */
    public DomainDnsUnavailableRecordRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
