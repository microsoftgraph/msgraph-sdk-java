...
public class EventForwardRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public EventForwardRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the EventForwardRequest instance
     */
    public EventForwardRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
