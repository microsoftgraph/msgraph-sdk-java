...
/**
 * The class for the Workbook Range View With Reference Request.
 */
public class WorkbookRangeViewWithReferenceRequest extends BaseRequest implements IWorkbookRangeViewWithReferenceRequest {
     ...
     */
    public WorkbookRangeViewWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookRangeView.class);
    }

    public void post(final WorkbookRangeView newWorkbookRangeView, final IJsonBackedObject payload, final ICallback<? super WorkbookRangeView> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public WorkbookRangeView post(final WorkbookRangeView newWorkbookRangeView, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newWorkbookRangeView;
        }
        return null;
    }
     ...
     */
    public IWorkbookRangeViewWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IWorkbookRangeViewWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookRangeViewWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (WorkbookRangeViewWithReferenceRequest)this;
    }
}
