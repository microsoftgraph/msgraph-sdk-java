...
public class GroupValidatePropertiesRequestBuilder extends BaseActionRequestBuilder implements IGroupValidatePropertiesRequestBuilder {
     ...
     */
    public GroupValidatePropertiesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String displayName, final String mailNickname, final java.util.UUID onBehalfOfUserId) {
     ...
     * @return the IGroupValidatePropertiesRequest instance
     */
    public IGroupValidatePropertiesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
