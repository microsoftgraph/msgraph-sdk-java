 ...
 */
public class WorkbookFunctionsStDevARequest extends BaseRequest implements IWorkbookFunctionsStDevARequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsStDevARequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsStDevARequest orderBy(final String value) {
