 ...
 */
public class UserTranslateExchangeIdsCollectionRequest extends BaseCollectionRequest<ConvertIdResult, UserTranslateExchangeIdsCollectionResponse> {
    ...
    public void post(final ICallback<? super BaseCollectionPage<ConvertIdResult>> callback) {
    ...
    public BaseCollectionPage<ConvertIdResult> post() throws ClientException {
        final UserTranslateExchangeIdsCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public BaseCollectionPage<ConvertIdResult> buildFromResponse(final UserTranslateExchangeIdsCollectionResponse response) {
        ...
        final BaseCollectionPage<ConvertIdResult> page = new BaseCollectionPage<ConvertIdResult>(response, builder);
