...
public class WorkbookNamedItemCollectionRequest extends BaseCollectionRequest<WorkbookNamedItemCollectionResponse, WorkbookNamedItemCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super WorkbookNamedItemCollectionPage> callback) {
    ...
    @Nonnull
    public WorkbookNamedItemCollectionPage buildFromResponse(@Nonnull final WorkbookNamedItemCollectionResponse response) {
