 ...
 */
public class ConversationMemberCollectionRequest extends BaseCollectionRequest<ConversationMemberCollectionResponse, IConversationMemberCollectionPage> implements IConversationMemberCollectionRequest {
    ...
    public void get(final ICallback<? super IConversationMemberCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IConversationMemberCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IConversationMemberCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IConversationMemberCollectionRequest top(final int value) {
