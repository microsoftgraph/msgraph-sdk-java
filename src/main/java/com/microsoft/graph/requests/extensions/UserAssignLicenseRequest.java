...
public class UserAssignLicenseRequest extends BaseRequest<User> {
     ...
     */
    public UserAssignLicenseRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserAssignLicenseBody parameters) {
        super(requestUrl, client, requestOptions, User.class);
        body = parameters;
    }

	/** The body for the method */
    protected UserAssignLicenseBody body;
    /**
