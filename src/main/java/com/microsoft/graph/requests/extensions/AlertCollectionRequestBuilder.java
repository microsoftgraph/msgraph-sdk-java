...
public class AlertCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public AlertCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AlertCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new AlertCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public AlertRequestBuilder byId(@Nonnull final String id) {
