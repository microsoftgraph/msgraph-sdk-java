...
public class ThreatAssessmentResultCollectionRequestBuilder extends BaseRequestBuilder implements IThreatAssessmentResultCollectionRequestBuilder {
     ...
     */
    public ThreatAssessmentResultCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IThreatAssessmentResultCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IThreatAssessmentResultCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
