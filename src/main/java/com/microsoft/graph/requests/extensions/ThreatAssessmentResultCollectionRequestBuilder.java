...
public class ThreatAssessmentResultCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ThreatAssessmentResultCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ThreatAssessmentResultCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ThreatAssessmentResultCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ThreatAssessmentResultRequestBuilder byId(@Nonnull final String id) {
