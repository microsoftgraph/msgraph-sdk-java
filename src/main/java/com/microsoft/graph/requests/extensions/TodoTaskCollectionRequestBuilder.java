...
public class TodoTaskCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public TodoTaskCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TodoTaskCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new TodoTaskCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public TodoTaskRequestBuilder byId(@Nonnull final String id) {
    ...
    @Nonnull
	public TodoTaskDeltaCollectionRequestBuilder delta(@Nonnull final String deltaLink) {
