...
public class DirectoryObjectRestoreRequest extends BaseRequest<DirectoryObject> {
     ...
     */
    public void post(@Nonnull final ICallback<? super DirectoryObject> callback) {
     ...
     */
    @Nonnull
    public DirectoryObjectRestoreRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DirectoryObjectRestoreRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public DirectoryObjectRestoreRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
