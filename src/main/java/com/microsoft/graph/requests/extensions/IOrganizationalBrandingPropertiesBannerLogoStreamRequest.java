...
/**
 * The interface for the Organizational Branding Properties Banner Logo Stream Request.
 */
public interface IOrganizationalBrandingPropertiesBannerLogoStreamRequest extends IHttpStreamRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final byte[] fileContents, final ICallback<? super OrganizationalBrandingProperties> callback);
