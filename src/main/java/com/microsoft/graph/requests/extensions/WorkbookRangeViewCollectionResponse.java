 ...
 */
public class WorkbookRangeViewCollectionResponse implements ICollectionResponse<WorkbookRangeView>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<WorkbookRangeView> values() {
        return value;
    }
