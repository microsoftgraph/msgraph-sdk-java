...
public class ManagedMobileLobAppCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ManagedMobileLobAppCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedMobileLobAppCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ManagedMobileLobAppCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ManagedMobileLobAppRequestBuilder byId(@Nonnull final String id) {
