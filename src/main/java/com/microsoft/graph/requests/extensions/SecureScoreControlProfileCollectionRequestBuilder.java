...
public class SecureScoreControlProfileCollectionRequestBuilder extends BaseRequestBuilder implements ISecureScoreControlProfileCollectionRequestBuilder {
     ...
     */
    public SecureScoreControlProfileCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ISecureScoreControlProfileCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ISecureScoreControlProfileCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
