...
import com.microsoft.graph.requests.extensions.IPermissionGrantPolicyCollectionWithReferencesPage;
...
/**
 * The class for the Permission Grant Policy Collection With References Page.
 */
public class PermissionGrantPolicyCollectionWithReferencesPage extends BaseCollectionPage<PermissionGrantPolicy, IPermissionGrantPolicyCollectionWithReferencesRequestBuilder> implements IPermissionGrantPolicyCollectionWithReferencesPage {
     ...
     */
    public PermissionGrantPolicyCollectionWithReferencesPage(final PermissionGrantPolicyCollectionResponse response, final IPermissionGrantPolicyCollectionWithReferencesRequestBuilder builder) {
