...
import com.microsoft.graph.requests.generated.BaseAdministrativeUnitRequest;
...
public class AdministrativeUnitRequest extends BaseAdministrativeUnitRequest implements IAdministrativeUnitRequest {
     ...
     */
    public AdministrativeUnitRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
