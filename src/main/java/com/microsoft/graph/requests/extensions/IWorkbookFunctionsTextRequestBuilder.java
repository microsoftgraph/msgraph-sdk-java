...
public interface IWorkbookFunctionsTextRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsTextRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsTextRequest instance
     */
    IWorkbookFunctionsTextRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
