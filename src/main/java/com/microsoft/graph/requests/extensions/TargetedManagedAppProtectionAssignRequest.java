...
public class TargetedManagedAppProtectionAssignRequest extends BaseRequest<Void> {
     ...
     */
    public TargetedManagedAppProtectionAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TargetedManagedAppProtectionAssignBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected TargetedManagedAppProtectionAssignBody body;
    /**
