 ...
 */
public class TargetedManagedAppProtectionAssignRequest extends BaseRequest implements ITargetedManagedAppProtectionAssignRequest {
     ...
     */
    public ITargetedManagedAppProtectionAssignRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ITargetedManagedAppProtectionAssignRequest top(final int value) {
     ...
     * @return the updated request
     */
    public ITargetedManagedAppProtectionAssignRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ITargetedManagedAppProtectionAssignRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public ITargetedManagedAppProtectionAssignRequest orderBy(final String value) {
