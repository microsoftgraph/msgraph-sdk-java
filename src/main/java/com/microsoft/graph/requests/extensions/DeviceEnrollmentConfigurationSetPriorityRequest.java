...
public class DeviceEnrollmentConfigurationSetPriorityRequest extends BaseRequest implements IDeviceEnrollmentConfigurationSetPriorityRequest {
     ...
     * @return the updated request
     */
    public IDeviceEnrollmentConfigurationSetPriorityRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceEnrollmentConfigurationSetPriorityRequest orderBy(final String value) {
