...
public class DeviceEnrollmentConfigurationSetPriorityRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationSetPriorityRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationSetPriorityRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationSetPriorityRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationSetPriorityRequest expand(@Nonnull final String value) {
