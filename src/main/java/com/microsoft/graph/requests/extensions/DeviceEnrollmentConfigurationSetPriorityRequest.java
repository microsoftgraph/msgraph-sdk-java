...
public class DeviceEnrollmentConfigurationSetPriorityRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceEnrollmentConfigurationSetPriorityRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DeviceEnrollmentConfigurationSetPriorityBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected DeviceEnrollmentConfigurationSetPriorityBody body;
    /**
