...
public interface IWorkbookChartAxisRequest extends IHttpRequest {
     ...
     */
    void delete(final ICallback<WorkbookChartAxis> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final WorkbookChartAxis newWorkbookChartAxis, final ICallback<WorkbookChartAxis> callback);
