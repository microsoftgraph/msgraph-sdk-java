 ...
 */
public class ContactDeltaCollectionRequest extends BaseCollectionRequest<Contact, ContactDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<Contact> buildFromResponse(final ContactDeltaCollectionResponse response) {
