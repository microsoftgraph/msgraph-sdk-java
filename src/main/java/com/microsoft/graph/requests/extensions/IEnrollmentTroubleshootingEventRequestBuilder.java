 ...
 */
public interface IEnrollmentTroubleshootingEventRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IEnrollmentTroubleshootingEventRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
