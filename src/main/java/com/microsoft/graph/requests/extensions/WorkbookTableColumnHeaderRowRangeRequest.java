...
public class WorkbookTableColumnHeaderRowRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    public WorkbookTableColumnHeaderRowRangeRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnHeaderRowRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnHeaderRowRangeRequest count() {
        addCountOption(true);
        return this;
    }
}
