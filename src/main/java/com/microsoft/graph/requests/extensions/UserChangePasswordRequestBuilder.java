...
public class UserChangePasswordRequestBuilder extends BaseActionRequestBuilder<User> {
    ...
    private UserChangePasswordBody body;
    /**
     ...
     */
    public UserChangePasswordRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserChangePasswordBody parameters) {
