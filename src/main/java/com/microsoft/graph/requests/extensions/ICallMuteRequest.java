...
/**
 * The interface for the Call Mute Request.
 */
public interface ICallMuteRequest extends IHttpRequest {
     ...
     */
    ICallMuteRequest select(final String value) ;
     ...
     * @return the updated request
     */
    ICallMuteRequest top(final int value);
     ...
     * @return the updated request
     */
    ICallMuteRequest expand(final String value);
