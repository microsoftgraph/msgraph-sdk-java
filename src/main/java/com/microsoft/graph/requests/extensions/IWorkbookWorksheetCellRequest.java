 ...
 */
public interface IWorkbookWorksheetCellRequest extends IHttpRequest {
     ...
     */
    IWorkbookWorksheetCellRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookWorksheetCellRequest expand(final String value);
