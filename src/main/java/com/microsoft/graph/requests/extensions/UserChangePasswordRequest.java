...
public class UserChangePasswordRequest extends BaseRequest<Void> {
     ...
     */
    public UserChangePasswordRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserChangePasswordParameterSet parameters) {
