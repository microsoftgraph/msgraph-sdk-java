...
public class EventSnoozeReminderRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public EventSnoozeReminderRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EventSnoozeReminderRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public EventSnoozeReminderRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public EventSnoozeReminderRequest expand(@Nonnull final String value) {
