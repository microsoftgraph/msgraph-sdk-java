...
public class EventSnoozeReminderRequest extends BaseRequest<Void> {
     ...
     */
    public EventSnoozeReminderRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final EventSnoozeReminderBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected EventSnoozeReminderBody body;
    /**
