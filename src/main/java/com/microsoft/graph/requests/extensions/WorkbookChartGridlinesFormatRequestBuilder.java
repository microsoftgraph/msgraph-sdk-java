...
public class WorkbookChartGridlinesFormatRequestBuilder extends BaseRequestBuilder<WorkbookChartGridlinesFormat> {
     ...
     */
    public WorkbookChartGridlinesFormatRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookChartGridlinesFormatRequest instance
     */
    public WorkbookChartGridlinesFormatRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
