...
/**
 * The class for the Device Management With Reference Request Builder.
 */
public class DeviceManagementWithReferenceRequestBuilder extends BaseRequestBuilder implements IDeviceManagementWithReferenceRequestBuilder {
     ...
     */
    public DeviceManagementWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IDeviceManagementWithReferenceRequest instance
     */
    public IDeviceManagementWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IDeviceManagementWithReferenceRequest instance
     */
    public IDeviceManagementWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DeviceManagementWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IDeviceManagementReferenceRequestBuilder reference(){
        return new DeviceManagementReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
