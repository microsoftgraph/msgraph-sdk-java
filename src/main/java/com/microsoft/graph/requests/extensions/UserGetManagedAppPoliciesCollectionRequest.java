 ...
 */
public class UserGetManagedAppPoliciesCollectionRequest extends BaseCollectionRequest<ManagedAppPolicy, UserGetManagedAppPoliciesCollectionResponse> {
    ...
    public BaseCollectionPage<ManagedAppPolicy> buildFromResponse(final UserGetManagedAppPoliciesCollectionResponse response) {
