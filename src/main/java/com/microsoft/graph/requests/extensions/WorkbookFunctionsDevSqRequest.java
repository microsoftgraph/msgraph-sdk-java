 ...
 */
public class WorkbookFunctionsDevSqRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsDevSqRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDevSqBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsDevSqBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsDevSqRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsDevSqRequest count() {
        addCountOption(true);
        return this;
    }
