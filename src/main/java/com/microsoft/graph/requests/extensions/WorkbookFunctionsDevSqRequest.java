...
public class WorkbookFunctionsDevSqRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDevSqRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDevSqParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsDevSqParameterSet body;
    /**
