...
public class AndroidCustomConfigurationRequestBuilder extends BaseRequestBuilder<AndroidCustomConfiguration> {
     ...
     */
    public AndroidCustomConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidCustomConfigurationRequest instance
     */
    @Nonnull
    public AndroidCustomConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidCustomConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidCustomConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
