...
public class AndroidCustomConfigurationRequestBuilder extends BaseRequestBuilder<AndroidCustomConfiguration> {
     ...
     */
    public AndroidCustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the AndroidCustomConfigurationRequest instance
     */
    public AndroidCustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
