 ...
 */
public class DeviceInstallStateCollectionResponse implements ICollectionResponse<DeviceInstallState>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<DeviceInstallState> values() {
        return value;
    }
