...
public class ManagedDeviceDeleteUserFromSharedAppleDeviceRequestBuilder extends BaseActionRequestBuilder<ManagedDevice> {
    ...
    private ManagedDeviceDeleteUserFromSharedAppleDeviceBody body;
    /**
     ...
     */
    public ManagedDeviceDeleteUserFromSharedAppleDeviceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceDeleteUserFromSharedAppleDeviceBody parameters) {
