...
public class TargetedManagedAppPolicyAssignmentCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public TargetedManagedAppPolicyAssignmentCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public TargetedManagedAppPolicyAssignmentCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TargetedManagedAppPolicyAssignmentCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new TargetedManagedAppPolicyAssignmentCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public TargetedManagedAppPolicyAssignmentRequestBuilder byId(@Nonnull final String id) {
