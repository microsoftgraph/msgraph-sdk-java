...
public class AppRoleAssignmentWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public AppRoleAssignmentWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AppRoleAssignmentWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
