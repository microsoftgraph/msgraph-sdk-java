 ...
 */
public class LinkedResourceCollectionRequest extends BaseCollectionRequest<LinkedResourceCollectionResponse, LinkedResourceCollectionPage> {
    ...
    public LinkedResourceCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, LinkedResourceCollectionResponse.class, LinkedResourceCollectionPage.class);
    }

    public void get(final ICallback<? super LinkedResourceCollectionPage> callback) {
    ...
    public LinkedResourceCollectionPage get() throws ClientException {
     ...
     */
    public LinkedResourceCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public LinkedResourceCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public LinkedResourceCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public LinkedResourceCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public LinkedResourceCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (LinkedResourceCollectionRequest)this;
    }
    public LinkedResourceCollectionPage buildFromResponse(final LinkedResourceCollectionResponse response) {
