...
public class LinkedResourceCollectionRequest extends BaseCollectionRequest<LinkedResourceCollectionResponse, LinkedResourceCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super LinkedResourceCollectionPage> callback) {
    ...
    @Nonnull
    public LinkedResourceCollectionPage buildFromResponse(@Nonnull final LinkedResourceCollectionResponse response) {
