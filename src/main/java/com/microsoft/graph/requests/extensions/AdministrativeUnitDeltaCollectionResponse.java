 ...
 */
public class AdministrativeUnitDeltaCollectionResponse implements ICollectionResponse<AdministrativeUnit>, IJsonBackedObject {

    /**
     * The list of AdministrativeUnit within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AdministrativeUnit> value;

    /**
     * The list of AdministrativeUnit within this collection page
     */
    @Override
    public java.util.List<AdministrativeUnit> values() {
        return value;
    }
