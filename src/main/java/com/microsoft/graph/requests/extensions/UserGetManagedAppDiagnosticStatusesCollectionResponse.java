 ...
 */
public class UserGetManagedAppDiagnosticStatusesCollectionResponse implements ICollectionResponse<ManagedAppDiagnosticStatus>, IJsonBackedObject {

    /**
     * The list of ManagedAppDiagnosticStatus within this collection page
     */
     ...
     */
    @Override
    public java.util.List<ManagedAppDiagnosticStatus> values() {
        return value;
    }
