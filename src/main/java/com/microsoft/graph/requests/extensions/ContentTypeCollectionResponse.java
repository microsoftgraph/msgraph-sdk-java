 ...
 */
public class ContentTypeCollectionResponse implements ICollectionResponse<ContentType>, IJsonBackedObject {

    /**
     * The list of ContentType within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ContentType> value;

    /**
     * The list of ContentType within this collection page
     */
    @Override
    public java.util.List<ContentType> values() {
        return value;
    }
