...
/**
 * The interface for the Teams Template Collection Page.
 */
public interface ITeamsTemplateCollectionPage extends IBaseCollectionPage<TeamsTemplate, ITeamsTemplateCollectionRequestBuilder> {
}
