 ...
 */
public class DriveSearchCollectionRequestBuilder extends BaseFunctionRequestBuilder<DriveItem> {
     ...
     */
    public DriveSearchCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
