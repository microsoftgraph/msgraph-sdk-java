...
public class ReportRootGetOffice365ServicesUserCountsRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetOffice365ServicesUserCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetOffice365ServicesUserCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetOffice365ServicesUserCountsRequest count() {
        addCountOption(true);
        return this;
    }
}
