 ...
 */
public class ReportRootGetOffice365ServicesUserCountsRequest extends BaseRequest implements IReportRootGetOffice365ServicesUserCountsRequest {
     ...
     */
    public ReportRootGetOffice365ServicesUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetOffice365ServicesUserCounts
    ...
    /**
     * Puts the ReportRootGetOffice365ServicesUserCounts
     *
     ...
     */
    public IReportRootGetOffice365ServicesUserCountsRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ServicesUserCountsRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ServicesUserCountsRequest orderBy(final String value) {
