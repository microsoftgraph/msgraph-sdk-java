...
public interface IInferenceClassificationOverrideCollectionRequest extends IHttpRequest {
     ...
     */
    IInferenceClassificationOverrideCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IInferenceClassificationOverrideCollectionRequest filter(final String value);
     ...
     * @return the updated request
     */
    IInferenceClassificationOverrideCollectionRequest orderBy(final String value);
     ...
     * @return the updated request
     */
    IInferenceClassificationOverrideCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IInferenceClassificationOverrideCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IInferenceClassificationOverrideCollectionRequest skip(final int value);
