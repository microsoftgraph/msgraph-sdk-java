...
public class WorkbookCreateSessionRequest extends BaseRequest<WorkbookSessionInfo> {
     ...
     */
    public WorkbookCreateSessionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookCreateSessionBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookSessionInfo.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookCreateSessionBody body;
    /**
