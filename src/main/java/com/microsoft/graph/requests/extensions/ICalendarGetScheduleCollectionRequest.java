...
public interface ICalendarGetScheduleCollectionRequest {
     ...
     */
    ICalendarGetScheduleCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ICalendarGetScheduleCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ICalendarGetScheduleCollectionRequest top(final int value);
