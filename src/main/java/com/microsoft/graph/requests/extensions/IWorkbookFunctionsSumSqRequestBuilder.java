...
public interface IWorkbookFunctionsSumSqRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsSumSqRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsSumSqRequest instance
     */
    IWorkbookFunctionsSumSqRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
