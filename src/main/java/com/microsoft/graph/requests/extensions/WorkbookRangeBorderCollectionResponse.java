...
/**
 * The class for the Workbook Range Border Collection Response.
 */
public class WorkbookRangeBorderCollectionResponse implements ICollectionResponse<WorkbookRangeBorder>, IJsonBackedObject {

    /**
     * The list of WorkbookRangeBorder within this collection page
     */
     ...
     */
    @Override
    public java.util.List<WorkbookRangeBorder> values() {
        return value;
    }
