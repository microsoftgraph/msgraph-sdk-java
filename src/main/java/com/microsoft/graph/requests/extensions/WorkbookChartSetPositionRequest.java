...
public class WorkbookChartSetPositionRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartSetPositionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartSetPositionBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookChartSetPositionBody body;
    /**
