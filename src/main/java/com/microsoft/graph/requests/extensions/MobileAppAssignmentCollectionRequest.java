...
public class MobileAppAssignmentCollectionRequest extends BaseCollectionRequest<MobileAppAssignmentCollectionResponse, IMobileAppAssignmentCollectionPage> implements IMobileAppAssignmentCollectionRequest {
     ...
     * @return the updated request
     */
    public IMobileAppAssignmentCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IMobileAppAssignmentCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IMobileAppAssignmentCollectionRequest)this;
    }
