...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsWeibull_DistRequest;
...
public class WorkbookFunctionsWeibull_DistRequest extends BaseWorkbookFunctionsWeibull_DistRequest implements IWorkbookFunctionsWeibull_DistRequest {
     ...
     */
    public WorkbookFunctionsWeibull_DistRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
