...
/**
 * The class for the Web App Collection Response.
 */
public class WebAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of WebApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<WebApp> value;
