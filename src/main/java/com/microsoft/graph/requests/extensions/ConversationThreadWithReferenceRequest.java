...
/**
 * The class for the Conversation Thread With Reference Request.
 */
public class ConversationThreadWithReferenceRequest extends BaseRequest implements IConversationThreadWithReferenceRequest {
     ...
     */
    public ConversationThreadWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ConversationThread.class);
    }

    public void post(final ConversationThread newConversationThread, final IJsonBackedObject payload, final ICallback<? super ConversationThread> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public ConversationThread post(final ConversationThread newConversationThread, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IConversationThreadWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IConversationThreadWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IConversationThreadWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (ConversationThreadWithReferenceRequest)this;
    }
}
