 ...
 */
public class WorkbookFunctionsFalseRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsFalseRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsFalseRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookFunctionsFalseRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
