...
/**
 * The interface for the Onenote With Reference Request Builder.
 */
public interface IOnenoteWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IOnenoteWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOnenoteWithReferenceRequest instance
     */
    IOnenoteWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IOnenoteReferenceRequestBuilder reference();
