 ...
 */
public class UserDeltaCollectionRequest extends BaseCollectionRequest<User, UserDeltaCollectionResponse> {
    ...
    public UserDeltaCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, User.class, UserDeltaCollectionResponse.class, (Class<BaseCollectionPage<User>>) (new BaseCollectionPage<User>(new java.util.ArrayList<User>(), null).getClass()));
    }
    ...
    public BaseCollectionPage<User> buildFromResponse(final UserDeltaCollectionResponse response) {
