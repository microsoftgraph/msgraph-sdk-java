...
public class SoftwareUpdateStatusSummaryRequest extends BaseRequest implements ISoftwareUpdateStatusSummaryRequest {
     ...
     */
    public SoftwareUpdateStatusSummaryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public SoftwareUpdateStatusSummary post(final SoftwareUpdateStatusSummary newSoftwareUpdateStatusSummary) throws ClientException {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public SoftwareUpdateStatusSummary put(final SoftwareUpdateStatusSummary newSoftwareUpdateStatusSummary) throws ClientException {
     ...
     */
     public ISoftwareUpdateStatusSummaryRequest select(final String value) {
     ...
     * @return the updated request
     */
     public ISoftwareUpdateStatusSummaryRequest orderBy(final String value) {
