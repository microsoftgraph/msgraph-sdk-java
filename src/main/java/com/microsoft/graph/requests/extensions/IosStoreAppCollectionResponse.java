...
/**
 * The class for the Ios Store App Collection Response.
 */
public class IosStoreAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IosStoreApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IosStoreApp> value;
