...
public class MailFolderMoveRequestBuilder extends BaseActionRequestBuilder implements IMailFolderMoveRequestBuilder {
     ...
     */
    public MailFolderMoveRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String destinationId) {
