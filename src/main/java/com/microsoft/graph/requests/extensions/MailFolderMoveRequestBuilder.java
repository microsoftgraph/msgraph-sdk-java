...
import com.microsoft.graph.requests.generated.BaseMailFolderMoveRequestBuilder;
...
public class MailFolderMoveRequestBuilder extends BaseMailFolderMoveRequestBuilder implements IMailFolderMoveRequestBuilder {
     ...
     */
    public MailFolderMoveRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String destinationId) {
