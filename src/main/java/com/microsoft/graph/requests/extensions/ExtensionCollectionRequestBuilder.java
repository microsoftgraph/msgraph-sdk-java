...
public class ExtensionCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ExtensionCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ExtensionCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ExtensionCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ExtensionRequestBuilder byId(@Nonnull final String id) {
