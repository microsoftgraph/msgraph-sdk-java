...
/**
 * The interface for the Print Task Trigger Reference Request Builder.
 */
public interface IPrintTaskTriggerReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPrintTaskTriggerReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
