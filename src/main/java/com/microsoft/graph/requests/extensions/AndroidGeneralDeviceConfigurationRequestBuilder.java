...
public class AndroidGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder<AndroidGeneralDeviceConfiguration> {
     ...
     */
    public AndroidGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the AndroidGeneralDeviceConfigurationRequest instance
     */
    public AndroidGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
