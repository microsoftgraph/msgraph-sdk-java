 ...
 */
public class AppRoleAssignmentCollectionResponse implements ICollectionResponse<AppRoleAssignment>, IJsonBackedObject {

    /**
     * The list of AppRoleAssignment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AppRoleAssignment> value;

    /**
     * The list of AppRoleAssignment within this collection page
     */
    @Override
    public java.util.List<AppRoleAssignment> values() {
        return value;
    }
