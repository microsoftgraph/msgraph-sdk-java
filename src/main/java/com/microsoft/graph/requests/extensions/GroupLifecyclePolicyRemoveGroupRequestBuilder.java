...
public class GroupLifecyclePolicyRemoveGroupRequestBuilder extends BaseActionRequestBuilder<Boolean> {
    ...
    private GroupLifecyclePolicyRemoveGroupParameterSet body;
    /**
     ...
     */
    public GroupLifecyclePolicyRemoveGroupRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final GroupLifecyclePolicyRemoveGroupParameterSet parameters) {
