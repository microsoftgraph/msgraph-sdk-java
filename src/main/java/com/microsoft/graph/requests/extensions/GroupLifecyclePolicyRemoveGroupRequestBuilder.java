...
import com.microsoft.graph.requests.generated.BaseGroupLifecyclePolicyRemoveGroupRequestBuilder;
...
public class GroupLifecyclePolicyRemoveGroupRequestBuilder extends BaseGroupLifecyclePolicyRemoveGroupRequestBuilder implements IGroupLifecyclePolicyRemoveGroupRequestBuilder {
     ...
     */
    public GroupLifecyclePolicyRemoveGroupRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String groupId) {
