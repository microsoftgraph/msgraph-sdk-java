 ...
 */
public class NamedLocationCollectionResponse implements ICollectionResponse<NamedLocation>, IJsonBackedObject {

    /**
     * The list of NamedLocation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<NamedLocation> value;

    /**
     * The list of NamedLocation within this collection page
     */
    @Override
    public java.util.List<NamedLocation> values() {
        return value;
    }
