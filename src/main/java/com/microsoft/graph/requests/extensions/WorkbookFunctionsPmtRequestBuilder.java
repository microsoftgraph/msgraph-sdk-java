...
public class WorkbookFunctionsPmtRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsPmtRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsPmtRequest instance
     */
    public WorkbookFunctionsPmtRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
