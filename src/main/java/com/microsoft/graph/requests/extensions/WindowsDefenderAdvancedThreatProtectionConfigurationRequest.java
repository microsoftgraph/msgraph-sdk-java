...
public class WindowsDefenderAdvancedThreatProtectionConfigurationRequest extends BaseRequest<WindowsDefenderAdvancedThreatProtectionConfiguration> {
     ...
     */
    @Nonnull
    public WindowsDefenderAdvancedThreatProtectionConfigurationRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WindowsDefenderAdvancedThreatProtectionConfigurationRequest count() {
        addCountOption(true);
        return this;
    }
}
