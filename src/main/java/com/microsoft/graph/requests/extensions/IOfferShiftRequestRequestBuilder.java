...
/**
 * The interface for the Offer Shift Request Request Builder.
 */
public interface IOfferShiftRequestRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IOfferShiftRequestRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
