...
public class WorkbookFunctionsMultiNomialRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsMultiNomialBody body;
    /**
     ...
     */
    public WorkbookFunctionsMultiNomialRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMultiNomialBody parameters) {
