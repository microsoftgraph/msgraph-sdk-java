...
public class MobileAppContentFileCommitRequest extends BaseRequest<Void> {
     ...
     */
    public MobileAppContentFileCommitRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public MobileAppContentFileCommitRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public MobileAppContentFileCommitRequest count() {
        addCountOption(true);
        return this;
    }
    /**
