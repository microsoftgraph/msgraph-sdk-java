...
public class MobileAppContentFileCommitRequest extends BaseRequest<Void> {
     ...
     */
    public MobileAppContentFileCommitRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MobileAppContentFileCommitParameterSet parameters) {
    ...
    @Nullable
    protected MobileAppContentFileCommitParameterSet body;
    /**
     * Creates the MobileAppContentFileCommit
     *
