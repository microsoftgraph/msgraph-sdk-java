...
public class MobileAppContentFileCommitRequest extends BaseRequest<Void> {
     ...
     */
    public MobileAppContentFileCommitRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MobileAppContentFileCommitBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected MobileAppContentFileCommitBody body;
    /**
