 ...
 */
public class WorkbookFunctionsRank_EqRequest extends BaseRequest implements IWorkbookFunctionsRank_EqRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsRank_EqRequest orderBy(final String value) {
