...
public interface IWorkbookChartAreaFormatRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookChartAreaFormatRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookChartAreaFormatRequest instance
     */
    IWorkbookChartAreaFormatRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
