 ...
 */
public class LicenseDetailsCollectionRequest extends BaseCollectionRequest<LicenseDetailsCollectionResponse, LicenseDetailsCollectionPage> {
    ...
    public LicenseDetailsCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, LicenseDetailsCollectionResponse.class, LicenseDetailsCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super LicenseDetailsCollectionPage> callback) {
    ...
    @Nonnull
    public LicenseDetailsCollectionPage get() throws ClientException {
    ...
    @Nonnull
    public LicenseDetailsCollectionPage buildFromResponse(@Nonnull final LicenseDetailsCollectionResponse response) {
