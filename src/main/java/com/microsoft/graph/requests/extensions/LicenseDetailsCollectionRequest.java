...
public class LicenseDetailsCollectionRequest extends BaseCollectionRequest<LicenseDetailsCollectionResponse, LicenseDetailsCollectionPage> {
    ...
    public void get(final ICallback<? super LicenseDetailsCollectionPage> callback) {
    ...
    public LicenseDetailsCollectionPage buildFromResponse(final LicenseDetailsCollectionResponse response) {
