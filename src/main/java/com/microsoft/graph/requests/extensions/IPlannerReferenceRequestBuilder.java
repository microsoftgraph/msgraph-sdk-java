...
/**
 * The interface for the Planner Reference Request Builder.
 */
public interface IPlannerReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPlannerReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPlannerReferenceRequest instance
     */
    IPlannerReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
