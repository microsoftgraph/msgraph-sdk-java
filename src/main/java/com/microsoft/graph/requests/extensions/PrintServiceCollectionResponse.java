 ...
 */
public class PrintServiceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintService within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintService> value;
