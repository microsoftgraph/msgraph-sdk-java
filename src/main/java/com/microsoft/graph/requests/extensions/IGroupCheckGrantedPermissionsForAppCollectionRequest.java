...
/**
 * The interface for the Group Check Granted Permissions For App Collection Request.
 */
public interface IGroupCheckGrantedPermissionsForAppCollectionRequest extends IHttpRequest {
     ...
     */
    IGroupCheckGrantedPermissionsForAppCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IGroupCheckGrantedPermissionsForAppCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IGroupCheckGrantedPermissionsForAppCollectionRequest top(final int value);
