...
public class GroupAssignLicenseRequest extends BaseRequest<Group> {
     ...
     */
    public GroupAssignLicenseRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final GroupAssignLicenseBody parameters) {
        super(requestUrl, client, requestOptions, Group.class);
        body = parameters;
    }

	/** The body for the method */
    protected GroupAssignLicenseBody body;
    /**
     ...
     */
    @Nonnull
    public GroupAssignLicenseRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public GroupAssignLicenseRequest count() {
        addCountOption(true);
        return this;
    }
