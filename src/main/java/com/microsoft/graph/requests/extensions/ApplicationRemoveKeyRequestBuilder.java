...
public class ApplicationRemoveKeyRequestBuilder extends BaseActionRequestBuilder implements IApplicationRemoveKeyRequestBuilder {
     ...
     */
    public ApplicationRemoveKeyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.UUID keyId, final String proof) {
     ...
     * @return the IApplicationRemoveKeyRequest instance
     */
    public IApplicationRemoveKeyRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
