 ...
 */
public class PermissionGrantPolicyCollectionRequestBuilder extends BaseRequestBuilder<PermissionGrantPolicy> {
     ...
     */
    public PermissionGrantPolicyCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public PermissionGrantPolicyCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PermissionGrantPolicyCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public PermissionGrantPolicyRequestBuilder byId(final String id) {
