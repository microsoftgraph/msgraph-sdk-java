...
public class PermissionGrantPolicyCollectionRequestBuilder extends BaseCollectionRequestBuilder<PermissionGrantPolicy, PermissionGrantPolicyRequestBuilder, PermissionGrantPolicyCollectionResponse, PermissionGrantPolicyCollectionPage, PermissionGrantPolicyCollectionRequest> {
    ...
    public PermissionGrantPolicyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PermissionGrantPolicyRequestBuilder.class, PermissionGrantPolicyCollectionResponse.class, PermissionGrantPolicyCollectionPage.class, PermissionGrantPolicyCollectionRequest.class);
    }
