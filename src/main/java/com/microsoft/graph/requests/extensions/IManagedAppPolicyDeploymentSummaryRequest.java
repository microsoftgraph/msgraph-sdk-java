...
public interface IManagedAppPolicyDeploymentSummaryRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    ManagedAppPolicyDeploymentSummary put(final ManagedAppPolicyDeploymentSummary newManagedAppPolicyDeploymentSummary) throws ClientException;
     ...
     */
    IManagedAppPolicyDeploymentSummaryRequest select(final String value);
     ...
     * @return the updated request
     */
    IManagedAppPolicyDeploymentSummaryRequest expand(final String value);
