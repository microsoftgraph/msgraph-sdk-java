...
import com.microsoft.graph.requests.generated.BaseOnenoteOperationCollectionRequestBuilder;
...
public class OnenoteOperationCollectionRequestBuilder extends BaseOnenoteOperationCollectionRequestBuilder implements IOnenoteOperationCollectionRequestBuilder {
     ...
     */
    public OnenoteOperationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
