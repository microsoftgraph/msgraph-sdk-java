...
public class TimeOffReasonCollectionRequestBuilder extends BaseRequestBuilder implements ITimeOffReasonCollectionRequestBuilder {
     ...
     */
    public TimeOffReasonCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ITimeOffReasonCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ITimeOffReasonCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
