 ...
 */
public class ColumnLinkCollectionResponse implements ICollectionResponse<ColumnLink>, IJsonBackedObject {

    /**
     * The list of ColumnLink within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ColumnLink> value;

    /**
     * The list of ColumnLink within this collection page
     */
    @Override
    public java.util.List<ColumnLink> values() {
        return value;
    }
