 ...
 */
public interface IIosUpdateConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosUpdateConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosUpdateConfigurationRequest instance
     */
    IIosUpdateConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
