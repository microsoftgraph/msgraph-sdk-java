 ...
 */
public class WorkbookFunctionsIfRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsIfRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsIfRequest instance
     */
    public WorkbookFunctionsIfRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
