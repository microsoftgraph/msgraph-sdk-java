 ...
 */
public class DeviceManagementGetEffectivePermissionsCollectionResponse implements ICollectionResponse<RolePermission>, IJsonBackedObject {

    /**
     * The list of RolePermission within this collection page
     */
     ...
     */
    @Override
    public java.util.List<RolePermission> values() {
        return value;
    }
