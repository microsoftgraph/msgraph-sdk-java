...
public class WorkbookFunctionsDatevalueRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsDatevalueRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsDatevalueRequest instance
     */
    public WorkbookFunctionsDatevalueRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
