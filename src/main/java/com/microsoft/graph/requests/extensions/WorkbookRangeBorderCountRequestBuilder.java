...
import com.microsoft.graph.requests.generated.BaseWorkbookRangeBorderCountRequestBuilder;
...
public class WorkbookRangeBorderCountRequestBuilder extends BaseWorkbookRangeBorderCountRequestBuilder implements IWorkbookRangeBorderCountRequestBuilder {
     ...
     */
    public WorkbookRangeBorderCountRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
