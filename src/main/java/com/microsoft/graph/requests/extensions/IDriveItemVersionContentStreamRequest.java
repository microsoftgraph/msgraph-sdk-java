...
/**
 * The interface for the Drive Item Version Content Stream Request.
 */
public interface IDriveItemVersionContentStreamRequest extends IHttpStreamRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final byte[] fileContents, final ICallback<? super DriveItemVersion> callback);
