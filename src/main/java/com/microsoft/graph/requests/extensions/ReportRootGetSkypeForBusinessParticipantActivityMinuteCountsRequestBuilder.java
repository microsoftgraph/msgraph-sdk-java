...
public class ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public ReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final String period) {
