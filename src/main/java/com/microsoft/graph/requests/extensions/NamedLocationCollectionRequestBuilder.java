...
public class NamedLocationCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public NamedLocationCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public NamedLocationCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public NamedLocationCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new NamedLocationCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public NamedLocationRequestBuilder byId(@Nonnull final String id) {
