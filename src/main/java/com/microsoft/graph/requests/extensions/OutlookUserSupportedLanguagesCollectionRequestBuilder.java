...
public class OutlookUserSupportedLanguagesCollectionRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    @Nonnull
    public OutlookUserSupportedLanguagesCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OutlookUserSupportedLanguagesCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
