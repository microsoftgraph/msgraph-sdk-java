...
public class OAuth2PermissionGrantDeltaCollectionRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OAuth2PermissionGrantDeltaCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
