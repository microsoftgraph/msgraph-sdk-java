...
public class WorkbookWorksheetRangeRequestBuilder extends BaseFunctionRequestBuilder<WorkbookRange> {
     ...
     */
    public WorkbookWorksheetRangeRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookWorksheetRangeRequest instance
     */
    public WorkbookWorksheetRangeRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
