 ...
 */
public class UserGetMailTipsCollectionRequest extends BaseCollectionRequest<MailTips, UserGetMailTipsCollectionResponse> {
    ...
    public void post(final ICallback<? super BaseCollectionPage<MailTips>> callback) {
    ...
    public BaseCollectionPage<MailTips> post() throws ClientException {
        final UserGetMailTipsCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public BaseCollectionPage<MailTips> buildFromResponse(final UserGetMailTipsCollectionResponse response) {
        ...
        final BaseCollectionPage<MailTips> page = new BaseCollectionPage<MailTips>(response, builder);
