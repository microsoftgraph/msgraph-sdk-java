 ...
 */
public class WorkbookFunctionsChooseRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsChooseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsChooseRequest instance
     */
    public WorkbookFunctionsChooseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
