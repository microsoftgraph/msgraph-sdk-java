...
public class ManagedDeviceMobileAppConfigurationAssignmentRequest extends BaseRequest<ManagedDeviceMobileAppConfigurationAssignment> {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationAssignmentRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationAssignmentRequest count() {
        addCountOption(true);
        return this;
    }
}
