 ...
 */
public class WorkbookFunctionsTextRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsTextRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsTextRequest instance
     */
    public WorkbookFunctionsTextRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
