 ...
 */
public interface IWorkbookTableTotalRowRangeRequest extends IHttpRequest {
     ...
     */
    IWorkbookTableTotalRowRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookTableTotalRowRangeRequest expand(final String value);
