...
public class RestrictedSignInCollectionRequestBuilder extends BaseRequestBuilder implements IRestrictedSignInCollectionRequestBuilder {
     ...
     */
    public RestrictedSignInCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IRestrictedSignInCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IRestrictedSignInCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
