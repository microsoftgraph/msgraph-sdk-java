...
public interface IWorkbookFunctionsCscRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsCscRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsCscRequest instance
     */
    IWorkbookFunctionsCscRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
