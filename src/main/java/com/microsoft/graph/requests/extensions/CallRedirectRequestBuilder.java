...
public class CallRedirectRequestBuilder extends BaseActionRequestBuilder implements ICallRedirectRequestBuilder {
     ...
     */
    public CallRedirectRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<InvitationParticipantInfo> targets, final Integer timeout, final String callbackUri) {
     ...
     * @return the ICallRedirectRequest instance
     */
    public ICallRedirectRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
