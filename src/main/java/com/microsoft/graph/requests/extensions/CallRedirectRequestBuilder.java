...
public class CallRedirectRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public CallRedirectRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the CallRedirectRequest instance
     */
    public CallRedirectRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
