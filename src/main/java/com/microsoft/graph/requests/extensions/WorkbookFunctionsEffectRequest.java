...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsEffectRequest;
...
public class WorkbookFunctionsEffectRequest extends BaseWorkbookFunctionsEffectRequest implements IWorkbookFunctionsEffectRequest {
     ...
     */
    public WorkbookFunctionsEffectRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
