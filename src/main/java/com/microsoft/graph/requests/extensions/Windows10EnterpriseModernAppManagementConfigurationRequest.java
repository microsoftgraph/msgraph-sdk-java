...
public class Windows10EnterpriseModernAppManagementConfigurationRequest extends BaseRequest<Windows10EnterpriseModernAppManagementConfiguration> {
     ...
     */
    @Nonnull
    public Windows10EnterpriseModernAppManagementConfigurationRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public Windows10EnterpriseModernAppManagementConfigurationRequest count() {
        addCountOption(true);
        return this;
    }
}
