 ...
 */
public class DriveItemReferenceRequestBuilder extends BaseRequestBuilder implements IDriveItemReferenceRequestBuilder {
     ...
     */
    public DriveItemReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IDriveItemReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IDriveItemReferenceRequest instance
     */
    public IDriveItemReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DriveItemReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
