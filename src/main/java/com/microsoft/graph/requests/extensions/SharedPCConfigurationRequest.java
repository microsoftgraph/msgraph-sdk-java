...
public class SharedPCConfigurationRequest extends BaseRequest implements ISharedPCConfigurationRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public SharedPCConfiguration put(final SharedPCConfiguration newSharedPCConfiguration) throws ClientException {
     ...
     * @return the updated request
     */
     public ISharedPCConfigurationRequest orderBy(final String value) {
