...
/**
 * The class for the Conversation With Reference Request.
 */
public class ConversationWithReferenceRequest extends BaseRequest implements IConversationWithReferenceRequest {
     ...
     */
    public ConversationWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Conversation.class);
    }

    public void post(final Conversation newConversation, final IJsonBackedObject payload, final ICallback<? super Conversation> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public Conversation post(final Conversation newConversation, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IConversationWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IConversationWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IConversationWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (ConversationWithReferenceRequest)this;
    }
}
