...
public class HomeRealmDiscoveryPolicyWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public HomeRealmDiscoveryPolicyWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public HomeRealmDiscoveryPolicyWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
