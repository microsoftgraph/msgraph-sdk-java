 ...
 */
public class TeamsAsyncOperationCollectionResponse implements ICollectionResponse<TeamsAsyncOperation>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<TeamsAsyncOperation> values() {
        return value;
    }
