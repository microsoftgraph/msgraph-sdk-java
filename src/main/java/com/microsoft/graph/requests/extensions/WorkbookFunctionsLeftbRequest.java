...
public class WorkbookFunctionsLeftbRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsLeftbRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsLeftbBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsLeftbBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsLeftbRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsLeftbRequest count() {
        addCountOption(true);
        return this;
    }
