...
public class MessageReplyAllRequest extends BaseRequest<Void> {
     ...
     */
    public MessageReplyAllRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MessageReplyAllParameterSet parameters) {
