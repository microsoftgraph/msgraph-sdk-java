 ...
 */
public interface IRemoteAssistancePartnerDisconnectRequestBuilder extends IRequestBuilder {
     ...
     */
    IRemoteAssistancePartnerDisconnectRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
