...
/**
 * The class for the Teams App Installation With Reference Request.
 */
public class TeamsAppInstallationWithReferenceRequest extends BaseRequest implements ITeamsAppInstallationWithReferenceRequest {
     ...
     */
    public TeamsAppInstallationWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, TeamsAppInstallation.class);
    }

    public void post(final TeamsAppInstallation newTeamsAppInstallation, final IJsonBackedObject payload, final ICallback<? super TeamsAppInstallation> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public TeamsAppInstallation post(final TeamsAppInstallation newTeamsAppInstallation, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public ITeamsAppInstallationWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (ITeamsAppInstallationWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public ITeamsAppInstallationWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (TeamsAppInstallationWithReferenceRequest)this;
    }
}
