...
public class ReportRootGetTeamsDeviceUsageUserDetailRequest extends BaseRequest<Report> {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageUserDetailRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageUserDetailRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageUserDetailRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageUserDetailRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootGetTeamsDeviceUsageUserDetailRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
