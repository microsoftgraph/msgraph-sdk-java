...
/**
 * The interface for the Calendar Sharing Message Request.
 */
public interface ICalendarSharingMessageRequest extends IHttpRequest {
     ...
     */
    ICalendarSharingMessageRequest select(final String value);
     ...
     * @return the updated request
     */
    ICalendarSharingMessageRequest expand(final String value);
