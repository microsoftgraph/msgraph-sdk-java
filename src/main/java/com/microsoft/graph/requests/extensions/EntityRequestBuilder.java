 ...
 */
public class EntityRequestBuilder extends BaseRequestBuilder<Entity> {
     ...
     */
    @Nonnull
    public EntityRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EntityRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
