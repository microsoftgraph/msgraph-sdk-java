...
public class CertificateBasedAuthConfigurationRequestBuilder extends BaseRequestBuilder<CertificateBasedAuthConfiguration> {
     ...
     */
    public CertificateBasedAuthConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the CertificateBasedAuthConfigurationRequest instance
     */
    public CertificateBasedAuthConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
