...
/**
 * The interface for the User Scope Teams App Installation Collection Request.
 */
public interface IUserScopeTeamsAppInstallationCollectionRequest extends IHttpRequest {
     ...
     */
    IUserScopeTeamsAppInstallationCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserScopeTeamsAppInstallationCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserScopeTeamsAppInstallationCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserScopeTeamsAppInstallationCollectionRequest skip(final int value);
