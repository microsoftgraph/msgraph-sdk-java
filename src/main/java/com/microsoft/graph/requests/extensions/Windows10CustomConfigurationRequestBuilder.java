...
public class Windows10CustomConfigurationRequestBuilder extends BaseRequestBuilder<Windows10CustomConfiguration> {
     ...
     */
    public Windows10CustomConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10CustomConfigurationRequest instance
     */
    @Nonnull
    public Windows10CustomConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10CustomConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.Windows10CustomConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
