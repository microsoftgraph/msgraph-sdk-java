...
import com.microsoft.graph.requests.generated.BaseWorkbookChartPointFormatRequestBuilder;
...
public class WorkbookChartPointFormatRequestBuilder extends BaseWorkbookChartPointFormatRequestBuilder implements IWorkbookChartPointFormatRequestBuilder {
     ...
     */
    public WorkbookChartPointFormatRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
