...
public class WorkbookChartPointFormatRequestBuilder extends BaseRequestBuilder<WorkbookChartPointFormat> {
     ...
     */
    public WorkbookChartPointFormatRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookChartPointFormatRequest instance
     */
    public WorkbookChartPointFormatRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
