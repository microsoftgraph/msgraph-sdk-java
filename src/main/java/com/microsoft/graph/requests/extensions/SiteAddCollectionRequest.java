 ...
 */
public class SiteAddCollectionRequest extends BaseCollectionRequest<Site, SiteAddCollectionResponse> {
    ...
    public BaseCollectionPage<Site> buildFromResponse(final SiteAddCollectionResponse response) {
