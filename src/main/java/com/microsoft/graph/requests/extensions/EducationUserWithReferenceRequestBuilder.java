 ...
 */
public class EducationUserWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     *
     * @param requestOptions the options for this request
     * @return the EducationUserWithReferenceRequest instance
     */
    @Nonnull
    public EducationUserWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EducationUserWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new EducationUserWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public EducationUserReferenceRequestBuilder reference(){
