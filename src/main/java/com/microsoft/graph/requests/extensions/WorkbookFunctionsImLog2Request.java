 ...
 */
public class WorkbookFunctionsImLog2Request extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsImLog2Request(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsImLog2Body parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsImLog2Body body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsImLog2Request count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsImLog2Request count() {
        addCountOption(true);
        return this;
    }
