...
public class SchemaExtensionCollectionRequestBuilder extends BaseCollectionRequestBuilder<SchemaExtension, SchemaExtensionRequestBuilder, SchemaExtensionCollectionResponse, SchemaExtensionCollectionPage, SchemaExtensionCollectionRequest> {
    ...
    public SchemaExtensionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SchemaExtensionRequestBuilder.class, SchemaExtensionCollectionResponse.class, SchemaExtensionCollectionPage.class, SchemaExtensionCollectionRequest.class);
    }
