...
/**
 * The interface for the Permission Grant Policy Collection Page.
 */
public interface IPermissionGrantPolicyCollectionPage extends IBaseCollectionPage<PermissionGrantPolicy, IPermissionGrantPolicyCollectionRequestBuilder> {
}
