...
/**
 * The class for the Targeted Managed App Configuration Reference Request Builder.
 */
public class TargetedManagedAppConfigurationReferenceRequestBuilder extends BaseRequestBuilder implements ITargetedManagedAppConfigurationReferenceRequestBuilder {
     ...
     */
    public TargetedManagedAppConfigurationReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public ITargetedManagedAppConfigurationReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ITargetedManagedAppConfigurationReferenceRequest instance
     */
    public ITargetedManagedAppConfigurationReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new TargetedManagedAppConfigurationReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
