...
public class MacOSCustomConfigurationRequestBuilder extends BaseRequestBuilder<MacOSCustomConfiguration> {
     ...
     */
    public MacOSCustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the MacOSCustomConfigurationRequest instance
     */
    public MacOSCustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
