...
import com.microsoft.graph.requests.generated.BaseDomainDnsUnavailableRecordRequest;
...
public class DomainDnsUnavailableRecordRequest extends BaseDomainDnsUnavailableRecordRequest implements IDomainDnsUnavailableRecordRequest {
     ...
     */
    public DomainDnsUnavailableRecordRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
