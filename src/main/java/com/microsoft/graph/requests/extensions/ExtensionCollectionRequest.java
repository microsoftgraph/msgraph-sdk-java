...
public class ExtensionCollectionRequest extends BaseCollectionRequest<ExtensionCollectionResponse, ExtensionCollectionPage> {
    ...
    public void get(final ICallback<? super ExtensionCollectionPage> callback) {
    ...
    public ExtensionCollectionPage buildFromResponse(final ExtensionCollectionResponse response) {
