...
public class WorkbookTableSortApplyRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public WorkbookTableSortApplyRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookTableSortApplyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableSortApplyRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookTableSortApplyRequest expand(@Nonnull final String value) {
