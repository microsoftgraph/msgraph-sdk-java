...
public class WorkbookTableSortApplyRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookTableSortApplyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookTableSortApplyBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookTableSortApplyBody body;
    /**
