...
public class IosUpdateDeviceStatusCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public IosUpdateDeviceStatusCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public IosUpdateDeviceStatusCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosUpdateDeviceStatusCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new IosUpdateDeviceStatusCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public IosUpdateDeviceStatusRequestBuilder byId(@Nonnull final String id) {
