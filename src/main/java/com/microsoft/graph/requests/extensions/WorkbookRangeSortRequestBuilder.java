...
public class WorkbookRangeSortRequestBuilder extends BaseRequestBuilder<WorkbookRangeSort> {
     ...
     */
    @Nonnull
    public WorkbookRangeSortApplyRequestBuilder apply(@Nonnull final WorkbookRangeSortApplyParameterSet parameters) {
        return new WorkbookRangeSortApplyRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.apply"), getClient(), null, parameters);
    }
}
