...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsFisherRequestBuilder;
...
public class WorkbookFunctionsFisherRequestBuilder extends BaseWorkbookFunctionsFisherRequestBuilder implements IWorkbookFunctionsFisherRequestBuilder {
     ...
     * @param x the x
     */
    public WorkbookFunctionsFisherRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.google.gson.JsonElement x) {
