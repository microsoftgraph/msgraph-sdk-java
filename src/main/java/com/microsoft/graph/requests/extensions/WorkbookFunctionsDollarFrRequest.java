 ...
 */
public class WorkbookFunctionsDollarFrRequest extends BaseRequest implements IWorkbookFunctionsDollarFrRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDollarFrRequest orderBy(final String value) {
