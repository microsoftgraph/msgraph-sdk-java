...
public class TeamsAppDefinitionWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public TeamsAppDefinitionWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TeamsAppDefinitionWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
