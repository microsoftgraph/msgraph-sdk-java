...
public class DomainForceDeleteRequest extends BaseRequest<Void> {
     ...
     */
    public DomainForceDeleteRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DomainForceDeleteBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected DomainForceDeleteBody body;
    /**
