 ...
 */
public interface IReportRootGetTeamsDeviceUsageDistributionUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetTeamsDeviceUsageDistributionUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetTeamsDeviceUsageDistributionUserCountsRequest expand(final String value);
