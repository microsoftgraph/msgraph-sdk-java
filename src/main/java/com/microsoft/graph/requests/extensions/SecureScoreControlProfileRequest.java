 ...
 */
public class SecureScoreControlProfileRequest extends BaseRequest<SecureScoreControlProfile> {
     ...
     */
    @Nonnull
    public SecureScoreControlProfileRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public SecureScoreControlProfileRequest count() {
        addCountOption(true);
        return this;
    }
}
