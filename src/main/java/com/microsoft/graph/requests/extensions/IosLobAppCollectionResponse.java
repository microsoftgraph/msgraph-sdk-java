 ...
 */
public class IosLobAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IosLobApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IosLobApp> value;
