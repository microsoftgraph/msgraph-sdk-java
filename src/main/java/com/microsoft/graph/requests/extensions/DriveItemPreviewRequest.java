...
public class DriveItemPreviewRequest extends BaseRequest<ItemPreviewInfo> {
     ...
     */
    public DriveItemPreviewRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DriveItemPreviewParameterSet parameters) {
