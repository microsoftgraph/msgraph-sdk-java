...
public class ServicePrincipalRequestBuilder extends BaseRequestBuilder<ServicePrincipal> {
     ...
     */
    @Nonnull
    public ServicePrincipalAddKeyRequestBuilder addKey(@Nonnull final ServicePrincipalAddKeyBody parameters) {
     ...
     */
    @Nonnull
    public ServicePrincipalAddPasswordRequestBuilder addPassword(@Nonnull final ServicePrincipalAddPasswordBody parameters) {
     ...
     */
    @Nonnull
    public ServicePrincipalRemoveKeyRequestBuilder removeKey(@Nonnull final ServicePrincipalRemoveKeyBody parameters) {
     ...
     */
    @Nonnull
    public ServicePrincipalRemovePasswordRequestBuilder removePassword(@Nonnull final ServicePrincipalRemovePasswordBody parameters) {
