...
public class WorkbookFunctionsOddFYieldRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsOddFYieldBody body;
    /**
     ...
     */
    public WorkbookFunctionsOddFYieldRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsOddFYieldBody parameters) {
