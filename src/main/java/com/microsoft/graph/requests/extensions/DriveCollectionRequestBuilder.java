...
public class DriveCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public DriveCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DriveCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DriveCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public DriveRequestBuilder byId(@Nonnull final String id) {
