...
public class PlannerPlanCollectionRequestBuilder extends BaseCollectionRequestBuilder<PlannerPlan, PlannerPlanRequestBuilder, PlannerPlanCollectionResponse, PlannerPlanCollectionPage, PlannerPlanCollectionRequest> {
    ...
    public PlannerPlanCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PlannerPlanRequestBuilder.class, PlannerPlanCollectionResponse.class, PlannerPlanCollectionPage.class, PlannerPlanCollectionRequest.class);
    }
