...
public class PlannerPlanCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public PlannerPlanCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PlannerPlanCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerPlanCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public PlannerPlanRequestBuilder byId(@Nonnull final String id) {
