...
public class WorkbookFunctionsDec2HexRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDec2HexRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDec2HexParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsDec2HexParameterSet body;
    /**
