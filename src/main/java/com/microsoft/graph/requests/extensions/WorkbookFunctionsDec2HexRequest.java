...
public class WorkbookFunctionsDec2HexRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDec2HexRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDec2HexBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsDec2HexBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsDec2HexRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsDec2HexRequest count() {
        addCountOption(true);
        return this;
    }
