...
public class WorkbookRangeMergeRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookRangeMergeRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookRangeMergeParameterSet parameters) {
