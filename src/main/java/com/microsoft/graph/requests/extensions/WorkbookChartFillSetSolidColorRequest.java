...
public class WorkbookChartFillSetSolidColorRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartFillSetSolidColorRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookChartFillSetSolidColorRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookChartFillSetSolidColorRequest count() {
        addCountOption(true);
        return this;
    }
    /**
