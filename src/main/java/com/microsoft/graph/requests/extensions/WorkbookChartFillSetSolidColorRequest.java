...
public class WorkbookChartFillSetSolidColorRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartFillSetSolidColorRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartFillSetSolidColorBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookChartFillSetSolidColorBody body;
    /**
