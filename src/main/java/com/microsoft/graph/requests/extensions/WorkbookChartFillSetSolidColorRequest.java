...
public class WorkbookChartFillSetSolidColorRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartFillSetSolidColorRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartFillSetSolidColorParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookChartFillSetSolidColorParameterSet body;
    /**
     * Creates the WorkbookChartFillSetSolidColor
     *
