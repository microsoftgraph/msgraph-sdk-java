 ...
 */
public class LocalizedNotificationMessageCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public LocalizedNotificationMessageCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public LocalizedNotificationMessageCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new LocalizedNotificationMessageCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public LocalizedNotificationMessageRequestBuilder byId(@Nonnull final String id) {
