 ...
 */
public class PermissionGrantPolicyCollectionRequest extends BaseCollectionRequest<PermissionGrantPolicy, PermissionGrantPolicyCollectionResponse> {
    ...
    public BaseCollectionPage<PermissionGrantPolicy> get() throws ClientException {
    ...
    public BaseCollectionPage<PermissionGrantPolicy> buildFromResponse(final PermissionGrantPolicyCollectionResponse response) {
        ...
        final BaseCollectionPage<PermissionGrantPolicy> page = new BaseCollectionPage<PermissionGrantPolicy>(response, builder);
