...
public class DriveItemRestoreRequestBuilder extends BaseActionRequestBuilder implements IDriveItemRestoreRequestBuilder {
     ...
     * @param name the name
     */
    public DriveItemRestoreRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final ItemReference parentReference, final String name) {
     ...
     * @return the IDriveItemRestoreRequest instance
     */
    public IDriveItemRestoreRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
