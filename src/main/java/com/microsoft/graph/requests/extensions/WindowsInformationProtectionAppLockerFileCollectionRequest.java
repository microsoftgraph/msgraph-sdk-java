 ...
 */
public class WindowsInformationProtectionAppLockerFileCollectionRequest extends BaseCollectionRequest<WindowsInformationProtectionAppLockerFileCollectionResponse, WindowsInformationProtectionAppLockerFileCollectionPage> {
    ...
    public WindowsInformationProtectionAppLockerFileCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsInformationProtectionAppLockerFileCollectionResponse.class, WindowsInformationProtectionAppLockerFileCollectionPage.class);
    }

    public void get(final ICallback<? super WindowsInformationProtectionAppLockerFileCollectionPage> callback) {
    ...
    public WindowsInformationProtectionAppLockerFileCollectionPage get() throws ClientException {
     ...
     */
    public WindowsInformationProtectionAppLockerFileCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public WindowsInformationProtectionAppLockerFileCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public WindowsInformationProtectionAppLockerFileCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public WindowsInformationProtectionAppLockerFileCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WindowsInformationProtectionAppLockerFileCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (WindowsInformationProtectionAppLockerFileCollectionRequest)this;
    }
    public WindowsInformationProtectionAppLockerFileCollectionPage buildFromResponse(final WindowsInformationProtectionAppLockerFileCollectionResponse response) {
        final WindowsInformationProtectionAppLockerFileCollectionRequestBuilder builder;
