...
public class WindowsInformationProtectionAppLockerFileCollectionRequest extends BaseCollectionRequest<WindowsInformationProtectionAppLockerFileCollectionResponse, WindowsInformationProtectionAppLockerFileCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super WindowsInformationProtectionAppLockerFileCollectionPage> callback) {
    ...
    @Nonnull
    public WindowsInformationProtectionAppLockerFileCollectionPage buildFromResponse(@Nonnull final WindowsInformationProtectionAppLockerFileCollectionResponse response) {
