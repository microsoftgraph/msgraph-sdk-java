 ...
 */
public class WorkbookFunctionsZ_TestRequest extends BaseRequest implements IWorkbookFunctionsZ_TestRequest {
     ...
     */
    public IWorkbookFunctionsZ_TestRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsZ_TestRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsZ_TestRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsZ_TestRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsZ_TestRequest orderBy(final String value) {
