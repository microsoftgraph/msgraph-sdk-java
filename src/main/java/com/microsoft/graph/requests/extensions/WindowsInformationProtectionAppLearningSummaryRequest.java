...
public class WindowsInformationProtectionAppLearningSummaryRequest extends BaseRequest<WindowsInformationProtectionAppLearningSummary> {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WindowsInformationProtectionAppLearningSummaryRequest count() {
        addCountOption(true);
        return this;
    }
}
