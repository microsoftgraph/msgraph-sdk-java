...
public class Windows81GeneralConfigurationRequestBuilder extends BaseRequestBuilder<Windows81GeneralConfiguration> {
     ...
     */
    public Windows81GeneralConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the Windows81GeneralConfigurationRequest instance
     */
    public Windows81GeneralConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
