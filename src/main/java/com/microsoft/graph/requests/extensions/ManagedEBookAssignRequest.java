...
public class ManagedEBookAssignRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedEBookAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedEBookAssignParameterSet parameters) {
