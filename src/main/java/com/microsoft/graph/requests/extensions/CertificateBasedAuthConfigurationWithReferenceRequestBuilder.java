...
public class CertificateBasedAuthConfigurationWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public CertificateBasedAuthConfigurationWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public CertificateBasedAuthConfigurationWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
