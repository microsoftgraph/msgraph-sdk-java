...
public class AttachmentCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public AttachmentCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AttachmentCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new AttachmentCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public AttachmentRequestBuilder byId(@Nonnull final String id) {
