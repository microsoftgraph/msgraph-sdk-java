...
import com.microsoft.graph.requests.generated.BaseInferenceClassificationOverrideCollectionRequest;
...
public class InferenceClassificationOverrideCollectionRequest extends BaseInferenceClassificationOverrideCollectionRequest implements IInferenceClassificationOverrideCollectionRequest {
     ...
     */
    public InferenceClassificationOverrideCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
