...
public class InferenceClassificationOverrideCollectionRequest extends BaseCollectionRequest<InferenceClassificationOverrideCollectionResponse, InferenceClassificationOverrideCollectionPage> {
    ...
    public void get(final ICallback<? super InferenceClassificationOverrideCollectionPage> callback) {
    ...
    public InferenceClassificationOverrideCollectionPage buildFromResponse(final InferenceClassificationOverrideCollectionResponse response) {
