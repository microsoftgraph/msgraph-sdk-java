...
public class TargetedManagedAppConfigurationRequestBuilder extends BaseRequestBuilder<TargetedManagedAppConfiguration> {
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationAssignRequestBuilder assign(@Nonnull final TargetedManagedAppConfigurationAssignBody parameters) {
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationTargetAppsRequestBuilder targetApps(@Nonnull final TargetedManagedAppConfigurationTargetAppsBody parameters) {
