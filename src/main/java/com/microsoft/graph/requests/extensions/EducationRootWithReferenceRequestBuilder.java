...
/**
 * The class for the Education Root With Reference Request Builder.
 */
public class EducationRootWithReferenceRequestBuilder extends BaseRequestBuilder implements IEducationRootWithReferenceRequestBuilder {
     ...
     */
    public EducationRootWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IEducationRootWithReferenceRequest instance
     */
    public IEducationRootWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IEducationRootWithReferenceRequest instance
     */
    public IEducationRootWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new EducationRootWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IEducationRootReferenceRequestBuilder reference(){
        return new EducationRootReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
