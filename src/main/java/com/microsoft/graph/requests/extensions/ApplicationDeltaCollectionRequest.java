...
public class ApplicationDeltaCollectionRequest extends BaseDeltaCollectionRequest<Application, ApplicationDeltaCollectionResponse, ApplicationDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public ApplicationDeltaCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ApplicationDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public ApplicationDeltaCollectionRequest skipToken(@Nonnull final String skipToken) {
     ...
     */
    @Nonnull
    public ApplicationDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public ApplicationDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
