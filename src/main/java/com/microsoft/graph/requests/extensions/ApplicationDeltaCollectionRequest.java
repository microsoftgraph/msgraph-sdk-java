 ...
 */
public class ApplicationDeltaCollectionRequest extends BaseCollectionRequest<Application, ApplicationDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<Application> buildFromResponse(final ApplicationDeltaCollectionResponse response) {
