...
/**
 * The interface for the Device Configuration Reference Request Builder.
 */
public interface IDeviceConfigurationReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceConfigurationReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceConfigurationReferenceRequest instance
     */
    IDeviceConfigurationReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
