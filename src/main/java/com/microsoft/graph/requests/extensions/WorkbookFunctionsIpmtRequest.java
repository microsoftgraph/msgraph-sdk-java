 ...
 */
public class WorkbookFunctionsIpmtRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsIpmtRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsIpmtRequest expand(final String value) {
