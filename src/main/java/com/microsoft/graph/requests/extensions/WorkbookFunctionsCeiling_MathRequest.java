...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsCeiling_MathRequest;
...
public class WorkbookFunctionsCeiling_MathRequest extends BaseWorkbookFunctionsCeiling_MathRequest implements IWorkbookFunctionsCeiling_MathRequest {
     ...
     */
    public WorkbookFunctionsCeiling_MathRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
