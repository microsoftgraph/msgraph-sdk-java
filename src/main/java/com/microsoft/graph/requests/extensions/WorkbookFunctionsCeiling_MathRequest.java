 ...
 */
public class WorkbookFunctionsCeiling_MathRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsCeiling_MathRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsCeiling_MathRequest expand(final String value) {
