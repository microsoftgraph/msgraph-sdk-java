...
public class WorkbookFunctionsCeiling_MathRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsCeiling_MathRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsCeiling_MathParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsCeiling_MathParameterSet body;
    /**
