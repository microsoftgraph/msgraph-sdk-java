...
public class PlannerTaskCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public PlannerTaskCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PlannerTaskCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerTaskCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public PlannerTaskRequestBuilder byId(@Nonnull final String id) {
