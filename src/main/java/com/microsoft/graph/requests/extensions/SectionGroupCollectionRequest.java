...
public class SectionGroupCollectionRequest extends BaseCollectionRequest<SectionGroupCollectionResponse, SectionGroupCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super SectionGroupCollectionPage> callback) {
    ...
    @Nonnull
    public SectionGroupCollectionPage buildFromResponse(@Nonnull final SectionGroupCollectionResponse response) {
