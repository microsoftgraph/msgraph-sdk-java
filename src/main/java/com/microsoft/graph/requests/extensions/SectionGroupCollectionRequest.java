 ...
 */
public class SectionGroupCollectionRequest extends BaseCollectionRequest<SectionGroupCollectionResponse, SectionGroupCollectionPage> {
    ...
    public SectionGroupCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SectionGroupCollectionResponse.class, SectionGroupCollectionPage.class);
    }

    public void get(final ICallback<? super SectionGroupCollectionPage> callback) {
    ...
    public SectionGroupCollectionPage get() throws ClientException {
     ...
     */
    public SectionGroupCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public SectionGroupCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public SectionGroupCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public SectionGroupCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public SectionGroupCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (SectionGroupCollectionRequest)this;
    }
    public SectionGroupCollectionPage buildFromResponse(final SectionGroupCollectionResponse response) {
        final SectionGroupCollectionRequestBuilder builder;
