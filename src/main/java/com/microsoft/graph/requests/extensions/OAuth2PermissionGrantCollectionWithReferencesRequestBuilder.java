...
public class OAuth2PermissionGrantCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IOAuth2PermissionGrantCollectionWithReferencesRequestBuilder {
     ...
     */
    public OAuth2PermissionGrantCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IOAuth2PermissionGrantCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
