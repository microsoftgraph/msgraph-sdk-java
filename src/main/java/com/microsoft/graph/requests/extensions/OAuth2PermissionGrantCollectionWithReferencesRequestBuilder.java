...
public class OAuth2PermissionGrantCollectionWithReferencesRequestBuilder extends BaseCollectionWithReferencesRequestBuilder<OAuth2PermissionGrant, OAuth2PermissionGrantWithReferenceRequest, OAuth2PermissionGrantReferenceRequestBuilder, OAuth2PermissionGrantWithReferenceRequestBuilder, OAuth2PermissionGrantCollectionResponse, OAuth2PermissionGrantCollectionWithReferencesRequest, OAuth2PermissionGrantCollectionWithReferencesRequest> {
    ...
    public OAuth2PermissionGrantCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OAuth2PermissionGrantWithReferenceRequestBuilder.class, OAuth2PermissionGrantCollectionWithReferencesRequest.class, OAuth2PermissionGrantCollectionWithReferencesRequest.class);
    }
}
