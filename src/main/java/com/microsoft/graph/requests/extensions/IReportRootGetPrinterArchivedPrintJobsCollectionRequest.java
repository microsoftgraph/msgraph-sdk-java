...
public interface IReportRootGetPrinterArchivedPrintJobsCollectionRequest extends IHttpRequest {
     ...
     */
    IReportRootGetPrinterArchivedPrintJobsCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetPrinterArchivedPrintJobsCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetPrinterArchivedPrintJobsCollectionRequest top(final int value);
