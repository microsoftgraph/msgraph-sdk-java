...
public class Windows10GeneralConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public Windows10GeneralConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public Windows10GeneralConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the Windows10GeneralConfigurationRequest instance
     */
    public Windows10GeneralConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
