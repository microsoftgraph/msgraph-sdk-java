...
public class WindowsPhone81GeneralConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WindowsPhone81GeneralConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WindowsPhone81GeneralConfigurationRequest instance
     */
    public WindowsPhone81GeneralConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
