 ...
 */
public class SiteRemoveCollectionRequest extends BaseActionCollectionRequest<Site, SiteRemoveCollectionResponse, SiteRemoveCollectionPage> {
     ...
     */
    @Nonnull
    public SiteRemoveCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public SiteRemoveCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
