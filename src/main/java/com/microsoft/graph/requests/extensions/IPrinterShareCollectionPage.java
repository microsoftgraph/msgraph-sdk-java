...
/**
 * The interface for the Printer Share Collection Page.
 */
public interface IPrinterShareCollectionPage extends IBaseCollectionPage<PrinterShare, IPrinterShareCollectionRequestBuilder> {
}
