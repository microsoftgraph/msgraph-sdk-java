 ...
 */
public class WorkbookFunctionsDegreesRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsDegreesRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsDegreesRequest instance
     */
    public WorkbookFunctionsDegreesRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
