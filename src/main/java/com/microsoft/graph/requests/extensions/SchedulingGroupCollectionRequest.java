...
public class SchedulingGroupCollectionRequest extends BaseCollectionRequest<SchedulingGroupCollectionResponse, ISchedulingGroupCollectionPage> implements ISchedulingGroupCollectionRequest {
     ...
     */
    public SchedulingGroupCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public ISchedulingGroupCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ISchedulingGroupCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ISchedulingGroupCollectionRequest top(final int value) {
