 ...
 */
public class TargetedManagedAppConfigurationAssignRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationAssignRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationAssignRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationAssignRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationAssignRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public TargetedManagedAppConfigurationAssignRequest expand(@Nonnull final String value) {
