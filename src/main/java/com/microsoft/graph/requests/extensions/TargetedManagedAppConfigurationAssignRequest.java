...
public class TargetedManagedAppConfigurationAssignRequest extends BaseRequest<Void> {
     ...
     */
    public TargetedManagedAppConfigurationAssignRequest select(final String value) {
     ...
     * @return the updated request
     */
    public TargetedManagedAppConfigurationAssignRequest expand(final String value) {
