...
public class TargetedManagedAppConfigurationAssignRequest extends BaseRequest<Void> {
     ...
     */
    public TargetedManagedAppConfigurationAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TargetedManagedAppConfigurationAssignBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected TargetedManagedAppConfigurationAssignBody body;
    /**
