 ...
 */
public class WorkbookFunctionsUpperRequest extends BaseRequest implements IWorkbookFunctionsUpperRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsUpperRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsUpperRequest orderBy(final String value) {
