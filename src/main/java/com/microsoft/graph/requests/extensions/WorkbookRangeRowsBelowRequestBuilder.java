...
public class WorkbookRangeRowsBelowRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public WorkbookRangeRowsBelowRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final Integer count) {
        super(requestUrl, client, requestOptions);
