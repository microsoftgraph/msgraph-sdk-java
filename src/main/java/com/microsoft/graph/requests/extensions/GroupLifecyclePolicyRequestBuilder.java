...
public class GroupLifecyclePolicyRequestBuilder extends BaseRequestBuilder<GroupLifecyclePolicy> {
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyAddGroupRequestBuilder addGroup(@Nonnull final GroupLifecyclePolicyAddGroupBody parameters) {
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyRemoveGroupRequestBuilder removeGroup(@Nonnull final GroupLifecyclePolicyRemoveGroupBody parameters) {
