 ...
 */
public class DeviceComplianceActionItemCollectionRequestBuilder extends BaseCollectionRequestBuilder<DeviceComplianceActionItem, DeviceComplianceActionItemRequestBuilder, DeviceComplianceActionItemCollectionResponse, DeviceComplianceActionItemCollectionPage, DeviceComplianceActionItemCollectionRequest> {
    ...
    public DeviceComplianceActionItemCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceComplianceActionItemRequestBuilder.class, DeviceComplianceActionItemCollectionResponse.class, DeviceComplianceActionItemCollectionPage.class, DeviceComplianceActionItemCollectionRequest.class);
    }
