...
/**
 * The interface for the Agreement Acceptance Collection Page.
 */
public interface IAgreementAcceptanceCollectionPage extends IBaseCollectionPage<AgreementAcceptance, IAgreementAcceptanceCollectionRequestBuilder> {
}
