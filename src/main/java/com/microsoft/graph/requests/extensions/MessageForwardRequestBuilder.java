...
public class MessageForwardRequestBuilder extends BaseActionRequestBuilder implements IMessageForwardRequestBuilder {
     ...
     */
    public MessageForwardRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<Recipient> toRecipients, final String comment) {
