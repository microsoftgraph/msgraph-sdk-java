...
import com.microsoft.graph.requests.generated.BasePermissionRequest;
...
public class PermissionRequest extends BasePermissionRequest implements IPermissionRequest {
     ...
     */
    public PermissionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
