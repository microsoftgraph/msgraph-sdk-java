...
public class TimeOffCollectionRequestBuilder extends BaseRequestBuilder implements ITimeOffCollectionRequestBuilder {
     ...
     */
    public TimeOffCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITimeOffCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
