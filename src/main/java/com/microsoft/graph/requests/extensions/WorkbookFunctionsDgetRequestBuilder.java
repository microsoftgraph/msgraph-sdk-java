 ...
 */
public class WorkbookFunctionsDgetRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsDgetRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsDgetRequest instance
     */
    public WorkbookFunctionsDgetRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
