 ...
 */
public class DirectoryObjectCollectionRequest extends BaseCollectionRequest<DirectoryObjectCollectionResponse, DirectoryObjectCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super DirectoryObjectCollectionPage> callback) {
    ...
    @Nonnull
    public DirectoryObjectCollectionPage get() throws ClientException {
    ...
    @Nonnull
    public DirectoryObjectCollectionPage buildFromResponse(@Nonnull final DirectoryObjectCollectionResponse response) {
