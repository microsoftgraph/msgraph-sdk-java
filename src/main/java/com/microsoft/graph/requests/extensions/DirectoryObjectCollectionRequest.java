...
public class DirectoryObjectCollectionRequest extends BaseCollectionRequest<DirectoryObjectCollectionResponse, DirectoryObjectCollectionPage> {
    ...
    public void get(final ICallback<? super DirectoryObjectCollectionPage> callback) {
    ...
    public DirectoryObjectCollectionPage buildFromResponse(final DirectoryObjectCollectionResponse response) {
