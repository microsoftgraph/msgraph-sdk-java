 ...
 */
public class NotificationMessageTemplateCollectionResponse implements ICollectionResponse<NotificationMessageTemplate>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<NotificationMessageTemplate> values() {
        return value;
    }
