 ...
 */
public interface IWorkbookFunctionsDsumRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsDsumRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
