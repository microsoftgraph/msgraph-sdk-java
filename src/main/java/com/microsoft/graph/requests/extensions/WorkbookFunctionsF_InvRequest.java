...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsF_InvRequest;
...
public class WorkbookFunctionsF_InvRequest extends BaseWorkbookFunctionsF_InvRequest implements IWorkbookFunctionsF_InvRequest {
     ...
     */
    public WorkbookFunctionsF_InvRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
