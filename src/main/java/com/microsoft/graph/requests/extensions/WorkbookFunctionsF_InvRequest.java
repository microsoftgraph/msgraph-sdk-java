 ...
 */
public class WorkbookFunctionsF_InvRequest extends BaseRequest implements IWorkbookFunctionsF_InvRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsF_InvRequest orderBy(final String value) {
