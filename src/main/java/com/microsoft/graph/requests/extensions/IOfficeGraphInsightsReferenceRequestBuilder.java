...
/**
 * The interface for the Office Graph Insights Reference Request Builder.
 */
public interface IOfficeGraphInsightsReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IOfficeGraphInsightsReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOfficeGraphInsightsReferenceRequest instance
     */
    IOfficeGraphInsightsReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
