...
/**
 * The class for the Planner Plan Reference Request Builder.
 */
public class PlannerPlanReferenceRequestBuilder extends BaseRequestBuilder implements IPlannerPlanReferenceRequestBuilder {
     ...
     */
    public PlannerPlanReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return The IPlannerPlanReferenceRequest instance
     */
    public IPlannerPlanReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPlannerPlanReferenceRequest instance
     */
    public IPlannerPlanReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerPlanReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
