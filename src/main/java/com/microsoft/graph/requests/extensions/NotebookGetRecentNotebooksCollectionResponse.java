 ...
 */
public class NotebookGetRecentNotebooksCollectionResponse implements ICollectionResponse<RecentNotebook>, IJsonBackedObject {

    /**
     * The list of RecentNotebook within this collection page
     */
     ...
     */
    @Override
    public java.util.List<RecentNotebook> values() {
        return value;
    }
