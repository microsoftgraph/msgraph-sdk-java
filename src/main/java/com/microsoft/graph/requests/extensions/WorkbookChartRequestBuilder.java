...
public class WorkbookChartRequestBuilder extends BaseRequestBuilder<WorkbookChart> {
     ...
     */
    @Nonnull
    public WorkbookChartSetDataRequestBuilder setData(@Nonnull final WorkbookChartSetDataBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookChartSetPositionRequestBuilder setPosition(@Nonnull final WorkbookChartSetPositionBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookChartImageRequestBuilder image(@Nonnull final WorkbookChartImageBody parameters) {
