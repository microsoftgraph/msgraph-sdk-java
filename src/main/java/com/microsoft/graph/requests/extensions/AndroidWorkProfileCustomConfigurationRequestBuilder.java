...
public class AndroidWorkProfileCustomConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileCustomConfiguration> {
     ...
     */
    public AndroidWorkProfileCustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the AndroidWorkProfileCustomConfigurationRequest instance
     */
    public AndroidWorkProfileCustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
