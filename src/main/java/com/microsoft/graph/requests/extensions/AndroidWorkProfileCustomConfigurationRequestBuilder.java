 ...
 */
public class AndroidWorkProfileCustomConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileCustomConfiguration> {
     ...
     */
    public AndroidWorkProfileCustomConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileCustomConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileCustomConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileCustomConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileCustomConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
