...
public class UserExportPersonalDataRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public UserExportPersonalDataRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public UserExportPersonalDataRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public UserExportPersonalDataRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public UserExportPersonalDataRequest expand(@Nonnull final String value) {
