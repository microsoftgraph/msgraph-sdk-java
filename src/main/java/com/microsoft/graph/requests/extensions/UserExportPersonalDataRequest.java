...
public class UserExportPersonalDataRequest extends BaseRequest<Void> {
     ...
     */
    public UserExportPersonalDataRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserExportPersonalDataBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected UserExportPersonalDataBody body;
    /**
