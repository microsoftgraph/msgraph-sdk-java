...
public class EditionUpgradeConfigurationRequestBuilder extends BaseRequestBuilder<EditionUpgradeConfiguration> {
     ...
     */
    public EditionUpgradeConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the EditionUpgradeConfigurationRequest instance
     */
    public EditionUpgradeConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
