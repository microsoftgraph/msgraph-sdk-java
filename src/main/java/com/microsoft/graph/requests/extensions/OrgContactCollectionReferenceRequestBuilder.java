 ...
 */
public class OrgContactCollectionReferenceRequestBuilder extends BaseCollectionReferenceRequestBuilder<OrgContact, OrgContactCollectionResponse, OrgContactCollectionReferenceRequest> {
    ...
    public OrgContactCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OrgContactCollectionReferenceRequest.class);
    }
}
