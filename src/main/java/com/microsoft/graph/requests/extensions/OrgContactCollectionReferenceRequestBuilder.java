...
public class OrgContactCollectionReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public OrgContactCollectionReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OrgContactCollectionReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
