...
public interface IProfilePhotoStreamRequestBuilder extends IRequestBuilder {
     ...
     */
    IProfilePhotoStreamRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IProfilePhotoStreamRequest instance
     */
    IProfilePhotoStreamRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
