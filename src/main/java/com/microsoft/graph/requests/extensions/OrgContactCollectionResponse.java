 ...
 */
public class OrgContactCollectionResponse implements ICollectionResponse<OrgContact>, IJsonBackedObject {

    /**
     * The list of OrgContact within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OrgContact> value;

    /**
     * The list of OrgContact within this collection page
     */
    @Override
    public java.util.List<OrgContact> values() {
        return value;
    }
