...
/**
 * The interface for the Open Shift Collection Page.
 */
public interface IOpenShiftCollectionPage extends IBaseCollectionPage<OpenShift, IOpenShiftCollectionRequestBuilder> {
}
