...
public class ApplicationAddKeyRequest extends BaseRequest<KeyCredential> {
     ...
     */
    public ApplicationAddKeyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ApplicationAddKeyBody parameters) {
        super(requestUrl, client, requestOptions, KeyCredential.class);
        body = parameters;
    }

	/** The body for the method */
    protected ApplicationAddKeyBody body;
    /**
     ...
     */
    @Nonnull
    public ApplicationAddKeyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ApplicationAddKeyRequest count() {
        addCountOption(true);
        return this;
    }
