...
public class WindowsInformationProtectionPolicyCollectionRequestBuilder extends BaseCollectionRequestBuilder<WindowsInformationProtectionPolicy, WindowsInformationProtectionPolicyRequestBuilder, WindowsInformationProtectionPolicyCollectionResponse, WindowsInformationProtectionPolicyCollectionPage, WindowsInformationProtectionPolicyCollectionRequest> {
    ...
    public WindowsInformationProtectionPolicyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsInformationProtectionPolicyRequestBuilder.class, WindowsInformationProtectionPolicyCollectionResponse.class, WindowsInformationProtectionPolicyCollectionPage.class, WindowsInformationProtectionPolicyCollectionRequest.class);
    }
