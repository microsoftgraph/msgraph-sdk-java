 ...
 */
public class WorkbookFunctionsStDev_PRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsStDev_PRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsStDev_PBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsStDev_PBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsStDev_PRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsStDev_PRequest count() {
        addCountOption(true);
        return this;
    }
