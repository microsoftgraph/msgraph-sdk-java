...
public class WorkbookFunctionsStDev_PRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsStDev_PRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsStDev_PParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsStDev_PParameterSet body;
    /**
