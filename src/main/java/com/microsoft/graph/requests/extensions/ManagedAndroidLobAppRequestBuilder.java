 ...
 */
public class ManagedAndroidLobAppRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ManagedAndroidLobAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ManagedAndroidLobAppRequest instance
     */
    public ManagedAndroidLobAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
