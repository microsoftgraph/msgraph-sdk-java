 ...
 */
public class GroupSettingTemplateCollectionResponse implements ICollectionResponse<GroupSettingTemplate>, IJsonBackedObject {

    /**
     * The list of GroupSettingTemplate within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<GroupSettingTemplate> value;

    /**
     * The list of GroupSettingTemplate within this collection page
     */
    @Override
    public java.util.List<GroupSettingTemplate> values() {
        return value;
    }
