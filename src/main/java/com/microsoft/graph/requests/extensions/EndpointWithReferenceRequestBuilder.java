...
public class EndpointWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public EndpointWithReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EndpointWithReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
