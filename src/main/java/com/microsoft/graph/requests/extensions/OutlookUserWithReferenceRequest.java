...
/**
 * The class for the Outlook User With Reference Request.
 */
public class OutlookUserWithReferenceRequest extends BaseRequest implements IOutlookUserWithReferenceRequest {
     ...
     */
    public OutlookUserWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OutlookUser.class);
    }

    public void post(final OutlookUser newOutlookUser, final IJsonBackedObject payload, final ICallback<? super OutlookUser> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public OutlookUser post(final OutlookUser newOutlookUser, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newOutlookUser;
        }
        return null;
    }
     ...
     */
    public IOutlookUserWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IOutlookUserWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IOutlookUserWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (OutlookUserWithReferenceRequest)this;
    }
}
