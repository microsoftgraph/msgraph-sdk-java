 ...
 */
public class WorkbookFunctionsOct2HexRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsOct2HexRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsOct2HexRequest expand(final String value) {
