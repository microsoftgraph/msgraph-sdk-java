 ...
 */
public interface IReportRootGetTeamsDeviceUsageUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetTeamsDeviceUsageUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetTeamsDeviceUsageUserCountsRequest expand(final String value);
