...
public class WorkbookFunctionsMroundRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsMroundBody body;
    /**
     ...
     */
    public WorkbookFunctionsMroundRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMroundBody parameters) {
