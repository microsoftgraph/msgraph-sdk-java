...
public class CallAnswerRequest extends BaseRequest<Void> {
     ...
     */
    public CallAnswerRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallAnswerParameterSet parameters) {
