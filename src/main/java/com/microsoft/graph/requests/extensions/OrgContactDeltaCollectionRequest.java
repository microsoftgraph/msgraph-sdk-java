...
public class OrgContactDeltaCollectionRequest extends BaseDeltaCollectionRequest<OrgContact, OrgContactDeltaCollectionResponse, OrgContactDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public OrgContactDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public OrgContactDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
