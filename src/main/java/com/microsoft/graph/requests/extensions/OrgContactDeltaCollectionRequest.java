 ...
 */
public class OrgContactDeltaCollectionRequest extends BaseCollectionRequest<OrgContact, OrgContactDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<OrgContact> buildFromResponse(final OrgContactDeltaCollectionResponse response) {
