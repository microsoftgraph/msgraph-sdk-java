 ...
 */
public class TermsAndConditionsCollectionResponse implements ICollectionResponse<TermsAndConditions>, IJsonBackedObject {

    /**
     * The list of TermsAndConditions within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TermsAndConditions> value;

    /**
     * The list of TermsAndConditions within this collection page
     */
    @Override
    public java.util.List<TermsAndConditions> values() {
        return value;
    }
