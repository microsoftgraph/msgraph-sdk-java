...
public class ManagedDeviceMobileAppConfigurationUserStatusRequest extends BaseRequest implements IManagedDeviceMobileAppConfigurationUserStatusRequest {
     ...
     * @return the updated request
     */
     public IManagedDeviceMobileAppConfigurationUserStatusRequest filter(final String value) {
     ...
     * @return the updated request
     */
     public IManagedDeviceMobileAppConfigurationUserStatusRequest orderBy(final String value) {
