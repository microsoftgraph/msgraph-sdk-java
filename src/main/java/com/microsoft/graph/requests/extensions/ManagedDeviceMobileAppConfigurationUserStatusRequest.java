...
public class ManagedDeviceMobileAppConfigurationUserStatusRequest extends BaseRequest<ManagedDeviceMobileAppConfigurationUserStatus> {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationUserStatusRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationUserStatusRequest count() {
        addCountOption(true);
        return this;
    }
}
