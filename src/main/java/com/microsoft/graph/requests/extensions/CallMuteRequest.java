...
public class CallMuteRequest extends BaseRequest<MuteParticipantOperation> {
     ...
     */
    public CallMuteRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallMuteBody parameters) {
        super(requestUrl, client, requestOptions, MuteParticipantOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected CallMuteBody body;
    /**
     ...
     */
    @Nonnull
    public CallMuteRequest count(final boolean value) {
