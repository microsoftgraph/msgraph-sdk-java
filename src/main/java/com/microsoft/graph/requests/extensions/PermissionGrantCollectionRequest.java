 ...
 */
public class PermissionGrantCollectionRequest extends BaseCollectionRequest<Permission, PermissionGrantCollectionResponse> {
    ...
    public BaseCollectionPage<Permission> buildFromResponse(final PermissionGrantCollectionResponse response) {
