...
/**
 * The interface for the Change Tracked Entity With Reference Request Builder.
 */
public interface IChangeTrackedEntityWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IChangeTrackedEntityWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IChangeTrackedEntityWithReferenceRequest instance
     */
    IChangeTrackedEntityWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IChangeTrackedEntityReferenceRequestBuilder reference();
