 ...
 */
public interface IRemoteAssistancePartnerRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IRemoteAssistancePartnerRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
