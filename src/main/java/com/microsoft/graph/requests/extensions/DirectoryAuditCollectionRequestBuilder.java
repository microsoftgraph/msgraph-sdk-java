...
public class DirectoryAuditCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public DirectoryAuditCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DirectoryAuditCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DirectoryAuditCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public DirectoryAuditRequestBuilder byId(@Nonnull final String id) {
