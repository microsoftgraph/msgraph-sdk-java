...
public class DirectoryAuditCollectionRequestBuilder extends BaseRequestBuilder implements IDirectoryAuditCollectionRequestBuilder {
     ...
     */
    public DirectoryAuditCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDirectoryAuditCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
