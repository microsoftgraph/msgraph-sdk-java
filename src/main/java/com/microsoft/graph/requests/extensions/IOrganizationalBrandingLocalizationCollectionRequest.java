...
/**
 * The interface for the Organizational Branding Localization Collection Request.
 */
public interface IOrganizationalBrandingLocalizationCollectionRequest extends IHttpRequest {
     ...
     */
    IOrganizationalBrandingLocalizationCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IOrganizationalBrandingLocalizationCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOrganizationalBrandingLocalizationCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IOrganizationalBrandingLocalizationCollectionRequest skip(final int value);
