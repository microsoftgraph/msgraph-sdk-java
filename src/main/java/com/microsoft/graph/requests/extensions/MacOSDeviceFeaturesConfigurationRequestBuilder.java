...
public class MacOSDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder<MacOSDeviceFeaturesConfiguration> {
     ...
     */
    public MacOSDeviceFeaturesConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the MacOSDeviceFeaturesConfigurationRequest instance
     */
    public MacOSDeviceFeaturesConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
