...
public class WorkbookChartSetDataRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartSetDataRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookChartSetDataRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookChartSetDataRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookChartSetDataRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookChartSetDataRequest expand(@Nonnull final String value) {
