...
public class WorkbookChartSetDataRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartSetDataRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartSetDataBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookChartSetDataBody body;
    /**
