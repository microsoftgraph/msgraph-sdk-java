...
public class WorkbookChartSetDataRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookChartSetDataRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookChartSetDataParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookChartSetDataParameterSet body;
    /**
     * Creates the WorkbookChartSetData
     *
