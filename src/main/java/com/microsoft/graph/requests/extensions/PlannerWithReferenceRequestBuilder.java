...
/**
 * The class for the Planner With Reference Request Builder.
 */
public class PlannerWithReferenceRequestBuilder extends BaseRequestBuilder implements IPlannerWithReferenceRequestBuilder {
     ...
     */
    public PlannerWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IPlannerWithReferenceRequest instance
     */
    public IPlannerWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPlannerWithReferenceRequest instance
     */
    public IPlannerWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IPlannerReferenceRequestBuilder reference(){
        return new PlannerReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
