 ...
 */
public class WorkbookFunctionsArabicRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsArabicRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsArabicBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsArabicBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsArabicRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsArabicRequest count() {
        addCountOption(true);
        return this;
    }
