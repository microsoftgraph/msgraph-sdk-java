...
public class WorkbookFunctionsArabicRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsArabicRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsArabicParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsArabicParameterSet body;
    /**
