...
public class MessageCreateForwardRequest extends BaseRequest<Message> {
     ...
     */
    public MessageCreateForwardRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MessageCreateForwardParameterSet parameters) {
