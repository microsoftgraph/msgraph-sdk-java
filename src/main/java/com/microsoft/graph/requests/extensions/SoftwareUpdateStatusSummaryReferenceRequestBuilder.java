...
public class SoftwareUpdateStatusSummaryReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public SoftwareUpdateStatusSummaryReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public SoftwareUpdateStatusSummaryReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
