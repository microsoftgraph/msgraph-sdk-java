...
public class WorkbookFunctionsBeta_DistRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsBeta_DistBody body;
    /**
     ...
     */
    public WorkbookFunctionsBeta_DistRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsBeta_DistBody parameters) {
