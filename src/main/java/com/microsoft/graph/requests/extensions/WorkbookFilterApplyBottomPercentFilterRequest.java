...
public class WorkbookFilterApplyBottomPercentFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyBottomPercentFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyBottomPercentFilterRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyBottomPercentFilterRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookFilterApplyBottomPercentFilterRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyBottomPercentFilterRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookFilterApplyBottomPercentFilterRequest expand(@Nonnull final String value) {
