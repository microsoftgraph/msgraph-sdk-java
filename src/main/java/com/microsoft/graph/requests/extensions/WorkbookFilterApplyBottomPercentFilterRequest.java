...
public class WorkbookFilterApplyBottomPercentFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyBottomPercentFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyBottomPercentFilterParameterSet parameters) {
