 ...
 */
public class LinkedResourceCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public LinkedResourceCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public LinkedResourceCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new LinkedResourceCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public LinkedResourceRequestBuilder byId(@Nonnull final String id) {
