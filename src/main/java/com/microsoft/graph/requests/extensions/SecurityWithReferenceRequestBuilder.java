...
/**
 * The class for the Security With Reference Request Builder.
 */
public class SecurityWithReferenceRequestBuilder extends BaseRequestBuilder implements ISecurityWithReferenceRequestBuilder {
     ...
     */
    public SecurityWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the ISecurityWithReferenceRequest instance
     */
    public ISecurityWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ISecurityWithReferenceRequest instance
     */
    public ISecurityWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new SecurityWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public ISecurityReferenceRequestBuilder reference(){
        return new SecurityReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
