 ...
 */
public class ReportStreamRequest extends BaseStreamRequest<Report> implements IReportStreamRequest {
     ...
     */
    public ReportStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
