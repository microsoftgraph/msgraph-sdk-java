 ...
 */
public interface IWorkbookFunctionsCumPrincRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsCumPrincRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
