...
/**
 * The class for the Workbook Chart With Reference Request Builder.
 */
public class WorkbookChartWithReferenceRequestBuilder extends BaseRequestBuilder implements IWorkbookChartWithReferenceRequestBuilder {
     ...
     */
    public WorkbookChartWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWorkbookChartWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWorkbookChartWithReferenceRequest instance
     */
    public IWorkbookChartWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WorkbookChartWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IWorkbookChartReferenceRequestBuilder reference(){
        return new WorkbookChartReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
