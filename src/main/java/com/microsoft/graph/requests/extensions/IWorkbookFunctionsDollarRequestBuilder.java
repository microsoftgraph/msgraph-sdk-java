...
public interface IWorkbookFunctionsDollarRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsDollarRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsDollarRequest instance
     */
    IWorkbookFunctionsDollarRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
