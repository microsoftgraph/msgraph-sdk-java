...
public class WorkbookRangeViewRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookRangeViewRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeViewRangeRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeViewRangeRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
