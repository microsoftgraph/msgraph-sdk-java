...
public class ManagedDeviceMobileAppConfigurationUserSummaryRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ManagedDeviceMobileAppConfigurationUserSummaryRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ManagedDeviceMobileAppConfigurationUserSummaryRequest instance
     */
    public ManagedDeviceMobileAppConfigurationUserSummaryRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
