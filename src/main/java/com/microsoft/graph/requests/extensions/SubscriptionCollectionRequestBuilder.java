...
import com.microsoft.graph.requests.generated.BaseSubscriptionCollectionRequestBuilder;
...
public class SubscriptionCollectionRequestBuilder extends BaseSubscriptionCollectionRequestBuilder implements ISubscriptionCollectionRequestBuilder {
     ...
     */
    public SubscriptionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
