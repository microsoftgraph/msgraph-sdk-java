...
public class WorkbookFunctionsIsLogicalRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsIsLogicalBody body;
    /**
     ...
     */
    public WorkbookFunctionsIsLogicalRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsIsLogicalBody parameters) {
