 ...
 */
public class MobileAppContentFileCollectionResponse implements ICollectionResponse<MobileAppContentFile>, IJsonBackedObject {

    /**
     * The list of MobileAppContentFile within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<MobileAppContentFile> value;

    /**
     * The list of MobileAppContentFile within this collection page
     */
    @Override
    public java.util.List<MobileAppContentFile> values() {
        return value;
    }
