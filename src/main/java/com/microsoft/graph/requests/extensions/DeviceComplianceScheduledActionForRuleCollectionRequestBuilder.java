...
public class DeviceComplianceScheduledActionForRuleCollectionRequestBuilder extends BaseCollectionRequestBuilder<DeviceComplianceScheduledActionForRule, DeviceComplianceScheduledActionForRuleRequestBuilder, DeviceComplianceScheduledActionForRuleCollectionResponse, DeviceComplianceScheduledActionForRuleCollectionPage, DeviceComplianceScheduledActionForRuleCollectionRequest> {
    ...
    public DeviceComplianceScheduledActionForRuleCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceComplianceScheduledActionForRuleRequestBuilder.class, DeviceComplianceScheduledActionForRuleCollectionResponse.class, DeviceComplianceScheduledActionForRuleCollectionPage.class, DeviceComplianceScheduledActionForRuleCollectionRequest.class);
    }
