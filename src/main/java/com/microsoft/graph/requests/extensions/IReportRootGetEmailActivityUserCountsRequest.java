 ...
 */
public interface IReportRootGetEmailActivityUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetEmailActivityUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetEmailActivityUserCountsRequest expand(final String value);
