...
public class UserTeamworkRequestBuilder extends BaseRequestBuilder<UserTeamwork> {
     ...
     */
    public UserTeamworkRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the UserTeamworkRequest instance
     */
    public UserTeamworkRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
