...
public class DriveItemVersionCollectionRequestBuilder extends BaseCollectionRequestBuilder<DriveItemVersion, DriveItemVersionRequestBuilder, DriveItemVersionCollectionResponse, DriveItemVersionCollectionPage, DriveItemVersionCollectionRequest> {
    ...
    public DriveItemVersionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DriveItemVersionRequestBuilder.class, DriveItemVersionCollectionResponse.class, DriveItemVersionCollectionPage.class, DriveItemVersionCollectionRequest.class);
    }
