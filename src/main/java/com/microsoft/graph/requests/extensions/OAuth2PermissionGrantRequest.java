...
import com.microsoft.graph.requests.extensions.IOAuth2PermissionGrantRequest;
import com.microsoft.graph.requests.extensions.OAuth2PermissionGrantRequest;
...
public class OAuth2PermissionGrantRequest extends BaseRequest implements IOAuth2PermissionGrantRequest {
     ...
     */
    public OAuth2PermissionGrantRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
