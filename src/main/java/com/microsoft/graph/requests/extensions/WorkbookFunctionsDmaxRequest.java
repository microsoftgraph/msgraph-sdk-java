...
public class WorkbookFunctionsDmaxRequest extends BaseRequest implements IWorkbookFunctionsDmaxRequest {
     ...
     */
    public IWorkbookFunctionsDmaxRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDmaxRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDmaxRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDmaxRequest orderBy(final String value) {
