...
public class DriveItemCheckinRequest extends BaseRequest<Void> {
     ...
     */
    public DriveItemCheckinRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DriveItemCheckinBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected DriveItemCheckinBody body;
    /**
