...
public class WorkbookFilterApplyFontColorFilterRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFilterApplyFontColorFilterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final String color) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyFontColorFilterRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyFontColorFilterRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
