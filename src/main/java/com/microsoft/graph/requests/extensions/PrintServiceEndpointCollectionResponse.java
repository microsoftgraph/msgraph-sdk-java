 ...
 */
public class PrintServiceEndpointCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintServiceEndpoint within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintServiceEndpoint> value;
