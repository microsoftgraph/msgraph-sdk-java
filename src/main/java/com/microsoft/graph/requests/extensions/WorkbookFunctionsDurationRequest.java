 ...
 */
public class WorkbookFunctionsDurationRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsDurationRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsDurationRequest expand(final String value) {
