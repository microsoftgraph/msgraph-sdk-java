...
/**
 * The class for the Office Graph Insights With Reference Request.
 */
public class OfficeGraphInsightsWithReferenceRequest extends BaseRequest implements IOfficeGraphInsightsWithReferenceRequest {
     ...
     */
    public OfficeGraphInsightsWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OfficeGraphInsights.class);
    }

    public void post(final OfficeGraphInsights newOfficeGraphInsights, final IJsonBackedObject payload, final ICallback<? super OfficeGraphInsights> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public OfficeGraphInsights post(final OfficeGraphInsights newOfficeGraphInsights, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IOfficeGraphInsightsWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IOfficeGraphInsightsWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IOfficeGraphInsightsWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (OfficeGraphInsightsWithReferenceRequest)this;
    }
}
