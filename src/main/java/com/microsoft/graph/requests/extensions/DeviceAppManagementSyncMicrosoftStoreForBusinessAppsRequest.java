...
public class DeviceAppManagementSyncMicrosoftStoreForBusinessAppsRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceAppManagementSyncMicrosoftStoreForBusinessAppsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
