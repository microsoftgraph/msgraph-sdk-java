...
/**
 * The interface for the Room List Collection Page.
 */
public interface IRoomListCollectionPage extends IBaseCollectionPage<RoomList, IRoomListCollectionRequestBuilder> {
}
