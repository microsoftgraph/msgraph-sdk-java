...
public class NotebookCopyNotebookRequest extends BaseRequest<OnenoteOperation> {
     ...
     */
    public NotebookCopyNotebookRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final NotebookCopyNotebookBody parameters) {
        super(requestUrl, client, requestOptions, OnenoteOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected NotebookCopyNotebookBody body;
    /**
