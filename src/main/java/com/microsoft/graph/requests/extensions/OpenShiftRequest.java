 ...
 */
public class OpenShiftRequest extends BaseRequest implements IOpenShiftRequest {
     ...
     */
    public OpenShiftRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final OpenShift newOpenShift, final ICallback<? super OpenShift> callback) {
     ...
     */
     public IOpenShiftRequest select(final String value) {
         getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
         return (OpenShiftRequest)this;
     }
     ...
     * @return the updated request
     */
     public IOpenShiftRequest expand(final String value) {
     ...
     * @return the updated request
     */
     public IOpenShiftRequest filter(final String value) {
     ...
     * @return the updated request
     */
     public IOpenShiftRequest orderBy(final String value) {
