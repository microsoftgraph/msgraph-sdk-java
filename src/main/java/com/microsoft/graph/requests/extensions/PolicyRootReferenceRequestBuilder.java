...
/**
 * The class for the Policy Root Reference Request Builder.
 */
public class PolicyRootReferenceRequestBuilder extends BaseRequestBuilder implements IPolicyRootReferenceRequestBuilder {
     ...
     */
    public PolicyRootReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IPolicyRootReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPolicyRootReferenceRequest instance
     */
    public IPolicyRootReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PolicyRootReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
