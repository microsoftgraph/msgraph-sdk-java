...
public class DriveItemSearchCollectionRequest extends BaseFunctionCollectionRequest<DriveItem, DriveItemSearchCollectionResponse, DriveItemSearchCollectionPage> {
     ...
     */
    @Nonnull
    public DriveItemSearchCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DriveItemSearchCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public DriveItemSearchCollectionRequest skipToken(@Nonnull final String skipToken) {
