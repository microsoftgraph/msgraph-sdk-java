 ...
 */
public class DriveItemSearchCollectionRequest extends BaseCollectionRequest<DriveItem, DriveItemSearchCollectionResponse> {
    ...
    public BaseCollectionPage<DriveItem> buildFromResponse(final DriveItemSearchCollectionResponse response) {
