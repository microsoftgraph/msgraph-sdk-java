...
public class IosGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public IosGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IosGeneralDeviceConfigurationRequest instance
     */
    public IosGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
