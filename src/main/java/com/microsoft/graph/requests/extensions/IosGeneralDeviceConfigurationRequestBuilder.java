 ...
 */
public class IosGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IIosGeneralDeviceConfigurationRequestBuilder {
     ...
     */
    public IosGeneralDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IIosGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IIosGeneralDeviceConfigurationRequest instance
     */
    public IIosGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosGeneralDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
