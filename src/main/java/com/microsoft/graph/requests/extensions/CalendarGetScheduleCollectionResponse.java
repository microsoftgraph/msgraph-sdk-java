 ...
 */
public class CalendarGetScheduleCollectionResponse implements ICollectionResponse<ScheduleInformation>, IJsonBackedObject {

    /**
     * The list of ScheduleInformation within this collection page
     */
     ...
     */
    @Override
    public java.util.List<ScheduleInformation> values() {
        return value;
    }
