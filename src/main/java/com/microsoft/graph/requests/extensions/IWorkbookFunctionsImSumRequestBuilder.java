 ...
 */
public interface IWorkbookFunctionsImSumRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsImSumRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
