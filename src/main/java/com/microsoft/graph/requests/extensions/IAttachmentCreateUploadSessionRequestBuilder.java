...
/**
 * The interface for the Attachment Create Upload Session Request Builder.
 */
public interface IAttachmentCreateUploadSessionRequestBuilder extends IRequestBuilder {
     ...
     */
    IAttachmentCreateUploadSessionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAttachmentCreateUploadSessionRequest instance
     */
    IAttachmentCreateUploadSessionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
