 ...
 */
public interface IMacOSCompliancePolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSCompliancePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSCompliancePolicyRequest instance
     */
    IMacOSCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
