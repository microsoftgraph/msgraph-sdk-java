...
public class CallMuteRequestBuilder extends BaseActionRequestBuilder<MuteParticipantOperation> {
     ...
     */
    public CallMuteRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallMuteBody parameters) {
