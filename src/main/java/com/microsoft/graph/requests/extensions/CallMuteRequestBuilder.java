...
public class CallMuteRequestBuilder extends BaseActionRequestBuilder implements ICallMuteRequestBuilder {
     ...
     */
    public CallMuteRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String clientContext) {
     ...
     * @return the ICallMuteRequest instance
     */
    public ICallMuteRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
