...
/**
 * The class for the Android Managed App Protection With Reference Request.
 */
public class AndroidManagedAppProtectionWithReferenceRequest extends BaseRequest implements IAndroidManagedAppProtectionWithReferenceRequest {
     ...
     */
    public AndroidManagedAppProtectionWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AndroidManagedAppProtection.class);
    }

    public void post(final AndroidManagedAppProtection newAndroidManagedAppProtection, final IJsonBackedObject payload, final ICallback<? super AndroidManagedAppProtection> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public AndroidManagedAppProtection post(final AndroidManagedAppProtection newAndroidManagedAppProtection, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newAndroidManagedAppProtection;
        }
        return null;
    }
	...
	public AndroidManagedAppProtection patch(final AndroidManagedAppProtection sourceAndroidManagedAppProtection) throws ClientException {
     ...
     */
    public IAndroidManagedAppProtectionWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IAndroidManagedAppProtectionWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IAndroidManagedAppProtectionWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (AndroidManagedAppProtectionWithReferenceRequest)this;
    }
}
