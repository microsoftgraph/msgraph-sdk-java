...
public class DeviceEnrollmentConfigurationAssignRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceEnrollmentConfigurationAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationAssignRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationAssignRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationAssignRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationAssignRequest expand(@Nonnull final String value) {
