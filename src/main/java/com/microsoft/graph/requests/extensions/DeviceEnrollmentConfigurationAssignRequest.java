...
public class DeviceEnrollmentConfigurationAssignRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceEnrollmentConfigurationAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DeviceEnrollmentConfigurationAssignBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected DeviceEnrollmentConfigurationAssignBody body;
    /**
