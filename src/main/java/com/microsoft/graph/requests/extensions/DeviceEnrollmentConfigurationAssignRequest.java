 ...
 */
public class DeviceEnrollmentConfigurationAssignRequest extends BaseRequest implements IDeviceEnrollmentConfigurationAssignRequest {
     ...
     * @return the updated request
     */
    public IDeviceEnrollmentConfigurationAssignRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceEnrollmentConfigurationAssignRequest orderBy(final String value) {
