 ...
 */
public class ManagedAppStatusCollectionResponse implements ICollectionResponse<ManagedAppStatus>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<ManagedAppStatus> values() {
        return value;
    }
