...
public class WorkbookChartAreaFormatRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WorkbookChartAreaFormatRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookChartAreaFormatRequest instance
     */
    public WorkbookChartAreaFormatRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
