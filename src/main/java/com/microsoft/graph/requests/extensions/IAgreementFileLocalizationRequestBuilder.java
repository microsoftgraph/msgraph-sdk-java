...
/**
 * The interface for the Agreement File Localization Request Builder.
 */
public interface IAgreementFileLocalizationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAgreementFileLocalizationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
