...
public class WorkbookFunctionsRoundUpRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsRoundUpRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsRoundUpBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsRoundUpBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsRoundUpRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsRoundUpRequest count() {
        addCountOption(true);
        return this;
    }
