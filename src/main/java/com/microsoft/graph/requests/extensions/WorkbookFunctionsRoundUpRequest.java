...
public class WorkbookFunctionsRoundUpRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsRoundUpRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsRoundUpParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsRoundUpParameterSet body;
    /**
