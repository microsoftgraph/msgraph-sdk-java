...
public class WorkbookFunctionsPercentile_ExcRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     * @param k the k
     */
    public WorkbookFunctionsPercentile_ExcRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final com.google.gson.JsonElement array, @Nullable final com.google.gson.JsonElement k) {
