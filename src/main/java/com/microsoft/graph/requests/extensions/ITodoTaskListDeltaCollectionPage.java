...
/**
 * The interface for the Todo Task List Delta Collection Page.
 */
public interface ITodoTaskListDeltaCollectionPage extends IBaseCollectionPage<TodoTaskList, ITodoTaskListDeltaCollectionRequestBuilder> {
    /**
