 ...
 */
public class ServicePrincipalAddPasswordRequest extends BaseRequest {
     ...
     */
    public ServicePrincipalAddPasswordRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ServicePrincipalAddPasswordRequest expand(final String value) {
