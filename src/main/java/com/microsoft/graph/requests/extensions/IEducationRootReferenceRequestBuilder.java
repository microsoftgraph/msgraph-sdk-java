...
/**
 * The interface for the Education Root Reference Request Builder.
 */
public interface IEducationRootReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IEducationRootReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IEducationRootReferenceRequest instance
     */
    IEducationRootReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
