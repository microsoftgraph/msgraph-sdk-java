...
public class DeviceConfigurationAssignmentCollectionRequest extends BaseCollectionRequest<DeviceConfigurationAssignmentCollectionResponse, IDeviceConfigurationAssignmentCollectionPage> implements IDeviceConfigurationAssignmentCollectionRequest {
    ...
    public void get(final ICallback<? super IDeviceConfigurationAssignmentCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IDeviceConfigurationAssignmentCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceConfigurationAssignmentCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceConfigurationAssignmentCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IDeviceConfigurationAssignmentCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IDeviceConfigurationAssignmentCollectionRequest)this;
    }
