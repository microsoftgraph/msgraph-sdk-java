 ...
 */
public class WorkbookFunctionsMdurationRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsMdurationRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMdurationBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsMdurationBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsMdurationRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsMdurationRequest count() {
        addCountOption(true);
        return this;
    }
