 ...
 */
public interface IWorkbookFunctionsCoupDaysRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsCoupDaysRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
