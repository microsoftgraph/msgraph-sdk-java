...
public class OnenotePageOnenotePatchContentRequest extends BaseRequest<Void> {
     ...
     */
    public OnenotePageOnenotePatchContentRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final OnenotePageOnenotePatchContentBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected OnenotePageOnenotePatchContentBody body;
    /**
