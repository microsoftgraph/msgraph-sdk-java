...
public class OnenotePageOnenotePatchContentRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public OnenotePageOnenotePatchContentRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OnenotePageOnenotePatchContentRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OnenotePageOnenotePatchContentRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public OnenotePageOnenotePatchContentRequest expand(@Nonnull final String value) {
