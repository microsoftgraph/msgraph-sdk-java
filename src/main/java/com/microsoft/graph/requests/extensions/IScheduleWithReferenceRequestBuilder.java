...
/**
 * The interface for the Schedule With Reference Request Builder.
 */
public interface IScheduleWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IScheduleWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IScheduleWithReferenceRequest instance
     */
    IScheduleWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IScheduleReferenceRequestBuilder reference();
