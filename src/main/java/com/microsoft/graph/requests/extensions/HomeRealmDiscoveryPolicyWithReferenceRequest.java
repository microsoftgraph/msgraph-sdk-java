...
public class HomeRealmDiscoveryPolicyWithReferenceRequest extends BaseRequest implements IHomeRealmDiscoveryPolicyWithReferenceRequest {
     ...
     * @return the updated request
     */
    public IHomeRealmDiscoveryPolicyWithReferenceRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IHomeRealmDiscoveryPolicyWithReferenceRequest orderBy(final String value) {
