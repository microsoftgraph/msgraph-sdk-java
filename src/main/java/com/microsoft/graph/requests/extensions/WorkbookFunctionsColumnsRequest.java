 ...
 */
public class WorkbookFunctionsColumnsRequest extends BaseRequest implements IWorkbookFunctionsColumnsRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsColumnsRequest orderBy(final String value) {
