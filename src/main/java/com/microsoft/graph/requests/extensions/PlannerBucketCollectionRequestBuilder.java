...
public class PlannerBucketCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public PlannerBucketCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PlannerBucketCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerBucketCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public PlannerBucketRequestBuilder byId(@Nonnull final String id) {
