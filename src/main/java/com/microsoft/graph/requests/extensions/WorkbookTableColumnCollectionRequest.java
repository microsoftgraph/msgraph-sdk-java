 ...
 */
public class WorkbookTableColumnCollectionRequest extends BaseEntityCollectionRequest<WorkbookTableColumn, WorkbookTableColumnCollectionResponse, WorkbookTableColumnCollectionPage> {
    ...
    public java.util.concurrent.CompletableFuture<WorkbookTableColumn> futurePost(@Nonnull final WorkbookTableColumn newWorkbookTableColumn) {
        ...
        return new WorkbookTableColumnRequestBuilder(requestUrl, getBaseRequest().getClient(), /* Options */ null)
            ...
            .futurePost(newWorkbookTableColumn);
    }
     ...
     */
    @Nonnull
    public WorkbookTableColumnCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
