 ...
 */
public class PrintUsageByUserCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintUsageByUser within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintUsageByUser> value;
