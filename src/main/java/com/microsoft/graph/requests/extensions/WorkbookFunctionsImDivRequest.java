 ...
 */
public class WorkbookFunctionsImDivRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsImDivRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsImDivRequest expand(final String value) {
