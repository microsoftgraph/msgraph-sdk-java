...
/**
 * The interface for the Device App Management With Reference Request.
 */
public interface IDeviceAppManagementWithReferenceRequest extends IHttpRequest {

    void post(final DeviceAppManagement newDeviceAppManagement, final IJsonBackedObject payload, final ICallback<? super DeviceAppManagement> callback);

    DeviceAppManagement post(final DeviceAppManagement newDeviceAppManagement, final IJsonBackedObject payload) throws ClientException;
    ...
    IDeviceAppManagementWithReferenceRequest select(final String value);

    IDeviceAppManagementWithReferenceRequest expand(final String value);
