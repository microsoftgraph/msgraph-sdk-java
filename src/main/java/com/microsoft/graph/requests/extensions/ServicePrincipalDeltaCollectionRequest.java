...
public class ServicePrincipalDeltaCollectionRequest extends BaseDeltaCollectionRequest<ServicePrincipal, ServicePrincipalDeltaCollectionResponse, ServicePrincipalDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public ServicePrincipalDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public ServicePrincipalDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
