 ...
 */
public class ServicePrincipalDeltaCollectionRequest extends BaseFunctionCollectionRequest<ServicePrincipal, ServicePrincipalDeltaCollectionResponse, ServicePrincipalDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public ServicePrincipalDeltaCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ServicePrincipalDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
