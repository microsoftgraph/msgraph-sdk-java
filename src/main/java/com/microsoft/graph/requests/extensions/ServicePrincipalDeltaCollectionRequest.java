 ...
 */
public class ServicePrincipalDeltaCollectionRequest extends BaseCollectionRequest<ServicePrincipal, ServicePrincipalDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<ServicePrincipal> buildFromResponse(final ServicePrincipalDeltaCollectionResponse response) {
