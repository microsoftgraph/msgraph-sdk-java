 ...
 */
public class TeamsAppCollectionResponse implements ICollectionResponse<TeamsApp>, IJsonBackedObject {

    /**
     * The list of TeamsApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TeamsApp> value;

    /**
     * The list of TeamsApp within this collection page
     */
    @Override
    public java.util.List<TeamsApp> values() {
        return value;
    }
