...
/**
 * The interface for the Named Location Collection Page.
 */
public interface INamedLocationCollectionPage extends IBaseCollectionPage<NamedLocation, INamedLocationCollectionRequestBuilder> {
}
