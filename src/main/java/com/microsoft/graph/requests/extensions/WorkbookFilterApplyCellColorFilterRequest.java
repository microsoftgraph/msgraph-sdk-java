...
public class WorkbookFilterApplyCellColorFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyCellColorFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyCellColorFilterBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFilterApplyCellColorFilterBody body;
    /**
     * Creates the WorkbookFilterApplyCellColorFilter
     *
