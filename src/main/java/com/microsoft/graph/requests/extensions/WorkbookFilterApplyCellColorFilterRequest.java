...
public class WorkbookFilterApplyCellColorFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyCellColorFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyCellColorFilterParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFilterApplyCellColorFilterParameterSet body;
    /**
