...
/**
 * The class for the Ios Vpp App Collection Response.
 */
public class IosVppAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IosVppApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IosVppApp> value;
