...
public class CloudCommunicationsRequestBuilder extends BaseRequestBuilder<CloudCommunications> {
     ...
     */
    @Nonnull
    public PresenceRequestBuilder presences(@Nonnull final String id) {
     ...
     */
    @Nonnull
    public CloudCommunicationsGetPresencesByUserIdCollectionRequestBuilder getPresencesByUserId(@Nonnull final CloudCommunicationsGetPresencesByUserIdBody parameters) {
