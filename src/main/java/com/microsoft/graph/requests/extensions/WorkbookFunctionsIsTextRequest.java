...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsIsTextRequest;
...
public class WorkbookFunctionsIsTextRequest extends BaseWorkbookFunctionsIsTextRequest implements IWorkbookFunctionsIsTextRequest {
     ...
     */
    public WorkbookFunctionsIsTextRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
