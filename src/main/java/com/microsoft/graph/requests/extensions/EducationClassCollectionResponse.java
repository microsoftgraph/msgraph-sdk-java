 ...
 */
public class EducationClassCollectionResponse implements ICollectionResponse<EducationClass>, IJsonBackedObject {

    /**
     * The list of EducationClass within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationClass> value;

    /**
     * The list of EducationClass within this collection page
     */
    @Override
    public java.util.List<EducationClass> values() {
        return value;
    }
