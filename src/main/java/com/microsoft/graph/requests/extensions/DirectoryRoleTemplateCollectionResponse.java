 ...
 */
public class DirectoryRoleTemplateCollectionResponse implements ICollectionResponse<DirectoryRoleTemplate>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<DirectoryRoleTemplate> values() {
        return value;
    }
