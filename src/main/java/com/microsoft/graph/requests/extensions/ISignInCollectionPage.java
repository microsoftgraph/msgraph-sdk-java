...
/**
 * The interface for the Sign In Collection Page.
 */
public interface ISignInCollectionPage extends IBaseCollectionPage<SignIn, ISignInCollectionRequestBuilder> {
}
