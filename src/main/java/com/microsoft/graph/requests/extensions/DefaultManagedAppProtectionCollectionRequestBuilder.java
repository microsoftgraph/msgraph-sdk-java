...
public class DefaultManagedAppProtectionCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public DefaultManagedAppProtectionCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DefaultManagedAppProtectionCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DefaultManagedAppProtectionCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public DefaultManagedAppProtectionRequestBuilder byId(@Nonnull final String id) {
