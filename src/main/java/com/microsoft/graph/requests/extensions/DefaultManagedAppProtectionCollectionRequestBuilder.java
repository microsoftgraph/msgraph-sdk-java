...
public class DefaultManagedAppProtectionCollectionRequestBuilder extends BaseCollectionRequestBuilder<DefaultManagedAppProtection, DefaultManagedAppProtectionRequestBuilder, DefaultManagedAppProtectionCollectionResponse, DefaultManagedAppProtectionCollectionPage, DefaultManagedAppProtectionCollectionRequest> {
    ...
    public DefaultManagedAppProtectionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DefaultManagedAppProtectionRequestBuilder.class, DefaultManagedAppProtectionCollectionResponse.class, DefaultManagedAppProtectionCollectionPage.class, DefaultManagedAppProtectionCollectionRequest.class);
    }
