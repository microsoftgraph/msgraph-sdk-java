...
public class ManagedDeviceReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ManagedDeviceReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedDeviceReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
