...
public class CallLogTeleconferenceDeviceQualityRequestBuilder extends BaseActionRequestBuilder implements ICallLogTeleconferenceDeviceQualityRequestBuilder {
     ...
     */
    public CallLogTeleconferenceDeviceQualityRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final TeleconferenceDeviceQuality quality) {
     ...
     * @return the ICallLogTeleconferenceDeviceQualityRequest instance
     */
    public ICallLogTeleconferenceDeviceQualityRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
