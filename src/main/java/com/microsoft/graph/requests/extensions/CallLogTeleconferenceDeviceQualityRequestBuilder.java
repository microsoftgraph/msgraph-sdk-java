...
public class CallLogTeleconferenceDeviceQualityRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public CallLogTeleconferenceDeviceQualityRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final TeleconferenceDeviceQuality quality) {
