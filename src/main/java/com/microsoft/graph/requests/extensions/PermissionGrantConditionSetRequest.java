...
public class PermissionGrantConditionSetRequest extends BaseRequest implements IPermissionGrantConditionSetRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final PermissionGrantConditionSet newPermissionGrantConditionSet, final ICallback<PermissionGrantConditionSet> callback) {
     ...
     * @return the updated request
     */
     public IPermissionGrantConditionSetRequest filter(final String value) {
