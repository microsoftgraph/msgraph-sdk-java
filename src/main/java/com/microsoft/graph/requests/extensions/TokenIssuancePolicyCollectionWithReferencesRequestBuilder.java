...
public class TokenIssuancePolicyCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements ITokenIssuancePolicyCollectionWithReferencesRequestBuilder {
     ...
     */
    public TokenIssuancePolicyCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITokenIssuancePolicyCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
