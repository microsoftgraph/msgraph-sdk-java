...
public class DomainCollectionRequestBuilder extends BaseCollectionRequestBuilder<Domain, DomainRequestBuilder, DomainCollectionResponse, DomainCollectionPage, DomainCollectionRequest> {
    ...
    public DomainCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DomainRequestBuilder.class, DomainCollectionResponse.class, DomainCollectionPage.class, DomainCollectionRequest.class);
    }
