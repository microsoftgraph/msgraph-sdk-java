...
public class ManagedDeviceOverviewReferenceRequest extends BaseReferenceRequest<ManagedDeviceOverview> {
     ...
     */
    public void put(@Nonnull final ManagedDeviceOverview srcManagedDeviceOverview, @Nonnull final ICallback<? super ManagedDeviceOverview> callback) {
     ...
     */
    @Nullable
    public ManagedDeviceOverview put(@Nonnull final ManagedDeviceOverview srcManagedDeviceOverview) throws ClientException {
