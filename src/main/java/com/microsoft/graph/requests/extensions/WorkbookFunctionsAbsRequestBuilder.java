...
public class WorkbookFunctionsAbsRequestBuilder extends BaseActionRequestBuilder implements IWorkbookFunctionsAbsRequestBuilder {
     ...
     */
    public IWorkbookFunctionsAbsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWorkbookFunctionsAbsRequest instance
     */
    public IWorkbookFunctionsAbsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
