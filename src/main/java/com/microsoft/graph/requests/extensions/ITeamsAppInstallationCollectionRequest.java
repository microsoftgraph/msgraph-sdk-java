...
public interface ITeamsAppInstallationCollectionRequest extends IHttpRequest {
     ...
     */
    ITeamsAppInstallationCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ITeamsAppInstallationCollectionRequest filter(final String value);
     ...
     * @return the updated request
     */
    ITeamsAppInstallationCollectionRequest orderBy(final String value);
     ...
     * @return the updated request
     */
    ITeamsAppInstallationCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ITeamsAppInstallationCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ITeamsAppInstallationCollectionRequest skip(final int value);
