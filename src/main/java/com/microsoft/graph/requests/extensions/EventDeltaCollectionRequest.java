 ...
 */
public class EventDeltaCollectionRequest extends BaseCollectionRequest<Event, EventDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<Event> buildFromResponse(final EventDeltaCollectionResponse response) {
