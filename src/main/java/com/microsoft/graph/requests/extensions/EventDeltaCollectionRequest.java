 ...
 */
public class EventDeltaCollectionRequest extends BaseDeltaCollectionRequest<Event, EventDeltaCollectionResponse, EventDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public EventDeltaCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public EventDeltaCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public EventDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public EventDeltaCollectionRequest skipToken(@Nonnull final String skipToken) {
     ...
     */
    @Nonnull
    public EventDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public EventDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
