...
import com.microsoft.graph.requests.generated.BaseWorkbookTableRowCountRequest;
...
public class WorkbookTableRowCountRequest extends BaseWorkbookTableRowCountRequest implements IWorkbookTableRowCountRequest {
     ...
     */
    public WorkbookTableRowCountRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
