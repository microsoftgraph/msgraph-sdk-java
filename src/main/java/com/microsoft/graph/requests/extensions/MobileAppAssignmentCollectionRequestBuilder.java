...
public class MobileAppAssignmentCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public MobileAppAssignmentCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MobileAppAssignmentCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new MobileAppAssignmentCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public MobileAppAssignmentRequestBuilder byId(@Nonnull final String id) {
