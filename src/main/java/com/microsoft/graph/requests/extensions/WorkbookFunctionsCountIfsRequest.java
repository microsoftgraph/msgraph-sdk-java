...
import com.microsoft.graph.requests.generated.BaseWorkbookFunctionsCountIfsRequest;
...
public class WorkbookFunctionsCountIfsRequest extends BaseWorkbookFunctionsCountIfsRequest implements IWorkbookFunctionsCountIfsRequest {
     ...
     */
    public WorkbookFunctionsCountIfsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
