 ...
 */
public interface IColumnDefinitionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IColumnDefinitionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
