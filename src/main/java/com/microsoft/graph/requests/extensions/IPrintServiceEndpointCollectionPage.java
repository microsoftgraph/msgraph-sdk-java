...
/**
 * The interface for the Print Service Endpoint Collection Page.
 */
public interface IPrintServiceEndpointCollectionPage extends IBaseCollectionPage<PrintServiceEndpoint, IPrintServiceEndpointCollectionRequestBuilder> {
}
