 ...
 */
public class CommsOperationCollectionResponse implements ICollectionResponse<CommsOperation>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<CommsOperation> values() {
        return value;
    }
