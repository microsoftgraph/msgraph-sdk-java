 ...
 */
public interface IEditionUpgradeConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IEditionUpgradeConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
