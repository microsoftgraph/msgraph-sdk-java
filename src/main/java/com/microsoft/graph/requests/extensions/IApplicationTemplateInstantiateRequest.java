...
/**
 * The interface for the Application Template Instantiate Request.
 */
public interface IApplicationTemplateInstantiateRequest extends IHttpRequest {
     ...
     */
    IApplicationTemplateInstantiateRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IApplicationTemplateInstantiateRequest top(final int value);
     ...
     * @return the updated request
     */
    IApplicationTemplateInstantiateRequest expand(final String value);
