 ...
 */
public class OfferShiftRequestCollectionResponse implements ICollectionResponse<OfferShiftRequest>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<OfferShiftRequest> values() {
        return value;
    }
