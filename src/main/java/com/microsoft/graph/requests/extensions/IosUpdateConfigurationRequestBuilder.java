...
public class IosUpdateConfigurationRequestBuilder extends BaseRequestBuilder<IosUpdateConfiguration> {
     ...
     */
    public IosUpdateConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IosUpdateConfigurationRequest instance
     */
    public IosUpdateConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
