 ...
 */
public class IosUpdateConfigurationRequestBuilder extends BaseRequestBuilder<IosUpdateConfiguration> {
     ...
     */
    public IosUpdateConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosUpdateConfigurationRequest instance
     */
    @Nonnull
    public IosUpdateConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosUpdateConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosUpdateConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
