...
public class WorkbookTableRowCollectionRequestBuilder extends BaseCollectionRequestBuilder<WorkbookTableRow, WorkbookTableRowRequestBuilder, WorkbookTableRowCollectionResponse, WorkbookTableRowCollectionPage, WorkbookTableRowCollectionRequest> {
    ...
    public WorkbookTableRowCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookTableRowRequestBuilder.class, WorkbookTableRowCollectionResponse.class, WorkbookTableRowCollectionPage.class, WorkbookTableRowCollectionRequest.class);
    }
