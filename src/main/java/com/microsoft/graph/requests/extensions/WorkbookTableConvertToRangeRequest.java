...
public class WorkbookTableConvertToRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookTableConvertToRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableConvertToRangeRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableConvertToRangeRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
