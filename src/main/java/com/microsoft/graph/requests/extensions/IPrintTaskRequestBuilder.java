...
public interface IPrintTaskRequestBuilder extends IRequestBuilder {
     ...
     */
    IPrintTaskRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPrintTaskRequest instance
     */
    IPrintTaskRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
