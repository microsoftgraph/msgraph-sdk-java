 ...
 */
public class AdministrativeUnitDeltaCollectionRequest extends BaseCollectionRequest<AdministrativeUnit, AdministrativeUnitDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<AdministrativeUnit> buildFromResponse(final AdministrativeUnitDeltaCollectionResponse response) {
