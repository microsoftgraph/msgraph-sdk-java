...
public class DeviceManagementExchangeConnectorCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public DeviceManagementExchangeConnectorCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceManagementExchangeConnectorCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceManagementExchangeConnectorCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DeviceManagementExchangeConnectorCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public DeviceManagementExchangeConnectorRequestBuilder byId(@Nonnull final String id) {
