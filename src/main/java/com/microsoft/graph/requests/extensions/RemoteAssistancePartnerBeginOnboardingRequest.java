...
public class RemoteAssistancePartnerBeginOnboardingRequest extends BaseRequest<Void> {
     ...
     */
    public RemoteAssistancePartnerBeginOnboardingRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
