...
public class ParticipantMuteRequestBuilder extends BaseActionRequestBuilder implements IParticipantMuteRequestBuilder {
     ...
     */
    public ParticipantMuteRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String clientContext) {
