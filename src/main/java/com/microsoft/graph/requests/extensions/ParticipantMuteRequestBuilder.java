...
public class ParticipantMuteRequestBuilder extends BaseActionRequestBuilder implements IParticipantMuteRequestBuilder {
     ...
     */
    public ParticipantMuteRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String clientContext) {
     ...
     */
    public IParticipantMuteRequest buildRequest() {
     ...
     * @return the IParticipantMuteRequest instance
     */
    public IParticipantMuteRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
