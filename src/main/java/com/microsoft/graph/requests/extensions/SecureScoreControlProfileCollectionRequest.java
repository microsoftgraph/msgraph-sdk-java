...
public class SecureScoreControlProfileCollectionRequest extends BaseCollectionRequest<SecureScoreControlProfileCollectionResponse, SecureScoreControlProfileCollectionPage> {
    ...
    public void get(final ICallback<? super SecureScoreControlProfileCollectionPage> callback) {
    ...
    public SecureScoreControlProfileCollectionPage buildFromResponse(final SecureScoreControlProfileCollectionResponse response) {
