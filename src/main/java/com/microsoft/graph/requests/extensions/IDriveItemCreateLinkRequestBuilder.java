 ...
 */
public interface IDriveItemCreateLinkRequestBuilder extends IRequestBuilder {
     ...
     */
    IDriveItemCreateLinkRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
