 ...
 */
public interface IGroupResetUnseenCountRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupResetUnseenCountRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
