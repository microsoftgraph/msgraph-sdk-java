...
public class EndpointCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public EndpointCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public EndpointCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EndpointCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new EndpointCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public EndpointRequestBuilder byId(@Nonnull final String id) {
