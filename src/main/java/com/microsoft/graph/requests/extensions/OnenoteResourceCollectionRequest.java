 ...
 */
public class OnenoteResourceCollectionRequest extends BaseCollectionRequest<OnenoteResource, OnenoteResourceCollectionResponse> {
    ...
    public BaseCollectionPage<OnenoteResource> get() throws ClientException {
    ...
    public BaseCollectionPage<OnenoteResource> buildFromResponse(final OnenoteResourceCollectionResponse response) {
        ...
        final BaseCollectionPage<OnenoteResource> page = new BaseCollectionPage<OnenoteResource>(response, builder);
