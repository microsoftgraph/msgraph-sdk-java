 ...
 */
public class OnenoteResourceCollectionRequest extends BaseCollectionRequest<OnenoteResourceCollectionResponse, OnenoteResourceCollectionPage> {
    ...
    public OnenoteResourceCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OnenoteResourceCollectionResponse.class, OnenoteResourceCollectionPage.class);
    }

    public void get(final ICallback<? super OnenoteResourceCollectionPage> callback) {
    ...
    public OnenoteResourceCollectionPage get() throws ClientException {
     ...
     */
    public OnenoteResourceCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public OnenoteResourceCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public OnenoteResourceCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public OnenoteResourceCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public OnenoteResourceCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (OnenoteResourceCollectionRequest)this;
    }
    public OnenoteResourceCollectionPage buildFromResponse(final OnenoteResourceCollectionResponse response) {
        final OnenoteResourceCollectionRequestBuilder builder;
