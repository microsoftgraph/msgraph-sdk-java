...
public class WorkbookFunctionsPermutRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsPermutBody body;
    /**
     ...
     */
    public WorkbookFunctionsPermutRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsPermutBody parameters) {
