 ...
 */
public interface IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest expand(final String value);
