...
public class OnlineMeetingCreateOrGetRequest extends BaseRequest<OnlineMeeting> {
     ...
     */
    public OnlineMeetingCreateOrGetRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final OnlineMeetingCreateOrGetBody parameters) {
        super(requestUrl, client, requestOptions, OnlineMeeting.class);
        body = parameters;
    }

	/** The body for the method */
    protected OnlineMeetingCreateOrGetBody body;
    /**
     ...
     */
    @Nonnull
    public OnlineMeetingCreateOrGetRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OnlineMeetingCreateOrGetRequest count() {
        addCountOption(true);
        return this;
    }
