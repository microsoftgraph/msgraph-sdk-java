...
/**
 * The class for the Workbook Chart Series Format With Reference Request.
 */
public class WorkbookChartSeriesFormatWithReferenceRequest extends BaseRequest implements IWorkbookChartSeriesFormatWithReferenceRequest {
     ...
     */
    public WorkbookChartSeriesFormatWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookChartSeriesFormat.class);
    }

    public void post(final WorkbookChartSeriesFormat newWorkbookChartSeriesFormat, final IJsonBackedObject payload, final ICallback<? super WorkbookChartSeriesFormat> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public WorkbookChartSeriesFormat post(final WorkbookChartSeriesFormat newWorkbookChartSeriesFormat, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newWorkbookChartSeriesFormat;
        }
        return null;
    }
     ...
     */
    public IWorkbookChartSeriesFormatWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IWorkbookChartSeriesFormatWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookChartSeriesFormatWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (WorkbookChartSeriesFormatWithReferenceRequest)this;
    }
}
