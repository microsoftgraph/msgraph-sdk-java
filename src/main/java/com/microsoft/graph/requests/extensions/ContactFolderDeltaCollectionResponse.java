 ...
 */
public class ContactFolderDeltaCollectionResponse implements ICollectionResponse<ContactFolder>, IJsonBackedObject {

    /**
     * The list of ContactFolder within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ContactFolder> value;

    /**
     * The list of ContactFolder within this collection page
     */
    @Override
    public java.util.List<ContactFolder> values() {
        return value;
    }
