...
public class DeviceComplianceUserStatusCollectionRequest extends BaseCollectionRequest<DeviceComplianceUserStatusCollectionResponse, DeviceComplianceUserStatusCollectionPage> {
    ...
    public void get(final ICallback<? super DeviceComplianceUserStatusCollectionPage> callback) {
    ...
    public DeviceComplianceUserStatusCollectionPage buildFromResponse(final DeviceComplianceUserStatusCollectionResponse response) {
