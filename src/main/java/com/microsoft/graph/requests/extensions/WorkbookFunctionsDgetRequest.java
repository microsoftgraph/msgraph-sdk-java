 ...
 */
public class WorkbookFunctionsDgetRequest extends BaseRequest implements IWorkbookFunctionsDgetRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsDgetRequest orderBy(final String value) {
