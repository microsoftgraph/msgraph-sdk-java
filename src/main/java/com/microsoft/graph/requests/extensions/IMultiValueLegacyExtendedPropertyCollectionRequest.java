...
public interface IMultiValueLegacyExtendedPropertyCollectionRequest extends IHttpRequest {
    ...
    void get(final ICallback<? super IMultiValueLegacyExtendedPropertyCollectionPage> callback);
     ...
     */
    IMultiValueLegacyExtendedPropertyCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IMultiValueLegacyExtendedPropertyCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IMultiValueLegacyExtendedPropertyCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IMultiValueLegacyExtendedPropertyCollectionRequest skip(final int value);
