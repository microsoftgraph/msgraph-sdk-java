...
public class WorkbookFilterApplyTopItemsFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyTopItemsFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyTopItemsFilterBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFilterApplyTopItemsFilterBody body;
    /**
