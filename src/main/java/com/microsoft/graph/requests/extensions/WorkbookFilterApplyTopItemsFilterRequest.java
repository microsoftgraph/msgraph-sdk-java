...
public class WorkbookFilterApplyTopItemsFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyTopItemsFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopItemsFilterRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopItemsFilterRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopItemsFilterRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopItemsFilterRequest expand(@Nonnull final String value) {
