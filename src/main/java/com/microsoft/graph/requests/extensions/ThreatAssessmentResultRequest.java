...
import com.microsoft.graph.requests.extensions.IThreatAssessmentResultRequest;
import com.microsoft.graph.requests.extensions.ThreatAssessmentResultRequest;
...
public class ThreatAssessmentResultRequest extends BaseRequest implements IThreatAssessmentResultRequest {
     ...
     */
    public ThreatAssessmentResultRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<ThreatAssessmentResult> callback) {
     ...
     */
    public void delete(final ICallback<ThreatAssessmentResult> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final ThreatAssessmentResult sourceThreatAssessmentResult, final ICallback<ThreatAssessmentResult> callback) {
