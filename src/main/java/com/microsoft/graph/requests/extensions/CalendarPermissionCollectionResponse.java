 ...
 */
public class CalendarPermissionCollectionResponse implements ICollectionResponse<CalendarPermission>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<CalendarPermission> values() {
        return value;
    }
