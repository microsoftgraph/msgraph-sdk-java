 ...
 */
public class WorkbookFunctionsGcdRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsGcdRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final com.google.gson.JsonElement values) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsGcdRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
