...
public class SiteWithReferenceRequestBuilder extends BaseRequestBuilder implements ISiteWithReferenceRequestBuilder {
     ...
     */
    public SiteWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the ISiteWithReferenceRequest instance
     */
    public ISiteWithReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
