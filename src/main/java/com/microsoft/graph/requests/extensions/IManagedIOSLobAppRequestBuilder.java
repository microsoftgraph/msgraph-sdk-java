 ...
 */
public interface IManagedIOSLobAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IManagedIOSLobAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
