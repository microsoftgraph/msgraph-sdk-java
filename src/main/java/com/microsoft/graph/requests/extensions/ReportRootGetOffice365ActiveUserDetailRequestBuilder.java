...
public class ReportRootGetOffice365ActiveUserDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     * @param date the date
     */
    public ReportRootGetOffice365ActiveUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final com.microsoft.graph.core.DateOnly date) {
