...
public class ReportRootGetOffice365ActiveUserDetailRequestBuilder extends BaseFunctionRequestBuilder<Report> {
     ...
     * @param date the date
     */
    public ReportRootGetOffice365ActiveUserDetailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final com.microsoft.graph.core.DateOnly date) {
     ...
     */
    public ReportRootGetOffice365ActiveUserDetailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final String period) {
        super(requestUrl, client, requestOptions);
