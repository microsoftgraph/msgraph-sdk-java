...
/**
 * The interface for the Conditional Access Root With Reference Request Builder.
 */
public interface IConditionalAccessRootWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IConditionalAccessRootWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IConditionalAccessRootWithReferenceRequest instance
     */
    IConditionalAccessRootWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IConditionalAccessRootReferenceRequestBuilder reference();
