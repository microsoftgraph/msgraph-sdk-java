...
import com.microsoft.graph.models.extensions.CallRecordBody;
...
public class CallRecordRequest extends BaseRequest implements ICallRecordRequest {
    protected final CallRecordBody body;

    /**
     * The request for this CallRecord
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public CallRecordRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the updated request
     */
    public ICallRecordRequest top(final int value) {
