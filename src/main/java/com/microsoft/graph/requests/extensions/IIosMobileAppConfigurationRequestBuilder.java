...
public interface IIosMobileAppConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IIosMobileAppConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosMobileAppConfigurationRequest instance
     */
    IIosMobileAppConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
