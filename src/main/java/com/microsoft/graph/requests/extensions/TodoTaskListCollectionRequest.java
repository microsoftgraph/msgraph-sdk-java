...
public class TodoTaskListCollectionRequest extends BaseCollectionRequest<TodoTaskListCollectionResponse, ITodoTaskListCollectionPage> implements ITodoTaskListCollectionRequest {
     ...
     */
    public ITodoTaskListCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListCollectionRequest top(final int value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (ITodoTaskListCollectionRequest)this;
    }
    public ITodoTaskListCollectionPage buildFromResponse(final TodoTaskListCollectionResponse response) {
        final ITodoTaskListCollectionRequestBuilder builder;
