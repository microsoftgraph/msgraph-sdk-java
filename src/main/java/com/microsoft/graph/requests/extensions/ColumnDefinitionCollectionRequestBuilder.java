...
public class ColumnDefinitionCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ColumnDefinitionCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ColumnDefinitionCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ColumnDefinitionCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ColumnDefinitionRequestBuilder byId(@Nonnull final String id) {
