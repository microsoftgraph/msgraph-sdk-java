...
public class ColumnDefinitionCollectionRequestBuilder extends BaseCollectionRequestBuilder<ColumnDefinition, ColumnDefinitionRequestBuilder, ColumnDefinitionCollectionResponse, ColumnDefinitionCollectionPage, ColumnDefinitionCollectionRequest> {
    ...
    public ColumnDefinitionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ColumnDefinitionRequestBuilder.class, ColumnDefinitionCollectionResponse.class, ColumnDefinitionCollectionPage.class, ColumnDefinitionCollectionRequest.class);
    }
