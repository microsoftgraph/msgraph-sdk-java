...
public class ApplicationRemovePasswordRequestBuilder extends BaseActionRequestBuilder implements IApplicationRemovePasswordRequestBuilder {
     ...
     */
    public ApplicationRemovePasswordRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.UUID keyId) {
     ...
     * @return the IApplicationRemovePasswordRequest instance
     */
    public IApplicationRemovePasswordRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
