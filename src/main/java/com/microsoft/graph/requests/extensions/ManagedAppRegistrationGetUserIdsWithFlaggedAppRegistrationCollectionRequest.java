 ...
 */
public class ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest extends BaseCollectionRequest<String, ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionResponse> {
    ...
    public void get(final ICallback<? super BaseCollectionPage<String>> callback) {
    ...
    public BaseCollectionPage<String> get() throws ClientException {
        final ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionResponse response = send();
        return buildFromResponse(response);
    }


    public BaseCollectionPage<String> buildFromResponse(final ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionResponse response) {
