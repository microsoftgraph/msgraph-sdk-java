...
public class ChatWithReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ChatWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ChatWithReferenceRequest instance
     */
    public ChatWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
