...
public class WorkbookRangeRowsAboveRequestBuilder extends BaseFunctionRequestBuilder<WorkbookRange> {
     ...
     */
    public WorkbookRangeRowsAboveRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookRangeRowsAboveBody parameters) {
        super(requestUrl, client, requestOptions);
