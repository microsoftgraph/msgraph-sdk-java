...
public class DeviceManagementTroubleshootingEventCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public DeviceManagementTroubleshootingEventCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceManagementTroubleshootingEventCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new DeviceManagementTroubleshootingEventCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public DeviceManagementTroubleshootingEventRequestBuilder byId(@Nonnull final String id) {
