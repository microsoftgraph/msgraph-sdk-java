...
import com.microsoft.graph.requests.extensions.ICallRecordRequest;
import com.microsoft.graph.requests.extensions.CallRecordRequest;
 ...
 */
public class CallRecordRequestBuilder extends BaseActionRequestBuilder implements ICallRecordRequestBuilder {
     ...
     */
    public CallRecordRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<Prompt> prompts, final Boolean bargeInAllowed, final Integer initialSilenceTimeoutInSeconds, final Integer maxSilenceTimeoutInSeconds, final Integer maxRecordDurationInSeconds, final Boolean playBeep, final java.util.List<String> stopTones, final String clientContext) {
    ...
    /**
     * Creates the ICallRecordRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the ICallRecordRequest instance
     */
    public ICallRecordRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
