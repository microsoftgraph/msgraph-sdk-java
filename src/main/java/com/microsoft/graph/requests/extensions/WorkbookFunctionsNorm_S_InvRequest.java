 ...
 */
public class WorkbookFunctionsNorm_S_InvRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsNorm_S_InvRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsNorm_S_InvRequest expand(final String value) {
