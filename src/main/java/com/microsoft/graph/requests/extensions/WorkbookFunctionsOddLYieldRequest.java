...
public class WorkbookFunctionsOddLYieldRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsOddLYieldRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsOddLYieldBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsOddLYieldBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsOddLYieldRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsOddLYieldRequest count() {
        addCountOption(true);
        return this;
    }
