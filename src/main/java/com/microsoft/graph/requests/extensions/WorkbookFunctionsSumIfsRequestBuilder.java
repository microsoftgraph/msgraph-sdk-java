...
public class WorkbookFunctionsSumIfsRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsSumIfsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsSumIfsRequest instance
     */
    public WorkbookFunctionsSumIfsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
