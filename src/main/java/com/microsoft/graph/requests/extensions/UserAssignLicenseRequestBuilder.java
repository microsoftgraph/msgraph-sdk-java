...
public class UserAssignLicenseRequestBuilder extends BaseActionRequestBuilder<User> {
    ...
    private UserAssignLicenseBody body;
    /**
     ...
     */
    public UserAssignLicenseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserAssignLicenseBody parameters) {
