...
/**
 * The interface for the Managed App With Reference Request Builder.
 */
public interface IManagedAppWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IManagedAppWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IManagedAppWithReferenceRequest instance
     */
    IManagedAppWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IManagedAppReferenceRequestBuilder reference();
