 ...
 */
public class ReportRootDeviceConfigurationDeviceActivityRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootDeviceConfigurationDeviceActivityRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootDeviceConfigurationDeviceActivity
    ...
    /**
     * Puts the ReportRootDeviceConfigurationDeviceActivity
     *
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationDeviceActivityRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationDeviceActivityRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationDeviceActivityRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationDeviceActivityRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationDeviceActivityRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootDeviceConfigurationDeviceActivityRequest count() {
        addCountOption(true);
        return this;
    }
}
