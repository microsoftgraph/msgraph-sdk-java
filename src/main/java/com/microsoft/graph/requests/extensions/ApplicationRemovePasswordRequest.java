...
public class ApplicationRemovePasswordRequest extends BaseRequest<Void> {
     ...
     */
    public ApplicationRemovePasswordRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ApplicationRemovePasswordBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ApplicationRemovePasswordBody body;
    /**
