 ...
 */
public class SchedulingGroupCollectionResponse implements ICollectionResponse<SchedulingGroup>, IJsonBackedObject {

    /**
     * The list of SchedulingGroup within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SchedulingGroup> value;

    /**
     * The list of SchedulingGroup within this collection page
     */
    @Override
    public java.util.List<SchedulingGroup> values() {
        return value;
    }
