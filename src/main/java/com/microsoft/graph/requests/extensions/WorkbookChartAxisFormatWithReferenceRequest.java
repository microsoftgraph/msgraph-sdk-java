...
/**
 * The class for the Workbook Chart Axis Format With Reference Request.
 */
public class WorkbookChartAxisFormatWithReferenceRequest extends BaseRequest implements IWorkbookChartAxisFormatWithReferenceRequest {
     ...
     */
    public WorkbookChartAxisFormatWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookChartAxisFormat.class);
    }

    public void post(final WorkbookChartAxisFormat newWorkbookChartAxisFormat, final IJsonBackedObject payload, final ICallback<? super WorkbookChartAxisFormat> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public WorkbookChartAxisFormat post(final WorkbookChartAxisFormat newWorkbookChartAxisFormat, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IWorkbookChartAxisFormatWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IWorkbookChartAxisFormatWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookChartAxisFormatWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (WorkbookChartAxisFormatWithReferenceRequest)this;
    }
}
