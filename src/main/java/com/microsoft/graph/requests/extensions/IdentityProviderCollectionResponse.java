 ...
 */
public class IdentityProviderCollectionResponse implements ICollectionResponse<IdentityProvider>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<IdentityProvider> values() {
        return value;
    }
