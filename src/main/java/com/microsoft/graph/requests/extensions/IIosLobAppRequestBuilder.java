 ...
 */
public interface IIosLobAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosLobAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosLobAppRequest instance
     */
    IIosLobAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
