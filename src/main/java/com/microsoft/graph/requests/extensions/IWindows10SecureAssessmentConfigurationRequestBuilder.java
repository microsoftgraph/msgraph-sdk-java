 ...
 */
public interface IWindows10SecureAssessmentConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows10SecureAssessmentConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows10SecureAssessmentConfigurationRequest instance
     */
    IWindows10SecureAssessmentConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
