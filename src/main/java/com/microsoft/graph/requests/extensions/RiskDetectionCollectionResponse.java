 ...
 */
public class RiskDetectionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of RiskDetection within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<RiskDetection> value;
