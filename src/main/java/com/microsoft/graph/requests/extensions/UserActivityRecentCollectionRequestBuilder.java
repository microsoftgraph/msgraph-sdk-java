...
import com.microsoft.graph.requests.generated.BaseUserActivityRecentCollectionRequestBuilder;
...
public class UserActivityRecentCollectionRequestBuilder extends BaseUserActivityRecentCollectionRequestBuilder implements IUserActivityRecentCollectionRequestBuilder {
     ...
     */
    public UserActivityRecentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
