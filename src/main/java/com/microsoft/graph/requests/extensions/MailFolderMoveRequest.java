...
public class MailFolderMoveRequest extends BaseRequest<MailFolder> {
     ...
     */
    public MailFolderMoveRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MailFolderMoveParameterSet parameters) {
