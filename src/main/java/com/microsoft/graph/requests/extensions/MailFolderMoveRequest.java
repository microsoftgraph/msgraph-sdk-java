...
public class MailFolderMoveRequest extends BaseRequest<MailFolder> {
     ...
     */
    public MailFolderMoveRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MailFolderMoveBody parameters) {
        super(requestUrl, client, requestOptions, MailFolder.class);
        body = parameters;
    }

	/** The body for the method */
    protected MailFolderMoveBody body;
    /**
     ...
     */
    @Nonnull
    public MailFolderMoveRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public MailFolderMoveRequest count() {
        addCountOption(true);
        return this;
    }
