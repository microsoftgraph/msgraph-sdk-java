 ...
 */
public class MailFolderMoveRequest extends BaseRequest implements IMailFolderMoveRequest {
     ...
     * @return the updated request
     */
    public IMailFolderMoveRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IMailFolderMoveRequest orderBy(final String value) {
