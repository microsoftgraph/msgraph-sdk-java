...
import com.microsoft.graph.requests.generated.BaseOnenotePageCollectionRequestBuilder;
...
public class OnenotePageCollectionRequestBuilder extends BaseOnenotePageCollectionRequestBuilder implements IOnenotePageCollectionRequestBuilder {
     ...
     */
    public OnenotePageCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
