...
public class OnenotePageCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public OnenotePageCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OnenotePageCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new OnenotePageCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public OnenotePageRequestBuilder byId(@Nonnull final String id) {
