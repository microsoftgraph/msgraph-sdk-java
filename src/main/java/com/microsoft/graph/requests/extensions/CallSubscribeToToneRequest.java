...
public class CallSubscribeToToneRequest extends BaseRequest<SubscribeToToneOperation> {
     ...
     */
    public CallSubscribeToToneRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallSubscribeToToneBody parameters) {
        super(requestUrl, client, requestOptions, SubscribeToToneOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected CallSubscribeToToneBody body;
    /**
     * Invokes the method and invokes the callback with the result
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final ICallback<? super SubscribeToToneOperation> callback) {
     ...
     */
    @Nonnull
    public CallSubscribeToToneRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public CallSubscribeToToneRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public CallSubscribeToToneRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
