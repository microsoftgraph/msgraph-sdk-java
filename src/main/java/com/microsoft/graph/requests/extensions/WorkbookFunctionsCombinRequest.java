...
public class WorkbookFunctionsCombinRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsCombinRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsCombinBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsCombinBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsCombinRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsCombinRequest count() {
        addCountOption(true);
        return this;
    }
