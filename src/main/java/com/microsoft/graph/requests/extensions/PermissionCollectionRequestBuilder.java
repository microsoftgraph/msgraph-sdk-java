...
import com.microsoft.graph.requests.generated.BasePermissionCollectionRequestBuilder;
...
public class PermissionCollectionRequestBuilder extends BasePermissionCollectionRequestBuilder implements IPermissionCollectionRequestBuilder {
     ...
     */
    public PermissionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
