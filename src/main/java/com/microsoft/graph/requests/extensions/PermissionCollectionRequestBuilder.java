...
public class PermissionCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public PermissionCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PermissionCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PermissionCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public PermissionRequestBuilder byId(@Nonnull final String id) {
