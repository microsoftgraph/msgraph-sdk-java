...
/**
 * The class for the Office Graph Insights Reference Request Builder.
 */
public class OfficeGraphInsightsReferenceRequestBuilder extends BaseRequestBuilder implements IOfficeGraphInsightsReferenceRequestBuilder {
     ...
     */
    public OfficeGraphInsightsReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return The IOfficeGraphInsightsReferenceRequest instance
     */
    public IOfficeGraphInsightsReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IOfficeGraphInsightsReferenceRequest instance
     */
    public IOfficeGraphInsightsReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new OfficeGraphInsightsReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
