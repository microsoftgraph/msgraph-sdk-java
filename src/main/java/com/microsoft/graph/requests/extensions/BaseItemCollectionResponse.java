 ...
 */
public class BaseItemCollectionResponse implements ICollectionResponse<BaseItem>, IJsonBackedObject {

    /**
     * The list of BaseItem within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<BaseItem> value;

    /**
     * The list of BaseItem within this collection page
     */
    @Override
    public java.util.List<BaseItem> values() {
        return value;
    }
