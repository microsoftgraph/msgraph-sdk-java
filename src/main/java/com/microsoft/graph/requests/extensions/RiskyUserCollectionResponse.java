 ...
 */
public class RiskyUserCollectionResponse implements IJsonBackedObject {

    /**
     * The list of RiskyUser within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<RiskyUser> value;
