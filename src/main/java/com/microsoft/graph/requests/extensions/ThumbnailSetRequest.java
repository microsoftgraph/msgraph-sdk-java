...
import com.microsoft.graph.requests.generated.BaseThumbnailSetRequest;
...
public class ThumbnailSetRequest extends BaseThumbnailSetRequest implements IThumbnailSetRequest {
     ...
     */
    public ThumbnailSetRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
