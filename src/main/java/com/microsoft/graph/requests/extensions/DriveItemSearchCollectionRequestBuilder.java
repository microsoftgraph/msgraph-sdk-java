 ...
 */
public class DriveItemSearchCollectionRequestBuilder extends BaseFunctionRequestBuilder<DriveItem> {
     ...
     */
    public DriveItemSearchCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
