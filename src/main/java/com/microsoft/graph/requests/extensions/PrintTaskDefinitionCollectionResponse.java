 ...
 */
public class PrintTaskDefinitionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintTaskDefinition within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintTaskDefinition> value;
