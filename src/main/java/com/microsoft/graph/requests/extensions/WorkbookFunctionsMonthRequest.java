...
public class WorkbookFunctionsMonthRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMonthRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMonthBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsMonthBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsMonthRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsMonthRequest count() {
        addCountOption(true);
        return this;
    }
