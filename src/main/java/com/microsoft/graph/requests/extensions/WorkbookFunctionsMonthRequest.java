...
public class WorkbookFunctionsMonthRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMonthRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMonthParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsMonthParameterSet body;
    /**
