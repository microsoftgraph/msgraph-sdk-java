...
public class IosManagedAppProtectionCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public IosManagedAppProtectionCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosManagedAppProtectionCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new IosManagedAppProtectionCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public IosManagedAppProtectionRequestBuilder byId(@Nonnull final String id) {
