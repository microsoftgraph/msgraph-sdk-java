...
public class IosManagedAppProtectionCollectionRequestBuilder extends BaseCollectionRequestBuilder<IosManagedAppProtection, IosManagedAppProtectionRequestBuilder, IosManagedAppProtectionCollectionResponse, IosManagedAppProtectionCollectionPage, IosManagedAppProtectionCollectionRequest> {
    ...
    public IosManagedAppProtectionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, IosManagedAppProtectionRequestBuilder.class, IosManagedAppProtectionCollectionResponse.class, IosManagedAppProtectionCollectionPage.class, IosManagedAppProtectionCollectionRequest.class);
    }
