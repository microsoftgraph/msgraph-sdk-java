...
public class WorkbookFunctionsIsNonTextRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsIsNonTextBody body;
    /**
     ...
     */
    public WorkbookFunctionsIsNonTextRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsIsNonTextBody parameters) {
