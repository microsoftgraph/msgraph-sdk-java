...
public class ReportRootGetYammerDeviceUsageDistributionUserCountsRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetYammerDeviceUsageDistributionUserCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetYammerDeviceUsageDistributionUserCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetYammerDeviceUsageDistributionUserCountsRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootGetYammerDeviceUsageDistributionUserCountsRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
