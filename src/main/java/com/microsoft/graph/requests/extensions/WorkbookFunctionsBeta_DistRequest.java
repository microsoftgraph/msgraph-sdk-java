 ...
 */
public class WorkbookFunctionsBeta_DistRequest extends BaseRequest implements IWorkbookFunctionsBeta_DistRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsBeta_DistRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFunctionsBeta_DistRequest orderBy(final String value) {
