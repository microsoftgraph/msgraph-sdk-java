...
public class WorkbookFunctionsErfCRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsErfCRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsErfCBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsErfCBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsErfCRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsErfCRequest count() {
        addCountOption(true);
        return this;
    }
