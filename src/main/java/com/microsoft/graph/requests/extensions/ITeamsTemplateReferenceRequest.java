...
/**
 * The interface for the Teams Template Reference Request.
 */
public interface ITeamsTemplateReferenceRequest extends IHttpRequest {
     ...
     */
    ITeamsTemplateReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    ITeamsTemplateReferenceRequest expand(final String value);
     ...
     */
    TeamsTemplate put(TeamsTemplate srcTeamsTemplate) throws ClientException;
}
