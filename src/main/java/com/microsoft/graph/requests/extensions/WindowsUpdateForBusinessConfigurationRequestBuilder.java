...
public class WindowsUpdateForBusinessConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WindowsUpdateForBusinessConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WindowsUpdateForBusinessConfigurationRequest instance
     */
    public WindowsUpdateForBusinessConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
