 ...
 */
public class SiteGetActivitiesByIntervalCollectionRequest extends BaseCollectionRequest<ItemActivityStat, SiteGetActivitiesByIntervalCollectionResponse> {
    ...
    public BaseCollectionPage<ItemActivityStat> buildFromResponse(final SiteGetActivitiesByIntervalCollectionResponse response) {
