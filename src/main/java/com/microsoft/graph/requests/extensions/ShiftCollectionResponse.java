...
/**
 * The class for the Shift Collection Response.
 */
public class ShiftCollectionResponse implements ICollectionResponse<Shift>, IJsonBackedObject {

    /**
     * The list of Shift within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Shift> value;

    /**
     * The list of Shift within this collection page
     */
    @Override
    public java.util.List<Shift> values() {
        return value;
    }
