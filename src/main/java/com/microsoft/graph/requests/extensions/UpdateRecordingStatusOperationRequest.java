...
public class UpdateRecordingStatusOperationRequest extends BaseRequest implements IUpdateRecordingStatusOperationRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final UpdateRecordingStatusOperation newUpdateRecordingStatusOperation, final ICallback<UpdateRecordingStatusOperation> callback) {
     ...
     * @return the updated request
     */
     public IUpdateRecordingStatusOperationRequest filter(final String value) {
