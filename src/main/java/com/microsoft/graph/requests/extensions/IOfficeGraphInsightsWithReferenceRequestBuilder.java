...
/**
 * The interface for the Office Graph Insights With Reference Request Builder.
 */
public interface IOfficeGraphInsightsWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IOfficeGraphInsightsWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOfficeGraphInsightsWithReferenceRequest instance
     */
    IOfficeGraphInsightsWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IOfficeGraphInsightsReferenceRequestBuilder reference();
