...
public class WorkbookFunctionsF_DistRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsF_DistParameterSet body;
    /**
     ...
     */
    public WorkbookFunctionsF_DistRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsF_DistParameterSet parameters) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsF_DistRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
