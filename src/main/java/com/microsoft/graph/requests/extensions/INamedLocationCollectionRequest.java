...
/**
 * The interface for the Named Location Collection Request.
 */
public interface INamedLocationCollectionRequest {
     ...
     */
    INamedLocationCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    INamedLocationCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    INamedLocationCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    INamedLocationCollectionRequest skip(final int value);
