...
/**
 * The interface for the Workbook With Reference Request Builder.
 */
public interface IWorkbookWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookWithReferenceRequest instance
     */
    IWorkbookWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IWorkbookReferenceRequestBuilder reference();
