...
public class ChannelCollectionRequest extends BaseCollectionRequest<ChannelCollectionResponse, ChannelCollectionPage> {
    ...
    public void get(final ICallback<? super ChannelCollectionPage> callback) {
    ...
    public ChannelCollectionPage buildFromResponse(final ChannelCollectionResponse response) {
