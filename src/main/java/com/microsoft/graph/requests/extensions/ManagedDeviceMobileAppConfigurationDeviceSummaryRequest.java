...
public class ManagedDeviceMobileAppConfigurationDeviceSummaryRequest extends BaseRequest<ManagedDeviceMobileAppConfigurationDeviceSummary> {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationDeviceSummaryRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedDeviceMobileAppConfigurationDeviceSummaryRequest count() {
        addCountOption(true);
        return this;
    }
}
