...
public class NotebookGetNotebookFromWebUrlRequest extends BaseRequest<CopyNotebookModel> {
     ...
     */
    public NotebookGetNotebookFromWebUrlRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final NotebookGetNotebookFromWebUrlBody parameters) {
        super(requestUrl, client, requestOptions, CopyNotebookModel.class);
        body = parameters;
    }

	/** The body for the method */
    protected NotebookGetNotebookFromWebUrlBody body;
    /**
     * Invokes the method and invokes the callback with the result
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final ICallback<? super CopyNotebookModel> callback) {
     ...
     */
    @Nonnull
    public NotebookGetNotebookFromWebUrlRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public NotebookGetNotebookFromWebUrlRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public NotebookGetNotebookFromWebUrlRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
