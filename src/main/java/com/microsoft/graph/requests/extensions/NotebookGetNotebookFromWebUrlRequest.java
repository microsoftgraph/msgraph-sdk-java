...
public class NotebookGetNotebookFromWebUrlRequest extends BaseRequest<CopyNotebookModel> {
     ...
     */
    public NotebookGetNotebookFromWebUrlRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final NotebookGetNotebookFromWebUrlParameterSet parameters) {
    ...
    @Nullable
    protected NotebookGetNotebookFromWebUrlParameterSet body;
    /**
