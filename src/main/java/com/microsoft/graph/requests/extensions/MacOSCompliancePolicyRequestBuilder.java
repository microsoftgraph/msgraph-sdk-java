...
public class MacOSCompliancePolicyRequestBuilder extends BaseRequestBuilder<MacOSCompliancePolicy> {
     ...
     */
    public MacOSCompliancePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the MacOSCompliancePolicyRequest instance
     */
    public MacOSCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
