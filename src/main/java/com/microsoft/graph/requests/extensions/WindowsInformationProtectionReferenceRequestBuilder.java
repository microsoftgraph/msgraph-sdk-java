...
/**
 * The class for the Windows Information Protection Reference Request Builder.
 */
public class WindowsInformationProtectionReferenceRequestBuilder extends BaseRequestBuilder implements IWindowsInformationProtectionReferenceRequestBuilder {
     ...
     */
    public WindowsInformationProtectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsInformationProtectionReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsInformationProtectionReferenceRequest instance
     */
    public IWindowsInformationProtectionReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WindowsInformationProtectionReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
