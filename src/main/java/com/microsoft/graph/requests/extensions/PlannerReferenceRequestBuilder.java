...
/**
 * The class for the Planner Reference Request Builder.
 */
public class PlannerReferenceRequestBuilder extends BaseRequestBuilder implements IPlannerReferenceRequestBuilder {
     ...
     */
    public PlannerReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return The IPlannerReferenceRequest instance
     */
    public IPlannerReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPlannerReferenceRequest instance
     */
    public IPlannerReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new PlannerReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
