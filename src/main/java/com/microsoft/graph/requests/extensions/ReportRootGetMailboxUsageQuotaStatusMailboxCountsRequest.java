 ...
 */
public class ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetMailboxUsageQuotaStatusMailboxCounts
    ...
    /**
     * Puts the ReportRootGetMailboxUsageQuotaStatusMailboxCounts
     *
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest count() {
        addCountOption(true);
        return this;
    }
}
