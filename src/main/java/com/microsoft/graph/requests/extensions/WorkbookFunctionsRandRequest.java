...
public class WorkbookFunctionsRandRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    @Nonnull
    public WorkbookFunctionsRandRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsRandRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookFunctionsRandRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
