 ...
 */
public interface IReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest extends IHttpRequest {

    /**
     * Patches the ReportRootGetSkypeForBusinessParticipantActivityMinuteCounts
     *
    ...
    /**
     * Puts the ReportRootGetSkypeForBusinessParticipantActivityMinuteCounts
     *
     ...
     */
    IReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest expand(final String value);
