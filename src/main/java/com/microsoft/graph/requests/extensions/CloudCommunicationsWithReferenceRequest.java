...
/**
 * The class for the Cloud Communications With Reference Request.
 */
public class CloudCommunicationsWithReferenceRequest extends BaseRequest implements ICloudCommunicationsWithReferenceRequest {
     ...
     */
    public CloudCommunicationsWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, CloudCommunications.class);
    }

    public void post(final CloudCommunications newCloudCommunications, final IJsonBackedObject payload, final ICallback<? super CloudCommunications> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public CloudCommunications post(final CloudCommunications newCloudCommunications, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newCloudCommunications;
        }
        return null;
    }
     ...
     */
    public ICloudCommunicationsWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (ICloudCommunicationsWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public ICloudCommunicationsWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (CloudCommunicationsWithReferenceRequest)this;
    }
}
