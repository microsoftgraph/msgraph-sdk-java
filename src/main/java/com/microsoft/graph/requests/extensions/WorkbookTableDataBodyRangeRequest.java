...
public class WorkbookTableDataBodyRangeRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    public WorkbookTableDataBodyRangeRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableDataBodyRangeRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookTableDataBodyRangeRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookTableDataBodyRangeRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
