 ...
 */
public interface IDeviceAndAppManagementRoleDefinitionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceAndAppManagementRoleDefinitionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
