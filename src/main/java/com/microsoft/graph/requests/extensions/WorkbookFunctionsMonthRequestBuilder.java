...
public class WorkbookFunctionsMonthRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsMonthBody body;
    /**
     ...
     */
    public WorkbookFunctionsMonthRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMonthBody parameters) {
