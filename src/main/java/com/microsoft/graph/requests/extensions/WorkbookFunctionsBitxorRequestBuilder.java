...
public class WorkbookFunctionsBitxorRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsBitxorBody body;
    /**
     ...
     */
    public WorkbookFunctionsBitxorRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsBitxorBody parameters) {
