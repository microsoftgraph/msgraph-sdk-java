...
public class CallUpdateRecordingStatusRequest extends BaseRequest<UpdateRecordingStatusOperation> {
     ...
     */
    public CallUpdateRecordingStatusRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallUpdateRecordingStatusBody parameters) {
        super(requestUrl, client, requestOptions, UpdateRecordingStatusOperation.class);
        body = parameters;
    }

	/** The body for the method */
    protected CallUpdateRecordingStatusBody body;
    /**
     * Invokes the method and invokes the callback with the result
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final ICallback<? super UpdateRecordingStatusOperation> callback) {
     ...
     */
    @Nonnull
    public CallUpdateRecordingStatusRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public CallUpdateRecordingStatusRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public CallUpdateRecordingStatusRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
