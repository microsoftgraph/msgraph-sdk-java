...
/**
 * The interface for the Policy Root With Reference Request Builder.
 */
public interface IPolicyRootWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPolicyRootWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPolicyRootWithReferenceRequest instance
     */
    IPolicyRootWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IPolicyRootReferenceRequestBuilder reference();
