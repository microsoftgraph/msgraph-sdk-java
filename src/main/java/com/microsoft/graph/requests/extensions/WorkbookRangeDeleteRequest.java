...
public class WorkbookRangeDeleteRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookRangeDeleteRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookRangeDeleteBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookRangeDeleteBody body;
    /**
