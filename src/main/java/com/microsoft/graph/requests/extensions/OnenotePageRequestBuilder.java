...
public class OnenotePageRequestBuilder extends BaseRequestBuilder<OnenotePage> {
     ...
     */
    @Nonnull
    public OnenotePageCopyToSectionRequestBuilder copyToSection(@Nonnull final OnenotePageCopyToSectionBody parameters) {
     ...
     */
    @Nonnull
    public OnenotePageOnenotePatchContentRequestBuilder onenotePatchContent(@Nonnull final OnenotePageOnenotePatchContentBody parameters) {
