...
public class WorkbookWorksheetProtectionProtectRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookWorksheetProtectionProtectRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookWorksheetProtectionProtectBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookWorksheetProtectionProtectBody body;
    /**
