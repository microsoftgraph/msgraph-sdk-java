...
public class WorkbookWorksheetProtectionProtectRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public WorkbookWorksheetProtectionProtectRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetProtectionProtectRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookWorksheetProtectionProtectRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetProtectionProtectRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookWorksheetProtectionProtectRequest expand(@Nonnull final String value) {
