...
public class WorkbookWorksheetProtectionProtectRequest extends BaseRequest implements IWorkbookWorksheetProtectionProtectRequest {
     ...
     * @return the updated request
     */
    public IWorkbookWorksheetProtectionProtectRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookWorksheetProtectionProtectRequest orderBy(final String value) {
