...
public class ScheduleChangeRequestApproveRequestBuilder extends BaseActionRequestBuilder<ScheduleChangeRequest> {
    ...
    private ScheduleChangeRequestApproveBody body;
    /**
     ...
     */
    public ScheduleChangeRequestApproveRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ScheduleChangeRequestApproveBody parameters) {
