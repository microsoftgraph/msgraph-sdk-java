 ...
 */
public class PrintDocumentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintDocument within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintDocument> value;
