...
import com.microsoft.graph.models.extensions.WorkbookTableColumnItemAtBody;
...
public class WorkbookTableColumnCollectionRequestBuilder extends BaseCollectionRequestBuilder<WorkbookTableColumn, WorkbookTableColumnRequestBuilder, WorkbookTableColumnCollectionResponse, WorkbookTableColumnCollectionPage, WorkbookTableColumnCollectionRequest> {
     ...
     */
    @Nonnull
    public WorkbookTableColumnAddRequestBuilder add(@Nonnull final WorkbookTableColumnAddBody parameters) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnItemAtRequestBuilder itemAt(@Nonnull final WorkbookTableColumnItemAtBody parameters) {
