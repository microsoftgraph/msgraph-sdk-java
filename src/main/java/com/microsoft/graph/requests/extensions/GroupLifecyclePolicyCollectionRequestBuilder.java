 ...
 */
public class GroupLifecyclePolicyCollectionRequestBuilder extends BaseCollectionRequestBuilder<GroupLifecyclePolicy, GroupLifecyclePolicyRequestBuilder, GroupLifecyclePolicyCollectionResponse, GroupLifecyclePolicyCollectionPage, GroupLifecyclePolicyCollectionRequest> {
     ...
     */
    public GroupLifecyclePolicyCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
