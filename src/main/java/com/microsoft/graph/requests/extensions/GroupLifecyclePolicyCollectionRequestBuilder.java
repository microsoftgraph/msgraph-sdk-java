...
public class GroupLifecyclePolicyCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new GroupLifecyclePolicyCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public GroupLifecyclePolicyRequestBuilder byId(@Nonnull final String id) {
