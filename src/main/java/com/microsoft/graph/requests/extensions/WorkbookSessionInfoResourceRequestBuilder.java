...
public class WorkbookSessionInfoResourceRequestBuilder extends BaseFunctionRequestBuilder<WorkbookSessionInfo> {
     ...
     * @param key the key
     */
    public WorkbookSessionInfoResourceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final String key) {
