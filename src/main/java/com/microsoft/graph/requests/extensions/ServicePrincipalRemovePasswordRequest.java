...
public class ServicePrincipalRemovePasswordRequest extends BaseRequest<Void> {
     ...
     */
    public ServicePrincipalRemovePasswordRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ServicePrincipalRemovePasswordBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ServicePrincipalRemovePasswordBody body;
    /**
