...
public class WorkbookFunctionsIsErrRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsIsErrRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsIsErrRequest instance
     */
    public WorkbookFunctionsIsErrRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
