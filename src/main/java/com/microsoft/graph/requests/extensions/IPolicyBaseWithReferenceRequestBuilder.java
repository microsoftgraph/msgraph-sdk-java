...
/**
 * The interface for the Policy Base With Reference Request Builder.
 */
public interface IPolicyBaseWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPolicyBaseWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPolicyBaseWithReferenceRequest instance
     */
    IPolicyBaseWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IPolicyBaseReferenceRequestBuilder reference();
