 ...
 */
public class WorkbookFunctionsHyperlinkRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsHyperlinkRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsHyperlinkRequest instance
     */
    public WorkbookFunctionsHyperlinkRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
