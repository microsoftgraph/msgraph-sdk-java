...
/**
 * The interface for the Planner With Reference Request Builder.
 */
public interface IPlannerWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPlannerWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPlannerWithReferenceRequest instance
     */
    IPlannerWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IPlannerReferenceRequestBuilder reference();
