...
public class AndroidWorkProfileGeneralDeviceConfigurationRequest extends BaseRequest implements IAndroidWorkProfileGeneralDeviceConfigurationRequest {
     ...
     * @return the updated request
     */
     public IAndroidWorkProfileGeneralDeviceConfigurationRequest filter(final String value) {
     ...
     * @return the updated request
     */
     public IAndroidWorkProfileGeneralDeviceConfigurationRequest orderBy(final String value) {
