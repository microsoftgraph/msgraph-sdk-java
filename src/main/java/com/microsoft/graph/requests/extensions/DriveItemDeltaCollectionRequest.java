 ...
 */
public class DriveItemDeltaCollectionRequest extends BaseCollectionRequest<DriveItem, DriveItemDeltaCollectionResponse> {
    ...
    public BaseCollectionPage<DriveItem> buildFromResponse(final DriveItemDeltaCollectionResponse response) {
