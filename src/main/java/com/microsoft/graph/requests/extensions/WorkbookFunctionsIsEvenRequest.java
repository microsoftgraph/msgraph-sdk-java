 ...
 */
public class WorkbookFunctionsIsEvenRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsIsEvenRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsIsEvenRequest expand(final String value) {
