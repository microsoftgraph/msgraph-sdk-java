...
public class WorkbookFunctionsIsEvenRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsIsEvenRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsIsEvenBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsIsEvenBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsIsEvenRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsIsEvenRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookFunctionsIsEvenRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
