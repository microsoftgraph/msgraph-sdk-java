...
import com.microsoft.graph.requests.generated.BaseWorkbookWorksheetUsedRangeRequest;
...
public class WorkbookWorksheetUsedRangeRequest extends BaseWorkbookWorksheetUsedRangeRequest implements IWorkbookWorksheetUsedRangeRequest {
     ...
     */
    public WorkbookWorksheetUsedRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
