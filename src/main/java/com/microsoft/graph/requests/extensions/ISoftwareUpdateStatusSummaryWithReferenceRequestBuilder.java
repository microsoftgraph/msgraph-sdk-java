 ...
 */
public interface ISoftwareUpdateStatusSummaryWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     * @return the ISoftwareUpdateStatusSummaryWithReferenceRequest instance
     */
    ISoftwareUpdateStatusSummaryWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
