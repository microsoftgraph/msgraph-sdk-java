...
public class WorkbookRangeLastColumnRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    @Nonnull
    public WorkbookRangeLastColumnRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeLastColumnRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeLastColumnRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeLastColumnRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookRangeLastColumnRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
