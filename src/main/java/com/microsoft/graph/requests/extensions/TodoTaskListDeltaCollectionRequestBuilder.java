...
public class TodoTaskListDeltaCollectionRequestBuilder extends BaseFunctionRequestBuilder implements ITodoTaskListDeltaCollectionRequestBuilder {
     ...
     */
    public ITodoTaskListDeltaCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public ITodoTaskListDeltaCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
