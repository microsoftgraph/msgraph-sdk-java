...
public class WindowsDefenderAdvancedThreatProtectionConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WindowsDefenderAdvancedThreatProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WindowsDefenderAdvancedThreatProtectionConfigurationRequest instance
     */
    public WindowsDefenderAdvancedThreatProtectionConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
