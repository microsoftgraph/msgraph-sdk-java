...
public class WorkbookFilterApplyTopPercentFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyTopPercentFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopPercentFilterRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopPercentFilterRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopPercentFilterRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookFilterApplyTopPercentFilterRequest expand(@Nonnull final String value) {
