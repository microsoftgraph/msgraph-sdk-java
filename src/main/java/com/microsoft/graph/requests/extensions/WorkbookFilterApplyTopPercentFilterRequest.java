...
public class WorkbookFilterApplyTopPercentFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyTopPercentFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyTopPercentFilterBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFilterApplyTopPercentFilterBody body;
    /**
