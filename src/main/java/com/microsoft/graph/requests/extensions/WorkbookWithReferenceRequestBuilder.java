...
/**
 * The class for the Workbook With Reference Request Builder.
 */
public class WorkbookWithReferenceRequestBuilder extends BaseRequestBuilder implements IWorkbookWithReferenceRequestBuilder {
     ...
     */
    public WorkbookWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IWorkbookWithReferenceRequest instance
     */
    public IWorkbookWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWorkbookWithReferenceRequest instance
     */
    public IWorkbookWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new WorkbookWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IWorkbookReferenceRequestBuilder reference(){
        return new WorkbookReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
