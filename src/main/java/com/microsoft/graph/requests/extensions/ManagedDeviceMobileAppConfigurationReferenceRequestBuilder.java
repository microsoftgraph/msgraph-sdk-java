...
/**
 * The class for the Managed Device Mobile App Configuration Reference Request Builder.
 */
public class ManagedDeviceMobileAppConfigurationReferenceRequestBuilder extends BaseRequestBuilder implements IManagedDeviceMobileAppConfigurationReferenceRequestBuilder {
     ...
     */
    public ManagedDeviceMobileAppConfigurationReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IManagedDeviceMobileAppConfigurationReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IManagedDeviceMobileAppConfigurationReferenceRequest instance
     */
    public IManagedDeviceMobileAppConfigurationReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ManagedDeviceMobileAppConfigurationReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
