 ...
 */
public class ThumbnailSetCollectionRequest extends BaseCollectionRequest<ThumbnailSetCollectionResponse, ThumbnailSetCollectionPage> {
    ...
    public ThumbnailSetCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ThumbnailSetCollectionResponse.class, ThumbnailSetCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super ThumbnailSetCollectionPage> callback) {
    ...
    @Nonnull
    public ThumbnailSetCollectionPage get() throws ClientException {
    ...
    @Nonnull
    public ThumbnailSetCollectionPage buildFromResponse(@Nonnull final ThumbnailSetCollectionResponse response) {
