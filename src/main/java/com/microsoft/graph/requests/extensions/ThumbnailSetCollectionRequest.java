...
import com.microsoft.graph.requests.generated.BaseThumbnailSetCollectionRequest;
...
public class ThumbnailSetCollectionRequest extends BaseThumbnailSetCollectionRequest implements IThumbnailSetCollectionRequest {
     ...
     */
    public ThumbnailSetCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
