...
public class ThumbnailSetCollectionRequest extends BaseCollectionRequest<ThumbnailSetCollectionResponse, ThumbnailSetCollectionPage> {
    ...
    public void get(final ICallback<? super ThumbnailSetCollectionPage> callback) {
    ...
    public ThumbnailSetCollectionPage buildFromResponse(final ThumbnailSetCollectionResponse response) {
