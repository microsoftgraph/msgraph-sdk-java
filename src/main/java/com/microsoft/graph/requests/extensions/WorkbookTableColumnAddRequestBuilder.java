...
public class WorkbookTableColumnAddRequestBuilder extends BaseActionRequestBuilder implements IWorkbookTableColumnAddRequestBuilder {
     ...
     * @param name the name
     */
    public WorkbookTableColumnAddRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final Integer index, final com.google.gson.JsonElement values, final String name) {
