...
/**
 * The interface for the Device App Management With Reference Request Builder.
 */
public interface IDeviceAppManagementWithReferenceRequestBuilder extends IRequestBuilder {

    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IDeviceAppManagementWithReferenceRequest instance
     */
    IDeviceAppManagementWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceAppManagementWithReferenceRequest instance
     */
    IDeviceAppManagementWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IDeviceAppManagementReferenceRequestBuilder reference();
