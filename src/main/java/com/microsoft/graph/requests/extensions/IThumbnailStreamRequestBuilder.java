 ...
 */
public interface IThumbnailStreamRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IThumbnailStreamRequest instance
     */
    IThumbnailStreamRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
