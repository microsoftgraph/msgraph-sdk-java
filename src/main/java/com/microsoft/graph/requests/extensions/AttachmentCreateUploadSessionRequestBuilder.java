...
public class AttachmentCreateUploadSessionRequestBuilder extends BaseActionRequestBuilder implements IAttachmentCreateUploadSessionRequestBuilder {
     ...
     */
    public AttachmentCreateUploadSessionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final AttachmentItem attachmentItem) {
     ...
     * @return the IAttachmentCreateUploadSessionRequest instance
     */
    public IAttachmentCreateUploadSessionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
