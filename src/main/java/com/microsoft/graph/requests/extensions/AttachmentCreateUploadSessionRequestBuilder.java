...
public class AttachmentCreateUploadSessionRequestBuilder extends BaseActionRequestBuilder<UploadSession> {
     ...
     */
    public AttachmentCreateUploadSessionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nullable final AttachmentItem attachmentItem) {
