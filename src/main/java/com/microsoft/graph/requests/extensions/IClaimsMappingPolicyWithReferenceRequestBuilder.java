...
/**
 * The interface for the Claims Mapping Policy With Reference Request Builder.
 */
public interface IClaimsMappingPolicyWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IClaimsMappingPolicyWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
