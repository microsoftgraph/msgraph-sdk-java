...
/**
 * The interface for the Call Reference Request Builder.
 */
public interface ICallReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ICallReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ICallReferenceRequest instance
     */
    ICallReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
