...
public class UserCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public UserCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UserCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new UserCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public UserRequestBuilder byId(@Nonnull final String id) {
