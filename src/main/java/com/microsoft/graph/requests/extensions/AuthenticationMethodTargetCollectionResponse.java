 ...
 */
public class AuthenticationMethodTargetCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AuthenticationMethodTarget within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AuthenticationMethodTarget> value;
