...
import com.microsoft.graph.requests.generated.BaseManagedEBookAssignmentRequest;
 ...
 */
public class ManagedEBookAssignmentRequest extends BaseManagedEBookAssignmentRequest implements IManagedEBookAssignmentRequest {
     ...
     * @param requestOptions the options for this request
     */
    public ManagedEBookAssignmentRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
