...
public class ServicePrincipalRemoveKeyRequest extends BaseRequest<Void> {
     ...
     */
    public ServicePrincipalRemoveKeyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ServicePrincipalRemoveKeyParameterSet parameters) {
