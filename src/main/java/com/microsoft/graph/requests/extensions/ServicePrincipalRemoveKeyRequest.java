...
public class ServicePrincipalRemoveKeyRequest extends BaseRequest<Void> {
     ...
     */
    public ServicePrincipalRemoveKeyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ServicePrincipalRemoveKeyBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ServicePrincipalRemoveKeyBody body;
    /**
