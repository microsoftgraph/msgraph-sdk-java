...
public class ServicePrincipalRemoveKeyRequest extends BaseRequest<Void> {
     ...
     */
    public ServicePrincipalRemoveKeyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ServicePrincipalRemoveKeyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ServicePrincipalRemoveKeyRequest count() {
        addCountOption(true);
        return this;
    }
    /**
