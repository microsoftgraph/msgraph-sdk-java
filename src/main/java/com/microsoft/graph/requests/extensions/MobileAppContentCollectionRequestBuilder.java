...
public class MobileAppContentCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public MobileAppContentCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MobileAppContentCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new MobileAppContentCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public MobileAppContentRequestBuilder byId(@Nonnull final String id) {
