...
public class OnenoteSectionCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public OnenoteSectionCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OnenoteSectionCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new OnenoteSectionCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public OnenoteSectionRequestBuilder byId(@Nonnull final String id) {
