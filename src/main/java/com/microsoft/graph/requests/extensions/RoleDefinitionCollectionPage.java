...
public class RoleDefinitionCollectionPage extends BaseCollectionPage<RoleDefinition, RoleDefinitionCollectionRequestBuilder> {
     ...
     */
    public RoleDefinitionCollectionPage(@Nonnull final java.util.List<RoleDefinition> pageContents, @Nullable final RoleDefinitionCollectionRequestBuilder nextRequestBuilder) {
