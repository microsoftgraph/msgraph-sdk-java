 ...
 */
public interface IReportRootGetSharePointSiteUsageDetailRequest extends IHttpRequest {
     ...
     */
    IReportRootGetSharePointSiteUsageDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetSharePointSiteUsageDetailRequest expand(final String value);
