 ...
 */
public interface IManagedAppPolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IManagedAppPolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
