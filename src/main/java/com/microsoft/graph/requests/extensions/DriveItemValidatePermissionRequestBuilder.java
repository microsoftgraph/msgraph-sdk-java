...
public class DriveItemValidatePermissionRequestBuilder extends BaseActionRequestBuilder implements IDriveItemValidatePermissionRequestBuilder {
     ...
     */
    public DriveItemValidatePermissionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String challengeToken, final String password) {
     ...
     * @return the IDriveItemValidatePermissionRequest instance
     */
    public IDriveItemValidatePermissionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
