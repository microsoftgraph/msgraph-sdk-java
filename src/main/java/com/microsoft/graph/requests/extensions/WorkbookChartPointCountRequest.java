...
public class WorkbookChartPointCountRequest extends BaseRequest<Integer> {
     ...
     */
    @Nonnull
    public WorkbookChartPointCountRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookChartPointCountRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookChartPointCountRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
