...
public class EventDeclineRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public EventDeclineRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EventDeclineRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public EventDeclineRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public EventDeclineRequest expand(@Nonnull final String value) {
