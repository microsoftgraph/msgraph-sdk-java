...
public class EventDeclineRequest extends BaseRequest<Void> {
     ...
     */
    public EventDeclineRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final EventDeclineBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected EventDeclineBody body;
    /**
