...
public class TokenIssuancePolicyCollectionReferenceRequestBuilder extends BaseRequestBuilder implements ITokenIssuancePolicyCollectionReferenceRequestBuilder {
     ...
     */
    public TokenIssuancePolicyCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITokenIssuancePolicyCollectionReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
