 ...
 */
public class EducationUserCollectionResponse implements ICollectionResponse<EducationUser>, IJsonBackedObject {

    /**
     * The list of EducationUser within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationUser> value;

    /**
     * The list of EducationUser within this collection page
     */
    @Override
    public java.util.List<EducationUser> values() {
        return value;
    }
