...
public class ChatMessageHostedContentCollectionRequestBuilder extends BaseRequestBuilder implements IChatMessageHostedContentCollectionRequestBuilder {
     ...
     */
    public ChatMessageHostedContentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IChatMessageHostedContentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
