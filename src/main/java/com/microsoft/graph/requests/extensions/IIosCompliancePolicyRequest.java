 ...
 */
public interface IIosCompliancePolicyRequest extends IHttpRequest {
     ...
     */
    IIosCompliancePolicyRequest select(final String value);
     ...
     * @return the updated request
     */
    IIosCompliancePolicyRequest expand(final String value);
