...
/**
 * The class for the Education Root Reference Request Builder.
 */
public class EducationRootReferenceRequestBuilder extends BaseRequestBuilder implements IEducationRootReferenceRequestBuilder {
     ...
     */
    public EducationRootReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return The IEducationRootReferenceRequest instance
     */
    public IEducationRootReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IEducationRootReferenceRequest instance
     */
    public IEducationRootReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new EducationRootReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
