...
import com.microsoft.graph.requests.generated.BaseDirectoryRoleTemplateRequest;
...
public class DirectoryRoleTemplateRequest extends BaseDirectoryRoleTemplateRequest implements IDirectoryRoleTemplateRequest {
     ...
     */
    public DirectoryRoleTemplateRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
