...
public class EventRequestBuilder extends BaseRequestBuilder<Event> {
     ...
     */
    @Nonnull
    public EventAcceptRequestBuilder accept(@Nonnull final EventAcceptBody parameters) {
     ...
     */
    @Nonnull
    public EventCancelRequestBuilder cancel(@Nonnull final EventCancelBody parameters) {
     ...
     */
    @Nonnull
    public EventDeclineRequestBuilder decline(@Nonnull final EventDeclineBody parameters) {
     ...
     */
    @Nonnull
    public EventForwardRequestBuilder forward(@Nonnull final EventForwardBody parameters) {
     ...
     */
    @Nonnull
    public EventSnoozeReminderRequestBuilder snoozeReminder(@Nonnull final EventSnoozeReminderBody parameters) {
     ...
     */
    @Nonnull
    public EventTentativelyAcceptRequestBuilder tentativelyAccept(@Nonnull final EventTentativelyAcceptBody parameters) {
