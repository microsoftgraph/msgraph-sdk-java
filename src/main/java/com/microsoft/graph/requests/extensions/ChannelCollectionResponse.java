 ...
 */
public class ChannelCollectionResponse implements ICollectionResponse<Channel>, IJsonBackedObject {

    /**
     * The list of Channel within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Channel> value;

    /**
     * The list of Channel within this collection page
     */
    @Override
    public java.util.List<Channel> values() {
        return value;
    }
