...
public class AttachmentCreateUploadSessionRequest extends BaseRequest<UploadSession> {
     ...
     */
    public AttachmentCreateUploadSessionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final AttachmentCreateUploadSessionBody parameters) {
        super(requestUrl, client, requestOptions, UploadSession.class);
        body = parameters;
    }

	/** The body for the method */
    protected AttachmentCreateUploadSessionBody body;
    /**
     ...
     */
    @Nonnull
    public AttachmentCreateUploadSessionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public AttachmentCreateUploadSessionRequest count() {
        addCountOption(true);
        return this;
    }
