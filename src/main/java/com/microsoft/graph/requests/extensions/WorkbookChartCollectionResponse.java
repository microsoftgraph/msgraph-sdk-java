 ...
 */
public class WorkbookChartCollectionResponse implements ICollectionResponse<WorkbookChart>, IJsonBackedObject {

    /**
     * The list of WorkbookChart within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<WorkbookChart> value;

    /**
     * The list of WorkbookChart within this collection page
     */
    @Override
    public java.util.List<WorkbookChart> values() {
        return value;
    }
