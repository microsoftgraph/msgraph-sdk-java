 ...
 */
public class Fido2AuthenticationMethodCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Fido2AuthenticationMethod within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Fido2AuthenticationMethod> value;
