...
public class CallChangeScreenSharingRoleRequest extends BaseRequest<Void> {
     ...
     */
    public CallChangeScreenSharingRoleRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallChangeScreenSharingRoleParameterSet parameters) {
