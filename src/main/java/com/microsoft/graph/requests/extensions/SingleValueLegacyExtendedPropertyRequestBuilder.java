...
public class SingleValueLegacyExtendedPropertyRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SingleValueLegacyExtendedPropertyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the SingleValueLegacyExtendedPropertyRequest instance
     */
    public SingleValueLegacyExtendedPropertyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
