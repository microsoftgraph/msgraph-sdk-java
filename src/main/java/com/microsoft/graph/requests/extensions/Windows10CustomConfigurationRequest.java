...
public class Windows10CustomConfigurationRequest extends BaseRequest<Windows10CustomConfiguration> {
     ...
     */
    public void get(@Nonnull final ICallback<? super Windows10CustomConfiguration> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super Windows10CustomConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final Windows10CustomConfiguration sourceWindows10CustomConfiguration, @Nonnull final ICallback<? super Windows10CustomConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final Windows10CustomConfiguration newWindows10CustomConfiguration, @Nonnull final ICallback<? super Windows10CustomConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final Windows10CustomConfiguration newWindows10CustomConfiguration, @Nonnull final ICallback<? super Windows10CustomConfiguration> callback) {
     ...
     */
    @Nonnull
    public Windows10CustomConfigurationRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public Windows10CustomConfigurationRequest count() {
        addCountOption(true);
        return this;
    }
}
