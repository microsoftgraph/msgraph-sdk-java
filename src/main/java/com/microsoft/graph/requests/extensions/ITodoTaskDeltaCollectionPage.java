...
/**
 * The interface for the Todo Task Delta Collection Page.
 */
public interface ITodoTaskDeltaCollectionPage extends IBaseCollectionPage<TodoTask, ITodoTaskDeltaCollectionRequestBuilder> {
    /**
