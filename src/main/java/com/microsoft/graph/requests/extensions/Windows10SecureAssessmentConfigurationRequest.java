...
public class Windows10SecureAssessmentConfigurationRequest extends BaseRequest implements IWindows10SecureAssessmentConfigurationRequest {
     ...
     * @return the updated request
     */
     public IWindows10SecureAssessmentConfigurationRequest filter(final String value) {
     ...
     * @return the updated request
     */
     public IWindows10SecureAssessmentConfigurationRequest orderBy(final String value) {
