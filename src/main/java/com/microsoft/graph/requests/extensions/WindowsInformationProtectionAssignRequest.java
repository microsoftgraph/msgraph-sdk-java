...
public class WindowsInformationProtectionAssignRequest extends BaseRequest<Void> {
     ...
     */
    public WindowsInformationProtectionAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WindowsInformationProtectionAssignBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WindowsInformationProtectionAssignBody body;
    /**
