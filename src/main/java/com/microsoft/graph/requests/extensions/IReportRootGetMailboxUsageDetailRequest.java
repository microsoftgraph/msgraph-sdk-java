 ...
 */
public interface IReportRootGetMailboxUsageDetailRequest extends IHttpRequest {
     ...
     */
    IReportRootGetMailboxUsageDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetMailboxUsageDetailRequest expand(final String value);
