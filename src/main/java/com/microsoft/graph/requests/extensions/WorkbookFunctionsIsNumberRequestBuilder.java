...
public class WorkbookFunctionsIsNumberRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsIsNumberBody body;
    /**
     ...
     */
    public WorkbookFunctionsIsNumberRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsIsNumberBody parameters) {
