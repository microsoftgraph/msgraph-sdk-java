...
public class ChatCollectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public ChatCollectionRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ChatCollectionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ChatCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }

    @Nonnull
    public ChatRequestBuilder byId(@Nonnull final String id) {
