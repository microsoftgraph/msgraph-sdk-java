...
public class WorkbookFunctionsT_Dist_2TRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    private WorkbookFunctionsT_Dist_2TBody body;
    /**
     ...
     */
    public WorkbookFunctionsT_Dist_2TRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsT_Dist_2TBody parameters) {
