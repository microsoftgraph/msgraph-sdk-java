 ...
 */
public class TeamsTemplateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public TeamsTemplateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the TeamsTemplateRequest instance
     */
    public TeamsTemplateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
