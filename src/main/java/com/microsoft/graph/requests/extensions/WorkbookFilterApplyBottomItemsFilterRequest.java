...
public class WorkbookFilterApplyBottomItemsFilterRequest extends BaseRequest implements IWorkbookFilterApplyBottomItemsFilterRequest {
     ...
     * @return the updated request
     */
    public IWorkbookFilterApplyBottomItemsFilterRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookFilterApplyBottomItemsFilterRequest orderBy(final String value) {
