...
public class WorkbookFilterApplyBottomItemsFilterRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookFilterApplyBottomItemsFilterRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFilterApplyBottomItemsFilterBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFilterApplyBottomItemsFilterBody body;
    /**
