...
public class TermsAndConditionsAssignmentCollectionRequest extends BaseCollectionRequest<TermsAndConditionsAssignmentCollectionResponse, TermsAndConditionsAssignmentCollectionPage> {
    ...
    public void get(final ICallback<? super TermsAndConditionsAssignmentCollectionPage> callback) {
    ...
    public TermsAndConditionsAssignmentCollectionPage buildFromResponse(final TermsAndConditionsAssignmentCollectionResponse response) {
