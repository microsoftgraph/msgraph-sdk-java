...
/**
 * The interface for the Domain Dns Record With Reference Request Builder.
 */
public interface IDomainDnsRecordWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IDomainDnsRecordWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDomainDnsRecordWithReferenceRequest instance
     */
    IDomainDnsRecordWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IDomainDnsRecordReferenceRequestBuilder reference();
