 ...
 */
public class OnenoteSectionCollectionResponse implements ICollectionResponse<OnenoteSection>, IJsonBackedObject {
     ...
     */
    @Override
    public java.util.List<OnenoteSection> values() {
        return value;
    }
