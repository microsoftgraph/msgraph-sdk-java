...
public class WorkbookRangeSortApplyRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookRangeSortApplyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookRangeSortApplyBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookRangeSortApplyBody body;
    /**
