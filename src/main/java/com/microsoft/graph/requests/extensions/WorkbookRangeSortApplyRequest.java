...
public class WorkbookRangeSortApplyRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public WorkbookRangeSortApplyRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeSortApplyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeSortApplyRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public WorkbookRangeSortApplyRequest expand(@Nonnull final String value) {
