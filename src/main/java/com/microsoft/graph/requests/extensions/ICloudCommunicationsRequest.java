...
/**
 * The interface for the Cloud Communications Request.
 */
public interface ICloudCommunicationsRequest extends IHttpRequest {
     ...
     */
    ICloudCommunicationsRequest select(final String value);
     ...
     * @return the updated request
     */
    ICloudCommunicationsRequest expand(final String value);
