 ...
 */
public interface IWorkbookFunctionsNowRequest extends IHttpRequest {
     ...
     */
    IWorkbookFunctionsNowRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsNowRequest expand(final String value);
