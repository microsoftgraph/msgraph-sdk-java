...
public class ApplicationAddPasswordRequest extends BaseRequest<PasswordCredential> {
     ...
     */
    public ApplicationAddPasswordRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ApplicationAddPasswordBody parameters) {
        super(requestUrl, client, requestOptions, PasswordCredential.class);
        body = parameters;
    }

	/** The body for the method */
    protected ApplicationAddPasswordBody body;
    /**
     ...
     */
    @Nonnull
    public ApplicationAddPasswordRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ApplicationAddPasswordRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ApplicationAddPasswordRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
