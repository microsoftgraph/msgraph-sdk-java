 ...
 */
public class ReportRootGetTeamsDeviceUsageDistributionUserCountsRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetTeamsDeviceUsageDistributionUserCountsRequestBuilder {
     ...
     */
    public ReportRootGetTeamsDeviceUsageDistributionUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String period) {
    ...
    /**
     * Creates the IReportRootGetTeamsDeviceUsageDistributionUserCountsRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IReportRootGetTeamsDeviceUsageDistributionUserCountsRequest instance
     */
    public IReportRootGetTeamsDeviceUsageDistributionUserCountsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
