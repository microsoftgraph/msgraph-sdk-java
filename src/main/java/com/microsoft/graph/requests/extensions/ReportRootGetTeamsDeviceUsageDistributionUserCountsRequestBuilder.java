...
public class ReportRootGetTeamsDeviceUsageDistributionUserCountsRequestBuilder extends BaseFunctionRequestBuilder<Report> {
     ...
     */
    public ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest instance
     */
    public ReportRootGetTeamsDeviceUsageDistributionUserCountsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
