...
public class DriveItemCheckoutRequestBuilder extends BaseActionRequestBuilder implements IDriveItemCheckoutRequestBuilder {
     ...
     */
    public DriveItemCheckoutRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IDriveItemCheckoutRequest instance
     */
    public IDriveItemCheckoutRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
