 ...
 */
public class WorkbookRangeRowsAboveRequest extends BaseRequest<WorkbookRange> {
     ...
     */
    public WorkbookRangeRowsAboveRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookRange.class);
    }

    /**
     * Patches the WorkbookRangeRowsAbove
    ...
    /**
     * Puts the WorkbookRangeRowsAbove
     *
     ...
     */
    @Nonnull
    public WorkbookRangeRowsAboveRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeRowsAboveRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeRowsAboveRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeRowsAboveRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookRangeRowsAboveRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookRangeRowsAboveRequest count() {
        addCountOption(true);
        return this;
    }
}
