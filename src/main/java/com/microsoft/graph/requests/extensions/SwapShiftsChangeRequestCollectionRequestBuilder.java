...
public class SwapShiftsChangeRequestCollectionRequestBuilder extends BaseRequestBuilder implements ISwapShiftsChangeRequestCollectionRequestBuilder {
     ...
     */
    public SwapShiftsChangeRequestCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ISwapShiftsChangeRequestCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
