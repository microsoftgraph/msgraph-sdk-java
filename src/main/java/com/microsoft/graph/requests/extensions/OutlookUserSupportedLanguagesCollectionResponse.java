 ...
 */
public class OutlookUserSupportedLanguagesCollectionResponse implements ICollectionResponse<LocaleInfo>, IJsonBackedObject {

    /**
     * The list of LocaleInfo within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<LocaleInfo> value;

    /**
     * The list of LocaleInfo within this collection page
     */
    @Override
    public java.util.List<LocaleInfo> values() {
        return value;
    }
