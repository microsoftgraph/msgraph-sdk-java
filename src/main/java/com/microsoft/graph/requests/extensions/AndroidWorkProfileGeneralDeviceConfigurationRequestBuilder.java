...
public class AndroidWorkProfileGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public AndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the AndroidWorkProfileGeneralDeviceConfigurationRequest instance
     */
    public AndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
