...
/**
 * The interface for the Item Activity Collection Request.
 */
public interface IItemActivityCollectionRequest extends IHttpRequest {
     ...
     */
    IItemActivityCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IItemActivityCollectionRequest filter(final String value);
     ...
     * @return the updated request
     */
    IItemActivityCollectionRequest orderBy(final String value);
     ...
     * @return the updated request
     */
    IItemActivityCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IItemActivityCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IItemActivityCollectionRequest skip(final int value);
	 ...
	 * @return the updated request
	 */
	IItemActivityCollectionRequest skipToken(final String skipToken);
}
