...
public class DeviceManagementExchangeConnectorSyncRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceManagementExchangeConnectorSyncRequest select(final String value) {
     ...
     * @return the updated request
     */
    public DeviceManagementExchangeConnectorSyncRequest expand(final String value) {
