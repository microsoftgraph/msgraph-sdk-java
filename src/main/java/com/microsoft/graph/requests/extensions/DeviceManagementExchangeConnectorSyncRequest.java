...
public class DeviceManagementExchangeConnectorSyncRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceManagementExchangeConnectorSyncRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DeviceManagementExchangeConnectorSyncBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected DeviceManagementExchangeConnectorSyncBody body;
    /**
