...
public interface IWorkbookFunctionsFactRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsFactRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsFactRequest instance
     */
    IWorkbookFunctionsFactRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
