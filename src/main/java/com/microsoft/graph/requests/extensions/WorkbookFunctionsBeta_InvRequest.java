...
public class WorkbookFunctionsBeta_InvRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsBeta_InvRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsBeta_InvParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsBeta_InvParameterSet body;
    /**
