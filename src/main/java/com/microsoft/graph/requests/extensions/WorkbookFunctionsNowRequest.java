...
public class WorkbookFunctionsNowRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    @Nonnull
    public WorkbookFunctionsNowRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsNowRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public WorkbookFunctionsNowRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
