...
/**
 * The class for the Workbook Chart Data Label Format With Reference Request.
 */
public class WorkbookChartDataLabelFormatWithReferenceRequest extends BaseRequest implements IWorkbookChartDataLabelFormatWithReferenceRequest {
     ...
     */
    public WorkbookChartDataLabelFormatWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookChartDataLabelFormat.class);
    }

    public void post(final WorkbookChartDataLabelFormat newWorkbookChartDataLabelFormat, final IJsonBackedObject payload, final ICallback<? super WorkbookChartDataLabelFormat> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public WorkbookChartDataLabelFormat post(final WorkbookChartDataLabelFormat newWorkbookChartDataLabelFormat, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newWorkbookChartDataLabelFormat;
        }
        return null;
    }
     ...
     */
    public IWorkbookChartDataLabelFormatWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IWorkbookChartDataLabelFormatWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookChartDataLabelFormatWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (WorkbookChartDataLabelFormatWithReferenceRequest)this;
    }
}
