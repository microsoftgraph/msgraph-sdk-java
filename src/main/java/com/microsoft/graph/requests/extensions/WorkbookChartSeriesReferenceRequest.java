...
/**
 * The class for the Workbook Chart Series Reference Request.
 */
public class WorkbookChartSeriesReferenceRequest extends BaseRequest implements IWorkbookChartSeriesReferenceRequest {
     ...
     */
    public WorkbookChartSeriesReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWorkbookChartSeriesReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (WorkbookChartSeriesReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IWorkbookChartSeriesReferenceRequest expand(final String value) {
     ...
     *
     * @param srcWorkbookChartSeries the WorkbookChartSeries reference to PUT
    ...
    public WorkbookChartSeries put(WorkbookChartSeries srcWorkbookChartSeries) throws ClientException {
        return send(HttpMethod.PUT, srcWorkbookChartSeries);
    }
}
