...
public class DeviceCompliancePolicyScheduleActionsForRulesRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceCompliancePolicyScheduleActionsForRulesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceCompliancePolicyScheduleActionsForRulesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceCompliancePolicyScheduleActionsForRulesRequest count() {
        addCountOption(true);
        return this;
    }
    /**
