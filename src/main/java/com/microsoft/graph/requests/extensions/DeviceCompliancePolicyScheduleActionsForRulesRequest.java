...
public class DeviceCompliancePolicyScheduleActionsForRulesRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceCompliancePolicyScheduleActionsForRulesRequest select(final String value) {
     ...
     * @return the updated request
     */
    public DeviceCompliancePolicyScheduleActionsForRulesRequest expand(final String value) {
