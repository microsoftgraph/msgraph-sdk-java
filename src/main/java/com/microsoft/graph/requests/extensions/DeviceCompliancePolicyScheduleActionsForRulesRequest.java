...
public class DeviceCompliancePolicyScheduleActionsForRulesRequest extends BaseRequest implements IDeviceCompliancePolicyScheduleActionsForRulesRequest {
     ...
     * @return the updated request
     */
    public IDeviceCompliancePolicyScheduleActionsForRulesRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceCompliancePolicyScheduleActionsForRulesRequest orderBy(final String value) {
