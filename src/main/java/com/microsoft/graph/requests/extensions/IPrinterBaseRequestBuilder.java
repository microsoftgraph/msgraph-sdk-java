...
/**
 * The interface for the Printer Base Request Builder.
 */
public interface IPrinterBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IPrinterBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
