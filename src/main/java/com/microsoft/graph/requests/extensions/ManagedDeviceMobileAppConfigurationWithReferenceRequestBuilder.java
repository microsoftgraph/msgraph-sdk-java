...
/**
 * The class for the Managed Device Mobile App Configuration With Reference Request Builder.
 */
public class ManagedDeviceMobileAppConfigurationWithReferenceRequestBuilder extends BaseRequestBuilder implements IManagedDeviceMobileAppConfigurationWithReferenceRequestBuilder {
     ...
     */
    public ManagedDeviceMobileAppConfigurationWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IManagedDeviceMobileAppConfigurationWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IManagedDeviceMobileAppConfigurationWithReferenceRequest instance
     */
    public IManagedDeviceMobileAppConfigurationWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ManagedDeviceMobileAppConfigurationWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IManagedDeviceMobileAppConfigurationReferenceRequestBuilder reference(){
        return new ManagedDeviceMobileAppConfigurationReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
