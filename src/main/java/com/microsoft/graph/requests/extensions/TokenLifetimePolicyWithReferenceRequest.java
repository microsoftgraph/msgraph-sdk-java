...
public class TokenLifetimePolicyWithReferenceRequest extends BaseRequest implements ITokenLifetimePolicyWithReferenceRequest {
     ...
     */
    public TokenLifetimePolicyWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public TokenLifetimePolicy post(final TokenLifetimePolicy newTokenLifetimePolicy, final IJsonBackedObject payload) throws ClientException {
     ...
     * @return the updated request
     */
    public ITokenLifetimePolicyWithReferenceRequest orderBy(final String value) {
