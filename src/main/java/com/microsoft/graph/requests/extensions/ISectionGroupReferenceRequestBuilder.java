...
/**
 * The interface for the Section Group Reference Request Builder.
 */
public interface ISectionGroupReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ISectionGroupReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ISectionGroupReferenceRequest instance
     */
    ISectionGroupReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
