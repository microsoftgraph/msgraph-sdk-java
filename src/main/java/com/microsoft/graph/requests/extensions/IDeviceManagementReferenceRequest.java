...
/**
 * The interface for the Device Management Reference Request.
 */
public interface IDeviceManagementReferenceRequest extends IHttpRequest {

    void delete(final ICallback<? super DeviceManagement> callback);

    DeviceManagement delete() throws ClientException;
     ...
     */
    IDeviceManagementReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IDeviceManagementReferenceRequest expand(final String value);

    /**
     * Puts the DeviceManagement
     *
     * @param srcDeviceManagement the DeviceManagement to PUT
     * @param callback the callback to be called after success or failure
     */
    void put(DeviceManagement srcDeviceManagement, final ICallback<? super DeviceManagement> callback);
     ...
     */
    DeviceManagement put(DeviceManagement srcDeviceManagement) throws ClientException;
}
