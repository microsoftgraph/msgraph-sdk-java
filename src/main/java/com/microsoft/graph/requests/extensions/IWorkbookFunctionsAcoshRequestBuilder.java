...
public interface IWorkbookFunctionsAcoshRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsAcoshRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsAcoshRequest instance
     */
    IWorkbookFunctionsAcoshRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
