...
public class ManagedDeviceCleanWindowsDeviceRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceCleanWindowsDeviceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceCleanWindowsDeviceBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ManagedDeviceCleanWindowsDeviceBody body;
    /**
