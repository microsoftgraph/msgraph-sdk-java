...
public class ManagedDeviceCleanWindowsDeviceRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceCleanWindowsDeviceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceCleanWindowsDeviceParameterSet parameters) {
