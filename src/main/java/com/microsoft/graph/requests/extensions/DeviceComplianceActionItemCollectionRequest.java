 ...
 */
public class DeviceComplianceActionItemCollectionRequest extends BaseCollectionRequest<DeviceComplianceActionItemCollectionResponse, IDeviceComplianceActionItemCollectionPage> implements IDeviceComplianceActionItemCollectionRequest {
     ...
     * @return the updated request
     */
    public IDeviceComplianceActionItemCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceComplianceActionItemCollectionRequest orderBy(final String value) {
