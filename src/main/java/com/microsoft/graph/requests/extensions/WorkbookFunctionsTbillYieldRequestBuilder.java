 ...
 */
public class WorkbookFunctionsTbillYieldRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public WorkbookFunctionsTbillYieldRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the WorkbookFunctionsTbillYieldRequest instance
     */
    public WorkbookFunctionsTbillYieldRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
