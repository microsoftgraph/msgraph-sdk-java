 ...
 */
public class DriveSharedWithMeCollectionRequest extends BaseCollectionRequest<DriveItem, DriveSharedWithMeCollectionResponse> {
    ...
    public BaseCollectionPage<DriveItem> buildFromResponse(final DriveSharedWithMeCollectionResponse response) {
