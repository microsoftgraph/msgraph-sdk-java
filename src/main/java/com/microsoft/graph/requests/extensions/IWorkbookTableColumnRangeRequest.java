 ...
 */
public interface IWorkbookTableColumnRangeRequest extends IHttpRequest {
     ...
     */
    IWorkbookTableColumnRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookTableColumnRangeRequest expand(final String value);
