 ...
 */
public interface IWindows10EnterpriseModernAppManagementConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows10EnterpriseModernAppManagementConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows10EnterpriseModernAppManagementConfigurationRequest instance
     */
    IWindows10EnterpriseModernAppManagementConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
