...
public class DirectoryObjectValidatePropertiesRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public DirectoryObjectValidatePropertiesRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DirectoryObjectValidatePropertiesRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public DirectoryObjectValidatePropertiesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DirectoryObjectValidatePropertiesRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public DirectoryObjectValidatePropertiesRequest expand(@Nonnull final String value) {
