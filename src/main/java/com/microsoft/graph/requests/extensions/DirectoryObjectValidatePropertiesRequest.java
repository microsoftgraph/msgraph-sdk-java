...
public class DirectoryObjectValidatePropertiesRequest extends BaseRequest<Void> {
     ...
     */
    public DirectoryObjectValidatePropertiesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DirectoryObjectValidatePropertiesBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected DirectoryObjectValidatePropertiesBody body;
    /**
