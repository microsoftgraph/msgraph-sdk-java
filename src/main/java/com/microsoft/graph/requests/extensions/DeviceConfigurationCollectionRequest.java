 ...
 */
public class DeviceConfigurationCollectionRequest extends BaseEntityCollectionRequest<DeviceConfiguration, DeviceConfigurationCollectionResponse, DeviceConfigurationCollectionPage> {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfiguration> futurePost(@Nonnull final DeviceConfiguration newDeviceConfiguration) {
        ...
        return new DeviceConfigurationRequestBuilder(requestUrl, getBaseRequest().getClient(), /* Options */ null)
            ...
            .futurePost(newDeviceConfiguration);
    }
     ...
     */
    @Nonnull
    public DeviceConfigurationCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DeviceConfigurationCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
