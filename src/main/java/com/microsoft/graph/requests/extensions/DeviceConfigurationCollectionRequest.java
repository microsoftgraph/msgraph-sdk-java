 ...
 */
public class DeviceConfigurationCollectionRequest extends BaseCollectionRequest<DeviceConfigurationCollectionResponse, DeviceConfigurationCollectionPage> {
    ...
    public DeviceConfigurationCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceConfigurationCollectionResponse.class, DeviceConfigurationCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super DeviceConfigurationCollectionPage> callback) {
    ...
    @Nonnull
    public DeviceConfigurationCollectionPage get() throws ClientException {
    ...
    @Nonnull
    public DeviceConfigurationCollectionPage buildFromResponse(@Nonnull final DeviceConfigurationCollectionResponse response) {
