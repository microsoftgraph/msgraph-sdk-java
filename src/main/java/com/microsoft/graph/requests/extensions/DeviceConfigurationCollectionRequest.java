...
public class DeviceConfigurationCollectionRequest extends BaseCollectionRequest<DeviceConfigurationCollectionResponse, DeviceConfigurationCollectionPage> {
    ...
    public void get(final ICallback<? super DeviceConfigurationCollectionPage> callback) {
    ...
    public DeviceConfigurationCollectionPage buildFromResponse(final DeviceConfigurationCollectionResponse response) {
