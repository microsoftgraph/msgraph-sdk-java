 ...
 */
public class ReportRootGetSharePointSiteUsagePagesRequest extends BaseRequest<Report> {
     ...
     */
    public ReportRootGetSharePointSiteUsagePagesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsagePagesRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsagePagesRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsagePagesRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsagePagesRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsagePagesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsagePagesRequest count() {
        addCountOption(true);
        return this;
    }
}
