...
public class TokenIssuancePolicyReferenceRequestBuilder extends BaseRequestBuilder implements ITokenIssuancePolicyReferenceRequestBuilder {
     ...
     */
    public TokenIssuancePolicyReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public ITokenIssuancePolicyReferenceRequest buildRequest() {
     ...
     * @return the ITokenIssuancePolicyReferenceRequest instance
     */
    public ITokenIssuancePolicyReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
