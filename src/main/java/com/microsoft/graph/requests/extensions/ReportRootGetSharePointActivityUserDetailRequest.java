...
public class ReportRootGetSharePointActivityUserDetailRequest extends BaseRequest<Report> {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserDetailRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserDetailRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ReportRootGetSharePointActivityUserDetailRequest top(final int value) {
        addTopOption(value);
        return this;
    }
}
