...
/**
 * The interface for the Channel Reference Request Builder.
 */
public interface IChannelReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IChannelReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IChannelReferenceRequest instance
     */
    IChannelReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
