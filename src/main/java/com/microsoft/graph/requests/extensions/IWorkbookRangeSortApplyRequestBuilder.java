 ...
 */
public interface IWorkbookRangeSortApplyRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookRangeSortApplyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
