...
public class WindowsPhone81CustomConfigurationRequest extends BaseRequest<WindowsPhone81CustomConfiguration> {
     ...
     */
    public void get(@Nonnull final ICallback<? super WindowsPhone81CustomConfiguration> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super WindowsPhone81CustomConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final WindowsPhone81CustomConfiguration sourceWindowsPhone81CustomConfiguration, @Nonnull final ICallback<? super WindowsPhone81CustomConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final WindowsPhone81CustomConfiguration newWindowsPhone81CustomConfiguration, @Nonnull final ICallback<? super WindowsPhone81CustomConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final WindowsPhone81CustomConfiguration newWindowsPhone81CustomConfiguration, @Nonnull final ICallback<? super WindowsPhone81CustomConfiguration> callback) {
     ...
     */
    @Nonnull
    public WindowsPhone81CustomConfigurationRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WindowsPhone81CustomConfigurationRequest count() {
        addCountOption(true);
        return this;
    }
}
