...
/**
 * The interface for the Comms Operation With Reference Request Builder.
 */
public interface ICommsOperationWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ICommsOperationWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ICommsOperationWithReferenceRequest instance
     */
    ICommsOperationWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    ICommsOperationReferenceRequestBuilder reference();
