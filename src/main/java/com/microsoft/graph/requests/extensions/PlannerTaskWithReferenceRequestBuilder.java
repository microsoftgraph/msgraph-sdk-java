...
public class PlannerTaskWithReferenceRequestBuilder extends BaseRequestBuilder implements IPlannerTaskWithReferenceRequestBuilder {
     ...
     */
    public PlannerTaskWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IPlannerTaskWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IPlannerTaskWithReferenceRequest instance
     */
    public IPlannerTaskWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
