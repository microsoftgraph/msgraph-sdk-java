...
public class WorkbookFunctionsOddFPriceRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsOddFPriceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsOddFPriceParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsOddFPriceParameterSet body;
    /**
