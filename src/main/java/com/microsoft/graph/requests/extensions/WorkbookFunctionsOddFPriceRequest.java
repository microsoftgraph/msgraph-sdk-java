...
public class WorkbookFunctionsOddFPriceRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsOddFPriceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsOddFPriceBody parameters) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        body = parameters;
    }

	/** The body for the method */
    protected WorkbookFunctionsOddFPriceBody body;
    /**
     ...
     */
    @Nonnull
    public WorkbookFunctionsOddFPriceRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsOddFPriceRequest count() {
        addCountOption(true);
        return this;
    }
