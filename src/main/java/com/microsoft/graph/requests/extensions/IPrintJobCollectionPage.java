...
/**
 * The interface for the Print Job Collection Page.
 */
public interface IPrintJobCollectionPage extends IBaseCollectionPage<PrintJob, IPrintJobCollectionRequestBuilder> {
}
