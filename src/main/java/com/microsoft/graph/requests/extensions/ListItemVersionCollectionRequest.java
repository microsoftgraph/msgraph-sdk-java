...
public class ListItemVersionCollectionRequest extends BaseCollectionRequest<ListItemVersionCollectionResponse, ListItemVersionCollectionPage> {
    ...
    public void get(final ICallback<? super ListItemVersionCollectionPage> callback) {
    ...
    public ListItemVersionCollectionPage buildFromResponse(final ListItemVersionCollectionResponse response) {
