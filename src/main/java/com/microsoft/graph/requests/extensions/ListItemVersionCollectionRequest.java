 ...
 */
public class ListItemVersionCollectionRequest extends BaseCollectionRequest<ListItemVersionCollectionResponse, ListItemVersionCollectionPage> {
    ...
    public ListItemVersionCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ListItemVersionCollectionResponse.class, ListItemVersionCollectionPage.class);
    }

    public void get(@Nonnull final ICallback<? super ListItemVersionCollectionPage> callback) {
    ...
    @Nonnull
    public ListItemVersionCollectionPage get() throws ClientException {
    ...
    @Nonnull
    public ListItemVersionCollectionPage buildFromResponse(@Nonnull final ListItemVersionCollectionResponse response) {
