...
import com.microsoft.graph.requests.generated.BaseListItemVersionCollectionRequest;
...
public class ListItemVersionCollectionRequest extends BaseListItemVersionCollectionRequest implements IListItemVersionCollectionRequest {
     ...
     */
    public ListItemVersionCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
