...
/**
 * The interface for the Education Class Delta Collection Page.
 */
public interface IEducationClassDeltaCollectionPage extends IBaseCollectionPage<EducationClass, IEducationClassDeltaCollectionRequestBuilder> {
    /**
