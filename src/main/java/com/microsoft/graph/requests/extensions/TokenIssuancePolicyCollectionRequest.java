...
public class TokenIssuancePolicyCollectionRequest extends BaseCollectionRequest<TokenIssuancePolicyCollectionResponse, TokenIssuancePolicyCollectionPage> {
    ...
    public void get(final ICallback<? super TokenIssuancePolicyCollectionPage> callback) {
    ...
    public TokenIssuancePolicyCollectionPage buildFromResponse(final TokenIssuancePolicyCollectionResponse response) {
