...
public class ManagedAppPolicyTargetAppsRequest extends BaseRequest<Void> {
     ...
     */
    @Nonnull
    public ManagedAppPolicyTargetAppsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ManagedAppPolicyTargetAppsRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public ManagedAppPolicyTargetAppsRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedAppPolicyTargetAppsRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public ManagedAppPolicyTargetAppsRequest expand(@Nonnull final String value) {
