...
public class ManagedAppPolicyTargetAppsRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedAppPolicyTargetAppsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedAppPolicyTargetAppsBody parameters) {
        super(requestUrl, client, requestOptions, Void.class);
        body = parameters;
    }

	/** The body for the method */
    protected ManagedAppPolicyTargetAppsBody body;
    /**
