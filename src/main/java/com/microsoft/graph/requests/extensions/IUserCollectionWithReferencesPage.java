...
/**
 * The interface for the User Collection With References Page.
 */
public interface IUserCollectionWithReferencesPage extends IBaseCollectionPage<User, IUserCollectionWithReferencesRequestBuilder> {
}
