...
import com.microsoft.graph.requests.generated.BaseWorkbookTableClearFiltersRequest;
...
public class WorkbookTableClearFiltersRequest extends BaseWorkbookTableClearFiltersRequest implements IWorkbookTableClearFiltersRequest {
     ...
     */
    public WorkbookTableClearFiltersRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
