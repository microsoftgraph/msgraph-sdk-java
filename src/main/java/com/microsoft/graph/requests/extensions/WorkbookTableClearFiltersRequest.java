 ...
 */
public class WorkbookTableClearFiltersRequest extends BaseRequest<Void> {
    /**
     ...
     */
    public WorkbookTableClearFiltersRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
