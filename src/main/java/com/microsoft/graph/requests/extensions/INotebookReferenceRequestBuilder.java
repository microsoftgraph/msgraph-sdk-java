...
/**
 * The interface for the Notebook Reference Request Builder.
 */
public interface INotebookReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    INotebookReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the INotebookReferenceRequest instance
     */
    INotebookReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
