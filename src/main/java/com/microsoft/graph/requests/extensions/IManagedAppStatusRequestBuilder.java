 ...
 */
public interface IManagedAppStatusRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IManagedAppStatusRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
