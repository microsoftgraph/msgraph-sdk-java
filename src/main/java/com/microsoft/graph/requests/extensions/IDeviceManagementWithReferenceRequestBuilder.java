...
/**
 * The interface for the Device Management With Reference Request Builder.
 */
public interface IDeviceManagementWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceManagementWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceManagementWithReferenceRequest instance
     */
    IDeviceManagementWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IDeviceManagementReferenceRequestBuilder reference();
