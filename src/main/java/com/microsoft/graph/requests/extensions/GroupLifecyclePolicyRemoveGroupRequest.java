...
public class GroupLifecyclePolicyRemoveGroupRequest extends BaseRequest<Boolean> {
     ...
     */
    public GroupLifecyclePolicyRemoveGroupRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final GroupLifecyclePolicyRemoveGroupBody parameters) {
        super(requestUrl, client, requestOptions, Boolean.class);
        body = parameters;
    }

	/** The body for the method */
    protected GroupLifecyclePolicyRemoveGroupBody body;
    /**
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyRemoveGroupRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyRemoveGroupRequest count() {
        addCountOption(true);
        return this;
    }
