 ...
 */
public class WorkbookFunctionsPvRequest extends BaseRequest {
     ...
     */
    public WorkbookFunctionsPvRequest select(final String value) {
     ...
     * @return the updated request
     */
    public WorkbookFunctionsPvRequest expand(final String value) {
