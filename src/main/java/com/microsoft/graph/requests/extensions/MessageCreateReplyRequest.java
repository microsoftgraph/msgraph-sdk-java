...
public class MessageCreateReplyRequest extends BaseRequest<Message> {
     ...
     */
    public MessageCreateReplyRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final MessageCreateReplyBody parameters) {
        super(requestUrl, client, requestOptions, Message.class);
        body = parameters;
    }

	/** The body for the method */
    protected MessageCreateReplyBody body;
    /**
     ...
     */
    @Nonnull
    public MessageCreateReplyRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public MessageCreateReplyRequest count() {
        addCountOption(true);
        return this;
    }
