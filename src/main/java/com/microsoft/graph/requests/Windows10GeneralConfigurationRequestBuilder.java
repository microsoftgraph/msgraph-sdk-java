...
public class Windows10GeneralConfigurationRequestBuilder extends BaseRequestBuilder<Windows10GeneralConfiguration> {
     ...
     */
    public Windows10GeneralConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10GeneralConfigurationRequest instance
     */
    @Nonnull
    public Windows10GeneralConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10GeneralConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows10GeneralConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
