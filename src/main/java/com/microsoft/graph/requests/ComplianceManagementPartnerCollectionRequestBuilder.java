 ...
 */
public class ComplianceManagementPartnerCollectionRequestBuilder extends BaseCollectionRequestBuilder<ComplianceManagementPartner, ComplianceManagementPartnerRequestBuilder, ComplianceManagementPartnerCollectionResponse, ComplianceManagementPartnerCollectionPage, ComplianceManagementPartnerCollectionRequest> {
     ...
     */
    public ComplianceManagementPartnerCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
