...
import com.microsoft.graph.requests.ManagedAppProtectionTargetAppsRequest;
...
public class ManagedAppProtectionTargetAppsRequestBuilder extends BaseActionRequestBuilder<ManagedAppProtection> {
     ...
     */
    public ManagedAppProtectionTargetAppsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ManagedAppProtectionTargetAppsRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final ManagedAppProtectionTargetAppsRequest request = new ManagedAppProtectionTargetAppsRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
