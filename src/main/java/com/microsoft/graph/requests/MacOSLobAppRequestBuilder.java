...
/**
 * The class for the Mac OSLob App Request Builder.
 */
public class MacOSLobAppRequestBuilder extends BaseRequestBuilder<MacOSLobApp> {

    /**
     * The request builder for the MacOSLobApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSLobAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSLobAppRequest instance
     */
    @Nonnull
    public MacOSLobAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSLobAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSLobAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
