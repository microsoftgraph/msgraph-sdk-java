...
import com.microsoft.graph.requests.WorkbookWorksheetAddRequestBuilder;
...
public class WorkbookWorksheetCollectionRequestBuilder extends BaseCollectionRequestBuilder<WorkbookWorksheet, WorkbookWorksheetRequestBuilder, WorkbookWorksheetCollectionResponse, WorkbookWorksheetCollectionPage, WorkbookWorksheetCollectionRequest> {
     ...
     */
    public WorkbookWorksheetCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookWorksheetAddRequestBuilder add(@Nonnull final WorkbookWorksheetAddParameterSet parameters) {
        return new WorkbookWorksheetAddRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.add"), getClient(), null, parameters);
    }
