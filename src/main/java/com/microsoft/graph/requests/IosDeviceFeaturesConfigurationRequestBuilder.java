 ...
 */
public class IosDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder<IosDeviceFeaturesConfiguration> {
     ...
     */
    public IosDeviceFeaturesConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosDeviceFeaturesConfigurationRequest instance
     */
    @Nonnull
    public IosDeviceFeaturesConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosDeviceFeaturesConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosDeviceFeaturesConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
