 ...
 */
public class ReportRootGetOffice365ActiveUserDetailRequestBuilder extends BaseFunctionRequestBuilder<java.io.InputStream> {
     ...
     */
    public ReportRootGetOffice365ActiveUserDetailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
