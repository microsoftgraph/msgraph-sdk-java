...
public class FileAttachmentStreamRequest extends BaseStreamRequest<FileAttachment> {
     ...
     */
    public FileAttachmentStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<FileAttachment> futurePut(@Nonnull final byte[] fileContents) {
     ...
     */
    @Nullable
    public FileAttachment put(@Nonnull final byte[] fileContents) throws ClientException {
