...
public class AndroidWorkProfileGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileGeneralDeviceConfiguration> {
     ...
     */
    public AndroidWorkProfileGeneralDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileGeneralDeviceConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidWorkProfileGeneralDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
