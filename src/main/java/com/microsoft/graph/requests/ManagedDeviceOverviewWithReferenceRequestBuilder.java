 ...
 */
public class ManagedDeviceOverviewWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<ManagedDeviceOverview, ManagedDeviceOverviewWithReferenceRequest, ManagedDeviceOverviewReferenceRequestBuilder> {
     ...
     */
    public ManagedDeviceOverviewWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
