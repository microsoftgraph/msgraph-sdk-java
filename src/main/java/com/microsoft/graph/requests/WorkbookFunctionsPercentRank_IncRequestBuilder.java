...
import com.microsoft.graph.requests.WorkbookFunctionsPercentRank_IncRequest;
...
public class WorkbookFunctionsPercentRank_IncRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    @Nonnull
    public WorkbookFunctionsPercentRank_IncRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsPercentRank_IncRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsPercentRank_IncRequest request = new WorkbookFunctionsPercentRank_IncRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
