 ...
 */
public class ReportRootGetEmailAppUsageAppsUserCountsRequestBuilder extends BaseFunctionRequestBuilder<java.io.InputStream> {
     ...
     */
    public ReportRootGetEmailAppUsageAppsUserCountsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public ReportRootGetEmailAppUsageAppsUserCountsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ReportRootGetEmailAppUsageAppsUserCountsParameterSet parameters) {
        super(requestUrl, client, requestOptions);
        if(parameters != null) {
    ...
    public ReportRootGetEmailAppUsageAppsUserCountsRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final ReportRootGetEmailAppUsageAppsUserCountsRequest request = new ReportRootGetEmailAppUsageAppsUserCountsRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
