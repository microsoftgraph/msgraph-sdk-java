...
import com.microsoft.graph.requests.ReportRootGetOneDriveUsageAccountCountsRequest;
 ...
 */
public class ReportRootGetOneDriveUsageAccountCountsRequestBuilder extends BaseFunctionRequestBuilder<java.io.InputStream> {
     ...
     */
    public ReportRootGetOneDriveUsageAccountCountsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
