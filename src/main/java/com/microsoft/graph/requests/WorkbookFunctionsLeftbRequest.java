 ...
 */
public class WorkbookFunctionsLeftbRequest extends BaseRequest<WorkbookFunctionResult> {
    /**
     ...
     */
    public WorkbookFunctionsLeftbRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsLeftbParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsLeftbParameterSet body;
    /**
