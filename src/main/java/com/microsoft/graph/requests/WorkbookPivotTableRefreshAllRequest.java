...
import com.microsoft.graph.requests.WorkbookPivotTableRefreshAllRequest;
...
public class WorkbookPivotTableRefreshAllRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookPivotTableRefreshAllRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
