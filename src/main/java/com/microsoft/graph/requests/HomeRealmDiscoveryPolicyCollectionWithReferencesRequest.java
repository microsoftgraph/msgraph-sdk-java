...
import com.microsoft.graph.models.HomeRealmDiscoveryPolicy;
import com.microsoft.graph.requests.HomeRealmDiscoveryPolicyWithReferenceRequest;
import com.microsoft.graph.requests.HomeRealmDiscoveryPolicyReferenceRequestBuilder;
import com.microsoft.graph.requests.HomeRealmDiscoveryPolicyWithReferenceRequestBuilder;
import com.microsoft.graph.requests.HomeRealmDiscoveryPolicyCollectionWithReferencesRequest;
import com.microsoft.graph.requests.HomeRealmDiscoveryPolicyCollectionWithReferencesRequest;
...
public class HomeRealmDiscoveryPolicyCollectionWithReferencesRequest extends BaseCollectionWithReferencesRequest<HomeRealmDiscoveryPolicy, HomeRealmDiscoveryPolicyWithReferenceRequest, HomeRealmDiscoveryPolicyReferenceRequestBuilder, HomeRealmDiscoveryPolicyWithReferenceRequestBuilder, HomeRealmDiscoveryPolicyCollectionResponse, HomeRealmDiscoveryPolicyCollectionWithReferencesPage, HomeRealmDiscoveryPolicyCollectionWithReferencesRequest> {
     ...
     */
    @Nonnull
    public HomeRealmDiscoveryPolicyCollectionWithReferencesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public HomeRealmDiscoveryPolicyCollectionWithReferencesRequest count() {
        addCountOption(true);
        return this;
    }
}
