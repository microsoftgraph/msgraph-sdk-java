...
public class NotificationMessageTemplateSendTestMessageRequest extends BaseRequest<Void> {
     ...
     */
    public NotificationMessageTemplateSendTestMessageRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
