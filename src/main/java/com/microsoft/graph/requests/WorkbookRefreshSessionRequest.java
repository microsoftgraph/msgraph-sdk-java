...
import com.microsoft.graph.requests.WorkbookRefreshSessionRequest;
...
public class WorkbookRefreshSessionRequest extends BaseRequest<Void> {
     ...
     */
    public WorkbookRefreshSessionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
