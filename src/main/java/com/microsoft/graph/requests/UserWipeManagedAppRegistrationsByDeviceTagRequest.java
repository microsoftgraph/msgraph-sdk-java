...
import com.microsoft.graph.requests.UserWipeManagedAppRegistrationsByDeviceTagRequest;
...
public class UserWipeManagedAppRegistrationsByDeviceTagRequest extends BaseRequest<Void> {
     ...
     */
    public UserWipeManagedAppRegistrationsByDeviceTagRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserWipeManagedAppRegistrationsByDeviceTagParameterSet parameters) {
