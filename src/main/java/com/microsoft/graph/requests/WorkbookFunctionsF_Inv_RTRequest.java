...
import com.microsoft.graph.requests.WorkbookFunctionsF_Inv_RTRequest;
...
public class WorkbookFunctionsF_Inv_RTRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsF_Inv_RTRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsF_Inv_RTParameterSet parameters) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsF_Inv_RTRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsF_Inv_RTRequest expand(@Nonnull final String value) {
