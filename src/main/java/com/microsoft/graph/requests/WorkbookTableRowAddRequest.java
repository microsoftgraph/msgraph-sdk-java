...
public class WorkbookTableRowAddRequest extends BaseRequest<WorkbookTableRow> {
     ...
     */
    public WorkbookTableRowAddRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookTableRowAddParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookTableRowAddParameterSet body;
    /**
     * Invokes the method and returns a future with the result
     * @return a future with the result
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookTableRow> futurePost() {
