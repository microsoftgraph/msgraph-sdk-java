...
import com.microsoft.graph.requests.WorkbookRangeLastRowRequest;
...
public class WorkbookRangeLastRowRequestBuilder extends BaseFunctionRequestBuilder<WorkbookRange> {
     ...
     */
    public WorkbookRangeLastRowRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    /**
     * Creates the WorkbookRangeLastRowRequest
     *
     * @param requestOptions the options for the request
     * @return the WorkbookRangeLastRowRequest instance
     */
    @Nonnull
    public WorkbookRangeLastRowRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the WorkbookRangeLastRowRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the WorkbookRangeLastRowRequest instance
     */
    @Nonnull
    public WorkbookRangeLastRowRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookRangeLastRowRequest request = new WorkbookRangeLastRowRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
        return request;
