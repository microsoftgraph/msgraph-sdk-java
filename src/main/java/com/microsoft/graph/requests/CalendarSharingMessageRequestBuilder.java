...
public class CalendarSharingMessageRequestBuilder extends BaseRequestBuilder<CalendarSharingMessage> {
     ...
     */
    public CalendarSharingMessageRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public CalendarSharingMessageRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public CalendarSharingMessageRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.CalendarSharingMessageRequest(getRequestUrl(), getClient(), requestOptions);
    }
