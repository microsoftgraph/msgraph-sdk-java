...
/**
 * The class for the Unified Role Eligibility Schedule Instance Request Builder.
 */
public class UnifiedRoleEligibilityScheduleInstanceRequestBuilder extends BaseRequestBuilder<UnifiedRoleEligibilityScheduleInstance> {

    /**
     * The request builder for the UnifiedRoleEligibilityScheduleInstance
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public UnifiedRoleEligibilityScheduleInstanceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the UnifiedRoleEligibilityScheduleInstanceRequest instance
     */
    @Nonnull
    public UnifiedRoleEligibilityScheduleInstanceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UnifiedRoleEligibilityScheduleInstanceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.UnifiedRoleEligibilityScheduleInstanceRequest(getRequestUrl(), getClient(), requestOptions);
    }
