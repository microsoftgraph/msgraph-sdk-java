 ...
 */
public class ManagedDeviceRequestRemoteAssistanceRequest extends BaseRequest<Void> {
    /**
     ...
     */
    public ManagedDeviceRequestRemoteAssistanceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
