...
public class MicrosoftAuthenticatorAuthenticationMethodTargetRequest extends BaseRequest<MicrosoftAuthenticatorAuthenticationMethodTarget> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodTarget> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodTarget> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodTarget> patchAsync(@Nonnull final MicrosoftAuthenticatorAuthenticationMethodTarget sourceMicrosoftAuthenticatorAuthenticationMethodTarget) {
        return sendAsync(HttpMethod.PATCH, sourceMicrosoftAuthenticatorAuthenticationMethodTarget);
    }
    ...
    /**
     * Creates a MicrosoftAuthenticatorAuthenticationMethodTarget with a new object
     *
    ...
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodTarget> postAsync(@Nonnull final MicrosoftAuthenticatorAuthenticationMethodTarget newMicrosoftAuthenticatorAuthenticationMethodTarget) {
        return sendAsync(HttpMethod.POST, newMicrosoftAuthenticatorAuthenticationMethodTarget);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodTarget> putAsync(@Nonnull final MicrosoftAuthenticatorAuthenticationMethodTarget newMicrosoftAuthenticatorAuthenticationMethodTarget) {
        return sendAsync(HttpMethod.PUT, newMicrosoftAuthenticatorAuthenticationMethodTarget);
    }
