...
/**
 * The class for the Tenant App Management Policy Request Builder.
 */
public class TenantAppManagementPolicyRequestBuilder extends BaseRequestBuilder<TenantAppManagementPolicy> {

    /**
     * The request builder for the TenantAppManagementPolicy
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public TenantAppManagementPolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the TenantAppManagementPolicyRequest instance
     */
    @Nonnull
    public TenantAppManagementPolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TenantAppManagementPolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.TenantAppManagementPolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
