...
import com.microsoft.graph.requests.TokenIssuancePolicyCollectionRequest;
...
public class TokenIssuancePolicyCollectionRequest extends BaseEntityCollectionRequest<TokenIssuancePolicy, TokenIssuancePolicyCollectionResponse, TokenIssuancePolicyCollectionPage> {
     ...
     */
    @Nonnull
    public TokenIssuancePolicyCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public TokenIssuancePolicyCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
