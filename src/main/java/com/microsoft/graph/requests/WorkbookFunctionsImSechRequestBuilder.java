...
import com.microsoft.graph.requests.WorkbookFunctionsImSechRequest;
...
public class WorkbookFunctionsImSechRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsImSechRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsImSechParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsImSech
     *
     * @param requestUrl     the request URL
     ...
     */
    @Nonnull
    public WorkbookFunctionsImSechRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
