 ...
 */
public class ReportRootGetOffice365ActiveUserDetailRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetOffice365ActiveUserDetailRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetOffice365ActiveUserDetailRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetOffice365ActiveUserDetailRequest expand(@Nonnull final String value) {
