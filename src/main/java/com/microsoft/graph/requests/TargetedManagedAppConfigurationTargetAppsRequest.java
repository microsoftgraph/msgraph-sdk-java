...
public class TargetedManagedAppConfigurationTargetAppsRequest extends BaseRequest<Void> {
    /**
     * The request for this TargetedManagedAppConfigurationTargetApps
     *
     ...
     */
    public TargetedManagedAppConfigurationTargetAppsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TargetedManagedAppConfigurationTargetAppsParameterSet parameters) {
