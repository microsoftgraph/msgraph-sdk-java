 ...
 */
public class ReportRootGetSkypeForBusinessOrganizerActivityCountsRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetSkypeForBusinessOrganizerActivityCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
