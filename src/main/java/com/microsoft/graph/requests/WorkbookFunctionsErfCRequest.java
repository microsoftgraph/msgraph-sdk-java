...
import com.microsoft.graph.requests.WorkbookFunctionsErfCRequest;
...
public class WorkbookFunctionsErfCRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsErfCRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsErfCParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsErfCParameterSet body;
    /**
