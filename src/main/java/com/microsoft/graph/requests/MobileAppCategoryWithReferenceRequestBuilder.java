 ...
 */
public class MobileAppCategoryWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<MobileAppCategory, MobileAppCategoryWithReferenceRequest, MobileAppCategoryReferenceRequestBuilder> {
    ...
    public MobileAppCategoryWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, MobileAppCategoryWithReferenceRequest.class, MobileAppCategoryReferenceRequestBuilder.class);
    }
}
