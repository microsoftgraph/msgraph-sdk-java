...
import com.microsoft.graph.requests.WorkbookFunctionsMroundRequest;
...
public class WorkbookFunctionsMroundRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMroundRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsMroundParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsMround
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsMroundRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMroundParameterSet parameters) {
        super(requestUrl, client, requestOptions);
