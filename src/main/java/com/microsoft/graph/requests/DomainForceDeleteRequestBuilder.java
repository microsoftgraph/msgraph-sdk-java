...
import com.microsoft.graph.requests.DomainForceDeleteRequest;
...
public class DomainForceDeleteRequestBuilder extends BaseActionRequestBuilder<Domain> {
     ...
     */
    public DomainForceDeleteRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public DomainForceDeleteRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final DomainForceDeleteRequest request = new DomainForceDeleteRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
