 ...
 */
public class ReportRootGetSharePointSiteUsageFileCountsRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetSharePointSiteUsageFileCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsageFileCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetSharePointSiteUsageFileCountsRequest expand(@Nonnull final String value) {
