...
public class DeviceComplianceScheduledActionForRuleRequestBuilder extends BaseRequestBuilder<DeviceComplianceScheduledActionForRule> {
    ...
    public DeviceComplianceScheduledActionForRuleRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.DeviceComplianceScheduledActionForRuleRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.DeviceComplianceActionItemCollectionRequestBuilder scheduledActionConfigurations() {
        return new com.microsoft.graph.requests.DeviceComplianceActionItemCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("scheduledActionConfigurations"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.DeviceComplianceActionItemRequestBuilder scheduledActionConfigurations(@Nonnull final String id) {
        return new com.microsoft.graph.requests.DeviceComplianceActionItemRequestBuilder(getRequestUrlWithAdditionalSegment("scheduledActionConfigurations") + "/" + id, getClient(), null);
    }
}
