...
public class UserExperienceAnalyticsBaselineRequest extends BaseRequest<UserExperienceAnalyticsBaseline> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> patchAsync(@Nonnull final UserExperienceAnalyticsBaseline sourceUserExperienceAnalyticsBaseline) {
        return sendAsync(HttpMethod.PATCH, sourceUserExperienceAnalyticsBaseline);
    }
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> postAsync(@Nonnull final UserExperienceAnalyticsBaseline newUserExperienceAnalyticsBaseline) {
        return sendAsync(HttpMethod.POST, newUserExperienceAnalyticsBaseline);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> putAsync(@Nonnull final UserExperienceAnalyticsBaseline newUserExperienceAnalyticsBaseline) {
        return sendAsync(HttpMethod.PUT, newUserExperienceAnalyticsBaseline);
    }
