...
/**
 * The class for the Service Announcement Attachment Content Stream Request.
 */
public class ServiceAnnouncementAttachmentContentStreamRequest extends BaseStreamRequest<ServiceAnnouncementAttachment> {

    /**
     * The request for the ServiceAnnouncementAttachmentContentStream
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public ServiceAnnouncementAttachmentContentStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ServiceAnnouncementAttachment> putAsync(@Nonnull final byte[] fileContents) {
     ...
     */
    @Nullable
    public ServiceAnnouncementAttachment put(@Nonnull final byte[] fileContents) throws ClientException {
