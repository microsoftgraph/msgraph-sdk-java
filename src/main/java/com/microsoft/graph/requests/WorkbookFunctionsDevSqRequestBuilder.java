...
import com.microsoft.graph.requests.WorkbookFunctionsDevSqRequest;
...
public class WorkbookFunctionsDevSqRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDevSqRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public WorkbookFunctionsDevSqRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDevSqParameterSet parameters) {
        super(requestUrl, client, requestOptions);
    ...
    public WorkbookFunctionsDevSqRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsDevSqRequest request = new WorkbookFunctionsDevSqRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
