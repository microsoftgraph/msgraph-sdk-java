...
public class CallUnmuteRequest extends BaseRequest<UnmuteParticipantOperation> {
     ...
     */
    public CallUnmuteRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final CallUnmuteParameterSet parameters) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UnmuteParticipantOperation> futurePost() {
