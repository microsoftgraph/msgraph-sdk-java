...
public class ManagedDeviceLogoutSharedAppleDeviceActiveUserRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceLogoutSharedAppleDeviceActiveUserRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
