 ...
 */
public class ReportRootGetM365AppUserDetailRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetM365AppUserDetailRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetM365AppUserDetailRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetM365AppUserDetailRequest expand(@Nonnull final String value) {
