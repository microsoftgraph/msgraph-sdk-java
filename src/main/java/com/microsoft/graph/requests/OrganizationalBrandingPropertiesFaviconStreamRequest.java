...
/**
 * The class for the Organizational Branding Properties Favicon Stream Request.
 */
public class OrganizationalBrandingPropertiesFaviconStreamRequest extends BaseStreamRequest<OrganizationalBrandingProperties> {

    /**
     * The request for the OrganizationalBrandingPropertiesFaviconStream
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public OrganizationalBrandingPropertiesFaviconStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
