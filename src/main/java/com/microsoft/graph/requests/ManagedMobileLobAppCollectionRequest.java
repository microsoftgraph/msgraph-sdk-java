...
import com.microsoft.graph.requests.ManagedMobileLobAppCollectionResponse;
import com.microsoft.graph.requests.ManagedMobileLobAppCollectionRequestBuilder;
import com.microsoft.graph.requests.ManagedMobileLobAppCollectionRequest;
 ...
 */
public class ManagedMobileLobAppCollectionRequest extends BaseEntityCollectionRequest<ManagedMobileLobApp, ManagedMobileLobAppCollectionResponse, ManagedMobileLobAppCollectionPage> {
    ...
    public java.util.concurrent.CompletableFuture<ManagedMobileLobApp> futurePost(@Nonnull final ManagedMobileLobApp newManagedMobileLobApp) {
        ...
        return new ManagedMobileLobAppRequestBuilder(requestUrl, getBaseRequest().getClient(), /* Options */ null)
            ...
            .futurePost(newManagedMobileLobApp);
    }
