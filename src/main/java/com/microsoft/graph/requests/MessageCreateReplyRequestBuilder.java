...
import com.microsoft.graph.requests.MessageCreateReplyRequest;
...
public class MessageCreateReplyRequestBuilder extends BaseActionRequestBuilder<Message> {
     ...
     */
    public MessageCreateReplyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private MessageCreateReplyParameterSet body;
    /**
     * The request builder for this MessageCreateReply
     *
     * @param requestUrl     the request URL
    ...
    public MessageCreateReplyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final MessageCreateReplyRequest request = new MessageCreateReplyRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
