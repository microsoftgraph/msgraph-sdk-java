 ...
 */
public class ReportRootGetTeamsUserActivityCountsRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetTeamsUserActivityCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsUserActivityCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetTeamsUserActivityCountsRequest expand(@Nonnull final String value) {
