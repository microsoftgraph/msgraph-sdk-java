...
import com.microsoft.graph.requests.WorkbookFunctionsDays360Request;
...
public class WorkbookFunctionsDays360Request extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDays360Request(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDays360ParameterSet parameters) {
