...
import com.microsoft.graph.requests.OnenotePageCopyToSectionRequest;
...
public class OnenotePageCopyToSectionRequest extends BaseRequest<OnenoteOperation> {
     ...
     */
    public OnenotePageCopyToSectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final OnenotePageCopyToSectionParameterSet parameters) {
    ...
    @Nullable
    protected OnenotePageCopyToSectionParameterSet body;
    /**
