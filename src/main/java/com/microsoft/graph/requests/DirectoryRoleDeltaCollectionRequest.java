 ...
 */
public class DirectoryRoleDeltaCollectionRequest extends BaseDeltaCollectionRequest<DirectoryRole, DirectoryRoleDeltaCollectionResponse, DirectoryRoleDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public DirectoryRoleDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public DirectoryRoleDeltaCollectionRequest skipToken(@Nonnull final String skipToken) {
     ...
     */
    @Nonnull
    public DirectoryRoleDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public DirectoryRoleDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
