...
import com.microsoft.graph.requests.WorkbookTableReapplyFiltersRequest;
...
public class WorkbookTableReapplyFiltersRequestBuilder extends BaseActionRequestBuilder<WorkbookTable> {
     ...
     */
    public WorkbookTableReapplyFiltersRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableReapplyFiltersRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
