...
public class DeviceManagementReportsGetReportFiltersRequestBuilder extends BaseActionRequestBuilder<java.io.InputStream> {
     ...
     */
    public DeviceManagementReportsGetReportFiltersRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public DeviceManagementReportsGetReportFiltersRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final DeviceManagementReportsGetReportFiltersRequest request = new DeviceManagementReportsGetReportFiltersRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
