...
public class RbacApplicationRequest extends BaseRequest<RbacApplication> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RbacApplication> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RbacApplication> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RbacApplication> patchAsync(@Nonnull final RbacApplication sourceRbacApplication) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<RbacApplication> putAsync(@Nonnull final RbacApplication newRbacApplication) {
