...
import com.microsoft.graph.requests.WorkbookFunctionsTodayRequest;
 ...
 */
public class WorkbookFunctionsTodayRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsTodayRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsTodayRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
