...
import com.microsoft.graph.requests.WorkbookFunctionsYieldRequest;
...
public class WorkbookFunctionsYieldRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsYieldRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public WorkbookFunctionsYieldRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsYieldRequest request = new WorkbookFunctionsYieldRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
