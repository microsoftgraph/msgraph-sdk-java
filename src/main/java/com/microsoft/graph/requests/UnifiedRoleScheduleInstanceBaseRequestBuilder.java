...
/**
 * The class for the Unified Role Schedule Instance Base Request Builder.
 */
public class UnifiedRoleScheduleInstanceBaseRequestBuilder extends BaseRequestBuilder<UnifiedRoleScheduleInstanceBase> {

    /**
     * The request builder for the UnifiedRoleScheduleInstanceBase
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public UnifiedRoleScheduleInstanceBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the UnifiedRoleScheduleInstanceBaseRequest instance
     */
    @Nonnull
    public UnifiedRoleScheduleInstanceBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UnifiedRoleScheduleInstanceBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.UnifiedRoleScheduleInstanceBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
