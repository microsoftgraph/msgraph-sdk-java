...
public class WindowsUpdateForBusinessConfigurationRequestBuilder extends BaseRequestBuilder<WindowsUpdateForBusinessConfiguration> {
     ...
     */
    public WindowsUpdateForBusinessConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsUpdateForBusinessConfigurationRequest instance
     */
    @Nonnull
    public WindowsUpdateForBusinessConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsUpdateForBusinessConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsUpdateForBusinessConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
