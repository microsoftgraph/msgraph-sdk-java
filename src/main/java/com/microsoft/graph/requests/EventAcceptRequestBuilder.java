...
import com.microsoft.graph.requests.EventAcceptRequest;
...
public class EventAcceptRequestBuilder extends BaseActionRequestBuilder<Event> {
     ...
     */
    public EventAcceptRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public EventAcceptRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final EventAcceptRequest request = new EventAcceptRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
