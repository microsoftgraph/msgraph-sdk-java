 ...
 */
public class OutlookUserSupportedLanguagesCollectionRequest extends BaseFunctionCollectionRequest<LocaleInfo, OutlookUserSupportedLanguagesCollectionResponse, OutlookUserSupportedLanguagesCollectionPage> {
     ...
     */
    @Nonnull
    public OutlookUserSupportedLanguagesCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OutlookUserSupportedLanguagesCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public OutlookUserSupportedLanguagesCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public OutlookUserSupportedLanguagesCollectionRequest skipToken(@Nonnull final String skipToken) {
