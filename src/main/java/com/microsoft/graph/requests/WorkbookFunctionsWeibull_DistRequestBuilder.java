...
import com.microsoft.graph.requests.WorkbookFunctionsWeibull_DistRequest;
 ...
 */
public class WorkbookFunctionsWeibull_DistRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsWeibull_DistRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsWeibull_DistParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsWeibull_Dist
     *
     * @param requestUrl     the request URL
    ...
    public WorkbookFunctionsWeibull_DistRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsWeibull_DistRequest request = new WorkbookFunctionsWeibull_DistRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
