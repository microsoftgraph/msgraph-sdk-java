...
public class ManagedDeviceMobileAppConfigurationAssignRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceMobileAppConfigurationAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final ManagedDeviceMobileAppConfigurationAssignParameterSet parameters) {
