...
import com.microsoft.graph.requests.ReportRootGetYammerGroupsActivityDetailRequest;
 ...
 */
public class ReportRootGetYammerGroupsActivityDetailRequestBuilder extends BaseFunctionRequestBuilder<java.io.InputStream> {
     ...
     */
    public ReportRootGetYammerGroupsActivityDetailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
