...
import com.microsoft.graph.requests.WorkbookFunctionsEvenRequest;
...
public class WorkbookFunctionsEvenRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsEvenRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsEvenParameterSet parameters) {
