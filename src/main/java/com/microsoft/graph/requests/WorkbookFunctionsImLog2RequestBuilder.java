...
import com.microsoft.graph.requests.WorkbookFunctionsImLog2Request;
...
public class WorkbookFunctionsImLog2RequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsImLog2RequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsImLog2Request buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
