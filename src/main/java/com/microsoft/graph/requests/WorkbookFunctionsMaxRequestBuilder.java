...
import com.microsoft.graph.requests.WorkbookFunctionsMaxRequest;
...
public class WorkbookFunctionsMaxRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMaxRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsMaxParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsMax
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsMaxRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMaxParameterSet parameters) {
        super(requestUrl, client, requestOptions);
    ...
    public WorkbookFunctionsMaxRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsMaxRequest request = new WorkbookFunctionsMaxRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
