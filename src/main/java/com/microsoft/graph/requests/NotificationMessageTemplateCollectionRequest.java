...
import com.microsoft.graph.requests.NotificationMessageTemplateCollectionRequest;
...
public class NotificationMessageTemplateCollectionRequest extends BaseEntityCollectionRequest<NotificationMessageTemplate, NotificationMessageTemplateCollectionResponse, NotificationMessageTemplateCollectionPage> {
     ...
     */
    @Nonnull
    public NotificationMessageTemplateCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public NotificationMessageTemplateCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
