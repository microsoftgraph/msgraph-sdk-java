 ...
 */
public class ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest extends BaseFunctionCollectionRequest<String, ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionResponse, ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionPage> {
     ...
     */
    @Nonnull
    public ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ManagedAppRegistrationGetUserIdsWithFlaggedAppRegistrationCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
