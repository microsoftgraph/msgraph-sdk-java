...
public class EditionUpgradeConfigurationRequestBuilder extends BaseRequestBuilder<EditionUpgradeConfiguration> {
     ...
     */
    public EditionUpgradeConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the EditionUpgradeConfigurationRequest instance
     */
    @Nonnull
    public EditionUpgradeConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EditionUpgradeConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.EditionUpgradeConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
