...
public class WorkbookFilterApplyBottomPercentFilterRequestBuilder extends BaseActionRequestBuilder<WorkbookFilter> {
     ...
     */
    public WorkbookFilterApplyBottomPercentFilterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
