...
public class EducationFeedbackOutcomeRequest extends BaseRequest<EducationFeedbackOutcome> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EducationFeedbackOutcome> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EducationFeedbackOutcome> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EducationFeedbackOutcome> patchAsync(@Nonnull final EducationFeedbackOutcome sourceEducationFeedbackOutcome) {
        return sendAsync(HttpMethod.PATCH, sourceEducationFeedbackOutcome);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EducationFeedbackOutcome> postAsync(@Nonnull final EducationFeedbackOutcome newEducationFeedbackOutcome) {
        return sendAsync(HttpMethod.POST, newEducationFeedbackOutcome);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EducationFeedbackOutcome> putAsync(@Nonnull final EducationFeedbackOutcome newEducationFeedbackOutcome) {
        return sendAsync(HttpMethod.PUT, newEducationFeedbackOutcome);
    }
