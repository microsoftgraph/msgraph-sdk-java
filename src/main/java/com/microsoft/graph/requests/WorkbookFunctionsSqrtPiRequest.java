...
public class WorkbookFunctionsSqrtPiRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsSqrtPiRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsSqrtPiParameterSet parameters) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsSqrtPiRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsSqrtPiRequest expand(@Nonnull final String value) {
