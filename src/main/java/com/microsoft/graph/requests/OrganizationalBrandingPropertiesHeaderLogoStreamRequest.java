...
/**
 * The class for the Organizational Branding Properties Header Logo Stream Request.
 */
public class OrganizationalBrandingPropertiesHeaderLogoStreamRequest extends BaseStreamRequest<OrganizationalBrandingProperties> {

    /**
     * The request for the OrganizationalBrandingPropertiesHeaderLogoStream
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public OrganizationalBrandingPropertiesHeaderLogoStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
