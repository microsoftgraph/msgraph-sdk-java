...
import com.microsoft.graph.requests.GroupRenewRequest;
...
public class GroupRenewRequest extends BaseRequest<Void> {
     ...
     */
    public GroupRenewRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
