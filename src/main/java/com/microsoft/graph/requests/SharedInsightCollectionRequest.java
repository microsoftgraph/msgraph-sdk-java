...
import com.microsoft.graph.requests.SharedInsightCollectionRequest;
 ...
 */
public class SharedInsightCollectionRequest extends BaseEntityCollectionRequest<SharedInsight, SharedInsightCollectionResponse, SharedInsightCollectionPage> {
     ...
     */
    @Nonnull
    public SharedInsightCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public SharedInsightCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
