...
public class FeatureRolloutPolicyRequest extends BaseRequest<FeatureRolloutPolicy> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> patchAsync(@Nonnull final FeatureRolloutPolicy sourceFeatureRolloutPolicy) {
        return sendAsync(HttpMethod.PATCH, sourceFeatureRolloutPolicy);
    }
    ...
    public java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> postAsync(@Nonnull final FeatureRolloutPolicy newFeatureRolloutPolicy) {
        return sendAsync(HttpMethod.POST, newFeatureRolloutPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> putAsync(@Nonnull final FeatureRolloutPolicy newFeatureRolloutPolicy) {
        return sendAsync(HttpMethod.PUT, newFeatureRolloutPolicy);
    }
