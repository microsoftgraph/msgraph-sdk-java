...
import com.microsoft.graph.requests.WorkbookTableSortClearRequest;
 ...
 */
public class WorkbookTableSortClearRequestBuilder extends BaseActionRequestBuilder<WorkbookTableSort> {
     ...
     */
    public WorkbookTableSortClearRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableSortClearRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
