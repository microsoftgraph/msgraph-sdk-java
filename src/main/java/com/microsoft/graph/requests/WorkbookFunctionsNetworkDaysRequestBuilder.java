...
import com.microsoft.graph.requests.WorkbookFunctionsNetworkDaysRequest;
...
public class WorkbookFunctionsNetworkDaysRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    @Nonnull
    public WorkbookFunctionsNetworkDaysRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsNetworkDaysRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsNetworkDaysRequest request = new WorkbookFunctionsNetworkDaysRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
