...
import com.microsoft.graph.requests.ChatGetAllMessagesCollectionResponse;
import com.microsoft.graph.models.ChatMessage;
...
public class ChatGetAllMessagesCollectionRequest extends BaseFunctionCollectionRequest<ChatMessage, ChatGetAllMessagesCollectionResponse, ChatGetAllMessagesCollectionPage> {
     ...
     */
    @Nonnull
    public ChatGetAllMessagesCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ChatGetAllMessagesCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public ChatGetAllMessagesCollectionRequest skipToken(@Nonnull final String skipToken) {
