...
public class ProfilePhotoStreamRequest extends BaseStreamRequest<ProfilePhoto> {
     ...
     */
    public ProfilePhotoStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ProfilePhoto> putAsync(@Nonnull final byte[] fileContents) {
     ...
     */
    @Nullable
    public ProfilePhoto put(@Nonnull final byte[] fileContents) throws ClientException {
