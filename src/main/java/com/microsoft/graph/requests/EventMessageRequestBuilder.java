...
public class EventMessageRequestBuilder extends BaseRequestBuilder<EventMessage> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EventRequestBuilder event() {
        return new com.microsoft.graph.requests.EventRequestBuilder(getRequestUrlWithAdditionalSegment("event"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public EventMessageStreamRequestBuilder content() {
        return new EventMessageStreamRequestBuilder(getRequestUrlWithAdditionalSegment("$value"), getClient(), null);
    }
