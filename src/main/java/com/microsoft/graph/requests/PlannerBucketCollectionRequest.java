...
import com.microsoft.graph.requests.PlannerBucketCollectionRequest;
 ...
 */
public class PlannerBucketCollectionRequest extends BaseEntityCollectionRequest<PlannerBucket, PlannerBucketCollectionResponse, PlannerBucketCollectionPage> {
    ...
    public PlannerBucketCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PlannerBucketCollectionResponse.class, PlannerBucketCollectionPage.class, PlannerBucketCollectionRequestBuilder.class);
    }

    /**
     * Creates a new PlannerBucket
     * @param newPlannerBucket the PlannerBucket to create
     ...
     */
    @Nonnull
    public PlannerBucketCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public PlannerBucketCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
