...
public class EducationSubmissionSetUpResourcesFolderRequest extends BaseRequest<EducationSubmission> {
     ...
     */
    @Nonnull
    public EducationSubmissionSetUpResourcesFolderRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EducationSubmissionSetUpResourcesFolderRequest expand(@Nonnull final String value) {
