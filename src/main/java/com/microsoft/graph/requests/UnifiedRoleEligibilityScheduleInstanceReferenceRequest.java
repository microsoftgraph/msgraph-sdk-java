...
public class UnifiedRoleEligibilityScheduleInstanceReferenceRequest extends BaseReferenceRequest<UnifiedRoleEligibilityScheduleInstance> {
     ...
     */
    public UnifiedRoleEligibilityScheduleInstanceReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public UnifiedRoleEligibilityScheduleInstanceReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public UnifiedRoleEligibilityScheduleInstanceReferenceRequest expand(@Nonnull final String value) {
