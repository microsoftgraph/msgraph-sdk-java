...
/**
 * The class for the Windows App XRequest Builder.
 */
public class WindowsAppXRequestBuilder extends BaseRequestBuilder<WindowsAppX> {

    /**
     * The request builder for the WindowsAppX
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsAppXRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsAppXRequest instance
     */
    @Nonnull
    public WindowsAppXRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsAppXRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsAppXRequest(getRequestUrl(), getClient(), requestOptions);
    }
