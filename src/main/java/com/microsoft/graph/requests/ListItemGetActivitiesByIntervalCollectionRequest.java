 ...
 */
public class ListItemGetActivitiesByIntervalCollectionRequest extends BaseFunctionCollectionRequest<ItemActivityStat, ListItemGetActivitiesByIntervalCollectionResponse, ListItemGetActivitiesByIntervalCollectionPage> {
     ...
     */
    @Nonnull
    public ListItemGetActivitiesByIntervalCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ListItemGetActivitiesByIntervalCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public ListItemGetActivitiesByIntervalCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public ListItemGetActivitiesByIntervalCollectionRequest skipToken(@Nonnull final String skipToken) {
