...
import com.microsoft.graph.requests.RoomCollectionRequest;
 ...
 */
public class RoomCollectionRequest extends BaseEntityCollectionRequest<Room, RoomCollectionResponse, RoomCollectionPage> {
     ...
     */
    @Nonnull
    public RoomCollectionRequest count(final boolean value) {
