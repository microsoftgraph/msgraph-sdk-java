...
public class WorkbookFunctionsHyperlinkRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsHyperlinkRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsHyperlinkParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsHyperlink
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsHyperlinkRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsHyperlinkParameterSet parameters) {
        super(requestUrl, client, requestOptions);
