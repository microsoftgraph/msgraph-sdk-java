...
public class TodoTaskListDeltaCollectionRequest extends BaseDeltaCollectionRequest<TodoTaskList, TodoTaskListDeltaCollectionResponse, TodoTaskListDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public TodoTaskListDeltaCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public TodoTaskListDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public TodoTaskListDeltaCollectionRequest skipToken(@Nonnull final String skipToken) {
     ...
     */
    @Nonnull
    public TodoTaskListDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public TodoTaskListDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
