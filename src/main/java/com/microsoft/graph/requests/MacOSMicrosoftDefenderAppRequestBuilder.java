...
/**
 * The class for the Mac OSMicrosoft Defender App Request Builder.
 */
public class MacOSMicrosoftDefenderAppRequestBuilder extends BaseRequestBuilder<MacOSMicrosoftDefenderApp> {

    /**
     * The request builder for the MacOSMicrosoftDefenderApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSMicrosoftDefenderAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSMicrosoftDefenderAppRequest instance
     */
    @Nonnull
    public MacOSMicrosoftDefenderAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSMicrosoftDefenderAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSMicrosoftDefenderAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
