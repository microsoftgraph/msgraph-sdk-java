...
public class MacOSMicrosoftEdgeAppRequest extends BaseRequest<MacOSMicrosoftEdgeApp> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMicrosoftEdgeApp> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMicrosoftEdgeApp> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMicrosoftEdgeApp> patchAsync(@Nonnull final MacOSMicrosoftEdgeApp sourceMacOSMicrosoftEdgeApp) {
        return sendAsync(HttpMethod.PATCH, sourceMacOSMicrosoftEdgeApp);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMicrosoftEdgeApp> postAsync(@Nonnull final MacOSMicrosoftEdgeApp newMacOSMicrosoftEdgeApp) {
        return sendAsync(HttpMethod.POST, newMacOSMicrosoftEdgeApp);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMicrosoftEdgeApp> putAsync(@Nonnull final MacOSMicrosoftEdgeApp newMacOSMicrosoftEdgeApp) {
        return sendAsync(HttpMethod.PUT, newMacOSMicrosoftEdgeApp);
    }
