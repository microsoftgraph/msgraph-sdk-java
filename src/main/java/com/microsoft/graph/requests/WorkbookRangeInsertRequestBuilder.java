...
public class WorkbookRangeInsertRequestBuilder extends BaseActionRequestBuilder<WorkbookRange> {
     ...
     */
    public WorkbookRangeInsertRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
