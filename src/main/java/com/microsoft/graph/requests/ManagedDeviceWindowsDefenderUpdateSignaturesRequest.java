...
import com.microsoft.graph.requests.ManagedDeviceWindowsDefenderUpdateSignaturesRequest;
...
public class ManagedDeviceWindowsDefenderUpdateSignaturesRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceWindowsDefenderUpdateSignaturesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
