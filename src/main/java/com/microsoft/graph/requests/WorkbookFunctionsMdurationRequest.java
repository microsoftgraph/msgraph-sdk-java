...
import com.microsoft.graph.requests.WorkbookFunctionsMdurationRequest;
...
public class WorkbookFunctionsMdurationRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMdurationRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMdurationParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsMdurationParameterSet body;
    /**
