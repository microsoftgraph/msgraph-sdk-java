...
import com.microsoft.graph.requests.RemoteAssistancePartnerBeginOnboardingRequest;
 ...
 */
public class RemoteAssistancePartnerBeginOnboardingRequestBuilder extends BaseActionRequestBuilder<RemoteAssistancePartner> {
     ...
     */
    public RemoteAssistancePartnerBeginOnboardingRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public RemoteAssistancePartnerBeginOnboardingRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
