...
import com.microsoft.graph.requests.ScopedRoleMembershipCollectionResponse;
...
public class ScopedRoleMembershipCollectionRequest extends BaseEntityCollectionRequest<ScopedRoleMembership, ScopedRoleMembershipCollectionResponse, ScopedRoleMembershipCollectionPage> {
     ...
     */
    @Nonnull
    public ScopedRoleMembershipCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ScopedRoleMembershipCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
