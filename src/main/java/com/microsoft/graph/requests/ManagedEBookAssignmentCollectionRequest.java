...
import com.microsoft.graph.requests.ManagedEBookAssignmentCollectionRequest;
...
public class ManagedEBookAssignmentCollectionRequest extends BaseEntityCollectionRequest<ManagedEBookAssignment, ManagedEBookAssignmentCollectionResponse, ManagedEBookAssignmentCollectionPage> {
    ...
    /**
     * Creates a new ManagedEBookAssignment
     * @param newManagedEBookAssignment the ManagedEBookAssignment to create
     ...
     */
    @Nonnull
    public ManagedEBookAssignmentCollectionRequest count(final boolean value) {
