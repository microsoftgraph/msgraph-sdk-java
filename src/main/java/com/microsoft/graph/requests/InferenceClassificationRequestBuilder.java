...
public class InferenceClassificationRequestBuilder extends BaseRequestBuilder<InferenceClassification> {
     ...
     */
    public InferenceClassificationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public InferenceClassificationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public InferenceClassificationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.InferenceClassificationRequest(getRequestUrl(), getClient(), requestOptions);
    }
