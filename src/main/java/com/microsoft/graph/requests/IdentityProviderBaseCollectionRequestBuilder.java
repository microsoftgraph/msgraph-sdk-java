...
/**
 * The class for the Identity Provider Base Collection Request Builder.
 */
public class IdentityProviderBaseCollectionRequestBuilder extends BaseCollectionRequestBuilder<IdentityProviderBase, IdentityProviderBaseRequestBuilder, IdentityProviderBaseCollectionResponse, IdentityProviderBaseCollectionPage, IdentityProviderBaseCollectionRequest> {
     ...
     */
    public IdentityProviderBaseCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, IdentityProviderBaseRequestBuilder.class, IdentityProviderBaseCollectionRequest.class);
    }
