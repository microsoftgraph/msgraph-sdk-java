 ...
 */
public class AppleDeviceFeaturesConfigurationBaseRequestBuilder extends BaseRequestBuilder<AppleDeviceFeaturesConfigurationBase> {
     ...
     */
    public AppleDeviceFeaturesConfigurationBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public AppleDeviceFeaturesConfigurationBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AppleDeviceFeaturesConfigurationBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AppleDeviceFeaturesConfigurationBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
