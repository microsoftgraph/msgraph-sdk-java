...
public class ManagedDeviceWipeRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceWipeRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

	/** The body for the method */
    @Nullable
    public ManagedDeviceWipeParameterSet body;
    /**
