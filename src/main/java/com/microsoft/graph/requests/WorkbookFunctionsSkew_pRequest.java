...
import com.microsoft.graph.requests.WorkbookFunctionsSkew_pRequest;
...
public class WorkbookFunctionsSkew_pRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsSkew_pRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsSkew_pParameterSet parameters) {
