 ...
 */
public class EventMessageRequestStreamRequestBuilder extends BaseRequestBuilder<InputStream> {
     ...
     */
    public EventMessageRequestStreamRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the EventMessageRequestStreamRequest instance
     */
    @Nonnull
    public EventMessageRequestStreamRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EventMessageRequestStreamRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new EventMessageRequestStreamRequest(getRequestUrl(), getClient(), requestOptions);
    }
