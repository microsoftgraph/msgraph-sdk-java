...
import com.microsoft.graph.requests.WorkbookFunctionsDurationRequest;
...
public class WorkbookFunctionsDurationRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsDurationParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsDuration
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsDurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDurationParameterSet parameters) {
        super(requestUrl, client, requestOptions);
    ...
    public WorkbookFunctionsDurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsDurationRequest request = new WorkbookFunctionsDurationRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
