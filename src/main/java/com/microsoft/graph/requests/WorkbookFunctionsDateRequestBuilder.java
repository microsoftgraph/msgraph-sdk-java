...
public class WorkbookFunctionsDateRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsDateParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsDate
     *
     * @param requestUrl     the request URL
     ...
     */
    @Nonnull
    public WorkbookFunctionsDateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsDateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsDateRequest request = new WorkbookFunctionsDateRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
