...
public class ReportRootGetM365AppUserCountsRequest extends BaseRequest<java.io.InputStream> {
     ...
     */
    @Nonnull
    public ReportRootGetM365AppUserCountsRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ReportRootGetM365AppUserCountsRequest expand(@Nonnull final String value) {
