...
import com.microsoft.graph.requests.TargetedManagedAppProtectionAssignRequest;
...
public class TargetedManagedAppProtectionAssignRequestBuilder extends BaseActionRequestBuilder<TargetedManagedAppProtection> {
     ...
     */
    public TargetedManagedAppProtectionAssignRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public TargetedManagedAppProtectionAssignRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final TargetedManagedAppProtectionAssignRequest request = new TargetedManagedAppProtectionAssignRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
