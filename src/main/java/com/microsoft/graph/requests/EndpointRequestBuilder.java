...
public class EndpointRequestBuilder extends BaseRequestBuilder<Endpoint> {
     ...
     */
    @Nonnull
    public EndpointRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EndpointRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.EndpointRequest(getRequestUrl(), getClient(), requestOptions);
    }
