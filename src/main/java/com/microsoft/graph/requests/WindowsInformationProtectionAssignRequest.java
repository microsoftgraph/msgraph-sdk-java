...
import com.microsoft.graph.requests.WindowsInformationProtectionAssignRequest;
...
public class WindowsInformationProtectionAssignRequest extends BaseRequest<Void> {
     ...
     */
    public WindowsInformationProtectionAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WindowsInformationProtectionAssignParameterSet parameters) {
