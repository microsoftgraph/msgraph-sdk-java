...
public class WorkbookFunctionsYieldDiscRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsYieldDiscRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsYieldDiscParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsYieldDisc
     *
     * @param requestUrl     the request URL
