...
import com.microsoft.graph.requests.WorkbookFunctionsNominalRequest;
...
public class WorkbookFunctionsNominalRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsNominalRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public WorkbookFunctionsNominalRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final WorkbookFunctionsNominalRequest request = new WorkbookFunctionsNominalRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
