...
public class WorkbookFunctionsIsEvenRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsIsEvenRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsIsEvenParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsIsEvenParameterSet body;
    /**
