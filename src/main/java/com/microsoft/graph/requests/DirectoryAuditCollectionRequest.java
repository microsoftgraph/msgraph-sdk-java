...
import com.microsoft.graph.requests.DirectoryAuditCollectionRequest;
 ...
 */
public class DirectoryAuditCollectionRequest extends BaseEntityCollectionRequest<DirectoryAudit, DirectoryAuditCollectionResponse, DirectoryAuditCollectionPage> {
     ...
     */
    @Nonnull
    public DirectoryAuditCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DirectoryAuditCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
