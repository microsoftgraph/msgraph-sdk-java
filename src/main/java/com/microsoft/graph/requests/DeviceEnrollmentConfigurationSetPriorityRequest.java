...
import com.microsoft.graph.requests.DeviceEnrollmentConfigurationSetPriorityRequest;
...
public class DeviceEnrollmentConfigurationSetPriorityRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceEnrollmentConfigurationSetPriorityRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DeviceEnrollmentConfigurationSetPriorityParameterSet parameters) {
