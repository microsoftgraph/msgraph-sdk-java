...
import com.microsoft.graph.requests.WorkbookFunctionsDcountARequest;
...
public class WorkbookFunctionsDcountARequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsDcountARequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }
    private WorkbookFunctionsDcountAParameterSet body;
    /**
     * The request builder for this WorkbookFunctionsDcountA
     *
     * @param requestUrl     the request URL
     ...
     */
    public WorkbookFunctionsDcountARequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsDcountAParameterSet parameters) {
        super(requestUrl, client, requestOptions);
     ...
     */
    @Nonnull
    public WorkbookFunctionsDcountARequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
