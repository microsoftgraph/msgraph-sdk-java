 ...
 */
public class DriveItemGetActivitiesByIntervalCollectionRequest extends BaseFunctionCollectionRequest<ItemActivityStat, DriveItemGetActivitiesByIntervalCollectionResponse, DriveItemGetActivitiesByIntervalCollectionPage> {
     ...
     */
    @Nonnull
    public DriveItemGetActivitiesByIntervalCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public DriveItemGetActivitiesByIntervalCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public DriveItemGetActivitiesByIntervalCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public DriveItemGetActivitiesByIntervalCollectionRequest skipToken(@Nonnull final String skipToken) {
