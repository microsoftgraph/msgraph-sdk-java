 ...
 */
public class ReportRootGetOneDriveUsageFileCountsRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetOneDriveUsageFileCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
