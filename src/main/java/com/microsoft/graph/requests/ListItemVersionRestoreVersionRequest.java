...
public class ListItemVersionRestoreVersionRequest extends BaseRequest<Void> {
     ...
     */
    public ListItemVersionRestoreVersionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

    /**
     * Creates the ListItemVersionRestoreVersion
     *
