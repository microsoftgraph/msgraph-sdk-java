...
public class MailFolderDeltaCollectionRequest extends BaseDeltaCollectionRequest<MailFolder, MailFolderDeltaCollectionResponse, MailFolderDeltaCollectionPage> {
     ...
     */
    @Nonnull
    public MailFolderDeltaCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public MailFolderDeltaCollectionRequest skipToken(@Nonnull final String skipToken) {
     ...
     */
    @Nonnull
    public MailFolderDeltaCollectionRequest deltaToken(@Nonnull final String deltaToken) {
     ...
     */
    @Nonnull
    public MailFolderDeltaCollectionRequest deltaLink(@Nonnull final String deltaLink) {
