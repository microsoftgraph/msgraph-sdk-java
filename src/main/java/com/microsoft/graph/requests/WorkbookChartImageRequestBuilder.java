...
import com.microsoft.graph.requests.WorkbookChartImageRequest;
 ...
 */
public class WorkbookChartImageRequestBuilder extends BaseFunctionRequestBuilder<String> {
     ...
     */
    public WorkbookChartImageRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookChartImageRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
