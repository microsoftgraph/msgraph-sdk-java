...
import com.microsoft.graph.requests.EventSnoozeReminderRequest;
...
public class EventSnoozeReminderRequest extends BaseRequest<Void> {
     ...
     */
    public EventSnoozeReminderRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final EventSnoozeReminderParameterSet parameters) {
