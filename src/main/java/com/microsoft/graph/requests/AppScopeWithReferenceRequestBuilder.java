 ...
 */
public class AppScopeWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<AppScope, AppScopeWithReferenceRequest, AppScopeReferenceRequestBuilder> {
     ...
     */
    public AppScopeWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
