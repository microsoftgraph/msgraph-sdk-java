...
public class GroupLifecyclePolicyRequestBuilder extends BaseRequestBuilder<GroupLifecyclePolicy> {
    ...
    public GroupLifecyclePolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.GroupLifecyclePolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyAddGroupRequestBuilder addGroup(@Nonnull final GroupLifecyclePolicyAddGroupParameterSet parameters) {
        return new GroupLifecyclePolicyAddGroupRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.addGroup"), getClient(), null, parameters);
    }
     ...
     */
    @Nonnull
    public GroupLifecyclePolicyRemoveGroupRequestBuilder removeGroup(@Nonnull final GroupLifecyclePolicyRemoveGroupParameterSet parameters) {
        return new GroupLifecyclePolicyRemoveGroupRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.removeGroup"), getClient(), null, parameters);
    }
}
