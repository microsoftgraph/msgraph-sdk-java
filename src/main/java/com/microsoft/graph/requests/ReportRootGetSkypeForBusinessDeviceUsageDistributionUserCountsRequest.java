...
import com.microsoft.graph.requests.ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest;
 ...
 */
public class ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest extends BaseRequest<java.io.InputStream> {
    /**
     ...
     */
    public ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
