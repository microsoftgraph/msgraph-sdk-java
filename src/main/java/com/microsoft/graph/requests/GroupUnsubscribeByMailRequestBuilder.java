...
import com.microsoft.graph.requests.GroupUnsubscribeByMailRequest;
 ...
 */
public class GroupUnsubscribeByMailRequestBuilder extends BaseActionRequestBuilder<Group> {
     ...
     */
    public GroupUnsubscribeByMailRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GroupUnsubscribeByMailRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
