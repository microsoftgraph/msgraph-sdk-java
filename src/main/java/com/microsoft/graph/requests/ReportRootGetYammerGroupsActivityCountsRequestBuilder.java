...
public class ReportRootGetYammerGroupsActivityCountsRequestBuilder extends BaseFunctionRequestBuilder<java.io.InputStream> {
     ...
     */
    public ReportRootGetYammerGroupsActivityCountsRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
