...
public class PresenceRequestBuilder extends BaseRequestBuilder<Presence> {
     ...
     */
    @Nonnull
    public PresenceSetStatusMessageRequestBuilder setStatusMessage(@Nonnull final PresenceSetStatusMessageParameterSet parameters) {
        return new PresenceSetStatusMessageRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.setStatusMessage"), getClient(), null, parameters);
    }
