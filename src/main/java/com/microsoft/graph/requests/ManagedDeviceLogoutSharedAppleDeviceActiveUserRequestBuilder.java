...
import com.microsoft.graph.requests.ManagedDeviceLogoutSharedAppleDeviceActiveUserRequest;
 ...
 */
public class ManagedDeviceLogoutSharedAppleDeviceActiveUserRequestBuilder extends BaseActionRequestBuilder<ManagedDevice> {
     ...
     */
    public ManagedDeviceLogoutSharedAppleDeviceActiveUserRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public ManagedDeviceLogoutSharedAppleDeviceActiveUserRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
