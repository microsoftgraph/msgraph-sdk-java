...
import com.microsoft.graph.requests.IosUpdateDeviceStatusCollectionRequest;
...
public class IosUpdateDeviceStatusCollectionRequestBuilder extends BaseCollectionRequestBuilder<IosUpdateDeviceStatus, IosUpdateDeviceStatusRequestBuilder, IosUpdateDeviceStatusCollectionResponse, IosUpdateDeviceStatusCollectionPage, IosUpdateDeviceStatusCollectionRequest> {
    ...
    public IosUpdateDeviceStatusCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, IosUpdateDeviceStatusRequestBuilder.class, IosUpdateDeviceStatusCollectionRequest.class);
    }
