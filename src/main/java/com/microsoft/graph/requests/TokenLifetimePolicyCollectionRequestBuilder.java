 ...
 */
public class TokenLifetimePolicyCollectionRequestBuilder extends BaseCollectionRequestBuilder<TokenLifetimePolicy, TokenLifetimePolicyRequestBuilder, TokenLifetimePolicyCollectionResponse, TokenLifetimePolicyCollectionPage, TokenLifetimePolicyCollectionRequest> {
     ...
     */
    public TokenLifetimePolicyCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
