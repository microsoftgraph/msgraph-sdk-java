...
import com.microsoft.graph.requests.WorkbookFunctionsMirrRequest;
...
public class WorkbookFunctionsMirrRequest extends BaseRequest<WorkbookFunctionResult> {
     ...
     */
    public WorkbookFunctionsMirrRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsMirrParameterSet parameters) {
    ...
    @Nullable
    protected WorkbookFunctionsMirrParameterSet body;
    /**
