...
public class AuthenticationRequest extends BaseRequest<Authentication> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Authentication> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Authentication> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Authentication> patchAsync(@Nonnull final Authentication sourceAuthentication) {
        return sendAsync(HttpMethod.PATCH, sourceAuthentication);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Authentication> postAsync(@Nonnull final Authentication newAuthentication) {
        return sendAsync(HttpMethod.POST, newAuthentication);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Authentication> putAsync(@Nonnull final Authentication newAuthentication) {
        return sendAsync(HttpMethod.PUT, newAuthentication);
    }
