...
public class AgreementRequest extends BaseRequest<Agreement> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Agreement> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Agreement> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Agreement> patchAsync(@Nonnull final Agreement sourceAgreement) {
        return sendAsync(HttpMethod.PATCH, sourceAgreement);
    }
    ...
    public java.util.concurrent.CompletableFuture<Agreement> postAsync(@Nonnull final Agreement newAgreement) {
        return sendAsync(HttpMethod.POST, newAgreement);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Agreement> putAsync(@Nonnull final Agreement newAgreement) {
        return sendAsync(HttpMethod.PUT, newAgreement);
    }
