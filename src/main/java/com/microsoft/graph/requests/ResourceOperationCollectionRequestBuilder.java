...
import com.microsoft.graph.requests.ResourceOperationCollectionRequest;
...
public class ResourceOperationCollectionRequestBuilder extends BaseCollectionRequestBuilder<ResourceOperation, ResourceOperationRequestBuilder, ResourceOperationCollectionResponse, ResourceOperationCollectionPage, ResourceOperationCollectionRequest> {
     ...
     */
    public ResourceOperationCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ResourceOperationRequestBuilder.class, ResourceOperationCollectionRequest.class);
    }
