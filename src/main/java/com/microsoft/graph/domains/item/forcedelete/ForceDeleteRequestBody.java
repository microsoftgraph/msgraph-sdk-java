...
public class ForceDeleteRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a forceDeleteRequestBody
     */
    @javax.annotation.Nonnull
    public static ForceDeleteRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ForceDeleteRequestBody currentObject = this;
