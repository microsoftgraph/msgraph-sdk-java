...
public class PromoteResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * @return a promoteResponse
     */
    @jakarta.annotation.Nonnull
    public static PromoteResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
