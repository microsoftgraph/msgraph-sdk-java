...
public class DomainsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DomainCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DomainCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DomainCollectionResponse>();
