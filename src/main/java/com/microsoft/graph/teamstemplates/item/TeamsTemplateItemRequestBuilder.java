...
public class TeamsTemplateItemRequestBuilder {
     ...
     * @return a CompletableFuture of teamsTemplate
     */
    public java.util.concurrent.CompletableFuture<TeamsTemplate> patch(@javax.annotation.Nonnull final TeamsTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<TeamsTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
