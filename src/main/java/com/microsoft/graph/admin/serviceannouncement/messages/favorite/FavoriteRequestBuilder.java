...
public class FavoriteRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final FavoritePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<FavoriteResponse> post(@javax.annotation.Nonnull final FavoritePostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<FavoriteResponse> executionException = new java.util.concurrent.CompletableFuture<FavoriteResponse>();
