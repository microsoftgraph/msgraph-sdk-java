...
public class UnarchiveResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a unarchiveResponse
     */
    @javax.annotation.Nonnull
    public static UnarchiveResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnarchiveResponse currentObject = this;
