package microsoft.graph.admin.serviceannouncement.issues.item;
...
import microsoft.graph.admin.serviceannouncement.issues.item.incidentreport.IncidentReportRequestBuilder;
