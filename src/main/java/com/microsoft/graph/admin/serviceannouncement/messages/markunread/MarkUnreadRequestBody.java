package microsoft.graph.admin.serviceannouncement.messages.markunread;
...
public class MarkUnreadRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a markUnreadRequestBody
     */
    @javax.annotation.Nonnull
    public static MarkUnreadRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MarkUnreadRequestBody currentObject = this;
