package microsoft.graph.admin.serviceannouncement.healthoverviews;
...
import microsoft.graph.admin.serviceannouncement.healthoverviews.count.CountRequestBuilder;
...
public class HealthOverviewsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ServiceHealthCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ServiceHealthCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ServiceHealthCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ServiceHealthCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<HealthOverviewsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ServiceHealthCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of serviceHealth
     */
    public java.util.concurrent.CompletableFuture<ServiceHealth> post(@javax.annotation.Nonnull final ServiceHealth body, @javax.annotation.Nullable final java.util.function.Consumer<HealthOverviewsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
