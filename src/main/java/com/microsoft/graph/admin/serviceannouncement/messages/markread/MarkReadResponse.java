...
public class MarkReadResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a markReadResponse
     */
    @javax.annotation.Nonnull
    public static MarkReadResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MarkReadResponse currentObject = this;
