...
public class UnarchiveRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unarchiveRequestBody
     */
    @javax.annotation.Nonnull
    public static UnarchiveRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnarchiveRequestBody currentObject = this;
