...
public class MarkReadRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MarkReadResponse> post(@javax.annotation.Nonnull final MarkReadPostRequestBody body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MarkReadResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of markReadResponse
     */
    public java.util.concurrent.CompletableFuture<MarkReadResponse> post(@javax.annotation.Nonnull final MarkReadPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<MarkReadRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, MarkReadResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
