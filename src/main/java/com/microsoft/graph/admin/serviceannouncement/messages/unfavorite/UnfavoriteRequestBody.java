...
public class UnfavoriteRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unfavoriteRequestBody
     */
    @javax.annotation.Nonnull
    public static UnfavoriteRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnfavoriteRequestBody currentObject = this;
