...
public class MarkReadRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a markReadRequestBody
     */
    @javax.annotation.Nonnull
    public static MarkReadRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MarkReadRequestBody currentObject = this;
