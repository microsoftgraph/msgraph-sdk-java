...
public class FavoriteRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a favoriteRequestBody
     */
    @javax.annotation.Nonnull
    public static FavoriteRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FavoriteRequestBody currentObject = this;
