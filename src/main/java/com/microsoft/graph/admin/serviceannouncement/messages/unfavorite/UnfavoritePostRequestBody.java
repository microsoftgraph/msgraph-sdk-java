...
public class UnfavoritePostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unfavoritePostRequestBody
     */
    @javax.annotation.Nonnull
    public static UnfavoritePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnfavoritePostRequestBody currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(1);
        deserializerMap.put("messageIds", (n) -> { currentObject.setMessageIds(n.getCollectionOfPrimitiveValues(String.class)); });
