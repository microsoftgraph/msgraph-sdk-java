...
public class UnfavoriteRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UnfavoritePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UnfavoriteResponse> post(@javax.annotation.Nonnull final UnfavoritePostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnfavoriteResponse> executionException = new java.util.concurrent.CompletableFuture<UnfavoriteResponse>();
