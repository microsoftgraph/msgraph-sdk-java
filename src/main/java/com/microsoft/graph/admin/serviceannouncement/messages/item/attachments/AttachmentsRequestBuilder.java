...
public class AttachmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ServiceAnnouncementAttachment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ServiceAnnouncementAttachmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ServiceAnnouncementAttachmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ServiceAnnouncementAttachmentCollectionResponse>();
