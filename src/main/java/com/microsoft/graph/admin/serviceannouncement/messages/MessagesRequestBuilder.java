...
public class MessagesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ServiceUpdateMessage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ServiceUpdateMessageCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ServiceUpdateMessageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ServiceUpdateMessageCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ServiceUpdateMessage> post(@javax.annotation.Nonnull final ServiceUpdateMessage body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ServiceUpdateMessage> executionException = new java.util.concurrent.CompletableFuture<ServiceUpdateMessage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
