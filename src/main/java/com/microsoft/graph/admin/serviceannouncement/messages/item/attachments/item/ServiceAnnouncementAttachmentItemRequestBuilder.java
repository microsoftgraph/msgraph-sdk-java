...
public class ServiceAnnouncementAttachmentItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceAnnouncementAttachment get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceAnnouncementAttachment patch(@jakarta.annotation.Nonnull final ServiceAnnouncementAttachment body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceAnnouncementAttachment patch(@jakarta.annotation.Nonnull final ServiceAnnouncementAttachment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public ServiceAnnouncementAttachmentItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
