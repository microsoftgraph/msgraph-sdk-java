...
public class MarkUnreadResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a markUnreadResponse
     */
    @javax.annotation.Nonnull
    public static MarkUnreadResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MarkUnreadResponse currentObject = this;
