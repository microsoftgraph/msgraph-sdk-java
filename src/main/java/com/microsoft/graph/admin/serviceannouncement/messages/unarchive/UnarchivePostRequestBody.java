...
public class UnarchivePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static UnarchivePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnarchivePostRequestBody currentObject = this;
