package microsoft.graph.admin.serviceannouncement.messages.archive;
...
public class ArchiveRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a archiveRequestBody
     */
    @javax.annotation.Nonnull
    public static ArchiveRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ArchiveRequestBody currentObject = this;
