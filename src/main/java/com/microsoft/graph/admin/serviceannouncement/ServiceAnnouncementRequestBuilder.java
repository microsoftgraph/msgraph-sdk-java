...
public class ServiceAnnouncementRequestBuilder {
     ...
     * @return a CompletableFuture of serviceAnnouncement
     */
    public java.util.concurrent.CompletableFuture<ServiceAnnouncement> patch(@javax.annotation.Nonnull final ServiceAnnouncement body, @javax.annotation.Nullable final java.util.function.Consumer<ServiceAnnouncementRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
