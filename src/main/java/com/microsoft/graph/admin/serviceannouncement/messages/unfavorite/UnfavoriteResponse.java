...
public class UnfavoriteResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a unfavoriteResponse
     */
    @javax.annotation.Nonnull
    public static UnfavoriteResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnfavoriteResponse currentObject = this;
