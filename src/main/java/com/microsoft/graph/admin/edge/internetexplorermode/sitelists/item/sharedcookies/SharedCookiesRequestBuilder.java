...
public class SharedCookiesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a BrowserSharedCookieCollectionResponse
    ...
    public BrowserSharedCookieCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, BrowserSharedCookieCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public BrowserSharedCookie post(@jakarta.annotation.Nonnull final BrowserSharedCookie body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, BrowserSharedCookie::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of the browserSharedCookie objects and their properties. This API is available in the following national cloud deployments.
