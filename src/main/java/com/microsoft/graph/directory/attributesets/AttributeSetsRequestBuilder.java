...
public class AttributeSetsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AttributeSetCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AttributeSetCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<AttributeSetCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AttributeSetCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AttributeSetCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AttributeSet> post(@jakarta.annotation.Nonnull final AttributeSet body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AttributeSet> post(@jakarta.annotation.Nonnull final AttributeSet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AttributeSet body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AttributeSet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
