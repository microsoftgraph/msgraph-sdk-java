...
public class AdministrativeUnitsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AdministrativeUnit body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AdministrativeUnitCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AdministrativeUnitCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AdministrativeUnitCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AdministrativeUnit> post(@javax.annotation.Nonnull final AdministrativeUnit body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AdministrativeUnit> executionException = new java.util.concurrent.CompletableFuture<AdministrativeUnit>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
