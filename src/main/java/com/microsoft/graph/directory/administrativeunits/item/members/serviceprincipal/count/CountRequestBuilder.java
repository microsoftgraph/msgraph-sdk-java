package com.microsoft.graph.directory.administrativeunits.item.members.serviceprincipal.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.servicePrincipal/$count";
