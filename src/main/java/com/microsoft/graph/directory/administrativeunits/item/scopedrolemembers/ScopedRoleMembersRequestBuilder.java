...
public class ScopedRoleMembersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ScopedRoleMembership body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ScopedRoleMembershipCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ScopedRoleMembershipCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ScopedRoleMembershipCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ScopedRoleMembership> post(@javax.annotation.Nonnull final ScopedRoleMembership body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ScopedRoleMembership> executionException = new java.util.concurrent.CompletableFuture<ScopedRoleMembership>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
