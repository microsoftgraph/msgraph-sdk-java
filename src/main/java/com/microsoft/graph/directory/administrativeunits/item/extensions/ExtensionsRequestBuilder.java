package microsoft.graph.directory.administrativeunits.item.extensions;
...
import microsoft.graph.directory.administrativeunits.item.extensions.count.CountRequestBuilder;
