...
public class FederationConfigurationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final IdentityProviderBase body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IdentityProviderBaseCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityProviderBaseCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IdentityProviderBaseCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<IdentityProviderBase> post(@javax.annotation.Nonnull final IdentityProviderBase body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityProviderBase> executionException = new java.util.concurrent.CompletableFuture<IdentityProviderBase>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
