...
public class AvailableProviderTypesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AvailableProviderTypesResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AvailableProviderTypesResponse> executionException = new java.util.concurrent.CompletableFuture<AvailableProviderTypesResponse>();
