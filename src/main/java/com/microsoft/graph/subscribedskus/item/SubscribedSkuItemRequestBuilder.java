...
public class SubscribedSkuItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SubscribedSku body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SubscribedSku> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SubscribedSku> executionException = new java.util.concurrent.CompletableFuture<SubscribedSku>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
