...
public class ProvisioningRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ProvisioningObjectSummaryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProvisioningObjectSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ProvisioningObjectSummaryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ProvisioningObjectSummary> post(@javax.annotation.Nonnull final ProvisioningObjectSummary body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProvisioningObjectSummary> executionException = new java.util.concurrent.CompletableFuture<ProvisioningObjectSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
