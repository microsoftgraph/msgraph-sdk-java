...
public class PermissionGrantPolicyItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PermissionGrantPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PermissionGrantPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PermissionGrantPolicy> executionException = new java.util.concurrent.CompletableFuture<PermissionGrantPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
