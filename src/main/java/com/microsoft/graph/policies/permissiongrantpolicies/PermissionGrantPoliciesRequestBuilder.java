...
public class PermissionGrantPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PermissionGrantPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PermissionGrantPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PermissionGrantPolicyCollectionResponse>();
