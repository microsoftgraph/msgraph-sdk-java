...
public class DefaultRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationDefault> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationDefault> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationDefault>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CrossTenantAccessPolicyConfigurationDefault body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CrossTenantAccessPolicyConfigurationDefault body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
