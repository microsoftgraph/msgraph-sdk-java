...
public class DefaultRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationDefault> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationDefault> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationDefault>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
