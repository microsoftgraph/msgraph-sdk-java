package com.microsoft.graph.policies.crosstenantaccesspolicy.partners.item.identitysynchronization;
...
public class IdentitySynchronizationRequestBuilder extends BaseRequestBuilder {
    ...
    public IdentitySynchronizationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}/identitySynchronization{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new IdentitySynchronizationRequestBuilder and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public IdentitySynchronizationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantIdentitySyncPolicyPartner> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CrossTenantIdentitySyncPolicyPartner> executionException = new java.util.concurrent.CompletableFuture<CrossTenantIdentitySyncPolicyPartner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CrossTenantIdentitySyncPolicyPartner body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CrossTenantIdentitySyncPolicyPartner body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
