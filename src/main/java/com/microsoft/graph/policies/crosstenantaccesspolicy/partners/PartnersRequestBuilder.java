...
public class PartnersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartner> post(@javax.annotation.Nonnull final CrossTenantAccessPolicyConfigurationPartner body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartner> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
