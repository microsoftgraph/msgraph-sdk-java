 ...
 */
public class PartnersRequestBuilder extends BaseRequestBuilder {
    ...
    public PartnersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PartnersRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartner> post(@javax.annotation.Nonnull final CrossTenantAccessPolicyConfigurationPartner body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartner> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicyConfigurationPartner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CrossTenantAccessPolicyConfigurationPartner body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CrossTenantAccessPolicyConfigurationPartner body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
