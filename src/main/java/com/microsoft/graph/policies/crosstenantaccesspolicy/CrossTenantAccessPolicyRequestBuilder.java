...
public class CrossTenantAccessPolicyRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final CrossTenantAccessPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CrossTenantAccessPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CrossTenantAccessPolicy> executionException = new java.util.concurrent.CompletableFuture<CrossTenantAccessPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
