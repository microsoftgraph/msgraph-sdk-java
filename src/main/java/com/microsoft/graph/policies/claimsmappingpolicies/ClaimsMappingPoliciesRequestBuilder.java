package microsoft.graph.policies.claimsmappingpolicies;
...
public class ClaimsMappingPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ClaimsMappingPolicy body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ClaimsMappingPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration requestConfig = new ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<ClaimsMappingPolicyCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ClaimsMappingPolicyCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ClaimsMappingPolicyCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ClaimsMappingPolicyCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ClaimsMappingPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ClaimsMappingPolicyCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of claimsMappingPolicy
     */
    public java.util.concurrent.CompletableFuture<ClaimsMappingPolicy> post(@javax.annotation.Nonnull final ClaimsMappingPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of claimsMappingPolicy
     */
    public java.util.concurrent.CompletableFuture<ClaimsMappingPolicy> post(@javax.annotation.Nonnull final ClaimsMappingPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
