...
public class ClaimsMappingPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ClaimsMappingPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ClaimsMappingPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ClaimsMappingPolicyCollectionResponse>();
