...
public class GetAvailableExtensionPropertiesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetAvailableExtensionPropertiesPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GetAvailableExtensionPropertiesResponse> post(@javax.annotation.Nonnull final GetAvailableExtensionPropertiesPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetAvailableExtensionPropertiesResponse> executionException = new java.util.concurrent.CompletableFuture<GetAvailableExtensionPropertiesResponse>();
