...
public class FeatureRolloutPolicyItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final FeatureRolloutPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<FeatureRolloutPolicy> executionException = new java.util.concurrent.CompletableFuture<FeatureRolloutPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
