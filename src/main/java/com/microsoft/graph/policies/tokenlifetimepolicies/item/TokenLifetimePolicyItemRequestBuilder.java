...
public class TokenLifetimePolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of tokenLifetimePolicy
     */
    public java.util.concurrent.CompletableFuture<TokenLifetimePolicy> patch(@javax.annotation.Nonnull final TokenLifetimePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<TokenLifetimePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of tokenLifetimePolicy
     */
    public java.util.concurrent.CompletableFuture<TokenLifetimePolicy> patch(@javax.annotation.Nonnull final TokenLifetimePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<TokenLifetimePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
