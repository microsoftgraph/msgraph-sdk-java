...
public class HomeRealmDiscoveryPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final HomeRealmDiscoveryPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicyCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicy> post(@javax.annotation.Nonnull final HomeRealmDiscoveryPolicy body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicy> executionException = new java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
