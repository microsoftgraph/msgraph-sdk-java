...
public class HomeRealmDiscoveryPolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of homeRealmDiscoveryPolicy
     */
    public java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicy> patch(@javax.annotation.Nonnull final HomeRealmDiscoveryPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<HomeRealmDiscoveryPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
