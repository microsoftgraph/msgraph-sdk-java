...
public class AdminConsentRequestPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AdminConsentRequestPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AdminConsentRequestPolicy> executionException = new java.util.concurrent.CompletableFuture<AdminConsentRequestPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
