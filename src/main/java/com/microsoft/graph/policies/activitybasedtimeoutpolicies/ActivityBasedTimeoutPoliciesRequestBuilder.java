package microsoft.graph.policies.activitybasedtimeoutpolicies;
...
import microsoft.graph.models.ActivityBasedTimeoutPolicyCollectionResponse;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.policies.activitybasedtimeoutpolicies.count.CountRequestBuilder;
...
public class ActivityBasedTimeoutPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ActivityBasedTimeoutPolicyCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ActivityBasedTimeoutPolicyCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ActivityBasedTimeoutPolicyCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ActivityBasedTimeoutPolicyCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ActivityBasedTimeoutPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ActivityBasedTimeoutPolicyCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of activityBasedTimeoutPolicy
     */
    public java.util.concurrent.CompletableFuture<ActivityBasedTimeoutPolicy> post(@javax.annotation.Nonnull final ActivityBasedTimeoutPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ActivityBasedTimeoutPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
