...
public class AuthenticationFlowsPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationFlowsPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationFlowsPolicy> executionException = new java.util.concurrent.CompletableFuture<AuthenticationFlowsPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
