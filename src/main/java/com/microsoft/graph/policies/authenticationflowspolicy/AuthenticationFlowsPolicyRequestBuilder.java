...
public class AuthenticationFlowsPolicyRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AuthenticationFlowsPolicy body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AuthenticationFlowsPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a AuthenticationFlowsPolicyRequestBuilder
     */
    @jakarta.annotation.Nonnull
    public AuthenticationFlowsPolicyRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
