...
public class RoleManagementPolicyAssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicyAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicyAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicyAssignmentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicyAssignment> post(@javax.annotation.Nonnull final UnifiedRoleManagementPolicyAssignment body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicyAssignment> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicyAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
