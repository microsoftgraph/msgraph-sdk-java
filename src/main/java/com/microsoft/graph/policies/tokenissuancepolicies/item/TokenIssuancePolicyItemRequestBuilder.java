...
public class TokenIssuancePolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of tokenIssuancePolicy
     */
    public java.util.concurrent.CompletableFuture<TokenIssuancePolicy> patch(@javax.annotation.Nonnull final TokenIssuancePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<TokenIssuancePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
