...
public class ScopedRoleMembershipItemRequestBuilder {
     ...
     * @return a CompletableFuture of scopedRoleMembership
     */
    public java.util.concurrent.CompletableFuture<ScopedRoleMembership> patch(@javax.annotation.Nonnull final ScopedRoleMembership body, @javax.annotation.Nullable final java.util.function.Consumer<ScopedRoleMembershipItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
