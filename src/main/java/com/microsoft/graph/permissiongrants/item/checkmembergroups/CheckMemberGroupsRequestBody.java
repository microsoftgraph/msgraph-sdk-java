...
public class CheckMemberGroupsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a checkMemberGroupsRequestBody
     */
    @javax.annotation.Nonnull
    public static CheckMemberGroupsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CheckMemberGroupsRequestBody currentObject = this;
