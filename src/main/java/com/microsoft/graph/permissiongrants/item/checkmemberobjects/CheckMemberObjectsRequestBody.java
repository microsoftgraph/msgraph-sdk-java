package microsoft.graph.permissiongrants.item.checkmemberobjects;
...
public class CheckMemberObjectsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a checkMemberObjectsRequestBody
     */
    @javax.annotation.Nonnull
    public static CheckMemberObjectsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CheckMemberObjectsRequestBody currentObject = this;
