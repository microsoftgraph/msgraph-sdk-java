...
public class SecureScoresRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SecureScoreCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SecureScoreCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SecureScoreCollectionResponse>();
