package microsoft.graph.security.securescores;
...
import microsoft.graph.models.SecureScoreCollectionResponse;
import microsoft.graph.security.securescores.count.CountRequestBuilder;
...
public class SecureScoresRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SecureScoreCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SecureScoreCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of SecureScoreCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<SecureScoreCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<SecureScoresRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, SecureScoreCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of secureScore
     */
    public java.util.concurrent.CompletableFuture<SecureScore> post(@javax.annotation.Nonnull final SecureScore body, @javax.annotation.Nullable final java.util.function.Consumer<SecureScoresRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
