...
public class AttackSimulationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AttackSimulationRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AttackSimulationRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AttackSimulationRoot> executionException = new java.util.concurrent.CompletableFuture<AttackSimulationRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
