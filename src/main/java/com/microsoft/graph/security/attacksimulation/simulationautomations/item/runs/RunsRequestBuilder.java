...
public class RunsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SimulationAutomationRunCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SimulationAutomationRunCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of SimulationAutomationRunCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<SimulationAutomationRunCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<RunsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, SimulationAutomationRunCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<SimulationAutomationRun> post(@javax.annotation.Nonnull final SimulationAutomationRun body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SimulationAutomationRun::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of simulationAutomationRun
     */
    public java.util.concurrent.CompletableFuture<SimulationAutomationRun> post(@javax.annotation.Nonnull final SimulationAutomationRun body, @javax.annotation.Nullable final java.util.function.Consumer<RunsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, SimulationAutomationRun::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
