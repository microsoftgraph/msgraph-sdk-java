...
public class RunsRequestBuilder extends BaseRequestBuilder {
    ...
    public SimulationAutomationRunCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, SimulationAutomationRunCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public SimulationAutomationRun post(@jakarta.annotation.Nonnull final SimulationAutomationRun body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, SimulationAutomationRun::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of the attack simulation automation runs for a tenant. This API is available in the following national cloud deployments.
