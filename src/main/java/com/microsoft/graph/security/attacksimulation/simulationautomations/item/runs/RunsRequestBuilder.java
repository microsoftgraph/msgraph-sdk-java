...
public class RunsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SimulationAutomationRun body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SimulationAutomationRunCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SimulationAutomationRunCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SimulationAutomationRunCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<SimulationAutomationRun> post(@javax.annotation.Nonnull final SimulationAutomationRun body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<SimulationAutomationRun> executionException = new java.util.concurrent.CompletableFuture<SimulationAutomationRun>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
