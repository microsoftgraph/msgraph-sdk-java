...
public class SimulationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Simulation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SimulationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SimulationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SimulationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Simulation> post(@javax.annotation.Nonnull final Simulation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Simulation> executionException = new java.util.concurrent.CompletableFuture<Simulation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
