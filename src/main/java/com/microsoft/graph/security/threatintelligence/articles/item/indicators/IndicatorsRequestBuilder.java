...
public class IndicatorsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public ArticleIndicatorItemRequestBuilder byArticleIndicatorId(@javax.annotation.Nonnull final String articleIndicatorId) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/security-article-list-indicators?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ArticleIndicatorCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
