...
public class HostComponentItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public HostComponent patch(@jakarta.annotation.Nonnull final HostComponent body) {
     ...
     */
    @jakarta.annotation.Nullable
    public HostComponent patch(@jakarta.annotation.Nonnull final HostComponent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
