package com.microsoft.graph.security.threatintelligence.hosttrackers.item.host;
...
public class HostRequestBuilder extends BaseRequestBuilder {
    ...
    public HostRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}/host{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new HostRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public HostRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}/host{?%24select,%24expand}", rawUrl);
    }
    /**
