...
public class IntelligenceProfileIndicatorItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public IntelligenceProfileIndicator patch(@jakarta.annotation.Nonnull final IntelligenceProfileIndicator body) {
     ...
     */
    @jakarta.annotation.Nullable
    public IntelligenceProfileIndicator patch(@jakarta.annotation.Nonnull final IntelligenceProfileIndicator body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final IntelligenceProfileIndicator body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final IntelligenceProfileIndicator body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
