...
public class VulnerabilitiesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public VulnerabilityItemRequestBuilder byVulnerabilityId(@javax.annotation.Nonnull final String vulnerabilityId) {
    ...
    public VulnerabilitiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public VulnerabilitiesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<VulnerabilityCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<VulnerabilityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<VulnerabilityCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VulnerabilityCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Vulnerability> post(@javax.annotation.Nonnull final Vulnerability body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<Vulnerability> executionException = new java.util.concurrent.CompletableFuture<Vulnerability>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Vulnerability> post(@javax.annotation.Nonnull final Vulnerability body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final Vulnerability body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final Vulnerability body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
