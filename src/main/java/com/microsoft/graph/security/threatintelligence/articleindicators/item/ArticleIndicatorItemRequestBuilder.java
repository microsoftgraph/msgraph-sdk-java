...
public class ArticleIndicatorItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public ArticleIndicator patch(@jakarta.annotation.Nonnull final ArticleIndicator body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ArticleIndicator patch(@jakarta.annotation.Nonnull final ArticleIndicator body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
