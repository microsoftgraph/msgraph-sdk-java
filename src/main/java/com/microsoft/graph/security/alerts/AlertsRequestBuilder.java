...
public class AlertsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AlertCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AlertCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AlertCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Alert> post(@javax.annotation.Nonnull final Alert body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Alert> executionException = new java.util.concurrent.CompletableFuture<Alert>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
