...
public class SecureScoreControlProfileItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SecureScoreControlProfile body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SecureScoreControlProfile> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SecureScoreControlProfile> executionException = new java.util.concurrent.CompletableFuture<SecureScoreControlProfile>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
