...
public class SecureScoreControlProfileItemRequestBuilder {
     ...
     * @return a CompletableFuture of secureScoreControlProfile
     */
    public java.util.concurrent.CompletableFuture<SecureScoreControlProfile> patch(@javax.annotation.Nonnull final SecureScoreControlProfile body, @javax.annotation.Nullable final java.util.function.Consumer<SecureScoreControlProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
