package com.microsoft.graph.security.subjectrightsrequests.item.notes;
...
import com.microsoft.graph.security.subjectrightsrequests.item.notes.count.CountRequestBuilder;
...
public class NotesRequestBuilder extends BaseRequestBuilder {
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new NotesRequestBuilder and sets the default values.
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public AuthoredNoteCollectionResponse get() {
        return get(null);
    }
    /**
     * Get the list of authored notes assoicated with a subject rights request.  This API is available in the following national cloud deployments.
     ...
     */
    @jakarta.annotation.Nullable
    public AuthoredNoteCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public AuthoredNote post(@jakarta.annotation.Nonnull final AuthoredNote body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AuthoredNote post(@jakarta.annotation.Nonnull final AuthoredNote body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
