package com.microsoft.graph.security.subjectrightsrequests.item.approvers;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UserCollectionResponse;
import com.microsoft.graph.security.subjectrightsrequests.item.approvers.count.CountRequestBuilder;
import com.microsoft.graph.security.subjectrightsrequests.item.approvers.item.UserItemRequestBuilder;
...
public class ApproversRequestBuilder extends BaseRequestBuilder {
    ...
    public ApproversRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/approvers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ApproversRequestBuilder and sets the default values.
