...
public class EdiscoveryReviewTagCollectionReferenceRequest extends BaseCollectionWithReferencesRequest<EdiscoveryReviewTag, EdiscoveryReviewTagWithReferenceRequest, EdiscoveryReviewTagReferenceRequestBuilder, EdiscoveryReviewTagWithReferenceRequestBuilder, EdiscoveryReviewTagCollectionResponse, EdiscoveryReviewTagCollectionWithReferencesPage, EdiscoveryReviewTagCollectionWithReferencesRequest> {
     ...
     */
    public EdiscoveryReviewTagCollectionReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest top(final int value) {
        addTopOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewTagCollectionReferenceRequest count() {
        addCountOption(true);
        return this;
    }
}
