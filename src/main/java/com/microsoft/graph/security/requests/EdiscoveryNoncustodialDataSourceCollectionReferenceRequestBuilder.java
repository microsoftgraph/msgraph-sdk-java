...
/**
 * The class for the Ediscovery Noncustodial Data Source Collection Reference Request Builder.
 */
public class EdiscoveryNoncustodialDataSourceCollectionReferenceRequestBuilder extends BaseCollectionReferenceRequestBuilder<EdiscoveryNoncustodialDataSource, EdiscoveryNoncustodialDataSourceReferenceRequestBuilder, EdiscoveryNoncustodialDataSourceCollectionResponse, EdiscoveryNoncustodialDataSourceCollectionWithReferencesPage, EdiscoveryNoncustodialDataSourceCollectionReferenceRequest> {
     ...
     */
    public EdiscoveryNoncustodialDataSourceCollectionReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, EdiscoveryNoncustodialDataSourceReferenceRequestBuilder.class, EdiscoveryNoncustodialDataSourceCollectionReferenceRequest.class);
    }
}
