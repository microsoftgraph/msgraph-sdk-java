...
public class SubdomainCollectionReferenceRequest extends BaseCollectionWithReferencesRequest<Subdomain, SubdomainWithReferenceRequest, SubdomainReferenceRequestBuilder, SubdomainWithReferenceRequestBuilder, SubdomainCollectionResponse, SubdomainCollectionWithReferencesPage, SubdomainCollectionWithReferencesRequest> {
     ...
     */
    public SubdomainCollectionReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest top(final int value) {
        addTopOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public SubdomainCollectionReferenceRequest count() {
        addCountOption(true);
        return this;
    }
}
