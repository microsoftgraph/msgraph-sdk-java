...
public class EdiscoveryCasesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryCaseCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryCaseCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryCaseCollectionResponse>();
