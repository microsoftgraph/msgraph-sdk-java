...
public class PurgeDataRequestBuilder {
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PurgeDataPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PurgeDataPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PurgeDataRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final PurgeDataPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PurgeDataRequestBuilderPostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
