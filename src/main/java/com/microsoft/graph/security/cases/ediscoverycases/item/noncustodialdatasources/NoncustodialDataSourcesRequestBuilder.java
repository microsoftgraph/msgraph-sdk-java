...
import com.microsoft.graph.security.cases.ediscoverycases.item.noncustodialdatasources.applyhold.ApplyHoldRequestBuilder;
import com.microsoft.graph.security.cases.ediscoverycases.item.noncustodialdatasources.count.CountRequestBuilder;
import com.microsoft.graph.security.cases.ediscoverycases.item.noncustodialdatasources.removehold.RemoveHoldRequestBuilder;
...
public class NoncustodialDataSourcesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSourceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSourceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSource> post(@javax.annotation.Nonnull final EdiscoveryNoncustodialDataSource body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSource> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSource>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
