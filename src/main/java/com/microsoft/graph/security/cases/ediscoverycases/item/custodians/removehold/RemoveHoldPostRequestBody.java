package com.microsoft.graph.security.cases.ediscoverycases.item.custodians.removehold;
...
public class RemoveHoldPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static RemoveHoldPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveHoldPostRequestBody currentObject = this;
