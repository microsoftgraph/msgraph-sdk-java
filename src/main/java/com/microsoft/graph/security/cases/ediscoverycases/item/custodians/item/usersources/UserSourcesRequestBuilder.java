...
public class UserSourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserSourceCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserSourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserSourceCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserSource> post(@jakarta.annotation.Nonnull final UserSource body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserSource> post(@jakarta.annotation.Nonnull final UserSource body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserSource body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserSource body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
