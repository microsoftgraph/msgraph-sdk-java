package microsoft.graph.security.cases.ediscoverycases.item.tags.item.childtags.item;
...
public class EdiscoveryReviewTagItemRequestBuilder {
     ...
     * @return a CompletableFuture of ediscoveryReviewTag
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewTag> get(@javax.annotation.Nullable final java.util.function.Consumer<EdiscoveryReviewTagItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
