...
public class MicrosoftGraphSecurityReleaseRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphSecurityReleaseRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public MicrosoftGraphSecurityReleaseRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/security-ediscoverycustodian-release?view=graph-rest-1.0">Find more info here</a>
     */
