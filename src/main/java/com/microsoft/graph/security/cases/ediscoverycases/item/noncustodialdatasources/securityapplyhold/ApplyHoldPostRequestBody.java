package com.microsoft.graph.security.cases.ediscoverycases.item.noncustodialdatasources.securityapplyhold;
...
public class ApplyHoldPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ApplyHoldPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
