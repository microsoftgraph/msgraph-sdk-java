...
public class SiteSourcesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SiteSource body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SiteSourceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SiteSourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SiteSourceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<SiteSource> post(@javax.annotation.Nonnull final SiteSource body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<SiteSource> executionException = new java.util.concurrent.CompletableFuture<SiteSource>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
