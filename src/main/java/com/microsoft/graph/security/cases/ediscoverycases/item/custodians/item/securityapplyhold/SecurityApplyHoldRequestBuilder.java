package com.microsoft.graph.security.cases.ediscoverycases.item.custodians.item.securityapplyhold;
...
public class SecurityApplyHoldRequestBuilder extends BaseRequestBuilder {
    ...
    public SecurityApplyHoldRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.applyHold", pathParameters);
    }
    /**
     * Instantiates a new SecurityApplyHoldRequestBuilder and sets the default values.
