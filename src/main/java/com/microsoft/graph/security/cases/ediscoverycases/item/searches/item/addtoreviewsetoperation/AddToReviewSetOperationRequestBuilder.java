package microsoft.graph.security.cases.ediscoverycases.item.searches.item.addtoreviewsetoperation;
...
import microsoft.graph.models.security.EdiscoveryAddToReviewSetOperation;
...
public class AddToReviewSetOperationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<AddToReviewSetOperationRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final AddToReviewSetOperationRequestBuilderGetRequestConfiguration requestConfig = new AddToReviewSetOperationRequestBuilderGetRequestConfiguration();
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryAddToReviewSetOperation> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryAddToReviewSetOperation::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ediscoveryAddToReviewSetOperation
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryAddToReviewSetOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<AddToReviewSetOperationRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of ediscoveryAddToReviewSetOperation
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryAddToReviewSetOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<AddToReviewSetOperationRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryAddToReviewSetOperation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
