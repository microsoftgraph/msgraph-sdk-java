...
public class PurgeDataPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PurgeDataPostRequestBody currentObject = this;
        return new HashMap<String, Consumer<ParseNode>>(2) {{
            this.put("purgeAreas", (n) -> { currentObject.setPurgeAreas(n.getEnumValue(PurgeAreas.class)); });
            this.put("purgeType", (n) -> { currentObject.setPurgeType(n.getEnumValue(PurgeType.class)); });
        }};
    }
    /**
