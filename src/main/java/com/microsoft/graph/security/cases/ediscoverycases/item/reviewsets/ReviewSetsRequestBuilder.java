package microsoft.graph.security.cases.ediscoverycases.item.reviewsets;
...
import microsoft.graph.models.security.EdiscoveryReviewSetCollectionResponse;
import microsoft.graph.security.cases.ediscoverycases.item.reviewsets.count.CountRequestBuilder;
...
public class ReviewSetsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<ReviewSetsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final ReviewSetsRequestBuilderGetRequestConfiguration requestConfig = new ReviewSetsRequestBuilderGetRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EdiscoveryReviewSet body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EdiscoveryReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<ReviewSetsRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final ReviewSetsRequestBuilderPostRequestConfiguration requestConfig = new ReviewSetsRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSetCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryReviewSetCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSetCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ReviewSetsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryReviewSetCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSet> post(@javax.annotation.Nonnull final EdiscoveryReviewSet body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryReviewSet::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of ediscoveryReviewSet
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSet> post(@javax.annotation.Nonnull final EdiscoveryReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<ReviewSetsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryReviewSet::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
