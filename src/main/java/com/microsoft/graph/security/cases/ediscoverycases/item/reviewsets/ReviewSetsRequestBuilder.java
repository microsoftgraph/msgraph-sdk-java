...
public class ReviewSetsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EdiscoveryReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSetCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryReviewSetCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryReviewSetCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSet> post(@javax.annotation.Nonnull final EdiscoveryReviewSet body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryReviewSet> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryReviewSet>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
