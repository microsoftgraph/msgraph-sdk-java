...
public class MicrosoftGraphSecurityResetToDefaultRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphSecurityResetToDefaultRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public MicrosoftGraphSecurityResetToDefaultRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
