...
public class QueriesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EdiscoveryReviewSetQuery body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSetQueryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryReviewSetQueryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryReviewSetQueryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryReviewSetQuery> post(@javax.annotation.Nonnull final EdiscoveryReviewSetQuery body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryReviewSetQuery> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryReviewSetQuery>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
