...
public class CasesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final CasesRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CasesRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CasesRoot> executionException = new java.util.concurrent.CompletableFuture<CasesRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
