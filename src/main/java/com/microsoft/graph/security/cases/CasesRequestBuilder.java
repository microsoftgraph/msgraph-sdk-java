...
public class CasesRequestBuilder {
     ...
     * @return a CompletableFuture of casesRoot
     */
    public java.util.concurrent.CompletableFuture<CasesRoot> patch(@javax.annotation.Nonnull final CasesRoot body, @javax.annotation.Nullable final java.util.function.Consumer<CasesRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
