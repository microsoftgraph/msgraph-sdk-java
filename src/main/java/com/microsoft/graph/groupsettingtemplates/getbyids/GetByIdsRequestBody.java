package microsoft.graph.groupsettingtemplates.getbyids;
...
public class GetByIdsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getByIdsRequestBody
     */
    @javax.annotation.Nonnull
    public static GetByIdsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetByIdsRequestBody currentObject = this;
