package microsoft.graph.groupsettingtemplates;
...
import microsoft.graph.groupsettingtemplates.count.CountRequestBuilder;
import microsoft.graph.groupsettingtemplates.getavailableextensionproperties.GetAvailableExtensionPropertiesRequestBuilder;
import microsoft.graph.groupsettingtemplates.getbyids.GetByIdsRequestBuilder;
import microsoft.graph.groupsettingtemplates.validateproperties.ValidatePropertiesRequestBuilder;
import microsoft.graph.models.GroupSettingTemplate;
import microsoft.graph.models.GroupSettingTemplateCollectionResponse;
...
public class GroupSettingTemplatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GroupSettingTemplateCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GroupSettingTemplateCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of GroupSettingTemplateCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<GroupSettingTemplateCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GroupSettingTemplatesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, GroupSettingTemplateCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of groupSettingTemplate
     */
    public java.util.concurrent.CompletableFuture<GroupSettingTemplate> post(@javax.annotation.Nonnull final GroupSettingTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<GroupSettingTemplatesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
