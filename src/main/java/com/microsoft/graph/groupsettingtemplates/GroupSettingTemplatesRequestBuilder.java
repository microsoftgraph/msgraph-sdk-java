...
public class GroupSettingTemplatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GroupSettingTemplateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupSettingTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<GroupSettingTemplateCollectionResponse>();
