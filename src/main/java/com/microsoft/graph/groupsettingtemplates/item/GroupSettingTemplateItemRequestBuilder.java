...
public class GroupSettingTemplateItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final GroupSettingTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GroupSettingTemplate> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupSettingTemplate> executionException = new java.util.concurrent.CompletableFuture<GroupSettingTemplate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
