package microsoft.graph.workbooks.item.versions.item;
...
import microsoft.graph.workbooks.item.versions.item.content.ContentRequestBuilder;
import microsoft.graph.workbooks.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
