package microsoft.graph.workbooks.item.restore;
...
public class RestoreRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a restoreRequestBody
     */
    @javax.annotation.Nonnull
    public static RestoreRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RestoreRequestBody currentObject = this;
