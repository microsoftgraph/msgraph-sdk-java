...
public class ValidatePermissionRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a validatePermissionRequestBody
     */
    @javax.annotation.Nonnull
    public static ValidatePermissionRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ValidatePermissionRequestBody currentObject = this;
