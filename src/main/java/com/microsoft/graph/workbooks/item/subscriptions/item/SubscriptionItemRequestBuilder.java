package microsoft.graph.workbooks.item.subscriptions.item;
...
import microsoft.graph.workbooks.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
