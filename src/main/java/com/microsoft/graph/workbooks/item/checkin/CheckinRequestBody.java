...
public class CheckinRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a checkinRequestBody
     */
    @javax.annotation.Nonnull
    public static CheckinRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CheckinRequestBody currentObject = this;
