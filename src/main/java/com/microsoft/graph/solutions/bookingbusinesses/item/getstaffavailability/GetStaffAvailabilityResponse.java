...
public class GetStaffAvailabilityResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * @return a getStaffAvailabilityResponse
     */
    @javax.annotation.Nonnull
    public static GetStaffAvailabilityResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(StaffAvailabilityItem::createFromDiscriminatorValue)); });
