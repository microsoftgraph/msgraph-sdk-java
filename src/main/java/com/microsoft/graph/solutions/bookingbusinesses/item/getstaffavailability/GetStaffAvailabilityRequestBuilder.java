...
public class GetStaffAvailabilityRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetStaffAvailabilityPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GetStaffAvailabilityResponse> post(@javax.annotation.Nonnull final GetStaffAvailabilityPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetStaffAvailabilityResponse> executionException = new java.util.concurrent.CompletableFuture<GetStaffAvailabilityResponse>();
