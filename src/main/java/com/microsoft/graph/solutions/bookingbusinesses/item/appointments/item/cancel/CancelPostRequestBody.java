...
public class CancelPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public String getCancellationMessage() {
        return this.getBackingStore().get("cancellationMessage");
    }
    /**
     ...
     */
    public void setCancellationMessage(@jakarta.annotation.Nullable final String value) {
        this.getBackingStore().set("cancellationMessage", value);
    }
}
