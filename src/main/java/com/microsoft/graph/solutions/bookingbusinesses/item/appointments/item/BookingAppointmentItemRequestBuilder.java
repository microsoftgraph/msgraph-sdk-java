package microsoft.graph.solutions.bookingbusinesses.item.appointments.item;
...
import microsoft.graph.solutions.bookingbusinesses.item.appointments.item.cancel.CancelRequestBuilder;
