...
public class StaffMembersRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a BookingStaffMemberBaseCollectionResponse
    ...
    public BookingStaffMemberBaseCollectionResponse get() {
        return get(null);
    }
    /**
     * Get a list of bookingStaffMember objects in the specified bookingBusiness. This API is available in the following national cloud deployments.
     ...
     */
    @jakarta.annotation.Nullable
    public BookingStaffMemberBaseCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, BookingStaffMemberBaseCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public BookingStaffMemberBase post(@jakarta.annotation.Nonnull final BookingStaffMemberBase body) {
     ...
     */
    @jakarta.annotation.Nullable
    public BookingStaffMemberBase post(@jakarta.annotation.Nonnull final BookingStaffMemberBase body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final BookingStaffMemberBase body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final BookingStaffMemberBase body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
        if (requestConfiguration != null) {
