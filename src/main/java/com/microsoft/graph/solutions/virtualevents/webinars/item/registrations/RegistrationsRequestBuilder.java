package com.microsoft.graph.solutions.virtualevents.webinars.item.registrations;
...
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.VirtualEventRegistrationItemRequestBuilder;
...
public class RegistrationsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     * @return a VirtualEventRegistrationItemRequestBuilder
     */
    @jakarta.annotation.Nonnull
    public VirtualEventRegistrationItemRequestBuilder byVirtualEventRegistrationId(@jakarta.annotation.Nonnull final String virtualEventRegistrationId) {
        Objects.requireNonNull(virtualEventRegistrationId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("virtualEventRegistration%2Did", virtualEventRegistrationId);
    ...
    public RegistrationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RegistrationsRequestBuilder and sets the default values.
    ...
    public VirtualEventRegistrationCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, VirtualEventRegistrationCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VirtualEventRegistration body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VirtualEventRegistration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
