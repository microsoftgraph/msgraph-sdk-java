...
public class BookingCurrenciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<BookingCurrencyCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<BookingCurrencyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BookingCurrencyCollectionResponse>();
