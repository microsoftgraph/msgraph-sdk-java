...
public class ShutDownRequestBuilder extends BaseRequestBuilder {
    ...
    public ShutDownRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/shutDown", pathParameters);
    }
    /**
     * Instantiates a new ShutDownRequestBuilder and sets the default values.
    ...
    public ShutDownRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/shutDown", rawUrl);
    }
    /**
     * Shut down device
