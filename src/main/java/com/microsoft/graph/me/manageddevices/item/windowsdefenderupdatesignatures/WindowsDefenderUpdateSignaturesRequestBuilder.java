package com.microsoft.graph.me.manageddevices.item.windowsdefenderupdatesignatures;
...
public class WindowsDefenderUpdateSignaturesRequestBuilder extends BaseRequestBuilder {
    ...
    public WindowsDefenderUpdateSignaturesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", pathParameters);
    }
    /**
     * Instantiates a new WindowsDefenderUpdateSignaturesRequestBuilder and sets the default values.
    ...
    public WindowsDefenderUpdateSignaturesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", rawUrl);
    }
    /**
