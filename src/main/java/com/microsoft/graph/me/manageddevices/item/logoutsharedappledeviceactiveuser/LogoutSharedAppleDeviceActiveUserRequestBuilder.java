package com.microsoft.graph.me.manageddevices.item.logoutsharedappledeviceactiveuser;
...
public class LogoutSharedAppleDeviceActiveUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LogoutSharedAppleDeviceActiveUserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/logoutSharedAppleDeviceActiveUser", pathParameters);
    }
    /**
     * Instantiates a new LogoutSharedAppleDeviceActiveUserRequestBuilder and sets the default values.
    ...
    public LogoutSharedAppleDeviceActiveUserRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/logoutSharedAppleDeviceActiveUser", rawUrl);
    }
    /**
