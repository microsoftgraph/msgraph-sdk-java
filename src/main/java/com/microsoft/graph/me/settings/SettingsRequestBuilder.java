...
public class SettingsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final UserSettings body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserSettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserSettings> executionException = new java.util.concurrent.CompletableFuture<UserSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
