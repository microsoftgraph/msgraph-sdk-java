package microsoft.graph.me.joinedteams.item.primarychannel.messages.item.replies.item;
...
import microsoft.graph.me.joinedteams.item.primarychannel.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.me.joinedteams.item.primarychannel.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.primaryChannel.messages.item.replies.item.hostedContents.item collection
