package com.microsoft.graph.me.joinedteams.item.schedule.timesoff;

import com.microsoft.graph.me.joinedteams.item.schedule.timesoff.count.CountRequestBuilder;
...
public class TimesOffRequestBuilder extends BaseRequestBuilder {
    ...
    public TimesOffRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters);
    }
    /**
     * Instantiates a new TimesOffRequestBuilder and sets the default values.
    ...
    public TimesOffRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl);
    }
    /**
