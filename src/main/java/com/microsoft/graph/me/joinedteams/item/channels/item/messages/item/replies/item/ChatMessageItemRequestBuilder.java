package microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies.item;
...
import microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.channels.item.messages.item.replies.item.hostedContents.item collection
