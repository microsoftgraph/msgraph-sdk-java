package com.microsoft.graph.me.joinedteams.item.schedule.timesoff.item;
...
public class TimeOffItemRequestBuilder extends BaseRequestBuilder {
    ...
    public TimeOffItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timesOff/{timeOff%2Did}{?%24select}", pathParameters);
    }
    /**
     * Instantiates a new TimeOffItemRequestBuilder and sets the default values.
