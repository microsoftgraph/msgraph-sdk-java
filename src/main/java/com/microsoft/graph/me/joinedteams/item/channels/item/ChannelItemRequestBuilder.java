package microsoft.graph.me.joinedteams.item.channels.item;
...
import microsoft.graph.me.joinedteams.item.channels.item.messages.item.ChatMessageItemRequestBuilder;
