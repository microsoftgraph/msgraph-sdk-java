package com.microsoft.graph.me.joinedteams.item.channels.item;

import com.microsoft.graph.me.joinedteams.item.channels.item.completemigration.CompleteMigrationRequestBuilder;
import com.microsoft.graph.me.joinedteams.item.channels.item.doesuserhaveaccesswithuseridwithtenantidwithuserprincipalname.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
...
public class ChannelItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.channels.item.members.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.channels.item.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.channels.item.tabs.item collection
     * @param id Unique identifier of the item
