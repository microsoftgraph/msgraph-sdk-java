package com.microsoft.graph.me.joinedteams.item.allchannels;

import com.microsoft.graph.me.joinedteams.item.allchannels.count.CountRequestBuilder;
...
public class AllChannelsRequestBuilder {
    ...
    public AllChannelsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/allChannels{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<AllChannelsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
