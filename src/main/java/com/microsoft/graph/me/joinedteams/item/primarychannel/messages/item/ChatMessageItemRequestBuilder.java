package microsoft.graph.me.joinedteams.item.primarychannel.messages.item;
...
import microsoft.graph.me.joinedteams.item.primarychannel.messages.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.me.joinedteams.item.primarychannel.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.primarychannel.messages.item.replies.RepliesRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.primaryChannel.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.primaryChannel.messages.item.replies.item collection
     * @param id Unique identifier of the item
