...
public class ScheduleRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.offerShiftRequests.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.openShiftChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.openShifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.schedulingGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.shifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.swapShiftsChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.timeOffReasons.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.timeOffRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.joinedTeams.item.schedule.timesOff.item collection
     * @param id Unique identifier of the item
