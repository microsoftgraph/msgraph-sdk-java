package microsoft.graph.me.joinedteams.item.schedule;
...
import microsoft.graph.me.joinedteams.item.schedule.offershiftrequests.item.OfferShiftRequestItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.offershiftrequests.OfferShiftRequestsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.openshiftchangerequests.item.OpenShiftChangeRequestItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.openshiftchangerequests.OpenShiftChangeRequestsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.openshifts.item.OpenShiftItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.openshifts.OpenShiftsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.schedulinggroups.item.SchedulingGroupItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.schedulinggroups.SchedulingGroupsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.share.ShareRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.shifts.item.ShiftItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.shifts.ShiftsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.swapshiftschangerequests.item.SwapShiftsChangeRequestItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.swapshiftschangerequests.SwapShiftsChangeRequestsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.timeoffreasons.item.TimeOffReasonItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.timeoffreasons.TimeOffReasonsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.timeoffrequests.item.TimeOffRequestItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.timeoffrequests.TimeOffRequestsRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.timesoff.item.TimeOffItemRequestBuilder;
import microsoft.graph.me.joinedteams.item.schedule.timesoff.TimesOffRequestBuilder;
...
public class ScheduleRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.offerShiftRequests.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.openShiftChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.openShifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.schedulingGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.shifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.swapShiftsChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.timeOffReasons.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.timeOffRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedTeams.item.schedule.timesOff.item collection
     * @param id Unique identifier of the item
