...
public class SharedWithTeamsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SharedWithChannelTeamInfo body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SharedWithChannelTeamInfoCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SharedWithChannelTeamInfoCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SharedWithChannelTeamInfoCollectionResponse>();
