package microsoft.graph.me.joinedteams.item.template;
...
public class TemplateRequestBuilder {
     ...
     * @return a CompletableFuture of teamsTemplate
     */
    public java.util.concurrent.CompletableFuture<TeamsTemplate> get(@javax.annotation.Nullable final java.util.function.Consumer<TemplateRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
