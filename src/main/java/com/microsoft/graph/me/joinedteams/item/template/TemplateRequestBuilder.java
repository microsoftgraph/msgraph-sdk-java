...
public class TemplateRequestBuilder extends BaseRequestBuilder {
    ...
    public TemplateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/template{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TemplateRequestBuilder and sets the default values.
    ...
    public TemplateRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/template{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TeamsTemplate> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
