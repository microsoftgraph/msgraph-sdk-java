package com.microsoft.graph.me.joinedteams.item.channels.item.sharedwithteams.item.team;
...
public class TeamRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/team{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TeamRequestBuilder and sets the default values.
    ...
    public TeamRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/team{?%24select,%24expand}", rawUrl);
    }
    /**
     * Get team from me
