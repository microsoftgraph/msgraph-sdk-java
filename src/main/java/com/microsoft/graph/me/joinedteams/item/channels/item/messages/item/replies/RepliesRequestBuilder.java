package com.microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies;

import com.microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
import com.microsoft.graph.me.joinedteams.item.channels.item.messages.item.replies.item.ChatMessageItemRequestBuilder;
...
public class RepliesRequestBuilder extends BaseRequestBuilder {
    ...
    public RepliesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RepliesRequestBuilder and sets the default values.
    ...
    public RepliesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
