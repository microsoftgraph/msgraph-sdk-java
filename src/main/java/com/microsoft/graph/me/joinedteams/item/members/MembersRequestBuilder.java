...
public class MembersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConversationMemberCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConversationMemberCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConversationMemberCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ConversationMember> post(@javax.annotation.Nonnull final ConversationMember body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConversationMember> executionException = new java.util.concurrent.CompletableFuture<ConversationMember>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
