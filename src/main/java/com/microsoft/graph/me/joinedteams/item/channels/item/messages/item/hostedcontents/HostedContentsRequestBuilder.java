package com.microsoft.graph.me.joinedteams.item.channels.item.messages.item.hostedcontents;

import com.microsoft.graph.me.joinedteams.item.channels.item.messages.item.hostedcontents.count.CountRequestBuilder;
...
public class HostedContentsRequestBuilder extends BaseRequestBuilder {
    ...
    public HostedContentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new HostedContentsRequestBuilder and sets the default values.
