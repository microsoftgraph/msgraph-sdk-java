...
public class ShareRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a shareRequestBody
     */
    @javax.annotation.Nonnull
    public static ShareRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ShareRequestBody currentObject = this;
