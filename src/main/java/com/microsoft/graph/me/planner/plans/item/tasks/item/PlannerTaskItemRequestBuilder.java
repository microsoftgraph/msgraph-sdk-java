package com.microsoft.graph.me.planner.plans.item.tasks.item;

import com.microsoft.graph.me.planner.plans.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.tasks.item.details.DetailsRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
