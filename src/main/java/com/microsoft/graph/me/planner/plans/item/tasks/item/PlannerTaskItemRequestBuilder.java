package microsoft.graph.me.planner.plans.item.tasks.item;
...
import microsoft.graph.me.planner.plans.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import microsoft.graph.me.planner.plans.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import microsoft.graph.me.planner.plans.item.tasks.item.details.DetailsRequestBuilder;
import microsoft.graph.me.planner.plans.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
