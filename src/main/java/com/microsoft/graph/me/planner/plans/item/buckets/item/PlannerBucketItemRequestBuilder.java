package microsoft.graph.me.planner.plans.item.buckets.item;
...
import microsoft.graph.me.planner.plans.item.buckets.item.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.me.planner.plans.item.buckets.item.tasks.TasksRequestBuilder;
...
public class PlannerBucketItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.planner.plans.item.buckets.item.tasks.item collection
