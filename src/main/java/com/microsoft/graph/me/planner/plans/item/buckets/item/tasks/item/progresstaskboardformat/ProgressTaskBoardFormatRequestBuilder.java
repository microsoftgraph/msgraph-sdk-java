...
public class ProgressTaskBoardFormatRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PlannerProgressTaskBoardTaskFormat> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlannerProgressTaskBoardTaskFormat> executionException = new java.util.concurrent.CompletableFuture<PlannerProgressTaskBoardTaskFormat>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
