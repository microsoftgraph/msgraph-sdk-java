...
public class AssignedToTaskBoardFormatRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PlannerAssignedToTaskBoardTaskFormat body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PlannerAssignedToTaskBoardTaskFormat> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlannerAssignedToTaskBoardTaskFormat> executionException = new java.util.concurrent.CompletableFuture<PlannerAssignedToTaskBoardTaskFormat>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
