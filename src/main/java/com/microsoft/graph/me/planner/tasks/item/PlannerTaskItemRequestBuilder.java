package microsoft.graph.me.planner.tasks.item;
...
import microsoft.graph.me.planner.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import microsoft.graph.me.planner.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import microsoft.graph.me.planner.tasks.item.details.DetailsRequestBuilder;
import microsoft.graph.me.planner.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
