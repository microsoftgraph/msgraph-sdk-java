package microsoft.graph.me.calendarview.item;
...
import microsoft.graph.me.calendarview.item.accept.AcceptRequestBuilder;
import microsoft.graph.me.calendarview.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.calendarview.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.calendarview.item.calendar.CalendarRequestBuilder;
import microsoft.graph.me.calendarview.item.cancel.CancelRequestBuilder;
import microsoft.graph.me.calendarview.item.decline.DeclineRequestBuilder;
import microsoft.graph.me.calendarview.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.me.calendarview.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.calendarview.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.calendarview.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.calendarview.item.instances.InstancesRequestBuilder;
import microsoft.graph.me.calendarview.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendarview.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendarview.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendarview.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendarview.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.me.calendarview.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
