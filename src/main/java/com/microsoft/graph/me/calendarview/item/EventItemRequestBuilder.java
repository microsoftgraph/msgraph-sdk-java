package com.microsoft.graph.me.calendarview.item;

import com.microsoft.graph.me.calendarview.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.me.calendarview.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.me.calendarview.item.attachments.item.AttachmentItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.me.calendarview.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.me.calendarview.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.me.calendarview.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.me.calendarview.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.me.calendarview.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.me.calendarview.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.me.calendarview.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendarview.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendarview.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.me.calendarview.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
