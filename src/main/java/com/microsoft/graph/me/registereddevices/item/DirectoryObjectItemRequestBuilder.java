package com.microsoft.graph.me.registereddevices.item;

import com.microsoft.graph.me.registereddevices.item.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.me.registereddevices.item.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.me.registereddevices.item.graphendpoint.GraphEndpointRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/registeredDevices/{directoryObject%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
    ...
    public DirectoryObjectItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/registeredDevices/{directoryObject%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
