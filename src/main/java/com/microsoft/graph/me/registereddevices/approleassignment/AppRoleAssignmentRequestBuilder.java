package com.microsoft.graph.me.registereddevices.approleassignment;

import com.microsoft.graph.me.registereddevices.approleassignment.count.CountRequestBuilder;
...
public class AppRoleAssignmentRequestBuilder {
    ...
    public AppRoleAssignmentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/registeredDevices/microsoft.graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
