package microsoft.graph.me.transitivememberof.item;
...
import microsoft.graph.me.transitivememberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.me.transitivememberof.item.device.DeviceRequestBuilder;
import microsoft.graph.me.transitivememberof.item.group.GroupRequestBuilder;
import microsoft.graph.me.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.me.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.UserRequestBuilder;
