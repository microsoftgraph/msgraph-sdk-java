package microsoft.graph.me.transitivememberof.item.user;
...
import microsoft.graph.me.transitivememberof.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
