...
public class AttendanceRecordItemRequestBuilder {
     ...
     * @return a CompletableFuture of attendanceRecord
     */
    public java.util.concurrent.CompletableFuture<AttendanceRecord> patch(@javax.annotation.Nonnull final AttendanceRecord body, @javax.annotation.Nullable final java.util.function.Consumer<AttendanceRecordItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
