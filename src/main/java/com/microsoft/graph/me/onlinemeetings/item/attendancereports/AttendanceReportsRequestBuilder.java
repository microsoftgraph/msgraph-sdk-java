...
public class AttendanceReportsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MeetingAttendanceReport body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MeetingAttendanceReportCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MeetingAttendanceReportCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MeetingAttendanceReportCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MeetingAttendanceReport> post(@javax.annotation.Nonnull final MeetingAttendanceReport body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MeetingAttendanceReport> executionException = new java.util.concurrent.CompletableFuture<MeetingAttendanceReport>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
