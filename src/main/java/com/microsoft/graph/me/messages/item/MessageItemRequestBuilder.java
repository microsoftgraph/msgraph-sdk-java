package microsoft.graph.me.messages.item;
...
import microsoft.graph.me.messages.item.createreplyall.CreateReplyAllRequestBuilder;
import microsoft.graph.me.messages.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.messages.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.messages.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.messages.item.move.MoveRequestBuilder;
import microsoft.graph.me.messages.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.messages.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.messages.item.reply.ReplyRequestBuilder;
import microsoft.graph.me.messages.item.replyall.ReplyAllRequestBuilder;
import microsoft.graph.me.messages.item.send.SendRequestBuilder;
import microsoft.graph.me.messages.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.messages.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.messages.item.value.ContentRequestBuilder;
