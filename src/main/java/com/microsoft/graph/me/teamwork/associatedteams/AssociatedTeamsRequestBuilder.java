...
public class AssociatedTeamsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AssociatedTeamInfo body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AssociatedTeamInfoCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AssociatedTeamInfoCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AssociatedTeamInfoCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AssociatedTeamInfo> post(@javax.annotation.Nonnull final AssociatedTeamInfo body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AssociatedTeamInfo> executionException = new java.util.concurrent.CompletableFuture<AssociatedTeamInfo>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
