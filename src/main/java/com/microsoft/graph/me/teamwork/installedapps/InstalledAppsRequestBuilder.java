...
public class InstalledAppsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserScopeTeamsAppInstallation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserScopeTeamsAppInstallationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserScopeTeamsAppInstallationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserScopeTeamsAppInstallationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserScopeTeamsAppInstallation> post(@javax.annotation.Nonnull final UserScopeTeamsAppInstallation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserScopeTeamsAppInstallation> executionException = new java.util.concurrent.CompletableFuture<UserScopeTeamsAppInstallation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
