package com.microsoft.graph.me.exportdeviceandappmanagementdata;
...
public class ExportDeviceAndAppManagementDataRequestBuilder extends BaseRequestBuilder {
    ...
    public ExportDeviceAndAppManagementDataRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/exportDeviceAndAppManagementData()", pathParameters);
    }
    /**
     * Instantiates a new ExportDeviceAndAppManagementDataRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public ExportDeviceAndAppManagementDataRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/exportDeviceAndAppManagementData()", rawUrl);
    }
    /**
