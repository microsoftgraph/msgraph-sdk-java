package microsoft.graph.me.calendar;
...
import microsoft.graph.me.calendar.allowedcalendarsharingroleswithuser.AllowedCalendarSharingRolesWithUserRequestBuilder;
import microsoft.graph.me.calendar.calendarpermissions.CalendarPermissionsRequestBuilder;
import microsoft.graph.me.calendar.calendarpermissions.item.CalendarPermissionItemRequestBuilder;
import microsoft.graph.me.calendar.calendarview.CalendarViewRequestBuilder;
import microsoft.graph.me.calendar.events.EventsRequestBuilder;
import microsoft.graph.me.calendar.getschedule.GetScheduleRequestBuilder;
import microsoft.graph.me.calendar.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendar.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendar.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendar.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.calendarPermissions.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.calendarView.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendar.calendarview.item.EventItemRequestBuilder calendarView(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.events.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendar.events.item.EventItemRequestBuilder events(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did", id);
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
