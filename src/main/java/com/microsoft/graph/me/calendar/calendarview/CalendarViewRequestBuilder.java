package com.microsoft.graph.me.calendar.calendarview;

import com.microsoft.graph.me.calendar.calendarview.count.CountRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.delta.DeltaRequestBuilder;
...
public class CalendarViewRequestBuilder extends BaseRequestBuilder {
    ...
    public CalendarViewRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/calendarView{?startDateTime*,endDateTime*,%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters);
    }
    /**
     * Instantiates a new CalendarViewRequestBuilder and sets the default values.
    ...
    public CalendarViewRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/calendarView{?startDateTime*,endDateTime*,%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl);
    }
    /**
