package com.microsoft.graph.me.calendar.events.item;

import com.microsoft.graph.me.calendar.events.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.attachments.item.AttachmentItemRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.me.calendar.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.events.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
