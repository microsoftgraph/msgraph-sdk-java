package microsoft.graph.me.calendar.events.item;
...
import microsoft.graph.me.calendar.events.item.accept.AcceptRequestBuilder;
import microsoft.graph.me.calendar.events.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.calendar.events.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.calendar.events.item.calendar.CalendarRequestBuilder;
import microsoft.graph.me.calendar.events.item.cancel.CancelRequestBuilder;
import microsoft.graph.me.calendar.events.item.decline.DeclineRequestBuilder;
import microsoft.graph.me.calendar.events.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.me.calendar.events.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.calendar.events.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.calendar.events.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.calendar.events.item.instances.InstancesRequestBuilder;
import microsoft.graph.me.calendar.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendar.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendar.events.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendar.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendar.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.me.calendar.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.events.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendar.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
