package com.microsoft.graph.me.chats.item.unhideforuser;
...
public class UnhideForUserPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static UnhideForUserPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnhideForUserPostRequestBody currentObject = this;
