...
public class TeamsTabItemRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamsTabItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TeamsTabItemRequestBuilder and sets the default values.
    ...
    public TeamsTabItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     * Remove (unpin) a tab from the specified chat. 
     * @return a CompletableFuture of void
     * @see <a href="https://docs.microsoft.com/graph/api/chat-delete-tabs?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/chat-get-tabs?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     * @return a CompletableFuture of teamsTab
     * @see <a href="https://docs.microsoft.com/graph/api/chat-patch-tabs?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
