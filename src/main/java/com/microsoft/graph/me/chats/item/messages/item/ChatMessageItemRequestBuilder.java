package microsoft.graph.me.chats.item.messages.item;
...
import microsoft.graph.me.chats.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.me.chats.item.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.me.chats.item.messages.item.replies.RepliesRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.chats.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.chats.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
