...
public class UpgradeRequestBuilder extends BaseRequestBuilder {
    ...
    public UpgradeRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}/upgrade", pathParameters);
    }
    /**
     * Instantiates a new UpgradeRequestBuilder and sets the default values.
    ...
    public UpgradeRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}/upgrade", rawUrl);
    }
    /**
