...
public class TodoTaskItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.todo.lists.item.tasks.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.todo.lists.item.tasks.item.attachmentSessions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.todo.lists.item.tasks.item.checklistItems.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.todo.lists.item.tasks.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.todo.lists.item.tasks.item.linkedResources.item collection
     * @param id Unique identifier of the item
