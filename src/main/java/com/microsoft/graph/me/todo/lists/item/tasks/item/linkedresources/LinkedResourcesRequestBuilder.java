...
public class LinkedResourcesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final LinkedResource body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<LinkedResourceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LinkedResourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LinkedResourceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<LinkedResource> post(@javax.annotation.Nonnull final LinkedResource body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<LinkedResource> executionException = new java.util.concurrent.CompletableFuture<LinkedResource>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
