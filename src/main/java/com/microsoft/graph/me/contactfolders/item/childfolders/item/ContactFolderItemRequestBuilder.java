...
public class ContactFolderItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.contactFolders.item.childFolders.item.contacts.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.contactFolders.item.childFolders.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.contactFolders.item.childFolders.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
