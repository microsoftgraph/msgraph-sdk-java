package microsoft.graph.me.contactfolders.item.childfolders.item;
...
import microsoft.graph.me.contactfolders.item.childfolders.item.contacts.ContactsRequestBuilder;
import microsoft.graph.me.contactfolders.item.childfolders.item.contacts.item.ContactItemRequestBuilder;
import microsoft.graph.me.contactfolders.item.childfolders.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.contactfolders.item.childfolders.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.contactfolders.item.childfolders.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.contactfolders.item.childfolders.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class ContactFolderItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.contactFolders.item.childFolders.item.contacts.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.contactFolders.item.childFolders.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.contactFolders.item.childFolders.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
