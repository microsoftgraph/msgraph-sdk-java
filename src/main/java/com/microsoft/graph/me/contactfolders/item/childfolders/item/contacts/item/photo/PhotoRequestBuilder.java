package microsoft.graph.me.contactfolders.item.childfolders.item.contacts.item.photo;
...
import microsoft.graph.me.contactfolders.item.childfolders.item.contacts.item.photo.value.ContentRequestBuilder;
