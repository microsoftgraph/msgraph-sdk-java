...
public class InsightsRequestBuilder {
     ...
     * @return a CompletableFuture of officeGraphInsights
     */
    public java.util.concurrent.CompletableFuture<OfficeGraphInsights> patch(@javax.annotation.Nonnull final OfficeGraphInsights body, @javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
