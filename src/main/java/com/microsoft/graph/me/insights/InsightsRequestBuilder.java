...
public class InsightsRequestBuilder extends BaseRequestBuilder {
    ...
    public InsightsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/insights{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new InsightsRequestBuilder and sets the default values.
    ...
    public InsightsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/insights{?%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<OfficeGraphInsights> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<OfficeGraphInsights> executionException = new java.util.concurrent.CompletableFuture<OfficeGraphInsights>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OfficeGraphInsights> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OfficeGraphInsights> patch(@javax.annotation.Nonnull final OfficeGraphInsights body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final OfficeGraphInsights body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final OfficeGraphInsights body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
