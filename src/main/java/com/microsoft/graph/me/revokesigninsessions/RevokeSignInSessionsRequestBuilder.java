...
public class RevokeSignInSessionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse> executionException = new java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse>();
