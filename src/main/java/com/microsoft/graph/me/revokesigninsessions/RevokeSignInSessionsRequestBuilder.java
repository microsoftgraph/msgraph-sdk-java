...
public class RevokeSignInSessionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse> post() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RevokeSignInSessionsResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<RevokeSignInSessionsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RevokeSignInSessionsResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
