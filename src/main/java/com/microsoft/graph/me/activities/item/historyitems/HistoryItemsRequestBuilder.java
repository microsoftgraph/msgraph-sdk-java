...
public class HistoryItemsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ActivityHistoryItem body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ActivityHistoryItemCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ActivityHistoryItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ActivityHistoryItemCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ActivityHistoryItem> post(@javax.annotation.Nonnull final ActivityHistoryItem body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ActivityHistoryItem> executionException = new java.util.concurrent.CompletableFuture<ActivityHistoryItem>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
