package microsoft.graph.me.activities.recent;
...
public class RecentResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RecentResponse currentObject = this;
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(UserActivity::createFromDiscriminatorValue)); });
        }};
    }
    /**
