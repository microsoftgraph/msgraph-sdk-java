package microsoft.graph.me.authentication.microsoftauthenticatormethods.item;
...
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.DeviceRequestBuilder;
import microsoft.graph.models.MicrosoftAuthenticatorAuthenticationMethod;
...
public class MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of microsoftAuthenticatorAuthenticationMethod
     */
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethod> get(@javax.annotation.Nullable final java.util.function.Consumer<MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final MicrosoftAuthenticatorAuthenticationMethod body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final MicrosoftAuthenticatorAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
