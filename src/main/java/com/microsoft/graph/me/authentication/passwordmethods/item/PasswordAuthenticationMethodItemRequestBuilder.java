...
public class PasswordAuthenticationMethodItemRequestBuilder {
     ...
     * @return a CompletableFuture of passwordAuthenticationMethod
     */
    public java.util.concurrent.CompletableFuture<PasswordAuthenticationMethod> patch(@javax.annotation.Nonnull final PasswordAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PasswordAuthenticationMethodItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
