...
public class TemporaryAccessPassAuthenticationMethodItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TemporaryAccessPassAuthenticationMethod> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TemporaryAccessPassAuthenticationMethod> executionException = new java.util.concurrent.CompletableFuture<TemporaryAccessPassAuthenticationMethod>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
