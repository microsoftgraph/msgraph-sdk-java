...
public class MethodsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethodCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethodCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethodCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethod> post(@javax.annotation.Nonnull final AuthenticationMethod body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethod> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethod>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
