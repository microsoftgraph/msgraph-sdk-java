package microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredusers.item.user.getmembergroups;
...
public class GetMemberGroupsRequestBuilder {
    ...
    public GetMemberGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getMemberGroups";
