...
public class EmailAuthenticationMethodItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final EmailAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EmailAuthenticationMethod> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EmailAuthenticationMethod> executionException = new java.util.concurrent.CompletableFuture<EmailAuthenticationMethod>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
