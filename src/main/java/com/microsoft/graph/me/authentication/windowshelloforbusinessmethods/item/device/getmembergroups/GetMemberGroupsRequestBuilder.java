package com.microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.getmembergroups;
...
public class GetMemberGroupsRequestBuilder {
    ...
    public GetMemberGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/microsoft.graph.getMemberGroups";
    ...
    public java.util.concurrent.CompletableFuture<GetMemberGroupsResponse> post(@javax.annotation.Nonnull final GetMemberGroupsPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetMemberGroupsResponse> executionException = new java.util.concurrent.CompletableFuture<GetMemberGroupsResponse>();
