package com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.serviceprincipal;
...
public class ServicePrincipalRequestBuilder {
    ...
    public ServicePrincipalRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
