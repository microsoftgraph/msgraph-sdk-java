package microsoft.graph.me.authentication.microsoftauthenticatormethods;
...
import microsoft.graph.me.authentication.microsoftauthenticatormethods.count.CountRequestBuilder;
import microsoft.graph.models.MicrosoftAuthenticatorAuthenticationMethod;
import microsoft.graph.models.MicrosoftAuthenticatorAuthenticationMethodCollectionResponse;
...
public class MicrosoftAuthenticatorMethodsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MicrosoftAuthenticatorAuthenticationMethodCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<MicrosoftAuthenticatorAuthenticationMethodCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<MicrosoftAuthenticatorMethodsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MicrosoftAuthenticatorAuthenticationMethodCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
