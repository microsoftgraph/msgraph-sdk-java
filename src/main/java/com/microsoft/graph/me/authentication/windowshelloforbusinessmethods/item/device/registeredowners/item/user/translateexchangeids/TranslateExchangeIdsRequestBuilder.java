package microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.translateexchangeids;
...
public class TranslateExchangeIdsRequestBuilder {
    ...
    public TranslateExchangeIdsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.translateExchangeIds";
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TranslateExchangeIdsPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<TranslateExchangeIdsRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final TranslateExchangeIdsRequestBuilderPostRequestConfiguration requestConfig = new TranslateExchangeIdsRequestBuilderPostRequestConfiguration();
    ...
    public java.util.concurrent.CompletableFuture<TranslateExchangeIdsResponse> post(@javax.annotation.Nonnull final TranslateExchangeIdsPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<TranslateExchangeIdsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        ...
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, TranslateExchangeIdsResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
