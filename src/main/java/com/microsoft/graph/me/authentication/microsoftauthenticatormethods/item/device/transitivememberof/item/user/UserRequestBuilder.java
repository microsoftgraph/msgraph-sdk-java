package microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user;
...
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
