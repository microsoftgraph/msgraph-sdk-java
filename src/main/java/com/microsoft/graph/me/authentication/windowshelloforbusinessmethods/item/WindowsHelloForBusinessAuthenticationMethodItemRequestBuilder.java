...
public class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final WindowsHelloForBusinessAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WindowsHelloForBusinessAuthenticationMethod> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsHelloForBusinessAuthenticationMethod> executionException = new java.util.concurrent.CompletableFuture<WindowsHelloForBusinessAuthenticationMethod>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WindowsHelloForBusinessAuthenticationMethod> patch(@javax.annotation.Nonnull final WindowsHelloForBusinessAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
