...
public class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder {
     ...
     * @return a CompletableFuture of windowsHelloForBusinessAuthenticationMethod
     */
    public java.util.concurrent.CompletableFuture<WindowsHelloForBusinessAuthenticationMethod> patch(@javax.annotation.Nonnull final WindowsHelloForBusinessAuthenticationMethod body) {
        try {
     ...
     * @return a CompletableFuture of windowsHelloForBusinessAuthenticationMethod
     */
    public java.util.concurrent.CompletableFuture<WindowsHelloForBusinessAuthenticationMethod> patch(@javax.annotation.Nonnull final WindowsHelloForBusinessAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<WindowsHelloForBusinessAuthenticationMethodItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
