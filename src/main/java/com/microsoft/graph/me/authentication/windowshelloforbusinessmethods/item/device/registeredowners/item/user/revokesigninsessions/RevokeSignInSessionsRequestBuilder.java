package microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.revokesigninsessions;
...
public class RevokeSignInSessionsRequestBuilder {
     ...
     * @return a void
     */
    public RevokeSignInSessionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.revokeSignInSessions";
     ...
     * @return a void
     */
    public RevokeSignInSessionsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.revokeSignInSessions";
     ...
     */
    public java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse> post() {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, RevokeSignInSessionsResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of revokeSignInSessionsResponse
     */
    public java.util.concurrent.CompletableFuture<RevokeSignInSessionsResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<RevokeSignInSessionsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, RevokeSignInSessionsResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
