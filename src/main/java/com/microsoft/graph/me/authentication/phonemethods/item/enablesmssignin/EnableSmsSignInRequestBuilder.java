...
public class EnableSmsSignInRequestBuilder extends BaseRequestBuilder {
    ...
    public EnableSmsSignInRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/enableSmsSignIn", pathParameters);
    }
    /**
     * Instantiates a new EnableSmsSignInRequestBuilder and sets the default values.
    ...
    public EnableSmsSignInRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/enableSmsSignIn", rawUrl);
    }
    /**
