...
public class ResourcesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OnenoteResource body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OnenoteResourceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnenoteResourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OnenoteResourceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<OnenoteResource> post(@javax.annotation.Nonnull final OnenoteResource body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnenoteResource> executionException = new java.util.concurrent.CompletableFuture<OnenoteResource>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
