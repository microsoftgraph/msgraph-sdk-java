package microsoft.graph.me.onenote.notebooks.item.sections.item;
...
import microsoft.graph.me.onenote.notebooks.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
