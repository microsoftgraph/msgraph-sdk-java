package com.microsoft.graph.me.onenote.sections.item;

import com.microsoft.graph.me.onenote.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import com.microsoft.graph.me.onenote.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import com.microsoft.graph.me.onenote.sections.item.pages.item.OnenotePageItemRequestBuilder;
import com.microsoft.graph.me.onenote.sections.item.pages.PagesRequestBuilder;
import com.microsoft.graph.me.onenote.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.me.onenote.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
...
public class OnenoteSectionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public OnenoteSectionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OnenoteSectionItemRequestBuilder and sets the default values.
    ...
    public OnenoteSectionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
