package microsoft.graph.me.onenote.notebooks.item.sectiongroups.item;
...
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.item.sections.SectionsRequestBuilder;
