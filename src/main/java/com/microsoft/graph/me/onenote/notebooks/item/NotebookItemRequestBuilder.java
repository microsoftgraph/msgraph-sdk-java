package microsoft.graph.me.onenote.notebooks.item;
...
import microsoft.graph.me.onenote.notebooks.item.copynotebook.CopyNotebookRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.me.onenote.notebooks.item.sections.SectionsRequestBuilder;
