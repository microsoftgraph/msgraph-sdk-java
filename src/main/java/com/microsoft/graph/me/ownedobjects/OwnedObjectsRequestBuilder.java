...
import com.microsoft.graph.me.ownedobjects.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.me.ownedobjects.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.me.ownedobjects.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
...
public class OwnedObjectsRequestBuilder extends BaseRequestBuilder {
    ...
    public OwnedObjectsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OwnedObjectsRequestBuilder and sets the default values.
    ...
    public OwnedObjectsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
