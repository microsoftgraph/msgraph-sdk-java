package microsoft.graph.me.calendars.item.events.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.me.calendars.item.events.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
