package microsoft.graph.me.calendars.item;
...
import microsoft.graph.me.calendars.item.allowedcalendarsharingroleswithuser.AllowedCalendarSharingRolesWithUserRequestBuilder;
import microsoft.graph.me.calendars.item.calendarpermissions.CalendarPermissionsRequestBuilder;
import microsoft.graph.me.calendars.item.calendarpermissions.item.CalendarPermissionItemRequestBuilder;
import microsoft.graph.me.calendars.item.calendarview.CalendarViewRequestBuilder;
import microsoft.graph.me.calendars.item.events.EventsRequestBuilder;
import microsoft.graph.me.calendars.item.getschedule.GetScheduleRequestBuilder;
import microsoft.graph.me.calendars.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendars.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendars.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendars.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class CalendarItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendars.item.calendarview.item.EventItemRequestBuilder calendarView(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
     ...
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendars.item.events.item.EventItemRequestBuilder events(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did", id);
