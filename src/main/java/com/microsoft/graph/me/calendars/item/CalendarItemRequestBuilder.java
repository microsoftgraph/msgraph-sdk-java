...
public class CalendarItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.calendarPermissions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.calendarView.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.events.item collection
     * @param id Unique identifier of the item
     * @return a EventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
