package microsoft.graph.me.calendars.item.events.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.me.calendars.item.events.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
