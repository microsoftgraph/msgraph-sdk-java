package microsoft.graph.me.calendars.item.events.item.instances.item;
...
import microsoft.graph.me.calendars.item.events.item.instances.item.accept.AcceptRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.calendar.CalendarRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.cancel.CancelRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.decline.DeclineRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.me.calendars.item.events.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendars.item.events.item.instances.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendars.item.events.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendars.item.events.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendars.item.events.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
