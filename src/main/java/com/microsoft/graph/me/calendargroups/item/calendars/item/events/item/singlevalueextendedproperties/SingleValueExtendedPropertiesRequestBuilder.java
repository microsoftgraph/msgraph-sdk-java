package microsoft.graph.me.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties;
...
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
