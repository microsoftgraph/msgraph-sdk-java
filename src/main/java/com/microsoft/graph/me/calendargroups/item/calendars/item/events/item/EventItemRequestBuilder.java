package microsoft.graph.me.calendargroups.item.calendars.item.events.item;
...
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.accept.AcceptRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.calendar.CalendarRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.cancel.CancelRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.decline.DeclineRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.instances.InstancesRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
