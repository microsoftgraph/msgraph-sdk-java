package com.microsoft.graph.me.calendargroups.item.calendars.item.events.item;

import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.attachments.AttachmentsRequestBuilder;
...
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.instances.InstancesRequestBuilder;
...
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
...
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
