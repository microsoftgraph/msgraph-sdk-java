...
public class GetScheduleRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetSchedulePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GetScheduleResponse> post(@javax.annotation.Nonnull final GetSchedulePostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetScheduleResponse> executionException = new java.util.concurrent.CompletableFuture<GetScheduleResponse>();
