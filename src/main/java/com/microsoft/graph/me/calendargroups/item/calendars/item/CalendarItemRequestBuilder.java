package microsoft.graph.me.calendargroups.item.calendars.item;
...
import microsoft.graph.me.calendargroups.item.calendars.item.allowedcalendarsharingroleswithuser.AllowedCalendarSharingRolesWithUserRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.calendarpermissions.CalendarPermissionsRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.calendarpermissions.item.CalendarPermissionItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.calendarview.CalendarViewRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.events.EventsRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.getschedule.GetScheduleRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendargroups.item.calendars.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class CalendarItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarGroups.item.calendars.item.calendarPermissions.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarGroups.item.calendars.item.calendarView.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendargroups.item.calendars.item.calendarview.item.EventItemRequestBuilder calendarView(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendargroups.item.calendars.item.events.item.EventItemRequestBuilder events(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did", id);
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarGroups.item.calendars.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarGroups.item.calendars.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
