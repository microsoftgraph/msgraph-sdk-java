package com.microsoft.graph.me.calendargroups.item.calendars.item.calendarview.item.instances.item;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.calendarView.item.instances.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.calendarView.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.calendarView.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.calendarView.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
