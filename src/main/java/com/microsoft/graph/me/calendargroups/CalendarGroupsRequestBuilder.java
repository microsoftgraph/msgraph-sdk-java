package com.microsoft.graph.me.calendargroups;

import com.microsoft.graph.me.calendargroups.count.CountRequestBuilder;
...
public class CalendarGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public CalendarGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendarGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters);
    }
    /**
     * Instantiates a new CalendarGroupsRequestBuilder and sets the default values.
