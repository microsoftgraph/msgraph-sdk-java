package com.microsoft.graph.me.drives.item.root.listitem.documentsetversions;

import com.microsoft.graph.me.drives.item.root.listitem.documentsetversions.count.CountRequestBuilder;
...
public class DocumentSetVersionsRequestBuilder {
    ...
    public DocumentSetVersionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
