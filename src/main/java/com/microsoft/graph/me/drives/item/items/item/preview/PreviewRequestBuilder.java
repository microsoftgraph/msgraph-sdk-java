...
public class PreviewRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PreviewPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ItemPreviewInfo> post(@javax.annotation.Nonnull final PreviewPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ItemPreviewInfo> executionException = new java.util.concurrent.CompletableFuture<ItemPreviewInfo>();
