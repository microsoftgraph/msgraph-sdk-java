package com.microsoft.graph.me.drives.item.list.operations;

import com.microsoft.graph.me.drives.item.list.operations.count.CountRequestBuilder;
...
public class OperationsRequestBuilder {
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
