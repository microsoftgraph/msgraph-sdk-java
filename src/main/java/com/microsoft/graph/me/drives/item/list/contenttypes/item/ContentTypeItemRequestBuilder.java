package microsoft.graph.me.drives.item.list.contenttypes.item;
...
import microsoft.graph.me.drives.item.list.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.base.BaseRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.basetypes.BaseTypesRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.columnlinks.ColumnLinksRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.columnlinks.item.ColumnLinkItemRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.ColumnPositionsRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.columns.ColumnsRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.copytodefaultcontentlocation.CopyToDefaultContentLocationRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.ispublished.IsPublishedRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.publish.PublishRequestBuilder;
import microsoft.graph.me.drives.item.list.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.list.contentTypes.item.baseTypes.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.list.contentTypes.item.columnLinks.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.list.contentTypes.item.columnPositions.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder columnPositions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.list.contentTypes.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new microsoft.graph.me.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
