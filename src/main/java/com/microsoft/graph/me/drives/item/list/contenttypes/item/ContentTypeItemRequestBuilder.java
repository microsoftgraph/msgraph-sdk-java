package com.microsoft.graph.me.drives.item.list.contenttypes.item;

import com.microsoft.graph.me.drives.item.list.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.base.BaseRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.basetypes.BaseTypesRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.columnlinks.ColumnLinksRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.columnlinks.item.ColumnLinkItemRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.ColumnPositionsRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.columns.ColumnsRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.copytodefaultcontentlocation.CopyToDefaultContentLocationRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.ispublished.IsPublishedRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.publish.PublishRequestBuilder;
import com.microsoft.graph.me.drives.item.list.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.drives.item.list.contentTypes.item.baseTypes.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.drives.item.list.contentTypes.item.columnLinks.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.drives.item.list.contentTypes.item.columnPositions.item collection
     * @param id Unique identifier of the item
     * @return a ColumnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder columnPositions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new com.microsoft.graph.me.drives.item.list.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the com.Microsoft.Graph.me.drives.item.list.contentTypes.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a ColumnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.me.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new com.microsoft.graph.me.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     * @return a CompletableFuture of contentType
     */
    public java.util.concurrent.CompletableFuture<ContentType> patch(@javax.annotation.Nonnull final ContentType body, @javax.annotation.Nullable final java.util.function.Consumer<ContentTypeItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
