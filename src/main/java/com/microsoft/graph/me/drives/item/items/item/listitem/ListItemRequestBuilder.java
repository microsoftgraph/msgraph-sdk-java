package microsoft.graph.me.drives.item.items.item.listitem;
...
import microsoft.graph.me.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.me.drives.item.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.items.item.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.items.item.listItem.versions.item collection
     * @param id Unique identifier of the item
