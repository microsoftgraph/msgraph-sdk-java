package com.microsoft.graph.me.drives.item.recent;
...
public class RecentRequestBuilder {
    ...
    public RecentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/microsoft.graph.recent(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<RecentRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RecentResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RecentResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<RecentResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<RecentRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RecentResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
