package com.microsoft.graph.me.drives.item.items.item.restore;
...
public class RestoreRequestBuilder {
    ...
    public RestoreRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.restore";
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RestorePostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RestorePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @return a CompletableFuture of driveItem
     */
    public java.util.concurrent.CompletableFuture<DriveItem> post(@javax.annotation.Nonnull final RestorePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of driveItem
     */
    public java.util.concurrent.CompletableFuture<DriveItem> post(@javax.annotation.Nonnull final RestorePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
