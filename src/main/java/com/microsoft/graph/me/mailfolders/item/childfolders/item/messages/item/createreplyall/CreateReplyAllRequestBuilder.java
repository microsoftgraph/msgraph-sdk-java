package com.microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.createreplyall;
...
public class CreateReplyAllRequestBuilder extends BaseRequestBuilder {
    ...
    public CreateReplyAllRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReplyAll", pathParameters);
    }
    /**
     * Instantiates a new CreateReplyAllRequestBuilder and sets the default values.
    ...
    public CreateReplyAllRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReplyAll", rawUrl);
    }
    /**
