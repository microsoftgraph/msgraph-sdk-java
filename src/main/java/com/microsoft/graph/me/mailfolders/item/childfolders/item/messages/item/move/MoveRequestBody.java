package microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.move;
...
public class MoveRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a moveRequestBody
     */
    @javax.annotation.Nonnull
    public static MoveRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MoveRequestBody currentObject = this;
