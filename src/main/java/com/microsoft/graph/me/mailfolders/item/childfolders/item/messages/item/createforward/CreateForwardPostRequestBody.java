...
public class CreateForwardPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static CreateForwardPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateForwardPostRequestBody currentObject = this;
