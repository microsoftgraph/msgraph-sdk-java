...
public class MessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
