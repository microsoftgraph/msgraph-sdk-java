package microsoft.graph.me.mailfolders.item.childfolders.item.messages.item;
...
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.calendarsharingmessage.CalendarSharingMessageRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.copy.CopyRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.createforward.CreateForwardRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.createreply.CreateReplyRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.createreplyall.CreateReplyAllRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.move.MoveRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.reply.ReplyRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.replyall.ReplyAllRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.send.SendRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.value.ContentRequestBuilder;
...
public class MessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
