package com.microsoft.graph.me.mailfolders.item.childfolders.item.messagerules;

import com.microsoft.graph.me.mailfolders.item.childfolders.item.messagerules.count.CountRequestBuilder;
...
public class MessageRulesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MessageRuleCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MessageRuleCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<MessageRuleCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<MessageRulesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MessageRuleCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
