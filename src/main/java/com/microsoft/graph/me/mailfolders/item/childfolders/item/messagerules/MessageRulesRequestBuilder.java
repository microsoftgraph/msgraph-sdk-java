...
public class MessageRulesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MessageRuleCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MessageRuleCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MessageRuleCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MessageRule> post(@javax.annotation.Nonnull final MessageRule body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MessageRule> executionException = new java.util.concurrent.CompletableFuture<MessageRule>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
