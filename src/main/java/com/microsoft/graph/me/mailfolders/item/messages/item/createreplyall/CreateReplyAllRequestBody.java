...
public class CreateReplyAllRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createReplyAllRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateReplyAllRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateReplyAllRequestBody currentObject = this;
