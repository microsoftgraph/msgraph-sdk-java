...
public class SendRequestBuilder extends BaseRequestBuilder {
    ...
    public SendRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/send", pathParameters);
    }
    /**
     * Instantiates a new SendRequestBuilder and sets the default values.
    ...
    public SendRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/send", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/message-send?view=graph-rest-1.0">Find more info here</a>
     */
