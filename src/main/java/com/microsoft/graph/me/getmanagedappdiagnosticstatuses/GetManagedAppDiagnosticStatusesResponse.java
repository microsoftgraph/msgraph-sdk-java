package com.microsoft.graph.me.getmanagedappdiagnosticstatuses;
...
public class GetManagedAppDiagnosticStatusesResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(ManagedAppDiagnosticStatus::createFromDiscriminatorValue)); });
