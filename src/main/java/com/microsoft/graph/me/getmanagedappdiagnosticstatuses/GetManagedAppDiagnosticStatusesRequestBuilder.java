...
public class GetManagedAppDiagnosticStatusesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetManagedAppDiagnosticStatusesResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetManagedAppDiagnosticStatusesResponse> executionException = new java.util.concurrent.CompletableFuture<GetManagedAppDiagnosticStatusesResponse>();
