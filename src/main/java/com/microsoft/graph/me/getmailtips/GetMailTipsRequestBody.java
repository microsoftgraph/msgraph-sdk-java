...
import microsoft.graph.models.MailTipsType;
/** Provides operations to call the getMailTips method.  */
public class GetMailTipsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getMailTipsRequestBody
     */
    @javax.annotation.Nonnull
    public static GetMailTipsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMailTipsRequestBody currentObject = this;
