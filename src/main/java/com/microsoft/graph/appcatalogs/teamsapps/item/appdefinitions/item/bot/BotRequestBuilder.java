...
public class BotRequestBuilder {
     ...
     * @return a CompletableFuture of teamworkBot
     */
    public java.util.concurrent.CompletableFuture<TeamworkBot> patch(@javax.annotation.Nonnull final TeamworkBot body, @javax.annotation.Nullable final java.util.function.Consumer<BotRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
