...
public class SubjectRightsRequestsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SubjectRightsRequestCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<SubjectRightsRequestCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SubjectRightsRequestCollectionResponse>();
