...
public class WorkforceIntegrationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WorkforceIntegration body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WorkforceIntegrationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WorkforceIntegrationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WorkforceIntegrationCollectionResponse>();
