...
public class WorkforceIntegrationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WorkforceIntegrationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WorkforceIntegrationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WorkforceIntegrationCollectionResponse>();
