...
public class Oauth2PermissionGrantsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OAuth2PermissionGrant body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OAuth2PermissionGrantCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OAuth2PermissionGrantCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OAuth2PermissionGrantCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<OAuth2PermissionGrant> post(@javax.annotation.Nonnull final OAuth2PermissionGrant body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<OAuth2PermissionGrant> executionException = new java.util.concurrent.CompletableFuture<OAuth2PermissionGrant>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
