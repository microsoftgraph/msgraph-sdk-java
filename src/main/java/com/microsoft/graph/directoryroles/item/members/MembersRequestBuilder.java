...
import com.microsoft.graph.directoryroles.item.members.application.ApplicationRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.count.CountRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.device.DeviceRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.group.GroupRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.ref.RefRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.directoryroles.item.members.user.UserRequestBuilder;
