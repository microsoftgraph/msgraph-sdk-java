...
public class DirectoryRoleItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DirectoryRole body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DirectoryRole> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DirectoryRole> executionException = new java.util.concurrent.CompletableFuture<DirectoryRole>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
