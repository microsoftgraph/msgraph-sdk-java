package com.microsoft.graph.directoryroles.delta;
...
public class DeltaResponse extends BaseDeltaFunctionResponse implements Parsable {
    /** The value property */
    private java.util.List<DirectoryRole> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(DirectoryRole::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<DirectoryRole> value) {
        this._value = value;
    }
}
