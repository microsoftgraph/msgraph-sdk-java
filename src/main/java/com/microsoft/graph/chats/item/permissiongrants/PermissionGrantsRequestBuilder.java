...
import com.microsoft.graph.chats.item.permissiongrants.delta.DeltaRequestBuilder;
import com.microsoft.graph.chats.item.permissiongrants.getavailableextensionproperties.GetAvailableExtensionPropertiesRequestBuilder;
import com.microsoft.graph.chats.item.permissiongrants.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.chats.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import com.microsoft.graph.chats.item.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
