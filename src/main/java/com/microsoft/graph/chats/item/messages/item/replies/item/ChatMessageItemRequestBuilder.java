package microsoft.graph.chats.item.messages.item.replies.item;
...
import microsoft.graph.chats.item.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.chats.item.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.chats.item.messages.item.replies.item.hostedContents.item collection
