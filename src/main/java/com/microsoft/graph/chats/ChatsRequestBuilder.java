...
public class ChatsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Chat body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ChatCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ChatCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ChatCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Chat> post(@javax.annotation.Nonnull final Chat body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Chat> executionException = new java.util.concurrent.CompletableFuture<Chat>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
