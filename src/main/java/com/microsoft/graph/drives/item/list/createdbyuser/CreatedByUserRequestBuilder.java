package com.microsoft.graph.drives.item.list.createdbyuser;

import com.microsoft.graph.drives.item.list.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.drives.item.list.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
