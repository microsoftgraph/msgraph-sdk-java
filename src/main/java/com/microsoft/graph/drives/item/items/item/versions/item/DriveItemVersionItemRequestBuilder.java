package microsoft.graph.drives.item.items.item.versions.item;
...
import microsoft.graph.drives.item.items.item.versions.item.content.ContentRequestBuilder;
import microsoft.graph.drives.item.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
