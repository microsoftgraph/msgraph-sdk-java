...
public class SessionInfoResourceWithKeyRequestBuilder extends BaseRequestBuilder {
    ...
    public SessionInfoResourceWithKeyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String key) {
     ...
     */
    @javax.annotation.Nullable
    public SessionInfoResourceWithKeyRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookSessionInfo> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
