...
public class CellWithRowWithColumnRequestBuilder {
    ...
    public CellWithRowWithColumnRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final Integer column, @javax.annotation.Nullable final Integer row) {
        ...
        urlTplParams.put("column", column);
        urlTplParams.put("row", row);
     ...
     */
    @javax.annotation.Nullable
    public CellWithRowWithColumnRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/cell(row={row},column={column})";
