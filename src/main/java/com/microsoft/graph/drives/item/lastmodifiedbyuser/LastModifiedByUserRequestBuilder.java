package com.microsoft.graph.drives.item.lastmodifiedbyuser;

import com.microsoft.graph.drives.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
...
public class LastModifiedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByUserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/lastModifiedByUser{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new LastModifiedByUserRequestBuilder and sets the default values.
    ...
    public LastModifiedByUserRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/lastModifiedByUser{?%24select,%24expand}", rawUrl);
    }
    /**
