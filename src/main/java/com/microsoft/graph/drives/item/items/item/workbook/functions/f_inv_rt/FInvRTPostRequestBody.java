package com.microsoft.graph.drives.item.items.item.workbook.functions.f_inv_rt;
...
public class FInvRTPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a FInvRTPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static FInvRTPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new FInvRTPostRequestBody();
    }
    /**
