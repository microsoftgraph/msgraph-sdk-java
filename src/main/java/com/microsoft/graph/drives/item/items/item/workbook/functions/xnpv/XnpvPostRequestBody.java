...
public class XnpvPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static XnpvPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDates(@javax.annotation.Nullable final Json value) {
        this.dates = value;
    }
    /**
