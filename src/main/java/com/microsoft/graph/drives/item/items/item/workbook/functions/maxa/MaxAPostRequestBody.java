...
public class MaxAPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static MaxAPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
