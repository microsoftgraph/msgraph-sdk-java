package microsoft.graph.drives.item.root.subscriptions.item;
...
import microsoft.graph.drives.item.root.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
