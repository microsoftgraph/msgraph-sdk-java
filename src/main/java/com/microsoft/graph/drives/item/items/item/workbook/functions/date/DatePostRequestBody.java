...
public class DatePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static DatePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDay(@javax.annotation.Nullable final Json value) {
        this.day = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setYear(@javax.annotation.Nullable final Json value) {
        this.year = value;
    }
}
