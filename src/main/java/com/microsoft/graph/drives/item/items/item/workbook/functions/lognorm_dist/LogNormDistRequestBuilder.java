...
public class LogNormDistRequestBuilder extends BaseRequestBuilder {
    ...
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final LogNormDistPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WorkbookFunctionResult post(@jakarta.annotation.Nonnull final LogNormDistPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
