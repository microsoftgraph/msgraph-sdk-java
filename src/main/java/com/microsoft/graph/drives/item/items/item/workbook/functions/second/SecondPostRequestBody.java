...
public class SecondPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a SecondPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static SecondPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
