...
public class TPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static TPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
