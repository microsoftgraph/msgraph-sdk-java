...
public class DecimalPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static DecimalPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
