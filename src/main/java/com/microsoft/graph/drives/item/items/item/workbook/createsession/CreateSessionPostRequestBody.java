...
public class CreateSessionPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static CreateSessionPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPersistChanges(@javax.annotation.Nullable final Boolean value) {
