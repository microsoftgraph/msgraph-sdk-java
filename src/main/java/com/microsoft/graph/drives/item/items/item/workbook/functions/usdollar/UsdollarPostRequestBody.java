...
public class UsdollarPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static UsdollarPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDecimals(@javax.annotation.Nullable final Json value) {
        this.decimals = value;
    }
    /**
