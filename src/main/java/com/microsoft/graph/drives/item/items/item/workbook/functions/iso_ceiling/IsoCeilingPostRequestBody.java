...
public class IsoCeilingPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static IsoCeilingPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
