...
public class InviteRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<InviteResponse> post(@jakarta.annotation.Nonnull final InvitePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<InviteResponse> post(@jakarta.annotation.Nonnull final InvitePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
