package com.microsoft.graph.drives.item.list.contenttypes.item;

import com.microsoft.graph.drives.item.list.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import com.microsoft.graph.drives.item.list.contenttypes.item.base.BaseRequestBuilder;
...
import com.microsoft.graph.drives.item.list.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder;
...
import com.microsoft.graph.drives.item.list.contenttypes.item.publish.PublishRequestBuilder;
import com.microsoft.graph.drives.item.list.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.contentTypes.item.baseTypes.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.contentTypes.item.columnLinks.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.contentTypes.item.columnPositions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.contentTypes.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a ColumnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
