...
public class ImSecPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a ImSecPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static ImSecPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
