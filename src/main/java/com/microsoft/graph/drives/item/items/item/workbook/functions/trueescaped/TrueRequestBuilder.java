 ...
 */
public class TrueRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public TrueRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/true", pathParameters);
    }
    /**
     * Instantiates a new TrueRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public TrueRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/true", rawUrl);
    }
    /**
     * Invoke action true
