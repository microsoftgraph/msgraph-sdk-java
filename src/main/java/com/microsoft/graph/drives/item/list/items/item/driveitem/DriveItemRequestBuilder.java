package microsoft.graph.drives.item.list.items.item.driveitem;
...
import microsoft.graph.drives.item.list.items.item.driveitem.content.ContentRequestBuilder;
