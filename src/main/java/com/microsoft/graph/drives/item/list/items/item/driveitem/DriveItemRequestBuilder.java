package com.microsoft.graph.drives.item.list.items.item.driveitem;

import com.microsoft.graph.drives.item.list.items.item.driveitem.content.ContentRequestBuilder;
