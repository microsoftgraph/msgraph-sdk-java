package com.microsoft.graph.drives.item.items.item.workbook.tables.item.reapplyfilters;
...
public class ReapplyFiltersRequestBuilder {
    ...
    public ReapplyFiltersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/reapplyFilters";
