package com.microsoft.graph.drives.item.items.item.workbook.functions.today;
 ...
 */
public class TodayRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public TodayRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/today", pathParameters);
    }
    /**
     * Instantiates a new TodayRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public TodayRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/today", rawUrl);
    }
    /**
     * Invoke action today
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookFunctionResult> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
