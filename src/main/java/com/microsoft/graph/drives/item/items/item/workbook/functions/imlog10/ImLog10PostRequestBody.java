...
public class ImLog10PostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static ImLog10PostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
