...
public class LogPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static LogPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setBase(@javax.annotation.Nullable final Json value) {
        this.base = value;
    }
    /**
