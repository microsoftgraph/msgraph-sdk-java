...
public class Hex2OctPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a Hex2OctPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static Hex2OctPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
