...
public class ImSqrtPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static ImSqrtPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
