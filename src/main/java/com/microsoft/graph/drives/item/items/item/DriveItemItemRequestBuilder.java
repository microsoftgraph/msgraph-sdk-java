...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.children.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.versions.item collection
     * @param id Unique identifier of the item
