...
public class QuartileExcPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static QuartileExcPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setQuart(@javax.annotation.Nullable final Json value) {
        this.quart = value;
    }
}
