package com.microsoft.graph.drives.item.list.subscriptions.item;

import com.microsoft.graph.drives.item.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
