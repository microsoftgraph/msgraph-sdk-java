package microsoft.graph.drives.item.list.subscriptions.item;
...
import microsoft.graph.drives.item.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
