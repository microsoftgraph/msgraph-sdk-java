package com.microsoft.graph.drives.item.root.versions.item;

import com.microsoft.graph.drives.item.root.versions.item.content.ContentRequestBuilder;
import com.microsoft.graph.drives.item.root.versions.item.restoreversion.RestoreVersionRequestBuilder;
