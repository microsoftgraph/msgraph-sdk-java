package microsoft.graph.drives.item.root.versions.item;
...
import microsoft.graph.drives.item.root.versions.item.content.ContentRequestBuilder;
import microsoft.graph.drives.item.root.versions.item.restoreversion.RestoreVersionRequestBuilder;
