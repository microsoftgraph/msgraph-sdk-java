package com.microsoft.graph.drives.item.items.item.subscriptions.item;

import com.microsoft.graph.drives.item.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
