package microsoft.graph.drives.item.items.item.subscriptions.item;
...
import microsoft.graph.drives.item.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
