...
public class RepliesRequestBuilder extends BaseRequestBuilder {
    ...
    public RepliesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RepliesRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<WorkbookCommentReplyCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WorkbookCommentReplyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WorkbookCommentReplyCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookCommentReply> post(@javax.annotation.Nonnull final WorkbookCommentReply body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WorkbookCommentReply> executionException = new java.util.concurrent.CompletableFuture<WorkbookCommentReply>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookCommentReply> post(@javax.annotation.Nonnull final WorkbookCommentReply body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WorkbookCommentReply body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WorkbookCommentReply body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
