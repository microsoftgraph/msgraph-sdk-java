...
public class ImageWithWidthResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * @return a imageWithWidthResponse
     */
    @jakarta.annotation.Nonnull
    public static ImageWithWidthResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
