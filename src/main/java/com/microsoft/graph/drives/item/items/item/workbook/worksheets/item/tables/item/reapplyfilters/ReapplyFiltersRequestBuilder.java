package com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.tables.item.reapplyfilters;
...
public class ReapplyFiltersRequestBuilder extends BaseRequestBuilder {
    ...
    public ReapplyFiltersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/reapplyFilters", pathParameters);
    }
    /**
     * Instantiates a new ReapplyFiltersRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public ReapplyFiltersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
