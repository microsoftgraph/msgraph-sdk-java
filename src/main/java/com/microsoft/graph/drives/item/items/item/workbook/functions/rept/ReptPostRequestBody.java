...
public class ReptPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a reptPostRequestBody
     */
    @javax.annotation.Nonnull
    public static ReptPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("numberTimes", (n) -> { this.setNumberTimes(n.getObjectValue(Json::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setNumberTimes(@javax.annotation.Nullable final Json value) {
