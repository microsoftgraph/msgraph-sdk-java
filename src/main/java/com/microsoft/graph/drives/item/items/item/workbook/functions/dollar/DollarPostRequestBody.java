...
public class DollarPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static DollarPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
