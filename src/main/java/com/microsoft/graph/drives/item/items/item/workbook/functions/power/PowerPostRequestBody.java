...
public class PowerPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static PowerPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPower(@javax.annotation.Nullable final Json value) {
        this.power = value;
    }
}
