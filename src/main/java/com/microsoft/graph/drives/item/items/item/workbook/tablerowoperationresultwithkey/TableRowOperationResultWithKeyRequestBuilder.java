...
public class TableRowOperationResultWithKeyRequestBuilder extends BaseRequestBuilder {
    ...
    public TableRowOperationResultWithKeyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String key) {
     ...
     */
    @javax.annotation.Nullable
    public TableRowOperationResultWithKeyRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
