...
public class MroundPostRequestBody implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The multiple property */
    private Json multiple;
    /** The number property */
    private Json number;
    /**
    ...
    public static MroundPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setMultiple(@javax.annotation.Nullable final Json value) {
        this.multiple = value;
    }
    /**
