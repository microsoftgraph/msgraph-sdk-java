package com.microsoft.graph.drives.item.items.item.listitem.documentsetversions;

import com.microsoft.graph.drives.item.items.item.listitem.documentsetversions.count.CountRequestBuilder;
...
public class DocumentSetVersionsRequestBuilder {
    ...
    public DocumentSetVersionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
