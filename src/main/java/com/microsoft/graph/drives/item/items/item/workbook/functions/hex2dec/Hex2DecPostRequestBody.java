...
public class Hex2DecPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static Hex2DecPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
