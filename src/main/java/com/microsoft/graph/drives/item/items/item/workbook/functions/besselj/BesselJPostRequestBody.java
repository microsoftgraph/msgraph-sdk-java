...
public class BesselJPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static BesselJPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
