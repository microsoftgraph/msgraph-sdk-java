package microsoft.graph.drives.item.items.item.listitem.driveitem;
...
import microsoft.graph.drives.item.items.item.listitem.driveitem.content.ContentRequestBuilder;
