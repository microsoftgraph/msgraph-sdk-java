package com.microsoft.graph.drives.item.items.item.listitem.driveitem;

import com.microsoft.graph.drives.item.items.item.listitem.driveitem.content.ContentRequestBuilder;
