...
public class MinutePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a MinutePostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static MinutePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
