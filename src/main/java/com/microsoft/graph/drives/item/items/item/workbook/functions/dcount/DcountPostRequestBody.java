...
public class DcountPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static DcountPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
