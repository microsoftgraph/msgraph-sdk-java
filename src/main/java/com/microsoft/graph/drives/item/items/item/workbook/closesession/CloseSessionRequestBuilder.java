package com.microsoft.graph.drives.item.items.item.workbook.closesession;
...
public class CloseSessionRequestBuilder extends BaseRequestBuilder {
    ...
    public CloseSessionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/closeSession", pathParameters);
    }
    /**
     * Instantiates a new CloseSessionRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public CloseSessionRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/closeSession", rawUrl);
    }
    /**
     * Use this API to close an existing workbook session.
     * @return a CompletableFuture of void
     * @see <a href="https://docs.microsoft.com/graph/api/workbook-closesession?view=graph-rest-1.0">Find more info here</a>
     */
