...
public class DstDevPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a DstDevPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static DstDevPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
