...
public class IsErrorPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static IsErrorPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
