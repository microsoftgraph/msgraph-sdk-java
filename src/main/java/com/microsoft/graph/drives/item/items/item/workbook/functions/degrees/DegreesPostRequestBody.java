package com.microsoft.graph.drives.item.items.item.workbook.functions.degrees;
...
public class DegreesPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     * @return a degreesPostRequestBody
     */
    @javax.annotation.Nonnull
    public static DegreesPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAngle(@javax.annotation.Nullable final Json value) {
        this.angle = value;
    }
}
