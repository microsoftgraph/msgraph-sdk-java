...
public class ExtractSensitivityLabelsRequestBuilder extends BaseRequestBuilder {
    ...
    public ExtractSensitivityLabelsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public ExtractSensitivityLabelsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ExtractSensitivityLabelsResult> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ExtractSensitivityLabelsResult> executionException = new java.util.concurrent.CompletableFuture<ExtractSensitivityLabelsResult>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExtractSensitivityLabelsResult> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
