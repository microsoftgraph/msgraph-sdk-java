...
public class TextPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static TextPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setFormatText(@javax.annotation.Nullable final Json value) {
