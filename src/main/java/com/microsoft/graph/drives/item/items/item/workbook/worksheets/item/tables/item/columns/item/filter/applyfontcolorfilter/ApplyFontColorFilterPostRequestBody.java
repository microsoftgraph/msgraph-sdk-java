...
public class ApplyFontColorFilterPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a ApplyFontColorFilterPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static ApplyFontColorFilterPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
