...
public class ListRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.columns.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.subscriptions.item collection
     * @param id Unique identifier of the item
