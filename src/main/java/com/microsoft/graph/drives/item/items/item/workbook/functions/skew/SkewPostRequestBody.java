...
public class SkewPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static SkewPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
