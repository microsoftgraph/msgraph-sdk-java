...
public class DurationPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static DurationPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
