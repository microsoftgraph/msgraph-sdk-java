...
public class AcoshPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a AcoshPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static AcoshPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
