...
public class RightbPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a RightbPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static RightbPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
