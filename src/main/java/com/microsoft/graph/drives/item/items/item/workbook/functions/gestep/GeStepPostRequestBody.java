...
public class GeStepPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a GeStepPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GeStepPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("step", (n) -> { this.setStep(n.getObjectValue(Json::createFromDiscriminatorValue)); });
    ...
    @jakarta.annotation.Nullable
    public Json getStep() {
        return this.BackingStore.get("step");
    }
    /**
    ...
    public void setStep(@jakarta.annotation.Nullable final Json value) {
        this.BackingStore.set("step", value);
    }
}
