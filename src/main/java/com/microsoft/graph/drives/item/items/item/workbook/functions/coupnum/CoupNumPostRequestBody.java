...
public class CoupNumPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static CoupNumPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
