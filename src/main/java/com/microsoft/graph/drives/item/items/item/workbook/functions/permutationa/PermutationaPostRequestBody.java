...
public class PermutationaPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a PermutationaPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static PermutationaPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Json getNumberChosen() {
        return this.getBackingStore().get("numberChosen");
    }
    /**
    ...
    public void setNumberChosen(@jakarta.annotation.Nullable final Json value) {
        this.getBackingStore().set("numberChosen", value);
    }
}
