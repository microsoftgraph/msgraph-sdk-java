...
public class AddRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WorkbookTable> post(@javax.annotation.Nonnull final AddPostRequestBody body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookTable> post(@javax.annotation.Nonnull final AddPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
