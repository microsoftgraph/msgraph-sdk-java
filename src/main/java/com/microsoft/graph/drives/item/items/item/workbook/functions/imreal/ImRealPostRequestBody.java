...
public class ImRealPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static ImRealPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
