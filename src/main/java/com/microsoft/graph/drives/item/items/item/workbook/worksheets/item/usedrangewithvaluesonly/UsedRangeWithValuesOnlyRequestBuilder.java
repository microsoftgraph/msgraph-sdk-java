...
public class UsedRangeWithValuesOnlyRequestBuilder {
    ...
    public UsedRangeWithValuesOnlyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final Boolean valuesOnly) {
        ...
        urlTplParams.put("valuesOnly", valuesOnly);
     ...
     */
    @javax.annotation.Nullable
    public UsedRangeWithValuesOnlyRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/usedRange(valuesOnly={valuesOnly})";
