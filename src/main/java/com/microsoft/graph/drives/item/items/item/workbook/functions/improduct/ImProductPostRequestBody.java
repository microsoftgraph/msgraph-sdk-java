...
public class ImProductPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static ImProductPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
