...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.items.item.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.items.item.versions.item collection
     * @param id Unique identifier of the item
