...
public class CeilingPrecisePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static CeilingPrecisePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
