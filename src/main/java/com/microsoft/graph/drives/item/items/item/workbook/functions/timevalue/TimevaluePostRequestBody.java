...
public class TimevaluePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static TimevaluePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTimeText(@javax.annotation.Nullable final Json value) {
        this.timeText = value;
    }
}
