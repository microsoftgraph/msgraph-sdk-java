...
public class CoupDaysNcPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static CoupDaysNcPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
