...
public class NormDistPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static NormDistPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
