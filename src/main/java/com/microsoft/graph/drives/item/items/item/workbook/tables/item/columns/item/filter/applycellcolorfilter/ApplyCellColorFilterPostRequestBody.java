package com.microsoft.graph.drives.item.items.item.workbook.tables.item.columns.item.filter.applycellcolorfilter;
...
public class ApplyCellColorFilterPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ApplyCellColorFilterPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
