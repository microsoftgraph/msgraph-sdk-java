...
public class FileRequestBuilder {
     ...
     * @return a CompletableFuture of agreementFile
     */
    public java.util.concurrent.CompletableFuture<AgreementFile> patch(@javax.annotation.Nonnull final AgreementFile body, @javax.annotation.Nullable final java.util.function.Consumer<FileRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
