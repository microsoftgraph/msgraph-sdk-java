package com.microsoft.graph.communications.onlinemeetings.item.recordings.item;

import com.microsoft.graph.communications.onlinemeetings.item.recordings.item.content.ContentRequestBuilder;
...
public class CallRecordingItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CallRecordingItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/recordings/{callRecording%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CallRecordingItemRequestBuilder and sets the default values.
    ...
    public CallRecordingItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/recordings/{callRecording%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CallRecording> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CallRecording> patch(@jakarta.annotation.Nonnull final CallRecording body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CallRecording> patch(@jakarta.annotation.Nonnull final CallRecording body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
