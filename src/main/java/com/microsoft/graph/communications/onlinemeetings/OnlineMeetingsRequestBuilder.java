...
public class OnlineMeetingsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OnlineMeeting body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OnlineMeetingCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnlineMeetingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OnlineMeetingCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<OnlineMeeting> post(@javax.annotation.Nonnull final OnlineMeeting body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnlineMeeting> executionException = new java.util.concurrent.CompletableFuture<OnlineMeeting>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
