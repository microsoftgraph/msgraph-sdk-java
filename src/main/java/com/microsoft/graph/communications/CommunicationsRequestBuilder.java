package microsoft.graph.communications;
...
import microsoft.graph.communications.callrecords.CallRecordsRequestBuilder;
import microsoft.graph.communications.callrecords.item.CallRecordItemRequestBuilder;
import microsoft.graph.communications.calls.CallsRequestBuilder;
import microsoft.graph.communications.calls.item.CallItemRequestBuilder;
import microsoft.graph.communications.getpresencesbyuserid.GetPresencesByUserIdRequestBuilder;
import microsoft.graph.communications.onlinemeetings.item.OnlineMeetingItemRequestBuilder;
import microsoft.graph.communications.onlinemeetings.OnlineMeetingsRequestBuilder;
import microsoft.graph.communications.presences.item.PresenceItemRequestBuilder;
import microsoft.graph.communications.presences.PresencesRequestBuilder;
import microsoft.graph.models.CloudCommunications;
