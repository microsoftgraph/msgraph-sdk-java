...
public class GetPresencesByUserIdPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetPresencesByUserIdPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetPresencesByUserIdPostRequestBody currentObject = this;
