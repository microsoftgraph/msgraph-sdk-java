...
public class GetPresencesByUserIdRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetPresencesByUserIdResponse> post(@jakarta.annotation.Nonnull final GetPresencesByUserIdPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetPresencesByUserIdResponse> executionException = new java.util.concurrent.CompletableFuture<GetPresencesByUserIdResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetPresencesByUserIdResponse> post(@jakarta.annotation.Nonnull final GetPresencesByUserIdPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GetPresencesByUserIdPostRequestBody body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GetPresencesByUserIdPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
