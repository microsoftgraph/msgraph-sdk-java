...
public class GetPresencesByUserIdRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getPresencesByUserIdRequestBody
     */
    @javax.annotation.Nonnull
    public static GetPresencesByUserIdRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetPresencesByUserIdRequestBody currentObject = this;
