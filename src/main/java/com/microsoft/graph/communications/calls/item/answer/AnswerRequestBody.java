...
import microsoft.graph.models.Modality;
/** Provides operations to call the answer method.  */
public class AnswerRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a answerRequestBody
     */
    @javax.annotation.Nonnull
    public static AnswerRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AnswerRequestBody currentObject = this;
