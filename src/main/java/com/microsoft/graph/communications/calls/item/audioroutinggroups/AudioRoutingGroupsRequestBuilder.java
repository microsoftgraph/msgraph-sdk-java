...
public class AudioRoutingGroupsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AudioRoutingGroup body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AudioRoutingGroupCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AudioRoutingGroupCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AudioRoutingGroupCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AudioRoutingGroup> post(@javax.annotation.Nonnull final AudioRoutingGroup body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AudioRoutingGroup> executionException = new java.util.concurrent.CompletableFuture<AudioRoutingGroup>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
