...
public class RecordResponseRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a recordResponseRequestBody
     */
    @javax.annotation.Nonnull
    public static RecordResponseRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RecordResponseRequestBody currentObject = this;
