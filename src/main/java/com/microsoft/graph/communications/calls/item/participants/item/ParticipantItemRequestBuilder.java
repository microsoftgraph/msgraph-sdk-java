package microsoft.graph.communications.calls.item.participants.item;
...
import microsoft.graph.communications.calls.item.participants.item.mute.MuteRequestBuilder;
import microsoft.graph.communications.calls.item.participants.item.startholdmusic.StartHoldMusicRequestBuilder;
import microsoft.graph.communications.calls.item.participants.item.stopholdmusic.StopHoldMusicRequestBuilder;
