package microsoft.graph.communications.calls.item.subscribetotone;
...
public class SubscribeToTonePostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a subscribeToTonePostRequestBody
     */
    @javax.annotation.Nonnull
    public static SubscribeToTonePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SubscribeToTonePostRequestBody currentObject = this;
