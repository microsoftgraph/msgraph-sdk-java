...
public class StartHoldMusicRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a startHoldMusicRequestBody
     */
    @javax.annotation.Nonnull
    public static StartHoldMusicRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final StartHoldMusicRequestBody currentObject = this;
