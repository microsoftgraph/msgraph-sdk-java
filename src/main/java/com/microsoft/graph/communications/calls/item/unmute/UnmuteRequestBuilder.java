...
public class UnmuteRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UnmutePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UnmuteParticipantOperation> post(@javax.annotation.Nonnull final UnmutePostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UnmuteParticipantOperation> executionException = new java.util.concurrent.CompletableFuture<UnmuteParticipantOperation>();
