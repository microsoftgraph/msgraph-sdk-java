...
public class StopHoldMusicRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a stopHoldMusicRequestBody
     */
    @javax.annotation.Nonnull
    public static StopHoldMusicRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final StopHoldMusicRequestBody currentObject = this;
