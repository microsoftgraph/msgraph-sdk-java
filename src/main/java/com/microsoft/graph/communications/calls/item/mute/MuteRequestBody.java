...
public class MuteRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a muteRequestBody
     */
    @javax.annotation.Nonnull
    public static MuteRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MuteRequestBody currentObject = this;
