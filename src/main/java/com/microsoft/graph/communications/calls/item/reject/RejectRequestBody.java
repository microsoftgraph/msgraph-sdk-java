...
public class RejectRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a rejectRequestBody
     */
    @javax.annotation.Nonnull
    public static RejectRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RejectRequestBody currentObject = this;
