...
public class UnmutePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static UnmutePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnmutePostRequestBody currentObject = this;
