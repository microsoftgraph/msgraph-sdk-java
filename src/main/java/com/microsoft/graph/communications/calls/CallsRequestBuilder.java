...
public class CallsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Call body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CallCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CallCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CallCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Call> post(@javax.annotation.Nonnull final Call body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Call> executionException = new java.util.concurrent.CompletableFuture<Call>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
