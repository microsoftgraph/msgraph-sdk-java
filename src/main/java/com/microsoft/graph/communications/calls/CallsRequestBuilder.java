...
public class CallsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CallCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CallCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CallCollectionResponse>();
