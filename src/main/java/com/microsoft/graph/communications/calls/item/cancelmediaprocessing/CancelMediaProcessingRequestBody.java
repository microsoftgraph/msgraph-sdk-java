...
public class CancelMediaProcessingRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a cancelMediaProcessingRequestBody
     */
    @javax.annotation.Nonnull
    public static CancelMediaProcessingRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CancelMediaProcessingRequestBody currentObject = this;
