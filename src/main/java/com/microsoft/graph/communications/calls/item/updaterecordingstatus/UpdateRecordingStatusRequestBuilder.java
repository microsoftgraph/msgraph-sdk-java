...
public class UpdateRecordingStatusRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UpdateRecordingStatusPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UpdateRecordingStatusOperation> post(@javax.annotation.Nonnull final UpdateRecordingStatusPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UpdateRecordingStatusOperation> executionException = new java.util.concurrent.CompletableFuture<UpdateRecordingStatusOperation>();
