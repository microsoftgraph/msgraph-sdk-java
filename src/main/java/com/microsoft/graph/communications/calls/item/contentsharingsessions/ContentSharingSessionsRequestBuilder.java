...
public class ContentSharingSessionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ContentSharingSession> post(@javax.annotation.Nonnull final ContentSharingSession body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ContentSharingSession> executionException = new java.util.concurrent.CompletableFuture<ContentSharingSession>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
