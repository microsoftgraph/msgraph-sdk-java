...
public class ContentSharingSessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ContentSharingSession> post(@javax.annotation.Nonnull final ContentSharingSession body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ContentSharingSession> executionException = new java.util.concurrent.CompletableFuture<ContentSharingSession>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ContentSharingSession> post(@javax.annotation.Nonnull final ContentSharingSession body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ContentSharingSession body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ContentSharingSession body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
