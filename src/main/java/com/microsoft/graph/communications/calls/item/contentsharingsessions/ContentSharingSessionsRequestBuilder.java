...
public class ContentSharingSessionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ContentSharingSessionCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of ContentSharingSessionCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ContentSharingSessionCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ContentSharingSessionsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ContentSharingSessionCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<ContentSharingSession> post(@javax.annotation.Nonnull final ContentSharingSession body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ContentSharingSession::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of contentSharingSession
     */
    public java.util.concurrent.CompletableFuture<ContentSharingSession> post(@javax.annotation.Nonnull final ContentSharingSession body, @javax.annotation.Nullable final java.util.function.Consumer<ContentSharingSessionsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, ContentSharingSession::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
