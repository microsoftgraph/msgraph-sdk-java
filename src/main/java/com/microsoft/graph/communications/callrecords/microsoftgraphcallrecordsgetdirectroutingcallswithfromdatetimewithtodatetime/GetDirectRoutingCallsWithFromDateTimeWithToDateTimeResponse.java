...
public class GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * The value property
     */
    ...
    public static GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<DirectRoutingLogRow> value) {
        this.value = value;
    }
}
