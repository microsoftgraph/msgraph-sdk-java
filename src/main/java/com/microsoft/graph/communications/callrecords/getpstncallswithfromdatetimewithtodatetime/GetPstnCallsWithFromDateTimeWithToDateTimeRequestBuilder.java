...
public class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetPstnCallsWithFromDateTimeWithToDateTimeResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetPstnCallsWithFromDateTimeWithToDateTimeResponse> executionException = new java.util.concurrent.CompletableFuture<GetPstnCallsWithFromDateTimeWithToDateTimeResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetPstnCallsWithFromDateTimeWithToDateTimeResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
