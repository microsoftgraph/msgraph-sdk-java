...
public class SegmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SegmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SegmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SegmentCollectionResponse>();
