...
public class CallRecordsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CallRecordCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CallRecordCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CallRecordCollectionResponse>();
