package microsoft.graph.identity.conditionalaccess.namedlocations;
...
import microsoft.graph.identity.conditionalaccess.namedlocations.count.CountRequestBuilder;
import microsoft.graph.models.NamedLocation;
import microsoft.graph.models.NamedLocationCollectionResponse;
...
public class NamedLocationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<NamedLocationCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, NamedLocationCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of NamedLocationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<NamedLocationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<NamedLocationsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, NamedLocationCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of namedLocation
     */
    public java.util.concurrent.CompletableFuture<NamedLocation> post(@javax.annotation.Nonnull final NamedLocation body, @javax.annotation.Nullable final java.util.function.Consumer<NamedLocationsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
