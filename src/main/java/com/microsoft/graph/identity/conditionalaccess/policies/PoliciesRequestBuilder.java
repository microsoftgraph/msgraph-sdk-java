...
public class PoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCollectionResponse>();
