...
public class AuthenticationContextClassReferenceItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationContextClassReference> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationContextClassReference> executionException = new java.util.concurrent.CompletableFuture<AuthenticationContextClassReference>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
