...
public class ConditionalAccessTemplateItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConditionalAccessTemplate> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConditionalAccessTemplate> executionException = new java.util.concurrent.CompletableFuture<ConditionalAccessTemplate>();
