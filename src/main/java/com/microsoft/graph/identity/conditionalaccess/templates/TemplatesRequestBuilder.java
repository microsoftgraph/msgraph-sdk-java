...
public class TemplatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConditionalAccessTemplateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConditionalAccessTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConditionalAccessTemplateCollectionResponse>();
