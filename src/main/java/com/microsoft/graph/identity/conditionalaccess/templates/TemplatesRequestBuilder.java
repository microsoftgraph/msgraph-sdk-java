...
public class TemplatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConditionalAccessTemplateCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ConditionalAccessTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConditionalAccessTemplateCollectionResponse>();
