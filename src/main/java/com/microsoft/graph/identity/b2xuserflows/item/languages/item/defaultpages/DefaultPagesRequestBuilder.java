...
public class DefaultPagesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserFlowLanguagePage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserFlowLanguagePageCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserFlowLanguagePageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserFlowLanguagePageCollectionResponse>();
