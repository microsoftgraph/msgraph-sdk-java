...
public class UserAttributeAssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeAssignmentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeAssignment> post(@javax.annotation.Nonnull final IdentityUserFlowAttributeAssignment body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeAssignment> executionException = new java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
