package com.microsoft.graph.identity.b2xuserflows.item.apiconnectorconfiguration.postfederationsignup;

import com.microsoft.graph.identity.b2xuserflows.item.apiconnectorconfiguration.postfederationsignup.ref.RefRequestBuilder;
import com.microsoft.graph.identity.b2xuserflows.item.apiconnectorconfiguration.postfederationsignup.uploadclientcertificate.UploadClientCertificateRequestBuilder;
...
public class PostFederationSignupRequestBuilder extends BaseRequestBuilder {
    ...
    public PostFederationSignupRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/apiConnectorConfiguration/postFederationSignup{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PostFederationSignupRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public PostFederationSignupRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/apiConnectorConfiguration/postFederationSignup{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final IdentityApiConnector body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final IdentityApiConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
