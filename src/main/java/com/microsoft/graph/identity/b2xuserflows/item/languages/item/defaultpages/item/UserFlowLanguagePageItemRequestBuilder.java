...
public class UserFlowLanguagePageItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final UserFlowLanguagePage body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserFlowLanguagePage> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserFlowLanguagePage> executionException = new java.util.concurrent.CompletableFuture<UserFlowLanguagePage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
