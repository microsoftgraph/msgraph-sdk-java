...
public class UserFlowLanguageConfigurationItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final UserFlowLanguageConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserFlowLanguageConfiguration> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserFlowLanguageConfiguration> executionException = new java.util.concurrent.CompletableFuture<UserFlowLanguageConfiguration>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
