...
public class UploadClientCertificateRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a uploadClientCertificateRequestBody
     */
    @javax.annotation.Nonnull
    public static UploadClientCertificateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UploadClientCertificateRequestBody currentObject = this;
