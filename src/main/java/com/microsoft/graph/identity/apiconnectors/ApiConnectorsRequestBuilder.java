...
public class ApiConnectorsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IdentityApiConnectorCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityApiConnectorCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IdentityApiConnectorCollectionResponse>();
