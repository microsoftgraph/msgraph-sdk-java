...
public class UploadClientCertificateRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UploadClientCertificatePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IdentityApiConnector> post(@javax.annotation.Nonnull final UploadClientCertificatePostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityApiConnector> executionException = new java.util.concurrent.CompletableFuture<IdentityApiConnector>();
