...
public class UserFlowAttributesRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttributeCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/identityuserflowattribute-post?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<IdentityUserFlowAttribute> post(@javax.annotation.Nonnull final IdentityUserFlowAttribute body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final IdentityUserFlowAttribute body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final IdentityUserFlowAttribute body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
