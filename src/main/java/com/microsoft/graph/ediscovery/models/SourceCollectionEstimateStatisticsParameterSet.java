...
/**
 * The class for the Source Collection Estimate Statistics Parameter Set.
 */
public class SourceCollectionEstimateStatisticsParameterSet {

    /**
     * Instiaciates a new SourceCollectionEstimateStatisticsParameterSet
     */
     ...
     */
    protected SourceCollectionEstimateStatisticsParameterSet(@Nonnull final SourceCollectionEstimateStatisticsParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the SourceCollectionEstimateStatisticsParameterSet
     */
    public static final class SourceCollectionEstimateStatisticsParameterSetBuilder {
        /**
         * Instanciates a new SourceCollectionEstimateStatisticsParameterSetBuilder
         */
        @Nullable
