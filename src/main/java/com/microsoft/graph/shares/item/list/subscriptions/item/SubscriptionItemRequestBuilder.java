package microsoft.graph.shares.item.list.subscriptions.item;
...
import microsoft.graph.shares.item.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
