...
import com.microsoft.graph.shares.item.list.items.item.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
...
import com.microsoft.graph.shares.item.list.items.item.versions.item.ListItemVersionItemRequestBuilder;
...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.items.item.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.items.item.versions.item collection
     * @param id Unique identifier of the item
