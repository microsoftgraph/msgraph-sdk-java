package com.microsoft.graph.shares.item.list.items.item.createdbyuser;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.User;
import com.microsoft.graph.shares.item.list.items.item.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.shares.item.list.items.item.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class CreatedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public CreatedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/createdByUser{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CreatedByUserRequestBuilder and sets the default values.
    ...
    public CreatedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/createdByUser{?%24select,%24expand}", rawUrl);
    }
    /**
