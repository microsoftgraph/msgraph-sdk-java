package microsoft.graph.shares.item.list.items.item.driveitem;
...
import microsoft.graph.shares.item.list.items.item.driveitem.content.ContentRequestBuilder;
