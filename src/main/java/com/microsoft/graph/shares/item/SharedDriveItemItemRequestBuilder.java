...
public class SharedDriveItemItemRequestBuilder {
     ...
     * @return a CompletableFuture of sharedDriveItem
     */
    public java.util.concurrent.CompletableFuture<SharedDriveItem> patch(@javax.annotation.Nonnull final SharedDriveItem body, @javax.annotation.Nullable final java.util.function.Consumer<SharedDriveItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
