package com.microsoft.graph.sites.item.termstores.item.groups.item.sets.item.children.item.children.item.relations.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.termstore.Relation;
import com.microsoft.graph.sites.item.termstores.item.groups.item.sets.item.children.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.sites.item.termstores.item.groups.item.sets.item.children.item.children.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.sites.item.termstores.item.groups.item.sets.item.children.item.children.item.relations.item.toterm.ToTermRequestBuilder;
