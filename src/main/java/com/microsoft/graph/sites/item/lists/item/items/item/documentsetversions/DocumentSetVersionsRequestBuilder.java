package microsoft.graph.sites.item.lists.item.items.item.documentsetversions;
...
import microsoft.graph.sites.item.lists.item.items.item.documentsetversions.count.CountRequestBuilder;
...
public class DocumentSetVersionsRequestBuilder {
    ...
    public DocumentSetVersionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
