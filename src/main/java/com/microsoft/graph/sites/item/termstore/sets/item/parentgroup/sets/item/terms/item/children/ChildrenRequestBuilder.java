package microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children;
...
import microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.count.CountRequestBuilder;
