...
public class CopyToNotebookRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a copyToNotebookRequestBody
     */
    @javax.annotation.Nonnull
    public static CopyToNotebookRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CopyToNotebookRequestBody currentObject = this;
