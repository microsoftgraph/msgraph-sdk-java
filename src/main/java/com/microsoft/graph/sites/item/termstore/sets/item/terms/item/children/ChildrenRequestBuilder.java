package com.microsoft.graph.sites.item.termstore.sets.item.terms.item.children;
...
import com.microsoft.graph.sites.item.termstore.sets.item.terms.item.children.count.CountRequestBuilder;
