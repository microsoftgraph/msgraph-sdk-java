...
public class GetApplicableContentTypesForListWithListIdRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a GetApplicableContentTypesForListWithListIdGetResponse
     */
    ...
    public GetApplicableContentTypesForListWithListIdGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, GetApplicableContentTypesForListWithListIdGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function getApplicableContentTypesForList
