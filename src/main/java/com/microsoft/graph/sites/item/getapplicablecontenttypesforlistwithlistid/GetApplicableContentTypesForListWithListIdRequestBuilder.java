...
public class GetApplicableContentTypesForListWithListIdRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetApplicableContentTypesForListWithListIdResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetApplicableContentTypesForListWithListIdResponse> executionException = new java.util.concurrent.CompletableFuture<GetApplicableContentTypesForListWithListIdResponse>();
