package microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.children.item;
...
import microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.ChildrenRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStore.sets.item.parentGroup.sets.item.children.item.children.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStore.sets.item.parentGroup.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
