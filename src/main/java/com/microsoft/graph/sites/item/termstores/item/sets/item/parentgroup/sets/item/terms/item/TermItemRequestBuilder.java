package microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item;
...
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.ChildrenRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.relations.RelationsRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStores.item.sets.item.parentGroup.sets.item.terms.item.children.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStores.item.sets.item.parentGroup.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
