package com.microsoft.graph.sites.item.onenote.notebooks.item.copynotebook;
...
public class CopyNotebookPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("notebookFolder", (n) -> { currentObject.setNotebookFolder(n.getStringValue()); });
        deserializerMap.put("renameAs", (n) -> { currentObject.setRenameAs(n.getStringValue()); });
        deserializerMap.put("siteCollectionId", (n) -> { currentObject.setSiteCollectionId(n.getStringValue()); });
