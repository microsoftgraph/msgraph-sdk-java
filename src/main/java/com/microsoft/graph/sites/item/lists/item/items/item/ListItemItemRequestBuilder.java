...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.lists.item.items.item.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.lists.item.items.item.versions.item collection
     * @param id Unique identifier of the item
