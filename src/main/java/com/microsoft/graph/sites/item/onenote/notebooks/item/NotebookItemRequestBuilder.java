package com.microsoft.graph.sites.item.onenote.notebooks.item;

import com.microsoft.graph.models.Notebook;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.sites.item.onenote.notebooks.item.copynotebook.CopyNotebookRequestBuilder;
import com.microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import com.microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.sites.item.onenote.notebooks.item.sections.item.OnenoteSectionItemRequestBuilder;
import com.microsoft.graph.sites.item.onenote.notebooks.item.sections.SectionsRequestBuilder;
...
public class NotebookItemRequestBuilder {
     ...
     * @return a CompletableFuture of notebook
     */
    public java.util.concurrent.CompletableFuture<Notebook> patch(@javax.annotation.Nonnull final Notebook body, @javax.annotation.Nullable final java.util.function.Consumer<NotebookItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of notebook
     */
    public java.util.concurrent.CompletableFuture<Notebook> patch(@javax.annotation.Nonnull final Notebook body, @javax.annotation.Nullable final java.util.function.Consumer<NotebookItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
