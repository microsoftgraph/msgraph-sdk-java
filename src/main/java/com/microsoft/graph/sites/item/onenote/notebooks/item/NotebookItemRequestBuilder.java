package microsoft.graph.sites.item.onenote.notebooks.item;
...
import microsoft.graph.sites.item.onenote.notebooks.item.copynotebook.CopyNotebookRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.SectionsRequestBuilder;
...
public class NotebookItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
