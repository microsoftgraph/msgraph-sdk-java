package microsoft.graph.sites.item.termstores.item.sets.item.terms.item;
...
import microsoft.graph.sites.item.termstores.item.sets.item.terms.item.children.ChildrenRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.terms.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.terms.item.relations.RelationsRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.terms.item.set.SetRequestBuilder;
