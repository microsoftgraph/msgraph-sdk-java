package com.microsoft.graph.sites.item.termstore.sets.item.terms;
...
import com.microsoft.graph.sites.item.termstore.sets.item.terms.count.CountRequestBuilder;
