package microsoft.graph.sites.item.termstore;
...
import microsoft.graph.sites.item.termstore.groups.GroupsRequestBuilder;
import microsoft.graph.sites.item.termstore.groups.item.GroupItemRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.item.SetItemRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.SetsRequestBuilder;
