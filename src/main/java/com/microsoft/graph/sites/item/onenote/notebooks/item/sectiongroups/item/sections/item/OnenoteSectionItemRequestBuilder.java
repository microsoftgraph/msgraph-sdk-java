package microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item;
...
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
...
public class OnenoteSectionItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item.pages.item collection
