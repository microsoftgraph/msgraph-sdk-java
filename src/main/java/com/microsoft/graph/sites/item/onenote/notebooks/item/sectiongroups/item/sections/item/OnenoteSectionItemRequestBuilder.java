package com.microsoft.graph.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item;
...
public class OnenoteSectionItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item.pages.item collection
