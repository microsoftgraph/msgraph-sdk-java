...
public class ItemsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<BaseItemCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<BaseItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BaseItemCollectionResponse>();
