...
public class ItemsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<BaseItemCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BaseItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BaseItemCollectionResponse>();
