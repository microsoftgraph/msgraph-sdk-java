package microsoft.graph.sites.item.onenote.notebooks.item.sections;
...
import microsoft.graph.sites.item.onenote.notebooks.item.sections.count.CountRequestBuilder;
