package microsoft.graph.sites.item.termstores.item.groups.item;
...
public class GroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStores.item.groups.item.sets.item collection
