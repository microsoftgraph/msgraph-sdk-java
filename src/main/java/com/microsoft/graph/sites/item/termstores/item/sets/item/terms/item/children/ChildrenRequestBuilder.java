package com.microsoft.graph.sites.item.termstores.item.sets.item.terms.item.children;
...
import com.microsoft.graph.sites.item.termstores.item.sets.item.terms.item.children.count.CountRequestBuilder;
