package microsoft.graph.sites.item.onenote.notebooks.item.sections.item;
...
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
