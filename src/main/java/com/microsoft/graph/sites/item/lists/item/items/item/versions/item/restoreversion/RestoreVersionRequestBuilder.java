...
public class RestoreVersionRequestBuilder extends BaseRequestBuilder {
    ...
    public RestoreVersionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}/restoreVersion", pathParameters);
    }
    /**
     * Instantiates a new RestoreVersionRequestBuilder and sets the default values.
    ...
    public RestoreVersionRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}/restoreVersion", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/listitemversion-restore?view=graph-rest-1.0">Find more info here</a>
     */
