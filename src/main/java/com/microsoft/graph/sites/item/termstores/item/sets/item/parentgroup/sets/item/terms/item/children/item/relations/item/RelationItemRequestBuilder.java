package microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item;
...
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.toterm.ToTermRequestBuilder;
