package com.microsoft.graph.sites.item.termstores.item.sets.item.children.item.relations.item.toterm;
...
public class ToTermRequestBuilder extends BaseRequestBuilder {
    ...
    public ToTermRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ToTermRequestBuilder and sets the default values.
    ...
    public ToTermRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", rawUrl);
    }
    /**
