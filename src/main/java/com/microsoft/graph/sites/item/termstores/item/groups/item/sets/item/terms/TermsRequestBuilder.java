package microsoft.graph.sites.item.termstores.item.groups.item.sets.item.terms;
...
import microsoft.graph.sites.item.termstores.item.groups.item.sets.item.terms.count.CountRequestBuilder;
