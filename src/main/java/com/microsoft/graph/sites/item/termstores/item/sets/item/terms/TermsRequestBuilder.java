package com.microsoft.graph.sites.item.termstores.item.sets.item.terms;
...
import com.microsoft.graph.sites.item.termstores.item.sets.item.terms.count.CountRequestBuilder;
