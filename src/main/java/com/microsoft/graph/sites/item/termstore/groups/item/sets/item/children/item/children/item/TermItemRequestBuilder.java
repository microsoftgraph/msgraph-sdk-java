package microsoft.graph.sites.item.termstore.groups.item.sets.item.children.item.children.item;
...
import microsoft.graph.sites.item.termstore.groups.item.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.sites.item.termstore.groups.item.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.sites.item.termstore.groups.item.sets.item.children.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStore.groups.item.sets.item.children.item.children.item.relations.item collection
