package com.microsoft.graph.sites.item.termstores.item.sets.item.children;
...
import com.microsoft.graph.sites.item.termstores.item.sets.item.children.count.CountRequestBuilder;
