package com.microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.termstore.Term;
import com.microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
import com.microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.termStores.item.sets.item.parentGroup.sets.item.terms.item.children.item.relations.item collection
