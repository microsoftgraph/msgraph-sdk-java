package microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.children.item;
...
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.children.item.children.ChildrenRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.children.item.set.SetRequestBuilder;
