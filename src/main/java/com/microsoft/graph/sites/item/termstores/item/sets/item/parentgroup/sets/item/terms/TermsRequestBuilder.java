package microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms;
...
import microsoft.graph.sites.item.termstores.item.sets.item.parentgroup.sets.item.terms.count.CountRequestBuilder;
