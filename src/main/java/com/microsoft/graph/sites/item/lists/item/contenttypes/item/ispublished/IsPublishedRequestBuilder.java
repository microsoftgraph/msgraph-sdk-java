...
public class IsPublishedRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of IsPublishedGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<IsPublishedGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function isPublished
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<IsPublishedGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, IsPublishedGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function isPublished
