package microsoft.graph.sites.item.contenttypes;
...
import microsoft.graph.sites.item.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.sites.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.sites.item.contenttypes.count.CountRequestBuilder;
import microsoft.graph.sites.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
