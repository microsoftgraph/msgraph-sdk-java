package microsoft.graph.sites.item.termstore.groups.item.sets.item.terms;
...
import microsoft.graph.sites.item.termstore.groups.item.sets.item.terms.count.CountRequestBuilder;
