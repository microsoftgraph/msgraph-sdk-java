package microsoft.graph.sites.item.termstore.sets.item.terms.item.children.item;
...
import microsoft.graph.sites.item.termstore.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.sites.item.termstore.sets.item.terms.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.termStore.sets.item.terms.item.children.item.relations.item collection
