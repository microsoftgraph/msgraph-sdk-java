...
public class SetItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.termStores.item.sets.item.children.item collection
     * @param id Unique identifier of the item
     * @return a TermItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.sites.item.termstores.item.sets.item.children.item.TermItemRequestBuilder children(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("term%2Did", id);
        return new com.microsoft.graph.sites.item.termstores.item.sets.item.children.item.TermItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.termStores.item.sets.item.relations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.termStores.item.sets.item.terms.item collection
     * @param id Unique identifier of the item
     * @return a TermItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.sites.item.termstores.item.sets.item.terms.item.TermItemRequestBuilder terms(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("term%2Did", id);
        return new com.microsoft.graph.sites.item.termstores.item.sets.item.terms.item.TermItemRequestBuilder(urlTplParams, requestAdapter);
    }
