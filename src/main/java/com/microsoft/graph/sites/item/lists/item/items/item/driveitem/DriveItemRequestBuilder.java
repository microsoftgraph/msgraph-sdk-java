package microsoft.graph.sites.item.lists.item.items.item.driveitem;
...
import microsoft.graph.sites.item.lists.item.items.item.driveitem.content.ContentRequestBuilder;
