...
public class RemoveRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a removeRequestBody
     */
    @javax.annotation.Nonnull
    public static RemoveRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveRequestBody currentObject = this;
