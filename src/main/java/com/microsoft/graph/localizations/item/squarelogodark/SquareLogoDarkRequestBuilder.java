package com.microsoft.graph.localizations.item.squarelogodark;
...
public class SquareLogoDarkRequestBuilder extends BaseRequestBuilder {
    ...
    public SquareLogoDarkRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", pathParameters);
    }
    /**
     * Instantiates a new SquareLogoDarkRequestBuilder and sets the default values.
    ...
    public SquareLogoDarkRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", rawUrl);
    }
    /**
