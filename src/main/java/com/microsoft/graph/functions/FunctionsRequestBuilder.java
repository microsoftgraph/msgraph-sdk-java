...
public class FunctionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public AttributeMappingFunctionSchemaItemRequestBuilder byAttributeMappingFunctionSchemaId(@javax.annotation.Nonnull final String attributeMappingFunctionSchemaId) {
