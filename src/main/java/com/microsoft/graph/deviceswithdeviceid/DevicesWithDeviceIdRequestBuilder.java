...
public class DevicesWithDeviceIdRequestBuilder extends BaseRequestBuilder {
    ...
    public DevicesWithDeviceIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String deviceId) {
     ...
     */
    @javax.annotation.Nullable
    public DevicesWithDeviceIdRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
