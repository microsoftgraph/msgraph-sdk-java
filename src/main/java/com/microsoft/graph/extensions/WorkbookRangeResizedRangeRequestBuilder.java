...
public class WorkbookRangeResizedRangeRequestBuilder extends BaseWorkbookRangeResizedRangeRequestBuilder implements IWorkbookRangeResizedRangeRequestBuilder {
     ...
     */
    public WorkbookRangeResizedRangeRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final Integer deltaRows, final Integer deltaColumns) {
