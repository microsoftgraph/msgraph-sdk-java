...
public class WorkbookChartPointItemAtRequestBuilder extends BaseWorkbookChartPointItemAtRequestBuilder implements IWorkbookChartPointItemAtRequestBuilder {
     ...
     */
    public WorkbookChartPointItemAtRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final Integer index) {
