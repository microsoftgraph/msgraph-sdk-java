...
/**
 * The class for the Onenote Resource Stream Request.
 */
public class OnenoteResourceStreamRequest extends BaseOnenoteResourceStreamRequest implements IOnenoteResourceStreamRequest {
     ...
     */
    public OnenoteResourceStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
