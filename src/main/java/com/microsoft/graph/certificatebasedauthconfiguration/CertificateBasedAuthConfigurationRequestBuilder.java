...
public class CertificateBasedAuthConfigurationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CertificateBasedAuthConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration requestConfig = new CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CertificateBasedAuthConfiguration> post(@javax.annotation.Nonnull final CertificateBasedAuthConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
