package microsoft.graph.users.item.contactfolders.item.contacts.item.photo;
...
import microsoft.graph.users.item.contactfolders.item.contacts.item.photo.value.ContentRequestBuilder;
