package microsoft.graph.users.item.joinedteams.item.schedule;
...
import microsoft.graph.users.item.joinedteams.item.schedule.offershiftrequests.item.OfferShiftRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.offershiftrequests.OfferShiftRequestsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.openshiftchangerequests.item.OpenShiftChangeRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.openshiftchangerequests.OpenShiftChangeRequestsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.openshifts.item.OpenShiftItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.openshifts.OpenShiftsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.schedulinggroups.item.SchedulingGroupItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.schedulinggroups.SchedulingGroupsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.share.ShareRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.shifts.item.ShiftItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.shifts.ShiftsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.swapshiftschangerequests.item.SwapShiftsChangeRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.swapshiftschangerequests.SwapShiftsChangeRequestsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.timeoffreasons.item.TimeOffReasonItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.timeoffreasons.TimeOffReasonsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.timeoffrequests.item.TimeOffRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.timeoffrequests.TimeOffRequestsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.timesoff.item.TimeOffItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.schedule.timesoff.TimesOffRequestBuilder;
