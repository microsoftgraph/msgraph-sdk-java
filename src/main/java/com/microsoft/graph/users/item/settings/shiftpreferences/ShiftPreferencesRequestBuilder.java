...
public class ShiftPreferencesRequestBuilder {
     ...
     * @return a CompletableFuture of shiftPreferences
     */
    public java.util.concurrent.CompletableFuture<ShiftPreferences> patch(@javax.annotation.Nonnull final ShiftPreferences body, @javax.annotation.Nullable final java.util.function.Consumer<ShiftPreferencesRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
