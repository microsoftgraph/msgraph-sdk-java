package microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.replies.item;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedTeams.item.primaryChannel.messages.item.replies.item.hostedContents.item collection
