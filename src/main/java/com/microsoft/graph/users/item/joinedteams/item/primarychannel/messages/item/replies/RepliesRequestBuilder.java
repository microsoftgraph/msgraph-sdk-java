package microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.replies;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.replies.count.CountRequestBuilder;
