package microsoft.graph.users.item.joinedteams.item.channels.item.messages.item.replies;
...
import microsoft.graph.users.item.joinedteams.item.channels.item.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
