package microsoft.graph.users.item.joinedteams.item.primarychannel.tabs.item;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.tabs.item.teamsapp.TeamsAppRequestBuilder;
