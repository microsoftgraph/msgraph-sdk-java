...
public class CreateUploadSessionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public AttachmentInfo getAttachmentInfo() {
        return this.backingStore.get("attachmentInfo");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("attachmentInfo", (n) -> { this.setAttachmentInfo(n.getObjectValue(AttachmentInfo::createFromDiscriminatorValue)); });
     ...
     */
    public void setAttachmentInfo(@jakarta.annotation.Nullable final AttachmentInfo value) {
        this.backingStore.set("attachmentInfo", value);
    }
}
