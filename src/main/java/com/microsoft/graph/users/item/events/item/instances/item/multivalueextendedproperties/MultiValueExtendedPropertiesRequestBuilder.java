package microsoft.graph.users.item.events.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.events.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
