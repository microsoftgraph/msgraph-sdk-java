package microsoft.graph.users.item.mailfolders.item.messages.item.calendarsharingmessage;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.users.item.mailfolders.item.messages.item.calendarsharingmessage.accept.AcceptRequestBuilder;
