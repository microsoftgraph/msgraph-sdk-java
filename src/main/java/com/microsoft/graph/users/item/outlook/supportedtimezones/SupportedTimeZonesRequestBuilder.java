...
public class SupportedTimeZonesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SupportedTimeZonesResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SupportedTimeZonesResponse> executionException = new java.util.concurrent.CompletableFuture<SupportedTimeZonesResponse>();
