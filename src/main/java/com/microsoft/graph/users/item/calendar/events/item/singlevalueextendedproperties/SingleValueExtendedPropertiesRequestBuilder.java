package microsoft.graph.users.item.calendar.events.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendar.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
