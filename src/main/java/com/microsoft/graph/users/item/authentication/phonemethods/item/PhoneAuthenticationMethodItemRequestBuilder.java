...
public class PhoneAuthenticationMethodItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PhoneAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PhoneAuthenticationMethod> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PhoneAuthenticationMethod> executionException = new java.util.concurrent.CompletableFuture<PhoneAuthenticationMethod>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
