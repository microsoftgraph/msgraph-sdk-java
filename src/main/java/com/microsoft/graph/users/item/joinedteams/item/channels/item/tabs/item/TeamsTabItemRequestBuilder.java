package microsoft.graph.users.item.joinedteams.item.channels.item.tabs.item;
...
import microsoft.graph.users.item.joinedteams.item.channels.item.tabs.item.teamsapp.TeamsAppRequestBuilder;
