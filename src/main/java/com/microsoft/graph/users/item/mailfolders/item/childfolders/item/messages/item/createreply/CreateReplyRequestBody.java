package microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.createreply;
...
public class CreateReplyRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createReplyRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateReplyRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateReplyRequestBody currentObject = this;
