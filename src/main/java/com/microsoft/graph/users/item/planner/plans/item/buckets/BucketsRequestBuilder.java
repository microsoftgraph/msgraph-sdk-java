...
public class BucketsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PlannerBucket body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PlannerBucketCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlannerBucketCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PlannerBucketCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<PlannerBucket> post(@javax.annotation.Nonnull final PlannerBucket body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlannerBucket> executionException = new java.util.concurrent.CompletableFuture<PlannerBucket>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
