package microsoft.graph.users.item.createdobjects;
...
import microsoft.graph.users.item.createdobjects.count.CountRequestBuilder;
import microsoft.graph.users.item.createdobjects.serviceprincipal.ServicePrincipalRequestBuilder;
