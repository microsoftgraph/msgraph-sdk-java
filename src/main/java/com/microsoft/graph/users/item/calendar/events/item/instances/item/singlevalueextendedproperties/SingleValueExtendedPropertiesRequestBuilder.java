package microsoft.graph.users.item.calendar.events.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendar.events.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
