package microsoft.graph.users.item.contactfolders.item.contacts.item.extensions;
...
import microsoft.graph.users.item.contactfolders.item.contacts.item.extensions.count.CountRequestBuilder;
