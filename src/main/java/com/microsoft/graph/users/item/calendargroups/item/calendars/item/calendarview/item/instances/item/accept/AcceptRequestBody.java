...
public class AcceptRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a acceptRequestBody
     */
    @javax.annotation.Nonnull
    public static AcceptRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AcceptRequestBody currentObject = this;
