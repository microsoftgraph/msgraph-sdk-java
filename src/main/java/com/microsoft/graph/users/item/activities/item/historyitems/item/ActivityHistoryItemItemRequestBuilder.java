package microsoft.graph.users.item.activities.item.historyitems.item;
...
import microsoft.graph.users.item.activities.item.historyitems.item.activity.ActivityRequestBuilder;
