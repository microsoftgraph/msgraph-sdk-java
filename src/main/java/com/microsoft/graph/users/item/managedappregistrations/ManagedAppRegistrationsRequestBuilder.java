...
public class ManagedAppRegistrationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ManagedAppRegistrationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedAppRegistrationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedAppRegistrationCollectionResponse>();
