package microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
