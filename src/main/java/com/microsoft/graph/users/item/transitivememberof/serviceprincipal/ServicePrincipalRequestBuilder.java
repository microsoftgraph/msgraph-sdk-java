package microsoft.graph.users.item.transitivememberof.serviceprincipal;
...
import microsoft.graph.users.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
