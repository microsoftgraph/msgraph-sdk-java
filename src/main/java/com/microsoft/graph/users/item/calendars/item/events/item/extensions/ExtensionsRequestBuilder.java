package microsoft.graph.users.item.calendars.item.events.item.extensions;
...
import microsoft.graph.users.item.calendars.item.events.item.extensions.count.CountRequestBuilder;
