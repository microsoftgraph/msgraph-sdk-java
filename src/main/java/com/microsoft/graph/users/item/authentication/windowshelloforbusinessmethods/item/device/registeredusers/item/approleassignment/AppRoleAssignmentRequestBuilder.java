package com.microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.approleassignment;
...
public class AppRoleAssignmentRequestBuilder {
    ...
    public AppRoleAssignmentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}/microsoft.graph.appRoleAssignment{?%24select,%24expand}";
    ...
    public java.util.concurrent.CompletableFuture<AppRoleAssignment> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppRoleAssignment> executionException = new java.util.concurrent.CompletableFuture<AppRoleAssignment>();
