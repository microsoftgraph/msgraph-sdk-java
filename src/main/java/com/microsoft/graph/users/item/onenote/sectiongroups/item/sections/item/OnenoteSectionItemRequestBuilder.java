package microsoft.graph.users.item.onenote.sectiongroups.item.sections.item;
...
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
