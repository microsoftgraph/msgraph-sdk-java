package microsoft.graph.users.item.mailfolders.item.childfolders.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.childfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
