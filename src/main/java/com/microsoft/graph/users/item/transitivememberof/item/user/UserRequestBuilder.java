package microsoft.graph.users.item.transitivememberof.item.user;
...
import microsoft.graph.users.item.transitivememberof.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
