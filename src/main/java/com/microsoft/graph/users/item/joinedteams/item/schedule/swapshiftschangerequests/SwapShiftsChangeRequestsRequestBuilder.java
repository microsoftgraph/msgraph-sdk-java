package microsoft.graph.users.item.joinedteams.item.schedule.swapshiftschangerequests;
...
import microsoft.graph.users.item.joinedteams.item.schedule.swapshiftschangerequests.count.CountRequestBuilder;
...
public class SwapShiftsChangeRequestsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration requestConfig = new SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SwapShiftsChangeRequest body, @javax.annotation.Nullable final java.util.function.Consumer<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration requestConfig = new SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<SwapShiftsChangeRequestCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SwapShiftsChangeRequestCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<SwapShiftsChangeRequestCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SwapShiftsChangeRequestCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of swapShiftsChangeRequest
     */
    public java.util.concurrent.CompletableFuture<SwapShiftsChangeRequest> post(@javax.annotation.Nonnull final SwapShiftsChangeRequest body, @javax.annotation.Nullable final java.util.function.Consumer<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
