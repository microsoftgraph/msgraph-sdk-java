package microsoft.graph.users.item.calendargroups.item.calendars.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.multivalueextendedproperties.count.CountRequestBuilder;
