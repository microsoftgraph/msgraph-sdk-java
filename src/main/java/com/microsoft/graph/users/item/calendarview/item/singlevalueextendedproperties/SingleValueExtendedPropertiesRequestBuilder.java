package microsoft.graph.users.item.calendarview.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendarview.item.singlevalueextendedproperties.count.CountRequestBuilder;
