package microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.registeredusers;
...
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.registeredusers.approleassignment.AppRoleAssignmentRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.registeredusers.count.CountRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.registeredusers.endpoint.EndpointRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.registeredusers.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.registeredusers.user.UserRequestBuilder;
