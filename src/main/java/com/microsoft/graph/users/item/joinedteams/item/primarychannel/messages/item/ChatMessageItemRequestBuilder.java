package microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.item.replies.RepliesRequestBuilder;
