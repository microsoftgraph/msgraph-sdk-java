...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.joinedTeams.item.primaryChannel.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.joinedTeams.item.primaryChannel.messages.item.replies.item collection
     * @param id Unique identifier of the item
