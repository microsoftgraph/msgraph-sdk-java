package microsoft.graph.users.item.onenote.sectiongroups.item.sections;
...
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.count.CountRequestBuilder;
