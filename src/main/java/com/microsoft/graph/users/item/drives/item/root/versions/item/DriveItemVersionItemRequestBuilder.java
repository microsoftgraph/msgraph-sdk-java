package microsoft.graph.users.item.drives.item.root.versions.item;
...
import microsoft.graph.users.item.drives.item.root.versions.item.content.ContentRequestBuilder;
import microsoft.graph.users.item.drives.item.root.versions.item.restoreversion.RestoreVersionRequestBuilder;
