...
public class DriveItemVersionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DriveItemVersion body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DriveItemVersion> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DriveItemVersion> executionException = new java.util.concurrent.CompletableFuture<DriveItemVersion>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
