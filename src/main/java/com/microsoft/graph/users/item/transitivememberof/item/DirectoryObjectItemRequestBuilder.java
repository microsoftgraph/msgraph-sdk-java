package microsoft.graph.users.item.transitivememberof.item;
...
import microsoft.graph.users.item.transitivememberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.device.DeviceRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.group.GroupRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.UserRequestBuilder;
