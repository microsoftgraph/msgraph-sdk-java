package microsoft.graph.users.item.calendar.calendarview.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendar.calendarview.item.singlevalueextendedproperties.count.CountRequestBuilder;
