package microsoft.graph.users.item.devicemanagementtroubleshootingevents.item;
...
public class DeviceManagementTroubleshootingEventItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DeviceManagementTroubleshootingEvent body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DeviceManagementTroubleshootingEvent body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementTroubleshootingEventItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
