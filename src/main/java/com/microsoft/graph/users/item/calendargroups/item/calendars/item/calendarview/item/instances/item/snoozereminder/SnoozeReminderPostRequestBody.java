package com.microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.instances.item.snoozereminder;
...
public class SnoozeReminderPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("newReminderTime", (n) -> { currentObject.setNewReminderTime(n.getObjectValue(DateTimeTimeZone::createFromDiscriminatorValue)); });
