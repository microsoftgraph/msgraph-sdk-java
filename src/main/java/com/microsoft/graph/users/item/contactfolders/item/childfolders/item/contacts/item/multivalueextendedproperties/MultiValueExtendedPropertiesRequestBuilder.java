package microsoft.graph.users.item.contactfolders.item.childfolders.item.contacts.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.childfolders.item.contacts.item.multivalueextendedproperties.count.CountRequestBuilder;
