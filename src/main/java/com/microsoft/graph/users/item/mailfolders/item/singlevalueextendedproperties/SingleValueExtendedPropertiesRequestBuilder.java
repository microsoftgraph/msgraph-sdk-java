package com.microsoft.graph.users.item.mailfolders.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.mailfolders.item.singlevalueextendedproperties.count.CountRequestBuilder;
