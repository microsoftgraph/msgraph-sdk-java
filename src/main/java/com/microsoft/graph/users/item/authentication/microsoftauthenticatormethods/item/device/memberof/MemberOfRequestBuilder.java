package microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof;
...
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.count.CountRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.user.UserRequestBuilder;
