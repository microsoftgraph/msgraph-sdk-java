package microsoft.graph.users.item.directreports;
...
import microsoft.graph.users.item.directreports.count.CountRequestBuilder;
import microsoft.graph.users.item.directreports.orgcontact.OrgContactRequestBuilder;
