package microsoft.graph.users.item.mailfolders.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
