package com.microsoft.graph.users.item.calendar.calendarview.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.calendar.calendarview.item.multivalueextendedproperties.count.CountRequestBuilder;
