package microsoft.graph.users.item.joinedteams.item.primarychannel.messages;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.count.CountRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.primarychannel.messages.delta.DeltaRequestBuilder;
