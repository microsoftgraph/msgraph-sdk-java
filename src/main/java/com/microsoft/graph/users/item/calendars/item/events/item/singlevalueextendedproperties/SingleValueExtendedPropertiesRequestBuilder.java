package microsoft.graph.users.item.calendars.item.events.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendars.item.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
