...
public class CalendarPermissionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CalendarPermission body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CalendarPermissionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CalendarPermissionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CalendarPermissionCollectionResponse>();
