package microsoft.graph.users.item.calendar.calendarview.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendar.calendarview.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
