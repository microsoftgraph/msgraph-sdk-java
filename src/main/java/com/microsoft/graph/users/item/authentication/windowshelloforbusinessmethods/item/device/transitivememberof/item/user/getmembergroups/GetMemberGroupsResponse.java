package microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.transitivememberof.item.user.getmembergroups;
...
public class GetMemberGroupsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static GetMemberGroupsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMemberGroupsResponse currentObject = this;
