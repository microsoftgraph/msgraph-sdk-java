...
public class ServicePrincipalRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ServicePrincipalCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ServicePrincipalCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ServicePrincipalCollectionResponse>();
