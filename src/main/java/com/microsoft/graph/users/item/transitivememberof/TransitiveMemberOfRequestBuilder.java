package microsoft.graph.users.item.transitivememberof;
...
import microsoft.graph.users.item.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.users.item.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.transitivememberof.user.UserRequestBuilder;
