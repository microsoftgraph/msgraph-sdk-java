package microsoft.graph.users.item.joinedteams.item.allchannels;
...
import microsoft.graph.users.item.joinedteams.item.allchannels.count.CountRequestBuilder;
