package microsoft.graph.users.item.mailfolders;
...
import microsoft.graph.users.item.mailfolders.count.CountRequestBuilder;
import microsoft.graph.users.item.mailfolders.delta.DeltaRequestBuilder;
