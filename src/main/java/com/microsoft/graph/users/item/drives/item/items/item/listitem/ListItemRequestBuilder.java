package com.microsoft.graph.users.item.drives.item.items.item.listitem;

import com.microsoft.graph.models.ListItem;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.driveitem.DriveItemRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.fields.FieldsRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.items.item.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.items.item.listItem.versions.item collection
     * @param id Unique identifier of the item
