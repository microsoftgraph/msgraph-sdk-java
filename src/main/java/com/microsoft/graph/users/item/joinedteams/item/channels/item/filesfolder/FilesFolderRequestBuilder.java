package microsoft.graph.users.item.joinedteams.item.channels.item.filesfolder;
...
import microsoft.graph.users.item.joinedteams.item.channels.item.filesfolder.content.ContentRequestBuilder;
