package microsoft.graph.users.item.events.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.events.item.multivalueextendedproperties.count.CountRequestBuilder;
