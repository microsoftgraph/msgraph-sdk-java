package microsoft.graph.users.item.calendar.events.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendar.events.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
