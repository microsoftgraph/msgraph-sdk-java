package com.microsoft.graph.users.item.calendar.events.item.instances.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.calendar.events.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
