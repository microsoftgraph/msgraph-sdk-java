package microsoft.graph.users.item.calendar.events.item.instances.item.extensions;
...
import microsoft.graph.users.item.calendar.events.item.instances.item.extensions.count.CountRequestBuilder;
