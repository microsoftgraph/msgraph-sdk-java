...
public class SharedWithChannelTeamInfoItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SharedWithChannelTeamInfo body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SharedWithChannelTeamInfo> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SharedWithChannelTeamInfo> executionException = new java.util.concurrent.CompletableFuture<SharedWithChannelTeamInfo>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
