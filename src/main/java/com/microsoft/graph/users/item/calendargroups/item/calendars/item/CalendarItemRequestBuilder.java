package microsoft.graph.users.item.calendargroups.item.calendars.item;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.allowedcalendarsharingroleswithuser.AllowedCalendarSharingRolesWithUserRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarpermissions.CalendarPermissionsRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarpermissions.item.CalendarPermissionItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.CalendarViewRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.EventsRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.getschedule.GetScheduleRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
