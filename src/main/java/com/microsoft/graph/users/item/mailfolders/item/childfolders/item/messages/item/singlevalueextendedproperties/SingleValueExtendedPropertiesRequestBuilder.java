package microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.singlevalueextendedproperties.count.CountRequestBuilder;
