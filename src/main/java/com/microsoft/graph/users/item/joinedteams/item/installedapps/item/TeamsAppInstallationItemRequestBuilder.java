package microsoft.graph.users.item.joinedteams.item.installedapps.item;
...
import microsoft.graph.users.item.joinedteams.item.installedapps.item.teamsapp.TeamsAppRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.installedapps.item.teamsappdefinition.TeamsAppDefinitionRequestBuilder;
import microsoft.graph.users.item.joinedteams.item.installedapps.item.upgrade.UpgradeRequestBuilder;
