package microsoft.graph.users.item.joinedteams.item.primarychannel.tabs;
...
import microsoft.graph.models.TeamsTabCollectionResponse;
import microsoft.graph.users.item.joinedteams.item.primarychannel.tabs.count.CountRequestBuilder;
...
public class TabsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TeamsTabCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TeamsTabCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TeamsTabCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<TeamsTabCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TabsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TeamsTabCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of teamsTab
     */
    public java.util.concurrent.CompletableFuture<TeamsTab> post(@javax.annotation.Nonnull final TeamsTab body, @javax.annotation.Nullable final java.util.function.Consumer<TabsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
