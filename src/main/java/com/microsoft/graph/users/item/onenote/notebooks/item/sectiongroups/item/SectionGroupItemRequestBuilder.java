package com.microsoft.graph.users.item.onenote.notebooks.item.sectiongroups.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.SectionGroup;
import com.microsoft.graph.users.item.onenote.notebooks.item.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.users.item.onenote.notebooks.item.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import com.microsoft.graph.users.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
...
import com.microsoft.graph.users.item.onenote.notebooks.item.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
