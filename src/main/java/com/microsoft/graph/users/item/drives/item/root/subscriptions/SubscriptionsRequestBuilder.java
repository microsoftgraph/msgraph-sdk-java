package microsoft.graph.users.item.drives.item.root.subscriptions;
...
import microsoft.graph.users.item.drives.item.root.subscriptions.count.CountRequestBuilder;
