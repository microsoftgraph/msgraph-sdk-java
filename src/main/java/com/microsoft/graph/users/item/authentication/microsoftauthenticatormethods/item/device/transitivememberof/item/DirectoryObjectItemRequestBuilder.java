package microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item;
...
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.device.DeviceRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.group.GroupRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.UserRequestBuilder;
