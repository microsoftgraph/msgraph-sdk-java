package com.microsoft.graph.users.item.drives.item.list.contenttypes.getcompatiblehubcontenttypes;
...
public class GetCompatibleHubContentTypesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetCompatibleHubContentTypesResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetCompatibleHubContentTypesResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<GetCompatibleHubContentTypesResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetCompatibleHubContentTypesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetCompatibleHubContentTypesResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public class GetCompatibleHubContentTypesRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public GetCompatibleHubContentTypesRequestBuilderGetQueryParameters queryParameters = new GetCompatibleHubContentTypesRequestBuilderGetQueryParameters();
        /**
