package microsoft.graph.users.item.calendarview.item.instances.item;
...
import microsoft.graph.users.item.calendarview.item.instances.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.calendarview.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarView.item.instances.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarView.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarView.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarView.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
