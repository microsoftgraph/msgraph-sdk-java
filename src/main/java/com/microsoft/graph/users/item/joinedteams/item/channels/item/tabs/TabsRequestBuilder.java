package microsoft.graph.users.item.joinedteams.item.channels.item.tabs;
...
import microsoft.graph.users.item.joinedteams.item.channels.item.tabs.count.CountRequestBuilder;
