...
import com.microsoft.graph.users.item.directreports.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.users.item.directreports.item.user.UserRequestBuilder;
