package microsoft.graph.users.item.todo.lists.item.tasks;
...
import microsoft.graph.models.TodoTaskCollectionResponse;
import microsoft.graph.users.item.todo.lists.item.tasks.count.CountRequestBuilder;
...
public class TasksRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TodoTask body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TodoTask body, @javax.annotation.Nullable final java.util.function.Consumer<TasksRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TodoTaskCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TodoTaskCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<TodoTaskCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TasksRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TodoTaskCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of todoTask
     */
    public java.util.concurrent.CompletableFuture<TodoTask> post(@javax.annotation.Nonnull final TodoTask body, @javax.annotation.Nullable final java.util.function.Consumer<TasksRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
