...
public class CreateReplyAllRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CreateReplyAllPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @return a CompletableFuture of message
     */
    public java.util.concurrent.CompletableFuture<Message> post(@javax.annotation.Nonnull final CreateReplyAllPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of message
     */
    public java.util.concurrent.CompletableFuture<Message> post(@javax.annotation.Nonnull final CreateReplyAllPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
