package microsoft.graph.users.item.contactfolders.item.contacts.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.contacts.item.multivalueextendedproperties.count.CountRequestBuilder;
