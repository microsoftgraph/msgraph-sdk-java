package microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
