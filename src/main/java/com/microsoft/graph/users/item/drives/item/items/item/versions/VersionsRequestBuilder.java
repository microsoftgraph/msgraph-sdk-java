...
public class VersionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DriveItemVersion body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DriveItemVersionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DriveItemVersionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DriveItemVersionCollectionResponse>();
