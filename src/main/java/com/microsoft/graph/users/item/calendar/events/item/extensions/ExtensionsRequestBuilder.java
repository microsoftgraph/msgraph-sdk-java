package microsoft.graph.users.item.calendar.events.item.extensions;
...
import microsoft.graph.users.item.calendar.events.item.extensions.count.CountRequestBuilder;
