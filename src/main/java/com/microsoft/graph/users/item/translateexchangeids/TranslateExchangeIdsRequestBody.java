package microsoft.graph.users.item.translateexchangeids;
...
public class TranslateExchangeIdsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a translateExchangeIdsRequestBody
     */
    @javax.annotation.Nonnull
    public static TranslateExchangeIdsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final TranslateExchangeIdsRequestBody currentObject = this;
