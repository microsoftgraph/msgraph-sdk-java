package microsoft.graph.users.item.transitivememberof.item.user.assignlicense;
...
public class AssignLicenseRequestBuilder {
    ...
    public AssignLicenseRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.assignLicense";
