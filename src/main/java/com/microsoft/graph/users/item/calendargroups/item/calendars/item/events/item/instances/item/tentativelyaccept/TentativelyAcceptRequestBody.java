...
public class TentativelyAcceptRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a tentativelyAcceptRequestBody
     */
    @javax.annotation.Nonnull
    public static TentativelyAcceptRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final TentativelyAcceptRequestBody currentObject = this;
