package microsoft.graph.users.item.mailfolders.item.messages.item.extensions;
...
import microsoft.graph.users.item.mailfolders.item.messages.item.extensions.count.CountRequestBuilder;
