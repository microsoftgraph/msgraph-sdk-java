package microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.instances.InstancesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.calendarview.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
