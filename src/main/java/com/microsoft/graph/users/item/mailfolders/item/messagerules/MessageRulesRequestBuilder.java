package microsoft.graph.users.item.mailfolders.item.messagerules;
...
import microsoft.graph.users.item.mailfolders.item.messagerules.count.CountRequestBuilder;
