...
public class TagsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TeamworkTag body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TeamworkTagCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TeamworkTagCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TeamworkTagCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TeamworkTag> post(@javax.annotation.Nonnull final TeamworkTag body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TeamworkTag> executionException = new java.util.concurrent.CompletableFuture<TeamworkTag>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
