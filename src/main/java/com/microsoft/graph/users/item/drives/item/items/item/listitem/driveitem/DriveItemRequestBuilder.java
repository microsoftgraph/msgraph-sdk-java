package microsoft.graph.users.item.drives.item.items.item.listitem.driveitem;
...
import microsoft.graph.users.item.drives.item.items.item.listitem.driveitem.content.ContentRequestBuilder;
