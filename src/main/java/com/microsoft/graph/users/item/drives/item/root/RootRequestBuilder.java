...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.children.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.versions.item collection
     * @param id Unique identifier of the item
