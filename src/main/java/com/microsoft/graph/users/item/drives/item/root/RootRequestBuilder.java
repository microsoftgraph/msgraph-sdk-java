package microsoft.graph.users.item.drives.item.root;
...
import microsoft.graph.users.item.drives.item.root.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.checkin.CheckinRequestBuilder;
import microsoft.graph.users.item.drives.item.root.checkout.CheckoutRequestBuilder;
import microsoft.graph.users.item.drives.item.root.children.ChildrenRequestBuilder;
import microsoft.graph.users.item.drives.item.root.children.item.DriveItemItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.content.ContentRequestBuilder;
import microsoft.graph.users.item.drives.item.root.copy.CopyRequestBuilder;
import microsoft.graph.users.item.drives.item.root.createlink.CreateLinkRequestBuilder;
import microsoft.graph.users.item.drives.item.root.createuploadsession.CreateUploadSessionRequestBuilder;
import microsoft.graph.users.item.drives.item.root.delta.DeltaRequestBuilder;
import microsoft.graph.users.item.drives.item.root.deltawithtoken.DeltaWithTokenRequestBuilder;
import microsoft.graph.users.item.drives.item.root.follow.FollowRequestBuilder;
import microsoft.graph.users.item.drives.item.root.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.users.item.drives.item.root.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.users.item.drives.item.root.invite.InviteRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.ListItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.permissions.item.PermissionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.permissions.PermissionsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.preview.PreviewRequestBuilder;
import microsoft.graph.users.item.drives.item.root.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.drives.item.root.searchwithq.SearchWithQRequestBuilder;
import microsoft.graph.users.item.drives.item.root.subscriptions.item.SubscriptionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.subscriptions.SubscriptionsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.thumbnails.item.ThumbnailSetItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.thumbnails.ThumbnailsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.unfollow.UnfollowRequestBuilder;
import microsoft.graph.users.item.drives.item.root.validatepermission.ValidatePermissionRequestBuilder;
import microsoft.graph.users.item.drives.item.root.versions.item.DriveItemVersionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.versions.VersionsRequestBuilder;
