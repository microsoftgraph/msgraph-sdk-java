package microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user;
...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
