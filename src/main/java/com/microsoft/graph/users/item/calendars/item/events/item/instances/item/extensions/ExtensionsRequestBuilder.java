package com.microsoft.graph.users.item.calendars.item.events.item.instances.item.extensions;

import com.microsoft.graph.models.Extension;
import com.microsoft.graph.models.ExtensionCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.calendars.item.events.item.instances.item.extensions.count.CountRequestBuilder;
