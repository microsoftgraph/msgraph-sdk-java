...
public class PlannerTaskItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PlannerTask body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PlannerTask> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlannerTask> executionException = new java.util.concurrent.CompletableFuture<PlannerTask>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
