package microsoft.graph.users.item.authentication.microsoftauthenticatormethods;
...
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.count.CountRequestBuilder;
