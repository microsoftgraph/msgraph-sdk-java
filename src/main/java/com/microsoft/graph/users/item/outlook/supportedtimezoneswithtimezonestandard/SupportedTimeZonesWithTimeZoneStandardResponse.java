package microsoft.graph.users.item.outlook.supportedtimezoneswithtimezonestandard;
...
import microsoft.graph.models.TimeZoneInformation;
/** Provides operations to call the supportedTimeZones method. */
public class SupportedTimeZonesWithTimeZoneStandardResponse implements AdditionalDataHolder, Parsable {
