package microsoft.graph.users.item.drives.item.root.subscriptions.item;
...
import microsoft.graph.users.item.drives.item.root.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
