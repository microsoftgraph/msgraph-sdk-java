package microsoft.graph.users.item.contactfolders.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.singlevalueextendedproperties.count.CountRequestBuilder;
