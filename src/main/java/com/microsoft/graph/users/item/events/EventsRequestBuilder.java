package microsoft.graph.users.item.events;
...
import microsoft.graph.users.item.events.count.CountRequestBuilder;
import microsoft.graph.users.item.events.delta.DeltaRequestBuilder;
