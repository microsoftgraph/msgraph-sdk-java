package microsoft.graph.users.item.joinedteams.item.primarychannel.filesfolder;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.filesfolder.content.ContentRequestBuilder;
