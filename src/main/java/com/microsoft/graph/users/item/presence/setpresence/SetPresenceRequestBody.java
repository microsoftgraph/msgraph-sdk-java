package microsoft.graph.users.item.presence.setpresence;
...
public class SetPresenceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a setPresenceRequestBody
     */
    @javax.annotation.Nonnull
    public static SetPresenceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SetPresenceRequestBody currentObject = this;
