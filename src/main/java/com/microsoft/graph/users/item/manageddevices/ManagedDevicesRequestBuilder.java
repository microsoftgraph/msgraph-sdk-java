...
public class ManagedDevicesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ManagedDevice body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedDeviceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedDeviceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagedDevice> post(@javax.annotation.Nonnull final ManagedDevice body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagedDevice> executionException = new java.util.concurrent.CompletableFuture<ManagedDevice>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
