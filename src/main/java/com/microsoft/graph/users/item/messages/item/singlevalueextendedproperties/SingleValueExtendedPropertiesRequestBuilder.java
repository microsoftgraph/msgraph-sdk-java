package com.microsoft.graph.users.item.messages.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.messages.item.singlevalueextendedproperties.count.CountRequestBuilder;
