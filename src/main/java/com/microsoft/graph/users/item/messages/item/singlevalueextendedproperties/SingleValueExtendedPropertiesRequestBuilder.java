package microsoft.graph.users.item.messages.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.messages.item.singlevalueextendedproperties.count.CountRequestBuilder;
