...
public class ReplyAllRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a replyAllRequestBody
     */
    @javax.annotation.Nonnull
    public static ReplyAllRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ReplyAllRequestBody currentObject = this;
