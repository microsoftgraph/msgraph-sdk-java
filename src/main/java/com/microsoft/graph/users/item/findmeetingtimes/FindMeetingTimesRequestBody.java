...
public class FindMeetingTimesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a findMeetingTimesRequestBody
     */
    @javax.annotation.Nonnull
    public static FindMeetingTimesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FindMeetingTimesRequestBody currentObject = this;
