package microsoft.graph.users.item.createdobjects.item;
...
import microsoft.graph.users.item.createdobjects.item.serviceprincipal.ServicePrincipalRequestBuilder;
