package microsoft.graph.users.item.contactfolders.item.contacts.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.contacts.item.singlevalueextendedproperties.count.CountRequestBuilder;
