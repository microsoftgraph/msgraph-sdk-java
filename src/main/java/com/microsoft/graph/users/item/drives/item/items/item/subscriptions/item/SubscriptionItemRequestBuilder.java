package microsoft.graph.users.item.drives.item.items.item.subscriptions.item;
...
import microsoft.graph.users.item.drives.item.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
