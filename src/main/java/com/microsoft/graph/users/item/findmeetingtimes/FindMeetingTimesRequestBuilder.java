...
public class FindMeetingTimesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final FindMeetingTimesPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MeetingTimeSuggestionsResult> post(@javax.annotation.Nonnull final FindMeetingTimesPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MeetingTimeSuggestionsResult> executionException = new java.util.concurrent.CompletableFuture<MeetingTimeSuggestionsResult>();
