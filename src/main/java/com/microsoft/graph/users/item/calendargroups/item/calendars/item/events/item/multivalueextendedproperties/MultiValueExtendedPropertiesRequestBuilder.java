package microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.multivalueextendedproperties.count.CountRequestBuilder;
