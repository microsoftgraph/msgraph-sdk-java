package microsoft.graph.users.item.manageddevices.item.devicecompliancepolicystates;
...
import microsoft.graph.models.DeviceCompliancePolicyStateCollectionResponse;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.users.item.manageddevices.item.devicecompliancepolicystates.count.CountRequestBuilder;
...
public class DeviceCompliancePolicyStatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicyStateCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceCompliancePolicyStateCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DeviceCompliancePolicyStateCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicyStateCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceCompliancePolicyStatesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceCompliancePolicyStateCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of deviceCompliancePolicyState
     */
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicyState> post(@javax.annotation.Nonnull final DeviceCompliancePolicyState body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceCompliancePolicyStatesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
