package microsoft.graph.users.item.mailfolders.item.childfolders.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.childfolders.item.singlevalueextendedproperties.count.CountRequestBuilder;
