...
public class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ReminderViewWithStartDateTimeWithEndDateTimeResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ReminderViewWithStartDateTimeWithEndDateTimeResponse> executionException = new java.util.concurrent.CompletableFuture<ReminderViewWithStartDateTimeWithEndDateTimeResponse>();
