package com.microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.serviceprincipal;
...
public class ServicePrincipalRequestBuilder {
    ...
    public ServicePrincipalRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
    ...
    public java.util.concurrent.CompletableFuture<ServicePrincipal> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ServicePrincipal> executionException = new java.util.concurrent.CompletableFuture<ServicePrincipal>();
