package microsoft.graph.users.item.calendars.item.events.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendars.item.events.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
