package microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof;
...
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.user.UserRequestBuilder;
