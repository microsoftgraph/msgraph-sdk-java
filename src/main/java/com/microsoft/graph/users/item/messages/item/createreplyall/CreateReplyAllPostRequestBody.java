package microsoft.graph.users.item.messages.item.createreplyall;
...
public class CreateReplyAllPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static CreateReplyAllPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
