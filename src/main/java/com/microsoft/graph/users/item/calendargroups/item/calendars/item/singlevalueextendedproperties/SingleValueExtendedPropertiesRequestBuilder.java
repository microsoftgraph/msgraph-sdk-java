package microsoft.graph.users.item.calendargroups.item.calendars.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.singlevalueextendedproperties.count.CountRequestBuilder;
