...
public class PeopleRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PersonCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PersonCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PersonCollectionResponse>();
