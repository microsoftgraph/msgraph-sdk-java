package microsoft.graph.users.item.insights.trending;
...
public class TrendingRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TrendingCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TrendingCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TrendingCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<TrendingCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TrendingRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TrendingCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of trending
     */
    public java.util.concurrent.CompletableFuture<Trending> post(@javax.annotation.Nonnull final Trending body, @javax.annotation.Nullable final java.util.function.Consumer<TrendingRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
