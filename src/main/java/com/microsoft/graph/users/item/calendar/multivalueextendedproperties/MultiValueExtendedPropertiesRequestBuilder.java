package microsoft.graph.users.item.calendar.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendar.multivalueextendedproperties.count.CountRequestBuilder;
