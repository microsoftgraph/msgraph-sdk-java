...
public class CalendarGroupsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CalendarGroup body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CalendarGroupCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CalendarGroupCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CalendarGroupCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CalendarGroup> post(@javax.annotation.Nonnull final CalendarGroup body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CalendarGroup> executionException = new java.util.concurrent.CompletableFuture<CalendarGroup>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
