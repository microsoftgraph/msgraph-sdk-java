package microsoft.graph.users.item.joinedteams.item.primarychannel.sharedwithteams.item.allowedmembers;
...
import microsoft.graph.users.item.joinedteams.item.primarychannel.sharedwithteams.item.allowedmembers.count.CountRequestBuilder;
