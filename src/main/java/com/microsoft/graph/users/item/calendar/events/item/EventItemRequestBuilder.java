...
import com.microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
...
import com.microsoft.graph.users.item.calendar.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
