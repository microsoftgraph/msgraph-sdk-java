package microsoft.graph.users.item.calendar.events.item;
...
import microsoft.graph.users.item.calendar.events.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.instances.InstancesRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.calendar.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
