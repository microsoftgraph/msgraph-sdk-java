package microsoft.graph.users.item.mailfolders.item.messages.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.messages.item.singlevalueextendedproperties.count.CountRequestBuilder;
