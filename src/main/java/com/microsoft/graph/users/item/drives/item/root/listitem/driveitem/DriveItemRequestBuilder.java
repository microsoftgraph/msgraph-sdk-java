package microsoft.graph.users.item.drives.item.root.listitem.driveitem;
...
import microsoft.graph.users.item.drives.item.root.listitem.driveitem.content.ContentRequestBuilder;
