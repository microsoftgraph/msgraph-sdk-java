package microsoft.graph.users.item.sendmail;
...
public class SendMailRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a sendMailRequestBody
     */
    @javax.annotation.Nonnull
    public static SendMailRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SendMailRequestBody currentObject = this;
