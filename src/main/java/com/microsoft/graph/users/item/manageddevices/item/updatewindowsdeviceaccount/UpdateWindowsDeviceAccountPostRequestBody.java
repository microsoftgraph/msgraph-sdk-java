...
public class UpdateWindowsDeviceAccountPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public UpdateWindowsDeviceAccountActionParameter getUpdateWindowsDeviceAccountActionParameter() {
        return this.backingStore.get("updateWindowsDeviceAccountActionParameter");
    }
    /**
    ...
    public void setUpdateWindowsDeviceAccountActionParameter(@jakarta.annotation.Nullable final UpdateWindowsDeviceAccountActionParameter value) {
        this.backingStore.set("updateWindowsDeviceAccountActionParameter", value);
    }
}
