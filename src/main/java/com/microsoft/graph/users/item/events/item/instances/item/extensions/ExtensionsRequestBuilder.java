package microsoft.graph.users.item.events.item.instances.item.extensions;
...
import microsoft.graph.users.item.events.item.instances.item.extensions.count.CountRequestBuilder;
