package microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.user.getmemberobjects;
...
public class GetMemberObjectsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static GetMemberObjectsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMemberObjectsResponse currentObject = this;
