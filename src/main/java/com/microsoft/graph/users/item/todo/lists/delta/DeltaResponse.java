package com.microsoft.graph.users.item.todo.lists.delta;
...
public class DeltaResponse extends BaseDeltaFunctionResponse implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(TodoTaskList::createFromDiscriminatorValue)); });
