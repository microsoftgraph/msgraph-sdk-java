package microsoft.graph.users.item.calendarview;
...
import microsoft.graph.users.item.calendarview.count.CountRequestBuilder;
import microsoft.graph.users.item.calendarview.delta.DeltaRequestBuilder;
