package microsoft.graph.users.item.createdobjects.serviceprincipal;
...
import microsoft.graph.users.item.createdobjects.serviceprincipal.count.CountRequestBuilder;
