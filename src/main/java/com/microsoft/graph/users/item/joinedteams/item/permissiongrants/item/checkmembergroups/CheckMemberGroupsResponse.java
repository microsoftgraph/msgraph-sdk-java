package com.microsoft.graph.users.item.joinedteams.item.permissiongrants.item.checkmembergroups;
...
public class CheckMemberGroupsResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static CheckMemberGroupsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
