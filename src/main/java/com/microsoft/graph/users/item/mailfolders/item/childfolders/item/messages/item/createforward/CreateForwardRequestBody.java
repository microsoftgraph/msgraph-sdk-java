...
public class CreateForwardRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createForwardRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateForwardRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateForwardRequestBody currentObject = this;
