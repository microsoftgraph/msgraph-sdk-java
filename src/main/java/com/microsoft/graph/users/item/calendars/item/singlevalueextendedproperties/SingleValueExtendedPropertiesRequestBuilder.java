package microsoft.graph.users.item.calendars.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendars.item.singlevalueextendedproperties.count.CountRequestBuilder;
