package microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
