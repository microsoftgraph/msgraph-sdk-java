package microsoft.graph.users.item.mailfolders.item.messages.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.messages.item.multivalueextendedproperties.count.CountRequestBuilder;
