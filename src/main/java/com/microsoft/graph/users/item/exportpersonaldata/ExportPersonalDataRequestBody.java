package microsoft.graph.users.item.exportpersonaldata;
...
public class ExportPersonalDataRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a exportPersonalDataRequestBody
     */
    @javax.annotation.Nonnull
    public static ExportPersonalDataRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExportPersonalDataRequestBody currentObject = this;
