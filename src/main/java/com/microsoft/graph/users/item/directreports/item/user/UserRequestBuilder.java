package microsoft.graph.users.item.directreports.item.user;
...
import microsoft.graph.users.item.directreports.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.users.item.directreports.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
