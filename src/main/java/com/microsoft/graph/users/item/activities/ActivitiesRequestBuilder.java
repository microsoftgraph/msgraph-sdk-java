package microsoft.graph.users.item.activities;
...
import microsoft.graph.users.item.activities.count.CountRequestBuilder;
import microsoft.graph.users.item.activities.recent.RecentRequestBuilder;
...
public class ActivitiesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserActivityCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserActivityCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of UserActivityCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<UserActivityCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserActivityCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<UserActivity> post(@javax.annotation.Nonnull final UserActivity body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserActivity::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of userActivity
     */
    public java.util.concurrent.CompletableFuture<UserActivity> post(@javax.annotation.Nonnull final UserActivity body, @javax.annotation.Nullable final java.util.function.Consumer<ActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserActivity::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
