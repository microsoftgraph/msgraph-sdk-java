...
public class ActivitiesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserActivity body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserActivityCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserActivityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserActivityCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserActivity> post(@javax.annotation.Nonnull final UserActivity body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserActivity> executionException = new java.util.concurrent.CompletableFuture<UserActivity>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
