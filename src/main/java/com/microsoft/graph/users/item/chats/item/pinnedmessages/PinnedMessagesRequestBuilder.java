...
public class PinnedMessagesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PinnedChatMessageInfo body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PinnedChatMessageInfoCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PinnedChatMessageInfoCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PinnedChatMessageInfoCollectionResponse>();
