...
public class DeclineRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeclinePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/event-decline?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
