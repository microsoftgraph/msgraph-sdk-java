package microsoft.graph.users.item.drives.item.list.subscriptions.item;
...
import microsoft.graph.users.item.drives.item.list.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
