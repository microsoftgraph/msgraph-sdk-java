package microsoft.graph.users.item.registereddevices.approleassignment;
...
import microsoft.graph.users.item.registereddevices.approleassignment.count.CountRequestBuilder;
