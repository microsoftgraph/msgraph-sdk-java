package microsoft.graph.users.item.ownedobjects.serviceprincipal;
...
import microsoft.graph.users.item.ownedobjects.serviceprincipal.count.CountRequestBuilder;
