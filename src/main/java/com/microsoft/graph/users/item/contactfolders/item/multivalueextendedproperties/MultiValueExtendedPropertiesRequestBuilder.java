package com.microsoft.graph.users.item.contactfolders.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.contactfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
