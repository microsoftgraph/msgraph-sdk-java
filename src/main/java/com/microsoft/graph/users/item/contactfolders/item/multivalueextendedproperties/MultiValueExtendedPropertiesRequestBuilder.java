package microsoft.graph.users.item.contactfolders.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
