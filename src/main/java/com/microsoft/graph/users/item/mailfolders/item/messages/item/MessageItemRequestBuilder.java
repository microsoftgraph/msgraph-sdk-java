package microsoft.graph.users.item.mailfolders.item.messages.item;
...
import microsoft.graph.users.item.mailfolders.item.messages.item.createreplyall.CreateReplyAllRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.move.MoveRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.reply.ReplyRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.replyall.ReplyAllRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.send.SendRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.value.ContentRequestBuilder;
