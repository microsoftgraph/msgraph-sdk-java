...
import com.microsoft.graph.users.item.joinedteams.item.permissiongrants.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.permissiongrants.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.permissiongrants.item.getmembergroups.GetMemberGroupsRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.permissiongrants.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import com.microsoft.graph.users.item.joinedteams.item.permissiongrants.item.restore.RestoreRequestBuilder;
