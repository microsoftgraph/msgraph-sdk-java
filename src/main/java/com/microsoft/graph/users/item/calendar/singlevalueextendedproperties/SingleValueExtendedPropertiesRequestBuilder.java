package microsoft.graph.users.item.calendar.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendar.singlevalueextendedproperties.count.CountRequestBuilder;
