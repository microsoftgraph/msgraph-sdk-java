package microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.item.extensions;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.item.extensions.count.CountRequestBuilder;
