...
public class GrantRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a grantRequestBody
     */
    @javax.annotation.Nonnull
    public static GrantRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GrantRequestBody currentObject = this;
