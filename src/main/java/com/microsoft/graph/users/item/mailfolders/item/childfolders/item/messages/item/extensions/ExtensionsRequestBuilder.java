package microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.extensions;
...
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.extensions.count.CountRequestBuilder;
