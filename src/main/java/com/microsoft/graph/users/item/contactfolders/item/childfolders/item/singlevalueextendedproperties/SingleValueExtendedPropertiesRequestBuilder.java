package microsoft.graph.users.item.contactfolders.item.childfolders.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.childfolders.item.singlevalueextendedproperties.count.CountRequestBuilder;
