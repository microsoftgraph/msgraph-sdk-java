package microsoft.graph.users.item.joinedteams.item.schedule.schedulinggroups;
...
import microsoft.graph.users.item.joinedteams.item.schedule.schedulinggroups.count.CountRequestBuilder;
