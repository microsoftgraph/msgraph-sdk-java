...
public class RemoveEmailRequestBuilder extends BaseRequestBuilder {
    ...
    public RemoveEmailRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/removeEmail", pathParameters);
    }
    /**
     * Instantiates a new RemoveEmailRequestBuilder and sets the default values.
    ...
    public RemoveEmailRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/removeEmail", rawUrl);
    }
    /**
