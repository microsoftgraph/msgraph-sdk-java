package microsoft.graph.users.item.memberof;
...
import microsoft.graph.users.item.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.memberof.count.CountRequestBuilder;
import microsoft.graph.users.item.memberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.memberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.memberof.user.UserRequestBuilder;
