...
import com.microsoft.graph.users.item.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.users.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.users.item.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.users.item.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.users.item.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.users.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.memberof.user.UserRequestBuilder;
