package microsoft.graph.users.item.drives.item.items.item.versions.item;
...
import microsoft.graph.users.item.drives.item.items.item.versions.item.content.ContentRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
