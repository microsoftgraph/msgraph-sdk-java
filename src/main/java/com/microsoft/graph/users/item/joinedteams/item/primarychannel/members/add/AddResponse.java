package microsoft.graph.users.item.joinedteams.item.primarychannel.members.add;
...
import microsoft.graph.models.ActionResultPart;
/** Provides operations to call the add method. */
public class AddResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(ActionResultPart::createFromDiscriminatorValue)); });
        }};
    }
    /**
