package microsoft.graph.users.item.joinedteams.item.channels.item.sharedwithteams.item.allowedmembers;
...
import microsoft.graph.users.item.joinedteams.item.channels.item.sharedwithteams.item.allowedmembers.count.CountRequestBuilder;
