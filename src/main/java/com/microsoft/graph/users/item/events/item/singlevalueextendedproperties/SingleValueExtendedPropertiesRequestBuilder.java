package microsoft.graph.users.item.events.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
