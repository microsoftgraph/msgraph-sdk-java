package com.microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.move;
...
public class MovePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
