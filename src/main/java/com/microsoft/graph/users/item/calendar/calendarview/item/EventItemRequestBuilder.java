package microsoft.graph.users.item.calendar.calendarview.item;
...
import microsoft.graph.users.item.calendar.calendarview.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.instances.InstancesRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.calendar.calendarview.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendar.calendarView.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendar.calendarView.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendar.calendarView.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendar.calendarView.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendar.calendarView.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
