...
public class CalendarPermissionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final CalendarPermission body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CalendarPermission> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CalendarPermission> executionException = new java.util.concurrent.CompletableFuture<CalendarPermission>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
