package microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties.count.CountRequestBuilder;
