package microsoft.graph.users.item.contacts.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.contacts.item.singlevalueextendedproperties.count.CountRequestBuilder;
