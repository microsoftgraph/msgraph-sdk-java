package microsoft.graph.users.item.calendars.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendars.item.multivalueextendedproperties.count.CountRequestBuilder;
