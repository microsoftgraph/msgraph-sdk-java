...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.listItem.documentSetVersions.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.listItem.versions.item collection
     * @param id Unique identifier of the item
