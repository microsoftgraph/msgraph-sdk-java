package microsoft.graph.users.item.drives.item.root.listitem;
...
import microsoft.graph.users.item.drives.item.root.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.drives.item.root.listItem.documentSetVersions.item collection
