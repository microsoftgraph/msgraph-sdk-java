package microsoft.graph.users.item.mailfolders.item.messages;
...
import microsoft.graph.users.item.mailfolders.item.messages.count.CountRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.delta.DeltaRequestBuilder;
