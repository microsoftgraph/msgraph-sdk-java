package microsoft.graph.users.item.calendars.item.events.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendars.item.events.item.multivalueextendedproperties.count.CountRequestBuilder;
