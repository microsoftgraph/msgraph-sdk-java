package microsoft.graph.users.item.chats.item.messages.item.replies;
...
import microsoft.graph.users.item.chats.item.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.users.item.chats.item.messages.item.replies.delta.DeltaRequestBuilder;
