package microsoft.graph.users.item.messages.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.messages.item.multivalueextendedproperties.count.CountRequestBuilder;
