package com.microsoft.graph.users.item.messages.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.messages.item.multivalueextendedproperties.count.CountRequestBuilder;
