...
public class MasterCategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OutlookCategoryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OutlookCategoryCollectionResponse::createFromDiscriminatorValue, null);
        } catch (URISyntaxException ex) {
            return new java.util.concurrent.CompletableFuture<OutlookCategoryCollectionResponse>() {{
    ...
    public java.util.concurrent.CompletableFuture<OutlookCategory> post(@javax.annotation.Nonnull final OutlookCategory body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OutlookCategory::createFromDiscriminatorValue, null);
        } catch (URISyntaxException ex) {
