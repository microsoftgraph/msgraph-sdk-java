package microsoft.graph.users.item.calendargroups.item.calendars.item.events.item;
...
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.InstancesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarGroups.item.calendars.item.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarGroups.item.calendars.item.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarGroups.item.calendars.item.events.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarGroups.item.calendars.item.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarGroups.item.calendars.item.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
