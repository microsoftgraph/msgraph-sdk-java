package microsoft.graph.users.item.contactfolders.item.childfolders.item.contacts.item.extensions;
...
import microsoft.graph.users.item.contactfolders.item.childfolders.item.contacts.item.extensions.count.CountRequestBuilder;
