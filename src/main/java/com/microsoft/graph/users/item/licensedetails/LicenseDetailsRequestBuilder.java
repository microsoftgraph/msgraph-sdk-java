...
public class LicenseDetailsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<LicenseDetailsCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LicenseDetailsCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LicenseDetailsCollectionResponse>();
