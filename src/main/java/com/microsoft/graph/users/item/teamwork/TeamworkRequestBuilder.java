...
public class TeamworkRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final UserTeamwork body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserTeamwork> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserTeamwork> executionException = new java.util.concurrent.CompletableFuture<UserTeamwork>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
