package com.microsoft.graph.users.item.chats.item.messages.item;

import com.microsoft.graph.models.ChatMessage;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.chats.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
...
import com.microsoft.graph.users.item.chats.item.messages.item.replies.RepliesRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.chats.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.chats.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
