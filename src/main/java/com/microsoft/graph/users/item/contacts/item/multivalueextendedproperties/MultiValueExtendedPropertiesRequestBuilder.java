package microsoft.graph.users.item.contacts.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.contacts.item.multivalueextendedproperties.count.CountRequestBuilder;
