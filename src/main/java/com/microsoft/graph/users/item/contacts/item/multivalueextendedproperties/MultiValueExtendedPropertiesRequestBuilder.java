package com.microsoft.graph.users.item.contacts.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.contacts.item.multivalueextendedproperties.count.CountRequestBuilder;
