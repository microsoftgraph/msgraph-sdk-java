package microsoft.graph.users.item.onenote.notebooks;
...
import microsoft.graph.users.item.onenote.notebooks.count.CountRequestBuilder;
import microsoft.graph.users.item.onenote.notebooks.getnotebookfromweburl.GetNotebookFromWebUrlRequestBuilder;
