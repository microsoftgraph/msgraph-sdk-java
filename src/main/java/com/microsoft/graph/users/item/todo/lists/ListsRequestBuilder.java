...
public class ListsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TodoTaskList> post(@javax.annotation.Nonnull final TodoTaskList body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TodoTaskList> executionException = new java.util.concurrent.CompletableFuture<TodoTaskList>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
