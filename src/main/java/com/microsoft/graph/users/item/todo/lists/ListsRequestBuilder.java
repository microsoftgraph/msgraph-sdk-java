...
public class ListsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TodoTaskListCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TodoTaskList> post(@jakarta.annotation.Nonnull final TodoTaskList body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TodoTaskList> executionException = new java.util.concurrent.CompletableFuture<TodoTaskList>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TodoTaskList> post(@jakarta.annotation.Nonnull final TodoTaskList body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TodoTaskList body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TodoTaskList body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
