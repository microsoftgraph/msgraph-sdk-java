package microsoft.graph.users.item.drives.item.items.item;
...
import microsoft.graph.users.item.drives.item.items.item.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.checkin.CheckinRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.checkout.CheckoutRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.children.ChildrenRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.content.ContentRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.copy.CopyRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.createlink.CreateLinkRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.createuploadsession.CreateUploadSessionRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.delta.DeltaRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.deltawithtoken.DeltaWithTokenRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.follow.FollowRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.getactivitiesbyinterval.GetActivitiesByIntervalRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.invite.InviteRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.listitem.ListItemRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.permissions.item.PermissionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.permissions.PermissionsRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.preview.PreviewRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.searchwithq.SearchWithQRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.subscriptions.item.SubscriptionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.subscriptions.SubscriptionsRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.thumbnails.item.ThumbnailSetItemRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.thumbnails.ThumbnailsRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.unfollow.UnfollowRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.validatepermission.ValidatePermissionRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.versions.item.DriveItemVersionItemRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.versions.VersionsRequestBuilder;
