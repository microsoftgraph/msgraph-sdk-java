package com.microsoft.graph.users.item.drives.item.items.item.copy;
...
public class CopyRequestBuilder {
    ...
    public CopyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.copy";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CopyPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/driveitem-copy?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
