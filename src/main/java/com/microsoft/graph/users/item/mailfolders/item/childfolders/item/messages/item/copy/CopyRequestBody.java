package microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.copy;
...
public class CopyRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a copyRequestBody
     */
    @javax.annotation.Nonnull
    public static CopyRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CopyRequestBody currentObject = this;
