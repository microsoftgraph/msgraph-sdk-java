package microsoft.graph.users.item.contactfolders.item.childfolders.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.contactfolders.item.childfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
