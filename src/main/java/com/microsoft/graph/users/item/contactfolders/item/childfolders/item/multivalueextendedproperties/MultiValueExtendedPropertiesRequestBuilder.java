package com.microsoft.graph.users.item.contactfolders.item.childfolders.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.contactfolders.item.childfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
