package microsoft.graph.users.item.calendars.item.events;
...
import microsoft.graph.users.item.calendars.item.events.count.CountRequestBuilder;
import microsoft.graph.users.item.calendars.item.events.delta.DeltaRequestBuilder;
