package microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.multivalueextendedproperties.count.CountRequestBuilder;
