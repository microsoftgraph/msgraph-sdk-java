package microsoft.graph.users.item.authentication.temporaryaccesspassmethods;
...
import microsoft.graph.users.item.authentication.temporaryaccesspassmethods.count.CountRequestBuilder;
