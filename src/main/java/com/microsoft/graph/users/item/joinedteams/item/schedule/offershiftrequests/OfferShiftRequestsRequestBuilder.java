package microsoft.graph.users.item.joinedteams.item.schedule.offershiftrequests;
...
import microsoft.graph.users.item.joinedteams.item.schedule.offershiftrequests.count.CountRequestBuilder;
