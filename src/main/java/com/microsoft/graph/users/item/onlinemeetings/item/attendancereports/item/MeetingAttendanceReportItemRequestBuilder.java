package microsoft.graph.users.item.onlinemeetings.item.attendancereports.item;
...
import microsoft.graph.users.item.onlinemeetings.item.attendancereports.item.attendancerecords.AttendanceRecordsRequestBuilder;
import microsoft.graph.users.item.onlinemeetings.item.attendancereports.item.attendancerecords.item.AttendanceRecordItemRequestBuilder;
