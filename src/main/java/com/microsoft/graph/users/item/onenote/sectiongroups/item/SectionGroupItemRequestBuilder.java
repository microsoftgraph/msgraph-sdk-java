package com.microsoft.graph.users.item.onenote.sectiongroups.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.SectionGroup;
import com.microsoft.graph.users.item.onenote.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.users.item.onenote.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import com.microsoft.graph.users.item.onenote.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import com.microsoft.graph.users.item.onenote.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.onenote.sectionGroups.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.onenote.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
