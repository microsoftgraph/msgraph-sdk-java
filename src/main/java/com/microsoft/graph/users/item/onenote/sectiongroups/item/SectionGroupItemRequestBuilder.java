package microsoft.graph.users.item.onenote.sectiongroups.item;
...
import microsoft.graph.users.item.onenote.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.users.item.onenote.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.onenote.sectionGroups.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.onenote.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
