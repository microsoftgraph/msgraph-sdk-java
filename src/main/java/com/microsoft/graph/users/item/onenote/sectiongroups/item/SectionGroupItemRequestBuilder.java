...
public class SectionGroupItemRequestBuilder {
     ...
     * @return a CompletableFuture of sectionGroup
     */
    public java.util.concurrent.CompletableFuture<SectionGroup> patch(@javax.annotation.Nonnull final SectionGroup body, @javax.annotation.Nullable final java.util.function.Consumer<SectionGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
