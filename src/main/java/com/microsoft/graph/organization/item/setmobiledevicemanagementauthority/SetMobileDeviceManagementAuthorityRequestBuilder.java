...
public class SetMobileDeviceManagementAuthorityRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SetMobileDeviceManagementAuthorityResponse> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SetMobileDeviceManagementAuthorityResponse> executionException = new java.util.concurrent.CompletableFuture<SetMobileDeviceManagementAuthorityResponse>();
