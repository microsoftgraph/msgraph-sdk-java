package microsoft.graph.planner;
...
import microsoft.graph.models.Planner;
import microsoft.graph.planner.buckets.BucketsRequestBuilder;
import microsoft.graph.planner.buckets.item.PlannerBucketItemRequestBuilder;
import microsoft.graph.planner.plans.item.PlannerPlanItemRequestBuilder;
import microsoft.graph.planner.plans.PlansRequestBuilder;
import microsoft.graph.planner.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.planner.tasks.TasksRequestBuilder;
...
public class PlannerRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<Planner> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, Planner::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of planner
     */
    public java.util.concurrent.CompletableFuture<Planner> get(@javax.annotation.Nullable final java.util.function.Consumer<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, Planner::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Planner body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Planner body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Planner body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
