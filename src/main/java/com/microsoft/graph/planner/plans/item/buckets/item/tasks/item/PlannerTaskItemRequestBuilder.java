package microsoft.graph.planner.plans.item.buckets.item.tasks.item;
...
import microsoft.graph.planner.plans.item.buckets.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import microsoft.graph.planner.plans.item.buckets.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import microsoft.graph.planner.plans.item.buckets.item.tasks.item.details.DetailsRequestBuilder;
import microsoft.graph.planner.plans.item.buckets.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
