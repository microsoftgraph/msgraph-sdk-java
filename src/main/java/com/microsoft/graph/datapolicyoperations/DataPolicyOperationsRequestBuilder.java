...
public class DataPolicyOperationsRequestBuilder extends BaseRequestBuilder {
    ...
    public DataPolicyOperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataPolicyOperations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DataPolicyOperationsRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DataPolicyOperation> post(@javax.annotation.Nonnull final DataPolicyOperation body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DataPolicyOperation> executionException = new java.util.concurrent.CompletableFuture<DataPolicyOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DataPolicyOperation> post(@javax.annotation.Nonnull final DataPolicyOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DataPolicyOperation body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DataPolicyOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
