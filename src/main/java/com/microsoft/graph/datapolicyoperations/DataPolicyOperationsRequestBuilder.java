...
public class DataPolicyOperationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DataPolicyOperation> post(@javax.annotation.Nonnull final DataPolicyOperation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DataPolicyOperation> executionException = new java.util.concurrent.CompletableFuture<DataPolicyOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
