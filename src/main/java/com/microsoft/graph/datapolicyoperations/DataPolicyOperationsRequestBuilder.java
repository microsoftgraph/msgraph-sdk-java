package microsoft.graph.datapolicyoperations;
...
import microsoft.graph.datapolicyoperations.count.CountRequestBuilder;
import microsoft.graph.models.DataPolicyOperation;
import microsoft.graph.models.DataPolicyOperationCollectionResponse;
...
public class DataPolicyOperationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DataPolicyOperationCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DataPolicyOperationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DataPolicyOperationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DataPolicyOperationsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DataPolicyOperationCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<DataPolicyOperation> post(@javax.annotation.Nonnull final DataPolicyOperation body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DataPolicyOperation::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of dataPolicyOperation
     */
    public java.util.concurrent.CompletableFuture<DataPolicyOperation> post(@javax.annotation.Nonnull final DataPolicyOperation body, @javax.annotation.Nullable final java.util.function.Consumer<DataPolicyOperationsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, DataPolicyOperation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
